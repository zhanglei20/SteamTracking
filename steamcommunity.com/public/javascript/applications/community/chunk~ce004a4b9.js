  ...
  [8024],
  {
    11333: (e, r, t) => {
      ...
      function l(e, r) {
        return new (s())(
          async (r) => {
            const t = [...r],
              a = await i.xtC.GetPlayerLinkDetails(e, { steamids: t }),
              n = new Map();
            return (
              a
                .Body()
    ...
    76170: (e, r, t) => {
      ...
      class l extends i.Message {
        ...
        constructor(e = null) {
          super(),
            l.prototype.gifteename || n.Sg(l.M()),
            i.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static M() {
          return (
      ...
      class o extends i.Message {
        ...
        constructor(e = null) {
          super(),
            o.prototype.amount_in_cents || n.Sg(o.M()),
            i.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static M() {
          return (
    ...
    437: (e, r, t) => {
      ...
      class T extends a.Message {
        ...
        constructor(e = null) {
          super(),
            T.prototype.family_groupid || s.Sg(T.M()),
            a.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static M() {
          return (
      ...
      class we extends a.Message {
        ...
        constructor(e = null) {
          super(),
            we.prototype.wallet_country_matches || s.Sg(we.M()),
            a.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static M() {
          return (
      ...
      class ze extends a.Message {
        ...
        constructor(e = null) {
          super(),
            ze.prototype.steamid || s.Sg(ze.M()),
            a.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static M() {
          return (
    ...
    71430: (e, r, t) => {
      ...
      class g extends a.Message {
        ...
        static M() {
          return (
            g.sm_m ||
              (g.sm_m = { proto: g, fields: { walletcredit: { n: 1, c } } }),
            g.sm_m
          );
        }
        static MBF() {
      ...
      class M extends a.Message {
        ...
        constructor(e = null) {
          super(),
            M.prototype.gidparent || s.Sg(M.M()),
            a.Message.initialize(this, e, 0, -1, [2], null);
        }
        static M() {
          return (
      ...
      class O extends a.Message {
        ...
        static M() {
          return (
            O.sm_m ||
              (O.sm_m = { proto: O, fields: { contents: { n: 1, c: S } } }),
            O.sm_m
          );
        }
        static MBF() {
    ...
    42834: (e, r, t) => {
      ...
      function m(e, r = !1) {
        const { data: t } = (0, a.lv)({ appid: e });
        return void 0 === t
          ? void 0
          : null === t
            ? null
            : r && t.library_capsule_2x
              ? l(t, "library_capsule_2x")
              : t.library_capsule
                ? l(t, "library_capsule")
