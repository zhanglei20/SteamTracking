  ...
  [1574],
  {
        ...
        f = function (e) {
          const {
            ...
            _ = l
              ...
              : p,
            v = l ? void 0 : f,
            H = g && d.TS.IN_GAMEPADUI ? C.fu : "button";
          return (0, i.jsx)(H, {
            type: "button",
            ...(0, a.mz)(
              {
            ...
            ...(0, a.mz)(
              {
                ...
                size: n,
                minWidth: s,
                className: r()(o.Button, h && o.Icon, (0, l.T)()),
              },
              u,
            ),
          });
              ...
              children: [
                ...
                n &&
                  (0, i.jsx)(l.s, {
                    ...
                    justify: "center",
                    align: "center",
                    children: (0, i.jsx)(C, { size: t, color: c, variant: a }),
                  }),
              ],
            })
          : (0, i.jsx)(C, { size: t, color: c, variant: a, ...h });
      }
      function C(e) {
        const { className: t, color: n, ...o } = (0, r.mz)(e, d);
        return (0, i.jsx)("div", {
          "data-accent-color": n,
          className: a()(t, s.Spinner),
          ...o,
        });
      }
      const d = [
    ...
    49560: (e, t, n) => {
      ...
      function C(e) {
        ...
        return (
          s && n.offset
            ? i.push((0, c.cY)(n.offset))
            : (s && void 0 !== n.offset) || i.push((0, c.cY)(2)),
          s && n.flip
            ? i.push((0, c.UU)(n.flip))
            : (s && void 0 !== n.flip) || i.push((0, c.UU)()),
          s && n.shift
            ? i.push((0, c.BN)(n.shift))
            : (s && void 0 !== n.shift) || i.push((0, c.BN)()),
          i.push(
            (0, c.Ej)({
              apply: (n) => {
                const { rects: i, elements: s, availableHeight: r } = n,
                  o =
                    "number" == typeof t
                      ? r - t + "px"
                ...
                switch ((e.scroll && (c.overflowY = "auto"), e.width)) {
                  case "target":
                    c.width = `${i.reference.width}px`;
                    break;
                  case "content":
                    c.width = `${i.floating.width}px`;
                    break;
                  case "dropdown": {
                ...
                "function" == typeof e.width &&
                  ...
                  Object.assign(s.floating.style, c),
                  s.floating.style.setProperty("--popover-max-height", o);
              },
            }),
          ),
          i
      ...
      const d = {
          ...
          const { children: t, ...n } = e,
            s = (function (e) {
              ...
              const a = (0, r.we)({
                  ...
                  placement: i && "object" == typeof i ? i.initial : i,
                }),
                l = (0, r.kp)(a.context, { enabled: !!s.click }),
                h = (0, r.iQ)(a.context, { enabled: !!s.focus }),
                d = { handleClose: (0, r.iB)() },
                p = "function" == typeof s.hover ? s.hover(d) : d,
                u = (0, r.Mk)(a.context, { enabled: !!s.hover, ...p }),
                f = (0, r.s9)(a.context),
                { getFloatingProps: x, getReferenceProps: g } = (0, r.bv)([
                  l,
                  h,
                  u,
                  f,
        ...
        Anchor: function (e) {
          ...
          return n
            ? i
              ? (0, s.cloneElement)(n, {
                  ...i.getReferenceProps(n.props),
                  ref: (0, a.XB)(n.props.ref, i.floating.refs.setReference),
                })
              : (console.error(
        ...
        Positioner: function (e) {
          ...
          const d = s.Children.only(t),
            p = (0, s.cloneElement)(d, {
              ref: a,
          ...
          return (0, i.jsx)(r.XF, {
            root: null == C ? void 0 : C.targetElement,
            children: (0, i.jsx)(r.s3, {
    ...
    19997: (e, t, n) => {
      ...
      function h(e) {
        const { as: t = "div", ref: n, ...r } = e,
          c = (0, a.mz)({ ...r, className: o()(l.Grid, e.className) }, C),
          h = t;
        return (0, i.jsx)(s.J, {
          "flow-children": "grid",
          children: (0, i.jsx)(h, { ref: n, ...c }),
        });
      }
      const C = [
        ...c.h,
    ...
    59805: (e, t, n) => {
      ...
      function p(e) {
        ...
        return (0, i.jsx)(o, {
          ...(0, c.mz)({ ...e, className: d()((0, h.T)(), s.Heading, n) }, u),
        });
      }
      const u = [
        ...o.U6,
    ...
    2917: (e, t, n) => {
      ...
      function S(e) {
        const {
          ...
          [c, a] = (0, j.useState)(!1);
        return (0, i.jsxs)(w.A.Root, {
          open: c,
          onOpenChange: a,
          interactions: {
            hover: (e) => {
              let t = { ...e, delay: { open: s, close: 0 } };
              return r && (t = { ...t, handleClose: null }), t;
            },
          },
          ...o,
          children: [
            (0, i.jsx)(w.A.Anchor, { children: t }),
            (0, i.jsx)(w.A.Positioner, {
              children: (0, i.jsx)(V.az, { children: n }),
            }),
          ],
        });
      }
      ...
      function A(e) {
        ...
        return "initial" === t || "sm" === t
          ? null
          : (0, i.jsx)("footer", {
              className: H()(b().SteamChinaFooter, e.className),
              children: (0, i.jsxs)(V.az, {
      ...
      var E = n(42475);
      const k = {};
      (k.arabic = () => n.e(6939).then(n.t.bind(n, 36939, 19))),
        (k.brazilian = () => n.e(3095).then(n.t.bind(n, 83095, 19))),
        (k.bulgarian = () => n.e(864).then(n.t.bind(n, 864, 19))),
        (k.czech = () => n.e(3910).then(n.t.bind(n, 73910, 19))),
        (k.danish = () => n.e(7098).then(n.t.bind(n, 27098, 19))),
        (k.dutch = () => n.e(4847).then(n.t.bind(n, 84847, 19))),
        (k.english = () => n.e(3621).then(n.t.bind(n, 53621, 19))),
        (k.finnish = () => n.e(9058).then(n.t.bind(n, 29058, 19))),
        (k.french = () => n.e(2683).then(n.t.bind(n, 82683, 19))),
        (k.german = () => n.e(9209).then(n.t.bind(n, 49209, 19))),
        (k.greek = () => n.e(2933).then(n.t.bind(n, 42933, 19))),
        (k.hungarian = () => n.e(6740).then(n.t.bind(n, 66740, 19))),
        (k.indonesian = () => n.e(4631).then(n.t.bind(n, 4631, 19))),
        (k.italian = () => n.e(517).then(n.t.bind(n, 10517, 19))),
        (k.japanese = () => n.e(4788).then(n.t.bind(n, 24788, 19))),
        (k.koreana = () => n.e(3838).then(n.t.bind(n, 83838, 19))),
        (k.latam = () => n.e(1990).then(n.t.bind(n, 91990, 19))),
        (k.norwegian = () => n.e(8953).then(n.t.bind(n, 18953, 19))),
        (k.polish = () => n.e(8766).then(n.t.bind(n, 58766, 19))),
        (k.portuguese = () => n.e(3110).then(n.t.bind(n, 93110, 19))),
        (k.romanian = () => n.e(7384).then(n.t.bind(n, 67384, 19))),
        (k.russian = () => n.e(8928).then(n.t.bind(n, 28928, 19))),
        (k.schinese = () => n.e(8787).then(n.t.bind(n, 98787, 19))),
        (k.spanish = () => n.e(8802).then(n.t.bind(n, 96421, 19))),
        (k.swedish = () => n.e(7524).then(n.t.bind(n, 17524, 19))),
        (k.tchinese = () => n.e(7248).then(n.t.bind(n, 67248, 19))),
        (k.thai = () => n.e(6085).then(n.t.bind(n, 46085, 19))),
        (k.turkish = () => n.e(7997).then(n.t.bind(n, 37997, 19))),
        (k.ukrainian = () => n.e(7247).then(n.t.bind(n, 47247, 19))),
        (k.vietnamese = () => n.e(3092).then(n.t.bind(n, 3092, 19)));
      const N = (0, E.l)(async function (e) {
        if (k[e]) return k[e]();
      });
      function Z() {
        return (0, i.jsxs)("svg", {
      ...
      function F(e) {
        return (0, i.jsx)(s.s, { direction: "column", gap: "4", ...e });
      }
      function G(e) {
        return (0, i.jsx)(r.D, {
          level: "3",
        ...
        return (0, i.jsxs)(s.s, {
          ...
          children: [
            ...
            (0, i.jsx)(a.EY, {
              ...
              children: (0, p.A)(
                N.Localize("#footer_legal_notice", new Date().getFullYear()),
              ),
            }),
            (0, i.jsxs)(s.s, {
              gap: "6",
              ...
              children: [
                "initial" === e &&
                  ...
                  (0, i.jsx)(l.v, {
                    ...
                    children: N.Localize("#footer_link_get_mobile_apps"),
                  }),
                x() &&
                  (0, i.jsx)(l.$, {
                    color: "dull",
                    onClick: g,
                    children: N.Localize("#footer_view_mobile_website"),
                  }),
              ],
            }),
          ],
        ...
        return (
          ...
          (0, i.jsx)(h.N, {
            ...
            children: (0, i.jsxs)(C.x, {
              ...
              className: H()(L.GlobalFooter, e.className),
              ...
              children: [
                ...
                (0, i.jsxs)(F, {
                  ...
                  children: [
                    (0, i.jsx)(G, {
                      children: N.Localize("#footer_link_header_steam"),
                    }),
                    (0, i.jsx)(W, {
                      href: m.TS.STORE_BASE_URL + "about/",
                      children: N.Localize("#footer_link_about_steam"),
                    }),
                    (0, i.jsx)(W, {
                      href: m.TS.STORE_BASE_URL + "subscriber_agreement/",
                      children: N.Localize("#footer_link_steam_ssa"),
                    }),
                    (0, i.jsx)(W, {
                      href: m.TS.PARTNER_BASE_URL,
                      children: N.Localize("#footer_link_steamworks"),
                    }),
                    (0, i.jsx)(W, {
                      href: m.TS.PARTNER_BASE_URL + "steamdirect",
                      children: N.Localize("#footer_link_steam_distribution"),
                    }),
                    (0, i.jsx)(W, {
                      href: m.TS.STORE_BASE_URL + "digitalgiftcards/",
                      children: N.Localize("#footer_link_gift_cards"),
                    }),
                  ],
                }),
                (0, i.jsxs)(F, {
                  ...
                  children: [
                    (0, i.jsx)(G, {
                      children: N.Localize("#footer_link_header_valve"),
                    }),
                    (0, i.jsx)(W, {
                      href: "https://valvesoftware.com/about",
                      children: N.Localize("#footer_link_about_valve"),
                    }),
                    (0, i.jsx)(W, {
                      href: "https://valvesoftware.com/",
                      children: N.Localize("#footer_link_jobs"),
                    }),
                    (0, i.jsx)(W, {
                      href: m.TS.STORE_BASE_URL + "hardware/",
                      children: N.Localize("#footer_link_hardware"),
                    }),
                    (0, i.jsx)(W, {
                      href: m.TS.STORE_BASE_URL + "hardware_recycling/",
                      children: N.Localize("#footer_link_recycling"),
                    }),
                  ],
                }),
                (0, i.jsxs)(F, {
                  ...
                  children: [
                    (0, i.jsx)(G, {
                      children: N.Localize("#footer_link_header_legal"),
                    }),
                    (0, i.jsx)(W, {
                      href: m.TS.STORE_BASE_URL + "privacy_agreement/",
                      children: N.Localize("#footer_link_privacy"),
                    }),
                    (0, i.jsx)(W, {
                      href: "https://help.steampowered.com/faqs/view/10BB-D27A-6378-4436",
                      children: N.Localize("#footer_link_accessibility"),
                    }),
                    (0, i.jsx)(W, {
                      href: m.TS.STORE_BASE_URL + "legal/",
                      children: N.Localize("#footer_link_notices_and_policies"),
                    }),
                    (0, i.jsx)(W, {
                      href: m.TS.STORE_BASE_URL + "account/cookiepreferences/",
                      children: N.Localize("#footer_link_cookies"),
                    }),
                    (0, i.jsx)(W, {
                      href: m.TS.STORE_BASE_URL + "steam_refunds/",
                      children: N.Localize("#footer_link_refunds"),
                    }),
                  ],
                }),
                (0, i.jsxs)(F, {
                  ...
                  children: [
                    (0, i.jsx)(G, {
                      children: N.Localize("#footer_link_header_more"),
                    }),
                    (0, i.jsx)(W, {
                      href: m.TS.STORE_BASE_URL + "about/",
                      children: N.Localize("#footer_link_get_steam"),
                    }),
                    (0, i.jsx)(W, {
                      href: m.TS.STORE_BASE_URL + "mobile/",
                      children: N.Localize("#footer_link_get_mobile_apps"),
                    ...
                    (0, i.jsx)(W, {
                      ...
                      children: N.Localize("#footer_link_get_support"),
                    }),
                    (0, i.jsx)(W, {
                      href: m.TS.STORE_BASE_URL + "account/",
                      children: N.Localize("#footer_link_my_account"),
                    }),
                  ],
                }),
              ],
