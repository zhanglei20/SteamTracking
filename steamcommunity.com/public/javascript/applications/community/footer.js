  ...
  (self.webpackChunkcommunity = self.webpackChunkcommunity || []).push([
    [1574],
    {
      84909: (P, z, t) => {
        ...
        var n = t(7850),
          ...
          E = t(3877),
          j = t(3166);
        const u = (0, s.createContext)(null);
        function C(r) {
          const { children: f, ...i } = r,
            v = N(i);
          return (0, n.jsx)(u.Provider, { value: v, children: f });
        }
        function L(r) {
          const { children: f } = r,
            i = s.Children.only(f),
          ...
          return i
            ? v
              ? (0, s.cloneElement)(i, {
                  ...v.getReferenceProps(i.props),
                  ref: (0, T.XB)(i.props.ref, v.floating.refs.setReference),
                })
              : (console.error(
        ...
        function V(r) {
          const { children: f, className: i, ref: v } = r,
            c = (0, s.useContext)(u),
            W = (0, H.SV)([
              v,
              ...
              (A) => {
                var p;
                return (p = A == null ? void 0 : A.showPopover) == null
                  ? void 0
                  : p.call(A);
              },
            ]);
          ...
          let g = s.Children.only(f),
            F = s.Fragment;
          g.type == K.FocusManager &&
            ((g = s.Children.only(g.props.children)), (F = O));
          const I = (0, s.cloneElement)(g, {
            ref: W,
        ...
        function o(r) {
          ...
          const v = () => i.floating.context.onOpenChange(!1),
            c = s.useRef(void 0);
          return (
            (0, l.O7)(c, !!c.current, !1),
            (0, n.jsx)(B.D6, {
              navID: "Popover",
              onCancelButton: v,
              modal: !0,
              ...
              children: (0, n.jsx)("div", {
                ...
                children: (0, n.jsx)(y.q, { children: f }),
              }),
            })
          );
        }
        ...
        function N(r) {
          ...
          const g = (0, H.we)({
              ...
              placement: v && typeof v == "object" ? v.initial : v,
              strategy: "fixed",
              platform: {
                ...R.iD,
                getOffsetParent: (J) => {
                  var $, Q;
                  return (Q =
                    ($ = J == null ? void 0 : J.ownerDocument) == null
                      ? void 0
                      : $.defaultView) != null
                    ? Q
                    : window;
            ...
            F = { enabled: !!c.click },
            I = typeof c.click == "function" ? c.click(F) : F,
            A = (0, H.kp)(g.context, I),
            p = { enabled: !!c.focus },
            Z = typeof c.focus == "function" ? c.focus(p) : p,
            X = (0, H.iQ)(g.context, Z),
            e = { handleClose: (0, H.iB)() },
            _ = typeof c.hover == "function" ? c.hover(e) : e,
            h = (0, H.Mk)(g.context, { enabled: !!c.hover, ..._ }),
            t1 = (0, H.s9)(g.context),
            { getFloatingProps: n1, getReferenceProps: o1 } = (0, H.bv)([
              A,
              X,
              h,
              t1,
          ...
          return {
            floating: g,
            getFloatingProps: n1,
            getReferenceProps: o1,
            open: W,
          };
        }
        function G(r) {
          const { gutter: f = 0, placement: i } = r,
            v = [],
            c = i && typeof i == "object";
          return (
            c && i.offset
              ? v.push((0, M.cY)(i.offset))
              : (!c || i.offset === void 0) && v.push((0, M.cY)(2)),
            c && i.flip
              ? v.push((0, M.UU)(i.flip))
              : (!c || i.flip === void 0) && v.push((0, M.UU)()),
            c && i.shift
              ? v.push((0, M.BN)(i.shift))
              : (!c || i.shift === void 0) && v.push((0, M.BN)()),
            v.push(
              (0, M.Ej)({
                apply: (W) => {
                  const { rects: g, elements: F, availableHeight: I } = W,
                    A = { boxSizing: "border-box", zIndex: "1" };
                  switch ((r.scroll && (A.overflowY = "auto"), r.width)) {
                    case "target": {
                      A.width = `${g.reference.width}px`;
                      break;
                    }
                    case "content": {
                      A.width = `${g.floating.width}px`;
                      break;
                    }
                    case "dropdown": {
                      let Z = g.reference.width;
                      g.floating.width > Z && Z < 200 && (Z = g.floating.width),
                        (A.width = `${Z}px`);
                    }
                  }
                  typeof r.width == "function" &&
                    (A.width = r.width({
                      unContentWidth: g.floating.width,
                      unTargetWidth: g.reference.width,
                    }));
                  const p =
                    typeof f == "number" ? `${f}px` : `var(--spacing-${f})`;
                  typeof r.maxHeight == "function"
                    ? (A.maxHeight = r.maxHeight({
                        unAvailableHeight: I,
                        gutter: p,
                      }))
                    : typeof r.maxHeight == "number"
                      ? (A.maxHeight = `min( calc( ${I}px - ${p} ), ${r.maxHeight}px )`)
                      : typeof f == "number"
                        ? (A.maxHeight = `${I - f}px`)
                        : (A.maxHeight = `calc( ${I}px - var(--spacing-${f}) )`),
                    Object.assign(F.floating.style, A),
        ...
        const K = { Root: C, Anchor: L, Positioner: V, FocusManager: O };
      },
      95994: (P, z, t) => {
        "use strict";
        t.d(z, { x: () => S });
        ...
        function S(a) {
          var E;
          const { as: j = "div", ref: u, focusable: C, navProps: L, ...V } = a,
            O = (0, y.Qn)(),
            o = (0, T.mz)({ ...V, className: R()(l.Grid, a.className) }, D),
            U =
              (E = C != null ? C : L == null ? void 0 : L.focusable) != null
                ? E
                : !!V.onClick,
            N = (0, n.jsx)(j, { ref: u, ...o });
          return O
        ...
        const D = [
          ...
          },
          {
            prop: "autoColumns",
            responsive: !0,
            className: l.AutoColumns,
            cssProperty: "--grid-auto-columns",
          },
          {
            prop: "autoRows",
            responsive: !0,
            className: l.AutoRows,
          ...
          },
          {
            prop: "alignContent",
            responsive: !0,
            className: l.AlignContent,
            cssProperty: "--grid-align-content",
          },
          {
            prop: "justifyContent",
            responsive: !0,
            className: l.JustifyContent,
            cssProperty: "--grid-justify-content",
          },
          {
            prop: "alignItems",
            responsive: !0,
            className: l.AlignItems,
            cssProperty: "--grid-align-items",
          },
          {
            prop: "justifyItems",
            responsive: !0,
            className: l.JustifyItems,
          ...
          },
          {
            ...
            responsive: !0,
            className: l.Gap,
            cssProperty: (a) => ["--grid-gap", `var(--spacing-${a})`],
          },
          {
            prop: "gapX",
            responsive: !0,
            className: l.Gap,
            cssProperty: (a) => ["--grid-gap-x", `var(--spacing-${a})`],
          },
          {
            prop: "gapY",
            responsive: !0,
            className: l.Gap,
            cssProperty: (a) => ["--grid-gap-y", `var(--spacing-${a})`],
          },
        ];
      },
      34771: (P, z, t) => {
        ...
        var n = t(7850),
          ...
          T = t(90626);
        function l(C) {
          const { depth: L } = useContext(B);
          return jsx(B.Provider, {
            value: { depth: L + 1 },
            children: jsx(Box, { ...C }),
          });
        }
        const B = T.createContext({ depth: 0 });
        function y() {
          return (0, T.useContext)(B).depth;
        }
        var S = t(3877),
          D = t(64238),
          a = t.n(D);
        function E(C) {
          const { level: L = "auto", className: V, color: O } = C,
            o = y(),
            U = u(L, o);
          return (0, n.jsx)(U, {
            ...(0, M.mz)({ ...C, className: a()((0, S.T)(), s.Heading, V) }, j),
          });
        }
        const j = [
          ...R.U6,
          ...H.L,
          {
            prop: "size",
            responsive: !0,
            className: (C) => s[`HeadingSize-${C}`],
          },
        ];
        function u(C, L) {
          if (C === "auto" && L === 0) return "h1";
          const V = C === "auto" ? L.toString() : C;
          return /^[1-6]$/.test(V)
            ? "h" + V
            : C === "auto"
              ? (console.error(
                ...
                "h6")
              : (console.error(
                  `Attempt to render invalid heading level, "${V}".`,
                ),
                "h1");
        }
      },
      15252: (P, z, t) => {
        ...
        var n = t(7850),
          ...
          B = t.n(l);
        function y(a) {
          const { as: E = "span", ref: j, className: u, ...C } = a,
            L = E;
          return (0, n.jsx)(L, {
            ref: j,
            ...(0, H.mz)({ ...C, className: T()(l.Text, u) }, D),
          });
        }
        const S = [
            {
            ...
            },
            {
              ...
              cssProperty: (a, E, j) => {
                ...
                return [
                  ...
                  (0, H.To)(
                    a,
                    (u = (0, s.I)(E.contrast, j)) != null ? u : "body",
                  ),
                ];
              },
            },
            {
              ...
              cssProperty: (a, E, j) => {
                ...
                return [
                  "--text-color",
                  (0, H.To)(
                    (u = (0, s.I)(E.color, j)) != null ? u : "text-body",
                    a,
                  ),
                ];
              },
      ...
      86336: (P, z, t) => {
        ...
        function y(a) {
          var E;
          const { underline: j = "auto", focusable: u, navProps: C, ...L } = a,
            V = (0, B.Qn)(),
            O =
              (E = u != null ? u : C == null ? void 0 : C.focusable) != null
                ? E
                : !!L.href,
            o = (0, M.mz)({ ...L, underline: j, className: s.TextLink }, S);
          return V && (O || C)
            ? (0, n.jsx)(T.Ii, { ...o, ...(C || {}), focusable: O })
            : (0, n.jsx)("a", { ...o });
        }
        const S = [
          ...R.Ae,
          { prop: "underline", className: (a) => s[`Underline-${a}`] },
        ];
        function D(a) {
          var E;
          const { underline: j = "auto", focusable: u, navProps: C, ...L } = a,
            ...
            o = (0, n.jsx)("span", {
              role: "button",
              ...(0, M.mz)(
                { ...L, underline: j, className: s.TextLinkButton },
                S,
              ),
            });
          return V && (O || C)
            ? (0, n.jsx)(l.J, { ...(C || {}), focusable: O, children: o })
            : o;
        }
      },
      10566: (P, z, t) => {
        "use strict";
        t.r(z), t.d(z, { GlobalFooter: () => r1 });
        var n = t(7850),
          s = t(68031),
          H = t(34771),
          R = t(86336),
        ...
        function C(d = !1) {
          const m = [];
          return (
            j() ? m.push("force_desktop") : m.push("responsive"),
            (u() || d) && m.push("touch"),
            m.join(" ")
          );
        }
        ...
        function O() {
          j() && (0, a.Y1)(E.k1), "location" in window && location.reload();
        }
        var o = t(72609),
          U = t(72865),
          N = t(64238),
        ...
        function c(d) {
          const {
            ...
            [h1, e1] = (0, K.useState)(!1),
            u1 = (q) => {
              ((0, v.p)() && !q) || e1(q);
            },
            d1 = (q) => {
              let s1 = { ...q, delay: { open: w, close: 0 } };
              return c1 && (s1 = { ...s1, handleClose: null }), s1;
            };
          return (0, n.jsxs)(i.A.Root, {
            open: h1,
            onOpenChange: e1,
            interactions: { hover: d1 },
            ...C1,
            children: [
              (0, n.jsx)(i.A.Anchor, { children: m }),
              (0, n.jsx)(i.A.Positioner, {
                children: (0, n.jsx)(f.az, { children: Y }),
              }),
            ],
          });
        }
        ...
        function A() {
          return (0, n.jsxs)("svg", {
            ...
            fill: "#C30A14",
            children: [
              (0, n.jsx)("path", { d: "M30.4,15.3h3.5l-1.8-6.8L30.4,15.3z" }),
              (0, n.jsx)("path", {
	...
	c1.3,0,2.6,0,4,0c0,0.7,0,1.4,0,2.1c-1.3,0-2.6,0-4,0c0,0.8,0,1.6,0,2.4c1.4,0,4.3,0,4.3,0v2.1h-6.7V5.8h6.7V7.8z`,
        ...
        function p(d) {
          ...
          return (
            m != null &&
              m.startsWith(o.TS.STORE_BASE_URL) &&
              (m = (0, U.bV)(w, m)),
            (0, n.jsx)(R.Y, {
              href: m,
              color: "dull-11",
        ...
        function Z(d) {
          const m = (0, M.xC)();
          return m === "initial" || m === "sm"
            ? null
            : (0, n.jsx)("footer", {
                className: G()(g().SteamChinaFooter, d.className),
                children: (0, n.jsxs)(f.az, {
                      ...
                      children: [
                        ...
                        (0, n.jsxs)(f.az, {
                          ...
                          children: [
                            ...
                            (0, n.jsx)(p, {
                              href:
                                o.TS.STORE_BASE_URL + "subscriber_agreement",
                              children:
                                "\u8F6F\u4EF6\u8BB8\u53EF\u670D\u52A1\u534F\u8BAE",
                            }),
                            "\xA0 | \xA0",
                            ...
                            "\xA0 | \xA0",
                            (0, n.jsx)(p, {
                              href: o.TS.STORE_BASE_URL + "data_outbound",
                              children:
                                "\u4E2A\u4EBA\u4FE1\u606F\u51FA\u5883\u544A\u77E5\u4E66",
                            }),
                            "\xA0 | \xA0",
        ...
        var X = t(31275);
        const e = {};
        (e.arabic = () => t.e(2560).then(t.t.bind(t, 42560, 19))),
          (e.brazilian = () => t.e(7442).then(t.t.bind(t, 37442, 19))),
          (e.bulgarian = () => t.e(9945).then(t.t.bind(t, 39945, 19))),
          (e.czech = () => t.e(5059).then(t.t.bind(t, 55059, 19))),
          (e.danish = () => t.e(9605).then(t.t.bind(t, 19605, 19))),
          (e.dutch = () => t.e(3366).then(t.t.bind(t, 13366, 19))),
          (e.english = () => t.e(4468).then(t.t.bind(t, 74468, 19))),
          (e.finnish = () => t.e(1655).then(t.t.bind(t, 31655, 19))),
          (e.french = () => t.e(1580).then(t.t.bind(t, 21580, 19))),
          (e.german = () => t.e(5666).then(t.t.bind(t, 5666, 19))),
          (e.greek = () => t.e(2936).then(t.t.bind(t, 22936, 19))),
          (e.hungarian = () => t.e(2173).then(t.t.bind(t, 52173, 19))),
          (e.indonesian = () => t.e(412).then(t.t.bind(t, 80412, 19))),
          (e.italian = () => t.e(9468).then(t.t.bind(t, 29468, 19))),
          (e.japanese = () => t.e(2811).then(t.t.bind(t, 52811, 19))),
          (e.koreana = () => t.e(6139).then(t.t.bind(t, 76139, 19))),
          (e.latam = () => t.e(7267).then(t.t.bind(t, 77267, 19))),
          (e.malay = () => t.e(8844).then(t.t.bind(t, 88844, 19))),
          (e.norwegian = () => t.e(5964).then(t.t.bind(t, 85964, 19))),
          (e.polish = () => t.e(6509).then(t.t.bind(t, 26509, 19))),
          (e.portuguese = () => t.e(8233).then(t.t.bind(t, 58233, 19))),
          (e.romanian = () => t.e(8727).then(t.t.bind(t, 48727, 19))),
          (e.russian = () => t.e(8973).then(t.t.bind(t, 98973, 19))),
          (e.schinese = () => t.e(9720).then(t.t.bind(t, 49720, 19))),
          (e.spanish = () => t.e(1924).then(t.t.bind(t, 31924, 19))),
          (e.swedish = () => t.e(7925).then(t.t.bind(t, 17925, 19))),
          (e.tchinese = () => t.e(9259).then(t.t.bind(t, 89259, 19))),
          (e.thai = () => t.e(5474).then(t.t.bind(t, 25474, 19))),
          (e.turkish = () => t.e(2164).then(t.t.bind(t, 12164, 19))),
          (e.ukrainian = () => t.e(2626).then(t.t.bind(t, 52626, 19))),
          (e.vietnamese = () => t.e(6515).then(t.t.bind(t, 66515, 19)));
        async function _(d) {
          if (e[d]) return e[d]();
        }
        const h = (0, X.l)(_);
        ...
        function b(d) {
          return (0, n.jsx)(s.s, { direction: "column", gap: "4", ...d });
        }
        function k(d) {
          return (0, n.jsx)(H.D, {
            level: "3",
          ...
          return (0, n.jsxs)(s.s, {
            ...
            children: [
              ...
              (0, n.jsx)(T.EY, {
                as: "p",
                size: "1",
                className: r.LegalNotice,
                children: (0, D.A)(
                  h.Localize("#footer_legal_notice", new Date().getFullYear()),
                ),
              }),
              (0, n.jsxs)(s.s, {
                gap: "6",
                align: "center",
                className: r.LogoLinks,
                children: [
                  (0, n.jsx)(x, {
              ...
              (0, n.jsxs)(s.s, {
                ...
                children: [
                  d === "initial" &&
                    ...
                    (0, n.jsx)(l.v, {
                      href: o.TS.STORE_BASE_URL + "mobile/",
                      children: h.Localize("#footer_link_get_mobile_apps"),
                    }),
                  j() &&
                    (0, n.jsx)(l.$, {
                      color: "dull",
                      onClick: O,
                      children: h.Localize("#footer_view_mobile_website"),
                    }),
                ],
              }),
            ],
          ...
          return (
            ...
            (0, n.jsx)(B.N, {
              ...
              children: (0, n.jsxs)(y.x, {
                ...
                className: G()(r.GlobalFooter, d.className),
                ...
                children: [
                  ...
                  (0, n.jsxs)(b, {
                    ...
                    children: [
                      (0, n.jsx)(k, {
                        children: h.Localize("#footer_link_header_steam"),
                      }),
                      (0, n.jsx)(x, {
                        href: o.TS.STORE_BASE_URL + "about/",
                        children: h.Localize("#footer_link_about_steam"),
                      }),
                      (0, n.jsx)(x, {
                        href: o.TS.STORE_BASE_URL + "subscriber_agreement/",
                        children: h.Localize("#footer_link_steam_ssa"),
                      }),
                      (0, n.jsx)(x, {
                        href: o.TS.PARTNER_BASE_URL,
                        children: h.Localize("#footer_link_steamworks"),
                      }),
                      (0, n.jsx)(x, {
                        href: o.TS.PARTNER_BASE_URL + "steamdirect",
                        children: h.Localize("#footer_link_steam_distribution"),
                      }),
                      (0, n.jsx)(x, {
                        href: o.TS.STORE_BASE_URL + "digitalgiftcards/",
                        children: h.Localize("#footer_link_gift_cards"),
                      }),
                    ],
                  }),
                  (0, n.jsxs)(b, {
                    ...
                    children: [
                      (0, n.jsx)(k, {
                        children: h.Localize("#footer_link_header_valve"),
                      }),
                      (0, n.jsx)(x, {
                        href: "https://valvesoftware.com/about",
                        children: h.Localize("#footer_link_about_valve"),
                      }),
                      (0, n.jsx)(x, {
                        href: "https://valvesoftware.com/",
                        children: h.Localize("#footer_link_jobs"),
                      }),
                      (0, n.jsx)(x, {
                        href: o.TS.STORE_BASE_URL + "hardware/",
                        children: h.Localize("#footer_link_hardware"),
                      }),
                      (0, n.jsx)(x, {
                        href: o.TS.STORE_BASE_URL + "hardware_recycling/",
                        children: h.Localize("#footer_link_recycling"),
                      }),
                    ],
                  }),
                  (0, n.jsxs)(b, {
                    ...
                    children: [
                      (0, n.jsx)(k, {
                        children: h.Localize("#footer_link_header_legal"),
                      }),
                      (0, n.jsx)(x, {
                        href: o.TS.STORE_BASE_URL + "privacy_agreement/",
                        children: h.Localize("#footer_link_privacy"),
                      }),
                      (0, n.jsx)(x, {
                        href: "https://help.steampowered.com/faqs/view/10BB-D27A-6378-4436",
                        children: h.Localize("#footer_link_accessibility"),
                      }),
                      (0, n.jsx)(x, {
                        href: o.TS.STORE_BASE_URL + "legal/",
                        children: h.Localize(
                      ...
                      (0, n.jsx)(x, {
                        href:
                          o.TS.STORE_BASE_URL + "account/cookiepreferences/",
                        children: h.Localize("#footer_link_cookies"),
                      }),
                      (0, n.jsx)(x, {
                        href: o.TS.STORE_BASE_URL + "steam_refunds/",
                        children: h.Localize("#footer_link_refunds"),
                      }),
                    ],
                  }),
                  (0, n.jsxs)(b, {
                    ...
                    children: [
                      (0, n.jsx)(k, {
                        children: h.Localize("#footer_link_header_more"),
                      }),
                      (0, n.jsx)(x, {
                        href: o.TS.STORE_BASE_URL + "about/",
                        children: h.Localize("#footer_link_get_steam"),
                      }),
                      (0, n.jsx)(x, {
                        href: o.TS.STORE_BASE_URL + "mobile/",
                        children: h.Localize("#footer_link_get_mobile_apps"),
                      ...
                      (0, n.jsx)(x, {
                        ...
                        children: h.Localize("#footer_link_get_support"),
                      }),
                      (0, n.jsx)(x, {
                        href: o.TS.STORE_BASE_URL + "account/",
                        children: h.Localize("#footer_link_my_account"),
                      }),
                    ],
                  }),
                ],
        ...
        function r1(d) {
          if ((0, t1.Qn)()) return null;
          const m = (0, S.nA)(o.TS.EREALM)
            ? (0, n.jsx)(Z, { ...d })
            : (0, n.jsx)(a1, { ...d });
          return (0, n.jsx)(U.nn, {
            controller: "footer",
