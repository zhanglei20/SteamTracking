      ...
      function S(e) {
        ...
        return (
          i && n.offset
            ...
            : (i && void 0 !== n.offset) || o.push((0, a.cY)(2)),
          i && n.flip
            ? o.push((0, a.UU)(n.flip))
            : (i && void 0 !== n.flip) || o.push((0, a.UU)()),
          i && n.shift
            ? o.push((0, a.BN)(n.shift))
            : (i && void 0 !== n.shift) || o.push((0, a.BN)()),
          o.push(
            (0, a.Ej)({
              apply: (n) => {
                const { rects: o, elements: i, availableHeight: r } = n,
                ...
                "function" == typeof e.maxHeight
                  ...
                  : "number" == typeof e.maxHeight
                    ? (s.maxHeight = `min( calc( ${r}px - ${a} ), ${e.maxHeight}px )`)
                    : (s.maxHeight =
                        "number" == typeof t
                          ? r - t + "px"
                          : `calc( ${r}px - var(--spacing-${t}) )`),
                  Object.assign(i.floating.style, s),
          ...
          },
          {
            ...
            cssProperty: (e, t, n) => {
              ...
              return [
                ...
                (0, r.To)(
                  e,
                  null !== (o = (0, i.I)(t.contrast, n)) && void 0 !== o
                    ? o
                    : "body",
                ),
              ];
          ...
          },
          {
            ...
            cssProperty: (e, t, n) => {
              ...
              return [
                "--text-color",
                (0, r.To)(
                  null !== (o = (0, i.I)(t.color, n)) && void 0 !== o
                    ? o
                    : "text-body",
                  e,
                ),
