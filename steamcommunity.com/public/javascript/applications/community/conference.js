...
(self.webpackChunkcommunity = self.webpackChunkcommunity || []).push([
  [8521, 8396],
  {
    ...
    67318: (e, n, t) => {
      "use strict";
      t.r(n), t.d(n, { ConferenceRoutes: () => fn, default: () => gn });
      var a = t(7850),
        o = t(92757),
        s = t(6813),
        i = t(59952),
      ...
      class u {
        constructor() {
          this.m_mapConferences = m.sH.map();
        }
        GetConferenceInfo(e) {
          ...
          if (this.ValidateStoreDefault(e)) {
            const n = (0, r.sf)(d.TS.LANGUAGE),
              ...
              o = {
                ...
                clanSteamID: new l.b(e.event_group_steamid),
                broadcastSteamID: new l.b(e.broadcast_steamid),
            ...
            this.m_mapConferences.set(e.vanity, {
              ...
              strLocalizedMobileLogos: "string" == typeof m ? [m] : m,
            });
          }
        }
      ...
      function y(e) {
        ...
        return t
          ...
          : (0, a.jsxs)("div", {
              ...
              children: [
                (0, a.jsx)(T.BroadcastEmbeddablePopoutHeader, {
                  steamIDBroadcast: n.broadcastSteamID.ConvertTo64BitString(),
                  OnPreventPopup: () => o(!0),
                }),
                (0, a.jsx)(N, { conferenceInfo: n }),
              ],
            });
      }
      var A = t(14932);
      function k(e) {
        const { conferenceInfo: n } = e;
        return "dev" != d.TS.WEB_UNIVERSE
          ? null
          : (0, a.jsxs)("div", {
              children: [
                (0, a.jsx)("h1", { children: "Conference Data" }),
                (0, a.jsx)(A.G, { data: n }),
                (0, a.jsx)("h1", { children: "Config Data" }),
                (0, a.jsx)(A.z, { strConfigID: "application_config" }),
              ],
            });
      }
      var G = t(28579),
      ...
      class R {
        ...
        async InternalLoadInitialCalendarData(e, n) {
          M.KN.IsInitialized() || M.KN.InitGlobal(),
          ...
          a &&
            ...
            await t.RegisterCalendarEventsAndModels(a)),
      ...
      const pe = (0, Y.PA)((e) => {
        const { eventModel: n, calendarEvent: t, history: o } = e,
          s = (e) => {
            ...
            (0, ce.pg)(
              (0, a.jsx)(le.o0, {
                strTitle: (0, f.we)("#EventCalendar_MuteApp_Title", n),
                strDescription: (0, f.we)("#EventCalendar_MuteApp_details", n),
                onOK: () =>
                ...
                children: (0, a.jsx)("a", {
                  ...
                  children: (0, f.we)("#EventCalendar_ManageMutedSources"),
                }),
              }),
              (0, ie.uX)(e),
            );
          ...
          r = () => {
            const e = l().MapClanEventTypeToGroup(n.GetEventType());
            l().SetEventTypeGroupAllowed(e, !1);
          },
          l = () => (0, H.v0)().m_visibilityStore,
          c = (e, n, t, o = !0) => {
            l().BIsGameSourceAllowed(n) &&
              (o &&
                e.push(
                  (0, a.jsx)(
                    se.kt,
                    {
                      disabled: !0,
                      onSelected: () => {},
                      children: (0, f.we)("#EventCalender_Reason_" + n),
                    },
                    `item-source-${t}-${n}`,
                  ),
                ),
              e.push(
                (0, a.jsx)(
                  ...
                  {
                    onSelected: () => {
                      l().SetGameSourceAllowed(n, !1);
                    },
                    children: (0, f.we)("#EventCalender_Hide_Reason_" + n),
                  },
                  `item-hidesource-${t}-${n}`,
                ),
              ));
          },
          m = (0, ue.Bw)(n, ue.PH.k_eStoreNewsHub, "allowRelative"),
          u = () => {
            m.startsWith("http") ? (window.location.href = m) : o.push(m);
          };
        return (0, a.jsx)("div", {
          className: (0, E.A)(me().FooterStat, me().Options),
          onClick: (e) => {
            let o = [];
            const m = t.GetSource(),
              _ = t.unique_id,
            ...
            p.BIsGlobalCalendar() &&
              (m &&
                m & z.bK.k_eLibrary &&
                (l().BIsGameSourceAllowed(ee.FD.k_ERecent) && t.appInfo
                  ? (o.push(
                      (0, a.jsx)(
                        se.kt,
                        {
                    ...
                    c(o, ee.FD.k_ERecent, _, !1))
                  : c(o, ee.FD.k_ELibrary, _)),
              m && m & z.bK.k_eWishlist && c(o, ee.FD.k_EWishlist, _),
              m && m & z.bK.k_eFollowing && c(o, ee.FD.k_EFollowing, _),
              !h && m && m & z.bK.k_eCurator && c(o, ee.FD.k_ECurator, _),
              m && m & z.bK.k_eRecommended && c(o, ee.FD.k_ERecommended, _),
              m && m & z.bK.k_eSteam && c(o, ee.FD.k_ESteam, _),
              m && m & z.bK.k_eFeatured && c(o, ee.FD.k_EFeatured, _)),
              o.push(
                (0, a.jsx)(
                  se.kt,
                  {
                    ...
                    children: (0, f.we)(
                      ...
                      (0, f.we)(
                        "#EventCalendar_EventTypeGroup_" +
                          l().MapClanEventTypeToGroup(n.GetEventType()),
                      ),
                    ),
                  },
                  n.GID + "hidetype",
              ...
              d.iA.logged_in &&
                (oe.S.Get().BIsEventBlocked(t)
                  ? o.push(
                      (0, a.jsx)(
                        se.kt,
                        {
                          onSelected: i,
                          children: (0, a.jsx)(B.he, {
              ...
              n.BIsOGGEvent() ||
                h ||
                o.push((0, a.jsx)(Ce, { eventModel: n, calendarEvent: t })),
              p.BIsSingleSourceCalendar() ||
                o.push(
                  (0, a.jsx)(
                    se.kt,
                    {
              ...
              n.appid &&
                o.push(
                  (0, a.jsx)(
                    ...
                    {
                      onSelected: () =>
                        (window.location.href = (0, re.k2)(
                          d.TS.STORE_BASE_URL + "app/" + n.appid,
                        )),
                      children: (0, f.we)("#EventDisplay_ViewStorePage"),
                    },
                    n.GID + "goto",
                  ),
                ),
              (0, te.lX)((0, a.jsx)(se.tz, { children: o }), e);
          },
      ...
      function Ce(e) {
        const { eventModel: n, calendarEvent: t } = e,
          o = (0, _e.eT)(n.clanSteamID.GetAccountID()),
          { elDialogElement: s, fnShowLogonDialog: i } = (0, ve.E)(),
          r = x.useCallback(async () => {
            d.iA.logged_in
              ? (await ae.Fm.Get().UpdateFollowOrIgnoreCurator(
                  n.clanSteamID,
                  !0,
                  !o,
                ),
      ...
      const Te = (e) => {
            ...
            return (0, a.jsx)("img", { src: e.altImg, className: e.className });
          {
            const i =
              ...
              l = () => {
                s.current && s.current.naturalHeight < 91 && r();
              };
            return (0, a.jsx)("img", {
              ref: s,
              onLoad: l,
              onError: r,
              src: i,
              className: (0, E.A)(be().YoutubePreviewImage, e.className),
            });
          }
        },
        Ne = (e) => {
          const [n, t] = x.useState(!1);
          (0, je.VC)(!!e.preloadYoutubeScripts);
          const o = (0, we.Rp)("youtube");
          if (n && o)
            return (0, a.jsx)(je.N1, {
              ...e,
              classnames: (0, E.A)(be().YoutubePlayer, e.classnames),
            });
          {
            const n = (n) => {
                  ...
                  (0, a.jsxs)(a.Fragment, {
                    children: [
                      ...
                      (0, a.jsx)("div", {
                        ...
                        children: (0, f.we)("#EventCalendar_WatchYouTubeVideo"),
                      }),
                    ],
                  }),
              ],
      ...
      function Le(e) {
        const {
          ...
          [m, u] = x.useState(!1);
        (0, ke.t7)(n.GetAppIDOrReferenceAppID(), Ge),
          x.useEffect(() => {
            if (t.clanInfo) {
              let e = l.b.InitFromClanID(t.clanInfo.clanid);
              Z.ac.LoadClanInfoForClanSteamID(e);
            }
          }, [t.clanInfo]);
        const _ = M.KN.Get(),
          h = (0, r.sf)(d.TS.LANGUAGE),
          p = "capsule",
          [C, f, S, I, j, b, w, T, N, D, y] = (0, g.q3)(() => [
            n.has_live_stream,
            n.GetEventType(),
            n.GetAllTags(),
            n.GetCategoryAsString(),
            n.GetNameWithFallback(h),
            n.BImageNeedScreenshotFallback(p, h),
            n.appid,
            n.GID,
            n.GetStartTimeAndDateUnixSeconds(),
            n.GetSubTitleWithLanguageFallback(h),
            n.GetSummaryWithFallback(h),
          ]),
          [A, k] = x.useState(() =>
            (0, Se.c5)() && 14 == f ? X.wI.full : X.wI.capsule_main,
          ),
          G = (0, we.Ey)(),
          L = (0, g.q3)(() =>
            Boolean(b && w)
              ? n.GetFallbackArtworkScreenshot()
              : n.GetImageURLWithFallback(p, h, A, G),
          ),
          B =
            "upcoming" !== s &&
            (function (e, n, t, o) {
              const { video_preview_type: s, video_preview_id: i, type: l } = e,
                c = n.appid;
              if (!i) return null;
              if (12 === l) return null;
              if ("youtube" === s) {
                const n = (0, r.sf)(d.TS.LANGUAGE),
                  s = (0, Se.c5)() && 14 == l ? X.wI.full : X.wI.capsule_main,
                  m = e.GetImageForSizeAsArrayWithFallback("capsule", n, s, !0);
                if ("carousel" === o)
                  return (0, a.jsx)(Te, {
                    altImgWithFallback: m,
                    video: i,
                    className: me().YoutubePreviewImage,
                  });
                const u = () => {
                  $.V.RecordAppInteractionEvent(c, $.E.k_ePlayedVideo), t(!0);
                };
                return (0, a.jsx)(Ne, {
                  video: i,
                  altImgWithFallback: m,
                  ...
                  showFullscreenBtn: !0,
                  controls: !0,
                  imageClassnames: me().YoutubePreviewImage,
                  onPlayerActivated: u,
          ...
          R = (0, E.A)(
            ...
            P,
            C && me().TileVideoIcon,
            o ? me().DisableHovers : me().EnableHovers,
            m && me().VideoPlayerReady,
            B && me().HasVideo,
            _.HasEventBeenRead(T) && me().HasBeenRead,
            "wide" === s && me().WideMode,
            "carousel" === s && me().CarouselMode,
            "upcoming" === s && me().UpcomingMode,
            ...H,
          );
        let U = D,
          V = y;
        U === V && (V = void 0), U === j && (U = void 0);
        const O = (0, J.j3)(L),
          W = (0, a.jsx)(Fe, {
            videoPreview: B,
            calendarEvent: t,
          ...
          z =
            28 !== f &&
            12 !== f &&
            v.HD.GetTimeNowWithOverride() < N &&
            (0, a.jsx)("div", {
              className: (0, E.A)(me().ReminderContainer, Y && me().OnlyIcon),
              children: (0, a.jsx)(xe.j, {
                eventModel: n,
                lang: h,
                bShowStartTime: !0,
                bOnlyShowIcon: Y,
        ...
        return (0, a.jsxs)("div", {
          className: R,
          children: [
            (0, a.jsx)(ge.C, { event: n, recordNewsHubStats: !0 }),
            (0, a.jsx)(ue.tj, {
              eventModel: n,
              route: ue.PH.k_eView,
              children: (0, a.jsxs)("div", {
                className: me().Tile,
                onClick: (e) => {
                  $.V.RecordAppInteractionEvent(t.appid, $.E.k_eClickThrough),
                    c(n),
                    e.stopPropagation(),
                    e.preventDefault();
                },
                children: [
                  14 === f &&
                    (0, a.jsx)("div", {
                      className: (0, E.A)(
                        me().TileBackgroundImage,
                        b && me().FallbackImage,
                      ),
                      style: { backgroundImage: `url(${O})` },
                    }),
                  (0, a.jsxs)("div", {
                    className: me().MainContentContainer,
                    children: [
                      Q,
                      (0, a.jsxs)("div", {
                        ...
                        children: [
                          Boolean(12 == f) &&
                            (0, a.jsx)("div", {
                              className: me().PatchIconCtn,
                              children: (0, a.jsx)(F.vjL, {}),
                            }),
                          (0, a.jsxs)("div", {
                            className: me().EventTitleCtn,
                            children: [
                              K,
                              !i &&
                                (0, a.jsxs)("div", {
                                  className: me().GameSource,
                                  children: [
                                    (0, a.jsx)(Pe, { ...e }),
                                    t && (0, a.jsx)(Me, { calendarEvent: t }),
                                  ],
                                }),
                              (0, a.jsx)("div", {
                                className: me().EventName,
                                children: j,
                              }),
                              (0, a.jsxs)("div", {
                                className: me().EventTypeAndDateCtn,
                                children: [
                                  (0, a.jsx)("div", {
                                    className: (0, E.A)(
                                      me().TileTextCategoryType,
                                      P,
                                    ),
                                    children: I,
                                  }),
                              ...
                              ne &&
                                (0, a.jsx)("div", {
                                  className: me().EventSubTitle,
                                  children: U,
                                }),
                              ee &&
                                (0, a.jsx)("div", {
                                  className: (0, E.A)(
                                    me().EventSummaryDefault,
                                    U ? me().SubTitleShown : "",
                                  ),
                                  children: V,
                                }),
      ...
      function Fe(e) {
        const {
          ...
          [v, _, h, p, C, S] = (0, g.q3)(() => [
            ...
            o.GetGameCapsule(),
            t.BImageNeedScreenshotFallback(i, m),
          ]);
        x.useEffect(() => {
          const e = new Image();
          (e.src = l),
        ...
        const I = Z.ac.GetClanInfoByClanAccountID(p),
          j = I && !I.is_ogg;
        let b = t.GetSummaryWithFallback(m);
        return (
          t.GetSubTitleWithLanguageFallback(m) === b && (b = void 0),
          (0, a.jsxs)("div", {
            className: me().CoverImageCtn,
            children: [
              n,
              u &&
                (0, a.jsxs)(a.Fragment, {
                  children: [
                    12 === v &&
                      (0, a.jsxs)(a.Fragment, {
                        children: [
                          ...
                          (0, a.jsx)("div", {
                            className: me().GameShortDescription,
                            children: b,
                          }),
                        ],
                      }),
                    12 !== v &&
                      (0, a.jsxs)("div", {
                        className: (0, E.A)({
                          [me().EventCapsuleCtn]: !0,
                          [me().LiveBroadcastPreview]: h,
                        }),
                        children: [
                          (0, a.jsx)("div", {
                            className: (0, E.A)({
                          ...
                          h &&
                            (0, a.jsx)("div", {
                              className: me().TileCoverImagePlayable,
                            }),
                          _ &&
                            (0, a.jsx)("div", {
                              className: me().TileCoverLiveIcon,
                              children: (0, f.we)("#home_page_live_broadcast"),
                            }),
                          h &&
                            (0, a.jsx)("div", {
                              className: "VideoHintText",
      ...
      const Be = (0, Y.PA)((e) => {
          const {
            ...
            i = (0, ue.Bw)(n, ue.PH.k_eStoreNewsHub, "allowRelative"),
            r = t.GetEntityName(),
            l = t.GetGameIcon(),
            c = (0, E.A)(
              me().GameTitleContainer,
              o ? me().DisableHovers : me().EnableHovers,
            );
          return (0, a.jsx)(_.tH, {
            children: (0, a.jsx)("div", {
              className: me().TileTextHeader,
              children: (0, a.jsxs)("div", {
                className: c,
                onClick: (e) => {
                  i.startsWith("http") ? (window.location.href = i) : s.push(i),
                    e.stopPropagation(),
                    e.preventDefault();
                },
                children: [
                  (0, a.jsx)("img", { className: me().AppIcon, src: l }),
                  (0, a.jsxs)("div", {
        ...
        He = (0, Y.PA)((e) => {
          const { eventModel: n, calendarEvent: t, className: o } = e,
            ...
            i = n ? n.GetStartTimeAndDateUnixSeconds() : t.start_time,
            r = n && (0, ye.JS)(n.type) && n.GetEndTimeAndDateUnixSeconds();
          if (r && i < s && s < r) {
            const e = r - s,
              n = (0, f.Hq)(e, !0);
            return (0, a.jsxs)("div", {
              className: (0, E.A)(me().LiveText, o),
              children: [
                (0, a.jsx)(h.gS, {
                  rtFullDate: i,
                  stylesmodule: me(),
                  children: (0, a.jsx)("div", {
                    className: me().LiveNow,
                    children: (0, f.we)("#EventCalendar_LiveNow"),
                  }),
                }),
                (0, a.jsx)(h.gS, {
                  rtFullDate: r,
                  stylesmodule: me(),
                  children: (0, f.we)("#EventCalendar_TimeLeft", n),
                }),
              ],
            });
          }
          if (i < s) {
            const e = s - i,
              n = e < 86400 ? (0, f.Hq)(e, !1, !0) : (0, f._l)(i);
            return (0, a.jsx)(h.gS, {
              className: o,
              rtFullDate: i,
              stylesmodule: me(),
              children: (0, a.jsx)("div", {
                className: me().PastDateText,
                children: n,
              }),
            });
          }
          {
            ...
            const n = e.getTime() / 1e3,
              t = Math.floor((i - n) / 86400),
              r = t > 1 && t <= 5 ? (0, f.cc)(new Date(1e3 * i)) : (0, f._l)(i),
              l = (0, h.pg)(i);
            return (0, a.jsx)(h.gS, {
              className: o,
              rtFullDate: i,
              stylesmodule: me(),
              children: (0, a.jsx)("div", {
                className: me().FutureDateText,
                children: (0, f.we)("#EventCalendar_WillStartAtDateTime", r, l),
              }),
            });
          }
        }),
        Me = (0, Y.PA)((e) => {
          ...
          n & z.bK.k_eLibrary && o.BIsGameSourceAllowed(ee.FD.k_ELibrary)
            ? t.push({
                id: z.bK.k_eLibrary,
                name: "#EventCalendar_GameSource_inLibrary",
                ttip: "#EventCalendar_GameSource_EventExplanation_ttip_library",
                styles: me().LibrarySource,
              })
            : n & z.bK.k_eWishlist && o.BIsGameSourceAllowed(ee.FD.k_EWishlist)
              ? t.push({
                  id: z.bK.k_eWishlist,
                  name: "#EventCalendar_GameSource_onWishlist",
                  ttip: "#EventCalendar_GameSource_EventExplanation_ttip_wishlist",
                  styles: me().WishlistSource,
                })
              : n & z.bK.k_eRecommended &&
                  o.BIsGameSourceAllowed(ee.FD.k_ERecommended)
                ? t.push({
          ...
          return (0, a.jsx)("div", { className: me().SourceList, children: s });
        }),
        Re = (e, n, t, o, s) =>
          (0, a.jsx)(
            B.he,
            {
              className: (0, E.A)(me().Source, o),
              toolTipContent: (0, f.we)(t),
              children: (0, f.we)(n) + (s ? ", " : ""),
            },
            e,
          );
      let Ue = class extends x.Component {
        OnPerformVoteUp() {
          const { eventModel: e } = this.props,
            n = M.KN.Get();
          !0 !== n.GetPreviouslyLoadedVote(this.props.eventModel) &&
            (0, ne.W)(e, n) &&
            (n.Vote(e, !0, Q().CancelToken.source()),
            $.V.RecordAppInteractionEvent(e.appid, $.E.k_eThumbsUp));
        }
        OnDiscussionClicked() {
          const { eventModel: e } = this.props;
          $.V.RecordAppInteractionEvent(e.appid, $.E.k_eDiscussions);
        }
        render() {
          const e = M.KN.Get(),
            { eventModel: n } = this.props,
            t = Math.max(0, n.nVotesUp - n.nVotesDown),
          ...
          return (0, a.jsx)("div", {
            className: me().Footer,
            children: (0, a.jsxs)("div", {
              className: me().FooterRightSide,
              children: [
                Boolean(l) &&
                  (0, a.jsx)("div", {
                    className: me().TileViewerCount,
                    children: (0, De.Dq)(l),
                  }),
                (0, a.jsxs)("div", {
                  className: (0, E.A)(me().FooterStat, me().Vote, s),
                  onClick: this.OnPerformVoteUp,
                  children: [
                    (0, a.jsx)(F.bfp, { className: me().RateIcon }),
                    (0, a.jsx)("span", { children: (0, De.Dq)(Number(t)) }),
                  ],
                }),
                r &&
                  (0, a.jsx)("div", {
                    className: me().FooterStat,
                    children: (0, a.jsxs)("a", {
                      href: i,
                      className: me().CommentIconCtn,
                      target: "_blank",
                      onClick: this.OnDiscussionClicked,
                      children: [
                        (0, a.jsx)(F._h6, { className: me().CommentIcon }),
                        (0, a.jsx)("span", {
                          children: (0, De.Dq)(Number(n.nCommentCount)),
                        }),
                      ],
                    }),
                  }),
                (0, a.jsx)(fe, { ...this.props }),
              ],
            }),
          });
        }
      };
      (0, q.Cg)([Ae.oI], Ue.prototype, "OnPerformVoteUp", null),
        (0, q.Cg)([Ae.oI], Ue.prototype, "OnDiscussionClicked", null),
        (Ue = (0, q.Cg)([Y.PA], Ue));
      var Ve = t(8107),
        Oe = t(95034);
      function We(e) {
        const { displayLocation: n, fnChangeModalEvent: t } = e,
          [o, s] = x.useState(null),
          [i, r] = (0, Oe.QD)("emgid", null),
          [c, d] = (0, Oe.QD)("emclan", null);
        return (
          (0, Ae.hL)(t, (e, n) => {
            r(e), d(l.b.InitFromClanID(n).ConvertTo64BitString());
          }),
          x.useEffect(() => {
            if (null != i && null != c) {
              const e = new l.b(c);
              V.O3.LoadPartnerEventFromClanEventGIDAndClanSteamID(e, i, 0).then(
                s,
              );
            }
          }, [i, c]),
      ...
      function Xe(e) {
        const n = (0, H.v0)(),
          ...
          [s] = x.useState(new Ye.lu()),
          i = x.useCallback(
            (e, n) => (0, W.Y)(V.O3.GetClanEventModel(e), window),
            [],
          );
        return 0 == n.GetNumEventsLoaded()
          ? (0, a.jsx)("div", {
              children: (0, f.we)("#Conference_No_Schedule_Yet"),
            })
          : (0, a.jsxs)("div", {
              className: Je.EventsScheduleCtn,
              children: [
                (0, a.jsx)(We, { displayLocation: 6, fnChangeModalEvent: s }),
                (0, a.jsx)(nn, { rgActiveEvents: o, fnDisplayModalEvent: i }),
                (0, a.jsx)($e, {
                  rgActiveEvents: o,
                ...
                (0, a.jsx)("br", {}),
                (0, a.jsx)(O.$n, {
                  onClick: (e) => (0, ce.pg)((0, a.jsx)(sn, {}), (0, ie.uX)(e)),
                  children: (0, f.we)("#Conference_NeedHelp"),
                }),
              ],
            });
      }
      function Ze(e) {
        return (0, a.jsx)(on, { ...e, children: (0, a.jsx)(Xe, { ...e }) });
      }
      function $e(e) {
        ...
        return 0 == o.length
          ? (0, a.jsx)("div", {
              children: (0, f.we)("#Conference_No_More_Schedule"),
            })
          : (0, a.jsxs)("div", {
              className: Je.UpcomingEventsCtn,
              children: [
                (0, a.jsx)("div", {
                  className: Je.SectionTitle,
                  children: (0, f.we)("#Conference_ScheduleNext"),
                }),
                (0, a.jsx)("div", {
                  className: Je.EventSchedCtn,
                  children: o.map((o, s) =>
                    (0, a.jsx)(
                      en,
                      {
      ...
      function en(e) {
        const {
          ...
          i = V.O3.GetClanEventModel(n.unique_id),
          l = (0, r.sf)(d.TS.LANGUAGE),
          c = i.GetStartTimeAndDateUnixSeconds(),
          m = (0, P.JD)(new Date(1e3 * s), new Date(1e3 * c));
        return (0, a.jsxs)("div", {
          className: Je.EventItemCtn,
          onClick: () => o(i.GID, i.clanSteamID.GetAccountID()),
          children: [
            (0, a.jsx)("div", {
              className: Je.Title,
              children: i.GetNameWithFallback(l),
            }),
            (0, a.jsxs)("div", {
              className: Je.SessionTime,
              children: [
                !m && (0, a.jsx)("div", { children: (0, f.TW)(c, !0) }),
                (0, a.jsx)("div", {
                  children: Boolean(t && m)
                    ? (0, f.we)(
                    ...
                    : (0, f.we)(
                        "#Conference_StartsAt",
                        (0, ze.KC)(c, { bForce24HourClock: !1 }),
                      ),
                }),
              ],
            }),
            (0, a.jsx)("div", {
              className: (0, E.A)(Je.ReminderContainer, Je.OnlyIcon),
              children: (0, a.jsx)(xe.j, {
                eventModel: i,
                lang: l,
                bOnlyShowIcon: !0,
      ...
      function nn(e) {
        ...
        const o = n[0],
          s = (0, r.sf)(d.TS.LANGUAGE),
          i = U.m.ParseEventModelPresenters(o, s);
        return (0, a.jsxs)("div", {
          className: Je.ActiveEventCtn,
          children: [
            (0, a.jsxs)("div", {
              className: Je.LiveNote,
              children: [
                (0, a.jsx)("div", { className: Je.LiveIcon }),
                "Live Now!",
              ],
            }),
            (0, a.jsx)("div", {
            ...
            (0, a.jsx)("div", {
              className: Je.EventDescription,
              children: o.GetSummaryWithFallback(s),
            }),
            (0, a.jsx)("div", {
              className: Je.ReadMoreBtn,
              onClick: () => t(o.GID, o.clanSteamID.GetAccountID()),
              children: (0, f.we)("#EventEmail_Button_ClickForMoreDetails"),
            }),
          ],
        });
      }
      function tn(e) {
        ...
        return 0 == r.length
          ? (0, a.jsx)("div", {
              children: (0, f.we)("#Conference_NoPastEvents"),
            })
          : (0, a.jsxs)("div", {
              className: Je.PastEventsCtn,
              children: [
                (0, a.jsx)(We, { displayLocation: 6, fnChangeModalEvent: i }),
                r.map((e) => {
                  const n = V.O3.GetClanEventModel(e.unique_id);
                  return (0, a.jsx)(
                    Le,
                    {
                      eventModel: n,
                      ...
                      mode: "wide",
                      fnOnClicked: () =>
                        i.Dispatch(n.GID, n.clanSteamID.GetAccountID()),
                    },
                    "row" + e.unique_id,
                  );
                }),
      ...
      function an(e) {
        return (0, a.jsx)(on, { ...e, children: (0, a.jsx)(tn, { ...e }) });
      }
      function on(e) {
        const { conferenceInfo: n } = e,
          t = (0, Qe.m)("WithCalendarStore"),
          [o, s] = (0, x.useState)(!0);
        return (
          (0, x.useEffect)(() => {
            t.token.reason ||
      ...
      function sn(e) {
        ...
        return (0, a.jsxs)(le.o0, {
          ...
          children: [
            (0, a.jsx)("div", {
              children: (0, f.we)("#Conference_NeedHelp_Desc1"),
            }),
            (0, a.jsxs)("div", {
              children: [
                (0, a.jsxs)("div", {
                  className: Je.HelpDialogDetailsCtn,
                  children: [
                    (0, a.jsx)("div", {
                      children: (0, f.we)(
                    ...
                    (0, a.jsxs)("ul", {
                      className: Je.HelpRequirements,
                      children: [
                        (0, a.jsx)("li", {
                          children: (0, f.we)("#Conference_NeedHelp_ChatA1"),
                        }),
                        (0, a.jsx)("li", {
                          children: (0, f.PP)(
                ...
                (0, a.jsxs)("div", {
                  ...
                  children: [
                    (0, a.jsx)("div", {
                      children: (0, f.we)("#Conference_NeedHelp_QandAQ"),
                    }),
                    (0, a.jsx)("ul", {
                      children: (0, a.jsx)("li", {
                        children: (0, f.we)("#Conference_NeedHelp_ChatA1"),
                ...
                (0, a.jsxs)("div", {
                  ...
                  children: [
                    ...
                    (0, a.jsx)("a", {
                      ...
                      children: (0, f.we)("#Conference_NeedHelp_CreateTicket"),
                    }),
                  ],
                }),
              ],
      ...
      function dn(e) {
        const { conferenceInfo: n, bShowYouTube: t } = e,
          [o, s] = x.useState(!1),
          i = (0, v.P_)(P.Kp.PerMinute) < n.rtStartTime - 30 * P.Kp.PerMinute;
        return (0, a.jsxs)("div", {
          className: rn.ConferenceHome,
          children: [
            (0, a.jsx)("div", {
              className: (0, E.A)(rn.LeftCol, o ? "Active" : "Hidden"),
              children: (0, a.jsxs)("div", {
                className: rn.AgendaCtn,
                children: [
                  (0, a.jsx)(Ze, { conferenceInfo: n }),
                  (0, a.jsxs)("div", {
                    className: rn.AgendaToggle,
                    onClick: () => {
                      s(!o);
                    },
                    children: [
                      ...
                      (0, a.jsx)(B.he, {
                        ...
                        children: (0, a.jsxs)("div", {
                          className: rn.CalendarBtn,
                          children: [
                            (0, a.jsx)(F.VvS, {}),
                            (0, a.jsx)("div", {
                              className: rn.CalendarText,
            ...
            (0, a.jsxs)("div", {
              className: rn.MainCol,
              children: [
                t &&
                  (0, a.jsx)(ln.A, {
                    videoID: n.youtubeVideoID,
                    classNameAlign: "",
                    classNameSize: cn.sizeFull,
                    bAutoPlay: !0,
                    bShowVideoImmediately: !0,
                  }),
                Boolean(i)
                  ? (0, a.jsx)("div", {
                      className: rn.InteractionCtn,
                      children: (0, a.jsx)("div", {
                        className: rn.PreEventNote,
                        children: (0, f.we)("#Conference_ChatHidden", 30),
                      }),
                    })
                  : (0, a.jsx)(mn, { conferenceInfo: n }),
              ],
            }),
          ],
        });
      ...
      function mn(e) {
        const { conferenceInfo: n } = e,
          [t, o] = x.useState(window.innerWidth > 910),
          [s, i] = x.useState(!0),
          r =
        ...
        return (0, a.jsxs)("div", {
          ...
          children: [
            (0, a.jsxs)("div", {
              ...
              children: [
                (0, a.jsxs)("div", {
                  ...
                  children: [
                    (0, a.jsx)("div", {
                      className: rn.TabTitle,
                      onClick: () => {
                        o(!0), i(!1);
                      },
                      children: (0, f.we)("#Conference_Tab_Chat"),
                    }),
                    (0, a.jsx)(B.he, {
                ...
                (0, a.jsxs)("div", {
                  ...
                  children: [
                    (0, a.jsx)("div", {
                      ...
                      children: (0, f.we)("#Conference_Tab_QandA"),
                    }),
                    (0, a.jsx)(B.he, {
            ...
            (0, a.jsxs)("div", {
              className: rn.ChatStack,
              children: [
                Boolean((t && s) || (!s && !t)) &&
                  (0, a.jsxs)(a.Fragment, {
                    children: [
                      (0, a.jsx)("div", {
                        className: rn.ChatColumn,
                        children: (0, a.jsx)(D, {
                          conferenceInfo: n,
                          className: rn.ChatCtn,
                        }),
                      }),
                      (0, a.jsx)("div", {
                        className: rn.QAColumn,
                ...
                Boolean(t && !s) &&
                  (0, a.jsx)(D, { conferenceInfo: n, className: rn.ChatCtn }),
                Boolean(!t && s) &&
      ...
      function un(e) {
        ...
        if (!n.faqAboutPage)
          return (0, a.jsx)("div", {
            children: (0, f.we)("#Conference_NoAbout"),
          });
      ...
      function vn(e) {
        const { conferenceInfo: n } = e;
        return (0, a.jsx)(an, { conferenceInfo: n });
      }
      var _n = t(61937);
      function hn(e) {
        const { strVanity: n } = e,
        ...
        return t
          ? (0, a.jsx)(_.tH, {
              children: (0, a.jsx)("div", {
                className: _n.ConferencePageCtn,
                children: (0, a.jsx)(pn, { conferenceInfo: t }),
              }),
            })
          : (0, a.jsx)("div", { children: (0, f.we)("#Conference_Invalid") });
      }
      function pn(e) {
        const { conferenceInfo: n } = e,
          t = (e) =>
        ...
        return (
          ...
          (0, a.jsxs)("div", {
            className: _n.ConferenceContentsCtn,
            children: [
              (0, a.jsxs)("div", {
                className: _n.ConferenceHeaderCtn,
                children: [
                  (0, a.jsx)(p.c, {
                    className: _n.LogoImage,
                    rgSources: n.strLocalizedLogos,
                  }),
                  (0, a.jsx)(p.c, {
                    className: _n.LogoImageMobile,
                    rgSources: n.strLocalizedMobileLogos,
                  }),
                  (0, a.jsx)("div", {
                    className: _n.ConferenceDateRange,
      ...
      const gn = function (e) {
        return (0, a.jsxs)(o.dO, {
          children: [
            (0, a.jsx)(o.qh, {
              path: fn.LandingPage(":vanity_str"),
              render: (e) =>
                (0, a.jsx)(s.X, {
                  config: {
                    "conference-root": () => {
    ...
    73964: (e, n, t) => {
      ...
      class l extends i.ZQ {
        async DeleteOldAnnouncement(e, n) {
          ...
          return this.RemoveGIDFromList(e, r.cB + n), i.data;
        }
        static Get() {
          return (
    ...
    81301: (e, n, t) => {
      ...
      let p = class extends i.Component {
        ...
        render() {
          const { event: e, langOverride: n, isPreview: t } = this.props;
          return (0, o.jsx)("div", {
            ref: this.m_refFocus,
            className: v.Main,
      ...
      (0, a.Cg)([u.oI], p.prototype, "escFunction", null),
        (0, a.Cg)([u.oI], p.prototype, "OnBackgroundClick", null),
        (p = (0, a.Cg)([s.PA], p));
    },
    74976: (e, n, t) => {
      "use strict";
      ...
      const d = new (class {
          ...
          ShouldTrack(e) {
            ...
            return !n || !n.m_bHasBeenTracked;
          }
          StartTracking(e, n) {
            if (e.bOldAnnouncement) return;
            let t = this.m_mapEvents.get(e.GID);
            t || ((t = new c()), this.m_mapEvents.set(e.GID, t)),
              t.m_bHasBeenTracked ||
                t.m_fnSubmit ||
                ((t.m_fnSubmit = new o.LU()),
                t.m_fnSubmit.Schedule(
                  this.m_nImpressionDelayMS,
                  this.ReportImpression.bind(this, e, n),
                ));
          }
          StopTracking(e) {
            const n = this.m_mapEvents.get(e.GID);
            n && n.m_fnSubmit && (n.m_fnSubmit.Cancel(), (n.m_fnSubmit = null));
          }
          ReportImpression(e, n) {
            s.KN.Get().RecordEventShown(e, 8),
              n && r.V.RecordViewedEvent((0, i.v0)(), e.GID);
        ...
        m = (e) => {
          const { event: n } = e;
          if (d.ShouldTrack(n)) {
            const t = () => d.StartTracking(n, e.recordNewsHubStats || !1),
              o = () => d.StopTracking(n);
            return (0, a.jsx)(l.Y, { onEnter: t, onLeave: o });
          }
          return null;
        };
    },
