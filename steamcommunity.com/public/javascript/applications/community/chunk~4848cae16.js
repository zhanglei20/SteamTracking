...
(self.webpackChunkcommunity = self.webpackChunkcommunity || []).push([
  [6920],
  {
    ...
    83392: (s, r, e) => {
      ...
      function _(s) {
        var r, e;
        const { as: i = "div", focusable: m, navProps: _, ref: u, ...y } = s,
          v = (0, t.mz)({ ...y, className: a()(s.className, c.Flex) }, d),
          f =
            null !== (r = null != m ? m : null == _ ? void 0 : _.focusable) &&
            void 0 !== r
              ? r
              : !!y.onClick,
          g = (0, p.jsx)(i, { ref: u, ...v }),
          N = (0, n.n)(null !== (e = y.direction) && void 0 !== e ? e : "row");
      ...
      function t(s, r) {
        return (function (s, r, e) {
          const p = [],
            i = {},
            t = {},
            { extracted: n, remaining: m } = a(s, r);
          for (const a of r) {
            if (!(a.prop in n)) continue;
            let r = n[a.prop];
            if (
              void 0 !== r &&
              (a.responsive && (r = (0, o.I)(r, e.formFactor)), void 0 !== r)
            ) {
              if (a.className) {
                if (
                  !a.cssProperty &&
              ...
              if (a.cssProperty)
                if ("function" == typeof a.cssProperty) {
                  const p = a.cssProperty(r, s, e.formFactor);
          ...
          return (
            ...
            "style" in m &&
              ...
              Object.assign(i, m.style),
            { ...t, ...m, className: p.join(" "), style: i }
          );
    ...
    39479: (s, r, e) => {
      ...
      function m(s) {
        var r;
        const { children: e, "flow-children": m, ...c } = s,
          { gamepadEvents: l } = (0, t.C7)(s);
        m && (c.layout = (0, a.O)(m)),
          l.onOKButton ||
            ("onClick" in e.props && e.props.onClick && (l.onOKButton = t._K));
        const { ref: _, node: d } = (0, t.qp)(c);
        (0, n.Ui)(l, _);
        const u = (0, o.Ue)(
          _,
