         ...
         */ (function (pt, ht) {
          ...
          function ht(a) {
            for (var t = 1; t < arguments.length; t++) {
              ...
              t % 2
                ? pt(Object(e), !0).forEach(function (i) {
                    vi(a, i, e[i]);
                  })
                : Object.getOwnPropertyDescriptors
                  ...
                  : pt(Object(e)).forEach(function (i) {
          ...
          function Bt(a, t) {
            for (var e = 0; e < t.length; e++) {
              ...
              (i.enumerable = i.enumerable || !1),
                ...
                Object.defineProperty(a, _t(i.key), i);
            }
          }
          function mi(a, t, e) {
            return (
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
          ...
          var ct =
            ...
            k = ct ? window : {},
            vt =
              ct && k.document.documentElement
                ? "ontouchstart" in k.document.documentElement
                : !1,
            wt = ct ? "PointerEvent" in k : !1,
            b = "cropper",
            bt = "all",
            Pt = "crop",
            Yt = "move",
            ...
            rt = "sw",
            yt = "".concat(b, "-crop"),
            zt = "".concat(b, "-disabled"),
            N = "".concat(b, "-hidden"),
            Ht = "".concat(b, "-hide"),
            Ei = "".concat(b, "-invisible"),
            lt = "".concat(b, "-modal"),
            xt = "".concat(b, "-move"),
            nt = "".concat(b, "Action"),
            ft = "".concat(b, "Preview"),
            ...
            Ct = "cropstart",
            jt = "dblclick",
            Mi = vt ? "touchstart" : "mousedown",
            Ti = vt ? "touchmove" : "mousemove",
            Ci = vt ? "touchend touchcancel" : "mouseup",
            Vt = wt ? "pointerdown" : Mi,
            Gt = wt ? "pointermove" : Ti,
            $t = wt ? "pointerup pointercancel" : Ci,
            qt = "ready",
            Ft = "resize",
            Kt = "wheel",
            Ot = "zoom",
            Qt = "image/jpeg",
            Oi = /^e|w|s|n|se|sw|ne|nw|all|crop|move|zoom$/,
            Ni = /^data:/,
            Ai = /^data:image\/jpeg;base64,/,
            Si = /^img|canvas$/i,
            Zt = 200,
            Jt = 100,
            ti = {
              ...
              minCropBoxWidth: 0,
              minCropBoxHeight: 0,
              minContainerWidth: Zt,
              minContainerHeight: Jt,
              ready: null,
              cropstart: null,
              cropmove: null,
              cropend: null,
          ...
          function ei(a) {
            return Array.from ? Array.from(a) : Bi.call(a);
          }
          function D(a, t) {
            return (
              a &&
                A(t) &&
                (Array.isArray(a) || p(a.length)
                  ? ei(a).forEach(function (e, i) {
                      t.call(a, e, i, a);
                    })
                  : G(a) &&
          ...
          function H(a, t) {
            var e = a.style;
            D(t, function (i, o) {
              _i.test(o) && p(i) && (i = "".concat(i, "px")), (e[o] = i);
            });
          }
          function Pi(a, t) {
            return a.classList
              ? a.classList.contains(t)
              : a.className.indexOf(t) > -1;
          }
          function C(a, t) {
            if (t) {
              if (p(a.length)) {
          ...
          function St(a, t) {
            return G(a[t])
              ...
              : a.dataset
                ? a.dataset[t]
                : a.getAttribute("data-".concat(At(t)));
          }
          function ot(a, t, e) {
            G(e)
              ? (a[t] = e)
              : a.dataset
                ? (a.dataset[t] = e)
                : a.setAttribute("data-".concat(At(t)), e);
          }
          function Xi(a, t) {
            if (G(a[t]))
              try {
            ...
            else a.removeAttribute("data-".concat(At(t)));
          }
          var ai = /\s\s*/,
            ri = (function () {
              var a = !1;
              if (ct) {
                ...
                k.addEventListener("test", e, i),
                  k.removeEventListener("test", e, i);
              }
              return a;
            })();
          function B(a, t, e) {
              ...
              .forEach(function (r) {
                if (i.once && !ri) {
                  ...
                  (o = function () {
                    ...
                    for (
                      var l = arguments.length, h = new Array(l), c = 0;
                      c < l;
                      c++
                    )
                      h[c] = arguments[c];
          ...
          function oi(a) {
            ...
            return (
              t !== null &&
              (t[1] !== Rt.protocol || t[2] !== Rt.hostname || t[3] !== Rt.port)
            );
          }
          function si(a) {
          ...
          function st(a) {
            var t = a.rotate,
              ...
              r = a.translateY,
              n = [];
            p(o) && o !== 0 && n.push("translateX(".concat(o, "px)")),
              p(r) && r !== 0 && n.push("translateY(".concat(r, "px)")),
              p(t) && t !== 0 && n.push("rotate(".concat(t, "deg)")),
              p(e) && e !== 1 && n.push("scaleX(".concat(e, ")")),
              p(i) && i !== 1 && n.push("scaleY(".concat(i, ")"));
          ...
          function Hi(a) {
            ...
            return (
              D(a, function (i, o) {
                delete t[o],
                  D(t, function (r) {
                    var n = Math.abs(i.startX - r.startX),
                      s = Math.abs(i.startY - r.startY),
                      d = Math.abs(i.endX - r.endX),
          ...
          function dt(a, t) {
            var e = a.pageX,
              i = a.pageY,
              o = { endX: e, endY: i };
            return t ? o : ht({ startX: e, startY: i }, o);
          }
          function Wi(a) {
            var t = 0,
              e = 0,
          ...
          function Ui(a) {
            ...
            var o = ((i % 90) * Math.PI) / 180,
              ...
              s = t * n + e * r,
              d = t * r + e * n;
            return i > 90 ? { width: d, height: s } : { width: s, height: d };
          }
          function ji(a, t, e, i) {
            var o = t.aspectRatio,
              r = t.naturalWidth,
              ...
              S = P.getContext("2d"),
              F = W({ aspectRatio: m, width: w, height: L }),
              ut = W({ aspectRatio: m, width: $, height: U }, "cover"),
              It = Math.min(F.width, Math.max(ut.width, g)),
              Lt = Math.min(F.height, Math.max(ut.height, x)),
              li = W({ aspectRatio: o, width: w, height: L }),
              fi = W({ aspectRatio: o, width: $, height: U }, "cover"),
              di = Math.min(li.width, Math.max(fi.width, r)),
              ui = Math.min(li.height, Math.max(fi.height, n)),
              re = [-di / 2, -ui / 2, di, ui];
            return (
              (P.width = Z(It)),
              (P.height = Z(Lt)),
              (S.fillStyle = M),
              S.fillRect(0, 0, It, Lt),
              S.save(),
              S.translate(It / 2, Lt / 2),
              S.rotate((d * Math.PI) / 180),
              S.scale(h, f),
              (S.imageSmoothingEnabled = E),
              (S.imageSmoothingQuality = R),
              S.drawImage.apply(
                S,
                [a].concat(
                  kt(
                    re.map(function (ne) {
                      return Math.floor(Z(ne));
                    }),
                  ),
                ),
              ),
          ...
          function Vi(a, t, e) {
            var i = "";
            e += t;
            for (var o = t; o < e; o += 1) i += hi(a.getUint8(o));
            return i;
          }
          var Gi = /^data:.*,/;
          function $i(a) {
          ...
          function qi(a, t) {
            for (var e = [], i = 8192, o = new Uint8Array(a); o.length > 0; )
              e.push(hi.apply(null, ei(o.subarray(0, i)))), (o = o.subarray(i));
            ...
            try {
              ...
              if (o) {
                ...
                if (Vi(t, d, 4) === "Exif") {
                  ...
                  if (
                    ((i = h === 18761),
                    (i || h === 19789) && t.getUint16(l + 2, i) === 42)
                  ) {
          ...
          var Qi = {
              ...
              initContainer: function () {
                ...
                C(o, N), _(t, N);
                var s = {
                  width: Math.max(i.offsetWidth, r >= 0 ? r : Zt),
                  height: Math.max(i.offsetHeight, n >= 0 ? n : Jt),
                };
                (this.containerData = s),
                  H(o, { width: s.width, height: s.height }),
                  C(t, N),
                  _(o, N);
              },
              initCanvas: function () {
                var t = this.containerData,
                  ...
                  r = o ? e.naturalHeight : e.naturalWidth,
                  n = o ? e.naturalWidth : e.naturalHeight,
                  s = r / n,
                  d = t.width,
                  l = t.height;
                t.height * s > t.width
                      ...
                      (h
                        ...
                        : c
                          ...
                          : l &&
                            ...
                            (c = n.height),
                            c * d > h ? (h = c * d) : (c = h / d)));
                  var f = W({ aspectRatio: d, width: h, height: c });
                  (h = f.width),
                    (c = f.height),
                    (r.minWidth = h),
                    (r.minHeight = c),
                ...
                (i.width > i.maxWidth || i.width < i.minWidth) &&
                  ...
                  H(
                    ...
                    y(
                      ...
                      st({ translateX: i.left, translateY: i.top }),
                    ),
                  ),
                  this.renderImage(t),
              ...
              renderImage: function (t) {
                var e = this.canvasData,
                  i = this.imageData,
                  o = i.naturalWidth * (e.width / e.naturalWidth),
                ...
                y(i, {
                  ...
                  H(
                    ...
                    y(
                      { width: i.width, height: i.height },
                      st(y({ translateX: i.left, translateY: i.top }, i)),
                    ),
                  ),
                  t && this.output();
              },
                ...
                e &&
                  (s
                    ? ((n.minLeft = Math.max(0, r.left)),
                      ...
                      (n.maxLeft =
                        Math.min(o.width, r.left + r.width) - n.width),
                      (n.maxTop =
                        Math.min(o.height, r.top + r.height) - n.height))
                    : ((n.minLeft = 0),
                      (n.minTop = 0),
                ...
                (i.width > i.maxWidth || i.width < i.minWidth) &&
                  ...
                  t.movable &&
                    ...
                    ot(
                      this.face,
                      nt,
                      i.width >= e.width && i.height >= e.height ? Yt : bt,
                    ),
                  H(
                    this.cropBox,
                    y(
            ...
            Zi = {
              initPreview: function () {
                var t = this.element,
                  ...
                  o = e ? this.crossOriginUrl : this.url,
              ...
              resetPreview: function () {
                D(this.previews, function (t) {
                  var e = St(t, ft);
                  H(t, { width: e.width, height: e.height }),
                    (t.innerHTML = e.html),
                    Xi(t, ft);
                });
              },
              preview: function () {
                ...
                !this.cropped ||
                  ...
                  (H(
                    ...
                    y(
                      { width: n, height: s },
                      st(y({ translateX: -d, translateY: -l }, t)),
                    ),
                  ),
                  D(this.previews, function (h) {
                    var c = St(h, ft),
                      f = c.width,
                      m = c.height,
                      g = f,
                      ...
                      v = 1;
                    o && ((v = f / o), (x = r * v)),
                      r && x > m && ((v = m / r), (g = o * v), (x = m)),
                      H(h, { width: g, height: x }),
                      H(
                        h.getElementsByTagName("img")[0],
                        y(
                          { width: n * v, height: s * v },
                          st(y({ translateX: -d * v, translateY: -l * v }, t)),
                        ),
                      );
                  }));
              },
            ...
            Ji = {
              bind: function () {
                var t = this.element,
                  e = this.options,
                  i = this.cropper;
                A(e.cropstart) && I(t, Ct, e.cropstart),
                  A(e.cropmove) && I(t, Tt, e.cropmove),
                  A(e.cropend) && I(t, Mt, e.cropend),
                  A(e.crop) && I(t, Et, e.crop),
                  A(e.zoom) && I(t, Ot, e.zoom),
                  I(i, Vt, (this.onCropStart = this.cropStart.bind(this))),
                  e.zoomable &&
                    e.zoomOnWheel &&
                    I(i, Kt, (this.onWheel = this.wheel.bind(this)), {
                      passive: !1,
                      capture: !0,
                    }),
                  e.toggleDragModeOnDblclick &&
                    I(i, jt, (this.onDblclick = this.dblclick.bind(this))),
                  I(
                    t.ownerDocument,
                    Gt,
                  ...
                  e.responsive &&
                    I(window, Ft, (this.onResize = this.resize.bind(this)));
              },
              unbind: function () {
                var t = this.element,
                  e = this.options,
                  i = this.cropper;
                A(e.cropstart) && B(t, Ct, e.cropstart),
                  A(e.cropmove) && B(t, Tt, e.cropmove),
                  A(e.cropend) && B(t, Mt, e.cropend),
                  A(e.crop) && B(t, Et, e.crop),
                  A(e.zoom) && B(t, Ot, e.zoom),
                  B(i, Vt, this.onCropStart),
                  e.zoomable &&
                    e.zoomOnWheel &&
                    B(i, Kt, this.onWheel, { passive: !1, capture: !0 }),
                  e.toggleDragModeOnDblclick && B(i, jt, this.onDblclick),
                  B(t.ownerDocument, Gt, this.onCropMove),
                  B(t.ownerDocument, $t, this.onCropEnd),
                  e.responsive && B(window, Ft, this.onResize);
              },
            },
            te = {
              resize: function () {
                if (!this.disabled) {
                  var t = this.options,
                    ...
                    o = e.offsetWidth / i.width,
                    r = e.offsetHeight / i.height,
                    n = Math.abs(o - 1) > Math.abs(r - 1) ? o : r;
                  if (n !== 1) {
                    var s, d;
                    t.restore &&
                      ((s = this.getCanvasData()), (d = this.getCropBoxData())),
                      this.render(),
                      t.restore &&
                        (this.setCanvasData(
                          D(s, function (l, h) {
              ...
              dblclick: function () {
                this.disabled ||
                  this.options.dragMode === Ut ||
                  this.setDragMode(Pi(this.dragBox, yt) ? Wt : Dt);
              },
              wheel: function (t) {
                var e = this,
              ...
              cropStart: function (t) {
                ...
                if (
                  ...
                  var o = this.options,
                    ...
                    n;
                  t.changedTouches
                    ? D(t.changedTouches, function (s) {
                        r[s.identifier] = dt(s);
                      })
                    : (r[t.pointerId || 0] = dt(t)),
                    Object.keys(r).length > 1 && o.zoomable && o.zoomOnTouch
                      ? (n = Xt)
                      : (n = St(t.target, nt)),
                    Oi.test(n) &&
                      tt(this.element, Ct, { originalEvent: t, action: n }) !==
                        !1 &&
                      (t.preventDefault(),
                      (this.action = n),
                      (this.cropping = !1),
                      n === Pt && ((this.cropping = !0), C(this.dragBox, lt)));
                }
              },
              cropMove: function (t) {
                var e = this.action;
                if (!(this.disabled || !e)) {
                  var i = this.pointers;
                  t.preventDefault(),
                    tt(this.element, Tt, { originalEvent: t, action: e }) !==
                      !1 &&
                      (t.changedTouches
                        ? D(t.changedTouches, function (o) {
                            y(i[o.identifier] || {}, dt(o, !0));
                          })
                        : y(i[t.pointerId || 0] || {}, dt(t, !0)),
                      this.change(t));
                }
              },
              cropEnd: function (t) {
                if (!this.disabled) {
                  ...
                  t.changedTouches
                    ...
                    e &&
                      ...
                      tt(this.element, Mt, { originalEvent: t, action: e }));
                }
              },
            },
            ie = {
              change: function (t) {
                var e = this.options,
                  ...
                  E = !0,
                  Y;
                !d && t.shiftKey && (d = c && f ? c / f : 1),
                  this.limited &&
                    ((x = r.minLeft),
                    (v = r.minTop),
                    (M = x + Math.min(o.width, i.width, i.left + i.width)),
                    (O = v + Math.min(o.height, i.height, i.top + i.height)));
                ...
                switch (s) {
                  ...
                  case j:
                    ...
                    w(j),
                      (c += u.x),
                      c < 0 && ((s = V), (c = -c), (l -= c)),
                      d && ((f = c / d), (h += (r.height - f) / 2));
                    break;
                  case z:
                    if (u.y <= 0 && (h <= v || (d && (l <= x || m >= M)))) {
                      E = !1;
                      break;
                    }
                    w(z),
                      ...
                      (h += u.y),
                      f < 0 && ((s = K), (f = -f), (h -= f)),
                      d && ((c = f * d), (l += (r.width - c) / 2));
                    break;
                  case V:
                    if (u.x <= 0 && (l <= x || (d && (h <= v || g >= O)))) {
                      E = !1;
                      break;
                    }
                    w(V),
                      ...
                      w(K),
                        ...
                        u.x <= 0
                          ? l > x
                            ...
                            : u.y >= 0 && g >= O && (E = !1)
                          : ((c -= u.x), (l += u.x)),
                        u.y >= 0 ? g < O && (f += u.y) : (f += u.y);
                    c < 0 && f < 0
                      ? ((s = it), (f = -f), (c = -c), (h -= f), (l -= c))
                      : c < 0
                        ? ((s = at), (c = -c), (l -= c))
                        : f < 0 && ((s = et), (f = -f), (h -= f));
                    break;
                  case at:
                    if (d) {
                      ...
                      w(K),
                        ...
                        u.y >= 0 ? g < O && (f += u.y) : (f += u.y);
                    c < 0 && f < 0
                      ? ((s = et), (f = -f), (c = -c), (h -= f), (l -= c))
                      : c < 0
                        ? ((s = rt), (c = -c), (l -= c))
                        : f < 0 && ((s = it), (f = -f), (h -= f));
                    break;
                  case Yt:
                    this.move(u.x, u.y), (E = !1);
                    break;
                  case Xt:
                    this.zoom(Hi(n), t), (E = !1);
                    break;
                  case Pt:
                    if (!u.x || !u.y) {
                      E = !1;
            ...
            ee = {
              crop: function () {
                return (
                  this.ready &&
                    ...
                    ((this.cropped = !0),
                    this.limitCropBox(!0, !0),
                    this.options.modal && C(this.dragBox, lt),
                    _(this.cropBox, N),
              ...
              enable: function () {
                return (
                  this.ready &&
                    this.disabled &&
                    ((this.disabled = !1), _(this.cropper, zt)),
                  this
                );
              },
              disable: function () {
                return (
                  this.ready &&
                    !this.disabled &&
                    ((this.disabled = !0), C(this.cropper, zt)),
                  this
                );
              },
              destroy: function () {
              ...
              zoomTo: function (t, e, i) {
                ...
                if (
                  ((t = Number(t)),
                  t >= 0 && this.ready && !this.disabled && o.zoomable)
                ) {
                  var h = d * t,
                    c = l * t;
                  if (
              ...
              getData: function () {
                ...
                return (
                  e.rotatable && (n.rotate = i.rotate || 0),
                  e.scalable &&
                    ((n.scaleX = i.scaleX || 1), (n.scaleY = i.scaleY || 1)),
                  n
                );
              },
              setData: function (t) {
                ...
                if (this.ready && !this.disabled && Q(t)) {
                  ...
                  var s = i.width / i.naturalWidth;
                  p(t.x) && (r.left = t.x * s + o.left),
                    p(t.y) && (r.top = t.y * s + o.top),
                    p(t.width) && (r.width = t.width * s),
                    p(t.height) && (r.height = t.height * s),
              ...
              getCroppedCanvas: function () {
                ...
                var e = this.canvasData,
                  i = ji(this.image, this.imageData, e, t);
                ...
                var h = s / d,
                  ...
                  g = m.width,
                  x = m.height;
                (g = Math.min(c.width, Math.max(f.width, g))),
                  (x = Math.min(c.height, Math.max(f.height, x)));
                ...
                (v.width = Z(g)),
                  ...
                  M.fillRect(0, 0, g, x);
                var O = t.imageSmoothingEnabled,
                  E = O === void 0 ? !0 : O,
                  Y = t.imageSmoothingQuality;
                (M.imageSmoothingEnabled = E),
                  Y && (M.imageSmoothingQuality = Y);
                var R = i.width,
                  u = i.height,
                  w = r,
                  T = n,
                ...
                w <= -s || w > R
                  ? ((w = 0), (L = 0), ($ = 0), (U = 0))
                  : w <= 0
                    ? (($ = -w), (w = 0), (L = Math.min(R, s + w)), (U = L))
                    : w <= R && (($ = 0), (L = Math.min(s, R - w)), (U = L)),
                  L <= 0 || T <= -d || T > u
                    ? ((T = 0), (X = 0), (q = 0), (P = 0))
                    : T <= 0
                      ? ((q = -T), (T = 0), (X = Math.min(u, d + T)), (P = X))
                      : T <= u && ((q = 0), (X = Math.min(d, u - T)), (P = X));
                var S = [w, T, L, X];
                if (U > 0 && P > 0) {
                  var F = g / s;
                  S.push($ * F, q * F, U * F, P * F);
                }
                return (
                  M.drawImage.apply(
                    M,
                    ...
                    },
                    {
                      ...
                      value: function (e) {
                        ...
                        if (e) {
                          ...
                          if (Ni.test(e)) {
                            Ai.test(e) ? this.read($i(e)) : this.clone();
                            return;
                          }
                          ...
                          (this.reloading = !0),
                            ...
                            (n.onprogress = function () {
                              n.getResponseHeader("content-type") !== Qt &&
                                n.abort();
                            }),
                            (n.onload = function () {
                              i.read(n.response);
                    ...
                    },
                    {
                      ...
                      value: function (e) {
                        ...
                        i.rotatable && (o.rotate = n),
                          i.scalable && ((o.scaleX = s), (o.scaleY = d)),
                          this.clone();
                      },
                    },
                    {
                      ...
                      value: function () {
                        ...
                        this.options.checkCrossOrigin &&
                          oi(i) &&
                          (o || (o = "anonymous"), (r = si(i))),
                          (this.crossOrigin = o),
                          (this.crossOriginUrl = r);
                        var n = document.createElement("img");
                        o && (n.crossOrigin = o),
                          (n.src = r || i),
                          (n.alt = e.alt || "The image to crop"),
                          (this.image = n),
                        ...
                        var o =
                          ...
                          r = function (l, h) {
                            y(e.imageData, {
                              ...
                              (e.initialImageData = y({}, e.imageData)),
                              (e.sizing = !1),
                              (e.sized = !0),
                              e.build();
                          };
                    ...
                    },
                    {
                      ...
                      value: function () {
                        if (!(!this.sized || this.ready)) {
                          ...
                          n.innerHTML = Ri;
                          var s = n.querySelector(".".concat(b, "-container")),
                            d = s.querySelector(".".concat(b, "-canvas")),
                            l = s.querySelector(".".concat(b, "-drag-box")),
                            h = s.querySelector(".".concat(b, "-crop-box")),
                            c = h.querySelector(".".concat(b, "-face"));
                          (this.container = r),
                            (this.cropper = s),
                            (this.canvas = d),
                            (this.dragBox = l),
                            (this.cropBox = h),
                            (this.viewBox = s.querySelector(
                              ".".concat(b, "-view-box"),
                            )),
                            (this.face = c),
                            d.appendChild(o),
                            ...
                            i.background && C(s, "".concat(b, "-bg")),
                            i.highlight || C(c, Ei),
                            i.cropBoxMovable && (C(c, xt), ot(c, nt, bt)),
                            i.cropBoxResizable ||
                              (C(
                                h.getElementsByClassName("".concat(b, "-line")),
                                N,
                              ),
                              C(
                                h.getElementsByClassName(
                            ...
                            this.setData(i.data),
                            A(i.ready) && I(e, qt, i.ready, { once: !0 }),
                            tt(e, qt);
                        }
                      },
                    },
                    {
                      ...
                      value: function () {
                        if (this.ready) {
                          ...
                          e && e.removeChild(this.cropper), _(this.element, N);
                        }
                      },
                    },
                    {
          ...
          return y(ci.prototype, Qi, Zi, Ji, te, ie, ee), ci;
        });
      },
    },
  ]);
