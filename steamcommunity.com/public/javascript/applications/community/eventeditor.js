  ...
  [6662],
  {
    ...
    47861: (e, t, a) => {
      ...
      const se = "email_headline_",
        ...
        Ee = "sale_white_supplies_last_bbcode_",
        ...
        Ue = "mediacontent_sutitle_",
        ze = "mediacontent_desc_",
        qe = "meetsteam_",
        Ve = qe + "title_",
        We = qe + "desc_",
        Qe = qe + "faq_",
                        ...
                        if (
                          ...
                          "vo_internal" == t.section_type &&
                            ...
                            t.internal_section_data.while_supplies_last_option.forEach(
                              (i) => {
                                if (
                                  n === Ee + t.unique_id + "_" + i.unique_id &&
                                  (c ||
                          ...
                          (null ===
                            (E =
                              null === (S = t.quest) || void 0 === S
                                ? void 0
                                : S.door_info) || void 0 === E
                            ? void 0
                            : E.length) > 0 &&
                            (null === (x = t.quest) ||
                              void 0 === x ||
                              x.door_info.forEach((i) => {
                                if (
                                  n ===
      ...
      function It(e) {
        ...
        if (
          ...
          return null;
        let o = (0, i.jsx)("span", {
          className: (0, B.A)(Dt().BuildDisplay, Dt().BuildUnlinked),
          children: (0, L.we)("#EventEditor_AssociateBuildBlank"),
        });
        if (n) {
          const e = (0, i.jsx)("a", {
            className: (0, B.A)(Dt().BuildIDLink),
          ...
          o = s
            ? (0, i.jsx)("span", {
                className: (0, B.A)(Dt().BuildDisplay, Dt().BuildLinkedBranch),
                children: (0, L.PP)("#EventEditor_AssociatedBuild", e, s),
              })
            : (0, i.jsx)("span", {
                className: (0, B.A)(Dt().BuildDisplay, Dt().BuildLinkedDefault),
      ...
      const Gt = (0, _.PA)((e) => {
        ...
        return (0, i.jsx)(It, {
          ...
          children: (0, i.jsx)(E.$n, {
            onClick: (t) =>
              (0, y.pg)(
                (0, i.jsx)(Nt, { editModel: e.editModel }),
                (0, k.uX)(t),
              ),
      ...
      function At(e) {
        const t = new Date(1e3 * e.date).toLocaleDateString((0, Tt.J)());
        return e.branch
          ? (0, L.we)(
      ...
      let Bt = class extends n.Component {
        ...
        render() {
          ...
          let _ = t.GetNameWithFallback(c);
          const u = t.BHasSubTitle(c),
            h = !0,
            m = t.BHasSaleEnabled(),
            v = t.visibility_state != p.zv.k_EEventStateUnpublished,
            E = t.visibility_state != p.zv.k_EEventStateVisible,
            x = t.visibility_state == p.zv.k_EEventStateUnlisted;
          let b;
          const w = t.BShowLibrarySpotlight(!0);
          let C;
          if (
            (v &&
              E &&
          ...
          return (0, i.jsx)(xt.tH, {
            children: (0, i.jsxs)("div", {
              className: (0, B.A)({
                [_t.TileContainer]: !0,
                [_t.TileAgeAppropriate]: h,
                [_t.TileAgeNotAppropriate]: !1,
                [_t.ShowEventMetaDataSizes]: o,
                [_t.ShowLibrarySpotlight]: w,
              }),
              children: [
                w &&
                  (0, i.jsxs)("div", {
                        ...
                        children: [
                          ...
                          o &&
                            (0, i.jsx)(T.E, {
                              ...
                              children: (0, i.jsx)(Ot, { eventModel: t }),
                            }),
                        ],
                      }),
                    }),
      ...
      function kt(e) {
        ...
        let s = [(0, wt.m0)(a, "capsule", n)];
        return (0, i.jsx)("div", {
          className: _t.TileImageCtn,
          onClick: (e) => t(e),
          children: (0, i.jsx)(Ct.o, { className: _t.TileImage, srcs: s }),
        });
      }
      (0, K.Cg)([R.oI], Bt.prototype, "OnFallbackClick", null),
        (0, K.Cg)([R.oI], Bt.prototype, "OnGotoPage", null),
        (0, K.Cg)([R.oI], Bt.prototype, "OnIgnoreFallbackClick", null),
        (Bt = (0, K.Cg)([_.PA], Bt));
      let Lt = class extends n.Component {
        OnIgnoreFallbackClick(e) {
          e.stopPropagation();
        }
        OnPublishEvent(e) {
      ...
      (0, K.Cg)([R.oI], Lt.prototype, "OnIgnoreFallbackClick", null),
        (0, K.Cg)([R.oI], Lt.prototype, "OnPublishEvent", null),
        (0, K.Cg)([R.oI], Lt.prototype, "OnPublishSuccess", null),
        (0, K.Cg)([R.oI], Lt.prototype, "StopPropagation", null),
        (0, K.Cg)([R.oI], Lt.prototype, "OnDeleteClickAndVerify", null),
        (Lt = (0, K.Cg)([_.PA], Lt));
      const Ot = (e) => {
        var t, a;
        const { eventModel: n } = e;
        if (!(null == n ? void 0 : n.jsondata)) return null;
        const s = Rt(n.jsondata, 3);
      ...
      const Ft = (0, _.PA)((e) => {
        const { match: t } = e,
          ...
          U = n.useMemo(() => c().CancelToken.source(), []),
          {
            bIsFetching: z,
            nHiddenEventCount: q,
            rgEventModels: V,
        ...
        n.useEffect(
          () => (Y(), ae(), () => U.cancel("EventListView to unload")),
          [U, ae, Y],
        );
        ...
        n.useEffect(() => {
          const e = se
            ...
            .map((e) => e.GID);
          e.length > 0 && S.Uq.LoadStatsForEvents(F, e, U);
        }, [U, F, se]),
          n.useEffect(() => {
            if ("error" == ee) {
              const e = (0, N.H)(te);
        ...
        const re = oe(p.zv.k_EEventStateUnpublished, z ? q : 0),
        ...
        render() {
          ...
          if ("view" === e) {
            ...
            return e.BHasSaleEnabled()
              ...
              : (0, i.jsx)(n.Fragment, {
                  children: (0, i.jsx)(zt.jA, {
                    event: e,
                    lang: t,
                    partnerEventStore: o.mh,
                    emoticonStore: Qt.A,
                    adminPanel: (0, i.jsx)(Vt.g, {
                      eventModel: e,
                      partnerEventStore: o.mh,
                    }),
                    otherEventRow: (0, i.jsx)(Wt.r, {
                      clanAccountID: e.clanSteamID.GetAccountID(),
                      trackingLocation: Yt.Tc.My,
                ...
                children: [
                  ...
                  (0, i.jsxs)("div", {
                    children: [
                      (0, i.jsx)("img", {
                        style: { width: "50%" },
                        src: `${ha.zU.GetBaseURL()}31721797/2ef00d65527edf9aecdaddee086b0f5ee0cc2fe6.jpg`,
                      }),
                      (0, i.jsx)("img", {
                        style: { width: "50%" },
                        src: `${ha.zU.GetBaseURL()}7614223/fe3aa1776d96e4aa215edbdacc363a9ed005213e.png`,
                      }),
                      (0, i.jsx)("img", {
                        style: { width: "50%" },
                        src: `${ha.zU.GetBaseURL()}27000850/dc17534edaabe8d351fdfb1c6186c4eb3e637c8d.png`,
                      }),
                      (0, i.jsx)("img", {
                        style: { width: "50%" },
                        src: `${ha.zU.GetBaseURL()}31013613/a98ecca7730e4857cb5f83e50f3304ce13bf56bf.jpg`,
                      }),
                    ],
                  }),
                ],
            ...
            : "background" === e.artworkType
              ? (t = (0, i.jsxs)(n.Fragment, {
                  children: [
                    ...
                    (0, i.jsx)("img", {
                      style: { width: "100%" },
                      src: `${ha.zU.GetBaseURL()}3703047/72feb03fa4eced13596f0ff7b9ec434865cb73e4.png`,
                    }),
                    (0, i.jsx)("img", {
                      style: { width: "100%" },
                      src: `${ha.zU.GetBaseURL()}5193306/62436147b454715822a198a2767e5c7a8560617e.jpg`,
                    }),
                    (0, i.jsx)("img", {
                      style: { width: "100%" },
                      src: `${ha.zU.GetBaseURL()}31721797/77cbe3f768e16b149c78f127b09c047826646ba5.png`,
                    }),
                  ],
                }))
                  ...
                  (0, i.jsxs)("div", {
                    ...
                    children: [
                      (0, i.jsxs)("div", {
                        ...
                        children: [
                          (0, i.jsx)("a", {
                            href: `${ha.zU.GetBaseURL()}4/a7dcfaf476e3351bb34b8af3e423a6e6cd652a04.jpg`,
                            target: "_blank",
                            children: (0, i.jsx)("img", {
                              src: `${ha.zU.GetBaseURL()}4/a7dcfaf476e3351bb34b8af3e423a6e6cd652a04.jpg`,
                            }),
                          }),
                          (0, i.jsx)("a", {
                            href: `${ha.zU.GetBaseURL()}4/502e9a6d3bb266b4274a946192bb960f15e1d136.png`,
                            target: "_blank",
                            children: (0, i.jsx)("img", {
                              src: `${ha.zU.GetBaseURL()}4/502e9a6d3bb266b4274a946192bb960f15e1d136.png`,
                            }),
                          }),
                        ],
                      }),
                      (0, i.jsx)("div", {
                        className: ca().SaleHeaderExampleCol,
                        children: (0, i.jsx)("a", {
                          href: `${ha.zU.GetBaseURL()}4/0b6edf0575cc418172fc9d7614ae5c2881d1dcc0.jpg`,
                          target: "_blank",
                          children: (0, i.jsx)("img", {
                            src: `${ha.zU.GetBaseURL()}4/0b6edf0575cc418172fc9d7614ae5c2881d1dcc0.jpg`,
                          }),
                        }),
                      }),
                    ],
            ...
            : "product_banner" === e.artworkType &&
              (t = (0, i.jsxs)(n.Fragment, {
                children: [
                  ...
                  (0, i.jsx)("img", {
                    style: { width: "100%" },
                    src: `${ha.zU.GetBaseURL()}4/8298b4d6ebf6f6dd2355054431d339ec9dcafdef.jpg`,
                  }),
                  (0, i.jsx)("img", {
                    style: { width: "100%" },
                    src: `${ha.zU.GetBaseURL()}4/cc803d270bf7f47ee508bbadf14577bbfe5f6500.jpg`,
                  }),
                  (0, i.jsx)("img", {
                    style: { width: "100%" },
                    src: `${ha.zU.GetBaseURL()}4/309cb650beb92e00ae352710387832aea78433ef.jpg`,
                  }),
                  (0, i.jsx)("img", {
                    style: { width: "100%" },
                    src: `${ha.zU.GetBaseURL()}4/ecd819245dd4aca57aed76f714a28b2356ad90f2.jpg`,
                  }),
                  (0, i.jsx)("img", {
                    style: { width: "100%" },
                    src: `${ha.zU.GetBaseURL()}4/7375e5c0f2adb7241870acfa931e167ff13c669f.gif`,
                  }),
                ],
              }));
          return t
      ...
      function Ta(e) {
        const { editModel: t } = e,
          a = t.GetEventModel(),
          s = (0, aa.q3)(() => a.jsondata.bAutoUpdateVanityURLForContentHub),
          o = (0, aa.q3)(() => a.jsondata.sale_defines_specific_contenthub),
          l = (0, aa.q3)(() => a.jsondata.sale_defines_temporary_contenthub),
          r = (0, aa.q3)(() => a.BContentHubDiscountedOnly()),
          d = (0, aa.q3)(() => a.jsondata.content_hub_restricted_width),
          c = (0, aa.q3)(() => a.jsondata.ignore_item_browser_overrides),
          _ = (0, aa.q3)(() => a.jsondata.contenthub_override_artwork),
          u = (0, aa.q3)(() => a.jsondata.contenthub_override_section_styles),
          p = (0, aa.q3)(() => a.jsondata.contenthub_override_tab_styles),
          h = (0, aa.q3)(() => a.jsondata.contenthub_override_tab_definitions),
          m = (0, aa.q3)(
          ...
          g = (0, aa.q3)(() => a.jsondata.contenthub_disable_overrides),
          S = (0, aa.q3)(
      ...
      function Ia(e) {
        const { editModel: t } = e,
          a = t.GetEventModel(),
          s = (0, aa.q3)(() => a.GetContentHubType()),
          o = (0, aa.q3)(() => a.GetContentHubCategory()),
          l = (0, aa.q3)(() => a.GetContentHubTag()),
          { contentHubNames: r } = (0, xa._)(),
          d = (0, n.useMemo)(
      ...
      function Ga(e) {
        const { editModel: t } = e,
          a = t.GetEventModel(),
          s = (0, aa.q3)(() => a.jsondata.prune_list_optin_name),
          o = (0, aa.q3)(() => a.jsondata.optin_only),
          { rgOptIns: l } = (0, ja.Zs)(),
          r = (0, n.useMemo)(
            () =>
              l
        ...
        return (0, i.jsxs)("div", {
          style: { marginLeft: "32px", marginRight: "32px" },
          children: [
            (0, i.jsx)(E.JU, { children: "Opt-In Event" }),
            (0, i.jsxs)("div", {
              style: { marginBottom: "12px" },
              children: [
                (0, i.jsx)(ba.Ay, {
      ...
      function Aa(e) {
        const { editModel: t } = e,
          ...
          s = (0, aa.q3)(() => a.jsondata.contenthub_section_groups),
          [o, l] = (0, Ea._)(!0);
        return !n && o
          ? null
          : (0, i.jsxs)("div", {
      ...
      function Na(e) {
        const {
          ...
          r = (0, aa.q3)(() => a.name),
          d = (0, aa.q3)(() => a.description),
          c = (0, aa.q3)(() => a.sections),
          _ = (0, aa.q3)(() => a.override_type),
          u = (0, n.useMemo)(
            () =>
                  ...
                  : (0, i.jsxs)("div", {
                      ...
                      children: [
                        ...
                        (0, i.jsxs)("div", {
                          ...
                          children: [
                            (0, i.jsx)(E.JU, { children: "Override Type" }),
                            (0, i.jsx)(E.m, {
                              rgOptions: [
      ...
      function Ra(e) {
        ...
        return (0, i.jsxs)("div", {
          className: (0, B.A)(b().FlexRowContainer, ca().BackgroundConfigCtn),
          children: [
            (0, i.jsxs)("div", {
              ...
              children: [
                ...
                (0, i.jsxs)("div", {
                  ...
                  children: [
                    ...
                    (0, i.jsx)(E.$n, {
                      className: ca().BackgroundColorResetBtn,
                      onClick: (e) => {
      ...
      function Pa(e) {
        ...
        return (0, i.jsx)(i.Fragment, {
          children: (0, i.jsxs)(E.$n, {
            className: ca().BackgroundColorBtn,
            onClick: (e) => {
              (0, ka.lX)((0, i.jsx)(Ba.s, { color: t, onChange: a }), e, {
                bDisablePopTop: !0,
              });
            },
            children: [
      ...
      function Fa(e) {
        ...
        return (0, i.jsx)(i.Fragment, {
          children: (0, i.jsxs)(E.$n, {
            className: ca().BackgroundColorBtn,
            onClick: (e) => {
              (0, ka.lX)((0, i.jsx)(Ba.s, { color: n, onChange: a }), e, {
                bDisablePopTop: !0,
              });
            },
            children: [
              ...
              (0, i.jsx)(Oa.U, { ...e, bIsActive: !1 }),
              (0, i.jsx)(Oa.U, { ...e, bIsActive: !0 }),
              (0, i.jsx)(Oa.U, { ...e, bIsActive: !1 }),
              (0, i.jsx)(Oa.U, { ...e, bIsActive: !1 }),
            ],
          }),
      ...
      function Ua(e) {
        return (0, i.jsxs)(i.Fragment, {
          children: [(0, i.jsx)(za, { ...e }), (0, i.jsx)(qa, { ...e })],
        });
      }
      function za(e) {
        const { model: t, fnOnDirty: a } = e,
          [s, o] = (0, aa.q3)(() => [
            ...
            t.sale_carousel_arrow_style || Ha.C.k_ECutArrowStyle,
          ]),
          l = (0, n.useMemo)(() => {
            const e = [];
            return (
      ...
      function qa(e) {
        const { model: t, fnOnDirty: a } = e,
          [s, o, l] = (0, aa.q3)(() => [
            ...
            t.sale_carousel_breadcrumb_style || Ha.m.k_EPillCrumb,
          ]),
          r = (0, n.useMemo)(() => {
            const e = [];
            return (
      ...
      function Qa(e) {
        ...
        return (0, i.jsxs)(i.Fragment, {
          children: [
            ...
            (0, i.jsx)(Ja, { editModel: t }),
            (0, i.jsx)(Ya, { editModel: t }),
          ],
        });
      }
      function Ya(e) {
            ...
            for (let t = 0; t < o; t++) {
              ...
              const s = {
                label: (0, L.PP)(
                  ...
                  t + 1,
                  (0, i.jsx)(U.K4, { dateAndTime: n, bSingleLine: !0 }),
                  (0, i.jsx)(U.K4, { dateAndTime: n + a, bSingleLine: !0 }),
                ),
                data: t,
              };
              e.push(s);
      ...
      function en(e) {
        const {
          ...
          _ = (0, aa.q3)(() => a && (0, Sa.Nx)(t));
        if (r && !(0, T.m)(r, d)) return null;
        const u = a
          ? (e) => {
              (0, Sa.mi)(t), e.preventDefault(), e.stopPropagation();
            }
          : void 0;
        return (0, i.jsx)(tn, {
          strSectionId: t,
          children: (0, i.jsxs)("div", {
            ...
            children: [
              (0, i.jsxs)("div", {
                className: (0, B.A)(Ka.Title, a && Ka.HasHover),
                onClick: u,
                children: [
                  n,
                  ...
                  Boolean(c) &&
                    (0, i.jsxs)(i.Fragment, {
                      children: [
                        (0, i.jsx)(Xa.R6, {
                          dataToCopy: $a.E.k_EventData_SubMenu,
                        }),
                        (0, i.jsx)(Xa.oO, {
                          dataToPaste: $a.E.k_EventData_SubMenu,
                        }),
                      ],
                    }),
                  a &&
      ...
      function tn(e) {
        const { strSectionId: t, children: a } = e,
          n = (0, Za.OO)(
            {
              onEnter: () => nn.m_mapVisibleSections.set(t, t),
              onLeave: () => nn.m_mapVisibleSections.delete(t),
            },
        ...
        return (0, i.jsx)(
          xt.tH,
          {
            children: (0, i.jsx)(
              "div",
              { className: Ka.Waypoint, ref: n, children: a },
      ...
      (0, K.Cg)([X.sH], an.prototype, "m_mapVisibleSections", void 0);
      const nn = new an(),
        sn = (0, _.PA)((e) => {
          var t, a, n, s;
          const { editModel: l } = e,
            [d, c] = (0, aa.q3)(() => [l.GetAppID(), l.GetEventType()]),
            _ = Boolean(
              ...
              children: [
                ...
                (0, i.jsx)(tn, {
                  ...
                  children: (0, i.jsx)(ra.it, {
                    ...
                    elEventArtworkExample: (0, i.jsx)(ga, {
                      artworkType: "sale_header",
                    }),
                    ...
                    partnerEventStore: o.mh,
                    elAdditionalControls: (0, i.jsx)(Qa, { editModel: l }),
                  }),
                }),
                !p &&
                  (0, i.jsx)(tn, {
      ...
      var on = a(63556),
        ...
        _n = a(30470);
      function un(e) {
        const { data: t, isLoading: a } = (0, cn.I)({
          queryKey: ["PartnerInfoList", e],
          queryFn: () =>
            (async function (e) {
              var t, a;
              const n = { accountid: e, origin: self.origin };
              let i = `${_n.TS.COMMUNITY_BASE_URL}actions/ajaxgetuserpartnerinfo`;
              "partnerweb" == (0, O.yK)() &&
                (i = `${_n.TS.PARTNER_BASE_URL}actions/ajaxgetuserpartnerinfo`);
      ...
      function mn(e) {
        const { clanSteamID: t, gidClanEvent: a } = e,
          { bLoading: n } = (0, ln.g7)(t.GetAccountID(), a);
        return n
      ...
      function gn(e) {
        ...
        const {
          ...
          } = (0, ln.g7)(n.GetAccountID(), s),
          { oPrivateData: m } = (0, ln.fj)(n.GetAccountID(), s),
          v = Sn(n, s);
        if (d)
          return (
            v &&
            (0, i.jsx)("div", {
              className: (0, B.A)(
                dn.ApprovalRequiredCtn,
                dn.PublishWithRestrictions,
              ),
              children: (0, i.jsx)("div", {
                className: dn.Left,
                children: (0, i.jsx)(En, { clanSteamID: n, gidClanEvent: s }),
              }),
            })
          );
        if (!c && _ && !u) {
          const e = (e) => {
            ...
            r = (e) => {
              (0, y.pg)(
                (0, i.jsx)(bn, { clanSteamID: n, gidClanEvent: s }),
                (0, k.uX)(e),
              );
            },
            d =
        ...
        return !c && _ && u
          ? (0, i.jsx)("div", {
              className: (0, B.A)(dn.ApprovalRequiredCtn, dn.Approved),
              children: (0, i.jsxs)("div", {
                className: dn.Left,
                children: [
                  (0, i.jsxs)("div", {
      ...
      function jn(e) {
        const { clanSteamID: t, gidClanEvent: a, closeModal: n } = e,
          ...
          d = (0, rn.vs)();
        return d.bLoading
          ? (0, i.jsx)(rn.Hh, { state: d, strDialogTitle: s, closeModal: n })
          : (0, i.jsx)(f.o0, {
              strTitle: s,
              onOK: () => {
                d.fnSetLoading(!0),
      ...
      function bn(e) {
        const { clanSteamID: t, gidClanEvent: a, closeModal: n } = e,
          { fnSetAccountApproved: s } = (0, ln.g7)(t.GetAccountID(), a),
          [o, l, r] = (0, ln.hr)(),
          d = "APPROVE SALE PAGE?",
          c = (0, rn.vs)();
        if (c.bLoading)
          return (0, i.jsx)(rn.Hh, {
            state: c,
            strDialogTitle: d,
            closeModal: n,
          });
        return (0, i.jsx)(f.o0, {
          ...
          children: (0, i.jsxs)("div", {
            children: [
              ...
              (0, i.jsx)(xn, { clanSteamID: t, gidClanEvent: a }),
            ],
          }),
        });
      }
                ...
                h.fnSetLoading(!0),
                  (async function (e, t, a, n) {
                    ...
                    try {
                      ...
                      return e && 200 == e.status && e.data.success == ft.R
                        ? e.data
                        : (console.error(
                            "CreateReviewRequestTicket failed.",
                            e && (0, N.H)(e),
                          ),
                          e.data.success == ft.Ze ? e.data : null);
                    } catch (e) {
                      const t = (0, N.H)(e);
                      console.error(
      ...
      function Tn(e) {
        const t = o.mh.GetEditModel(),
          ...
          } = (0, ln.lA)(t.GetClanAccountID(), t.GetGID()),
          [l, d] = (0, aa.q3)(() => [
            t.BHasSaleEnabled(),
                  ...
                  children: [
                    ...
                    (0, i.jsx)("div", {
                      ...
                      children: (0, i.jsx)(E.jn, {
                        onClick: (e) =>
                          (0, y.pg)(
                            (0, i.jsx)(kn, { bCheckListReadOnly: !1 }),
                            (0, k.uX)(e),
                          ),
      ...
      function In(e) {
        const t = o.mh.GetEditModel(),
          { bLoading: a, nAcceptingGuidelineAccount: n } = (0, ln.lA)(
            t.GetClanAccountID(),
            t.GetGID(),
          ),
        ...
        if (a) return null;
        if (s || l) return null;
        if ((0, T.m)(t.GetClanSteamID(), !0)) return (0, i.jsx)(Bn, {});
        return Boolean(n) ? (0, i.jsx)(Gn, {}) : null;
      }
      function Gn() {
        const e = o.mh.GetEditModel(),
          ...
          } = (0, ln.lA)(e.GetClanAccountID(), e.GetGID()),
          n = (0, aa.q3)(() => {
            var t;
            ...
            (0, i.jsxs)("div", {
              ...
              children: [
                (0, L.PP)(
                  ...
                  (0, i.jsx)(U.K4, { dateAndTime: t, bSingleLine: !0 }),
                ),
                Boolean(!n) &&
                  (0, i.jsxs)("div", {
            ...
            (0, i.jsxs)("div", {
              ...
              children: [
                (0, i.jsx)(E.$n, {
                  onClick: (e) =>
                    (0, y.pg)(
                      (0, i.jsx)(kn, { bCheckListReadOnly: !0 }),
                      (0, k.uX)(e),
                    ),
                  children: (0, L.we)("#EventSaleGuidelines_Review"),
                }),
      ...
      function Nn(e) {
        const { clanSteamID: t, gidClanEvent: a, closeModal: n } = e,
          ...
          [o, l, r] = (0, ln.hr)(),
          { fnRemoveApprovalAccount: d } = (0, ln.g7)(t.GetAccountID(), a),
          {
      ...
      function Mn(e) {
        const t = o.mh.GetEditModel(),
          { bLoading: a, bPublishRequiresValveApproval: s } = (0, ln.g7)(
            t.GetClanAccountID(),
            t.GetGID(),
          ),
      ...
      function Bn() {
        const e = o.mh.GetEditModel(),
          { nAcceptingGuidelineAccount: t } = (0, ln.lA)(
            e.GetClanAccountID(),
            e.GetGID(),
          );
        return Pt.WN.includes(e.GetClanAccountID())
          ? null
          : t
            ? (0, i.jsxs)("div", {
      ...
      function kn(e) {
        const { bCheckListReadOnly: t, closeModal: a } = e,
          ...
          } = (0, ln.lA)(s.GetClanAccountID(), s.GetGID()),
          [p, h, m] = (0, ln.hr)(),
          v = Boolean(l),
          [g, S] = n.useState(v),
          [x, j] = n.useState(v),
        ...
        return (0, i.jsxs)(f.o0, {
          ...
          bOKDisabled:
            ...
            (0 == _.length ||
              ...
              _.some((e) => !E.pd.validateUrl(e.url)) ||
              _.some((e) => {
                var t;
                return !(
          ...
          children: [
            (0, i.jsx)(yn.$A, { editModel: s, eInitLangLanguage: r.Bhc }),
            (0, i.jsx)(fa.A, {
              items: _,
      ...
      function Rn(e) {
        const { presenter: t, setPresenter: a } = e,
          [n] = (0, aa.q3)(() => [on.O.Get().GetCurEditLanguage()]);
        return (0, i.jsxs)("div", {
      ...
      class Hn {
        static ConstructAppRightsMap() {
          const e = new Map();
          return Hn.AppRights.forEach((t) => e.set(t.token, t)), e;
        }
        static ConstructPubRightsMap() {
          const e = new Map();
          return Hn.PubRights.forEach((t) => e.set(t.token, t)), e;
        }
        static GetAppRightFlags(e) {
          let t = 0;
          return (
            e.forEach((e) => {
              t |= Hn.MapAppRights.get(e).flag;
            }),
            t
          );
        }
      ...
      (Hn.AppRights = [
        ...
        (Hn.MapAppRights = Hn.ConstructAppRightsMap()),
        (Hn.PubRights = [
        ...
        (Hn.MapPubRights = Hn.ConstructPubRightsMap());
      var Un = a(56330),
        zn = a(55263),
        qn = a(16261),
        Vn = a(15761);
              ...
              children: (0, i.jsxs)(f.o0, {
                ...
                children: [
                  (0, i.jsx)(E.$n, {
                    ...
                    children: qn.Z.Localize("#Button_Create"),
                  }),
                  a && 0 != a.length
                    ? (0, i.jsx)("ul", {
                        children: a.map((e, t) =>
          ...
          children: [
            ...
            (0, i.jsxs)("div", {
              ...
              children: [
                ...
                (0, i.jsx)(T.E, {
                  clanSteamID: n.GetClanSteamID(),
                  children: (0, i.jsx)(Fn.i, { editModel: n }),
                }),
                (0, i.jsx)(T.E, {
                  clanSteamID: n.GetClanSteamID(),
                  children: (0, i.jsx)(Wn, { editModel: n }),
                }),
              ],
            }),
          ],
                    ...
                    (0, X.h5)(() => {
                      ...
                      t.app_right_requirement_info
                        ...
                        : (t.app_right_requirement_info = {
                            ...
                            nAppRightFlag: Hn.GetAppRightFlags([On.EditInfo]),
                          }),
                        s.SetDirty(ie.IQ.jsondata_sales);
                    });
                  },
      ...
      function Xn(e) {
        const t = o.mh.GetEditModel(),
          ...
          ln.fp)(t.GetClanAccountID(), t.GetGID()),
          [s, l, r] = (0, aa.q3)(() => [
          ...
          { creatorHome: d } = (0, sa.FV)(t.GetClanAccountID());
        let c = null;
        return (
          s && !l
            ? (c = d
      ...
      function $n(e) {
        const t = o.mh.GetEditModel(),
          ...
          [l] = (0, zn.t7)(s.appid, { include_basic_info: !0 });
        if (n || !l) return;
      ...
      const si = (0, _.PA)((e) => {
          ...
          const { editModel: s, fnOnOKCallback: o } = e,
            ...
            } = (0, ln.g7)(s.GetClanAccountID(), s.GetGID()),
            [c, _] = n.useState(
            ...
            p =
              !_n.iA.is_support &&
              !(null === (a = sa.pF.GetCreatorHome(s.GetClanSteamID())) ||
              void 0 === a
                ? void 0
                : a.BHasClanAccountFlagSet(Xt.Wv.Mv)),
          ...
          const [g, S] = n.useState(
            ...
            x = new Date();
          x.setDate(v.getDate() + 1),
            x.setHours(10),
            x.setMinutes(0),
            x.setSeconds(0);
          const [j, b] = n.useState(
              (null == l ? void 0 : l.endTime) > Math.floor(x.getTime() / 1e3)
                ? l.endTime
                : Math.floor(x.getTime() / 1e3),
            ),
            w = () => {
              (0, X.h5)(() => {
      ...
      function li(e) {
        const { mode: t } = e,
          ...
          u = !(
            ...
            2 == t ||
            (r && r.BHasClanAccountFlagSet(Xt.Wv.Jn)) ||
            _
          ),
          p = 2 != t;
        return (0, i.jsxs)("div", {
      ...
      function mi(e) {
        ...
        return (0, i.jsx)(xt.tH, {
          children: (0, i.jsx)(f.x_, {
            ...
            children: (0, i.jsxs)(E.UC, {
              children: [
                (0, i.jsx)(E.Y9, { children: (0, L.we)("#Sale_Debug_Title") }),
                (0, i.jsx)(E.nB, {
                  children: (0, i.jsx)(E.a3, {
                    children: Boolean(a)
                      ? (0, i.jsxs)("div", {
      ...
      function gi(e, t = "") {
        var a;
        return (
          (null === (a = Et.A.Get().GetStoreItem(e.id, (0, di.SW)(e.type))) ||
          void 0 === a
            ? void 0
            : a.GetName()) || t
        );
            ...
            n &&
              ...
              (l.current = window.setTimeout(async () => {
                ...
                if (e.GetEventModel().BHasSaleEnabled()) {
                  const o = (e) =>
                      e.id == a || gi(e).toLowerCase().indexOf(n) >= 0,
                    d = (e) => {
                  ...
                  s.current = (0, ka.lX)(
                    (0, i.jsx)(Ei, { list: l, fnChooseCapsule: _ }),
                    r.current.element,
                    {
              ...
              ci.kt,
              {
                ...
                children: (0, i.jsx)("div", {
                  children: (0, L.we)(
                    ...
                    gi(e, (0, L.we)("#Sale_Debug_Unknown")),
                    e.type,
                  ),
                }),
              },
          ...
          children: [
            (0, i.jsx)("div", {
              children: (0, L.we)(
                ...
                gi(t, (0, L.we)("#Sale_Debug_Unknown")),
                t.type,
              ),
            }),
                  ...
                  null === (t = i.GetEventModel().jsondata.sale_sections) ||
                    ...
                    t.forEach((e) => {
                      ...
                      const t = {
                        ...
                        unique_id: e.unique_id,
                        strLabel: (0, L.we)(
                          (0, hi.s0)(e, i.GetEventModel(), wa.uF) ||
                      ...
                      children: [
                        ...
                        (0, i.jsx)(E.$n, {
                          onClick: () => {
                            ...
                            for (const [e, i] of n) {
                              const n = t.get(i),
                                s = [e, bi(i).id.toString(), n.size.toString()];
                              for (const e of a)
                                s.push(n.has(e.unique_id) ? "1" : " ");
                              o.push(s);
                            }
                            const r = "item_locations.csv";
                            _i.g.WriteCSVToFile(o, r),
                              (0, y.mK)(
                                (0, i.jsx)(f.o0, {
      ...
      const Di = (e) => {
          ...
          t.push(
            (0, i.jsx)(
              "div",
              {
                ...
                className: (0, B.A)({
                  [yi.TOCEntry]: !0,
                  [yi.SectionOnScreen]: a.bSectionIsVisible,
                  [a.strClassName]: !0,
                  [yi.TOCIndent]: a.bIndent,
                }),
                onClick: () => {
        ...
        return (0, i.jsxs)("div", {
          className: yi.TableOfContentsContainer,
          children: [
            (0, i.jsxs)("div", {
              className: yi.ManageLocCtn,
              children: [
                (0, i.jsx)("div", {
                  className: yi.Header,
      ...
      function Oi(e) {
        const { editModel: t } = e,
          ...
          o = (0, Ri.cv)();
        return (0, i.jsxs)("div", {
          className: (0, B.A)(Li().LivePreview, o && Li().Connected),
          children: [
            (0, i.jsx)(E.$n, {
              className: (0, B.A)(Li().Button),
              onClick: () => s(void 0),
              children: (0, L.we)("#Sale_Debug_LivePreview"),
            }),
            (0, i.jsx)(E.$n, {
              className: (0, B.A)(Li().DeviceDropdown),
              onClick: (e) =>
                ((e) => {
                  const t = (0, i.jsx)(E.n4, {
                    rgOptions: a,
                    onValueSelected: (e, t) => s(t.data),
                  });
                  (0, ka.lX)(t, e, { bOverlapHorizontal: !0 });
                })(e),
              children: (0, i.jsx)(fn.GB9, {}),
            }),
          ],
        });
      }
      function Pi(e) {
        return (0, i.jsx)(wa.Cs, {
          location: wa.W3,
          children: (0, i.jsx)(Fi, { ...e }),
        });
      }
      const Fi = (0, _.PA)((e) => {
          const { editModel: t } = e,
            ...
            c = (e, t, a, n = !1, i) => {
              e.push({
                ...
                style: i,
                bIndent: n,
                bSectionIsVisible: nn.m_mapVisibleSections.has(a),
              });
            };
          ...
          if (
            (_.GetSaleSections().forEach((e, o) => {
              if (h && n && !(0, Bi.bF)(s, e)) m += 1;
              else {
                const n = (0, i.jsx)(Ca.fi, {
                    saleSection: e,
                    eventModel: t.GetEventModel(),
                    editLanguage: t.GetCurEditLanguage(),
                    index: o,
                  }),
                  s = { ...(0, ya.sq)(e, _, a), color: e.label_color },
                  l = Ti.mj + e.unique_id;
            ...
            const e = (0, i.jsxs)("div", {
              className: Ni().Ctn,
              onClick: (e) => {
                (0, Gi.qT)(void 0), e.stopPropagation();
              },
              children: [
                (0, i.jsx)("div", {
                  className: Ni().ButtonIcon,
                  children: (0, i.jsx)(fn.X, {}),
                }),
          ...
          return (
            ...
            (0, i.jsx)(xt.tH, {
              children: (0, i.jsx)(Di, {
                ...
                elBottomContent: (0, i.jsx)(Hi, { editModel: e.editModel }),
              }),
            })
          );
        }),
      ...
      function Ui(e) {
        ...
        return (0, i.jsxs)(f.o0, {
          ...
          children: [
            ...
            (0, i.jsx)("div", {
              className: (0, B.A)(j.FlexColumnContainer, Ni().ReassignCtn),
            }),
          ],
        });
      }
      function zi(e) {
        const t = o.mh.GetEditModel(),
          [a, n, s] = (0, R.uD)(),
          { bSoloMode: l, SetSoloMode: r } = (0, Sa.eQ)();
        return (0, i.jsxs)("div", {
          className: Ci.BottomBarControls,
          children: [
            (0, i.jsx)("div", {
              children: (0, i.jsx)(ae.Gq, {
                toolTipContent: (0, L.we)("#Sale_Debug_LivePreview_ttip"),
                children: (0, i.jsx)(Oi, { editModel: t }),
              }),
            }),
            (0, i.jsx)("div", {
              children: (0, i.jsx)(ae.Gq, {
                ...
                children: (0, i.jsx)(E.$n, {
                  onClick: (e) => (0, y.pg)((0, i.jsx)(mi, {}), (0, k.uX)(e)),
                  children: (0, i.jsx)(fn.eSy, {}),
                }),
              }),
            }),
            (0, i.jsx)("div", {
              children: (0, i.jsx)(ae.Gq, {
                ...
                children: (0, i.jsx)(E.$n, {
                  onClick: (e) => (0, y.pg)((0, i.jsx)(wi, {}), (0, k.uX)(e)),
                  children: (0, i.jsx)(fn.f5X, {}),
                }),
              }),
            }),
            (0, i.jsxs)("div", {
              children: [
                (0, i.jsx)(f.EN, {
                  active: a,
                  children: (0, i.jsx)(qi, { editModel: t, closeModal: s }),
                }),
                (0, i.jsx)(ae.Gq, {
                  toolTipContent: (0, L.we)("#Sale_ReorderSections_ttip"),
                  children: (0, i.jsx)(E.$n, {
                    onClick: () => n(),
                    children: (0, i.jsx)(fn._EF, {}),
                  }),
                }),
              ],
            }),
            (0, i.jsx)("div", {
              className: Ci.MinimizeAll,
              children: (0, i.jsx)(ae.Gq, {
                toolTipContent: (0, L.we)("#Sale_Section_MinimizeAll_Tooltip"),
                children: (0, i.jsx)(E.$n, {
                  onClick: Sa.TA,
                  children: (0, i.jsx)(fn.Xjb, {}),
                }),
              }),
            }),
            (0, i.jsx)("div", {
      ...
      function qi(e) {
        ...
        return (0, i.jsx)(wa.Cs, {
          ...
          children: (0, i.jsx)(f.o0, {
            ...
            children: Boolean(o)
              ? (0, i.jsx)("div", {
                  className: Ci.ReorderSectionCtn,
                  children: (0, i.jsx)("div", {
                    className: Ci.SectionList,
                    children: (0, i.jsx)(fa.A, {
                      items: o,
                      onMove: (e, t) => {
                        let a = [...o];
                        (0, Ii.yY)(a, e, t), l(a);
      ...
      function Xi(e) {
        return (0, i.jsx)(Zi, { value: e.elContent, children: e.children });
      }
      function $i(e) {
        const t = n.useContext(Zi);
        return t ? Yi.createPortal(e.children, t) : null;
      }
      const es = (0, _.PA)((e) => {
          const t = o.mh.GetEditModel(),
          ...
          return (0, i.jsxs)("div", {
            className: (0, B.A)(
              Ji.EventEditorTopBarContainer,
              n && (l || s) ? Ji.EventPublished : Ji.EventUnPublished,
            ),
            children: [
              (0, i.jsxs)("div", {
                ...
                children: [
                  ...
                  (0, i.jsx)("div", {
                    ...
                    children: (0, i.jsx)(yn.zm, { editModel: t }),
                  }),
                ],
              }),
              (0, i.jsx)("div", {
                className: b().EventOptions,
                children: (0, i.jsx)(yn.$A, { editModel: t }),
              }),
              (0, i.jsxs)("div", {
        ...
        ts = (0, _.PA)((e) => {
          const { setAdditionalContentDiv: t } = e,
            ...
            { creatorHome: d } = (0, sa.FV)(a.GetClanAccountID()),
            ...
            _ =
              ...
              (!l || c);
          return (0, i.jsxs)("div", {
            className: Ji.EventEditorBottomBar,
            children: [
              (0, i.jsx)(Ki.c, { editModel: o.mh.GetEditModel() }),
              !l &&
                (0, i.jsx)(bt.tj, {
                  eventModel: s,
                  route: bt.PH.k_eCommunityPreview,
              ...
              _ &&
                (0, i.jsxs)(n.Fragment, {
                  children: [
                    ...
                    (0, i.jsx)("span", {
                      className: Ji.DisplayAdminPanel_Spacer,
                      children: " ",
                    }),
                  ],
                }),
              (0, i.jsx)("div", { className: Ji.AdditionalContent, ref: t }),
            ],
          });
        });
      var as = a(65944),
      ...
      function rs(e) {
        ...
        return (0, i.jsx)("div", {
          className: ss.AddLinkDropDown,
          children: (0, i.jsx)(E.ZU, {
      ...
      function cs(e) {
        ...
        const { bValid: o, strTooltip: l } = ds(t, n);
        return (0, i.jsxs)("div", {
          className: ss.SocialMediaRow,
          children: [
            (0, i.jsx)("div", {
              className: ss.SocialMediaType,
              children: (0, L.we)(`#StoreAdmin_SocialMedia_Type_${t.type}`),
            }),
            (0, i.jsx)(os.BA, {
              className: ss.SocialMediaLink,
              type: "text",
              value: t.link,
              placeholder: s,
            ...
            l &&
              (0, i.jsx)(ae.he, {
                className: ss.SocialMediaTooltip,
                toolTipContent: l,
                children: "(?)",
              }),
            !o &&
              (0, i.jsx)("div", { className: ss.ValidationError, children: l }),
          ],
        });
      }
      function _s(e) {
        const { editModel: t } = e;
        return (0, aa.q3)(() => t.GetEventType()) == r.ajI
          ? (0, i.jsx)(ps, { editModel: t })
        ...
        return (0, i.jsxs)("div", {
          children: [
            ...
            (0, i.jsx)(T.E, {
              ...
              requireAdmin: !0,
              children: (0, i.jsx)("p", {
                className: is().DefaultSocialOverrideMsg,
                children: (0, L.we)(
                  p
            ...
            h &&
              (0, i.jsxs)("div", {
                className: is().SocialShareCtn,
                children: [
                  (0, i.jsx)("img", {
                    className: (0, B.A)(
                      is().DefaultSocialImgCtn,
                      d && is().Small,
                    ),
                    src: l,
                  }),
                  (0, i.jsxs)("div", {
                    className: is().SocialShareText,
                    children: [
                      (0, i.jsxs)("div", {
                        className: is().SocialTitle,
                        children: [
                          a,
                          (0, i.jsx)("br", {}),
      ...
      function vs(e) {
        const { editModel: t } = e,
          a = (function () {
            const e = (0, cn.I)({
              ...
              queryFn: async () => {
                var e;
                const t = `${_n.TS.COMMUNITY_BASE_URL}sale/ajaxgetsocialmediaeditsettings`,
        ...
        return a
          ? a.success != ft.R
            ? (0, i.jsx)("div", {
                className: is().ErrorContainer,
                children: (0, i.jsx)("div", {
                  className: is().ErrorText,
      ...
      function Cs(e) {
        ...
        return (0, i.jsxs)(i.Fragment, {
          children: [
            (0, i.jsx)(Is, { editModel: t }),
            a && (0, i.jsx)(fs, { editModel: t }),
          ],
        });
      }
      function fs(e) {
        const { editModel: t } = e,
          [a] = (0, aa.q3)(() => [t.GetEventModel().jsondata.sale_sub_menu]),
          s = (0, n.useCallback)(() => t.SetDirty(ie.IQ.jsondata_sales), [t]),
          o = [
            {
              name: "Editor",
              key: "submenu_editor",
              contents: (0, i.jsx)(Ds, { ...e }),
            },
            {
              name: "Background",
              key: "submenu_back",
              contents: (0, i.jsx)(Vn.Bb, {
                section: a,
                fnOnSetDirty: () => s,
                elAdditionalLabelSettings: (0, i.jsx)(ys, {
                  fnOnSetDirty: s,
                  subMenuSection: a,
                }),
                fnOnClearSettings: () => {
            ...
            },
            {
              name: "Debug",
              key: "debug",
              contents: (0, i.jsx)(ea.ad, { saleSection: a }),
            },
          ];
        return (0, i.jsxs)(i.Fragment, {
          children: [
            ...
            (0, i.jsx)("div", {
              className: xs().TabContents,
              children: (0, i.jsx)(_a.V, { tabs: o, bDisableRouting: !0 }),
            }),
          ],
        });
      }
              ...
              onClick: (e) => {
                ...
                t
                  ...
                  .jsondata.sale_sub_menu.menu_items.push({
                    unique_id: n,
                    sub_menu_icon: { media_type: ws.Cu.k_MediaImage },
                  }),
                  t.SetDirty(ie.IQ.jsondata_sales),
                  a();
              },
      ...
      function Ts(e) {
        ...
        return (0, i.jsxs)("div", {
          children: [
              ...
              onChange: (e) => {
                ...
                i !== s &&
                  ((!a.localized_sub_menu_name ||
                    ...
                    (a.localized_sub_menu_name = (0, Ii.$Y)(
                      a.localized_sub_menu_name || [],
                      r.bP9,
                      null,
                    )),
            ...
            (0, i.jsx)(Gs, { fnOnDirty: t, menuItem: a }),
          ],
        });
      }
      function Is(e) {
      ...
      function Gs(e) {
        ...
        return (0, i.jsxs)(i.Fragment, {
          children: [
            (0, i.jsx)(E.$n, { onClick: o, children: "Open Icon Uploader" }),
            (0, i.jsx)(Ss.E, {
              active: s,
              children: (0, i.jsx)(gs.o0, {
      ...
      class Os {
        static Get() {
          return (
            Os.s_newsCuratorStore ||
              ((Os.s_newsCuratorStore = new Os()),
              (Os.s_newsCuratorStore.m_LoadingPromise =
                Os.s_newsCuratorStore.Init()),
              (window.g_NewsCuratorStore = Os.s_newsCuratorStore)),
            Os.s_newsCuratorStore
          );
        }
        constructor() {
      ...
      (0, K.Cg)([X.sH], Os.prototype, "m_mapNewsCurators", void 0),
        (0, K.Cg)([X.sH], Os.prototype, "m_bIsLoadComplete", void 0),
        (0, K.Cg)([X.sH], Os.prototype, "m_mapLangToNewsCurators", void 0),
        (0, K.Cg)([X.EW], Os.prototype, "allNewsCurators", null),
        (0, K.Cg)([X.XI], Os.prototype, "HandleCuratorResponse", null);
      var Ps = a(41338),
        Fs = a(16345),
        Hs = a.n(Fs);
      function Us(e) {
      ...
      class zs extends n.Component {
          ...
          for (const s of a) {
            ...
            if (
              ...
              if (
                ...
                continue;
              if (Rs.Fm.Get().BIsIgnoringCurator(a.clanAccountID)) continue;
              const e = Rs.Fm.Get().BIsFollowingCurator(a.clanAccountID),
                t = (0, i.jsx)(
                  qs,
                  {
                    suggestion: o,
        ...
        async GetAppSuggestionsFromServer(e) {
          ...
          const s = {
              cc: O.TS.COUNTRY,
              l: O.TS.LANGUAGE,
              realm: Ls.TU.k_ESteamRealmGlobal,
              origin: self.origin,
              f: "jsonfull",
              term: e.replace(" ", "+"),
              require_type: n.join(","),
              excluded_tags: Rs.Fm.Get().GetExcludedTagsSortedByID(),
              excluded_content_descriptors:
                Rs.Fm.Get().ExcludedContentDescriptor,
            },
        ...
        async UpdateSuggestions(e) {
          ...
          if (
            ...
            return (
              Array.from(Us(this.props.rgCorporaToSearch)).forEach((e) =>
                this.m_mapHighestReceivedRequestIDFromBackEnd.set(
                  e,
                  this.m_nHighestSentRequestID,
                ),
                      ...
                      (0, i.jsxs)(
                        "div",
                        {
                          children: [
                            _ &&
                              (0, i.jsx)("div", {
                                className: Hs().ResultSectionHeader,
                                children: u,
                              }),
                            o,
                          ],
      ...
      (0, K.Cg)([R.oI], zs.prototype, "UpdateSuggestions", null);
      const qs = (e) =>
        (0, i.jsxs)(
          "div",
          {
            className: Hs().ResultRow,
            onClick: () => e.fnOnSelected(e.suggestion),
            children: [
              (0, i.jsx)("img", {
                src: e.suggestion.img,
                className: Hs().AvatarImage,
              }),
              (0, i.jsxs)("div", {
                className: Hs().GameName,
                children: [" ", (0, Ps.EK)(e.suggestion.name), " "],
              }),
      ...
      function Vs(e) {
        const { editModel: t } = e,
          a = t.GetEventModel(),
          s = (0, aa.q3)(() => a.jsondata.associated_appid || 0),
      ...
      function $s(e) {
        return (0, i.jsxs)("div", {
          ...
          children: [
            ...
            (0, i.jsx)("p", {
              children: (0, i.jsx)("a", {
                href: `${Zs.TS.PARTNER_BASE_URL}doc/store/assets/promos#popup_update`,
      ...
      function eo(e) {
        const t = n.useRef(void 0),
          ...
          l = (0, aa.q3)(() => a.BHasTag("vo_marketing_message"));
        return (0, i.jsxs)(i.Fragment, {
          children: [
            (0, i.jsx)(to, { editModel: a }),
            (0, i.jsx)(ao, { editModel: a }),
            (0, i.jsx)(no, { editModel: a }),
            (0, i.jsx)(io, { editModel: a }),
            Boolean(s) && (0, i.jsx)(so, { editModel: a }),
            (0, i.jsx)(Gt, { editModel: a }),
            (0, i.jsx)(Vs, { editModel: a }),
            l && (0, i.jsx)($s, {}),
            (0, i.jsxs)("div", {
              className: b().Columns,
              children: [
                (0, i.jsx)(ro, { editModel: a, refOnInsertImage: t }),
                (0, i.jsx)(co, { editModel: a, fnInsertImage: o }),
              ],
            }),
          ],
        });
      ...
      function to(e) {
        const { editModel: t } = e,
          a = (0, Ws.IB)(e.editModel.GetClanSteamID().ConvertTo64BitString()),
          n = a.isSuccess && !!a.data.crowdin_project_id;
        return (0, i.jsx)("div", {
          children: (0, i.jsx)("div", {
            className: b().FlexColumnContainer,
            children: (0, i.jsxs)("div", {
              className: Qs.LanguageControlsCtn,
              children: [
                (0, L.we)("#EventEditor_LangaugeDesc"),
                (0, i.jsxs)("div", {
                  className: (0, B.A)(b().FlexRowContainer, Qs.ToolContainer),
                  children: [
                    (0, i.jsx)(yn.$A, { editModel: t }),
                    (0, i.jsx)(rt, { editModel: t }),
                  ],
                }),
                n && (0, i.jsx)(Ys.s, { editModel: e.editModel }),
              ],
            }),
          }),
        });
      ...
      function ao(e) {
        const { editModel: t } = e,
          ...
          o = (0, aa.q3)(() => t.BHasTag("vo_marketing_message"));
            ...
            children: [
              ...
              (0, i.jsxs)("div", {
                ...
                children: [
                  ...
                  (0, i.jsx)("span", {
                    className: (0, B.A)(
                      Ci.CharactorRemaining,
                      s ? Ci.CharactorExhausted : "",
                    ),
                    children: (0, L.we)(
              ...
              (0, i.jsx)("div", {
                ...
                children: (0, i.jsx)("input", {
                  type: "text",
                  className: (0, B.A)({
                    [Ci.EventEditorTitleInput]: !0,
                    [Ci.MainTitle]: !0,
                    [Ci.EventEditorInputMaxLength]: s,
                  }),
                  value: a,
            ...
            (0, i.jsx)("div", {
              ...
              children: (0, i.jsx)("input", {
                ...
                className: (0, B.A)(
                  Ci.EventEditorTitleInput,
                  Ci.Subtitle,
                  n ? Ci.EventEditorInputMaxLength : "",
                ),
                value: a,
                placeholder: (0, L.we)(
      ...
      function io(e) {
        ...
        return (0, i.jsxs)("div", {
          children: [
            (0, i.jsxs)("div", {
              className: Ci.EventEditorInputPaneContents,
              children: [
                (0, i.jsxs)("div", {
                  className: b().EventEditorTextTitleCtn,
                  children: [
                ...
                (0, i.jsx)("textarea", {
                  className: (0, B.A)(
                    Ci.EventEditorTitleInput,
                    Ci.Summary,
                    o ? Ci.EventEditorInputMaxLength : "",
                  ),
                  value: a,
                  placeholder: s,
                  onFocus: (e) => {
          ...
          children: [
            ...
            t.GetReferencedAppIDArray().length > 0 &&
              (0, i.jsx)(fa.A, {
                ...
                render: (e) => (0, i.jsx)(oo, { appid: e }, `suggestion-${e}`),
              }),
          ],
        });
      }
      function oo(e) {
        ...
        return (0, i.jsx)("div", {
          ...
          children: (0, i.jsxs)("div", {
            ...
            children: [
              " ",
              (0, Ps.EK)((null == a ? void 0 : a.GetName()) || "") + ` (${t})`,
              " ",
            ],
          }),
        });
      ...
      function ro(e) {
        const { editModel: t, refOnInsertImage: a } = e,
          ...
          l = (0, aa.q3)(() => t.GetEventType()),
          d = (0, R.QS)(
            (e) => {
              if (!e) return;
              const t = (t, a) => (0, Bs.fW)(e, t, a);
              return (
                (a.current = t),
                () => {
        ...
        return (0, i.jsxs)("div", {
          className: (0, B.A)(b().LeftCol, Qs.DescEditorPadding),
          children: [
            (0, i.jsx)("div", {
              className: b().EventEditorTextTitle,
              children:
            ...
            s
              ...
              : (0, i.jsx)(ks.I, {
                  ...
                  limitBBCode: c,
                  classNameForTextArea: Ci.EventEditorDescription,
                  clanSteamID: t.GetClanSteamID(),
                }),
          ],
        });
      ...
      function _o(e) {
        return (0, i.jsx)("div", {
          className: As.TutoralCtn,
          children: (0, i.jsxs)("div", {
            className: As.ExplanationCtn,
            children: [
              (0, i.jsx)("h2", {
      ...
      function uo(e) {
        const { editModel: t } = e,
          [a, n] = (0, aa.q3)(() => [t.GetGID(), t.GetClanAccountID()]),
          s = !!a,
          { creatorHome: o } = (0, sa.FV)(n),
          l = o ? o.GetCreatorHomeURL(null) + "admin/curator_edit" : void 0,
          r = o ? o.GetCreatorHomeURL(null) + "#edit" : void 0;
        return (0, i.jsxs)("div", {
          className: As.CreatorHomeEditCtn,
          children: [
            (0, i.jsx)(po, { editModel: t }),
            (0, i.jsx)(ao, { editModel: t }),
            s &&
              o &&
              (0, i.jsx)(i.Fragment, {
                children: (0, i.jsxs)("div", {
                  className: As.AdminLinkCtn,
                  children: [
                    (0, i.jsxs)("div", {
                      className: As.LeftCol,
                      children: [
                        (0, i.jsx)("div", {
                          className: As.Label,
                          children: (0, L.we)(
                        ...
                        (0, i.jsx)("img", {
                          ...
                          className: As.AvatarImage,
                        }),
                        (0, i.jsx)("div", {
                          className: As.EditLink,
                          children: (0, L.oW)(
      ...
      function vo(e) {
        const { editModel: t, mode: a } = e,
          [n, s] = (0, aa.q3)(() => [t.GetGID(), t.GetEventType()]);
        return n
          ? (0, i.jsx)(mo.sn, {
              children: (0, i.jsx)(go, { editModel: t, mode: a }),
            })
          : s == r.ajI
            ? (0, i.jsx)(uo, { editModel: t })
            : (0, i.jsx)("div", {
                className: (0, B.A)(Ka.SaleContainer, "SaleContainer"),
                children: (0, L.we)("#Sale_SaveFirst"),
              });
      }
      function go(e) {
        const { editModel: t, mode: a } = e,
          [s, o, l, d, c, _, u] = (0, aa.q3)(() => {
            var e;
            return [
              t.GetEventType(),
              t.GetEventModel().jsondata.sale_presenters,
          ...
          { creatorHome: p } = (0, sa.FV)(d.GetAccountID()),
          { bRequiresHostDisclaimer: h } = (0, ln.lA)(d.GetAccountID(), c),
          m = Pt.WN.includes(d.GetAccountID()),
          v = s == r.ajI;
        (0, n.useEffect)(() => {
        ...
        if (
          ...
          (!p || !p.BHasClanAccountFlagSet(Xt.Wv.Jn))
        )
          return (0, i.jsxs)("div", {
            className: (0, B.A)(Ka.SaleContainer, "SaleContainer"),
            children: [
        ...
        let E = "#Sale_title",
          x = "doc/marketing/event_tools/sales/tools";
        1 == a
          ? ((E = "#Sale_UpdateLandingPage_title"),
            (x = "doc/marketing/event_tools/updatelandingpages/tools"))
          : 2 == a &&
            ((E = "#Sale_CreatorHome_title"),
          ...
          children: [
            ...
            (0, i.jsxs)(Tn, {
              children: [
                ...
                (0, i.jsxs)("div", {
                  children: [
                    (0, i.jsx)($i, { children: (0, i.jsx)(zi, {}) }),
                    (0, i.jsx)(Pi, { editModel: t, onSelected: S }),
                    ...
                    (t.BHasTag("contenthub") ||
                      ...
                      (0, i.jsx)(en, {
                        ...
                        children: (0, i.jsx)(Ta, { editModel: t }),
                      }),
                    ...
                    (0, i.jsx)(en, {
                      ...
                      children: (0, i.jsx)(_s, { editModel: t }),
                    }),
                    (0, i.jsx)("div", { className: Ka.SectionDivider }),
                    !v &&
                      (0, i.jsx)(en, {
                        ...
                        requireAdmin: !0,
                        children: (0, i.jsx)(jo, { editModel: t }),
                      }),
                    !v &&
                      (0, i.jsx)(en, {
                        ...
                        valveOnlyClanSteamID: t.GetClanSteamID(),
                        dataToCopy: $a.E.k_EventData_SubMenu,
                        children: (0, i.jsx)(Cs, { editModel: t }),
                      }),
                    (0, i.jsx)(en, {
                      ...
                      valveOnlyClanSteamID: t.GetClanSteamID(),
                      children: (0, i.jsx)(Wi, { editModel: t }),
                    }),
                  ],
                }),
              ],
      ...
      function So(e) {
        ...
        const { editModel: a, mode: n } = e,
          ...
          { data: d } = (0, cn.I)((0, ho.J)(o.GetAccountID())),
          {
            bLoading: c,
            strExternalSaleEventType: _,
            fnSetExternalSaleEventType: u,
          } = (0, ln.g7)(o.GetAccountID(), l),
          p = (0, as.iR)(a.GetEventModel());
        ...
        return (0, i.jsx)(i.Fragment, {
          children: (0, i.jsxs)(en, {
            ...
            children: [
              p && (0, i.jsx)(ri.w7, { editModel: a }),
              !p && (0, i.jsx)(ri.PT, { editModel: a }),
              !h &&
                (0, i.jsxs)(T.E, {
                  clanSteamID: o,
                  children: [
      ...
      function Eo(e) {
        ...
        const { editModel: a } = e,
          ...
          [l, r, d, c] = (0, aa.q3)(() => {
            ...
            return [o.GetSaleSections().length, t, e, (0, Gi.dy)()];
          }),
          [_, u] = n.useState(""),
          p =
            void 0 !== c ||
          ...
          children: [
            ...
            0 == l
              ...
              : (0, i.jsx)(fa.A, {
                  ...
                  bDisabled: p,
                  onMove: (e, t) => {
                    (0, Ii.yY)(a.GetEventModel().jsondata.sale_sections, e, t),
                      a.SetDirty(ie.IQ.jsondata_sales);
                  },
                  render: (e, t) => {
                    var n;
                    const o = Ti.mj + e.unique_id,
                      l =
                        (0, ya.vx)(e.section_type) && r.get(e.section_type) > 1;
                    return (0, i.jsx)(
                      tn,
                      {
                        strSectionId: o,
                        children: (0, i.jsx)(ya.m, {
                          ref:
                            t == h.length - 1
                              ? (e) => m(e, h[t].unique_id)
                              : void 0,
      ...
      function xo(e) {
        return (0, i.jsxs)("div", {
          id: "NoSaleSections",
          className: (0, B.A)(Ka.SaleSection, Ka.InEditor),
          children: [
            (0, i.jsx)("div", {
              className: (0, B.A)(j.SaleSectionHeader, "SaleSectionHeader"),
            ...
            (0, i.jsx)("div", {
              className: Ka.SaleSectionPlaceholder,
            ...
            const a = (0, cn.I)({
              ...
              queryFn: async () => {
                const a = v.b.InitFromClanID(t),
                  n = `${Zs.TS.COMMUNITY_BASE_URL}gid/${a.ConvertTo64BitString()}/ajaxgetsalesectionstats?event_gid=${e}`,
                  i = { event_gid: e };
              ...
              children: [
                (0, i.jsx)(E.$n, {
                  onClick: () => {
                    ...
                    _i.g.WriteCSVToFile(e, n);
                  },
                  children: "Export to CSV",
                }),
                (0, i.jsx)(yo, { rgStats: a }),
                (0, i.jsx)(To, { rgStats: a }),
              ],
            })
          : (0, i.jsx)(D.t, {});
      }
                  ...
                  (0, i.jsxs)(
                    "tr",
                    {
                      children: [
                        ...
                        (0, i.jsx)("td", { children: fo(e.total_impressions) }),
                        (0, i.jsx)("td", { children: fo(e.total_views) }),
                        (0, i.jsx)("td", {
                          children: Co(e.total_views, e.total_impressions),
                        }),
                        (0, i.jsx)("td", {
                          children: fo(e.total_owner_impressions),
                        }),
                        (0, i.jsx)("td", { children: fo(e.total_owner_views) }),
                        (0, i.jsx)("td", { children: fo(e.total_wishlists) }),
                        (0, i.jsx)("td", {
                          children: Co(e.total_wishlists, e.total_impressions),
                        }),
                        (0, i.jsx)("td", {
                          children: fo(e.total_add_to_carts),
                        }),
                        (0, i.jsx)("td", { children: fo(e.total_ignores) }),
                      ],
                    },
      ...
      function To(e) {
        ...
        return (0, i.jsxs)("div", {
          children: [
            ...
            a.map((e) => (0, i.jsx)(Io, { rgStats: t, rtDate: e }, "" + e)),
          ],
        });
      }
      function Io(e) {
      ...
      (0, K.Cg)([X.sH], Go.prototype, "m_editModel", void 0),
        (0, K.Cg)([X.XI], Go.prototype, "SetBroadcastEnabled", null),
        (0, K.Cg)([X.XI], Go.prototype, "SetBroadcastForceBanner", null),
        (0, K.Cg)([X.XI], Go.prototype, "SetChangeSetting", null),
        (0, K.Cg)([X.XI], Go.prototype, "SetTitleToken", null),
        (0, K.Cg)([X.XI], Go.prototype, "SetCustomTitleLocalize", null),
        (0, K.Cg)([X.XI], Go.prototype, "AddAccountToWhiteList", null),
        (0, K.Cg)([X.XI], Go.prototype, "DeleteWhiteListAccount", null),
        (0, K.Cg)([X.XI], Go.prototype, "SetWhiteListAccountLanguage", null),
        (0, K.Cg)([X.XI], Go.prototype, "SetWhiteListAccountPriority", null),
        (0, K.Cg)([X.XI], Go.prototype, "RemoveWhiteListAtIndex", null),
        (0, K.Cg)([X.XI], Go.prototype, "ClearWhiteList", null),
        (0, K.Cg)([X.XI], Go.prototype, "SetBroadcastContentType", null),
        (0, K.Cg)([X.XI], Go.prototype, "SetPrerollVODAppID", null),
        (0, K.Cg)([X.XI], Go.prototype, "SetDropsEnabled", null),
        (0, K.Cg)([X.XI], Go.prototype, "SetItemDropManual", null),
        (0, K.Cg)([X.XI], Go.prototype, "SetItemDropMinutes", null),
        (0, K.Cg)([X.XI], Go.prototype, "SetItemDropDetailEvents", null),
        (0, K.Cg)([X.XI], Go.prototype, "SetWidePlayerLayout", null),
        (0, K.Cg)([X.XI], Go.prototype, "SetWidePlayerSupportChat", null),
        (0, K.Cg)([X.XI], Go.prototype, "SetChatAnnouncementGiveawayGID", null);
      var Ao = a(44894),
        No = a(27643);
      class Mo {
        GetFriendLiset() {
          ...
          return (
            Mo.s_Singleton ||
              ...
              ("dev" != O.TS.WEB_UNIVERSE && "beta" != O.TS.WEB_UNIVERSE) ||
                (window.g_DynamicRevealStore = Mo.s_Singleton)),
            Mo.s_Singleton
          );
        }
        constructor() {
      ...
      var Bo = a(1909),
        ...
        Fo = a(75515),
        Ho = a(41471);
      let Uo = class extends n.Component {
        constructor() {
          super(...arguments),
            (this.state = {
              strCustomTitle: "",
        ...
        GetBroadcastEditModel() {
          return new Go(this.props.editModel);
        }
        ...
        render() {
          const { editModel: e } = this.props,
            ...
            n = [],
            s = L.A0.GetLanguageListForRealms([Ls.TU.k_ESteamRealmGlobal]);
          for (const e of s) {
            const t = {
          ...
          return (0, i.jsxs)("div", {
            className: fi().EventEditorInputPaneContents,
            children: [
              (0, i.jsxs)("div", {
                className: b().EventEditorTextTitleCtn,
                children: [
                  ...
                  children: [
                    ...
                    (0, i.jsxs)("div", {
                      ...
                      children: [
                        ...
                        (0, i.jsxs)("div", {
                          className: Po().customTitleOptionsCtn,
                          children: [
                            (0, i.jsxs)("div", {
                              className: (0, B.A)(
                                b().FlexRowContainer,
                              ...
                              children: [
                                ...
                                (0, i.jsx)("div", {
                                  className: Po().LanguageContainer,
                                  children: (0, i.jsx)(E.m, {
                                    bDisableMouseOverlay: !0,
                                    strDropDownClassName: b().DropDownScroll,
                                    rgOptions: n,
          ...
          children: [
            ...
            (0, i.jsxs)("div", {
              ...
              children: [
                ...
                (0, i.jsx)("div", {
                  className: fi().BroadcastAccountList,
                  children: a.map((e) =>
                    (0, i.jsx)(
                      Yo,
                      { accountid: e },
                ...
                (0, i.jsx)(qo, { broadcastEditModel: t }),
                (0, i.jsx)(ko.jl, {
      ...
      function qo(e) {
        const { broadcastEditModel: t } = e,
          a = (function () {
            const [e, t] = n.useState(Mo.Get().GetFriendLiset());
            return (
              n.useEffect(() => {
                Boolean(e) || Mo.Get().LoadFriendList().then(t);
              }, []),
              e
            );
          })();
      ...
      function Yo(e) {
        const { accountid: t } = e,
          { isLoading: a, data: n } = (0, Ho.js)(t),
          s = () => {
            let e = o.mh.GetEditModel();
            return new Go(e);
          };
        let l = o.mh.GetEditModel().GetEventModel(),
          d = (0, aa.q3)(() => l.jsondata.broadcast_whitelist.indexOf(t)),
          c = (0, aa.q3)(() => {
        ...
        return a
          ...
          : n
            ? (0, i.jsxs)("div", {
                className: (0, B.A)(Ro().FlexCenter, Po().AccountRow),
                children: [
                  (0, i.jsxs)("a", {
                    className: (0, B.A)(
                      Ro().FlexCenter,
                      fi().BroadcastAccountInfo,
                    ),
                  ...
                  (0, i.jsx)(Jo, { accountid: t }),
                  (0, i.jsx)("img", {
                    className: (0, B.A)(Ro().FlexCenter, Ro().RemoveIcon),
                    src: Ao.A,
      ...
      function Jo(e) {
        const t = o.mh.GetEditModel(),
          a = new Go(t),
          n = [
            { label: (0, L.we)("#Broadcast_Priority_Primary"), data: Fo.U7 },
            { label: (0, L.we)("#Broadcast_Priority_Featured"), data: Fo._ },
            {
              label: (0, L.we)("#Broadcast_Priority_DefaultFeatured"),
              data: Fo.zl,
            },
            { label: (0, L.we)("#Broadcast_Priority_General"), data: Fo.mP },
          ],
          s = a.GetWhiteListAccountPriority(e.accountid, Fo.mP);
        return (0, i.jsxs)(ae.he, {
          toolTipContent: (0, L.we)("#Broadcast_Priority_hint"),
          className: fi().PrioritySelector,
          children: [
            (0, i.jsxs)("span", {
      ...
      (0, K.Cg)([R.oI], Uo.prototype, "OnBroadcastOptionChange", null),
        (0, K.Cg)([R.oI], Uo.prototype, "OnBroadcastForceBanner", null),
        (0, K.Cg)([R.oI], Uo.prototype, "OnChatChange", null),
        (0, K.Cg)([R.oI], Uo.prototype, "OnTitleChange", null),
        (0, K.Cg)([R.oI], Uo.prototype, "OnCustomTitleChange", null),
        (0, K.Cg)([R.oI], Uo.prototype, "OnCustomTitleLanguageChange", null),
        (0, K.Cg)([R.oI], Uo.prototype, "AddTitle", null),
        (0, K.Cg)([R.oI], Uo.prototype, "RemoveTitle", null),
        (0, K.Cg)([R.oI], Uo.prototype, "OnSaleColorChange", null),
        (0, K.Cg)([R.oI], Uo.prototype, "OnOpenGradientInnerColor", null),
        (0, K.Cg)([R.oI], Uo.prototype, "OnOpenGradientOuterColor", null),
        (Uo = (0, K.Cg)([_.PA], Uo));
      var Zo = a(73744),
        Xo = a(28954);
      class $o {
          ...
          return (
            $o.s_Singleton ||
              ...
              "dev" == O.TS.WEB_UNIVERSE &&
                (window.g_StoreTagCache = $o.s_Singleton)),
            $o.s_Singleton
          );
        }
        constructor() {
      ...
      let ol = class extends n.Component {
        ...
        render() {
          ...
          return (0, i.jsxs)("div", {
            className: (0, B.A)(t, il.DevEmailEmailBackground, il.EmailSection),
            children: [
              e.BHasHeadline() &&
                (0, i.jsxs)(n.Fragment, {
                  children: [
              ...
              e.BHasVideo() &&
                (0, i.jsxs)(n.Fragment, {
                  children: [
                    ...
                    (0, i.jsxs)("div", {
                      className: il.VideoCtn,
                      children: [
                        (0, i.jsx)("img", { src: e.GetYouTubeImageURL() }),
                        Boolean(s) &&
                          (0, i.jsxs)("div", {
                            className: il.VideoInputCtn,
                            children: [
                              (0, i.jsx)("div", {
                                children: (0, L.we)(
      ...
      (0, K.Cg)([R.oI], ol.prototype, "OnHeadlineChange", null),
        (0, K.Cg)([R.oI], ol.prototype, "OnBodyChange", null),
        (0, K.Cg)([R.oI], ol.prototype, "OnVideoChange", null),
        (0, K.Cg)([R.oI], ol.prototype, "OnRemoveSubSection", null),
        (ol = (0, K.Cg)([_.PA], ol));
        ...
        render() {
          ...
          let t = this.BuildTextOptions(),
            ...
            n = e.BHasButtonAppIDOverride()
              ...
              : e.GetDestination();
          return (0, i.jsxs)("div", {
            className: il.ButtonSettingContainer,
            children: [
              (0, i.jsxs)("div", {
                className: il.ButtonSettingRow,
                children: [
                  (0, i.jsx)("span", {
      ...
      (0, K.Cg)([R.oI], ll.prototype, "OnButtonLocChange", null),
        (0, K.Cg)([R.oI], ll.prototype, "OnDestinationChange", null),
        (0, K.Cg)([R.oI], ll.prototype, "OnChangeStorePageURL", null),
        (ll = (0, K.Cg)([_.PA], ll));
        ...
        render() {
          ...
          return (0, i.jsx)(f.o0, {
            ...
            children: (0, i.jsx)("div", {
              children: (0, i.jsx)("input", {
                type: "test",
                className: il.ButtonDestInputSaleURL,
      ...
      function dl(e) {
        const {
          ...
          u = n.useCallback(
            (e, t, n) => {
              ha.zU.GetExtensionString(e) &&
                a.SetImage(ha.zU.GetHashAndExt(e), n),
                c(n);
            },
            [a],
          ),
        ...
        return (0, i.jsxs)("div", {
          className: il.ImagePreview,
          children: [
            (0, i.jsxs)("div", {
              className: il.FullImageCtn,
              children: [
                (0, i.jsx)("img", {
                  width: m ? (0, Zo.qj)(h.width) : void 0,
                  height: m ? (0, Zo.qj)(h.height) : void 0,
                  src: m,
                }),
                Boolean(l) &&
                  (0, i.jsx)(cl, {
            ...
            p &&
              (0, i.jsx)(sl.h, {
                ...
                fnOnLanguagePreviewChange: (e) => c(e),
                fnOnRemoveImage: (e) => a.SetImage(null, e),
      ...
      (0, K.Cg)([R.oI], rl.prototype, "OnURLUpdate", null),
        (rl = (0, K.Cg)([_.PA], rl));
      let cl = class extends n.Component {
        ...
        RefreshUploader() {
          this.m_clanImageUploader = new Xo.VE(this.props.clanSteamID, [
          ...
          try {
            ...
            for (const a of t)
              if (a.bSuccess && 1 === a.uploadResult.success) {
                ...
                let t = ha.zU.GetExtensionString(a.uploadResult);
        ...
        render() {
          ...
          if (this.state.bDownloadFromClanImageStore)
            return (0, i.jsx)("div", {
              className: il.EditImageInputCtn,
              children: (0, i.jsx)(D.t, {
                position: "center",
                size: "medium",
                string: (0, L.we)("#Loading"),
          ...
          let a = (0, el.fY)(this.m_clanImageUploader, "emailartupload_");
          return (0, i.jsx)("div", {
            className: il.EditImageInputCtn,
            children: (0, i.jsxs)(nl.D, {
      ...
      (0, K.Cg)([R.oI], cl.prototype, "DoUpload", null),
        (0, K.Cg)([R.oI], cl.prototype, "OnDropFiles", null),
        (0, K.Cg)([R.oI], cl.prototype, "RenderInstructions", null),
        (0, K.Cg)([R.oI], cl.prototype, "OnPreviousImageSelected", null),
        (cl = (0, K.Cg)([_.PA], cl));
      const _l =
          a.p +
      ...
      let vl = class extends n.Component {
        ...
        render() {
            ...
            n.push(
              (0, i.jsx)(
                ol,
                {
                  ...
                  appid: e.GetAppID(),
                  section: s,
                  additionalClassName: il.HeaderSection,
                  bTemplateEditable: !0,
          ...
          return (0, i.jsxs)("div", {
            className: il.EmailEditorContent,
            children: [
              (0, i.jsxs)("div", {
                className: il.RightAlign,
                children: [
                  (0, i.jsxs)("span", {
                    className: il.EmailOptionTitle,
              ...
              (0, i.jsxs)("div", {
                className: (0, B.A)(b().FlexRowContainer, il.EmailSubjectCtn),
                children: [
                  (0, i.jsx)("span", {
                    className: il.EmailOptionTitle,
              ...
              (0, i.jsxs)("div", {
                className: (0, B.A)(il.EmailTemplate, il.DevEmailTemplate),
                children: [
                  (0, i.jsx)("div", {
                    className: (0, B.A)(il.CenterAlign, il.DevEmail_TopHeader),
                    children: (0, i.jsx)("a", {
                      href: O.TS.PARTNER_BASE_URL,
                      children: (0, i.jsx)("img", {
                        src: _l,
                        className: il.DevEmail_TopLogo,
                      }),
                    }),
                  }),
                  (0, i.jsx)("div", {
                    className: (0, B.A)(il.DevEmail_Content),
                    children: (0, i.jsx)("div", {
                      className: il.DevEmail_Subject,
                      children: s,
                    }),
                  }),
                  n,
                  (0, i.jsxs)("div", {
                    className: (0, B.A)(il.EmailSection, il.SupportCtn),
                    children: [
                  ...
                  (0, i.jsxs)("div", {
                    ...
                    children: [
                      (0, i.jsx)("img", {
                        src: ul,
                        className: il.DevEmail_SignOff_Img,
                      }),
                      (0, i.jsx)("div", {
                        className: il.DevEmail_Signoff,
                        children: (0, i.jsxs)("div", {
                          children: [
                            "- ",
              ...
              (0, i.jsxs)("div", {
                className: (0, B.A)(il.DevEmail_Footer_Ctn),
                children: [
                  (0, i.jsx)("span", {
                    className: il.DevEmail_Footer_Reason,
                    children: (0, L.we)("#EventEmail_Developer_Footer_Reason"),
                  }),
                  (0, i.jsxs)("div", {
                    className: il.DevEmail_Footer_SubSection,
                    children: [
                      (0, i.jsx)("img", { src: pl, width: 103, height: 43 }),
                      (0, i.jsxs)("div", {
                        children: [
                          (0, i.jsx)("div", {
                            className: il.DevEmail_Footer_Bold,
                          ...
                          (0, i.jsx)("div", {
                            className: il.DevEmail_Footer_Regular,
                            children: (0, L.we)(
              ...
              (0, i.jsx)("button", {
                className: (0, B.A)(b().Button, il.CenterAlign),
                onClick: () => {
                  a.AddSection(ml);
                },
            ...
            children: [
              ...
              (0, i.jsxs)("div", {
                ...
                children: [
                  ...
                  (0, i.jsx)("table", {
                    className: il.DevEmail_RecipientTable,
                  ...
                  Boolean(this.state.nDuplicatesRemoved > 0) &&
                    (0, i.jsx)("div", {
                      className: Un.WarningStylesBackground,
                      children: (0, i.jsx)("b", {
                        children: (0, L.we)(
                          "#EventEmail_Developer_DuplicateRemoved",
                          (0, Mt.D)(this.state.nDuplicatesRemoved),
                        ),
                      }),
                    }),
                  (0, i.jsxs)("div", {
                    className: il.TargetCtn,
                    children: [
                      (0, i.jsx)("div", {
                        className: il.TargetTypeTitle,
                        children: (0, i.jsx)("b", {
                          children: "App Targeting",
                        }),
                      }),
                      (0, i.jsxs)("div", {
                        className: il.TargetTypeCtn,
                        children: [
                          Boolean(e.GetInternalTargetAppCount()) &&
                            (0, i.jsxs)("div", {
                              className: il.TargetedListCtn,
                              children: [
                                (0, i.jsxs)("div", {
                                  children: [
                          ...
                          (0, i.jsxs)("div", {
                            className: il.SelectListCtn,
                            children: [
                              (0, L.we)("#EventEmail_Developer_AddApps"),
                              (0, i.jsx)("label", {
                                className: hl.SelectImageButton,
      ...
      (0, K.Cg)([R.oI], gl.prototype, "OnFileChoice", null),
        (0, K.Cg)([R.oI], gl.prototype, "ShowTargets", null),
        (0, K.Cg)([R.oI], gl.prototype, "ClearTargets", null),
        (gl = (0, K.Cg)([_.PA], gl));
      var Sl = a(1088);
      const El = (e) => {
      ...
      function jl(e) {
        const { editModel: t } = e,
          ...
          [s, o] = (0, aa.q3)(() => [n.GetHeadline(a), n.GetBody(a)]);
        return (0, i.jsx)("div", {
          className: il.EmailEditorContent,
          children: (0, i.jsx)("div", {
            className: il.EmailTemplate,
            children: (0, i.jsxs)("div", {
              className: (0, B.A)(il.DevEmailEmailBackground, il.EmailSection),
              children: [
                (0, i.jsx)("p", {
                  children:
      ...
      const Cl = (0, _.PA)((e) => {
          ...
          const a = (0, oa.H)() !== t.GetClanAccountID();
          return (0, i.jsxs)(n.Fragment, {
            children: [
              (0, i.jsxs)("div", {
                className: il.EmailTabCtn,
                children: [
                  (0, i.jsxs)("div", {
              ...
              Boolean(t.BIsEmailEnabled()) &&
                (0, i.jsxs)("div", {
                  className: Ci.EventEditorInputPaneContainer,
                  children: [
                    a &&
                      (0, i.jsx)(xt.tH, {
                        children: (0, i.jsx)(Nl, { editModel: t }),
                      }),
                    a &&
                      (0, i.jsx)(xt.tH, {
                        children: (0, i.jsx)(yl, { editModel: t }),
                      }),
                    (0, i.jsx)(xt.tH, {
                      children: Boolean((0, oa.H)() === t.GetClanAccountID())
                    ...
                    a &&
                      (0, i.jsx)(xt.tH, {
                        children: O.UF.IS_VALVE_GROUP
                          ? (0, i.jsx)(gl, { editModel: t })
                          : (0, i.jsxs)(n.Fragment, {
                              children: [
                                (0, i.jsx)(Il, { editModel: t }),
                                (0, i.jsx)(Tl, { editModel: t }),
                              ],
                            }),
                      }),
                  ],
      ...
      let yl = class extends n.Component {
        ...
        OnTestEmail(e) {
          ...
          e.preventDefault(),
            Sl.O.BHasValidatedEmail() && !t.BIsDirtyType(ie.IQ.jsondata_email)
              ? (0, y.HT)(
                  (0, i.jsx)(f.o0, {
        ...
        OnPrepareEmail(e) {
          (0, y.pg)(
            (0, i.jsx)(Al, { editModel: this.props.editModel }),
            (0, k.uX)(e),
          );
        }
      ...
      (0, K.Cg)([R.oI], yl.prototype, "FireTestEmail", null),
        (0, K.Cg)([R.oI], yl.prototype, "OnTestEmail", null),
        (0, K.Cg)([R.oI], yl.prototype, "OnPrepareEmail", null),
        (0, K.Cg)([R.oI], yl.prototype, "OnSetupAndFireEmailConfirm", null),
        (0, K.Cg)([R.oI], yl.prototype, "OnSetupAndFireEmail", null),
        (yl = (0, K.Cg)([_.PA], yl));
      const Dl = (0, _.PA)((e) => {
        const { editModel: t } = e;
        let a = new Z.pC(t),
        ...
        const o = t.GetAppID(),
          [l] = (0, zn.t7)(o, { include_basic_info: !0 });
        if (!l)
          return (0, i.jsx)(D.t, {
            string: (0, L.we)("#Loading"),
            position: "center",
          ...
          children: [
            (0, i.jsxs)("div", {
              ...
              children: [
                ...
                (0, i.jsx)("select", {
                  className: il.EmailSubjectSelect,
            ...
            (0, i.jsxs)("div", {
              ...
              children: [
                (0, i.jsx)("div", {
                  className: (0, B.A)(il.EmailIconHeader, il.CenterAlign),
                  children: (0, i.jsx)("img", {
                ...
                (0, i.jsxs)("div", {
                  className: (0, B.A)(il.FooterLegal, b().FlexRowContainer),
                  children: [
                    (0, i.jsx)("img", { src: pl }),
                    (0, i.jsxs)("div", {
                      children: [
      ...
      let Tl = class extends n.Component {
        constructor() {
        ...
        render() {
          ...
          const t = this.GetEmailEditModel();
          return (0, i.jsxs)("div", {
            className: (0, B.A)(b().ValveOnlyBackground, il.RecipientCtn),
            children: [
              (0, i.jsx)("div", {
                className: (0, B.A)(b().EventEditorTextTitle),
                children: (0, i.jsx)("span", {
      ...
      (0, K.Cg)([R.oI], Tl.prototype, "OnControlGroupSpinnerChange", null),
        (Tl = (0, K.Cg)([_.PA], Tl));
      let Il = class extends n.Component {
        ...
        async LoadCreatorHome() {
          ...
          let t = new Array();
          (
            await sa.pF.LoadCreatorHomeListForAppIncludeHiddden(
              e.GetAppID(),
              this.m_cancelSignal,
            )
          ).forEach((e) => {
            let a = v.b.InitFromClanID(e.clan_account_id);
            t.push(sa.pF.LoadCreatorHome(a, !1, this.m_cancelSignal));
          }),
        ...
        BuildCreatorHomeToggle(e) {
          ...
          if (this.state.bLoadingCreator)
            ...
            sa.pF
              ...
              .forEach((n) => {
                let o = sa.pF.GetCreatorHomeByID(n);
                if (
                  o &&
      ...
      Il = (0, K.Cg)([_.PA], Il);
      class Gl extends n.Component {
        render() {
          const { valveOnly: e, label: t } = this.props;
          return (0, i.jsxs)("div", {
            className: il.TargetAndAudience,
            children: [
              (0, i.jsxs)("span", {
              ...
              (0, i.jsx)("span", {
                children:
                  ...
                  (0, Mt.D)(this.props.audience),
              }),
            ],
          });
        }
      }
      let Al = class extends n.Component {
        constructor() {
          super(...arguments),
            (this.state = {
      ...
      (0, K.Cg)([R.oI], Al.prototype, "OnLockEmail", null),
        (Al = (0, K.Cg)([_.PA], Al));
      let Nl = class extends n.Component {
        constructor() {
          super(...arguments),
      ...
      (0, K.Cg)([R.oI], Nl.prototype, "RefreshIfNeeded", null),
        (0, K.Cg)([R.oI], Nl.prototype, "RefreshStats", null),
        (Nl = (0, K.Cg)([_.PA], Nl));
      var Ml = a(85345),
        Bl = a(71150),
        kl = a(13899),
        ...
        return (0, i.jsxs)("div", {
          ...
          children: [
            (0, i.jsxs)("div", {
              ...
              children: [
                (0, i.jsx)(zl, { editModel: t }),
                (0, i.jsx)(kl.u, { bHideEndRange: !a, editModel: t }),
                Boolean(t.BHasTag("steam_award_nomination_request")) &&
                  (0, i.jsx)(Ml.ks, {}),
                (0, i.jsx)(Ul, { editModel: t }),
                (!s || n.valve_admin) && (0, i.jsx)(Pl, { editModel: t }),
                (0, i.jsx)("div", { className: b().ClearThings }),
              ],
            }),
            (0, i.jsxs)("div", {
              className: (0, B.A)(fi().OptionsNotes, b().RightCol),
              children: [
                (0, i.jsx)("span", {
                  className: b().EventEditorTextTitle,
            ...
            children: [
              ...
              (0, i.jsxs)("div", {
                ...
                children: [
                  ...
                  Boolean(!1) && (0, i.jsx)(Fl, { editModel: t }),
        ...
        const { editModel: t } = e,
          a = (function (e) {
            const t = (0, cn.I)({
              ...
              queryFn: async () => {
                var t;
                const a = `${_n.TS.COMMUNITY_BASE_URL}demos/ajaxgetappdemoinfo`,
          ...
          children: [
            ...
            (0, i.jsxs)("div", {
              ...
              children: [
                ...
                Boolean(t.GetClanAccountID() == Pt.bv) &&
                  (0, i.jsx)(E.RF, {
                ...
                Boolean(
                  t.GetClanAccountID() == Pt.GU ||
                    ((O.TS.EUNIVERSE == r.Rv || O.TS.EUNIVERSE == r.CII) &&
                      t.GetClanAccountID() == Pt.mW),
                ) &&
                  (0, i.jsx)(E.RF, {
        ...
        render() {
          ...
          let s = e.GetVisibilityPublishingSetup(),
            o =
              ...
              s == ie.Fl.event_start;
          return (0, i.jsx)("div", {
            className: (0, B.A)(fi().EventEditorInputPaneContents),
            children: (0, i.jsxs)("div", {
              className: (0, B.A)(b().LeftCol, Rl().ThemedCtn),
              children: [
                (0, i.jsx)("div", {
                  className: b().EventEditorTextTitle,
      ...
      (0, K.Cg)([R.oI], Ul.prototype, "TestFireEvent", null),
        (Ul = (0, K.Cg)([_.PA], Ul));
      const zl = (0, _.PA)((e) => {
        const { editModel: t } = e;
            ...
            children: [
              (0, i.jsxs)("div", {
                ...
                children: [
                  ...
                  (0, i.jsx)("span", {
                    className: fi().RequiredFieldLabel,
      ...
      function ql(e) {
        const t =
            ...
            L.A0.IsELanguageValidInRealm(
              e.GetCurEditLanguage(),
              Ls.TU.k_ESteamRealmChina,
            ),
          a =
            e.BInRealmGlobal() &&
            L.A0.IsELanguageValidInRealm(
              e.GetCurEditLanguage(),
              Ls.TU.k_ESteamRealmGlobal,
            );
      ...
      const Vl = (0, _.PA)((e) => {
        ...
        Yl = (0, _.PA)((e) => {
          const { editModel: t } = e;
          return ((e) => {
            const [t] = (0, zn.t7)(e, Et.A.k_DataRequest_CommonOnly);
            return Boolean(t && t.HasContentDescriptorID(Bl.u7));
          })(t.GetAppID())
            ? (0, i.jsx)(E.RF, {
                onChange: (e) => t.SetTag("adult_only_content", e),
      ...
      const $l = (0, _.PA)((e) => {
        ...
        const w = t.BAllowedToPublishStagedEvents(),
          C = p && !h;
        return (0, i.jsxs)("div", {
          className: (0, B.A)(b().FlexColumnContainer, Zl().PublishOption),
          children: [
            (0, i.jsx)("div", {
              className: b().EventEditorTextTitle,
            ...
            (0, i.jsxs)("div", {
              className: (0, B.A)(Zl().PublishButtonCtn),
              children: [
                C &&
                  (0, i.jsxs)(i.Fragment, {
                    children: [
      ...
      function er(e) {
        ...
        return (0, i.jsxs)("div", {
          children: [
            a &&
              (0, i.jsx)("div", { className: Zl().Description, children: a }),
            (0, i.jsxs)(E.$n, {
              onClick: l,
              className: (0, B.A)(
                Zl().EventPublishButton,
      ...
      function or(e) {
        ...
        const { editModel: a } = e,
          ...
          l = (0, ua.m)("EventReplacePublishingControls"),
          ...
          : j
            ? (0, i.jsx)(vt.t, {
                ...
                elSuccessDisplayLinks: (0, i.jsx)("a", {
                  href: `${Zs.TS.COMMUNITY_BASE_URL}/gid/${null == g ? void 0 : g.ConvertTo64BitString()}/partnerevents/edit/${s}`,
      ...
      function ur(e) {
        const { editModel: t } = e,
          [a] = (0, aa.q3)(() => [t.BHasTag("vo_marketing_message")]);
        if (a) return (0, i.jsx)(hr, { ...e });
      }
      const pr = 3;
      function hr(e) {
        var t, a;
              ...
              children: Boolean(c)
                ? (0, i.jsx)("p", {
                    children: (0, L.oW)(
                      ...
                      (0, i.jsx)(ma.uU, {
                        href: `${_n.TS.HELP_BASE_URL}en/wizard/HelpRequest/${c}`,
                        className: (0, B.A)(j.EditPreviewButton, j.Button),
                        bForceExternal: !0,
                      }),
                    ),
                ...
                : (0, i.jsxs)(i.Fragment, {
                    children: [
                      (0, i.jsx)("p", {
                        children: (0, L.we)("#MM_MajorUpdate_Review_desc", pr),
                      }),
                      (0, i.jsx)(pn, {
                        accountID: _n.iA.accountid,
                        partnerID: u,
                        fnSetPartnerID: p,
                        strLabel: (0, L.we)(
                          "#EventEditor_SaleValveApproval_Request_Partner",
          ...
          children: (0, i.jsx)("div", {
            ...
            children: (0, i.jsxs)("div", {
              ...
              children: [
                ...
                (0, i.jsxs)("div", {
                  className: (0, B.A)(j.FlexRowContainer, tr.PublishOptionsCtn),
                  children: [
                    (0, i.jsx)(Xl, { editModel: t, bTakePublishAction: !1 }),
                    (0, i.jsx)(or, { editModel: t }),
                  ],
                }),
                (0, i.jsx)(ur, { editModel: t }),
                (0, i.jsx)(gr, { eventType: s, clanSteamID: a }),
      ...
      let gr = class extends n.Component {
        constructor() {
          super(...arguments),
            (this.state = {
      ...
      function Sr(e) {
        const t = o.mh.GetEditModel(),
          a = (function (e, t) {
            const [a, i] = (0, n.useState)(ir.Get().GetVisibilityRounds(e, t));
            return (
              (0, n.useEffect)(() => {
                (a &&
                  0 != a.length &&
              ...
              (0, R.hL)(ir.Get().GetVisibilityRoundsChangeCallback(e, t), i),
              a
            );
          })(nr.tw.I8, t.GetAppID());
        return (0, i.jsxs)("div", {
              ...
              case ie.Fl.specified_time:
                p = (0, i.jsx)("div", {
                  ...
                  children: (0, i.jsx)("p", {
                    children: (0, L.PP)(
                      "#EventEditor_Status_WillBeVisible_At",
                      (0, i.jsx)(U.K4, { dateAndTime: _, bSingleLine: !0 }),
                    ),
                  }),
                });
                break;
            ...
            (0, i.jsxs)("div", {
              ...
              children: [
                ...
                u &&
                  (0, i.jsx)("div", {
                    className: j.FlexRowContainer,
                    children: (0, i.jsx)(po, { editModel: t }),
                  }),
              ],
            }),
          ],
      ...
      function xr(e) {
        ...
        const { bInitiatePublishDialog: a, clanSteamID: s } = e,
          o = (0, ua.m)("EventInputPane"),
          l = (0, $t.LU)(),
          r = l.GetEventModel();
        (0, n.useEffect)(() => {
          O.UF.IS_CURATOR && sa.pF.LoadCreatorHome(s, !1, o);
        }, [s, o]);
        const d = (0, n.useCallback)(() => {
            const e = sa.pF.GetCreatorHome(s);
            if (
              O.iA.is_support &&
              ...
              return !(
                e.BHasClanAccountFlagSet(Xt.Wv.bM) ||
                e.BHasClanAccountFlagSet(Xt.Wv._x) ||
                e.BHasClanAccountFlagSet(Xt.Wv.Jb) ||
          ...
          x = [
            {
              ...
              key: "description",
              status: (0, i.jsx)(br, { fnGetStatus: ta._P }),
              hidden: h.bVisible,
              contents: (0, i.jsx)(xt.tH, {
                children: (0, i.jsx)(eo, {
                  editModel: l,
            ...
            },
            {
              ...
              contents: (0, i.jsx)(xt.tH, {
                children: (0, i.jsx)(vo, { mode: 2, editModel: l }),
              }),
              onClick: E,
            },
            {
              ...
              key: "options",
              status: (0, i.jsx)(br, { fnGetStatus: ta.e5 }),
              hidden: h.bVisible,
              contents: (0, i.jsxs)(xt.tH, {
                children: [
                  (0, i.jsx)(Ol, { editModel: l }),
                  (0, i.jsx)("div", { className: b().ClearThings }),
                ],
              }),
              onClick: E,
            },
            {
              ...
              key: "artwork",
              status: (0, i.jsx)(br, { fnGetStatus: ta.uu }),
              hidden: !O.UF.CAN_UPLOAD_IMAGES || h.bVisible,
              vo_warning: d() && (0, L.we)("#EventEditor_CuratorImageWarning"),
              contents: (0, i.jsx)(Tr, { editModel: l }),
              onClick: E,
            },
            {
              ...
              key: "broadcast",
              hidden:
                !O.UF.CAN_UPLOAD_IMAGES || l.GetClanAccountID() == (0, oa.H)(),
              vo_warning: d() && (0, L.we)("#EventEditor_CuratorImageWarning"),
              contents: (0, i.jsx)(xt.tH, {
            ...
            },
            {
              ...
              hidden: m,
              status:
                l.GetClanAccountID() == (0, oa.H)()
                  ? (0, i.jsx)(br, { fnGetStatus: ta.ER })
                  : void 0,
              contents: (0, i.jsx)(xt.tH, {
                children: (0, i.jsx)(Cl, { editModel: l }),
              }),
              onClick: E,
            },
            {
              ...
              key: "sale",
              status: (0, i.jsx)(br, { fnGetStatus: () => _ }),
              statusToolTip: null == _ ? void 0 : _.ttip,
              hidden: !c.bVisible,
              vo_warning: d() && (0, L.we)("#EventEditor_CuratorImageWarning"),
              contents: (0, i.jsx)(xt.tH, {
                children: (0, i.jsx)(vo, { mode: 0, editModel: l }),
              }),
              onClick: E,
            },
            {
              ...
              status: (0, i.jsx)(br, { fnGetStatus: () => p }),
              statusToolTip: null == p ? void 0 : p.ttip,
              hidden: !u.bVisible,
              vo_warning: d() && (0, L.we)("#EventEditor_CuratorImageWarning"),
              contents: (0, i.jsx)(xt.tH, {
                children: (0, i.jsx)(vo, { mode: 1, editModel: l }),
              }),
              onClick: E,
            },
            {
              ...
              key: "publishing",
              contents: (0, i.jsx)(xt.tH, {
                children: (0, i.jsx)(vr, { editModel: l }),
              }),
              onClick: E,
            },
            {
              ...
              contents: (0, i.jsx)(xt.tH, {
                children: (0, i.jsx)(ea.Oq, { editModel: l }),
              }),
              onClick: E,
            },
            {
              ...
              contents: (0, i.jsx)(xt.tH, {
                children: (0, i.jsx)(bo, { editModel: l }),
              }),
              onClick: E,
            },
          ];
      ...
      function jr(e) {
        ...
        return (0, i.jsx)("div", {
          className: fi().EventEditorInputPaneContainer,
          children: (0, i.jsxs)(Xi, {
            elContent: t,
            children: [
              (0, i.jsx)("div", {
                className: fi().EventEditorInputPaneContents,
              ...
              (0, i.jsx)("div", {
                ...
                children: (0, i.jsx)(ts, { setAdditionalContentDiv: a }),
              }),
            ],
          }),
        });
        ...
        wr = (0, _.PA)((e) => {
          ...
          const {
            ...
            c = !(O.UF.IS_CREATOR_HOME || O.UF.IS_CURATOR)
              ? null === (t = Et.A.Get().GetApp(l)) || void 0 === t
                ? void 0
                : t.GetName()
              : O.UF.VANITY_ID,
            _ = o.mh.GetEditModel();
            ...
            children: (0, i.jsxs)("div", {
              ...
              children: [
                ...
                (0, i.jsxs)("div", {
                  className: (0, B.A)(
                    b().FlexColumnContainer,
                    fi().EventEditBelowTopBarContainer,
                  ),
                  children: [
                    (0, i.jsx)("div", {
                      className: fi().EventEditBelowTopBarGameName,
                      children: c,
                    }),
                    (0, i.jsxs)("div", {
                      className: fi().EventEditBelowTopBarRow,
                      children: [
                        (0, i.jsx)(Cr, { editModel: _ }),
                        (0, i.jsx)(ae.Gq, {
                          toolTipContent: _.GetName(),
                          direction: "bottom",
                          children: (0, i.jsx)("div", {
                            className: fi().EventEditBelowTopBarEventName,
                            children: _.GetName(),
                          }),
                        }),
                      ],
        ...
        return (0, i.jsxs)(i.Fragment, {
          children: [
            _ &&
              (0, i.jsx)(u.N_, {
                className: (0, B.A)(
                  fi().EventEditBelowTopBarCategoryChoice,
                  fi().AllowHover,
                ),
            ...
            !_ &&
              (0, i.jsx)("div", {
                className: fi().EventEditBelowTopBarCategoryChoice,
                children: h,
              }),
          ],
        });
      ...
      class Dr extends n.Component {
        ...
        render() {
          return this.m_bRedirect
            ...
            : (0, i.jsx)(yr, { ...this.props });
        }
      }
      function Tr(e) {
        const { editModel: t } = e,
          [a, n, s, l, d, c, _, u, p] = (0, aa.q3)(() => {
            return [
              t.GetEventType(),
        ...
        return (0, i.jsxs)(xt.tH, {
          children: [
            (0, i.jsxs)("div", {
              className: fi().ArtworkTipsCtn,
              children: [
                (0, i.jsxs)("div", {
                  className: fi().ArtworkTips,
                  children: [
                    (0, i.jsxs)("p", {
                      children: [
                        (0, i.jsx)("strong", {
                ...
                (0, i.jsxs)("a", {
                  ...
                  className: fi().ArtworkDocs,
                  target: O.TS.IN_CLIENT ? void 0 : "_blank",
                  children: [
                    (0, i.jsx)("div", {
                      className: fi().ArtworkExampleCtn,
                      children: (0, i.jsx)("img", {
                        className: fi().ArtworkExampleThumbnail,
                        src: O.TS.IMG_URL + "events/thumb_library_home.jpg",
                      }),
                    }),
                    (0, i.jsx)("div", {
                      className: fi().ArtworkExampleTitle,
            ...
            (0, i.jsx)(ra.it, {
              ...
              headerHint: (0, q.bc)(a, l) ? ra.uE.k_Required : void 0,
              elEventArtworkExample: (0, i.jsx)(va, { artworkType: "capsule" }),
              partnerEventStore: o.mh,
            }),
            (0, i.jsx)(ra.it, {
              clanSteamID: s,
              ...
              elEventArtworkExample: (0, i.jsx)(va, {
                artworkType: "background",
              }),
              partnerEventStore: o.mh,
            }),
            Boolean(c && (v || g || m)) &&
              (0, i.jsxs)("div", {
                ...
                children: [
                  ...
                  (0, i.jsx)("div", {
                    className: (0, B.A)(ca().SelectImageBlock, ca().Tips),
                    children: (0, L.we)(
            ...
            Boolean(m && !c) &&
              (0, i.jsx)(ra.it, {
                ...
                headerHint: (0, q.Ch)(a) ? ra.uE.k_Suggested : void 0,
                elEventArtworkExample: (0, i.jsx)(va, {
                  artworkType: "spotlight",
                }),
                partnerEventStore: o.mh,
      ...
      class kr {
        ...
        static Get() {
          return (
            kr.s_globalSingletonStore ||
              ((kr.s_globalSingletonStore = new kr()),
              ("dev" != O.TS.WEB_UNIVERSE && "beta" != O.TS.WEB_UNIVERSE) ||
                (window.g_DeckCompatCountStores = kr.s_globalSingletonStore)),
            kr.s_globalSingletonStore
          );
        }
        constructor() {
          if (
            ...
            kr.ValidateListCompat(e) && (this.m_counts = e);
          }
        }
      ...
      function qr(e) {
            ...
            () => [
              {
                ...
                deposit_package: a,
                localized_reservation_desc: (0, Ii.$Y)([], r.bP9, null),
                localized_out_of_stock_override: (0, Ii.$Y)(
                  [l || null],
                  r.bP9,
                  null,
                ),
                localized_delivery_override_desc: (0, Ii.$Y)(
                  [d || null],
                  r.bP9,
                  null,
                ),
        ...
        const m = !Zs.iA.logged_in || !u.account_restricted_from_purchasing,
          v =
            u.reservation_state == Hr.G.k_EPurchaseReservationState_Reserved
              ? u
              : void 0;
        return (0, i.jsxs)(xt.tH, {
          children: [
      ...
      function td(e) {
        const { appid: t, color: a, bgcolor: n } = e,
          ...
          l = (0, Qr.L3)(s);
        return (0, i.jsx)("div", {
          className: $r().WishlistHoverCtn,
          children: (0, i.jsx)(Kr.E, {
            snr: l,
            id: o,
            classOverride: (0, B.A)(
              Jr().WishlistButtonNotTop,
              $r().BBCodeWishlistButton,
              "WishlistButton",
            ),
      ...
      function ad(e) {
        ...
        if (!t) return null;
        const a = (0, Zr.O)(e.args.color, "black"),
          n = (0, Zr.O)(e.args.bgcolor, "white");
        return (0, i.jsx)(td, { appid: t, color: a, bgcolor: n });
      }
      var nd = a(10026),
        id = a.n(nd),
        sd = a(76217),
      ...
      function _d(e) {
        const { appID: t, classOverride: a, styleOverride: s } = e,
          ...
          { elDialogElement: d, fnShowLogonDialog: c } = (0, rd.E)(),
          _ = (0, od.Fh)(t),
          { mutateAsync: u } = (0, ld.L)(t, !_, void 0);
        return (0, i.jsxs)(sd.Z, {
          className: (0, B.A)(cd().FollowButton, a),
          onClick: async (e) => {
            e.preventDefault(),
              e.stopPropagation(),
              O.iA.logged_in
          ...
          style: s,
          children: [
            _ ? (0, i.jsx)(fn.pPV, {}) : (0, i.jsx)(fn.c9e, {}),
            (0, i.jsx)("div", {
              className: (0, B.A)(
                cd().FollowButtonText,
                o && cd().FollowLoadingText,
                "FollowGameButton",
              ),
              children: (0, L.we)(
      ...
      function ud(e) {
        ...
        return (0, i.jsx)(_d, {
          appID: t,
          classOverride: (0, B.A)(
            Jr().FollowGameButtonNotTop,
            id().BBCodeFollowButton,
          ),
          styleOverride: { color: a, backgroundColor: n },
        });
      }
              ...
              children: [
                Boolean(l) &&
                  (0, i.jsx)("div", {
                    ...
                    children:
                      o > 0
                        ? (0, L.we)("#Giveaway_Closed", (0, Mt.D)(o))
                    ...
                    children: [
                      Boolean(r <= 0)
                        ...
                        : (0, i.jsxs)("div", {
                            ...
                            children: [
                              (0, i.jsx)("div", {
                                className: md.CountDownTime,
                                children:
                                  vd(Math.floor(r / 60)) + ":" + vd(r % 60),
                              }),
                              (0, i.jsxs)("div", {
                                className: md.CountDownText,
                                children: [
                      ...
                      Boolean(o > 0) &&
                        (0, i.jsxs)("div", {
                          className: md.WinnerInfo,
                          children: [
                            (0, i.jsx)("div", {
                              className: md.WinnerCount,
                              children: (0, Mt.D)(o),
                            }),
                            (0, i.jsx)("div", {
                              className: md.WinnerText,
      ...
      function Id(e) {
        ...
        return O.iA.logged_in && a
          ? (0, i.jsx)(Dd, { nEventBadgeID: a, eventModel: t })
          : null;
      }
      function Gd(e) {
        const { nDoorIndex: t, children: a } = e,
          s = (0, Or.OM)(t),
          { fnOpenDoor: o } = (0, Or.OC)(),
          [l, r] = n.useState(!1),
          [d, c] = n.useState(!1);
        return (0, i.jsx)(E.$n, {
          disabled: s,
      ...
      function Ad(e) {
        ...
        return t >= 0 && t < 32
          ? (0, i.jsx)(Gd, { nDoorIndex: t, children: e.children })
          : null;
      }
      const Nd = (0, gt.y)(fd.H);
      function Md(e) {
        var t, a;
        ...
        if (n) {
          ...
          if (l >= 0) {
            ...
            return (0, i.jsx)(wa.Cs, {
              location: o ? wa.HY : wa.bs,
              children: (0, i.jsx)(Nd, {
                event: s,
                section: s.jsondata.sale_sections[l],
                activeTab: new bd.y(null, t),
                language: e.language,
                nSaleDayIndex: t,
                promotionName: "",
                appVisibilityTracker: null,
                ePreviewMode: o
                  ? yd.S.EPreviewMode_Enabled
                  : yd.S.EPreviewMode_Disabled,
              }),
            });
          }
          if (o)
            return (0, i.jsxs)("div", {
              className: jd.ErrorDiv,
      ...
      function Rd(e) {
        ...
        return (0, i.jsx)("div", {
          className: (0, B.A)(kd().BBCodeFollowButton, o && kd().isHovered),
          onMouseEnter: () => l(!0),
          onMouseLeave: () => l(!1),
          children: (0, i.jsx)(Ld.Q, {
            nCreatorAccountID: t,
            classOverride: Jr().FollowGameButtonNotTop,
      ...
      function Od(e) {
        ...
        if (!a) return null;
        const n = (0, Zr.O)(e.args.color, "black"),
          s = (0, Zr.O)(e.args.bgcolor, "white");
        return (0, i.jsx)(Rd, { clanAccountID: a, color: n, bgcolor: s });
      }
      let Pd = null;
      function Fd(e) {
        const { event: t } = e.context,
          ...
          s = Number.parseInt((0, Br.j$)(e.args, "maxquantity")),
          o = (0, Br.j$)(e.args, "calltoaction");
        return (0, Rr.gS)(a, n)
          ? (0, i.jsx)(Vr.f, {
              language: e.language,
      ...
      function Hd(e) {
        const t = (function () {
          const [e, t] = n.useState(kr.Get().GetCounts());
          return (
            n.useEffect(() => {
              e || kr.Get().LoadCounts().then(t);
            }, []),
            e
          );
        })();
        ...
        return (0, i.jsx)("span", { children: (0, Mt.D)(Number(s)) });
      }
      function Ud(e) {
        var t, a, n, s;
        const o = (0, Lr.j)(O.iA.accountid, "library");
        if (!o) return (0, i.jsx)(D.t, { size: "small" });
        const l = Number.parseInt((0, Br.j$)(e.args));
        let r =
        ...
        return (0, i.jsx)("span", { children: (0, Mt.D)(Number(r)) });
      }
      function zd(e) {
        ...
        return t >= 0
          ? (0, i.jsx)(qd, { nDoorIndex: t, bHide: a, children: e.children })
          : null;
      }
      function qd(e) {
      ...
      function Yd(e) {
        let t = (0, Br.j$)(e.args);
        return t
          ? (0, i.jsx)(gd, { giveawayid: t })
          : (0, i.jsx)(n.Fragment, {});
      }
      function Jd(e) {
        const { showErrorInfo: t, event: a } = e.context,
          s = Number.parseInt((0, Br.j$)(e.args)),
          o = n.useMemo(() => {
            var e;
        ...
        if (s && o) {
          const t = Number.parseInt((0, Br.j$)(e.args, "depositpackageid")),
            a = Number.parseInt((0, Br.j$)(e.args, "psulesspackageid")),
            n = (0, Br.j$)(e.args, "out_of_stock_override"),
            l = (0, Br.j$)(e.args, "delivery_override"),
            r = (0, Br.j$)(e.args, "delivery_override_out_of_stock");
          return (0, i.jsx)(qr, {
            section: o,
      ...
      function ac(e) {
        const [t, a] = n.useState(!0),
          r = (0, $d.vb)(O.TS.LANGUAGE);
        return (
          n.useEffect(() => {
            Ar.Vw.Init(new Gr.D(O.TS.WEBAPI_BASE_URL)),
              Nr.O3.Init(),
              o.mh.Init(),
              Kd.us.AddDictionary(
                (null == Pd &&
                  (Pd = new Map([
                    ...
                    ["wishlist", { Constructor: ad, autocloses: !1 }],
                    ["followgame", { Constructor: pd, autocloses: !1 }],
                    ["followgroup", { Constructor: Od, autocloses: !1 }],
                    ["deckcompatcount", { Constructor: Hd, autocloses: !1 }],
                    [
                      "deckcompatuserlibrarycount",
                      { Constructor: Ud, autocloses: !1 },
                    ],
                    ["giveawayinfo", { Constructor: Yd, autocloses: !1 }],
                    ["price", { Constructor: Sd.zD, autocloses: !1 }],
                    ["pricesavings", { Constructor: Sd.y7, autocloses: !1 }],
                    [
                      "eventdoorvisibility",
                      { Constructor: zd, autocloses: !1 },
                    ],
                    ["chooseaccount", { Constructor: Vd, autocloses: !1 }],
                    ["badgecurrentlevel", { Constructor: Id, autocloses: !1 }],
                    ["optindoorquest", { Constructor: Ad, autocloses: !1 }],
                    ["classname", { Constructor: Wd, autocloses: !1 }],
                    ["localize", { Constructor: Qd, autocloses: !1 }],
                    ["salesection", { Constructor: Md, autocloses: !1 }],
                    ["reservationbutton", { Constructor: Jd, autocloses: !1 }],
                  ])),
                Pd),
              ),
          ...
          t || !r
            ...
            : (0, i.jsx)(xt.tH, {
                children: (0, i.jsxs)(Zd.I.Provider, {
                  value: { bCanUseLink: !0 },
                  children: [
                    (0, i.jsx)(yn.EB, {}),
                    (0, i.jsxs)(gt.dO, {
    ...
    19369: (e, t, a) => {
      ...
      (0, n.Cg)([v.sH], E.prototype, "m_mapProfiles", void 0);
      const x = new E();
      var j = a(37085),
        b = a(12155),
        w = a(86328),
      ...
      class y extends s.Component {
        ...
        async LoadProfile(e) {
          if (e) {
            ...
            await x.LoadProfiles([t.ConvertTo64BitString()]);
            const a = x.GetProfile(t.ConvertTo64BitString());
            a
              ? this.setState({
                  searchResult: a,
                  disable_send_invite:
