      ...
      class Y extends r.PureComponent {
        ...
        render() {
          const e =
            ...
            `${F.TS.STORE_CDN_URL}public/images/loyalty/reactions/${s ? "animated" : "still"}/${t}.png`);
          var t, s;
          return (0, n.jsx)("img", {
          ...
          P = (function (e, t) {
            return (0, m.I)({
              ...
              queryFn: async () => {
                ...
                if (1 == a.GetEResult())
                  return o.A.fromString(a.Body().summary().points());
                throw a.GetEResult();
              },
              enabled: e,
            });
        ...
        render() {
          ...
          return (0, n.jsxs)(U, {
            ...
            children: [
              ...
              s && (0, n.jsx)(K, { className: Z.IconCheckMark }),
            ],
          });
        }
      }
