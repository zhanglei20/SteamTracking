...
(self.webpackChunkHelp = self.webpackChunkHelp || []).push([
  [1574],
  {
    ...
    544: (e, s, r) => {
      ...
      var p = r(7647);
      const h = p.IE.reduce((e, s, r) => ((e[s] = r), e), {});
      function d(e, s) {
        if ("object" != typeof e) return e;
        for (let r = h[s]; r >= 0; r--) if (p.IE[r] in e) return e[p.IE[r]];
        return e.initial;
      }
      const C = {
        0: !0,
      ...
      function m(e, s) {
        return (function (e, s, r) {
          const t = [],
            n = {},
            o = {},
            { extracted: i, remaining: a } = (function (e, s) {
          ...
          for (const a of s) {
            if (!(a.prop in i)) continue;
            let s = i[a.prop];
            if (
              void 0 !== s &&
              (a.responsive && (s = d(s, r.formFactor)), void 0 !== s)
            ) {
              if (a.className) {
                if (
                  !a.cssProperty &&
              ...
              if (a.dataProperty)
                if ("function" == typeof a.dataProperty) {
                  const [e, r] = a.dataProperty(s);
                  o[`data-${e}`] = r;
                } else o[`data-${a.dataProperty}`] = s;
            }
          }
          return (
            "className" in a &&
            ...
            "style" in a &&
              ...
              Object.assign(n, a.style),
            { ...o, ...a, className: t.join(" "), style: n }
          );
        })(e, s, { formFactor: (0, p.xC)() });
      }
      function _(e) {
        return (function (e) {
          return !!C[e];
      ...
      const x = [
          ...
          { prop: "marginY", responsive: !0, className: (e) => f[`my-${e}`] },
          { prop: "marginTop", responsive: !0, className: (e) => f[`mt-${e}`] },
          {
            prop: "marginRight",
            responsive: !0,
            className: (e) => f[`mr-${e}`],
          ...
          { prop: "marginEnd", responsive: !0, className: (e) => f[`me-${e}`] },
        ],
        v = [
          ...x,
          { prop: "padding", responsive: !0, className: (e) => f[`p-${e}`] },
          { prop: "paddingX", responsive: !0, className: (e) => f[`px-${e}`] },
          { prop: "paddingY", responsive: !0, className: (e) => f[`py-${e}`] },
          {
            prop: "paddingTop",
            responsive: !0,
            className: (e) => f[`pt-${e}`],
          ...
          },
          {
            prop: "minHeight",
            responsive: !0,
            className: f.MinHeight,
            cssProperty: "--min-height",
          },
          {
            prop: "maxHeight",
            responsive: !0,
            className: f.MaxHeight,
            cssProperty: "--max-height",
          },
          {
            prop: "flexBasis",
            responsive: !0,
            className: f.FlexBasis,
            cssProperty: "--flex-basis",
          },
          {
            prop: "flexGrow",
            responsive: !0,
            className: f.FlexGrow,
            cssProperty: "--flex-grow",
          },
          {
            prop: "flexShrink",
            responsive: !0,
            className: f.FlexShrink,
            cssProperty: "--flex-shrink",
          },
          {
            prop: "radius",
            responsive: !0,
            className: (e) => f[`Radius-${e}`],
          },
          {
            prop: "cursor",
            responsive: !0,
          ...
          },
          {
            ...
            responsive: !0,
            className: f.Inset,
            cssProperty: (e) => ["--inset", _(e)],
          },
          {
            prop: "gridColumn",
            responsive: !0,
            className: f.GridColumn,
            cssProperty: "--grid-column",
          },
          {
            prop: "gridColumnStart",
            responsive: !0,
            className: f.GridColumnStart,
            cssProperty: "--grid-column-start",
          },
          {
            prop: "gridColumnEnd",
            responsive: !0,
            className: f.GridColumnEnd,
          ...
          },
          {
            prop: "gridRowStart",
            responsive: !0,
            className: f.GridRowStart,
            cssProperty: "--grid-row-start",
          },
          {
            prop: "gridRowEnd",
            responsive: !0,
            className: f.GridRowEnd,
            cssProperty: "--grid-row-end",
          },
          {
            prop: "gridArea",
            responsive: !0,
            className: f.GridArea,
            cssProperty: "--grid-area",
          },
          {
            prop: "alignSelf",
            responsive: !0,
            className: f.AlignSelf,
            cssProperty: "--align-self",
          },
          {
            prop: "justifySelf",
            responsive: !0,
            className: f.JustifySelf,
          ...
          },
          {
            prop: "borderColor",
            responsive: !0,
            className: [f.Border, f.BorderColor].join(" "),
            cssProperty: (e) => ["--border-color", u(e)],
          },
          {
            prop: "outline",
            responsive: !0,
            className: f.Outline,
            cssProperty: (e) => ["--outline-color", u(e)],
          },
          {
            prop: "textAlign",
            responsive: !0,
      ...
      var j = r(4238),
        ...
        y = r(8875);
      function w(e) {
        const { as: s = "div", ref: r, ...n } = e,
          o = m({ ...n, className: H()(e.className, y.Flex) }, S),
          i = !n.disabled && !!n.onClick,
          a = s;
        return (0, t.jsx)(l, {
          focusable: i,
          children: (0, t.jsx)(a, { ref: r, ...o }),
        });
      }
      const S = [
        ...v,
            ...
            if (!/^[1-6]$/.test(r))
              return "auto" === e
                ...
                : (console.error(
                  ...
                  "h1");
            return "h" + r;
          })(s, (0, o.useContext)(P).depth);
        return (0, t.jsx)(i, {
          ...m({ ...e, className: H()(T(), b.Heading, r) }, E),
        });
      }
      const E = [
        ...z,
      ...
      function I(e) {
        ...
        return (0, t.jsx)(n, {
          ...m({ ...r, underline: s, className: k.TextLink }, G),
        });
      }
      const G = [
        ...M,
      ...
      function O(e) {
        const { as: s = "div", ref: r, ...n } = e,
          o = m({ ...n, className: H()(W.Box, e.className) }, D),
          i = s;
        return (0, t.jsx)(i, { ref: r, ...o });
      }
      const D = v;
      function K(e) {
        const {
              ...
              children: [
                ...
                r &&
                  (0, t.jsx)(w, {
                    ...
                    justify: "center",
                    align: "center",
                    children: (0, t.jsx)(Y, { size: s, color: o, variant: i }),
                  }),
              ],
            })
      ...
      function Y(e) {
        const { className: s, color: r, ...n } = m(e, Q);
        return (0, t.jsx)("div", {
          "data-accent-color": r,
      ...
      const q = [
        ...
        X = function (e) {
          const {
            ...
            d = i
              ...
              : a,
            C = i ? void 0 : c,
            _ = p && U.TS.IN_GAMEPADUI ? Z.fu : "button";
          return (0, t.jsx)(_, {
            type: "button",
            ...m(
              {
        ...
        $ = function (e) {
          const {
              ...
              disabled: o,
              icon: i,
              gamepadFocusable: a = !0,
              ...c
            } = e,
            l = o ? J : void 0,
            p = a && U.TS.IN_GAMEPADUI ? Z.Ii : "a";
          return (0, t.jsx)(p, {
            ...m(
              {
                onClick: l,
                ...
                size: r,
                minWidth: n,
                className: H()(B.Button, i && B.Icon, T()),
              },
              q,
            ),
          });
      ...
      function re(e) {
        const { as: s = "div", ref: r, ...n } = e,
          o = m({ ...n, className: H()(se.Grid, e.className) }, te),
          i = s;
        return (0, t.jsx)(l, {
          "flow-children": "grid",
          children: (0, t.jsx)(i, { ref: r, ...o }),
        });
      }
      const te = [
        ...v,
      ...
      function oe(e, s = ["b", "i", "br"]) {
        const r = s.join("|"),
          t = [],
          n = new RegExp(
            `(?<before>.*?)<(?<tagname>${r})>(?<contents>.*?)(?<endtag><\\/\\2>|$)`,
            "gs",
          );
        let i,
          a = 0;
        for (; (i = n.exec(e)); ) {
          ...
          if (!i.groups?.endtag) {
            ...
            (a += e), (n.lastIndex = i.index + e), t.push(i.groups.before);
            const s = i[2],
              r = o.createElement(s);
            t.push(r);
            continue;
          }
          (a += i[0].length), t.push(i.groups.before);
        ...
        return (
          ...
          (0, t.jsx)(ue.D6, {
            ...
            children: (0, t.jsx)("div", {
              ...
              children: (0, t.jsx)(ge.q, { children: s }),
            }),
          })
        );
      }
      ...
      function ye(e) {
        ...
        return (
          n && r.offset
            ? t.push((0, me.cY)(r.offset))
            : (n && void 0 !== r.offset) || t.push((0, me.cY)(2)),
          n && r.flip
            ? t.push((0, me.UU)(r.flip))
            : (n && void 0 !== r.flip) || t.push((0, me.UU)()),
          n && r.shift
            ? t.push((0, me.BN)(r.shift))
            : (n && void 0 !== r.shift) || t.push((0, me.BN)()),
          t.push(
            (0, me.Ej)({
              apply: (r) => {
                ...
                "function" == typeof e.width &&
                  ...
                  Object.assign(n.floating.style, a),
                  n.floating.style.setProperty("--popover-max-height", i);
              },
            }),
          ),
          t
      ...
      const we = {
        Root: function (e) {
          ...
          return (0, t.jsx)(xe.Provider, { value: n, children: s });
        },
        Anchor: function (e) {
          const { children: s } = e,
            r = o.Children.only(s),
          ...
          return r
            ? t
              ? (0, o.cloneElement)(r, {
                  ...
                  ref: (0, n.XB)(r.props.ref, t.floating.refs.setReference),
                })
              : (console.error(
        ...
        Positioner: function (e) {
          const { children: s, className: r, ref: n } = e,
            i = (0, o.useContext)(xe),
            a = (0, de.SV)([n, i?.floating.refs.setFloating]),
            c = (0, _e.gK)();
          if (!i)
            return (
              console.error(
          ...
          let l = o.Children.only(s),
            p = o.Fragment;
          l.type == we.FocusManager &&
            ((l = o.Children.only(l.props.children)), (p = ve));
          const h = (0, o.cloneElement)(l, {
            ref: a,
            style: i.floating.floatingStyles,
            className: r,
            ...i.getFloatingProps(),
          });
          return (0, t.jsx)(de.XF, {
            root: c?.targetElement,
            children: (0, t.jsx)(p, { children: h }),
          });
        },
        FocusManager: ve,
      };
      ...
      function Me(e) {
        ...
        const n = (0, pe.n9)();
        return (
          s?.startsWith(U.TS.STORE_BASE_URL) && (s = (0, pe.bV)(n, s)),
          (0, t.jsx)(I, {
            href: s,
            color: "dull-11",
            target: "_blank",
      ...
      function Pe(e) {
        ...
        return "initial" === s || "sm" === s
          ? null
          : (0, t.jsx)("footer", {
              className: H()(be().SteamChinaFooter, e.className),
              children: (0, t.jsxs)(O, {
                className: be().FooterContent,
                children: [
                  (0, t.jsxs)(w, {
                    align: "center",
                    justify: "between",
                    children: [
                      ...
                      (0, t.jsxs)(O, {
                        ...
                        children: [
                          ...
                          "  |  ",
                          (0, t.jsx)(Me, {
                            href: U.TS.STORE_BASE_URL + "about",
                            children: "关于蒸汽平台",
                          }),
                          "  |  ",
                          (0, t.jsx)(Me, {
                            href: U.TS.STORE_BASE_URL + "steam_refunds",
                            children: "退款政策",
                          }),
                          "  |  ",
                          (0, t.jsx)(Me, {
                            href: U.TS.STORE_BASE_URL + "subscriber_agreement",
                            children: "软件许可服务协议",
                          }),
                          "  |  ",
                          (0, t.jsx)(Me, {
                            href: U.TS.STORE_BASE_URL + "privacy_agreement",
                            children: "个人信息保护政策",
                          }),
                          "  |  ",
                          (0, t.jsx)(Me, {
                            href: U.TS.STORE_BASE_URL + "data_outbound",
                            children: "个人信息出境告知书",
                          }),
                          "  |  ",
                          (0, t.jsx)(Me, {
      ...
      let Ee = null;
      function ke() {
        if (!(0, Re.VD)(U.TS.LANGUAGE))
          throw `unknown language ${U.TS.LANGUAGE}`;
        return {
          languages: [
            {
              strLanguage: U.TS.LANGUAGE,
              strISOCode: Re.yc.get(U.TS.LANGUAGE),
              eSource: 5,
            },
          ],
        };
      ...
      const Ue = {};
      (Ue.arabic = () => r.e(6939).then(r.t.bind(r, 9320, 19))),
        (Ue.brazilian = () => r.e(3095).then(r.t.bind(r, 3095, 19))),
        (Ue.bulgarian = () => r.e(864).then(r.t.bind(r, 864, 19))),
        (Ue.czech = () => r.e(3910).then(r.t.bind(r, 3910, 19))),
        (Ue.danish = () => r.e(7098).then(r.t.bind(r, 7098, 19))),
        (Ue.dutch = () => r.e(4847).then(r.t.bind(r, 4847, 19))),
        (Ue.english = () => r.e(3621).then(r.t.bind(r, 3621, 19))),
        (Ue.finnish = () => r.e(9058).then(r.t.bind(r, 9058, 19))),
        (Ue.french = () => r.e(2683).then(r.t.bind(r, 2683, 19))),
        (Ue.german = () => r.e(9209).then(r.t.bind(r, 9209, 19))),
        (Ue.greek = () => r.e(2933).then(r.t.bind(r, 2933, 19))),
        (Ue.hungarian = () => r.e(6740).then(r.t.bind(r, 6740, 19))),
        (Ue.indonesian = () => r.e(4631).then(r.t.bind(r, 4631, 19))),
        (Ue.italian = () => r.e(517).then(r.t.bind(r, 517, 19))),
        (Ue.japanese = () => r.e(4788).then(r.t.bind(r, 4788, 19))),
        (Ue.koreana = () => r.e(3838).then(r.t.bind(r, 3838, 19))),
        (Ue.latam = () => r.e(1990).then(r.t.bind(r, 1990, 19))),
        (Ue.norwegian = () => r.e(8953).then(r.t.bind(r, 8953, 19))),
        (Ue.polish = () => r.e(8766).then(r.t.bind(r, 8766, 19))),
        (Ue.portuguese = () => r.e(3110).then(r.t.bind(r, 3110, 19))),
        (Ue.romanian = () => r.e(7384).then(r.t.bind(r, 7384, 19))),
        (Ue.russian = () => r.e(8928).then(r.t.bind(r, 8928, 19))),
        (Ue.schinese = () => r.e(8787).then(r.t.bind(r, 1168, 19))),
        (Ue.spanish = () => r.e(6421).then(r.t.bind(r, 6421, 19))),
        (Ue.swedish = () => r.e(7524).then(r.t.bind(r, 7524, 19))),
        (Ue.tchinese = () => r.e(7248).then(r.t.bind(r, 7248, 19))),
        (Ue.thai = () => r.e(6085).then(r.t.bind(r, 6085, 19))),
        (Ue.turkish = () => r.e(7997).then(r.t.bind(r, 7997, 19))),
        (Ue.ukrainian = () => r.e(7247).then(r.t.bind(r, 7247, 19))),
        (Ue.vietnamese = () => r.e(3092).then(r.t.bind(r, 3092, 19)));
      const Ze = (function (e) {
        const s = new Map(),
          r = (async function () {
            await (0, U.Ki)();
            ...
            return Promise.all(
              Array.from(t).map((r) =>
                e(r).then((e) => {
                  if (!e) return;
                  const t = new Map();
                  for (const [s, r] of Object.entries(e)) t.set("#" + s, r);
                  s.set(r, t);
                }),
              ),
            );
        ...
        function i(e, r) {
          const [t, ...n] = r,
            o =
              s.get(t.strLanguage)?.get(e) ??
              s.get((0, Re.mR)(t.strLanguage) ?? "english")?.get(e);
          return void 0 !== o
            ? o
            : 0 === n.length
          ...
          (Ee = Promise.all(Ae)),
          {
            ...
            LocalizeReact(e, ...s) {
              ...
              for (; (i = n.exec(r)); ) {
                ...
                e >= 1 && e <= s.length && t.push(s[e - 1]);
              }
              return (
                t.push(r.slice(a)), o.createElement(o.Fragment, null, ...t)
              );
            },
            LocalizePlural: (e, s, ...r) =>
              1 === s || "1" === s ? a(e, s, ...r) : a(e + "_Plural", s, ...r),
            LocalizeInSpecificLang: (e, s, ...r) => Te(i(s, [e]), ...r),
            Ready: () => r,
            IsReady: () => t,
          }
        );
      ...
      function De(e) {
        return (0, t.jsx)(w, { direction: "column", gap: "4", ...e });
      }
      function Ke(e) {
        return (0, t.jsx)(A, {
          level: "3",
          color: "dull-12",
          weight: "heavy",
          className: he.LinkColumnHeading,
          ...e,
        });
      }
      function Ye(e) {
        ...
        return (0, t.jsxs)(w, {
          ...
          children: [
            ...
            (0, t.jsx)(V, {
              as: "p",
              size: "1",
              className: he.LegalNotice,
              children: oe(
                Ze.Localize("#footer_legal_notice", new Date().getFullYear()),
              ),
            }),
            (0, t.jsxs)(w, {
              gap: "6",
              align: "center",
              className: he.LogoLinks,
              children: [
                (0, t.jsx)(Ye, {
            ...
            (0, t.jsxs)(w, {
              ...
              children: [
                "initial" === e &&
                  ...
                  (0, t.jsx)($, {
                    href: U.TS.STORE_BASE_URL + "mobile/",
                    children: Ze.Localize("#footer_link_get_mobile_apps"),
                  }),
                ce() &&
                  (0, t.jsx)(X, {
                    color: "dull",
                    onClick: le,
                    children: Ze.Localize("#footer_view_mobile_website"),
                  }),
              ],
            }),
          ],
        ...
        return (
          ...
          (0, t.jsx)(ee.N, {
            ...
            children: (0, t.jsxs)(re, {
              ...
              className: H()(he.GlobalFooter, e.className),
              ...
              children: [
                ...
                (0, t.jsxs)(De, {
                  ...
                  children: [
                    (0, t.jsx)(Ke, {
                      children: Ze.Localize("#footer_link_header_steam"),
                    }),
                    (0, t.jsx)(Ye, {
                      href: U.TS.STORE_BASE_URL + "about/",
                      children: Ze.Localize("#footer_link_about_steam"),
                    }),
                    (0, t.jsx)(Ye, {
                      href: U.TS.STORE_BASE_URL + "subscriber_agreement/",
                      children: Ze.Localize("#footer_link_steam_ssa"),
                    }),
                    (0, t.jsx)(Ye, {
                      href: U.TS.PARTNER_BASE_URL,
                      children: Ze.Localize("#footer_link_steamworks"),
                    }),
                    (0, t.jsx)(Ye, {
                      href: U.TS.PARTNER_BASE_URL + "steamdirect",
                      children: Ze.Localize("#footer_link_steam_distribution"),
                    }),
                    (0, t.jsx)(Ye, {
                      href: U.TS.STORE_BASE_URL + "digitalgiftcards/",
                      children: Ze.Localize("#footer_link_gift_cards"),
                    }),
                  ],
                }),
                (0, t.jsxs)(De, {
                  ...
                  children: [
                    (0, t.jsx)(Ke, {
                      children: Ze.Localize("#footer_link_header_valve"),
                    }),
                    (0, t.jsx)(Ye, {
                      href: "https://valvesoftware.com/about",
                      children: Ze.Localize("#footer_link_about_valve"),
                    }),
                    (0, t.jsx)(Ye, {
                      href: "https://valvesoftware.com/",
                      children: Ze.Localize("#footer_link_jobs"),
                    }),
                    (0, t.jsx)(Ye, {
                      href: U.TS.STORE_BASE_URL + "hardware/",
                      children: Ze.Localize("#footer_link_hardware"),
                    }),
                    (0, t.jsx)(Ye, {
                      href: U.TS.STORE_BASE_URL + "hardware_recycling/",
                      children: Ze.Localize("#footer_link_recycling"),
                    }),
                  ],
                }),
                (0, t.jsxs)(De, {
                  ...
                  children: [
                    (0, t.jsx)(Ke, {
                      children: Ze.Localize("#footer_link_header_legal"),
                    }),
                    (0, t.jsx)(Ye, {
                      href: U.TS.STORE_BASE_URL + "privacy_agreement/",
                      children: Ze.Localize("#footer_link_privacy"),
                    }),
                    (0, t.jsx)(Ye, {
                      href: "https://help.steampowered.com/faqs/view/10BB-D27A-6378-4436",
                      children: Ze.Localize("#footer_link_accessibility"),
                    }),
                    (0, t.jsx)(Ye, {
                      href: U.TS.STORE_BASE_URL + "legal/",
                      children: Ze.Localize(
                        "#footer_link_notices_and_policies",
                      ),
                    }),
                    (0, t.jsx)(Ye, {
                      href: U.TS.STORE_BASE_URL + "account/cookiepreferences/",
                      children: Ze.Localize("#footer_link_cookies"),
                    }),
                    (0, t.jsx)(Ye, {
                      href: U.TS.STORE_BASE_URL + "steam_refunds/",
                      children: Ze.Localize("#footer_link_refunds"),
                    }),
                  ],
                }),
                (0, t.jsxs)(De, {
                  ...
                  children: [
                    (0, t.jsx)(Ke, {
                      children: Ze.Localize("#footer_link_header_more"),
                    }),
                    (0, t.jsx)(Ye, {
                      href: U.TS.STORE_BASE_URL + "about/",
                      children: Ze.Localize("#footer_link_get_steam"),
                    }),
                    (0, t.jsx)(Ye, {
                      href: U.TS.STORE_BASE_URL + "mobile/",
                      children: Ze.Localize("#footer_link_get_mobile_apps"),
                    ...
                    (0, t.jsx)(Ye, {
                      ...
                      children: Ze.Localize("#footer_link_get_support"),
                    }),
                    (0, t.jsx)(Ye, {
                      href: U.TS.STORE_BASE_URL + "account/",
                      children: Ze.Localize("#footer_link_my_account"),
                    }),
                  ],
                }),
              ],
      ...
      function qe(e) {
        if (U.TS.IN_GAMEPADUI) return null;
        const s = (0, ne.nA)(U.TS.EREALM)
          ? (0, t.jsx)(Pe, { ...e })
          : (0, t.jsx)(Je, { ...e });
