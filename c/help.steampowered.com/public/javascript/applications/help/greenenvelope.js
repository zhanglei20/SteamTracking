    ...
    chunkid: (module, module_exports, __webpack_require__) => {
        ...
        [_]: {
          ...
          url: (_) => {
            return (
              (_ = _.familyid),
              (_ = _.request_id),
              `${_._.STORE_BASE_URL}cart/purchaserequest/${_}/${_}`
            );
            var _, _;
          },
        },
      ...
      function _(_) {
        ...
        const _ = "string" == typeof _ ? _ : _.locString,
          _ = "string" == typeof _ ? [] : _.params || [];
        return _ ? ("#" !== _[0] ? _ : (0, _._)(_, ..._)) : void 0;
      }
      function _(_) {
        return _.useMemo(
          () =>
      ...
      const _ = "061818254b2c99ac49e6626adb128ed1282a392f";
      class _ {
        m_unAppID;
        m_bInitialized = !1;
        m_strName;
      ...
      class _ {
        ...
        OnGetAppsResponse(_) {
          ...
          for (let _ of _.Body().apps()) {
            ...
            (0, _._)(
              ...
              _ &&
                ((_ = new _(__webpack_require__.appid())),
        ...
        GetRichPresenceLoc(_) {
          if (this.m_mapRichPresenceLoc.has(_.toString())) {
            ...
            return (
              _.m_nLastUpdated + 72e5 < Date.now() &&
      ...
      function _(_) {
        ...
        const [_, _] = _.useState(_ ? _.loadingActive : _.none),
          [_, _] = _.useState(void 0);
        _.useEffect(() => {
          _ != _.loadingActive || _
            ? _ == _.loadingComplete && _ && _(_.loadingActive)
            : _(_.loadingComplete);
        }, [_, _]),
          _.useEffect(() => {
            let _ =
              ...
              1e3;
            const _ = window.setTimeout(() => _(_.none), _);
      ...
      class _ {
        ...
        BShowEmailEditorTab(_) {
          ...
          if (
            _.clanSteamID.GetAccountID() ==
            (_._.EUNIVERSE === _._ ? 2581 : 45267781)
          )
            return !0;
      ...
      const _ = new (class {
        ...
        BHasClanInfoLoadedByAccountID(_) {
          return Boolean(_(_(_), this.ReadCache()));
        }
        RegisterClanData(_) {
          ...
          return (
            ...
            0 == _
              ...
              : (async function (_, _) {
                ...
                })(_, this.m_queryClient).catch(() => null)
          );
        }
      ...
      function _(_) {
        ...
        const _ = _(_),
          ...
          _ = _ ? (0, _._)("#Notification_GiftReceived_Description", _) : null,
      ...
      function _(_) {
        ...
        10 == _.comment_type
          ...
          : 5 == _.comment_type && _.json_data?.file_type == _.pmA
            ? (_ =
                _.owner_steam_id?.ConvertTo64BitString() == _
                  ? _
                    ? (0, _._)(
        ...
        (_.UpdateTextFilterDictionaryHandler = {
          ...
          (_.GetGameIDForPID = function (_, _) {
            return null == (_ = _ || _().GetDefaultTransport())
              ...
              : _.SendMsg("SteamEngine.GetGameIDForPID#1", (0, _._)(_, _), _, {
                  ePrivilege: 1,
                  eClientExecutionSite: 2,
                });
          }),
      ...
      class _ {
        ...
        GetSteamEngineTextFilterDictionary(_, _) {
          const _ = _._.Init(_);
          return (
            __webpack_require__.Body().set_language(_),
            __webpack_require__.Body().set_type(_),
        ...
        DeobfuscateString(_) {
          try {
            ...
            return __webpack_require__.startsWith(_)
              ? ((_ = __webpack_require__.slice("chunkid")), _)
              : (console.log(
        ...
        async LoadFilter() {
          ...
          null != _ && null != _ && this.BRebuildFilter(_, _);
        }
        SaveFilter() {
          this.SaveObfuscatedString(
            "CTextFilterStore_strBannedPattern",
        ...
        async LoadLanguage(_) {
          ...
          if (!_) {
            _ = `${_._.COMMUNITY_CDN_URL}textfilter/gettextfilterdictionary?type=banned&language=${_}&v=1&origin=${_()}`;
            {
              const _ = await _().get(_);
              this.m_strBannedWords += _.data;
            }
            _ = `${_._.COMMUNITY_CDN_URL}textfilter/gettextfilterdictionary?type=profanity&language=${_}&v=1&origin=${_()}`;
            {
              const _ = await _().get(_);
              this.m_strProfanityWords += _.data;
            }
          }
          _ = `${_._.COMMUNITY_CDN_URL}textfilter/gettextfilterdictionary?type=clean_public&language=${_}&v=1&origin=${_()}`;
          {
            const _ = await _().get(_);
        ...
        FilterText(_, _) {
          ...
          return !_ ||
            ...
            : _.replace(this.m_regexBannedWords, (_) =>
                this.m_regexCleanWords && 0 == _.search(this.m_regexCleanWords)
                  ? _
      ...
      (0, _._)([_._], _.prototype, "m_TextFilterPreferences", void 0),
        (0, _._)([_._], _.prototype, "m_mapPlayerCache", void 0),
        ...
        (0, _._)([_._], _.prototype, "BRebuildFilter", null);
      let _ = null,
        _ = !1;
      function _() {
        const _ = (0, _._)(),
        ...
        [_]: function (_) {
          const {
            ...
            _ = (function (_) {
              ...
              ? _?.account_steam_id?.GetAccountID()
              : null,
            { data: _ } = _(_),
            _ = (function (_) {
              return _(_);
            ...
            _.setTransport(_),
              (window.RefreshSteamNotifications = () =>
                (async function (_) {
                  let _ = null;
                  try {
                    _ = await (async function (_, _, _, _, _, _ = !0, _ = !1) {
                      if (!_)
                        throw new Error(
                      ...
                      if (_.GetEResult() !== _._)
                        throw (
                          ...
                          new Error(
                            `Error from GetSteamNotifications: ${_.GetEResult()}`,
                          ))
                        );
