  ...
  (self.webpackChunkappmgmt_storeadmin =
    ...
    [6129],
    {
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        function _(_, _) {
          _.Body().set_filters(CStoreQueryFilters.fromObject(_));
        }
      },
      chunkid: (module, module_exports, __webpack_require__) => {
        __webpack_require__._(module_exports, {
        ...
        const _ = class _ {
          ...
          static ValidateDataRequest(_) {
            ...
            for (const _ of _) if (_ !== !0 && _ !== void 0) return !1;
            return !0;
          }
          ...
          GetPreviousSupersetLoadPromise(_, _, _) {
            ...
            return _ &&
              _._.BDataRequestContainsOtherDataRequest(_.dataRequest, _)
              ? _.promise
              : null;
          }
          async HintLoadStoreItems(_, _, _, _, _, _, _) {
            ...
            return (
              ...
              (_ || []).forEach((_) =>
                this.m_mapHubCategoriesInFlight.delete(_),
              ),
              _
            );
          }
          ...
          GetStoreItemWithLegacyVisibilityCheck(_, _) {
            ...
            return _ && (this.m_bReturnUnavailableItems || _.BIsVisible())
              ? _
              : void 0;
          }
          ...
          ReadResults(_, _) {
            let _ = [];
            for (const _ of _) _.push(this.ReadItem(_, _));
            return _;
          }
          ReadItem(_, _) {
            const _ = _.item_type();
