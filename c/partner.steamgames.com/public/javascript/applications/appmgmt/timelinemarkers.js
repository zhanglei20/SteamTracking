            ...
            children: [
              ...
              (0, _.jsx)(_._, {
                onSelected: () => {
                  ...
                  !(function (_, _, _, _) {
                    null != _() && _().TakeScreenshot(_, _, _.valMS, _);
                  })(_.GetGameID(), _, _, _.GetClipID());
                },
                className: _.TimelineContextMenuItem,
                children: (0, _.jsxs)("div", {
	...
	"endtime": 60000
      ...
      function _(_) {
            ...
            (_ = async () => {
              (0, _._)(
                (0, _.jsx)(_._, {
                  ...
                  onOK: async () => {
                    _.fnSetLoading(!0);
                    (await _(_, _.asset_set_id, _.timeline_marker_id)) != _._
                      ? (_.fnSetError(!0),
                        _.fnSetStrError(
                          (0, _._)("#OptIn_Appeals_Dialog_Failed"),
                        ))
        ...
        return (0, _.jsx)(_._, {
          ...
          onOK: async () => {
            _.fnSetLoading(!0),
              (await _(_, _.asset_set_id, _.timeline_marker_id, _, _, _)) == _._
                ? (_.fnSetSuccess(!0),
                  _.fnSetStrSuccess(
      ...
      function _(_) {
        const { appid: _, assetSetID: _, closeModal: _ } = _,
          ...
          _ = 0 == _.trim().length,
          _ = (0, _._)(
            _ ? "#AssetSet_Dialog_Edit_Title" : "#AssetSet_Dialog_Create_Title",
          ),
          _ = (0, _._)();
        return _.bLoading
          ? (0, _.jsx)(_._, {
          ...
          : (0, _.jsxs)(_._, {
              ...
              onOK: async () => {
                ...
                try {
                  let _;
                  _ ? (_ = await _(_)) : ((_.branches = []), (_ = await _(_))),
                    _ != _._ &&
                      (_ = (0, _._)({
                        sucess: _,
                      }));
