(() => {
  (self.webpackChunkappmgmt_storeadmin =
    ...
    [6343],
    {
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        const _ = 1,
          ...
          _ = 3;
        function _(_) {
          return "unknown ETimelineImageType ( " + _ + " )";
        }
        ...
        const _ = "default",
          ...
          _ = class _ {
            ...
            async CreateAssetSet(_) {
              ...
              try {
                _.Body().set_appid(_.appid),
                  _.Body().set_assetset(_.fromObject(_));
            ...
            async DeleteAssetSet(_, _) {
              ...
              let _ = null;
              try {
                _.Body().set_appid(_), _.Body().set_assetset_id(_);
            ...
            ValidateStoreDefault(_) {
              ...
              return _ &&
                ...
                _.length > 0 &&
                typeof _[0] == "object"
                ? typeof _[0].assetset_id == "string" &&
                    typeof _[0].appid == "number"
                : !1;
            }
          };
        _([_._], _.prototype, "CreateAssetSet", 1),
          _([_._], _.prototype, "UpdateAssetSet", 1),
          _([_._], _.prototype, "DeleteAssetSet", 1),
          _([_._], _.prototype, "AddBranchToAssetSet", 1),
          _([_._], _.prototype, "RemoveBranchFromAssetSet", 1);
        let _ = _;
        function _() {
          return {
        ...
        function _(_) {
          const [_, _] = (0, _.useState)(() => _.Get().GetAllAssetSets(_));
          return (0, _._)(_.Get().GetAppAssetSetListChangeCallback(_), _), _;
        }
        function _(_) {
          ...
          return (
            (0, _._)(_.Get().GetAppAssetSetListChangeCallback(_), (_) =>
              _(_.filter((_) => _.name != _ && _.name != _)),
            ),
            _
          );
        }
        ...
        function _(_) {
          const [_, _] = useState(() => _.Get().GetAllPublicAssetSets(_));
          return (
            useCallbackList(_.Get().GetAppAssetSetListChangeCallback(_), () =>
              _(_.Get().GetAllPublicAssetSets(_)),
            ),
            _
          );
        }
        function _(_, _) {
          const [_, _] = (0, _.useState)(() => _.Get().GetAssetSetByID(_, _));
          return (0, _._)(_.Get().GetAssetSetChangeCallback(_), _), _;
        }
        function _(_) {
          const [_, _] = useState(() => _.Get().GetAllAssetSets(_).length > 0);
          return (
            useCallbackList(_.Get().GetAppAssetSetListChangeCallback(_), () =>
              _(_.Get().GetAllAssetSets(_).length > 0),
            ),
            _
          );
        }
        async function _(_, _) {
          const { fnCreateAssetSet: _ } = _(),
            _ = await _({
              appid: _,
              name: _ ? _ : _,
              branches: _ ? [_] : [],
        ...
        var _ = __webpack_require__("chunkid");
        function _(_) {
          const { assetSetID: _, className: _, appid: _ } = _,
        ...
        const _ = 128,
          ...
          _ = class _ {
            ...
            EnsureRequirePublishingIsVisible() {
              ...
              _ && _.style.display === "none" && (_.style.display = "block");
            }
            ...
            async PublishTimelineMarkerDefinitions(_, _, _) {
              ...
              try {
                ...
                _.append("sessionid", (0, _._)()),
                  _.append("appid", "" + _),
                  _.append("asset_set_id", _),
                  _.append("timeline_marker_id", _.join(","));
            ...
            ValidateStoreDefault(_) {
              ...
              return _ &&
                ...
                _.length > 0 &&
                typeof _[0] == "object"
                ? typeof _[0].asset_set_id == "string" &&
                    typeof _[0].appid == "number"
                : !1;
            }
          };
        _([_._], _.prototype, "CreateTimelineMarkerDefinition", 1),
          _([_._], _.prototype, "UpdateTimelineMarkerDefinition", 1),
          _([_._], _.prototype, "DeleteTimelineMarkerDefinition", 1),
          _([_._], _.prototype, "PublishTimelineMarkerDefinitions", 1);
        let _ = _;
        function _() {
          return {
        ...
        function _(_, _) {
          return _.Get().BDoesAssetSetHaveMarkerID(_, _);
        }
        function _(_, _) {
        ...
        function _(_) {
          return Array.from(
            _.Get().GetUnpublishedTimelineMarkerIDSetForAssetSetID(_),
          );
        }
        function _(_, _) {
        ...
        function _(_) {
          const [_, _] = (0, _.useState)(() => _.Get().GetAllMarkersForApp(_));
          return (0, _._)(_.Get().GetAppMarkerListChange(_), _), _;
        }
        function _(_) {
          const _ = useAllPublicAssetSets(_),
            [_, _] = useState(() => _.Get().GetMarkerForAssetSets(_));
          return (
            useCallbackList(_.Get().GetAppMarkerListChange(_), () =>
              _(_.Get().GetMarkerForAssetSets(_)),
            ),
            _
          );
        }
        ...
        var _ = __webpack_require__("chunkid"),
          ...
          _ = __webpack_require__("chunkid");
        function _(_) {
          const { imageBase64OrUntrustedSVG: _, imageType: _ } = _;
          if (!_) return null;
          let _;
          return (
            _ == _
        ...
        function _(_) {
          const { appid: _, assetSetID: _, markerID: _ } = _,
            { oPublishedMarker: _, oUnpublishedMarker: _ } = _(_, _),
            { publicAssetSetID: _, hiddenAssetSetID: _ } = _(_),
            [_, _] = (0, _.useState)(!1);
          if (!_ && !_) return null;
          const _ = _ || _,
            _ = !!(_ && _.asset_set_id != _),
            _ = _?.asset_set_id === _;
          return (0, _.jsxs)("div", {
        ...
        function _(_) {
          const { _: _, children: _, index: _, bDraggable: _ } = _;
          return (0, _.jsx)(_._, {
            draggableId: _,
            index: _,
            isDragDisabled: !_,
        ...
        function _(_) {
          const { assetSetID: _, children: _ } = _;
          return (0, _.jsx)(_._, {
            ...
            children: (_) =>
              (0, _.jsxs)("div", {
                ...
                children: [_, _.placeholder],
              }),
          });
        }
        function _(_) {
          const { assetSetID: _, appid: _, strMessage: _ } = _;
          return (0, _.jsx)(_._, {
            droppableId: `droptarget_assetsetid_${_}_appid_${_}`,
            children: (_) =>
              (0, _.jsxs)("div", {
                ..._.droppableProps,
                ref: _.innerRef,
        ...
        async function _(_, _, _) {
          if (!_()) {
            ...
            _ && SetTimelineMarkerHookFunction(_);
            let _ = new _();
        ...
        function _(_) {
          return useObserver(() => _()?.GetClipSummaries(_));
        }
        function _(_) {
          return _()?.GetClipSummary(_);
        }
        function _(_) {
          return _() != null && _ ? _().GetClipSummariesForGame(_) || [] : [];
        }
        function _(_) {
          return useObserver(() => _()?.GetClipSummary(_));
        }
        function _(_) {
          return useObserver(() =>
            _ ? _()?.GetClipSummariesForGame(_) || [] : [],
          );
        }
        function _(_, _, _, _, _, _) {
          return _() != null
            ? _().LoadThumbnails(_, _, _, _, _, _ ?? !0)
            : null;
        }
        function _() {
          return _() != null
        ...
        _([_._], _.prototype, "m_bInitailized", 2),
          _([_._], _.prototype, "m_bPaused", 2),
          _([_._], _.prototype, "m_bAtEnd", 2),
          _([_._], _.prototype, "m_strMediaTypeError", 2),
          _([_._], _.prototype, "m_ePlayerError", 2),
          _([_._], _.prototype, "m_bUserInputNeeded", 2),
          _([_._], _.prototype, "m_bMuted", 2),
          _([_._], _.prototype, "m_bSeekReadyToPlay", 2),
          _([_._], _.prototype, "m_bVideoElementPlaying", 2),
          _([_._], _.prototype, "m_nPlaybackSpeed", 2),
          _([_._], _.prototype, "m_bIsWaiting", 2),
          _([_._], _.prototype, "m_bLoadedMetadata", 2),
          _([_._], _.prototype, "m_nPlaybackTime", 2),
          _([_._], _.prototype, "m_nVideoStartTime", 2),
          _([_._], _.prototype, "m_nVideoDuration", 2),
          _([_._], _.prototype, "m_nVolume", 2),
          _([_._], _.prototype, "m_eSeekType", 2),
          _([_._], _.prototype, "Start", 1),
          _([_._], _.prototype, "Stop", 1),
          _([_._], _.prototype, "OnCanPlay", 1),
          _([_._], _.prototype, "OnUserPauseChange", 1),
          _([_._], _.prototype, "OnVideoPlaying", 1),
          _([_._], _.prototype, "OnVideoPause", 1),
          _([_._], _.prototype, "OnVideoTimeUpdate", 1),
          _([_._], _.prototype, "OnVideoEnd", 1),
          _([_._], _.prototype, "OnSeeking", 1),
          _([_._], _.prototype, "OnLoadedMetadata", 1),
          _([_._], _.prototype, "OnDownloadFailed", 1),
          _([_._], _.prototype, "OnPlaybackError", 1),
          _([_._], _.prototype, "OnUserInputNeeded", 1),
          _([_._], _.prototype, "OnVolumeChange", 1),
          _([_._], _.prototype, "OnVideoWaiting", 1),
          _([_._], _.prototype, "UserInputReceived", 1);
        function _(_, _) {
          return useRefCallbackWithCleanup((_) => (_(_), () => _()), [_]);
        }
        let _;
        function _() {
          if (!_) {
        ...
        class _ {
          ...
          PlayNextTimelineRecording(_) {
            ...
            if (
              (this.m_strRecordingID
                ? (_ = this.m_timelineLoader.GetNextRecording(
                    this.m_strRecordingID,
                  ))
                : (_ =
        ...
        _([_._], _.prototype, "m_bHidePlayer", 2),
          _([_._], _.prototype, "m_strRecordingID", 2),
          _([_._], _.prototype, "m_durationMS", 2),
          _([_._], _.prototype, "m_lastRecordingGlobalMS", 2),
          _([_._], _.prototype, "m_nGlobalTimelinePlaybackMS", 2),
          _([_._], _.prototype, "m_nGlobalTimelinePlaybackSec", 2),
          _([_._], _.prototype, "m_rgSeekPerf", 2),
          _([_._], _.prototype, "m_eRecordingState", 2),
          _([_._], _.prototype, "m_eRecordingSetting", 2),
          _([_._], _.prototype, "m_bGamepadMode", 2),
          _([_._], _.prototype, "m_bControlsVisible", 2),
          _([_._], _.prototype, "m_fnRenderGlyph", 2),
          _([_._], _.prototype, "m_previousHighlightEntry", 2),
          _([_._], _.prototype, "m_nextHighlightEntry", 2),
          _([_._], _.prototype, "m_displayHighlightEntry", 2),
          _([_._], _.prototype, "m_nRelativeTimeForDisplay", 2),
          _([_._.ref], _.prototype, "m_rgClipOffsets", 2),
          _([_._.ref], _.prototype, "m_phasePreview", 2),
          _([_._], _.prototype, "SetVideoElement", 1),
          _([_._], _.prototype, "OnInvalidateRecording", 1),
          _([_._], _.prototype, "OnLoaderInitialized", 1),
          _([_._], _.prototype, "OnInvalidate", 1),
          _([_._], _.prototype, "OnTimelineLoaded", 1),
          _([_._], _.prototype, "GetLiveEdgeMS", 1),
          _([_._], _.prototype, "StopPlayback", 1),
          _([_._], _.prototype, "TogglePlayPause", 1),
          _([_._], _.prototype, "UpdateGlobalPlayTime", 1);
        ...
        function _() {
          const _ = useContext(_);
          return (
            !isNaN(_.globalPreviewStartMS?.valMS) &&
            !isNaN(_.globalPreviewEndMS?.valMS)
          );
        }
        function _() {
        ...
        _([_._], _.prototype, "m_durationMS", 2),
          _([_._], _.prototype, "m_scrollLeftPX", 2),
          _([_._], _.prototype, "m_scrollWindowWidth", 2),
          _([_._], _.prototype, "m_scrollWindowOffsetPX", 2),
          _([_._], _.prototype, "m_bAutoScrollPaused", 2),
          _([_._], _.prototype, "m_autoScrollPauseTimeout", 2),
          _([_._], _.prototype, "m_msVisible", 2),
          _([_._.ref], _.prototype, "m_rgTimelineOffsets", 2),
          _([_._], _.prototype, "m_bInitialized", 2),
          _([_._], _.prototype, "m_eThumbnailComponent", 2),
          _([_._], _.prototype, "m_nGlobalRelativeThumbnailPositionPX", 2),
          _([_._], _.prototype, "m_thumbnailHighlightEntry", 2),
          _([_._], _.prototype, "m_phaseToHighlight", 2),
          _([_._], _.prototype, "OnLoaderInitialized", 1),
          _([_._], _.prototype, "InitDefaultsIfReady", 1),
          _([_._], _.prototype, "OnInvalidate", 1),
          _([_._], _.prototype, "ZoomIn", 1),
          _([_._], _.prototype, "ZoomOut", 1),
          _([_._], _.prototype, "SetTempZoomScale", 1),
          _([_._], _.prototype, "ClearTempZoomScale", 1),
          _([_._], _.prototype, "UpdateClipSummaries", 1),
          _([_._], _.prototype, "BReachedMaxScroll", 1),
          _([_._], _.prototype, "BReachedMinScroll", 1);
        ...
        var _ = __webpack_require__("chunkid");
        const _ = 20,
          _ = [1e3, 5e3, 3e4, 6e4, 15e4, 3e5, 9e5, 18e5],
          _ = _.memo(function (_) {
            const _ = _(),
        ...
        _([_._], _.prototype, "create", 1), _([_._], _.prototype, "cleanup", 1);
        ...
        function _(_) {
          ...
          return {
            ...
            strCurrentExportPath: _?.exportPath,
            strSrcClipID: _,
        ...
        function _() {
          const _ = useTimelinePlaybackCoordinator(),
            _ = useSetSelectionClipRange(),
            _ = useObserver(() => !_.ShouldModeShowClipControls()),
            _ = useLowDiskSpace(),
            { onMarkerCreated: _ } = useGameRecordingCallbacks();
          return React.useCallback(
            (_, _) => {
              if (_ || _) return;
              const _ = jsx(_, {
        ...
        function _(_) {
          const { playbackCoordinator: _, fnSetSelectionClipRange: _ } = _,
            ...
            _ = () => {
              ...
              _(_, EClipRangeMethod.k_EClipRangeMethod_ContextMenu, _, void 0),
                _.SetPlaytimeFromGlobalMS(_),
                _.FocusGlobalMS(_);
            },
            _ = () => {
              const _ = _.GetGlobalMSPlaytime();
              _(_, EClipRangeMethod.k_EClipRangeMethod_ContextMenu, void 0, _),
                _.SetPlaytimeFromGlobalMS(_),
                _.FocusGlobalMS(_);
            },
            _ = () => {
              const _ = _.GetGlobalMSPlaytime(),
                { strTimelineID: _, nTimelineOffsetMS: _ } =
                  _.ConvertGlobalOffsetToTimelineRelativeOffset(_.valMS),
                _ = _.GetLoader().GetTimelineStartBeforeGlobalZeroMS(_);
              TakeScreenshot(_.GetGameID(), _, _, _.GetClipID());
            };
        ...
        function _(_) {
          const {
            ...
            { selectedMarker: _ } = _(),
            _ =
              _.entry?._ == _?.strEntryID &&
              _.strTimelineID == _?.strTimelineID,
            { ref: _, ..._ } = _(_, _),
            _ = _.useCallback(
              (_) => {
                const _ = _.valMS - _,
        ...
        _([_._], _.prototype, "m_mapThumbnailImages", 2);
        let _ = _;
        function _(_) {
        ...
        function _(_) {
          const { globalMS: _ } = _,
            _ = _();
          if (
            !(0, _._)(() => _.ConvertGlobaOffsetToRecordingAndRelativeOffset(_))
              ?.strRecordingID
          )
            return null;
          const _ = () => {
	...
	"endtime": 60000
          ...
          return (
            (0, _.useEffect)(() => {
              ...
              _.RemoveTimelineEvent(_, "5"),
                ...
                _.AddEventToTimeline(_, 12500, _, "5", 9, _, _, 0),
                _.AddEventToTimeline(_, 33500, _, "12", 2, _, _, 0),
                _.AddEventToTimeline(_, 48500, _, "16", 9, _, _, 0);
            }, [_, _]),
            (0, _.jsx)(_, {
              loader: _,
              fnGetManifest: () => "",
        ...
        var _ = ((_) => (
          (_.k_IconEditorPublic = "public"),
          (_.k_IconEditorHidden = "hidden"),
          _
        ))(_ || {});
        function _(_, _, _, _) {
            ...
            if (_) {
              ...
              (_.onloadend = () => {
                ...
                if (
                        ...
                        : _.width > _
                          ? _(_, _, _, (_) => {
                              _({
                                image: _,
                                image_type: _,
                                strFilenameWithoutExtension: _(_).substring(
                                  0,
                                  _,
                                ),
                              });
                  ...
                  _ === "image/svg+xml" || _.endsWith(".svg")
                    ? _({
                        image: _.result,
                        image_type: _,
                        strFilenameWithoutExtension: _(_).substring(0, _),
                ...
                _.type === "image/svg+xml" || _.name.endsWith(".svg")
                  ? _.readAsText(_)
                  : _.readAsDataURL(_);
            } else return _((0, _._)("#TimelineMarkers_Error_NotFound"));
          });
        }
        function _(_) {
        ...
        function _(_) {
          const { appid: _, closeModal: _ } = _,
            ...
            _ = (0, _.useCallback)(
              async (_) => {
                if ((_(null), (_.currentTarget?.files?.length || 0) > 0)) {
                  const _ = new Array();
            ...
            : (0, _.jsx)(_._, {
                ...
                onOK: async () => {
                  ...
                  for (let _ = 0; _ < _.length; ++_) {
                    const _ = _[_];
                    if (
                      (await _(_, _, _.markerid, _.image, _.image_type)) != _._
                    ) {
                      _.fnSetError(!0),
                        _.fnSetStrError(
        ...
        function _(_) {
          ...
          return (0, _.jsx)("div", {
            className: (0, _._)(_["drag-drop-box"], _ && _.dragging, _.DragBox),
            onDragEnter: _,
            onDragOver: _,
            onDragLeave: _,
            onDrop: _,
        ...
        function _(_) {
          const { marker: _, appid: _, setMarkerID: _ } = _;
          return (
            (0, _.useEffect)(
              () => (
        ...
        function _(_) {
          ...
          if (!_ || _.unpublished_changes) {
            let _ = null;
            _(_.asset_set_id, _.markerid).oPublishedMarker &&
            _.unpublished_changes
        ...
        function _(_) {
          const { createVisibilityState: _, setCreateVisibilityState: _ } = _,
            _ = _.useId();
          return (0, _.jsxs)(_.Fragment, {
            children: [
              (0, _.jsx)("h3", {
        ...
        async function _(_, _) {
          ...
          if (!(_?.length > 2 && _?.length > 2)) return;
          const _ = _[1],
            _ = _[2];
          let _ = _[1];
          const _ = Number.parseInt(_[2]);
          _(_, _, _, _);
        }
        async function _(_, _, _, _) {
          ...
          if (_.unpublished_changes) {
            if (((_ = await _(_, _, _.timeline_marker_id)), _ != _._))
              return (
          ...
          return (
            _ &&
              ...
              console.error("TimelineMarkerDrop failed on step 3: " + _),
            _
          );
        }
        var _ = __webpack_require__("chunkid"),
        ...
        function _(_) {
          const { appid: _ } = _,
            ...
            _ = (0, _.useMemo)(
              () =>
                _?.filter((_) => _.unpublished_changes && _.asset_set_id != _)
                  .length || 0,
              [_, _],
            );
          return _ == 0
        ...
        function _(_, _, _) {
          return _ == _
            ...
            : AssetSetStore_GetAssetSetName(_, _);
        }
        function _(_) {
          const { rgAssetSetsToPublish: _, closeModal: _, appid: _ } = _,
            { fnPublishTimelineMarkerDefinitions: _ } =
              GetTimelineMarkerDefinitionFunctions(),
            { publicAssetSetID: _ } = useSpecialAssetSets(_),
            _ = useMemo(() => {
              const _ = new Map();
              return (
                _.forEach((_) => {
            ...
            _ = useSimpleDialogProgressStates();
          return _.bLoading
            ...
            : jsx(GenericConfirmDialog, {
                ...
                onOK: async () => {
                  ...
                  for (let _ = 0; _ < _.length; ++_) {
                    const _ = _[_],
                      _ = _.get(_);
                    if ((await _(_, _, _)) != k_EResultOK) {
                      console.error(
                        `PublishAssetSetDialog failed to publish ${_.length} for ${_}`,
                      ),
                        _.fnSetError(!0),
                        _.fnSetStrError(
        ...
        function _(_) {
          const { appid: _, assetSetID: _, closeModal: _ } = _,
            _ = _(_, _),
        ...
        function _() {
          return _.Get().GetBranchDetails();
        }
        function _(_) {
          return _.Get().GetBranchDetailsByName(_);
        }
        var _ = __webpack_require__("chunkid");
        function _(_) {
          const { oAssetSet: _ } = _;
        ...
        function _(_) {
          const { oAssetSet: _, closeModal: _ } = _,
            _ = _(),
                ...
                onOK: async () => {
                  ...
                  for (let _ = 0; _ < _.length; ++_) {
                    ...
                    if (!_.branches?.includes(_)) {
                      if ((await _(_.appid, _.assetset_id, _)) != _._) {
                        _.fnSetError(!0);
                        return;
                      }
                      _++;
                  ...
                  _.map((_) =>
                    (0, _.jsx)(
                      _._,
                      {
                        ...
                        onChange: (_) => {
                          const _ = new Set(_);
                          _ ? _.add(_.name) : _.delete(_.name), _(_);
                        },
                      },
                      _.name,
                    ),
          ...
          return _.bLoading
            ...
            : (0, _.jsxs)(_._, {
                ...
                onOK: async () => {
                  ...
                  _.fnSetStrSuccess((0, _._)("#TimelineMarker_Clone_success")),
                    _.fnSetSuccess(!0);
                },
                children: [
                  (0, _.jsx)("br", {}),
      ...
      chunkid: (module, module_exports, __webpack_require__) => {
            ...
            *GetIteratorGameModesWithin(_, _) {
            ...
            async GenerateNamePartsFromTimeline(_, _, _, _) {
              ...
              const _ = _?.strTitle ?? _?.title,
                ...
                _ = _._.GetAppInfo(_.GetInternalAppID())?.name;
              return {
                strTimelinePart: _,
                strAppNamePart: _,
                rtStart: _,
        ...
        _([_._], _.prototype, "m_bInitialized", 2),
          _([_._], _.prototype, "UpdateRunningTimelines", 1);
        let _ = _;
        function _(_) {
          switch (_.type) {
            case "event":
      ...
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        class _ {
          m_ulGameID;
          constructor(_, _, _) {
            if (typeof _ == "string") this.m_ulGameID = _._.fromString(_, !0);
            else {
              const _ = _,
      ...
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        _([_._], _.prototype, "m_tours", 2),
          _([_._], _.prototype, "m_strActiveTour", 2),
          _([_._], _.prototype, "m_bReady", 2),
          _([_._.bound], _.prototype, "UpdateStop", 1),
          _([_._], _.prototype, "ActivateTour", 1),
          _([_._], _.prototype, "DismissTour", 1);
