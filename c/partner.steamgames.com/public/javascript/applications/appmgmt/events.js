    ...
    [4268],
    {
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        async function _(_, _, _) {
          ...
          const _ =
            _._.PARTNER_BASE_URL + "partnerevents/ajaxpublishpatchnotes";
          try {
        ...
        function _(_) {
          ...
          const _ = (_) => _(_),
            ...
            _ = async () => {
              _(null), _("submitting");
              const _ = await _(_.appId, _, _);
              _ ? (_(_.clan_event_gid), _(), _("submitted")) : _("failed");
            },
            _ = (_, _) => {
              const _ = new Array();
              let _ = _,
