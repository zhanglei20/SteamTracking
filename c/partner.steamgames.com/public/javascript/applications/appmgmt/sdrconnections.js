    ...
    [5027],
    {
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        function _(_) {
          const _ = _.host,
            _ = _.type + ":" + _._;
          let _ = _.host_role == "peer" ? "Peer" : "Client",
            _ = null;
          if (_.data_center)
            (_ = "Gameserver"),
        ...
        function _(_, _) {
          if (!(_ > 0)) return null;
          let _ = [];
          for (let _ = 0; _ < _.length; ++_) _.push(_(_[_][0], _[_][1], _));
        ...
        function _(_) {
          ...
          if (_) {
            ...
            if (_.start_time && _.duration) {
              const _ = new Date(_.start_time * 1e3),
                _ = new Date((_.start_time + _.duration) * 1e3),
          ...
          if (_) {
            const _ = function (_) {
                let _ = [..._];
                return (
                  _.sort((_, _) => (_.active_time || 0) - (_.active_time || 0)),
                  _
                );
              },
        ...
        function _(_) {
          ...
          _.useEffect(() => {
            ...
            const _ = _.get("client_id") || "",
              ...
              _ = _.get("app_name1") || "",
              _ = _.get("app_value1") || "";
            if ((_(_), _(_), _(_), _(_), _(_), !_.toString() && _ == 0)) return;
          ...
          const _ = () => {
            ...
            _ && _.set("client_id", _),
              _ && _.set("peer_id", _),
              _ && _.set("kind", _),
              _ && _ && (_.set("app_name1", _), _.set("app_value1", _));
            let _ = {
              ..._.location,
            };
            (_.search = _.toString()), _ != _.location && _.push(_), _(_ + 1);
          };
          let _ = null;
          if (_ !== void 0) {
            let _ = [];
            for (const _ of _) {
              const _ =
                (_.client._ || "") + "-" + (_.client.connection_id || "");
              _.push(
                (0, _.jsx)(
                  _,
                  {
