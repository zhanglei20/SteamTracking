      ...
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        let _ = class extends _.Component {
          ...
          render() {
            ...
            if (_) {
              ...
              let _ = _.Get().GetChatVisibility() === "show";
              const {
                event: _,
                language: _,
        ...
        class _ extends _.Component {
          ...
          CloseBroadcastPopup() {
            ...
            _(_, _._._, this.props.stream.snr),
              _() && _().AddEvent(_._._),
              this.setState({
                bPopout: !1,
                bPreventPopup: !0,
        ...
        let _ = class extends _.Component {
          OnToggleChat(_) {
            ...
            _(
              _,
              _.Get().GetChatVisibility() === "show" ? _._._ : _._._,
          ...
          render() {
            const _ = _.Get().GetChatVisibility() != "remove",
              _ = _.Get().GetChatVisibility() === "hide",
