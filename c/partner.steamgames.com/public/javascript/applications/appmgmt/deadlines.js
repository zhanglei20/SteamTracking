(() => {
  (self.webpackChunkappmgmt_storeadmin =
      ...
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        function _(_) {
          const { deadline: _ } = _,
            ...
            _ = (0, _._)(_.data.store_item_id)?.find(
              (_) => _.milestone_id == Number.parseInt(_.data.gid),
            );
          return (0, _.jsxs)("tr", {
            children: [
              (0, _.jsx)("td", {
                children: _.deadlineid,
              }),
              (0, _.jsx)("td", {
                children: _.data.gid,
              }),
              ...
              (0, _.jsx)("td", {
                children: (0, _.jsxs)("a", {
                  ...
                  target: "_blank",
                  children: [_?.name || "unknown", " (", _.data.partnerid, ")"],
                }),
              }),
              (0, _.jsxs)("td", {
                children: [
        ...
        function _() {
          ...
          return (0, _.jsxs)("div", {
            ...
            children: [
              (0, _.jsx)("h3", {
                children: "Tax Requirement Deadlines",
              }),
              (0, _.jsx)("div", {
                ...
                children: [
                      ...
                      (0, _.jsx)("thead", {
                        children: (0, _.jsxs)("tr", {
                          children: [
                            ...
                            (0, _.jsx)("th", {
                              children: "Dropbox URL",
                            }),
                            (0, _.jsx)("th", {
                              children: "Freeform Message",
                            }),
                          ],
                        }),
                      }),
                  ...
                  _?.length == 0 &&
                    ...
                    (0, _.jsxs)("div", {
                      ...
                      children: ["No tax notifications for partner ", _],
                    }),
                ],
              }),
            ],
        ...
        function _(_) {
          ...
          return (0, _.jsxs)("tr", {
            children: [
              (0, _.jsx)("td", {}),
              (0, _.jsx)("td", {
                children: _.status ? "Complete" : "Active",
              }),
              (0, _.jsx)("td", {
                children: _.TemplateName,
              }),
              (0, _.jsx)("td", {
                children: _,
              }),
              (0, _.jsx)("td", {
                children: _.Parameters?.Dropbox_FileRequest_Url,
              }),
              (0, _.jsx)("td", {
                children: _.Parameters?.CustomMessageBody,
              }),
            ],
          });
        }
        ...
        function _(_, _) {
          const _ = (0, _._)({
            ...
            queryFn: async () => {
              ...
              _.append("type", _.toString()),
                _.append("sessionid", (0, _._)()),
                _ && _.append("partnerid", _.toString());
      ...
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        function _(_) {
          const { requirement: _ } = _,
            _ =
              JSON.parse(_.deadline.data.description_jsondata).Parameters
        ...
        function _(_) {
          ...
          return (0, _.jsxs)("div", {
            ...
            children: [
              ...
              (0, _.jsxs)("div", {
                className: (0, _._)(_().SectionBody, _().RequiredDocumentList),
                children: [_.onboarded && _, !_.onboarded && _],
              }),
            ],
          });
        }
        ...
        function _(_) {
          ...
          return (0, _.jsxs)("div", {
            ...
            children: [
              ...
              (0, _.jsx)("div", {
                className: _().SectionBody,
                children: `If the additional documents noted below have not been provided by ${_}, per US KYC requirements, the KYC and
        ...
        function _(_) {
          const { requirement: _ } = _,
            ...
            _ = `Our records show that you consented to electronic delivery of your tax documents.  ${
              _
                ? `You can find your 1042-S tax statement for ${_} available for download 
	...
	US sales we paid to you in ${_} and related withholding taxes, if applicable.`
	...
	for informational purposes to you but you may want to consult with your tax advisors for additional guidance.`;
          ...
          const { requirement: _ } = _,
            ...
            _ = (0, _.useCallback)(async () => {
              if ((_(""), !_.deadline?.data?.partnerid)) {
                _("An error occurred.  Missing partner id");
                return;
              }
              ...
              try {
                ...
                _?.status == 200 && _.data?.success == _._ && _.data.url
          ...
          return (0, _.jsxs)(_.Fragment, {
            children: [
              ...
              (0, _.jsx)(_._, {
                ...
                onClick: () => _(),
                className: _().NotificationButton,
                children: _ ? "Opening Tax Interview" : "Begin Tax Interview",
              }),
            ],
          });
        }
        function _(_) {
          const { requirement: _ } = _,
            _ = JSON.parse(_.deadline.data.description_jsondata).Parameters
          ...
          const [_, _, _, _, _] = _(),
            ...
            [_, _] = _.useMemo(() => {
              ...
              _.sort((_, _) => {
                ...
                return _.getTime() > _.getTime() ? -1 : 1;
              });
              const _ =
                _.length > 0
                  ? !!_.find((_) => _.data.status == _._._ || _(_))
                  : !1;
              return [_, _];
            }, [_]);
          return (0, _.jsx)(_._, {
        ...
        function _(_) {
          ...
          return (
            (_.data = {}),
            (_.data.due_date = _ / 1e3 + _._.PerDay * 14),
        ...
        function _(_) {
          const { requirement: _ } = _,
            ...
            [, _] = _(),
            _ = new Date(_?.CreatedOn);
          if (_.TemplateName == "ActionComplete") return null;
          if (!_[_.TemplateName])
            return (0, _.jsxs)("div", {
              className: (0, _._)(_().NotificationContainer, _().SectionCtn),
              children: [
              ...
              "div",
              {
                children: [
                  jsx("div", {
                    ...
                    children: LocalizeRtime32ToShortDate(_.getTime() / 1e3),
                  }),
                  jsx("div", {
