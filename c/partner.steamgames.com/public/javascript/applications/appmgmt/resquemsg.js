      ...
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        const _ = class _ {
          ...
          async SetPositionMessages(_) {
            ...
            _.forEach((_) => {
              ...
              _.set_edistributor(_.edistributor),
                _.set_product_identifier(_.product_identifier),
                _.set_start_queue_position(_.start_queue_position),
                _.set_rtime_estimated_notification(
                  _.rtime_estimated_notification,
                ),
                _.set_localization_token(_.localization_token);
            });
            let _ = null;
            try {
          ...
          Init() {
            ...
            this.ValidateInputDefault(_) &&
              ...
              this.m_mapProductPositionMsgList.forEach((_) =>
                this.SortList(_),
              ));
          }
          GetSteamInterface() {
          ...
          ValidateInputDefault(_) {
            ...
            return (
              ...
              Array.isArray(_) &&
              _.length > 0 &&
              typeof _[0].edistributor == "number" &&
              typeof _[0].product_identifier == "string"
            );
          }
        };
        _([_._], _.prototype, "AddProductID", 1),
          _([_._], _.prototype, "SetPositionMessages", 1),
          _([_._], _.prototype, "DeletePositionMessage", 1),
          _([_._], _.prototype, "ReloadReservationPositionMessages", 1);
        let _ = _;
        function _() {
        ...
        function _(_, _, _, _, _, _, _) {
          let _ = null,
            _ = !1,
            _;
          if (_ == EHardwareDetailLoadState.k_LoadFailure || !_)
            _ = SharedLocalization.Localize("#Sale_Reservations_BusyServer");
          else if (BShouldDisplayKomodoMessage(_, _))
            (_ = !0),
              _ === k_nSteamDeckAppid
                ? (_ = LocalizeInlineReact(
        ...
        function _(_) {
          ...
          return (0, _.jsxs)("div", {
            ...
            children: [
              ...
              (0, _.jsx)(_, {
                elReservationMessage: _ ? (0, _._)(_, _, _, _, _) : _,
                strUrlLearnMoreLink: _,
              }),
            ],
          });
        ...
        function _(_) {
          const { productID: _, existingPositionMsg: _, closeModal: _ } = _,
            ...
            [_, _] = (0, _.useState)(
              _?.rtime_estimated_notification || _ + 1440 * 60,
            ),
            [_, _] = (0, _.useState)(
