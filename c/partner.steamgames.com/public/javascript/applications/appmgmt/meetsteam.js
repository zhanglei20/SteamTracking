      ...
      function _(_, _, _) {
        return (0, _._)({
          ...
          queryFn: async () => {
            ...
            const _ = await _.GetRegistrations(_, _);
            return _.BSuccess()
              ? _.Body()
                  .registrations()
                  .map((_) => _.toObject())
          ...
          _ = (0, _._)({
            ...
            queryFn: async () => {
              const _ = {
                ...
                _ = await _.GetUserActionData(_, _);
            ...
            _ ||
              (_ = new (_())(
                async (_) => {
                  ...
                  const _ = await _.GetMultipleUserActionData(_, _);
                  if (!_.BSuccess())
            ...
            _ ||
              (_ = new (_())(
                async (_) => {
                  ...
                  const _ = await _.GetBatchPartnerEmailAndName(_, _);
                  if (!_.BSuccess())
            ...
            (0, _.jsx)("a", {
              ...
              onClick: async (_) => {
                ...
                const _ = await (async function (_, _) {
                  ...
                  const _ = await _.TestFireEmails(_, _);
          ...
          _ = (function (_) {
            const _ = (0, _._)({
              ...
              queryFn: async () => {
                ...
                const _ = await _.GetSaleEventOrganizers(_, _);
                return _.BSuccess()
                  ? _.Body()
                      .info()
                      .map((_) => _.toObject())
