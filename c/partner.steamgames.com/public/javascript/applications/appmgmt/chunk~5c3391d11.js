    ...
    [4298],
    {
      ...
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        function _() {
          ...
          return (_ && _) || _ || _._.FORCED_DISPLAY_MODE == "steamdeck"
            ? [!0, _._]
            : (_ && _) || _._.FORCED_DISPLAY_MODE == "steammachine"
              ? [!0, _._]
              : (_ && _) || _._.FORCED_DISPLAY_MODE == "steamframe"
                ? [!0, _._]
                : _
                  ? [!0, _._]
                  : [!1, _._];
        ...
        const _ = (_) => {
          ...
          _ = (_) => {
            const {
                category:
                  _ = ESteamDeckCompatibilityCategory.k_ESteamDeckCompatibilityCategory_Unknown,
                className: _,
              } = _,
              _ = _(_);
            return jsxs("div", {
              className: classnames(styles.SteamDeckCompatInfo, _),
              children: [
                jsx(SteamMachineCompatLogo, {}),
                jsx(_, {
                  className: styles.SteamDeckCompatIcon,
                }),
              ],
            });
          },
          ...
          _ = (_) => {
            const { category: _, elControllerSupport: _ } = _,
              _ = _(_);
            return jsxs("div", {
              className: classnames(styles.SteamDeckCompatInfo, _.className),
              children: [
                _,
                jsx(_, {
                  className: styles.SteamDeckCompatIcon,
        ...
        const _ = {
          [_._]: "#DeckVerified_CategoryLabel_Verified",
          [_._]: "#DeckVerified_CategoryLabel_Playable",
          [_._]: "#DeckVerified_CategoryLabel_Unsupported",
          [_._]: "#DeckVerified_CategoryLabel_Unknown",
        };
        function _(_) {
        ...
        const _ = {
          [_._]: "#SteamOS_CategoryLabel_Compatible",
          [_._]: "#SteamOS_CategoryLabel_Unsupported",
          [_._]: "#SteamOS_CategoryLabel_Unknown",
        };
        function _(_) {
          return HWCompatLocalization.Localize(
            _[_] || "#SteamOS_CategoryLabel_Unknown",
        ...
        const _ = {
          [_._]: "#DeckVerified_FilterLabel_Verified",
          [_._]: "#DeckVerified_FilterLabel_Verified_Playable",
          [_._]: "#DeckVerified_FilterLabel_Verified_Playable_Unknown",
          [_._]: "#DeckVerified_FilterLabel_AllGames",
        };
        function _(_) {
          return HWCompatLocalization.Localize(
            _[_] || "#DeckVerified_FilterLabel_Unknown",
          );
        }
        const _ = {
          [_._]: "#DeckVerified_FilterDescription_Verified",
          [_._]: "#DeckVerified_FilterDescription_Verified_Playable",
          [_._]: "#DeckVerified_FilterDescription_Verified_Playable_Unknown",
          [_._]: "#DeckVerified_FilterDescription_AllGames",
        };
        function _(_) {
          return HWCompatLocalization.Localize(
            _[_] || "#DeckVerified_FilterLabel_Unknown",
        ...
        const _ = {
          [_._]: "#SteamOS_FilterLabel_Compatible",
          [_._]: "#SteamOS_FilterLabel_Compatible_Unknown",
          [_._]: "#SteamOS_FilterLabel_AllGames",
        };
        function _(_) {
          return HWCompatLocalization.Localize(
            _[_] || "#SteamOS_CategoryLabel_Unknown",
        ...
        const _ = {
          [_._]: "#MachineVerified_FilterDescription_Verified",
          [_._]: "#MachineVerified_FilterDescription_Verified_Playable",
          [_._]: "#MachineVerified_FilterDescription_Verified_Playable_Unknown",
          [_._]: "#MachineVerified_FilterDescription_AllGames",
        };
        function _(_) {
          return HWCompatLocalization.Localize(
            _[_] || "#DeckVerified_FilterLabel_Unknown",
        ...
        const _ = {
          [_._]: "#FrameVerified_FilterDescription_Verified",
          [_._]: "#FrameVerified_FilterDescription_Verified_Playable",
          [_._]: "#FrameVerified_FilterDescription_Verified_Playable_Unknown",
          [_._]: "#FrameVerified_FilterDescription_AllGames",
        };
        function _(_) {
          return HWCompatLocalization.Localize(
            _[_] || "#DeckVerified_FilterLabel_Unknown",
        ...
        const _ = {
          [_._]: "#SteamOS_FilterDescription_Compatible",
          [_._]: "#SteamOS_FilterDescription_Compatible_Unknown",
          [_._]: "#SteamOS_FilterDescription_AllGames",
        };
        function _(_) {
          return HWCompatLocalization.Localize(
            _[_] || "#SteamOS_CategoryLabel_Unknown",
      ...
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        _([_._], _.prototype, "LoadAppCompabitilityResult", 1);
        let _ = _;
        function _(_) {
        ...
        function _(_) {
          ...
          return jsxs(FocusableAnchor, {
            ...
            children: [
              _ &&
                jsx("div", {
                  className: styles.DeveloperComments_Icon,
                }),
              jsx("div", {
                className: _
      ...
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        _([_._], _.prototype, "OnFocusNavigationChanged", 1),
          _([_._], _.prototype, "OnActiveNavTreeChanged", 1),
          _([_._], _.prototype, "SetActionDescriptionsFromMap", 1);
        let _ = null;
        var _ = __webpack_require__("chunkid"),
          _ = __webpack_require__("chunkid"),
          _ = __webpack_require__._(_),
