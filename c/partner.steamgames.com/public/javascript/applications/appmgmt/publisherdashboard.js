      ...
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        function _(_) {
          const {
            ...
            _ = (0, _._)(_, -_.getDay()),
            _ = new Date(_.getFullYear(), _.getMonth() + 1, 0).getDate(),
            _ =
              (_ +
                _.getDay() +
                ((_.getDay() + _) % 7 != 0 ? 7 - ((_.getDay() + _) % 7) : 0)) /
              7,
          ...
          _.useEffect(() => {
            for (let _ = 0; _ < _; _++) {
              ...
              for (let _ = 0; _ < 7; _++) {
                ...
                _
                  ? _[_ * 7 + _].current?.style.setProperty("--note-color", _)
                  : _[_ * 7 + _].current?.style.removeProperty("--note-color"),
                  _
                    ? _[_ * 7 + _].current?.style.setProperty("--day-color1", _)
                    : _[_ * 7 + _].current?.style.removeProperty(
                        "--day-color1",
                      ),
                  (_ ?? _)
                    ? _[_ * 7 + _].current?.style.setProperty(
                        "--day-color2",
                        _ ?? _,
                      )
                    : _[_ * 7 + _].current?.style.removeProperty(
        ...
        class _ {
          ...
          RemoveAdditionalEvent(_) {
            this.m_rgAdditionalEvents.delete(_),
              this.m_eventsChanged.Dispatch();
          }
        }
        function _(_) {
          ...
          return (
            (0, _._)(_.EventsChanged(), () => {
              _(_.GetAdditionalEvents()), _((_) => _ + 1);
            }),
            _
          );
        }
        ...
        class _ {
          ...
          async Init(_, _) {
            ...
            _.Body().set_accountid(this.m_accountId),
              _.Body().set_partnerid(this.m_partnerId),
              _.Body().set_rtime_after(
            ...
            if (_.BSuccess()) {
              for (const _ of _.Body().dismiss_list())
                if (_.state() == _._._) {
                  ...
                  _.push(_.dismiss_id()),
                    this.m_rgDismisses.set(_.key_json(), _);
                }
          ...
          async SetDismiss(_, _) {
            ...
            _.push(null), this.m_rgDismisses.set(_, _), this.DismissesUpdated();
            const _ = _._.Init(_._),
              _ = new _._();
        ...
        function _() {
          return _.useMemo(
            () =>
              (0, _._)("rgUpcomingReleaseApps", "application_config")?.map(
                (_) => {
                  const _ = new Date(_.releaserequest.release_date * 1e3),
                    _ = _.type == "DLC",
        ...
        function _(_) {
          const { app: _, hasStoreItem: _ } = _,
            ...
            _ = (0, _._)(
              ...
              _.releasestate == "prerelease" && _.Prerelease,
              _.releasestate == "released" && _.Released,
            );
          return (0, _.jsx)("div", {
        ...
        class _ {
          ...
          GetInfo(_) {
            ...
            if (!_) {
              this.m_rgOptInComputed.set(_, void 0);
              return;
            }
            const _ = new Set(_.invited_appids),
              _ = _.description.definition.invitation_only
                ? _.summary?.apps_eligible.filter((_) => _.has(_.appid))
            ...
            _ = _.useMemo(() => {
              ...
              return (
                _?.map((_) => {
                  if (
                    !_.start_date ||
                    (new Date(_.end_date * 1e3) < _ && !_(_, _))
                  )
                    return null;
                  const _ = _.get(_._);
                  if (
                    (_.type == "assetrequest" &&
                      new Date(_.start_date * 1e3) < _ &&
                      _?.enable_input &&
                      _.submitting_accountid) ||
                    (_.type == "launchtracking" && !_?.enable_input)
                  )
                    return null;
                  const _ = _?.GetInfo(_.opt_in_id),
                    _ = _.type == "assetrequest" && _ && !_.enable_input,
                    _ =
                      _.has(_._) ||
                      ((_.type == "nextfest" || _.type == "themesale") &&
                        _ &&
                        !_) ||
                      _,
                    _ = (_.type == "nextfest" || _.type == "themesale") && !_,
                    _ =
                      _.type != "seasonalsale" &&
                      _ &&
                      _.rgEligibleApps &&
                      _.rgEligibleApps.length == 0 &&
                      _.rgRegisteredApps &&
                      _.rgRegisteredApps.length == 0;
                  return new _(
                    _._,
                    _,
                    _,
                    ...
                    _,
                    _,
                    new Date(_.start_date * 1e3),
                    new Date(_.end_date * 1e3),
                    "event",
                    _(_, _),
                    _,
                    _,
        ...
        class _ {
          ...
          constructor(_, _, _, _, _, _, _, _, _, _, _, _, _, _) {
            (this.m_partnerId = _),
              ...
              (this.m_optIn = _),
              (this._ = _),
              (this.title = _(_.name, _.type, _, _.start_date)),
              (this.startDate = _),
              (this.endDate = _),
              (this.eventType = _),
        ...
        _([_._], _.prototype, "dataChanged", 1);
        function _(_, _) {
          if (_(_, _))
            return (0, _._)(
        ...
        function _(_, _) {
          return (
            _.type == "nextfest" &&
            new Date(_.end_date * 1e3).getTime() < _.getTime()
          );
        }
        function _(_) {
          const { eventData: _ } = _,
            _ = _();
          return _(_, _.m_plan) && _.m_plan.type == "nextfest"
            ? (0, _.jsx)(_, {
                eventData: _,
              })
            : _.m_plan.type == "nextfest" || _.m_plan.type === "themesale"
              ? (0, _.jsx)(_, {
                  eventData: _,
                })
              : (0, _.jsx)(_, {
        ...
        function _(_) {
          ...
          let _ =
            ...
            _ = _?.GetAssets().GetHeaderURL();
          _ ??= _
            ? _._.PARTNER_BASE_URL + "apps/landing/" + _.GetAppID()
            : null;
        ...
        function _(_) {
          ...
          let _ = (_ ?? _)?.GetAssets().GetHeaderURL();
          const _ = (0, _.sfN)(_._.LANGUAGE),
            { eventModel: _, bLoading: _ } = (0, _._)(
              _.sale_clan_account,
              _.sale_clan_event_gid,
        ...
        function _(_) {
          ...
          let _;
          if (_.type == "nextfest" && _.eventType == "deadline") {
            const _ = new Intl.DateTimeFormat(navigator.language, {
              month: "short",
              day: "numeric",
            }).format(
              new Date(
                _.m_optIn.description.definition.optin_deadline_date * 1e3,
              ),
            );
            _ = (0, _.jsxs)(_.Fragment, {
              children: [
          ...
          const _ = _?.description.start_date ?? _.start_date,
            ...
            _ =
              _?.description?.definition?.localized_optin_banner?.[
                _._.LANGUAGE
              ],
            _ =
            ...
            _ = _().get("optin_placeholder_banner"),
            _ = _ ?? _,
        ...
        function _(_) {
          const _ = _(),
            _ =
              (_.m_plan.type == "seasonalsale" ||
                _.m_plan.type == "themesale") &&
              _.eventType != "deadline" &&
              _.eventType != "deadline-urgent" &&
          ...
          _.useEffect(() => {
            ...
            for (const _ of (0, _._)(
              ...
              if (
                !_.m_optIn?.rgFeaturedApps.includes(_.appid) ||
                !_?.has(_.appid)
              )
                continue;
              ...
              if (_) {
                if (!_ && _.m_plan.type == "seasonalsale") {
                  const _ = new Date(
                      _.m_optIn.description.definition.optin_deadline_date *
                        1e3,
                    ),
                    _ = new Date(_.m_plan.start_date * 1e3);
                  if (_ > _ && _ > _) {
                    const _ = _.clone(
                ...
                if (
                  ...
                  const _ = new Date(
                    _.m_optIn.description.definition.collect_demo_deadline *
                      1e3,
                  );
                  if (_ > _) {
                    const _ = _.clone(
          ...
          const { eventData: _ } = _,
            ...
            _ = _.useMemo(() => {
              ...
              const _ = _.data.stats?.reduce(
                (_, _) =>
                  _.rt_last_update_time > _ ? _.rt_last_update_time : _,
                0,
              );
              if (!(_ && _ > _.end_date)) return null;
              const _ =
                  _.data.stats?.filter(
                    (_) => _ != 0 && _.rt_last_update_time == _,
                  ) ?? [],
            ...
            _ =
              _ &&
              !_.survey_response?.some((_) => _.accountid == _._.accountid),
          ...
          if (
            (_.useEffect(() => {
              _.isLoading ||
                ...
                (_.isSuccess
                  ? _ == 0 && !_ && _.SetHidden(_._, !0)
                  : _.SetHidden(_._, !0));
            }, [_, _, _, _._, _.isLoading, _.isSuccess]),
            _.isLoading)
          )
            return (0, _.jsx)(_._, {});
          if (_ == 0 && !_ && !_._.startsWith("fakerecap_")) return;
        ...
        function _(_) {
          const { eventData: _ } = _,
            ...
            _ =
              _.m_plan.start_date &&
              _.format((0, _._)(void 0, _.m_plan.start_date, "partner") * 1e3),
            _ = _.m_plan,
            [_] = (0, _._)(_.store_item_id, _.store_item_type, {
              include_basic_info: !0,
              include_assets: !0,
          ...
          const {
            ...
            _ =
              ...
              _.description.definition.event_start_date -
                _.description.definition.optin_deadline_date >
                _._.PerDay &&
              _.format(_.description.definition.optin_deadline_date * 1e3);
          return (0, _.jsxs)(_.Fragment, {
            children: [
              _ &&
                (0, _.jsxs)(_._, {
        ...
        function _(_) {
          const {
            ...
            _ = _.format(_),
            _ =
              _ == "trailer-seasonalsale" || _ == "trailer-themesale"
                ? _
                : _.format(new Date(_?.description.start_date * 1e3)),
            _ = _.useMemo(() => {
            ...
            _ = _(_.m_partnerId, _, _.start_date, _.end_date)?.length > 0,
            _ =
              _?.description?.definition?.localized_optin_banner?.[
                _._.LANGUAGE
              ],
        ...
        function _(_) {
          ...
          return (0, _._)(_, (_) => `${_.rtStartDate}_${_.rtEndDate}`)
            .map(
              (_) =>
                `${_.format(new Date(_.rtStartDate * 1e3))} - ${_.format(new Date(_.rtEndDate * 1e3))}`,
            )
            .join(", ");
        }
        function _(_, _, _, _) {
        ...
        function _(_, _, _, _) {
          ...
          if (_ == "seasonalsale") {
            ...
            const _ = _?.description?.definition?.event_title?.[_._.LANGUAGE];
            if (_) _ = _;
            else {
              const _ = [
                "takeover",
              ...
              (_, _) => {
                const _ = new Date(_.getTime() - 5 * _._.PerDay * 1e3),
                  ...
                  _ = new _(
                    ...
                    null,
                    _,
                    new Date(_.description.start_date * 1e3),
                    new Date(_.description.end_date * 1e3),
                    "event",
                    _(_, _),
                    !1,
                    !1,
        ...
        function _(_, _) {
          ...
          let _ = "#";
          for (let _ = 0; _ < 3; _++) {
            const _ = Math.floor(((_ >> (_ * 8)) & 255) * _);
            _ += ("00" + _.toString(16)).slice(-2);
          }
          return _;
        }
        var _ = __webpack_require__("chunkid"),
        ...
        function _() {
          ...
          return _.useMemo(() => {
            if (!_) return [];
            const _ = _((0, _._)("rgDeadlines", "application_config")),
              _ = (_ ? Array.from(_.entries()) : [])
                .filter(([_, _]) => new Date(_.due_date * 1e3) >= _ || _(_))
                .reduce((_, [_, _]) => {
                  const _ = (0, _._)(new Date(_.due_date * 1e3)),
                    _ = _(_.type),
                    _ = _ ? "group" : _,
            ...
            return (
              Array.from(_.entries()).flatMap(([_, _]) => {
                const { dueDate: _, bSupportsGrouping: _, deadlines: _ } = _,
                  _ = [];
                return (
                  _ ? _.push(_(_, _)) : _.push(..._.map((_) => _(_, _))),
                  _.filter((_) => !!_).map((_) => ({
                    title: _.sTitle,
                    startDate: _,
                    endDate: _,
        ...
        function _(_) {
          if (_)
            return Object.keys(_).reduce((_, _) => _.set(_, _[_]), new Map());
        }
        function _(_) {
          switch (_.type) {
            case _._._:
            ...
            case _._._: {
              const _ = _.description_jsondata
                ...
                : void 0;
              return !(
                _?.TemplateName == "F1099MISC-ConsentYes" ||
                _?.TemplateName == "F1042-Consent"
              );
            }
          }
          return !1;
        ...
        function _(_, _) {
          ...
          switch (_.type) {
            ...
            case _._._: {
              const _ = _.GetInfo(_?.opt_in_name)?.description.definition
                .event_title[_._.LANGUAGE];
              return _
                ? {
                    sHeader: (0, _._)(
            ...
            case _._._:
              return {
                ...
                bUrgent: _.due_date < _._.GetTimeNowWithOverride() - 10080 * 60,
                element: (0, _.jsx)(_, {
                  deadline: _,
                  json: _,
                }),
            ...
            case _._._:
              return {
                ...
                bUrgent:
                  _.due_date < _._.GetTimeNowWithOverride() + 744 * 60 * 60,
                element: (0, _.jsx)(_, {
                  deadline: _,
                  json: _,
                }),
        ...
        function _(_) {
          const { deadline: _, json: _ } = _,
            _ = new Intl.DateTimeFormat(navigator.language, {
              month: "short",
              day: "numeric",
            }).format(new Date(_.due_date * 1e3));
          return (0, _.jsxs)(_.Fragment, {
            children: [
              (0, _.jsxs)("div", {
        ...
        function _(_) {
          const { deadline: _, json: _ } = _,
            ...
            _ = (0, _._)(_.store_item_id)?.find(
              (_) => _.milestone_id == Number.parseInt(_.gid),
            ),
          ...
          return _.useMemo(
            () =>
              _.filter(
                (_) =>
                  !_.cancelled &&
                  new Date((_.rtime32_start_time + 7 * _._.PerDay) * 1e3) > _,
              ).flatMap((_) => {
                const _ = new Date((_.rtime32_start_time + _._.PerDay) * 1e3);
                return {
                  title: _.store_item_name,
                  startDate: new Date(_.rtime32_start_time * 1e3),
                  endDate: _,
                  eventType: "event",
                  _: _.gid,
                  eventTypeName: _(_),
        ...
        function _(_, _) {
          return (
            new Date((_.rtime32_start_time + _._.PerDay) * 1e3).getTime() <
            _.getTime()
          );
        }
        function _(_) {
        ...
        function _(_) {
          ...
          const _ = _.rtime32_start_time + 1380 * 60,
            {
            ...
            _ = new Intl.DateTimeFormat(navigator.language, {
              month: "short",
              day: "numeric",
            }).format(new Date(_.rtime32_start_time * 1e3)),
            _ = (0, _._)(_);
          return (0, _.jsxs)(_._, {
            hasImage: !!_,
            children: [
        ...
        function _(_) {
          const { deal: _, partnerId: _ } = _,
            ...
            _ = (0, _._)(_, _?.gid ? [_.gid] : [])?.get(_.gid),
            _ = !_ || !_ || _ == _._;
          ...
          return _.useMemo(() => {
            const _ = _._.Get().GetActiveEvents(),
              ...
              _ = (_, _) => ({
                ...
                startDate: new Date(_.rtStartTime * 1e3),
                endDate: new Date(_.rtEndTime * 1e3),
                eventType: "event",
                _: _.clanEventGID,
                eventTypeName: _,
                getElement: () =>
        ...
        function _() {
          return _.useMemo(
            () =>
              (0, _._)("rgMarketingMessagePreviews", "application_config")?.map(
                (_) => {
                  const _ = new Date(_.start_date * 1e3),
                    _ = new Date(_.end_date * 1e3);
                  return {
                    title: _.title,
                    startDate: _,
                    endDate: _,
        ...
        function _(_) {
          const { marketingMessage: _ } = _,
            ...
            _ = _.bShowWarnings
              ? _._.GetMarketingMesssageEditURL(_.gid)
              : void 0,
            _ = _();
          let _,
            _,
        ...
        function _(_) {
          const _ =
              _.template_vars_json?.length > 0
                ...
                : void 0,
            _ = _?.custom_display == "partner_event" && _?.update_event_gid,
            { eventModel: _ } = (0, _._)(
            ...
            return (
              Array.from(_.values()).map((_) => {
                ...
                return {
                  ...
                  startDate: new Date(_.startTime * 1e3),
                  endDate: new Date(_.endTime * 1e3),
                  eventType: "event",
                  _: _.GID,
                  eventTypeName: (0, _._)(
        ...
        function _(_, _, _, _, _) {
          return !(
            (_.valveOnly && !_) ||
            (_?.length > 0 && !_.includes(_._)) ||
            _.has(_._) ||
            (_.dimmed && _ >= _.startDate) ||
            new Date(_.startDate.getTime() + 21 * _._.PerDay * 1e3) < _
          );
        }
        function _(_) {
            ...
            _.useMemo(() => {
              ...
              if (_ == _) {
                const _ = (_, _, _) => {
                  ...
                  return _.length > 1 ? _.filter((_) => !_(_)).concat(_(_)) : _;
                };
                _ ||
                  (_ = _(
                    _,
            ...
            _ = _.useMemo(
              () =>
                _(
                  ...
                  0,
                  "recap",
                  _.length != 1 || _[0].eventTypeName.length > 0,
                ),
              [_, _],
            ),
            _ = _.useMemo(
        ...
        function _(_) {
          const {
            ...
            _ = _();
          _(_);
          const _ = _.eventType == "deadline",
            _ = _.eventType == "deadline-urgent",
            _ = _.eventType == "release-game",
            _ = _.eventType == "release-dlc",
            _ = _.eventType == "event",
            _ = (0, _._)(
              _.ListDayNumber,
              _ && _.Deadline,
        ...
        function _(_, _) {
          ...
          return _(_.eventType) < _(_.eventType)
            ? -1
            : _(_.eventType) > _(_.eventType)
              ? 1
              : _._ < _._
                ? -1
                : _._ > _._
        ...
        function _(_) {
          const _ = Math.min(..._.keys()),
            _ = Math.max(..._.keys());
          let _ = new Date(_);
          for (_.setMonth(_.getMonth() + 1); _.getTime() < _; )
        ...
        function _(_, _, _, _) {
          return !(
            (_ &&
              _.trim().length > 0 &&
              ((_ = _.trim()),
              !_.title.toLocaleLowerCase().includes(_.toLocaleLowerCase()) &&
                !_.eventTypeName
                  .toLocaleLowerCase()
        ...
        function _(_) {
          ...
          if (!_ && (!_ || _.length == 0)) return [];
          const _ = [],
            _ = 14,
            _ = _.some(
              (_) =>
                new Date().getTime() / 1e3 >= _.rtexpiretime - _ * _._.PerDay,
            );
          return (
            _.push({
              _: "dailydeal",
          ...
          if (
            ((_ || !_.bHasCommunicationRightUser) &&
              _.push({
                ...
                title: (0, _._)("#Dashboard_ImportantActions_CommRights_Title"),
                image: (0, _.jsx)(_, {}),
                description: (0, _._)(
            ...
            const _ =
                _.rtPaymentInfoExpires > 0
                  ...
                  : _
                    ? new Date().getTime() / 1e3 + _._.PerDay * 7
                    : 0,
              _ = new Date(_ * 1e3).toLocaleDateString(
        ...
        function _(_) {
          const {
            ...
            _ = () => {
              typeof _ == "function" && _(), window.open(_, "_blank");
            };
          return (0, _.jsxs)("div", {
            ...
            _.useEffect(() => {
              _._.Init(),
                ...
                (async () => {
                  ...
                  await Promise.all([_._.InitGlobal(), _]), _(!1);
                })();
            }, [_]),
            _
          );
