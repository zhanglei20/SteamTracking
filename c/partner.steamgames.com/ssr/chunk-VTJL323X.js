...
var _ = "./pricing_malay-XXXXXXXX.json";
...
var _ = _(_);
var _ = _.k_EPriceConversion_NuancedRegional,
  _ = class {
    ...
    GetAnyPricePoint() {
      return Array.from(
        this.m_mapUSDPrice
          .get(_.k_EPriceConversion_NuancedRegional)
          ?.values() || [],
      )[0];
    }
        ...
        this.m_setConversionMethod.add(_),
          ...
          _.region_prices.forEach((_) => {
            ...
            if (
              ...
              this.m_setConversionMethod.has(_.k_EPriceConversion_ExchangeRate))
            ) {
              let _ = {
                  currency_code: 1,
                  price: _.usd_price,
                ...
                _ = this.GetKey(
                  ...
                  1,
                  _.region_code,
                  _.k_EPriceConversion_ExchangeRate,
                );
              this.m_mapKeyToGuidePrice.set(_, _);
            }
          });
...
var _ = _(_(), 1),
  _ = _.createContext({
    eConversionMethod: _.k_EPriceConversion_NuancedRegional,
