...
(_.arabic = () => _(() => import(`./DtwTqH6e2.js`), [], import.meta.url)),
  (_.brazilian = () => _(() => import(`./C8ozJMTI.js`), [], import.meta.url)),
  (_.bulgarian = () => _(() => import(`./9D52ulje.js`), [], import.meta.url)),
  (_.czech = () => _(() => import(`./CnX72g9_.js`), [], import.meta.url)),
  (_.danish = () => _(() => import(`./BGfDKJu5.js`), [], import.meta.url)),
  (_.dutch = () => _(() => import(`./CurMT3kZ.js`), [], import.meta.url)),
  (_.english = () => _(() => import(`./DZ2Kx39_.js`), [], import.meta.url)),
  (_.finnish = () => _(() => import(`./kzHE7aDH.js`), [], import.meta.url)),
  (_.french = () => _(() => import(`./BrvAdBM1.js`), [], import.meta.url)),
  (_.german = () => _(() => import(`./hj37n8Fs.js`), [], import.meta.url)),
  (_.greek = () => _(() => import(`./qofduZ-G.js`), [], import.meta.url)),
  (_.hungarian = () => _(() => import(`./Fr6W6May.js`), [], import.meta.url)),
  (_.indonesian = () => _(() => import(`./B0tU6Fja.js`), [], import.meta.url)),
  (_.italian = () => _(() => import(`./Dli5NBZU.js`), [], import.meta.url)),
  (_.japanese = () => _(() => import(`./C8092uwc.js`), [], import.meta.url)),
  (_.koreana = () => _(() => import(`./eqNdwhFA.js`), [], import.meta.url)),
  (_.latam = () => _(() => import(`./h46R475V.js`), [], import.meta.url)),
  (_.malay = () => _(() => import(`./jfJW19b6.js`), [], import.meta.url)),
  (_.norwegian = () => _(() => import(`./_Et1vrtb.js`), [], import.meta.url)),
  (_.polish = () => _(() => import(`./D_1_QxQ2.js`), [], import.meta.url)),
  (_.portuguese = () => _(() => import(`./DbetxX6O.js`), [], import.meta.url)),
  (_.romanian = () => _(() => import(`./CJeE1Nsv.js`), [], import.meta.url)),
  (_.russian = () => _(() => import(`./BV5w6bf4.js`), [], import.meta.url)),
