...
(_.arabic = () => _(() => import(`./DXCrsUpR2.js`), [], import.meta.url)),
  (_.brazilian = () => _(() => import(`./Dmgonj3M2.js`), [], import.meta.url)),
  (_.bulgarian = () => _(() => import(`./DzVARIoX2.js`), [], import.meta.url)),
  ...
  (_.greek = () => _(() => import(`./Cp_jQX1X2.js`), [], import.meta.url)),
  (_.hungarian = () => _(() => import(`./BgOTJtjS2.js`), [], import.meta.url)),
  (_.indonesian = () => _(() => import(`./BWqoCyJe2.js`), [], import.meta.url)),
  (_.italian = () => _(() => import(`./BwXeNLm22.js`), [], import.meta.url)),
  (_.japanese = () => _(() => import(`./CLhI_hSd2.js`), [], import.meta.url)),
  (_.koreana = () => _(() => import(`./jbuK5pRa2.js`), [], import.meta.url)),
  (_.latam = () => _(() => import(`./Bl_Kw8zH.js`), [], import.meta.url)),
  (_.malay = () => _(() => import(`./BTpCrYrL.js`), [], import.meta.url)),
  (_.norwegian = () => _(() => import(`./abyxQFqj.js`), [], import.meta.url)),
  (_.polish = () => _(() => import(`./CHBPaAXR.js`), [], import.meta.url)),
  (_.portuguese = () => _(() => import(`./DF4P5A_D.js`), [], import.meta.url)),
  (_.romanian = () => _(() => import(`./DNSWd3cw.js`), [], import.meta.url)),
  (_.russian = () => _(() => import(`./D540mCht.js`), [], import.meta.url)),
  (_.schinese = () => _(() => import(`./DZcLlS3C.js`), [], import.meta.url)),
  (_.spanish = () => _(() => import(`./Bvh0CC1m.js`), [], import.meta.url)),
  (_.swedish = () => _(() => import(`./Q6NgyrpY.js`), [], import.meta.url)),
  (_.tchinese = () => _(() => import(`./CfHl4_GK.js`), [], import.meta.url)),
  (_.thai = () => _(() => import(`./BGeFjkHZ.js`), [], import.meta.url)),
  (_.turkish = () => _(() => import(`./DILqBP0T.js`), [], import.meta.url)),
  (_.ukrainian = () => _(() => import(`./BSzPh1ZN.js`), [], import.meta.url)),
  (_.vietnamese = () => _(() => import(`./B8tzeCzt.js`), [], import.meta.url));
async function _(_) {
