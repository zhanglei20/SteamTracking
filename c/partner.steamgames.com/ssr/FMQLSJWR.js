...
var _ = "./currency_malay-XXXXXXXX.json";
        ...
        let _ = {
          ...
          nNuanced:
            _.GetRecommendPrice(
              ...
              _,
              void 0,
              _.k_EPriceConversion_NuancedRegional,
            )?.price || -1,
          nParity:
            _.GetRecommendPrice(
              _,
              _,
              void 0,
              _.k_EPriceConversion_PurchasingPowerParity,
            )?.price || -1,
          nFx:
            _.GetRecommendPrice(_, _, void 0, _.k_EPriceConversion_ExchangeRate)
              ?.price || -1,
        };
      ...
      for (let _ = 1; _ < 5; ++_) {
        ...
        let _ = 1,
          _ = {
            ...
            eCurrencyCode: _,
            nNuanced:
              _.GetRecommendPrice(_, _, _, _.k_EPriceConversion_NuancedRegional)
                ?.price || -1,
            nParity:
              _.GetRecommendPrice(
                _,
            ...
            nFx:
              _.GetRecommendPrice(_, _, _, _.k_EPriceConversion_ExchangeRate)
                ?.price || -1,
          };
        (_.nFx != -1 || _.nNuanced != -1 || _.nParity != -1) && _.push(_);
      }
