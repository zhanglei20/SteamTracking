...
var INT_CACHE = {},
  UINT_CACHE = {};
function fromInt(_, _) {
  var _, _, _;
  return _
    ? ((_ >>>= 0),
      (_ = 0 <= _ && _ < 256) && ((_ = UINT_CACHE[_]), _)
        ? _
        : ((_ = fromBits(_, 0, !0)), _ && (UINT_CACHE[_] = _), _))
    : ((_ |= 0),
      (_ = -128 <= _ && _ < 128) && ((_ = INT_CACHE[_]), _)
        ? _
        : ((_ = fromBits(_, _ < 0 ? -1 : 0, !1)), _ && (INT_CACHE[_] = _), _));
}
Long.fromInt = fromInt;
function fromNumber(_, _) {
  if (isNaN(_)) return _ ? UZERO : ZERO;
  if (_) {
    if (_ < 0) return UZERO;
  ...
  return _ < 0
    ? fromNumber(-_, _).neg()
    : fromBits((_ % TWO_PWR_32_DBL) | 0, (_ / TWO_PWR_32_DBL) | 0, _);
}
Long.fromNumber = fromNumber;
function fromBits(_, _, _) {
  return new Long(_, _, _);
}
Long.fromBits = fromBits;
var pow_dbl = Math.pow;
function fromString(_, _, _) {
  ...
  if (
    ...
    return _ ? UZERO : ZERO;
  if (((_ ||= 10), _ < 2 || 36 < _)) throw RangeError(`radix`);
  var _;
  if ((_ = _.indexOf(`-`)) > 0) throw Error(`interior hyphen`);
  if (_ === 0) return fromString(_.substring(1), _, _).neg();
  for (
    var _ = fromNumber(pow_dbl(_, 8)), _ = ZERO, _ = 0;
    _ < _.length;
    _ += 8
  ) {
    ...
    if (_ < 8) {
      var _ = fromNumber(pow_dbl(_, _));
      _ = _.mul(_).add(fromNumber(_));
    } else (_ = _.mul(_)), (_ = _.add(fromNumber(_)));
  }
  return (_.unsigned = _), _;
}
Long.fromString = fromString;
function fromValue(_, _) {
  return typeof _ == `number`
    ? fromNumber(_, _)
    : typeof _ == `string`
      ? fromString(_, _)
      : fromBits(_.low, _.high, typeof _ == `boolean` ? _ : _.unsigned);
}
...
(LongPrototype.toInt = function () {
  ...
  (LongPrototype.toString = function (_) {
    if (((_ ||= 10), _ < 2 || 36 < _)) throw RangeError(`radix`);
    ...
    for (
      var _ = fromNumber(pow_dbl(_, 6), this.unsigned), _ = this, _ = ``;
      ;
    ) {
      var _ = _.div(_),
  ...
  (LongPrototype.getNumBitsAbs = function () {
    if (this.isNegative())
      return this._(MIN_VALUE) ? 64 : this.neg().getNumBitsAbs();
    for (
      var _ = this.high == 0 ? this.low : this.high, _ = 31;
      _ > 0 && !(_ & (1 << _));
      _--
    );
    return this.high == 0 ? _ + 1 : _ + 33;
  }),
  ...
  (LongPrototype.equals = function (_) {
    return (
      isLong(_) || (_ = fromValue(_)),
  ...
  (LongPrototype._ = LongPrototype.equals),
  (LongPrototype.notEquals = function (_) {
    return !this._(_);
  }),
  (LongPrototype.neq = LongPrototype.notEquals),
  (LongPrototype._ = LongPrototype.notEquals),
  (LongPrototype.lessThan = function (_) {
    return this.comp(_) < 0;
  }),
  (LongPrototype._ = LongPrototype.lessThan),
  (LongPrototype.lessThanOrEqual = function (_) {
    return this.comp(_) <= 0;
  }),
  (LongPrototype.lte = LongPrototype.lessThanOrEqual),
  (LongPrototype._ = LongPrototype.lessThanOrEqual),
  (LongPrototype.greaterThan = function (_) {
    return this.comp(_) > 0;
  }),
  (LongPrototype._ = LongPrototype.greaterThan),
  (LongPrototype.greaterThanOrEqual = function (_) {
    return this.comp(_) >= 0;
  }),
  (LongPrototype.gte = LongPrototype.greaterThanOrEqual),
  (LongPrototype._ = LongPrototype.greaterThanOrEqual),
  (LongPrototype.compare = function (_) {
    if ((isLong(_) || (_ = fromValue(_)), this._(_))) return 0;
  ...
  (LongPrototype.negate = function () {
    return !this.unsigned && this._(MIN_VALUE)
      ? MIN_VALUE
      : this.not().add(ONE);
  }),
  (LongPrototype.neg = LongPrototype.negate),
  (LongPrototype.add = function (_) {
    isLong(_) || (_ = fromValue(_));
    var _ = this.high >>> 16,
      _ = this.high & 65535,
      _ = this.low >>> 16,
    ...
    return (
      ...
      (_ += _ + _),
      (_ &= 65535),
      fromBits((_ << 16) | _, (_ << 16) | _, this.unsigned)
    );
  }),
  (LongPrototype.subtract = function (_) {
    return isLong(_) || (_ = fromValue(_)), this.add(_.neg());
  }),
  (LongPrototype.sub = LongPrototype.subtract),
  (LongPrototype.multiply = function (_) {
    if (this.isZero()) return this;
    if ((isLong(_) || (_ = fromValue(_)), wasm))
      return fromBits(
        wasm.mul(this.low, this.high, _.low, _.high),
        wasm.get_high(),
        this.unsigned,
      );
    if (_.isZero()) return this.unsigned ? UZERO : ZERO;
    if (this._(MIN_VALUE)) return _.isOdd() ? MIN_VALUE : ZERO;
    if (_._(MIN_VALUE)) return this.isOdd() ? MIN_VALUE : ZERO;
    if (this.isNegative())
      return _.isNegative() ? this.neg().mul(_.neg()) : this.neg().mul(_).neg();
    if (_.isNegative()) return this.mul(_.neg()).neg();
    if (this._(TWO_PWR_24) && _._(TWO_PWR_24))
      return fromNumber(this.toNumber() * _.toNumber(), this.unsigned);
    var _ = this.high >>> 16,
      _ = this.high & 65535,
      _ = this.low >>> 16,
      _ = this.low & 65535,
  ...
  (LongPrototype.divide = function (_) {
    if ((isLong(_) || (_ = fromValue(_)), _.isZero()))
    ...
    var _, _, _;
    if (this.unsigned) {
      if ((_.unsigned || (_ = _.toUnsigned()), _._(this))) return UZERO;
      if (_._(this.shru(1))) return UONE;
      _ = UZERO;
    } else {
      if (this._(MIN_VALUE))
        return _._(ONE) || _._(NEG_ONE)
          ? MIN_VALUE
          : _._(MIN_VALUE)
            ? ONE
            : ((_ = this.shr(1).div(_).shl(1)),
              _._(ZERO)
                ? _.isNegative()
                  ? ONE
                  : NEG_ONE
                : ((_ = this.sub(_.mul(_))), (_ = _.add(_.div(_))), _));
      if (_._(MIN_VALUE)) return this.unsigned ? UZERO : ZERO;
      if (this.isNegative())
        return _.isNegative()
          ? this.neg().div(_.neg())
          : this.neg().div(_).neg();
    ...
    for (_ = this; _.gte(_); ) {
      ...
      for (
        var _ = Math.ceil(Math.log(_) / Math.LN2),
          _ = _ <= 48 ? 1 : pow_dbl(2, _ - 48),
          _ = fromNumber(_),
          _ = _.mul(_);
        _.isNegative() || _._(_);
      )
        (_ -= _), (_ = fromNumber(_, this.unsigned)), (_ = _.mul(_));
      _.isZero() && (_ = ONE), (_ = _.add(_)), (_ = _.sub(_));
    }
    return _;
  }),
  (LongPrototype.div = LongPrototype.divide),
  (LongPrototype.modulo = function (_) {
    return (
      isLong(_) || (_ = fromValue(_)),
      wasm
        ? fromBits(
  ...
  (LongPrototype.and = function (_) {
    return (
      isLong(_) || (_ = fromValue(_)),
      fromBits(this.low & _.low, this.high & _.high, this.unsigned)
    );
  }),
  (LongPrototype._ = function (_) {
    return (
      isLong(_) || (_ = fromValue(_)),
      fromBits(this.low | _.low, this.high | _.high, this.unsigned)
    );
  }),
  (LongPrototype.xor = function (_) {
    return (
      isLong(_) || (_ = fromValue(_)),
      fromBits(this.low ^ _.low, this.high ^ _.high, this.unsigned)
    );
  }),
  (LongPrototype.shiftLeft = function (_) {
    return (
      isLong(_) && (_ = _.toInt()),
      (_ &= 63) == 0
        ? this
        : _ < 32
          ...
          : fromBits(0, this.low << (_ - 32), this.unsigned)
    );
  }),
  (LongPrototype.shl = LongPrototype.shiftLeft),
  (LongPrototype.shiftRight = function (_) {
    return (
      isLong(_) && (_ = _.toInt()),
      (_ &= 63) == 0
        ? this
  ...
  (LongPrototype.shiftRightUnsigned = function (_) {
    return (
      isLong(_) && (_ = _.toInt()),
      (_ &= 63) == 0
        ? this
  ...
  (LongPrototype.rotateLeft = function (_) {
    var _;
    return (
      isLong(_) && (_ = _.toInt()),
      (_ &= 63) == 0
  ...
  (LongPrototype.rotateRight = function (_) {
    var _;
    return (
      isLong(_) && (_ = _.toInt()),
      (_ &= 63) == 0
  ...
  (LongPrototype.toBytes = function (_) {
  ...
  (Long.fromBytes = function (_, _, _) {
    return _ ? Long.fromBytesLE(_, _) : Long.fromBytesBE(_, _);
  }),
  (Long.fromBytesLE = function (_, _) {
    return new Long(
  ...
  typeof BigInt == `function` &&
    ...
    (Long.fromValue = function (_, _) {
      return typeof _ == `bigint` ? Long.fromBigInt(_, _) : fromValue(_, _);
    }),
    (LongPrototype.toBigInt = function () {
      var _ = BigInt(this.low >>> 0);
      return (
        (BigInt(this.unsigned ? this.high >>> 0 : this.high) << BigInt(32)) | _
      );
    }));
var CAccountPrivacyCookiePreferences = class _ extends import_google_protobuf.Message {
    ...
    constructor(_ = null) {
      super(),
        _.prototype.version || AddAccessors(_._()),
        import_google_protobuf.Message.initialize(this, _, 0, -1, void 0, null);
    }
    static sm_m;
    static sm_mbf;
        ...
        (_.sm_m ||= {
          ...
          fields: {
            ...
            content_customization: {
              _: 3,
              _: CAccountPrivacyCookiePreferences_ContentCustomization,
            },
            valve_analytics: {
              _: 4,
              _: CAccountPrivacyCookiePreferences_ValveAnalytics,
            },
            third_party_analytics: {
              _: 5,
              _: CAccountPrivacyCookiePreferences_ThirdPartyAnalytics,
            },
            third_party_content: {
              _: 6,
              _: CAccountPrivacyCookiePreferences_ThirdPartyContent,
            },
            utm_enabled: {
              _: 7,
              _: !0,
  ...
  CAccountPrivacyCookiePreferences_ContentCustomization = class _ extends import_google_protobuf.Message {
    static ImplementsStaticInterface() {}
    constructor(_ = null) {
      super(),
        _.prototype.recentapps || AddAccessors(_._()),
        import_google_protobuf.Message.initialize(this, _, 0, -1, void 0, null);
    }
    static sm_m;
    static sm_mbf;
  ...
  CAccountPrivacyCookiePreferences_ValveAnalytics = class _ extends import_google_protobuf.Message {
    static ImplementsStaticInterface() {}
    constructor(_ = null) {
      super(),
        _.prototype.product_impressions_tracking || AddAccessors(_._()),
        import_google_protobuf.Message.initialize(this, _, 0, -1, void 0, null);
    }
    static sm_m;
    static sm_mbf;
  ...
  CAccountPrivacyCookiePreferences_ThirdPartyAnalytics = class _ extends import_google_protobuf.Message {
    static ImplementsStaticInterface() {}
    constructor(_ = null) {
      super(),
        _.prototype.google_analytics || AddAccessors(_._()),
        import_google_protobuf.Message.initialize(this, _, 0, -1, void 0, null);
    }
    static sm_m;
    static sm_mbf;
  ...
  CAccountPrivacyCookiePreferences_ThirdPartyContent = class _ extends import_google_protobuf.Message {
    static ImplementsStaticInterface() {}
    constructor(_ = null) {
      super(),
        _.prototype.youtube || AddAccessors(_._()),
        import_google_protobuf.Message.initialize(this, _, 0, -1, void 0, null);
    }
    static sm_m;
    static sm_mbf;
  ...
  CAccountPrivacy_GetCookiePreferences_Request = class _ extends import_google_protobuf.Message {
    static ImplementsStaticInterface() {}
    constructor(_ = null) {
      super(),
        import_google_protobuf.Message.initialize(this, _, 0, -1, void 0, null);
  ...
  CAccountPrivacy_GetCookiePreferences_Response = class _ extends import_google_protobuf.Message {
    static ImplementsStaticInterface() {}
    constructor(_ = null) {
      super(),
        _.prototype.preferences || AddAccessors(_._()),
        import_google_protobuf.Message.initialize(this, _, 0, -1, void 0, null);
    }
    static sm_m;
    static sm_mbf;
      ...
      return (
        (_.sm_m ||= {
          ...
          fields: {
            preferences: {
              _: 1,
              _: CAccountPrivacyCookiePreferences,
            },
          },
        }),
        _.sm_m
...
function IsCookieAllowedByPreferences(_) {
  if (_.preferenceControls.isTechnicallyNecessary) return !0;
  let _ = GetCurrentCookiePreferences();
  if (!_) return !1;
...
function ReadCookie(_) {
  if (!document.cookie) return;
  let _ = document.cookie.match(`(^|; )` + _.name + `=([^;]*)`);
  if (_ && _[2]) return decodeURIComponent(_[2]);
}
function WriteCookie(_, _) {
  if (!document.cookie || !IsCookieAllowedByPreferences(_)) return;
