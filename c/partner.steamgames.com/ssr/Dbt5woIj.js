...
(_.arabic = () => _(() => import(`./DXCrsUpR2.js`), [], import.meta.url)),
  (_.brazilian = () => _(() => import(`./B8B3jmst2.js`), [], import.meta.url)),
  (_.bulgarian = () => _(() => import(`./BwEmfMxX2.js`), [], import.meta.url)),
  (_.czech = () => _(() => import(`./CTnO-LTh2.js`), [], import.meta.url)),
  (_.danish = () => _(() => import(`./ZwZ-UZOz2.js`), [], import.meta.url)),
  (_.dutch = () => _(() => import(`./kixpbOnT2.js`), [], import.meta.url)),
  (_.english = () => _(() => import(`./IDoVVvKL2.js`), [], import.meta.url)),
  (_.finnish = () => _(() => import(`./BfVHJksG2.js`), [], import.meta.url)),
  (_.french = () => _(() => import(`./BiLLemmS2.js`), [], import.meta.url)),
  (_.german = () => _(() => import(`./DEiWlHXr2.js`), [], import.meta.url)),
  (_.greek = () => _(() => import(`./DwMQByM72.js`), [], import.meta.url)),
  (_.hungarian = () => _(() => import(`./R0042eTc2.js`), [], import.meta.url)),
  (_.indonesian = () => _(() => import(`./B1NLeZn02.js`), [], import.meta.url)),
  (_.italian = () => _(() => import(`./BbNjp53k2.js`), [], import.meta.url)),
  (_.japanese = () => _(() => import(`./Dhqefz7T2.js`), [], import.meta.url)),
  (_.koreana = () => _(() => import(`./BuqHkorL2.js`), [], import.meta.url)),
  (_.latam = () => _(() => import(`./QZ4IoNxc.js`), [], import.meta.url)),
  (_.malay = () => _(() => import(`./BMIrpu5Q.js`), [], import.meta.url)),
