...
(_.arabic = () => _(() => import(`./OQyxh8vK.js`), [], import.meta.url)),
  ...
  (_.romanian = () => _(() => import(`./WR_cUivp2.js`), [], import.meta.url)),
  (_.russian = () => _(() => import(`./Bn39wRvi2.js`), [], import.meta.url)),
  (_.sc_schinese = () =>
    _(() => import(`./B5_7-iFs2.js`), [], import.meta.url)),
  (_.schinese = () => _(() => import(`./B0dBieCS2.js`), [], import.meta.url)),
  (_.spanish = () => _(() => import(`./D181i8PU2.js`), [], import.meta.url)),
  (_.swedish = () => _(() => import(`./Y6XFa73K2.js`), [], import.meta.url)),
  (_.tchinese = () => _(() => import(`./BTObMtPJ2.js`), [], import.meta.url)),
  (_.thai = () => _(() => import(`./CG_enuSa2.js`), [], import.meta.url)),
  (_.turkish = () => _(() => import(`./BfLb_p5m2.js`), [], import.meta.url)),
  (_.ukrainian = () => _(() => import(`./B4eDS75t2.js`), [], import.meta.url)),
  (_.vietnamese = () => _(() => import(`./91OVgSpq2.js`), [], import.meta.url));
async function _(_) {
