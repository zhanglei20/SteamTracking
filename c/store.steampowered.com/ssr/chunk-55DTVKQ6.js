...
var _ = {};
_(_, {
  k_ELineItemPurchaseNoticeAdultContentRestricted: () => _,
  k_ELineItemPurchaseNoticeAppsInCart: () => _,
  k_ELineItemPurchaseNoticeAvailableThroughMasterSub: () => _,
  k_ELineItemPurchaseNoticeCommercialLicenseRestricted: () => _,
  k_ELineItemPurchaseNoticeCouponExclusivePromo: () => _,
  k_ELineItemPurchaseNoticeExistingBillingAgreement: () => _,
  k_ELineItemPurchaseNoticeExtraCopies: () => _,
  k_ELineItemPurchaseNoticeHasUserDisabledLicense: () => _,
  k_ELineItemPurchaseNoticeIndexHardwareInCart: () => _,
  k_ELineItemPurchaseNoticeInvalidCoupon: () => _,
  k_ELineItemPurchaseNoticeInvalidCouponForItem: () => _,
  k_ELineItemPurchaseNoticeMissingMustOwnApps: () => _,
  k_ELineItemPurchaseNoticeNoRefunds: () => _,
  k_ELineItemPurchaseNoticeOwnsAllApps: () => _,
  k_ELineItemPurchaseNoticeOwnsSomeApps: () => _,
  k_ELineItemPurchaseNoticePriceChanged: () => _,
  k_ELineItemPurchaseNoticeTooManyInCart: () => _,
  k_ELineItemPurchaseNoticeUnavailableInCountry: () => _,
  k_ELineItemPurchaseNoticeValid: () => _,
});
var _ = 0,
  _ = 1,
  _ = 2,
...
var _ = {};
_(_, {
  k_EAccountCartLineItem_Bundle: () => _,
  k_EAccountCartLineItem_Package: () => _,
  k_EAccountCartLineItem_Unknown: () => _,
});
var _ = 0,
  _ = 1,
  _ = 2;
...
function _(_, _, _) {
  if (_ !== void 0)
    return _
      ? _.line_items.some(
          (_) =>
            _.type == _.k_EAccountCartLineItem_Package && _.packageid === _,
        )
      : _
        ? _.line_items.some(
            (_) =>
              _.type == _.k_EAccountCartLineItem_Bundle && _.bundleid === _,
          )
        : void 0;
}
function _(_) {
  ...
  return (
    ...
    _.bundle_item?.bundleid
      ? ((_.bundleid = _.bundle_item.bundleid),
        (_.type = _.k_EAccountCartLineItem_Bundle))
      : _.package_item &&
        ...
        (_.type = _.k_EAccountCartLineItem_Package)),
    _
  );
}
function _(_) {
  ...
  return (
    (_.line_items = _.cart_items
      ?.map((_) => {
        let _;
        if (_.item_id?.packageid) _ = _.k_EAccountCartLineItem_Package;
        else if (_.item_id?.bundleid) _ = _.k_EAccountCartLineItem_Bundle;
        else return;
        return {
