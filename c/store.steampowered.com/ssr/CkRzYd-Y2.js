...
function _(_, _, _, _, _) {
  switch (_) {
    ...
    case `rgCategoryFilters`: {
      let _ = _;
      return _(
        _.Localize(`#wishlist_controls_options_category_category`),
        _?.get(_)?.name || _.toString(),
      );
    }
