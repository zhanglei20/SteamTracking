...
var _ = {
  Spinner: "L8jNN5ANQPI-",
  SpinnerSpokeFade: "xz-cm3IJfg8-",
  SpeakerPlaying: "-U6NPiUFewI-",
  SpeakerPlayingBody: "CwW-ulN-rYA-",
  SpeakerPlayingBodyAnim: "ZKDYGRlRrAo-",
  SpeakerPlayingWave1: "OQepJKegtsc-",
  SpeakerPlayingWave1Anim: "_4-u4-rIu0u4-",
  SpeakerPlayingWave2: "_3TSAcn-T9oQ-",
  SpeakerPlayingWave2Anim: "jCwuxpONe1k-",
  WirelessConnectingActive: "X4V-4Uh6Aro-",
  WifiBar1: "_26-GJiYtRnY-",
  WifiBar1Anim: "_7sHyYh1zPwM-",
  WifiBar2: "JNFv9rMfHOo-",
  WifiBar2Anim: "kTXY8cD5Pxk-",
  WifiBar3: "kTWqxbbwPQE-",
  WifiBar3Anim: "_4UQ4ItAeIwQ-",
  WifiBar4: "IYQejH-E4sQ-",
  WifiBar4Anim: "wrVO9nyctWY-",
  GenericGamepadHighlight: "-zPQLSg3pAo-",
  GenericGamepadEmpty: "Q4qi8GruWsM-",
  LegionGoAnim1: "PlD7nYrtkrw-",
  LegionGoWiggleStick: "VqnTYPtpoQE-",
  LegionGoCursorWiggle: "_7IUn63jmWQY-",
  LegionGoWiggleCursor: "R5C1MKm20Zc-",
  LegionGoTriggerClick: "dClHmtjb3kM-",
  LegionGoScreenClick: "w3vr4ZbkJj4-",
  BatteryIcon: "Rbnnz8CAqF0-",
  LegacySizing: "_3umXoeh4fyg-",
  FlipInRTL: "okgvyKCi05U-",
  IbexDiagramFrontPanelTransparencyEffect: "Z0pV20ipAN0-",
  ShowXRay: "EFMoKwbmVBA-",
  ActivatableFill: "_3wAu0NpQ1-k-",
  Active: "JOk4iz1pxD8-",
  ActivatableStroke: "KTyEcvfz2zk-",
  ActivatableGradient: "z1skJyVVASA-",
  ScootCursor: "_0zG80HdGWLU-",
};
var _ = _(_());
function _(_) {
  return (0, _.jsx)("svg", {
...
function _(_) {
  return (0, _.jsxs)("svg", {
    ...
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg",
    className: _(_.className, _.FlipInRTL),
    children: [
      (0, _.jsx)("path", {
