var _ = {};
_(_, {
  k_EWishlistSort_DateAdded: () => _,
  k_EWishlistSort_Discount: () => _,
  k_EWishlistSort_Name: () => _,
  k_EWishlistSort_Price: () => _,
  k_EWishlistSort_ReleaseDate: () => _,
  k_EWishlistSort_ReviewScore: () => _,
  k_EWishlistSort_TopSelling: () => _,
  k_EWishlistSort_YourRank: () => _,
});
var _ = 0,
  _ = 1,
  _ = 2,
