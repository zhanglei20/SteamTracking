var _ = {};
_(_, {
  k_ESteamNotificationTarget_Email: () => _,
  k_ESteamNotificationTarget_Invalid: () => _,
  k_ESteamNotificationTarget_NotificationFeed: () => _,
  k_ESteamNotificationTarget_PushNotification: () => _,
  k_ESteamNotificationTarget_Steam: () => _,
});
var _ = 0,
  _ = 1,
  _ = 2,
...
var _ = {};
_(_, {
  k_ESteamNotificationType_2FAPrompt: () => _,
  k_ESteamNotificationType_AsyncGame: () => _,
  k_ESteamNotificationType_ChatMsg: () => _,
  k_ESteamNotificationType_ClipDownloaded: () => _,
  k_ESteamNotificationType_Comment: () => _,
  k_ESteamNotificationType_FamilyInvite: () => _,
  k_ESteamNotificationType_FamilyPurchaseRequest: () => _,
  k_ESteamNotificationType_FamilyPurchaseRequestResponse: () => _,
  k_ESteamNotificationType_FriendInvite: () => _,
  k_ESteamNotificationType_General: () => _,
  k_ESteamNotificationType_Gift: () => _,
  k_ESteamNotificationType_HelpRequest: () => _,
  k_ESteamNotificationType_Invalid: () => _,
  k_ESteamNotificationType_Item: () => _,
  k_ESteamNotificationType_MajorSale: () => _,
  k_ESteamNotificationType_MobileConfirmation: () => _,
  k_ESteamNotificationType_ModeratorMsg: () => _,
  k_ESteamNotificationType_ParentalFeatureAccessRequest: () => _,
  k_ESteamNotificationType_ParentalFeatureAccessResponse: () => _,
  k_ESteamNotificationType_ParentalPlaytimeRequest: () => _,
  k_ESteamNotificationType_ParentalPlaytimeResponse: () => _,
  k_ESteamNotificationType_PartnerEvent: () => _,
  k_ESteamNotificationType_PlaytestInvite: () => _,
  k_ESteamNotificationType_PreloadAvailable: () => _,
  k_ESteamNotificationType_ReportedContentAction: () => _,
  k_ESteamNotificationType_RequestedGameAdded: () => _,
  k_ESteamNotificationType_SendToPhone: () => _,
  k_ESteamNotificationType_Test: () => _,
  k_ESteamNotificationType_TradeOffer: () => _,
  k_ESteamNotificationType_TradeReversal: () => _,
  k_ESteamNotificationType_Wishlist: () => _,
});
var _ = 0,
  _ = 1,
  _ = 2,
...
var _ = {};
_(_, {
  k_ESteamNotificationTargetClientType_Invalid: () => _,
  k_ESteamNotificationTargetClientType_SteamMobileApp: () => _,
});
var _ = 0,
  _ = 1;
function _(_) {
...
var _ = {};
_(_, {
  k_EFamilyGroupRole_Adult: () => _,
  k_EFamilyGroupRole_Child: () => _,
  k_EFamilyGroupRole_MAX: () => _,
  k_EFamilyGroupRole_None: () => _,
});
var _ = 0,
  _ = 1,
  _ = 2,
...
var _ = {};
_(_, {
  k_EPurchaseRequestAction_Abandoned: () => _,
  k_EPurchaseRequestAction_Cancel: () => _,
  k_EPurchaseRequestAction_Decline: () => _,
  k_EPurchaseRequestAction_MAX: () => _,
  k_EPurchaseRequestAction_None: () => _,
  k_EPurchaseRequestAction_Purchased: () => _,
});
var _ = 0,
  _ = 1,
  _ = 2,
