var _ = {};
_(_, {
  k_EStoreQuerySort_ConcurrentPlayers: () => _,
  k_EStoreQuerySort_DailyActiveUserRank: () => _,
  k_EStoreQuerySort_Global24hSalesRank: () => _,
  k_EStoreQuerySort_GlobalLongTermSalesRank: () => _,
  k_EStoreQuerySort_Name: () => _,
  k_EStoreQuerySort_Regional24hSalesRank: () => _,
  k_EStoreQuerySort_RegionalLongTermSalesRank: () => _,
  k_EStoreQuerySort_ReleaseDate: () => _,
  k_EStoreQuerySort_ReleaseDateAscending: () => _,
  k_EStoreQuerySort_Relevance: () => _,
  k_EStoreQuerySort_SpecialsBoost: () => _,
  k_EStoreQuerySort_TypeID: () => _,
  k_EStoreQuerySort_UserReviewScore: () => _,
  k_EStoreQuerySort_UserReviewScoreAscending: () => _,
  k_EStoreQuerySort_VRDailyActiveUserRank: () => _,
  k_EStoreQuerySort_WishlistActivityRank: () => _,
});
var _ = 0,
  _ = 1,
  _ = 2,
...
var _ = {};
_(_, {
  k_EStoreQueryExcludeFrom_Invalid: () => _,
  k_EStoreQueryExcludeFrom_NewReleases: () => _,
  k_EStoreQueryExcludeFrom_Search: () => _,
  k_EStoreQueryExcludeFrom_Tabs: () => _,
});
var _ = 0,
  _ = 1,
  _ = 2,
...
var _ = {};
_(_, {
  k_EStoreQueryPredefinedFilter_Invalid: () => _,
  k_EStoreQueryPredefinedFilter_PopularFreeReleases: () => _,
  k_EStoreQueryPredefinedFilter_PopularNewReleases: () => _,
});
var _ = 0,
  _ = 1,
  _ = 2;
