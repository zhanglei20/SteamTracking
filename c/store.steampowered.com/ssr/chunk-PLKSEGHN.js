...
var _ = _.memo(function (_) {
  ...
  _ = _.memo(function (_) {
    let { platforms: _, eHWCompat: _, size: _ = "small" } = _,
      _;
    if (_ == _.k_ESteamHWCompatibility_None)
      return (
        _(!1, "SteamHWCompatIndicator called for k_ESteamHWCompatibility_None"),
        null
      );
    if (_ == _.k_ESteamHWCompatibility_SteamOS) {
      let _ = _?.steam_os_compat_category;
      if (_ === void 0) return null;
      switch (_) {
        case _.k_ESteamOSCompatibilityCategory_Compatible:
          _ = _;
          break;
        case _.k_ESteamOSCompatibilityCategory_Unsupported:
          _ = _;
          break;
        case _.k_ESteamOSCompatibilityCategory_Unknown:
          _ = _;
          break;
        default:
      ...
      let _ =
        _ == _.k_ESteamHWCompatibility_SteamMachine
          ? _?.steam_machine_compat_category
          : _?.steam_deck_compat_category;
      if (_ === void 0) return null;
      switch (_) {
        case _.k_ESteamDeckCompatibilityCategory_Verified:
          _ = _;
          break;
        case _.k_ESteamDeckCompatibilityCategory_Playable:
          _ = _;
          break;
        case _.k_ESteamDeckCompatibilityCategory_Unsupported:
          _ = _;
          break;
        case _.k_ESteamDeckCompatibilityCategory_Unknown:
          _ = _;
          break;
        default:
    ...
    return (0, _.jsxs)("span", {
      ...
      children: [
        _ == _.k_ESteamHWCompatibility_SteamDeck && (0, _.jsx)(_, {}),
        _ == _.k_ESteamHWCompatibility_SteamMachine && (0, _.jsx)(_, {}),
        (0, _.jsx)(_, {}),
      ],
    });
  });
