...
var _ = {};
(_.arabic = () => _(() => import(`./CbUFxhp02.js`), [], import.meta.url)),
  (_.brazilian = () => _(() => import(`./D_sgvH1m2.js`), [], import.meta.url)),
  (_.bulgarian = () => _(() => import(`./BS5OEtRg2.js`), [], import.meta.url)),
  (_.czech = () => _(() => import(`./BPTdAqvD2.js`), [], import.meta.url)),
  (_.danish = () => _(() => import(`./edGSZWfu2.js`), [], import.meta.url)),
  (_.dutch = () => _(() => import(`./Oiu9vtgr2.js`), [], import.meta.url)),
  (_.english = () => _(() => import(`./Bq9s1pBK2.js`), [], import.meta.url)),
  (_.finnish = () => _(() => import(`./DO3QlihC2.js`), [], import.meta.url)),
  (_.french = () => _(() => import(`./CHeEvP7P2.js`), [], import.meta.url)),
  (_.german = () => _(() => import(`./BRHSQF1p2.js`), [], import.meta.url)),
  (_.greek = () => _(() => import(`./DjczBK232.js`), [], import.meta.url)),
  (_.hungarian = () => _(() => import(`./YgOvrRXO2.js`), [], import.meta.url)),
  (_.indonesian = () => _(() => import(`./i_ALD9ku2.js`), [], import.meta.url)),
  (_.italian = () => _(() => import(`./DAIaiBC92.js`), [], import.meta.url)),
  (_.japanese = () => _(() => import(`./CQFYfrWF2.js`), [], import.meta.url)),
  (_.koreana = () => _(() => import(`./BPE4JqEP2.js`), [], import.meta.url)),
  (_.latam = () => _(() => import(`./NstsYp5o2.js`), [], import.meta.url)),
  (_.malay = () => _(() => import(`./7hCbf2hm2.js`), [], import.meta.url)),
  (_.norwegian = () => _(() => import(`./BQMVv1Eu2.js`), [], import.meta.url)),
  (_.polish = () => _(() => import(`./DGD8G3t_2.js`), [], import.meta.url)),
  (_.portuguese = () => _(() => import(`./CsyC0CmW.js`), [], import.meta.url)),
  (_.romanian = () => _(() => import(`./TCeEHhFM.js`), [], import.meta.url)),
  (_.russian = () => _(() => import(`./BRk-CyuQ.js`), [], import.meta.url)),
  (_.sc_schinese = () => _(() => import(`./pw7VSXvQ.js`), [], import.meta.url)),
  (_.schinese = () => _(() => import(`./B2300ACG.js`), [], import.meta.url)),
  (_.spanish = () => _(() => import(`./CVbMcqBD.js`), [], import.meta.url)),
  (_.swedish = () => _(() => import(`./CDbEeYB2.js`), [], import.meta.url)),
  (_.tchinese = () => _(() => import(`./CoGp2aA8.js`), [], import.meta.url)),
  (_.thai = () => _(() => import(`./Bk6kEqyI.js`), [], import.meta.url)),
  (_.turkish = () => _(() => import(`./CS3gJRnh.js`), [], import.meta.url)),
  (_.ukrainian = () => _(() => import(`./BERm8pl5.js`), [], import.meta.url)),
  (_.vietnamese = () => _(() => import(`./x_1o4dKP.js`), [], import.meta.url));
async function _(_) {
  if (_[_]) return await _[_]();
}
var _ = _(_),
