...
function _(_) {
  let { tag: _ } = _,
    ...
    _ = _(_, _().strLanguage);
  return (0, _.jsx)(`button`, {
    className: (0, _.default)(_, _ && `_166TmzXZ9aE-`),
    onClick: _,
...
var _ = _.forwardRef(function (_, _) {
  ...
  return (0, _.jsx)(_, {
    ...
    className: (0, _.default)(_, _ && `_3ZzwSEl8l6c-`),
    nRows: _,
    nItemHeight: _,
    nRowGap: 0,
    overscan: _,
  ...
  let { loading: _ } = _,
    ...
    _ = _.useCallback(
      (_) => {
        let _ = _.items[_];
        return (0, _.jsx)(`div`, {
          className: (0, _.default)(_, _ && `_5Gm7-x8vUHc-`),
          children: (0, _.jsx)(_, {
