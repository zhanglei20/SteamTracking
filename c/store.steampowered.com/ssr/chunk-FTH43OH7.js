...
((_) => {
  function _(_, _) {
    return _.SendMsg("FriendsList.GetCategories#1", _(_, _), _, {
      bConstMethod: !0,
      ePrivilege: 1,
    });
  }
  _.GetCategories = _;
  function _(_, _) {
    return _.SendMsg("FriendsList.GetFriendsList#1", _(_, _), _, {
      bConstMethod: !0,
      ePrivilege: 1,
    });
  }
  _.GetFriendsList = _;
  function _(_, _) {
    return _.SendMsg("FriendsList.GetFavorites#1", _(_, _), _, {
      bConstMethod: !0,
      ePrivilege: 1,
    });
  }
  _.GetFavorites = _;
  function _(_, _) {
    return _.SendMsg("FriendsList.SetFavorites#1", _(_, _), _, {
      ePrivilege: 1,
    });
  }
  _.SetFavorites = _;
    ...
    queryFn: async () => {
      ...
      return (await _.GetFriendsList(_, _))
        ...
        ?.filter((_) => {
          ...
          return (
            (_.efriendrelationship() == _ || _.efriendrelationship() == _) &&
