...
var _ = "./cookies_malay-XXXXXXXX.json";
...
function _() {
  let _ = _();
  return _ &&
    _.preference_state != _.k_EPrivacyCookiePreferenceState_DefaultRejectAll
    ? null
    : (0, _.jsx)(_, {});
}
var _ = _(_(), 1);
...
async function _(_, _, _) {
  ...
  _.Body().set_steamid(_.steamid),
    ...
    _ &&
      (_(_, _.data_request),
      _.Body().set_sort_order(_.k_EWishlistSort_TopSelling),
...
var _ = "./globalfooter_malay-XXXXXXXX.json";
...
var _ = _(_(), 1),
  _ = _.createContext({
    ePreferredHWCompat: _.k_ESteamHWCompatibility_None,
  });
function _(_) {
...
var _ = "./marketing_malay-XXXXXXXX.json";
...
function _() {
  ...
  return (0, _.jsxs)(_, {
    ...
    children: [
      ...
      (0, _.jsx)(_, {
        eStoreDiscoveryQueueType: _.k_EStoreDiscoveryQueueTypeNew,
      ...
      (0, _.jsx)(_, {
        eStoreDiscoveryQueueType: _.k_EStoreDiscoveryQueueTypeEveryNewRelease,
  ...
  return _({
    ...
    queryFn: async () => {
      ...
      let _ = (_) => {
        let _ = _.get(_);
        return !_ ||
          (_.filter_failure == _.k_EStoreBrowseFilterFailure_Redundant &&
            _.on_wishlist)
          ? _.k_EStoreBrowseFilterFailure_None
          : _.filter_failure;
      };
      return _.filter((_) => {
        let _ = _.get(_);
        return (
          !_ || _.filter_failure < _.k_EStoreBrowseFilterFailure_UnwantedContent
        );
      }).sort((_, _) => _(_) - _(_));
    },
    staleTime: 300 * 1e3,
