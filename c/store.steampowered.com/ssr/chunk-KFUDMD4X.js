...
function _(_) {
  let { rgCategories: _, onFilter: _ } = _,
    ...
    _ = _.default.useMemo(() => _.filter((_) => !!_.bSelected), [_]),
    _ = _({
      rgOptions: _,
      selectedValue: _,
      onSelectionChange: _,
...
function _(_, _) {
  ...
  return _
    ? _ !== 0
      ? !_ && !_.IN_GAMEPADUI
      : _?.type !== _.k_EStoreAppType_Hardware
    : !1;
}
var _ = _(_(), 1),
  _ = parseInt(_);
...
function _(_) {
  let {
    ...
    _ = _(),
    _ = (0, _.default)(_, _ && !_.visible && _, _ && _, _ && _),
    _ = _(_, _, _),
    _ = _(_, _, _),
...
function _(_) {
  let { purchaseOption: _ } = _,
    ...
    _ = !_ && !!_ && _ > 0 && _.user_can_purchase_as_gift;
  return (0, _.jsx)("div", {
    className: (0, _.default)(_, _ && _),
    children: (0, _.jsx)(_, {
      purchaseOption: _,
