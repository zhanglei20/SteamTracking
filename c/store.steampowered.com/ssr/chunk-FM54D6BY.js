...
function _(_, _) {
  return {
    ...
    rgCategoryFilters: _(_.categoryids, (_) => (_.IsDigits(_) ? _ : void 0)),
...
var _ = {
  order: _.k_EWishlistSort_YourRank,
  name: _.k_EWishlistSort_Name,
  price: _.k_EWishlistSort_Price,
  discount: _.k_EWishlistSort_Discount,
  dateadded: _.k_EWishlistSort_DateAdded,
  topsellers: _.k_EWishlistSort_TopSelling,
  releasedate: _.k_EWishlistSort_ReleaseDate,
...
function _(_, _ = _.k_EWishlistSort_YourRank, _ = {}, _) {
  return ["WishlistSortedFiltered", _, _, _, _];
}
function _(_, _, _, _, _ = _.k_EWishlistSort_YourRank, _ = {}, _) {
  return {
    queryKey: _(_, _, _, _),
...
function _(_, _ = _.k_EWishlistSort_YourRank, _ = {}) {
  let _ = _(),
    _ = _(),
    _ = _(),
    _ = _(),
...
function _(_) {
  let { onClose: _ } = _,
    ...
    _ = _(_, _),
    _ = async () => {
      (await _.mutateAsync()) === 1 && (_(!0), setTimeout(() => _(!1), 2e3));
    };
  return (
    _.default.useEffect(() => {
...
function _(_, _, _, _, _) {
  switch (_) {
    ...
    case "rgCategoryFilters": {
      ...
      return _(_, _?.get(_)?.name || _.toString());
    }
    default:
      return (
...
function _(_) {
  return (0, _.jsx)("button", {
    onClick: _.onClick,
    className: (0, _.default)(_, _.bCanRemove && _),
    children: _.children,
  });
}
    ...
    _ = _.default.useMemo(
      () =>
        (_ ?? [])
          ...
          .sort((_, _) => (_.bSelected ? 1 : 0) - (_.bSelected ? 1 : 0)),
      [_, _, _],
    );
  ...
  return (0, _.jsxs)("div", {
    ...
    children: [
      (0, _.jsx)(_, {
        rgCategories: _,
        eAction: 1,
        bShowEmptyLabel: _.IN_GAMEPADUI || !_,
        onClick: _ ? void 0 : _,
        header: _,
      }),
      !_.IN_GAMEPADUI &&
...
var _ = _(_(), 1),
  _ = 16;
function _(_) {
  let { wishlistItem: _, onClose: _ } = _,
    ...
    _ =
      _ && _.name && _.visible
        ? _.Localize("#wishlist_controls_categories_manageitem", _?.name)
            ...
            (0, _.jsxs)("div", {
              children: [
                ...
                (0, _.jsx)(_, {
                  ...
                  header: null,
                  bMultiline: !0,
                  containerClassName: (0, _.default)(_, _),
                }),
              ],
            }),
        ],
...
function _() {
  return (0, _.jsx)("div", {
    className: _,
    children: _.Localize("#wishlist_categories_max_per_app_reached", _),
  });
}
var _ = _(_(), 1);
var _ = _(_(), 1);
...
function _(_) {
  ...
  if (_ && _.summary_filtered)
    switch ((_.summary_language_specific ?? _.summary_filtered).review_score) {
      case _.k_EUserReviewScore_OverwhelminglyPositive:
      case _.k_EUserReviewScore_VeryPositive:
      case _.k_EUserReviewScore_Positive:
      case _.k_EUserReviewScore_MostlyPositive:
        _ = _;
        break;
      case _.k_EUserReviewScore_Mixed:
        _ = _;
        break;
      case _.k_EUserReviewScore_MostlyNegative:
      case _.k_EUserReviewScore_Negative:
      case _.k_EUserReviewScore_VeryNegative:
      case _.k_EUserReviewScore_OverwhelminglyNegative:
        _ = _;
        break;
    }
  return (0, _.default)(_, _);
...
function _(_) {
  ...
  let _ = null;
  if (
    (_.data?.preferences?.review_score_preference ==
      _.k_EUserReviewScorePreference_Unset ||
      _.data?.preferences?.review_score_preference ==
        _.k_EUserReviewScorePreference_ExcludeBombs) &&
...
function _(_, _) {
  let _ = [
    {
      data: 1,
      label: _("#Wishlist_Controls_Categories_Manage"),
    },
    {
      data: 2,
      label: _.Localize("#wishlist_gamepad_options_remove"),
    },
  ];
  _(
    (0, _.jsx)(_, {
    ...
    { mutate: _ } = _({
      async mutationFn([_, _]) {
        let _ = _.map((_) => ({
          ...
          _ = await _("/wishlistnew/action", "Reorder", _);
...
var _ = _(_(), 1),
  _ = _({
    Component: _,
    Actions: {
      CreateWishlistShareToken: _("BSGMMGCA", "CreateWishlistShareToken"),
      RevokeWishlistShareTokens: _("BSGMMGCA", "RevokeWishlistShareTokens"),
    },
  });
function _() {
  let {
...
function _(_) {
  let { wishlistCurrent: _, bEnableDragDrop: _, bLoadingFilters: _ } = _,
    _ = (0, _.useRef)(_),
    _ = _ || _.current;
  if (!_) return null;
  _.current = _;
...
function _(_, _, _) {
  ...
  _?.public_data?.profile_url
    ? (_ = _(`/wishlistnew/id/${_.public_data.profile_url}/`))
    : _?.public_data?.steamid &&
      (_ = _(`/wishlistnew/profiles/${_.public_data.steamid}/`)),
    (0, _.useEffect)(() => {
      if (!_ || (_.IN_GAMEPADUI && !_)) return;
