...
var _ = {};
_(_, {
  k_EStoreCuratorRecommendationState_CreatedApp: () => _,
  k_EStoreCuratorRecommendationState_Informative: () => _,
  k_EStoreCuratorRecommendationState_NotRecommended: () => _,
  k_EStoreCuratorRecommendationState_Recommended: () => _,
});
var _ = 0,
  _ = 1,
  _ = 2,
...
var _ = {};
_(_, {
  k_EClanAccountFlag_AllowClanImages: () => _,
  k_EClanAccountFlag_AllowFAQEditing: () => _,
  k_EClanAccountFlag_AllowInSteamChina: () => _,
  k_EClanAccountFlag_AllowPartnerEventEditor: () => _,
  k_EClanAccountFlag_AllowRSSFeed: () => _,
  k_EClanAccountFlag_AllowSalePageEditing: () => _,
  k_EClanAccountFlag_AllowSalePagePublishWithoutReview: () => _,
  k_EClanAccountFlag_None: () => _,
  k_EClanAccountFlag_TrustedPress: () => _,
});
var _ = 0,
  _ = 1,
  _ = 2,
...
var _ = class {
  ...
  BIsPartnerEventEditorEnabled() {
    return !!(
      this.m_clanAccountFlags & _.k_EClanAccountFlag_AllowPartnerEventEditor
    );
  }
  ...
  async EnablePartnerEventEditorFlag() {
    this.BIsPartnerEventEditorEnabled() ||
      (await this.UpdateGroupFlagsFeature(
        [
          _.k_EClanAccountFlag_AllowClanImages,
          _.k_EClanAccountFlag_AllowPartnerEventEditor,
        ],
        !0,
      ));
  }
  async UpdateGroupFlagsFeature(_, _) {
    ...
    if (
      ...
      return;
    let _ = new Array();
    _ & _.k_EClanAccountFlag_TrustedPress &&
      _.push(_.k_EClanAccountFlag_TrustedPress),
      _ & _.k_EClanAccountFlag_AllowPartnerEventEditor &&
        _.push(_.k_EClanAccountFlag_AllowPartnerEventEditor),
      _ & _.k_EClanAccountFlag_AllowClanImages &&
        _.push(_.k_EClanAccountFlag_AllowClanImages),
      _ & _.k_EClanAccountFlag_AllowRSSFeed &&
        _.push(_.k_EClanAccountFlag_AllowRSSFeed),
      _ & _.k_EClanAccountFlag_AllowFAQEditing &&
        _.push(_.k_EClanAccountFlag_AllowFAQEditing),
      _ & _.k_EClanAccountFlag_AllowSalePageEditing &&
        _.push(_.k_EClanAccountFlag_AllowSalePageEditing),
      _ & _.k_EClanAccountFlag_AllowSalePagePublishWithoutReview &&
        _.push(_.k_EClanAccountFlag_AllowSalePagePublishWithoutReview);
    let _ = new FormData();
...
var _ = class {
  ...
  async SendMsgAndAwaitResponse(_, _, _, _, _) {
    ...
    try {
      ...
      if (
        ((_ = _.Init(_, _.k_EMsgServiceMethodResponse)),
        _.headers &&
          (_.headers["x-eresult"] &&
      ...
      (_ = this.CreateFailedMsgProtobuf(_, _, _)),
        _ &&
          !this.m_refreshAccessTokenPromise &&
          this.m_bJWTToken &&
          _.bSendAuth &&
  ...
  Send(_, _, _, _) {
    ...
    let _ = _.SerializeBody(),
      ...
      _ = _?.ePrivilege == _.k_EProtoPrivNone && _ == _.k_EProtoWebAPIKeyNone,
      _ = {
...
var _ = _(_());
var _ = _(_());
var _ = () => (_.EUNIVERSE === _ ? 2581 : 45267781);
var _ = _(_(), 1);
var _ = {};
_(_, {
  k_EClanImageFileType_GIF: () => _,
  k_EClanImageFileType_JPEG: () => _,
  k_EClanImageFileType_MP4: () => _,
  k_EClanImageFileType_PNG: () => _,
  k_EClanImageFileType_SRT: () => _,
  k_EClanImageFileType_SVG: () => _,
  k_EClanImageFileType_Unknown: () => _,
  k_EClanImageFileType_VTT: () => _,
  k_EClanImageFileType_WEBM: () => _,
  k_EClanImageFileType_WEBP: () => _,
  k_EClanImageFileType_XML: () => _,
});
var _ = 0,
  _ = 1,
  _ = 2,
...
var _ = class _ {
  ...
  constructor(_, _) {
    (this.m_eItemType = _.item_type()),
      ...
      (this.m_eItemType == _.k_EStoreItemType_Package ||
        this.m_eItemType == _.k_EStoreItemType_Bundle) &&
  ...
  BIsApplicationOrTool() {
    return (
      this.GetAppType() == _.k_EStoreAppType_Software ||
      this.GetAppType() == _.k_EStoreAppType_Tool
    );
  }
  k_regexSalePage =
    /^https?:\/\/[^\/]*(?:valvesoftware|steampowered).com\/(?:(curator|dev|developer|pub|publisher|franchise)\/[0-9a-zA-Z\-_]+\/)?sale\//;
  BIsSalePage() {
    return this.GetStoreItemType() === _.k_EStoreItemType_App
  ...
  GetSalePageVanityURL() {
    ...
    return (
      this.GetStoreItemType() === _.k_EStoreItemType_App &&
...
var _ = class {
  ...
  InternalSetupValue(_) {
    let _ = {
      ...
      rss_language: _.rss_language ? _.rss_language : _,
