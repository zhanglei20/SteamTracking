...
var _ = _({
    AlbumCoverImage: () => _,
    AlbumTitle: () => _,
    AppSummaryWidgetCtn: () => _,
    BackgroundAnimation: () => _,
    CarouselCapsuleAnimated: () => _,
    CarouselCapsuleBordered: () => _,
    CarouselDisplay: () => _,
    CarouselPage: () => _,
    CarouselSalePageCapsule: () => _,
    CustomStyle_together: () => _,
    DefaultCreatorCtn: () => _,
    DesktopTabs: () => _,
    DisabledBackground: () => _,
    EventSectionViewAllCtn: () => _,
    HorizontalScrollInDragForceCursor: () => _,
    Hover: () => _,
    ...
    LoginButton: () => _,
    MobileTabSelector: () => _,
    MobileTabSelectorButton: () => _,
    MobileTabSelectorDropDown: () => _,
    MobileTabSelectorOption: () => _,
    MobileTabSelectorShortcut: () => _,
    NoTopPadding: () => _,
    SaleBackground: () => _,
    SaleBroadcastCtn: () => _,
    SaleBroadcastSection: () => _,
    SaleHeaderContainer: () => _,
    SaleNewSizing: () => _,
    SaleOuterContainer: () => _,
    SaleOuterTopMargin: () => _,
    SaleOverlay: () => _,
    SaleOverlayCtn: () => _,
    SalePageBroadcastContextHover: () => _,
    SalePageLogoSet: () => _,
    SaleSection: () => _,
    SaleSectionBackgroundImageGroupEdit: () => _,
    SaleSectionContainer: () => _,
    SaleSectionCtn: () => _,
    SaleSectionLivePreview: () => _,
    SaleSectionLoginPrompt: () => _,
    SaleSectionSubtext: () => _,
    SaleSectionTabListContainer: () => _,
    SaleSectionTabs: () => _,
    SaleSectionTitleCtn: () => _,
    SaleTabLabel: () => _,
    SaleViewAll: () => _,
    TabButton: () => _,
    TabButtonsCtn: () => _,
    TabContentsContainer: () => _,
    Visible: () => _,
    default: () => _,
    "duration-app-launch": () => _,
    focusAnimation: () => _,
    fullscreen_bg: () => _,
    fullscreen_bg_video: () => _,
    hoverAnimation: () => _,
    narrowWidth: () => _,
    preview_placeholder_section: () => _,
    vr_required: () => _,
    vr_supported: () => _,
  }),
  _ = `800ms`,
  ...
  _ = {
    ...
    SaleSectionBackgroundImageGroupEdit: _,
    BackgroundAnimation: _,
    "ItemFocusAnim-darkerGrey-nocolor": `MvJL4gokFfg-`,
    "ItemFocusAnim-darkerGrey": `_1PkIqn528tQ-`,
    "ItemFocusAnim-darkGreySettings": `OXAcQQ-leCc-`,
    "ItemFocusAnim-darkGrey": `OhT91vUlfc8-`,
    "ItemFocusAnim-grey": `ki7-ARg-c0A-`,
    "ItemFocusAnim-translucent-white-10": `W-2avlqXgQk-`,
    "ItemFocusAnim-translucent-white-20": `_5qgtdPSPyuM-`,
    "ItemFocusAnimBorder-darkGrey": `_8TEgWozT-EQ-`,
    "ItemFocusAnim-green": `whXDdOPOvGw-`,
    focusAnimation: _,
    hoverAnimation: _,
  },
  _ = class _ {
    ...
    MergeData(_, _) {
      _.include_assets &&
        ...
        _.include_optin_registration_tags &&
          ...
          ((this.m_rgOptInRegistrationTags = _.optin_registration_tags().map(
            (_) => _.toObject(),
          )),
    ...
    BHasSomeLanguageSupport(_) {
      return (
        ...
        this.m_rgSupportedLanguages?.some(
          (_) =>
            _.elanguage == _ && (_.supported || _.subtitles || _.full_audio),
        ) || !1
      );
    }
