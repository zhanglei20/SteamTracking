  ...
  (self.webpackChunkstore = self.webpackChunkstore || []).push([
    [70576],
    {
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        const module_exports = (_, _) => Math.abs(_ - _) < 1.01,
          module_exports = (_, _, _) => {
            let _;
            return function (..._) {
          ...
          module_exports = typeof window > "u" ? !0 : "onscrollend" in window,
          module_exports = (_, _) => {
            const _ = _.scrollElement;
            if (!_) return;
            const _ = _.targetWindow;
          ...
          module_exports = (_, { adjustments: _ = 0, behavior: _ }, _) => {
            var _, _;
            const _ = _ + _;
          ...
          constructor(_) {
            (this.unsubs = []),
              ...
              (this.resizeItem = (_, _) => {
                ...
                if (!_) return;
                const _ = this.itemSizeCache.get(_.key) ?? _.size,
                  _ = _ - _;
                _ !== 0 &&
        ...
        const module_exports =
          typeof document < "u" ? _.useLayoutEffect : _.useEffect;
        function _(_) {
