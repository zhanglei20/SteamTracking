      ...
      function _(_, _) {
        ...
        return (
          _.sort((_, _) => {
            ...
            if (_ != _.has(_.accountid)) return _ ? -1 : 1;
    ...
    chunkid: (module, module_exports, __webpack_require__) => {
      ...
      function _(_) {
        const {
          ...
          _ = (0, _._)(),
          _ = (0, _._)() && !_?.restrict_add_additional_to_cart && !(0, _._)(_),
          _ = _.errors?.adult_content_restricted,
          _ = (0, _._)(
            _.packageid,
            _.bundleid,
      ...
      function _(_) {
        ...
        if (("myself" === _ && _ && (_ = "private"), 1 === _.length))
          return null;
        return (0, _.jsx)(_, {
          onChange: (_) => {
            if (_ === _.data) return;
      ...
      function _(_) {
        ...
        return (0, _.jsxs)(_._, {
          children: [
            (0, _.jsxs)("span", {
              children: [(0, _._)("#Cart_Notice_SomeAppsPrivate"), " "],
            }),
            _,
          ],
        });
        ...
        const { validateCart: _, children: _, eDisplayType: _ } = _,
          _ = (function (_, _) {
            return _.useMemo(() => {
              ...
              let _ = Array.from(__webpack_require__.values());
              return (
      ...
      function _(_) {
        const { lineItem: _ } = _,
          _ = (function () {
            ...
            return _?.eDisplayType ?? _.k_ECartDisplayType_Unknown;
          })();
        let _ = [],
    ...
    chunkid: (module, module_exports, __webpack_require__) => {
      ...
      const _ = _.memo(function (_) {
        const { storeItem: _, highlightedAccountIDs: _, ..._ } = _,
          { rgFriendsForGifting: _, isLoading: _, isError: _ } = (0, _._)(_, _),
          _ = (0, _._)(_),
          _ = _.useMemo(() => {
            const _ = new Map(
            ...
            for (const _ of _.values())
              _.push({
                accountid: __webpack_require__.GetAccountID(),
                persona: _,
                ownership: {
                  already_owns: !1,
                  wishes_for: !1,
        ...
        const {
          ...
          _ = _.useMemo(() => {
            ...
            return _.length < 1
              ...
              : _.filter(
                  (_) =>
                    _.persona.m_strPlayerName.toLocaleLowerCase().indexOf(_) >
                      -1 ||
                    !!(
                      _.nickname &&
      ...
      function _(_) {
        const { lineItem: _ } = _,
          ...
          { data: _ } = (0, _._)(),
          _ = _.useMemo(
            () => !_ || _.includes(__webpack_require__?.GetSteamIDAsString()),
            [_, _],
          );
        return _
          ? _
      ...
      function _(_) {
        ...
        return _
          ? (0, _.jsx)(_._, {
              disabled: _,
              className: (0, _._)(_().CartSummaryBtn, _().SummaryMarginBottom),
              onClick: () => {
                _.mutate(void 0, {
                  onSuccess: () => {
        ...
        return _ || _ == _._.k_ENonGiftableItemPresent
          ? (0, _.jsxs)("div", {
              ...
              children: [
                ...
                _ === _._.k_ENonGiftableItemPresent &&
                  (0, _.jsx)("div", {
                    children: (0, _._)("#Cart_RequestPurchaseNonGiftableItems"),
                  }),
              ],
            })
          : null;
              ...
              children: [
                (0, _.jsxs)("div", {
                  ...
                  children: [
                    (0, _.jsx)(_._, {
                      onClick: () =>
                        (window.location.href = _._.STORE_BASE_URL),
                      className: _().Button,
