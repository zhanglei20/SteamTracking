(self.webpackChunkstore = self.webpackChunkstore || []).push([
  [9297, 8857],
  {
    ...
    chunkid: (module, module_exports, __webpack_require__) => {
        ...
        const { rgRankings: _, nTotalResultCount: _ } = _(_, _, _),
          _ = _.map((_) => {
            if (_.relative_playtime_percentagex100) {
              ...
              return (
                (_ =
                  "demo" == _ || "playtest" == _
                    ? _ > 0
                      ? (100 * _.relative_playtime_percentagex100 * 100) / _
                      : 0
            ...
            if (_ >= 0) {
              ...
              })(_, _, _.GetRawStats().playtime_stats.games[_]);
              return {
                appid: _.appid,
                parent_appid: _.parent_appid,
                strPercentage: _(_),
      ...
      function _(_, _, _) {
        if ("demo" == _ || "playtest" == _) {
          const _ =
            "demo" == _ ? _.GetDemoByPlaytime() : _.GetPlaytestByPlaytime();
          return {
            nTotalResultCount: _.length,
            rgRankings: _.slice(0, _).map((_) => ({
              appid: _.appid,
              parent_appid: _.parent_appid,
              relative_playtime_percentagex100: _.total_playtime_percentagex100,
            })),
          };
        }
        const _ = `${_}_ranking`,
      ...
      function _(_, _) {
        switch (_) {
          ...
          case "demo":
            return _.playtime_stats.game_summary.filter((_) => Boolean(_.demo));
          case "playtest":
      ...
      function _(_, _) {
        if ("demo" != _ && "playtest" != _) {
          const _ = `${"overall" === _ ? "total" : _}_sessions`,
            _ = `${"overall" === _ ? "total" : _}_playtime_percentagex100`;
          return {
        ...
        }
        {
          ...
          return {
            ...
            nTotalSessions: __webpack_require__
              .map((_) => _.total_sessions)
              .reduce((_, _) => _ + _, 0),
            nTotalPercentage: __webpack_require__
        ...
        constructor(_, _, _, _) {
          if (
            ...
            const { rgResults: _ } = (function (_, _, _) {
              ...
              _ = _.map((_) => _.appid);
            (this.m_rgTopGameMonthsChartIdsAndRanks = __webpack_require__.map(
              (_, _) => ({
                appid: _,
                rank: _,
              }),
              ...
              (this.m_rgMonthChartData = (function (_, _, _, _) {
                const _ = new Set(_),
                  _ = _.map((_, _) => {
                    ...
                    let _ = 0,
                      _ = 0;
                    const _ = _.game_summary?.sort(
                      (_, _) =>
                        (_?.total_playtime_percentagex100 ?? 0) -
                        (_?.total_playtime_percentagex100 ?? 0),
                    );
                    _.filter((_) => _.has(_.appid)).forEach((_, _) => {
                      const { appid: _ } = _,
                ...
                for (let _ = 0; _ < 12; ++_) {
                  const _ = _.findIndex(
                    (_) =>
                      _.date.getMonth() === _ && _.date.getFullYear() === _,
                  );
                  -1 === _
                    ? _.push({
          ...
          if (_?.playtime_stats?.tag_stats?.stats.length > 0) {
            ...
            this.m_rgAggregateTagData = (function (_, _) {
              const _ = _.filter(
                (_) => -1 == _.findIndex((_) => _ == _.nTagId),
              );
              let _ = [],
                _ = [],
                _ = _.length,
      ...
      (0, _._)([_._], _.prototype, "m_privacyState", void 0);
      ...
      class _ {
              ...
              "dev" == _._.WEB_UNIVERSE &&
                console.log(
                  "CYearInReviewStore - reading preload for " +
                    ...
                    _ +
                    " num games " +
                    _.playtime_stats.game_summary?.length,
                ),
              new _(
                _,
        ...
        async PreloadStoreItemCache(_) {
          ...
          let _ = _._.Init(_._);
          (0, _._)(_), (0, _._)(_, _), __webpack_require__.Body().set_ids(_);
        ...
        ValidateYearInReview(_) {
          ...
          return !!(
            ...
            "object" == typeof _ &&
            _.account_id &&
            "number" == typeof _.account_id &&
            _.playtime_stats &&
            "object" == typeof _.playtime_stats
          );
        }
        ...
        static Get() {
          return (
            _.s_Singleton ||
              ...
              _.s_Singleton.Init(),
              "dev" == _._.WEB_UNIVERSE &&
                (window.g_YearInReview = _.s_Singleton)),
            _.s_Singleton
          );
        }
        constructor() {
      ...
      (0, _._)([_._], _.prototype, "m_GameDetailPopupData", void 0);
      var _ = __webpack_require__("chunkid"),
        _ = __webpack_require__._(_);
      class _ {
        m_SteamInterface;
        ...
        async InternalLoadScreenshots(_) {
          ...
          if (!__webpack_require__.BSuccess())
            throw `Load Screenshots failed: ${__webpack_require__.GetErrorMessage()}`;
          const _ = new Map();
          for (const _ of __webpack_require__.Body().apps())
      ...
      async function _(_, _) {
        const _ = await _;
        if (_) {
          const _ = __webpack_require__.find((_) => _.appid == _);
          if (_) return _;
        }
        return null;
      }
      class _ {
        ...
        GetManyAchievement(_, _, _) {
          return __webpack_require__.map((_) => this.GetAchievement(_, _, _));
        }
        ...
        static Get() {
          return (
            _.s_Singleton ||
              ((_.s_Singleton = new _()),
              "dev" == _._.WEB_UNIVERSE &&
                (window.g_YearInReviewUserAchievement = _.s_Singleton),
              _.s_Singleton.Init()),
            _.s_Singleton
          );
        }
      ...
      function _(_) {
        const {
          ...
          _ = __webpack_require__.GetRawStats(),
          {
            nTotalGames: _,
            nTotalSessions: _,
            nTotalPercentage: _,
              ...
              _.useEffect(() => {
                ...
                const _ = _.reduce((_, _) => {
                  const _ = _.parent_appid || _.appid,
                    ...
                    _ = !("demo" == _ || "playtest" == _) || _.parent_appid;
                  return _ + (_ && _ ? 1 : 0);
                }, 0);
                _(_);
              }, [_, _, _]),
      ...
      function _(_) {
        ...
        return _.createElement(
          ...
          _.map((_, _) =>
            _.createElement(_, {
              key: __webpack_require__ + "_" + _.appid,
              appid: _.appid,
          ...
          : _.createElement(
              ...
              _.createElement(
                ...
                _.createElement(
                  ...
                  _("#YIR_FirstTime_Title", _.length),
                ),
                Boolean(1 == _)
                  ? _.createElement(_._, {
                      size: "medium",
          ...
          _.useMemo)(() => {
            const _ = new Set(),
              _ = _.filter(
                (_) =>
                  !_.has(_.appid) &&
                  (_.add(_.appid), _.parent_appid || (!_.demo && !_.playtest)),
              )
                .sort(
                  (_, _) =>
                    _.total_playtime_percentagex100 -
                ...
                .map((_) => ({
                  ...
                  bNewThisYear: Boolean(_.new_this_year),
                  bIsDemo: Boolean(_.demo),
                  bIsPlaytest: Boolean(_.playtest),
                  nParentAppID: _.parent_appid,
                })),
              _ = _.length > 100 && !_;
            return {
              bShouldShowMore: _,
              rgGamesInOrderOfPlaytime: _ ? _.slice(0, 100) : _,
            };
          }, [_, _]);
        return _.createElement(
          _.Fragment,
      ...
      function _(_) {
        ...
        return _.createElement(
          _.Fragment,
          null,
          _.filter((_) => _.stats.total_sessions > 0).map((_) =>
            _.createElement(_, {
              key: "outermonth" + _.rtime_month,
              month: _,
              userYearInReview: __webpack_require__,
              nYear: _,
            }),
      ...
      function _(_) {
        ...
        return _.createElement(
          ...
          _.createElement(
            ...
            Boolean(true)
              ? (0, _._)("#YIR_MonthlyGrid_MonthSingular_" + (_.getMonth() + 1))
              : (0, _._)(_),
          ),
          _.createElement(_, {
            rgGamesInOrderOfPlaytime: _,
      ...
      function _(_) {
        ...
        let _ = _.map((_, _) =>
          _.createElement(_, {
            ...
            fnOnClick: () => _.Get().SetGameDetailsPopupAppData(_, _),
            nYear: _,
      ...
      function _(_) {
        ...
        if (!_ || 0 == _.length)
          return _.createElement(_, null, __webpack_require__);
      ...
      const _ = ({
        ...
        return (
          ...
          _
            ? _.createElement(_.Fragment, null, " ", (0, _._)(_), " ")
            : _.createElement(_.Fragment, null, (0, _._)(_))
        );
      };
      var _ = __webpack_require__("chunkid"),
      ...
      function _(_) {
        ...
        let _ = _.GetPlayTimeStats().summary_stats?.total_achievements || 0,
          ...
          _ =
            _.GetPlayTimeStats().playtime_streak?.longest_consecutive_days || 0,
          ...
          _ = _ > 0 && _ > 0 && "cn" !== _._.country_code.toLowerCase();
        _ >= 99 && (_ = 100),
          _ >= 99 && (_ = 100),
          _ >= 99 && (_ = 100),
        ...
        return _.createElement(
          ...
          _.createElement(
            ...
            __webpack_require__("#YIR_Compare_Title_Label"),
          ),
          _.createElement(
            "div",
            {
            ...
            __webpack_require__("#YIR_Compare_Subtitle_Label"),
          ),
          _.createElement(
            _._,
            {
            ...
            _.createElement(_, {
              progressLabel: __webpack_require__(
                1 == _
              ...
              userPercent: _,
              steamAverage: _.GetPlayTimeStats().by_numbers?.achievements_avg,
              progressIcon: _.createElement(_, null),
            }),
            _.createElement(_, {
              progressLabel: __webpack_require__(
                1 == _
              ...
              userPercent: _,
              steamAverage: _.GetPlayTimeStats().by_numbers?.games_played_avg,
              progressIcon: _.createElement(_, null),
            }),
            _ &&
              _.createElement(_, {
                ...
                userPercent: _,
                steamAverage: _.GetPlayTimeStats().by_numbers?.game_streak_avg,
                progressIcon: _.createElement(_, null),
              }),
          ),
          _.createElement(
                ...
                _.createElement(
                  ...
                  _.createElement(
                    ...
                    _.createElement(
                      ...
                      _.createElement("div", {
                        className: (0, _._)(_().Glitter, _().GlitterSecond),
                      }),
                    ),
                  ),
                ),
      ...
      function _(_) {
        ...
        let [_, _, _] = _.useMemo(() => {
          ...
          if (0 == _) return [0, 0, 0];
          let _ = _.map((_) => Math.floor((100 * _) / _)),
        ...
        const _ = {
          ...
          _ = {
            ...
            UsedActive: (0, _._)("#YIR_Compare_ComfortGames_Desc_AvgSteam", _),
        ...
        return _.createElement(
          ...
          _.createElement(
            ...
            (0, _._)("#YIR_Compare_Flavor_Title", _.createElement("div", null)),
          ),
          _.createElement(
            "div",
            {
      ...
      function _(_) {
        const { userYearInReview: _ } = _,
          ...
          _ = __webpack_require__
            .map((_) => _.nPreSelectionWeight)
            .sort((_, _) => _ - _);
        let _ = __webpack_require__.map((_, _) => {
      ...
      class _ {
        ...
        async LoadFriendsSharedYearInReview(_, _) {
          const _ = _._.Init(_._),
            _ = _._.InitFromAccountID(_);
          __webpack_require__.Body().set_year(_),
            __webpack_require__.Body().set_steamid(_.ConvertTo64BitString()),
            __webpack_require__.Body().set_return_private(_._.is_support);
        ...
        const { accountID: _, year: __webpack_require__ } = _,
          ...
          _ = (0, _.useMemo)(
            () =>
              _?.length > 0
                ? [..._]
                    .sort((_, _) => _.rt_privacy_updated - _.rt_privacy_updated)
                    .slice(0, _)
                : [],
            [_],
          ),
        ...
        return (
          ...
          _.createElement(
            ...
            _.createElement(
              ...
              _.slice(0, _).map((_) =>
                _.createElement(_, {
                  key: "friendshare_" + _.steamid + "_" + __webpack_require__,
            ...
            Boolean(_._.is_support) &&
              _.createElement(
                ...
                (0, _._)("#YIR_FriendShared_support"),
              ),
          )
        );
      }
      ...
      function _(_) {
        ...
        if (_ && __webpack_require__ && __webpack_require__.length) {
          ...
          return _.createElement(
            _._,
            null,
            (0, _._)("#YIR_Platfrom_gamesplays_tooltip", _, (0, _._)(_), _),
          );
        }
        return null;
      }
          ...
          Boolean(_ > _) &&
            _.createElement(
              ...
              _.createElement(_, {
                category: "demo",
                userYearInReview: _,
                title: __webpack_require__("#YIR_TopGames_demo"),
          ...
          Boolean(_ > _) &&
            _.createElement(
              ...
              _.createElement(_, {
                category: "playtest",
                userYearInReview: _,
                title: __webpack_require__("#YIR_TopGames_playtest"),
      ...
      function _(_) {
        const { userYearInReview: _ } = _;
        if ("cn" === _._.country_code.toLowerCase())
          return (
            "dev" === _._.WEB_UNIVERSE &&
              console.log(
        ...
        return !_ || _.longest_consecutive_days < 5
          ? ("dev" === _._.WEB_UNIVERSE &&
              (_
                ? console.log(
                    `<DisplayLongestStreak is not displayed; require consequative days >= 5 (actual ${_.longest_consecutive_days})`,
                  )
                : console.log(
      ...
      function _(_) {
        const { userYearInReview: _ } = _,
          ...
          [_, _] = _.useState(!1),
          _ = _.streak_games.length > 12 && !_,
          _ = _
            ? _.streak_games.sort((_, _) => _.appid - _.appid).slice(0, 12)
          ...
          _.createElement(
            ...
            _.createElement(
              ...
              _.createElement(
                ...
                _.createElement(
                  "div",
                  {
                    className: (0, _._)({
                      [_().StreakTickCtn]: !0,
                      [_().LargerTicks]: _.longest_consecutive_days < 40,
                    }),
                  },
                  _.createElement(_, {
              ...
              _.createElement(
                ...
                _.createElement(
                  ...
                  (0, _._)(
                    _.rtime_start + 24 * _.longest_consecutive_days * 60 * 60,
                    _,
                  ),
                ),
              ),
            ...
            _.createElement(
              ...
              _.createElement(
                "div",
                {
                  className: (0, _._)(_().CapRowTitle, _ && _().AnimateTitle),
                },
                __webpack_require__(
                  _ > 1
        ...
        return _ && 0 !== _.length
          ? _.createElement(
              ...
              _.createElement(
                ...
                _("#YearInReview_OtherYearLinks_Header"),
              ),
              _.createElement(
                "div",
                {
            ...
            _.createElement(_._, {
              ...
              onChange: async (_) => {
                if (_.data !== _) {
                  ...
                  })(__webpack_require__.ConvertTo64BitString(), _, _.data);
                  void 0 !== _.privacy_state
      ...
      function _(_) {
        const {
          ...
          })(__webpack_require__.ConvertTo64BitString(), _, _),
          _ = _?.length - 1,
            ...
            : _
              ? _.createElement(
                      ...
                      _.createElement(
                        ...
                        _.createElement(
                          ...
                          _.createElement(
                            ...
                            (0, _._)("#YIR_ShareModal_FullscreenPreview"),
                          ),
                          _.createElement("img", {
                  ...
                  _.createElement(
                    ...
                    (0, _._)(`#YIR_ShareModal_ImageCaption_${_[_].name}`),
                  ),
                )
              : _.createElement(
                  "div",
                  ...
                  _.createElement(
                    "div",
                    null,
                    (0, _._)("#YIR_ShareModal_FailedToGenerateImages"),
                  ),
                )
        );
      }
      ...
      function _(_) {
        return _.createElement(
          ...
          _.createElement(
            ...
            (0, _._)("#YIR_ShareModal_SaveImage"),
          ),
        );
      }
      function _(_) {
        ...
        return _.createElement(
          ...
          _.createElement(
            ...
            (0, _._)("#YIR_ShareModal_ShareImage"),
          ),
        );
      }
      function _(_) {
          ...
          _.createElement(
            ...
            _.createElement(
              ...
              _.createElement(
                ...
                (0, _._)("#YIR_ShareModal_ShareOnFriendsActivity"),
              ),
            ),
            _.createElement(
              "a",
              ...
              _.createElement(
                ...
                (0, _._)("#YIR_ShareModal_AddShowcase"),
              ),
            ),
          ),
        );
          ...
          _.createElement(
            ...
            _.createElement(
              ...
              _.createElement(
                ...
                (0, _._)("#YIR_ShareModal_ShareLink"),
              ),
            ),
            _.createElement(
              "div",
      ...
      function _(_) {
        const { userYearInReview: _ } = _,
          ...
          _ = [
            _(_, _),
            _(_, _),
            _(_, _, _(_) ? _.GetPreviousYearSummary()?.longest_streak : void 0),
          ].filter((_) => null !== _),
          _ = _.createElement(_, {
            key: "overview",
            ...
            : 1 == _.length && __webpack_require__.length > 3
              ...
              : __webpack_require__.length > 1
                ? _.createElement(
                    ...
                    [_, __webpack_require__[0], __webpack_require__[1]],
                  )
                : null;
      }
      function _(_, _) {
                    ...
                    : _ > 10
                      ...
                      : __webpack_require__ > 1 &&
                        ...
                        : _ < 2 && _ > 36e4
                          ...
                          : _ < 2
                            ? _("#YIR_YourSummary_SingleGame")
                            : _ < 5
                              ? _("#YIR_YourSummary_GamesFew")
                              : _ > 36e4
                                ? _("#YIR_YourSummary_HoursMany")
                                : null),
          _.createElement(
            "div",
            {
              ...
              _.createElement(
                ...
                _.createElement(
                  ...
                  (0, _._)(
                    ...
                    _.createElement(
                      ...
                      (0, _._)("#YearInReview_PossessiveUserName", _),
                    ),
                    (0, _._)("#date_year", _),
                  ),
                ),
                _.createElement(
                  ...
                  _.createElement(
                    ...
                    (0, _._)("#YIR_YourSummary_Games", __webpack_require__),
                  ),
                  _.createElement(_, {
                ...
                Boolean(_) &&
                  _.createElement(
                    ...
                    _.createElement(
                      ...
                      (0, _._)("#YIR_YourSummary_GamesFirst", _),
                    ),
                  ),
                Boolean(_) &&
                  _.createElement(
                ...
                Boolean(_) &&
                  _.createElement(
                    ...
                    _.createElement(
                      ...
                      (0, _._)("#YIR_YourSummary_PlayTests", _),
                    ),
                  ),
              ),
            ),
      ...
      function _(_) {
        const { userYearInReview: _ } = _,
          ...
          _ = (_.GetFilteredGameSummary(), _.GetYear()),
          _ = _(),
              ...
              _.createElement(
                ...
                _.createElement(
                  ...
                  _.createElement(
                    ...
                    (0, _._)(_.total_games_with_achievements || 0),
                  ),
                  _.createElement(
                    "div",
                    {
                ...
                _.createElement(
                  ...
                  _.createElement(
                    ...
                    (0, _._)(_.total_rare_achievements || 0),
                  ),
                  _.createElement(
                    "div",
                    {
      ...
      function _(_) {
        const {
          ...
          _ = _();
        if ("ch" === _._.country_code) return null;
          ...
          _.createElement(
            ...
            _.createElement(
              ...
              _.createElement(
                ...
                (0, _._)("#YIR_YourSummary_Stat_Streak"),
              ),
              _.createElement(
                "div",
                {
                ...
                (0, _._)("#YIR_Game_LongestStreak_FromDateToDate", _, _),
              ),
              _.createElement(_, {
            ...
            _.createElement(
              ...
              _.createElement(
                ...
                _.createElement(
                  ...
                  (0, _._)("#YIR_YourSummary_Games", _.streak_games.length),
                ),
              ),
            ),
          ),
              ...
              _.createElement(
                ...
                _.createElement(
                  ...
                  _.createElement(
                    ...
                    (0, _._)("#YIR_HowYouPlayed_Keyboard_Generic"),
                  ),
                ),
                _.createElement(
                  "div",
                  ...
                  _.createElement(
                    ...
                    (0, _._)("#YIR_HowYouPlayed_Controllers_Percent"),
                  ),
                ),
              ),
            ),
                  ...
                  return _.createElement(
                    ...
                    !_ &&
                      _.createElement(
                        ...
                        _(_, _, "#YIR_MonthlyCharts_OtherGamesTooltip"),
                      ),
                    _ &&
                      _.slice(0, _).map((_) =>
                        _.createElement(_, {
          ...
          return _.createElement(
            ...
            _.createElement(
              ...
              _.createElement(
                ...
                _(_, _, "#YIR_MonthlyCharts_PlayedTotalTooltip"),
              ),
              !_ &&
                _.createElement(
                  _.Fragment,
                  ...
                  _.createElement(
                    "div",
                    null,
                    (0, _._)("#YIR_MonthlyCharts_PlayedSubtitleTooltip"),
                  ),
                  _,
                ),
              _ &&
                ...
                _.createElement(
                  ...
                  _.createElement(
                    "div",
                    null,
                    _("#YIR_MonthlyCharts_OtherGamesTooltip_Only"),
                  ),
                  _,
                ),
            ),
        ...
        return _
          ? _.createElement(
              ...
              _(
                ...
                _.createElement("b", null, _.GetName()),
              ),
            )
          : null;
      }
        ...
        if (
          ...
          return _.createElement(
            ...
            _.createElement(
              ...
              (0, _._)(_, _.createElement("b", null, _(_)), _, _),
            ),
          );
        }
        return null;
      ...
      function _(_, _, _, ..._) {
        const _ = `${_}_Percent`;
        return (0, _._)(_, _.createElement("b", null, _(_)), _, ..._);
      }
      var _ = __webpack_require__("chunkid");
      function _(_) {
        const { userYearInReview: _ } = _,
          ...
          _.GetPlayTimeStats().games?.length > 1 &&
            _.createElement(
              ...
              _.createElement(
                ...
                __webpack_require__("#YIR_MonthlyCharts_Title"),
              ),
              _.createElement(
                "div",
                {
        ...
        static Get() {
          return (
            _.s_Singleton ||
              ((_.s_Singleton = new _()),
              "dev" == _._.WEB_UNIVERSE &&
                (window.g_GameAchievementDisplayStore = _.s_Singleton),
              _.s_Singleton.Init()),
            _.s_Singleton
          );
        }
      ...
      function _(_) {
        ...
        return (
          (0, _.useEffect)(() => {
            ((null == _ && !_.Get().BHasAchievementLoaded(_)) || _ != _) &&
              _.Get()
      ...
      function _(_) {
        const {
          ...
          _ = `${_._.COMMUNITY_BASE_URL}profiles/${__webpack_require__.GetSteamID().ConvertTo64BitString()}/stats/${_}`,
          _ = (0, _._)();
        return _.createElement(
          "div",
          {
          ...
          _ &&
            _.createElement(
              ...
              (0, _._)("#YIR_TopGames_ContentRestrictionAchievements"),
            ),
          _.createElement(
            "div",
            {
      ...
      function _(_) {
        ...
        return _?.length > 0
          ? _.createElement(
              _.Fragment,
              null,
              _.map((_) => __webpack_require__.get(_.achievement_name_internal))
                .filter((_) => Boolean(_?.icon))
                .map((_) =>
                  _.createElement(_, {
                    key: "displayAch_" + _.internal_name,
                    appid: _.appid,
                    display: _,
                  }),
                ),
        ...
        return _.createElement(
          ...
          _ &&
            _.createElement(
              ...
              (0, _._)("#YIR_TopGames_ContentRestrictionScreenshots"),
            ),
          _.createElement("img", {
            src: `${_}`,
          }),
      ...
      function _(_) {
        const { userYearInReview: _ } = _,
          ...
          _ = _(),
          _ = _,
          _ = (0, _.useMemo)(() => __webpack_require__?.slice(0, _), [0, _, _]);
        if (!_ || 0 == _.length || 0 > _.length) return null;
        let _ = _.length > 1;
        return _.createElement(
          "div",
          {
            ...
            Boolean(_) &&
              _.createElement(
                ...
                _.createElement(
                  ...
                  _("#YIR_TopGame_mostplayed_intro"),
                ),
              ),
            _.map((_, _) =>
              _.createElement(
        ...
        let { userYearInReview: _ } = _,
          ...
          [_, _] = (function (_) {
            ...
            let _ = _.useRef(void 0),
              _ = _.useCallback(() => {
                let _ = parseInt(_.strGameDetailsTransitionTimeMS);
                (_.current = setTimeout(() => {
                  _ == _.unAppID &&
              ...
              _.createElement(
                ...
                _.createElement(
                  ...
                  _.createElement(
                    ...
                    _ &&
                      _.createElement(
                        ...
                        (0, _._)("#YIR_TopGames_VisitInStore"),
                      ),
                    !_ &&
                      _.createElement(
                        _._,
                    ...
                    !!_ &&
                      _.createElement(
                        ...
                        (0, _._)("#YIR_TopGames_VisitInLibrary"),
                      ),
                    !_ &&
                      _.createElement(_, {
                        appID: _,
                  ...
                  _.createElement(
                    ...
                    Boolean(_.total_playtime_percentagex100) &&
                      _.createElement(
                        "div",
                        {
                        ...
                        _.createElement(
                          ...
                          _(Math.ceil(_.total_playtime_percentagex100)),
                        ),
                        _.createElement(
                          "div",
                          {
                          ...
                          (0, _._)("#YIR_Game_PercentPlaytime"),
                        ),
                      ),
                    Boolean(_.total_sessions) &&
                      _.createElement(
                        "div",
                        {
                          className: _.StatContainer,
                      ...
                      _.createElement(
                        ...
                        _.createElement(
                          ...
                          _.createElement(
                            ...
                            (0, _._)("#YIR_Game_LongestStreak"),
                          ),
                        ),
                      ),
                    Boolean(_?.new_this_year) &&
                      _.createElement(
                        "div",
                        {
                          className: _.StatContainer,
                        ...
                        _.createElement(
                          ...
                          _.createElement(
                            ...
                            (0, _._)("#YIR_TopGames_NewThisYEar"),
                          ),
                        ),
                      ),
                    Boolean(_) &&
                ...
                _ &&
                  _.createElement(
                    "div",
                    {
                      className: (0, _._)(_.GameChartCtn, _.ChartWidthHelper),
                    },
                    _.createElement(
                      "div",
                      {
      ...
      function _(_) {
        ...
        return _.createElement(
          ...
          _.createElement(_, {
            bBlurContent: _,
            appid: _,
            nYear: __webpack_require__.GetYear(),
          }),
        );
      }
      function _(_) {
      ...
      function _(_) {
        ...
        return _.createElement(
          ...
          Boolean(_.GetPlayTimeStats().playtime_streak) &&
            _.createElement(
              _._,
              null,
              _.createElement(_, {
      ...
      function _(_) {
        ...
        return _.createElement(
          ...
          _.createElement(
            ...
            (0, _._)("#YearInReview_PossessiveUserName", _.persona_name),
          ),
        );
      }
      function _(_) {
            ...
            _.createElement(
              ...
              _.createElement(
                ...
                _.createElement(
                  "ol",
                  null,
                  _.createElement("li", null, (0, _._)("#YIR_FAQ_Share_A_b1")),
                  _.createElement("li", null, (0, _._)("#YIR_FAQ_Share_A_b2")),
                  _.createElement("li", null, (0, _._)("#YIR_FAQ_Share_A_b3")),
                ),
              ),
            ),
            _.createElement(
