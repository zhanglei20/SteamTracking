  ...
  (self.webpackChunkstore = self.webpackChunkstore || []).push([
    [36814],
    {
      ...
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        _([_._], _.prototype, "m_ItemDefinition", 2),
          _([_._], _.prototype, "m_ItemKV", 2);
        function _(_, _) {
      ...
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        function _(_) {
          return _ == 2 ? `hue-rotate(${360 + ((0, _._))(-30, 10)}deg)` : "";
        }
        function _(_, _) {
          const _ = [];
          if (!_) return _;
        ...
        const _ = (_, _) => {
          ...
          _ = ({ eType: _ }) => {
            const _ = _ == 1,
              _ = _ == 2,
              [_, _] = _();
            let { rgParticleStyles: _, rgStreamerStyles: _ } = _(_, _),
              _;
            switch (_) {
              case 1:
                _ = _.map((_, _) =>
      ...
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        var _ = __webpack_require__("chunkid"),
          ...
          _ = __webpack_require__("chunkid");
        function _(_) {
          return "unknown EUserLastReadFeedType ( " + _ + " )";
        }
        function _(_) {
          return "unknown EAccountCountryChangeSource ( " + _ + " )";
        }
        function _(_) {
          return "unknown ESetUserCountryError ( " + _ + " )";
        }
        function _(_) {
          return "unknown EUserAccountHistoryCategory ( " + _ + " )";
        }
        ...
        const _ = 1263950,
          ...
          _ = 4228010,
          _ = 4844660,
          _ = _._.EUNIVERSE === _._ ? 404860 : 1675200;
        function _(_, _ = !1) {
          const _ = (_) => (0, _._)(_ ? `${_}_Plural` : _);
          switch (_) {
            case _._:
              return _("#CommunityItemClass_Emoticon");
            case _._:
              return _("#CommunityItemClass_Sticker");
            case _._:
              return _("#CommunityItemClass_MiniProfileBackground");
            case _._:
              return _("#CommunityItemClass_Background");
            case _._:
              return _("#CommunityItemClass_ChatEffect");
            case _._:
              return _("#CommunityItemClass_AvatarFrame");
            case _._:
              return _("#CommunityItemClass_AnimatedAvatar");
            case _._:
              return _("#CommunityItemClass_Badge");
            case _._:
              return _("#CommunityItemClass_ProfileModifier");
            case _._:
              return _("#CommunityItemClass_SteamDeckKeyboardSkin");
            case _._:
              return _("#CommunityItemClass_SteamDeckStartupMovie");
          }
        ...
        const _ = class _ {
          ...
          SetCurrentSearchTerm(_) {
            this.m_strSearchTerm = _ && _.slice(0, 200);
          }
          ...
          GetRewardDefinitions(..._) {
            ...
            if (_.length > 0) {
              ...
              for (let _ = 0; _ < Math.ceil(_.length / 100); _++) {
                const _ = _.slice(_ * 100, _ * 100 + 100);
          ...
          QueryLoyaltyRewardDefinitions(_, _, _, _) {
            ...
            if (this.m_mapAppRewards.has(_)) {
              ...
              _ > _.rgRewardIds.length - 1
                ? (_ = _ + _ - _.rgRewardIds.length)
                : (_ = Math.max(_ - (_.rgRewardIds.length - _), 0)),
                _.bFullyLoaded && (_ = 0),
                (_ = _.strCursor);
            }
            if (
              ...
              this.LoadLoyaltyRewardDefinitions(_, _, _, _).then((_) => {
                (0, _._)(() => {
                  const { definitions: _, next_cursor: _, total_count: _ } = _,
                    _ = _.filter((_) => (!_(_) || _.type === _._._) && !_(_)),
                  ...
                  delete this.m_inflightRewardItemRequests[_],
                    ...
                    (_.bFullyLoaded =
                      _.length === 0 || _.rgRewardIds.length === _.cTotal),
                    _.forEach((_) => {
                      this.m_mapLoyaltyRewardDefs.set(_.defid, _),
                        _.push(_.appid);
                    }),
          ...
          GetGoldenProfileConfigForApp(_) {
            return (
              this.m_goldenProfileConfigs.find((_) => _.appid === _) || null
            );
          }
          ...
          async SetProfileBackground(_) {
            ...
            _.Body().set_communityitemid(this.GetOwnedCommunityItemID(_));
          ...
          async RedeemPointsForItem(_, _, _) {
            ...
            const _ = _._.Init(_._);
            _.Body().set_defid(_),
              _.Body().set_expected_points_cost(_.toString());
          ...
          async RedeemPointsForProfileShowcase(_) {
            ...
            const _ = _._.Init(_._);
            _.Body().set_customization_type(_);
          ...
          async RedeemPointsForCoupon(_) {
            ...
            _.append("sessionid", (0, _._)()), _.append("itemid", _.toString());
            try {
              await _()
                .post(
                  ...
                  case _._: {
                    if (
                      (_.community_item_data.animated &&
                        _.community_item_class == _._) ||
                      this.GetSortedGamesWithRewards().includes(_.appid)
                    )
                      return !0;
          ...
          BCanRedeemPointsForProfileShowcaseUpgrade(_, _) {
            return (
              _ < this.m_rgProfileCustomizationsConfig.max_upgradable_level
            );
          }
            ...
            if (!this.m_bSortedGamesWithRewards) {
              ...
              Promise.all([_, _]).then(([_, _]) => {
                ...
                const _ = _.filter((_) => this.m_mapEligibleApps.has(_)),
                  _ = _.filter((_) => _.includes(_.appid) == !1).map(
                    (_) => _.appid,
                  );
                this.m_rgSortedAppsWithRewards = _.concat(_);
              });
            }
          ...
          async LoadRecentlyPlayedApps() {
            ...
            const _ = _._.Init(_.t24),
              _ = Math.floor(Date.now() / 1e3) - _._.PerDay * 14;
            _.Body().set_min_last_played(_);
            const _ = await _.xtC.ClientGetLastPlayedTimes(this.m_transport, _);
            return _.GetEResult() == _._
              ? ((this.m_rgRecentlyPlayed = this.ProcessRecentlyPlayedApps(
                  _.Body().toObject().games,
                )),
                this.m_rgRecentlyPlayed)
              : (console.error(
                  `Error when calling PlayerService.ClientGetLastPlayedTimes: EResult=${_.GetEResult()}`,
                ),
                []);
          }
          ...
          async GetEquippedProfileItems(_) {
            ...
            const _ = _._.Init(_._);
            _.Body().set_steamid(_), _.Body().set_language(_._.LANGUAGE);
          ...
          async RetrievePersonaState() {
            ...
            return _()
              .get(
                `${_._.WEBAPI_BASE_URL}ISteamUserOAuth/GetUserSummaries/v2/`,
                {
                  params: _,
                },
              )
          ...
          GetAppHeroImage(_) {
            ...
            return _ && _.hero_carousel_image
              ? {
          ...
          HydrateCustomPages() {
            const _ = (_, _, _) => {
              ...
              _ = [];
            let _ = !0;
            _.push(_(4761370)), _.push(_(4374420));
            let _;
            const _ = [],
              _ = _ ? [_, _] : [_, _];
            ...
            _(
              ...
              this.BIsLoggedIn() &&
                (0, _._)(
                  ...
                  const _ = 3,
                    _ = _.Get().GetSortedGamesWithRewards(),
                    _ = (_) => {
                  ...
                  for (const _ of _) {
                    if (
                      _.findIndex(
                        (_) =>
                          _.type === "clusterview" && _(_.view.cluster) === _,
                      ) != -1
                    )
                      continue;
                    const _ = _(_),
        ...
        _([_._.ref], _.prototype, "m_lPointsAvailable", 2),
          _([_._], _.prototype, "m_mapCouponPromos", 2),
          _([_._], _.prototype, "m_nAppIDFiltersInUseCount", 2),
          _([_._], _.prototype, "m_mapAppIDFilters", 2),
          _([_._], _.prototype, "m_strAppFilterText", 2),
          _([_._], _.prototype, "m_strSearchTerm", 2),
          _([_._], _.prototype, "m_strSearchPlaceholder", 2),
          _([_._], _.prototype, "m_mapCouponDefinitons", 2),
          _([_._], _.prototype, "m_mapLoyaltyRewardDefs", 2),
          _([_._], _.prototype, "m_mapOwnedCommunityItems", 2),
          _([_._], _.prototype, "m_mapAppRewards", 2),
          _([_._], _.prototype, "m_seasonalBadgeDefinition", 2),
          _([_._], _.prototype, "m_goldenProfileDefinition", 2),
          _([_._], _.prototype, "m_goldenProfileConfigs", 2),
          _([_._], _.prototype, "m_rgSortedAppsWithRewards", 2),
          _([_._], _.prototype, "m_rgEventAppsWithRewards", 2),
          _([_._], _.prototype, "m_rgEligibleApps", 2),
          _([_._], _.prototype, "m_mapEligibleApps", 2),
          _([_._], _.prototype, "m_rgProfileCustomizationsConfig", 2),
          _([_._], _.prototype, "m_persona", 2),
          _([_._], _.prototype, "m_equippedItems", 2),
          _([_._], _.prototype, "m_rgPurchasedCustomizations", 2),
          _([_._], _.prototype, "m_rgUpgradedCustomizations", 2),
          _([_._], _.prototype, "m_unAwardPointsTransferred", 2),
          _([_._], _.prototype, "ShowLoginDialog", 1);
        let _ = _;
        function _(_) {
          const _ = _._.LoyaltyStore();
          switch (_.type) {
            case "app":
              return `${_}/app/${_.appid}${typeof _.clusterindex == "number" ? `/cluster/${_.clusterindex}` : ""}`;
            case "custom":
              return `${_}/c/${_.pageid}${typeof _.clusterindex == "number" ? `/cluster/${_.clusterindex}` : ""}`;
            case "event":
        ...
        _([_._], _.prototype, "GetRewards", 1);
        class _ {
          m_strId;
          m_appid;
          m_strSubtitle;
        ...
        class _ {
          ...
          get items() {
            return this.m_rgPageItems.map((_) => _(_));
          }
        }
        function _(_) {
          switch (_.type) {
        ...
        function _(_) {
          if (_.type === _._._ || _.type === _._._)
            return !_.bundle_defids || _.bundle_defids.length == 0
              ? (console.error(`Bundle contains no items for def ${_.defid}`),
                !0)
              : _.bundle_discount
                ? !1
                : (console.error(`Bundle has no discount for def ${_.defid}`),
                  !0);
          ...
          if (_.type === _._._) {
            ...
            if (_)
              return (
                console.error(`Missing expected assets for reward ${_.defid}`),
                !0
              );
          }
          return !1;
        ...
        const _ = class _ {
          ...
          BCanClaimFreeSaleReward() {
            return _.Get().BIsLoggedIn() ? this.m_bCanClaimFreeItem : !0;
          }
          ...
          async ClaimFreeSaleItem() {
            ...
            return (
              (_.eResult = _.GetEResult()),
              _.GetEResult() == _._
                ? ((this.m_claimedFreeItemDef = _.Body()
                    .reward_item()
                    .toObject()),
                ...
                : (_.GetEResult() == _._ &&
                  ...
                  console.error(
                    `Error when calling SaleItemRewardsService.ClaimItem: EResult=${_.GetEResult()}`,
                  )),
              _
            );
          }
          ...
          SetClaimTimer() {
            ...
            const _ = Date.now();
            let _ = new Date(this.m_rtNextClaimTime * 1e3);
        ...
        _([_._], _.prototype, "m_bCanClaimFreeItem", 2),
          _([_._], _.prototype, "m_claimedFreeItemDef", 2),
          _([_._], _.prototype, "m_rtNextClaimTime", 2);
        let _ = _;
      },
      chunkid: (module, module_exports, __webpack_require__) => {
        "use strict";
        ...
        function _({ definition: _, theme: _, ..._ }) {
          const _ = [],
            { icon_url: _, name: _ } = _._.GetAppInfo(_.appid),
        ...
        function _(_, _, _, _, _) {
          const _ = _ * (Math.sin(0.42) + Math.cos(0.42)) - _,
            _ = _ - _,
            _ = Math.min(_, _ / _),
            _ = ((_ - _) / 2) * _,
            _ = _ * _ + _,
            _ = (_ - 1) / 2,
            _ = (Math.pow(_ - _, 2) * 30) / (_ * _),
            _ = ((0.42 * 2) / (_ - 1)) * _ - 0.42;
          return {
            position: "absolute",
            transformOrigin: "center",
            transform: `translateX(${_}px) translateY(${_}px) rotate(${_}rad)`,
            width: `${_}px`,
            height: `${_}px`,
          };
        }
      ...
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        function _(_) {
          ...
          return _ === 0
            ? null
            : (0, _._)("#HiddenWithCountButton", (0, _._)(_));
        }
        function _(_) {
          const _ = _(_);
          return _ === 0
        ...
        const _ = 10,
          ...
          _ = (0, _._)((_) => {
            ...
            if (
              (_.cMaxToReturn > 0
                ...
                : _.cTotalMatching > 0
                  ...
                  : (_ = (0, _._)("#SeeAllButton")),
              _.cTotalMatching === 0 && !_.bLoadingMore)
            )
              return null;
            const _ = !_ || !_,
              _ = !_ && _ && _(_);
            ...
            return (
              ...
              _ && (_.length == 0 ? _.push(_) : _.length == 0 && _.push(_)),
              (0, _.jsx)(_._, {
                title: _,
                subtitle: _,
                leftActions: _,
          ...
          _ = (0, _._)((_) => {
            ...
            const {
              ...
              _ = _(0, _ ? 4 : 3, _),
              _ =
                _.bLoadingMore && _.rewards.length === 0
                  ? [
                      (0, _.jsx)(_._, {}, "0"),
                      (0, _.jsx)(_._, {}, "1"),
                      (0, _.jsx)(_._, {}, "2"),
...
`);
      ...
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        function _(_) {
          ...
          return jsx("svg", {
            ...
            xmlns: "http://www.w3.org/2000/svg",
            viewBox: "0 0 52 46.1",
            className: classnames(_, "SVGIcon_Button"),
            children: jsx("path", {
              _: `M49.3,41.6l-19.6-20l9.8-9.6c0.6,0.1,1.2,0.1,1.7-0.1c1.6-0.4,2.8-1.8,3.4-3.8c0.6-2.1,2-3.6,3.1-4.1
      ...
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        function _() {
          ...
          return _ !== null ? (_(_), _(), !0) : !1;
        }
        function _() {
          window.setTimeout(() => {
            _() === !1 &&
              (_ === null && (_ = new MutationObserver(_)),
              _.observe(document, {
                attributes: !0,
                childList: !0,
                subtree: !0,
        ...
        const _ = () => {
          ...
          _ = (_) => {
            const {
              ...
              _ = _,
              _ = _,
              _ = typeof _._ == "object" && _._.hash ? _ : _._;
            return (0, _.jsxs)(_, {
        ...
        function _(_) {
          const _ = (0, _._)(),
            _ = typeof _._ == "string" ? _._ : _._.pathname,
            _ = (0, _._)(_),
              ...
              _.items.forEach((_) => {
                if (_.external) {
                  ...
                  const _ = _.props,
                    ...
                    _ = typeof _._ == "string" ? _._ : JSON.stringify(_._);
                  _.push(
                    (0, _.createElement)(
                      _._,
                      {
        ...
        const _ = ({ className: _, ..._ }) => {
          ...
          _ = ({ className: _, ..._ }) =>
            jsx("div", {
              className: classnames(styles.StandardBackground, _),
              ..._,
            }),
          _ = ({ children: _ }) =>
            (0, _.jsx)(_, {
      ...
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        var _ = {
          ...
          _ = function (_, _, _) {
            return function () {
              var _;
              _.props[_] && (_ = _.props)[_].apply(_, arguments), _();
            };
          },
          _ =
            ((_ = {}),
            ...
            return (
              ...
              (_.getDerivedStateFromProps = function (_, _) {
                return _.children == null
                  ...
                  : _.status === _._ && _.mode === _._
                    ? {
                        status: _._,
                      }
                    : _.current && _(_.current, _.children)
                      ? {
                          status: _._,
                        }
                      : {
        ...
        function _(_, _, _) {
          return (
            _._.COMMUNITY_CDN_ASSET_URL + _ + "/roomeffects/" + _ + "/" + _
          );
        }
        class _ extends _.Component {
          m_strSaleId;
        ...
        function _(_) {
          return (
            ...
            `winter2019/roomeffects/fireworks/${_}`
          );
        }
        class _ extends _.Component {
        ...
        class _ extends _ {
          ...
          GenerateDuration() {
            const _ = parseFloat(_().balloonsDurationS),
              _ = parseFloat(_().balloonsDurationJitterS);
            return _ + _ * Math.random();
          }
          GenerateBalloons() {
            let _ = ["balloon_small_1", "balloon_small_2", "balloon_small_3"],
              _ = ["balloon_big_1", "balloon_big_2"],
              _ = ["balloon_move_left", "balloon_move_right"];
            this.m_rgBalloons = [];
            for (let _ of _) {
              let _ = _._(-10, 10);
        ...
        class _ {
          ...
          next() {
            const _ = Math.sin(this.m_seed++) * 1e3;
        ...
        function _(_) {
          ...
          for (let _ = 0; _ < 150; _++) {
            const _ = _.next(),
              _ = {
                left: `${_.next() * 100}%`,
                animationDuration: `${(1 - _) * 3 + 4}s`,
                animationDelay: `${_ + _.next() * 4}s`,
              };
            _.push(
              (0, _.jsxs)(
                "div",
        ...
        function _(_) {
          const _ = new _(_);
          let _ = _.next() * 0.8 + 0.5;
          const _ = `${(_.next() + _) * 10 + 10}px`,
            _ = {
              opacity: _,
              width: _,
              height: _,
              margin: `${_.next() * 30 + 15}px`,
              filter: `hue-rotate(${_.next() * 90 - 30}deg) saturate(100%)`,
            },
            _ = 1 + Math.floor(_.next() * 5),
            _ =
        ...
        const _ = {
          ...
          lny2020_firework: _("lny2020_firework", "lny2020", _, () =>
            (0, _.jsx)(_, {
              sale: "lny2020",
            }),
          ),
        ...
        const _ = class _ {
          ...
          UpdateRunningRoomEffects() {
            ...
            for (let _ in this.m_mapRoomEffectQueue) {
              ...
              for (
                ;
                this.m_mapRoomEffectQueue[_].length > 0 &&
                !this.BIsQueueFull(_);
              ) {
        ...
        _([_._], _.prototype, "m_rgRunningEffects", 2);
        let _ = _;
        var _ = __webpack_require__("chunkid"),
          _ = __webpack_require__("chunkid"),
          _ = __webpack_require__("chunkid"),
        ...
        function _(_) {
          const { link: _, className: _, ..._ } = _,
            [_, _] = _.useState(!1),
            _ = () => {
              _(!0), navigator.clipboard.writeText(_);
            };
          return (0, _.jsx)("div", {
        ...
        var _ = ((_) => (
          (_[(_.k_ERedeemPointsTypeInvalid = 0)] =
        ...
        function _(_) {
          switch (_.type) {
            case 1:
              return _.rewardDefinition.community_item_class == _._
                ? _._.Get().GetCostToLevelSeasonalBadge(_.itemLevel || 0)
                : _.rewardDefinition.type == _._._ ||
                    _.rewardDefinition.type == _._._
                  ? _._.Get().GetBundleOfferForUser(_.rewardDefinition)
                      .point_cost
                  : parseInt(_.rewardDefinition.point_cost);
            case 2:
        ...
        function _(_) {
          switch (_.type) {
            ...
            case 2:
              return {
                discount: 0,
                originalCost: _._.Get().GetUpgradableProfileShowcaseCost(),
              };
            case 3:
              return {
                discount: 0,
                originalCost: _._.Get().GetPurchasableProfileShowcaseSlotCost(),
              };
          }
          return {
            discount: 0,
        ...
        _([_._], _.prototype, "ShowGenericError", 1),
          _([_._], _.prototype, "ShowError", 1),
          _([_._], _.prototype, "RedeemPoints", 1),
          _([_._], _.prototype, "EquipItem", 1),
          _([_._], _.prototype, "ReloadItemDef", 1),
          _([_._], _.prototype, "CloseModal", 1),
          (_ = _([_._], _));
        const _ = (_) => {
        ...
        class _ extends _.Component {
          ...
          render() {
            ...
            if (!_ && _.rewardDefinition.bundle_defids?.length == 0)
              return null;
            if (!_) {
              _ = {
        ...
        class _ extends _.Component {
          ...
          OnProfileFrameResized = (_) => {
            _.data.message &&
              _.data.message == "iframe_dimensions" &&
              this.setState({
        ...
        const _ = {
              ...
              case 1:
                ...
                _.definition.rewardDefinition.type == _._._
                  ...
                  : _.definition.rewardDefinition.community_item_class == _._ &&
                      _.definition.rewardDefinition.bundle_defids?.length != 0
                    ? (_ = _)
                    : (_ =
          ...
          _ = (_) => {
            ...
            let _ = _.community_item_data.badge_data[_ - 1]?.image,
              _ = _.NextLevel;
            return (
              _._.Get().GetUserSeasonalBadgeLevel() == _ &&
                (_ = _.CurrentLevel),
              (0, _.jsxs)("div", {
      ...
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        const _ = (_) => {
          ...
          _ = (0, _._)((_) => {
            ...
            if (
              ...
              _.definition.bundle_defids?.length != 0
            )
              return (0, _.jsx)(_._, {
                fallback: null,
                children: (0, _.jsx)(_._, {
        ...
        function _(_) {
          return __webpack_require__("chunkid")(`./icon_showcase_${_}.svg`)
            ?.default;
        }
        function _({
          customization_type: _,
      ...
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        const _ = (_) => {
          ...
          _ = () =>
            jsxs("div", {
              ...
              style: {
                backgroundImage: `url(${ValveItemsBg})`,
              },
              children: [
                jsxs(Box, {
                  display: "flex",
        ...
        var _ = __webpack_require__("chunkid"),
          ...
          _ = __webpack_require__("chunkid");
        function _(_) {
          return "unknown EAuctionBidState ( " + _ + " )";
        }
        class _ extends _.Message {
          static ImplementsStaticInterface() {}
          constructor(_ = null) {
        ...
        const _ = class _ {
            ...
            return (
              (!this.m_bLoadedAllItems || _) &&
                ...
                this.LoadAllItems().then((_) =>
                  _.forEach((_) =>
                    this.m_mapAuctionItems.set(_.store_appid, _),
                  ),
                )),
          ...
          async GetUserBidForItem(_) {
            ...
            return _.GetEResult() == _._
              ? _.Body().toObject().bid
              : (console.error(
                  `Error when calling AuctionService.GetUserBidForItem: EResult=${_.GetEResult()}`,
                ),
                null);
          }
        ...
        _([_._], _.prototype, "m_rgCurrentUserBids", 2),
          _([_._], _.prototype, "m_mapAuctionItems", 2);
        let _ = null;
        var _ = __webpack_require__("chunkid");
        async function _() {
            ...
            (0, _.jsxs)(_._, {
              ...
              children: [
                (0, _.jsx)(_, {
                  header: (0, _.jsx)("a", {
                    href: (0, _._)(
                      _._.STORE_BASE_URL + _.data?.details?.url,
                      _,
                    ),
                    children: _,
                  }),
