      ...
      chunkid: function (module, module_exports, __webpack_require__) {
        ...
        (function (_, _) {
          ...
          var _ = "1.0.41",
            ...
            _ = function (_, _) {
              return typeof _ === _ ? _(_).indexOf(_(_)) !== -1 : !1;
            },
            _ = function (_) {
            ...
            _ = function (_, _) {
              if (typeof _ === _)
                return (
                  (_ = _.replace(/^\s\s*/, _)),
                  typeof _ === _ ? _ : _.substring(0, _)
                );
            },
            _ = function (_, _) {
              for (var _ = 0, _, _, _, _, _, _; _ < _.length && !_; ) {
                var _ = _[_],
                  _ = _[_ + 1];
              ...
              for (var _ in _)
                if (typeof _[_] === _ && _[_].length > 0) {
                  for (var _ = 0; _ < _[_].length; _++)
                    if (_(_[_][_], _)) return _ === _ ? _ : _;
                } else if (_(_[_], _)) return _ === _ ? _ : _;
            ...
            _ = function (_, _) {
              ...
              var _ = typeof _ !== _ && _.navigator ? _.navigator : _,
                _ = _ || (_ && _.userAgent ? _.userAgent : _),
              ...
              return (
                ...
                (this.setUA = function (_) {
                  return (
                    (_ = typeof _ === _ && _.length > _ ? _(_, _) : _), this
                  );
                }),
                this.setUA(_),
                this
          ...
          (_.VERSION = _),
            ...
            (_.ENGINE = _._ = _([_, _])),
            typeof _ !== _
              ? (_ !== "object" && _.exports && (_ = _.exports = _),
                (_.UAParser = _))
              : _ === "function" && _.amdO
                ? ((_ = function () {
                    return _;
