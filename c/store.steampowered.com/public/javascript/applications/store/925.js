      ...
      function _(_, _ = !1) {
        ...
        return (0, _._)({
          ...
          queryFn: async () => {
            ...
            const _ = await _._.GetFamilyGroupForUser(_, _);
            return _(_.GetEResult()), _.Body();
          },
          staleTime: _,
          enabled: !!_,
          placeholderData: _ ? void 0 : new _._(),
        });
      }
      function _(_) {
        const _ = (0, _._)(),
        ...
        return (0, _._)({
          ...
          queryFn: async () => {
            if (_) {
              ...
              const _ = await _._.GetFamilyGroup(_, _);
              return _(_.GetEResult()), _.Body();
            }
            throw _._;
          },
      ...
      function _() {
        ...
        return (0, _._)({
          mutationFn: async (_) => {
            ...
            const _ = await _._.CreateFamilyGroup(_, _);
            return _(_.GetEResult()), _.Body();
          },
          onSuccess: () => {
            _.invalidateQueries({
      ...
      function _(_) {
        ...
        return (0, _._)({
          mutationFn: async () => {
            const _ = _._.Init(_._);
            __webpack_require__.Body().set_family_groupid(_);
            const _ = await _._.DeleteFamilyGroup(_, _);
            return _(_.GetEResult()), _.Body();
          },
          onSuccess: () => {
      ...
      function _(_) {
        ...
        return (0, _._)({
          mutationFn: async (_) => {
            ...
            const _ = await _._.ModifyFamilyGroupDetails(_, _);
            return _(_.GetEResult()), _.Body();
          },
          onSuccess: () => {
            __webpack_require__.invalidateQueries({
      ...
      function _(_, _, _) {
        ...
        return (0, _._)({
          mutationFn: async () => {
            ...
            const _ = await _._.InviteToFamilyGroup(_, _);
            return _(_.GetEResult()), _.Body();
          },
          onSuccess: () => {
            _.invalidateQueries({
      ...
      function _(_) {
        ...
        return (0, _._)({
          mutationFn: async () => {
            const _ = _._.Init(_._);
            __webpack_require__.Body().set_family_groupid(_);
            const _ = await _._.JoinFamilyGroup(_, _);
            return _(_.GetEResult()), _.Body();
          },
          onSuccess: () => {
            _.invalidateQueries({
      ...
      function _(_, _) {
        ...
        return (0, _._)({
          mutationFn: async () => {
            ...
            const _ = await _._.CancelFamilyGroupInvite(_, _);
            return _(_.GetEResult()), _.Body();
          },
          onSuccess: () => {
            _.invalidateQueries({
      ...
      function _(_, _) {
        ...
        return (0, _._)({
          mutationFn: async () => {
            ...
            const _ = await _._.RemoveFromFamilyGroup(_, _);
            return _(_.GetEResult()), _.Body();
          },
          onSuccess: () => {
            _.invalidateQueries({
      ...
      function _(_) {
        ...
        return (0, _._)({
          ...
          queryFn: async () => {
            ...
            const _ = await _._.GetUsersSharingDevice(_, _);
            return _(_.GetEResult()), _.Body();
          },
        });
      }
      ...
      function _(_, _) {
        ...
        return (0, _._)({
          mutationFn: async () => {
            ...
            const _ = await _._.RequestPurchase(_, _);
            return _(_.GetEResult()), _.Body();
          },
        });
      }
      function _(_, _) {
        ...
        return (0, _._)({
          ...
          queryFn: async () => {
            ...
            const _ = await _._.GetPurchaseRequests(_, _);
            return _(_.GetEResult()), _.Body();
          },
        });
      }
        ...
        return (0, _._)({
          mutationFn: async () => {
            ...
            _.Body().set_family_groupid(_),
              ...
              _.Body().set_action(_);
            const _ = await _._.RespondToRequestedPurchase(_, _);
            return _(_.GetEResult()), _.Body();
          },
          onSuccess: () => {
            _.invalidateQueries({
      ...
      function _(_) {
        ...
        return (0, _._)({
          ...
          queryFn: async () => {
            const _ = _._.Init(_._);
            __webpack_require__.Body().set_family_groupid(_);
            const _ = await _._.GetChangeLog(_, _);
      ...
      function _(_, _) {
        ...
        return (0, _._)({
          ...
          queryFn: async () => {
            ...
            const _ = await _._.GetSharedLibraryApps(_, _);
            return (
        ...
        return (0, _._)({
          mutationFn: async (_) => {
            ...
            _.Body().set_family_groupid(_),
              ...
              _.Body().set_nonce(_);
            const _ = await _._.ConfirmJoinFamilyGroup(_, _);
            return _(_.GetEResult()), _.Body();
          },
          onSuccess: () => {
            _.invalidateQueries({
        ...
        return (0, _._)({
          mutationFn: async () => {
            ...
            _.Body().set_family_groupid(_),
              _.Body().set_invite_id(_),
              _.Body().set_nonce(_);
            const _ = await _._.ConfirmInviteToFamilyGroup(_, _);
            return _(_.GetEResult()), _.Body();
          },
          onSuccess: () => {
            _.invalidateQueries({
      ...
      function _(_) {
        ...
        return (0, _._)({
          mutationFn: async () => {
            const _ = _._.Init(_._);
            __webpack_require__.Body().set_family_groupid(_);
            const _ = await _._.UndeleteFamilyGroup(_, _);
