  ...
  (self.webpackChunkstore = self.webpackChunkstore || []).push([
    [80702],
    {
          ...
          return (0, _._)({
            mutationFn: async () => {
              ...
              if ((0, _._)(_)) {
                ...
                if (_ == _._) (_ = _.line_item_ids), (0, _._)(_, _, _.cart);
      ...
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        const module_exports = new WeakSet();
        function _(_) {
          if (!_.has(_)) {
            _.add(_);
            for (const _ of [
        ...
        const module_exports = new WeakMap();
        function _(_) {
          if (!_) return null;
          let _ = _.get(_);
          return (
      ...
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        function _(_, _ = k_ERegionCodeInvalid) {
          switch (_) {
            case k_ECurrencyCodeGBP:
              return "gbp";
            case k_ECurrencyCodeEUR:
      ...
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        const module_exports = 0,
          ...
          module_exports = 48;
        function _(_) {
          return typeof _ == "number" && _ > _ && _ < _;
        }
        function _() {
          return [
            "USD",
      ...
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        function _(_, _, _) {
          ...
          if (_ >= _._.PerYear)
            return (
              (_ -= _._.PerYear),
              _ >= _._.PerMonth * 2 && !_.bForceSingleUnits
          ...
          if (_ >= _._.PerDay)
            return (
              (_ -= _._.PerDay),
              _ >= _._.PerHour * 2 && !_.bForceSingleUnits
          ...
          if (_ >= _._.PerHour)
            return (
              (_ -= _._.PerHour),
              _ >= _._.PerMinute * 2 && !_.bForceSingleUnits
                ? _.Localize(`#${_}1HourXMinutes`, _(_ / _._.PerMinute))
                : _.Localize(`#${_}1Hour`)
            );
          if (_ >= _._.PerMinute * 2) {
      ...
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        const module_exports = "DEBUG_UseNewGameHover";
        function _(_) {
      ...
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        function _(_) {
          return new Date(_ * 1e3).toLocaleDateString((0, _._)());
        }
        function _(_) {
          return _.toLocaleDateString((0, _._)(), {
            year: "numeric",
        ...
        function _(_) {
          switch (_.getUTCMonth()) {
            ...
            case 1:
            case 2:
              return _._.Localize("#Time_QuarterOfYear_Q1", _.getUTCFullYear());
            case 3:
            case 4:
            case 5:
              return _._.Localize("#Time_QuarterOfYear_Q2", _.getUTCFullYear());
            case 6:
            case 7:
            case 8:
              return _._.Localize("#Time_QuarterOfYear_Q3", _.getUTCFullYear());
            default:
              return _._.Localize("#Time_QuarterOfYear_Q4", _.getUTCFullYear());
          }
        }
        function _(_) {
          if (!_) return "";
      ...
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        async function _(_, _) {
          ...
          _._.IN_CLIENT ? (window.location.href = _) : _(_, _, _);
        }
        async function _(_, _, _) {
      ...
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        const module_exports = class _ {
          ...
          static Log = new _.module_exports("ActionDescription").Debug;
          ...
          BFromActiveNavTree(_, _) {
            let _ = _?.Tree;
            return (
              _ || (_ = _?.Tree), _ && _.Controller.IsActiveFocusNavTree(_)
            );
          }
          ...
          IsDefaultAction(_) {
            return (
              this.GetActionDescription(_) === this.m_defaultActions.get(_)
            );
          }
          ...
          SetActionsFromMap(_) {
            ...
            for (let _ of _)
              _[_] === void 0 && this.SetAction(_, void 0) && (_ = !0);
            for (let _ in _) {
              const _ = parseInt(_);
        ...
        _([_.module_exports], _.prototype, "OnFocusNavigationChanged", 1),
          _([_.module_exports], _.prototype, "OnActiveNavTreeChanged", 1),
          _([_.module_exports], _.prototype, "SetActionDescriptionsFromMap", 1);
      ...
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        const module_exports = class _ {
          ...
          async InternalLoadAppCompatability(_) {
            ...
            try {
              ...
              if (_?.status == 200 && _.data?.success == _._ && _.data?.results)
        ...
        _([_.module_exports], _.prototype, "LoadAppCompabitilityResult", 1);
      ...
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        function _(_) {
          const _ = (0, _._)(
              _.size != null ? _(_.size) : _(1),
              _.type != null ? _(_.type) : _(1),
      ...
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        function _(_) {
          ...
          return useQuery({
            queryKey: ["performancestats_" + _],
            queryFn: async () => {
              const _ = CProtoBufMsg.Init(
                CGamePerformanceStats_GetGameFrameRateStats_Request,
              );
              _.Body().set_appid(_);
              const _ = await GamePerformanceStatsService.GetGameFrameRateStats(
                _,
                _,
              );
              return _.BSuccess() ? _.Body().toObject() : null;
            },
          });
        }
        var module_exports = __webpack_require__("chunkid");
        ...
        function _(_) {
          const { titleId: _, descriptionId: _, results: _, appName: _ } = _,
            ...
            _ =
              _.steamos_resolved_items && _.steamos_resolved_items?.length > 0;
          return (0, _.jsx)(_, {
            titleId: _,
            title: _._.Localize(
              "#SteamOSCompatibility_Store_CompatSectionHeader_GamepadUI",
        ...
        function _(_) {
          const { titleId: _, descriptionId: _, results: _, appName: _ } = _,
            _ = _.resolved_items?.findIndex((_) => _.display_type == _) !== -1,
            _ = (0, _.jsx)(_._, {
              _: _,
              category: _.resolved_category,
              appName: _,
        ...
        function _(_) {
          const { titleId: _, descriptionId: _, results: _, appName: _ } = _,
            _ =
              _.machine_resolved_items?.findIndex(
                (_) => _.display_type == _,
              ) !== -1,
            _ = (0, _.jsx)(_._, {
              _: _,
            ...
            _ =
              _.machine_resolved_items && _.machine_resolved_items?.length > 0;
          return (0, _.jsx)(_, {
            titleId: _,
            title: _._.Localize(
              "#SteamMachineCompatibility_Store_CompatSectionHeader_GamepadUI",
        ...
        function _(_) {
          const _ = usePerformanceStats(_.appid);
          return useMemo(
            () =>
              _?.data?.frame_rates
                ?.find((_) => _.clusterid == "1")
                ?.mean_frame_rate?.toFixed(0),
            [_],
          )
            ? jsx("div", {
                className: styles.GamePerformance,
                children: null,
              })
            : null;
        }
      ...
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        function _(_) {
          ...
          return (
            _ === "success"
              ? (_ = styles.StatusSuccess)
              : _ === "danger"
                ? (_ = styles.StatusDanger)
                : _ === "caution"
                  ? (_ = styles.StatusCaution)
                  : _ === "info"
                    ? (_ = styles.StatusInfo)
                    : _ === "incomplete" && (_ = styles.StatusIncomplete),
            jsx("div", {
              className: classnames(
                styles.GraphicalAssetStatus,
                _,
                _ ? styles.checklistBox : "",
              ),
              children: _,
            })
          );
