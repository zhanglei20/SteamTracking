    ...
    [33615],
    {
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        var _ = __webpack_require__("chunkid"),
          ...
          _ = __webpack_require__("chunkid");
        function _(_) {
          return "unknown EPromoPlanAssociationType ( " + _ + " )";
        }
        function _(_) {
          return "unknown EPromotionNotification ( " + _ + " )";
        }
        function _(_) {
          return "unknown EPromotionEventInviteType ( " + _ + " )";
        }
        ...
        ((_) => {
          ...
          _.GetPlanCompletedInDateRange = _;
          function _(_, _, _) {
            return _.SendMsg(
          ...
          _.MarkLocalizationAssetComplete = _;
          function _(_, _, _) {
            return _.SendMsg(
          ...
          _.GetPromotionPlanSalesDaily = _;
          function _(_, _, _) {
            return _.SendMsg(
          ...
          _.GetPromotionPlanForSalePages = _;
          function _(_, _, _) {
            return _.SendMsg(
          ...
          _.GetUpcomingScheduledDiscounts = _;
          function _(_, _, _) {
            return _.SendMsg(
          ...
          _.GetSalePageCandidatesForPromo = _;
          function _(_, _, _) {
            return _.SendMsg(
          ...
          _.GetAdvertisingAppsForPartner = _;
        })(_ || (_ = {}));
        var _;
        ((_) => {
          function _(_, _, _) {
        ...
        _([_._], _.prototype, "OnDeleteEventSuccessCallback", 1),
          _([_._], _.prototype, "OnDeleteForumTopicSuccessCallback", 1),
          _([_._], _.prototype, "OnDeleteEventFailureCallback", 1),
          _([_._], _.prototype, "OnDeleteForumTopicFailureCallback", 1),
          _([_._], _.prototype, "SetToWaiting", 1),
          _([_._], _.prototype, "OnDelete", 1),
          _([_._], _.prototype, "OnChangeDeleteForum", 1);
        let _ = _;
        var _ = __webpack_require__("chunkid"),
          _ = __webpack_require__("chunkid"),
          _ = __webpack_require__._(_),
        ...
        function _(_) {
          return !!(_?.support_user && _?.valve_admin);
        }
        var _ = __webpack_require__("chunkid"),
          _ = __webpack_require__("chunkid"),
          _ = __webpack_require__("chunkid"),
            ...
            () =>
              _?.some(
                (_) =>
                  ...
                  _.section_type == "quest" ||
                  _.section_type == "rewards",
              ),
            [_],
          )
            ? (0, _.jsx)(_, {
        ...
        function _(_, _) {
          if (_ && _.section_type == "rewards") {
            const _ = _.rewards.reward_items?.filter((_) => _.item_bucket == _);
            if (_?.length > 0)
              return _.map((_) => ({
                appid: _.appid,
        ...
        function _(_) {
          ...
          const _ = _.GetSaleSectionsByType("quiz"),
            ...
            _ =
              _?.length == 1 &&
              (_[0].quiz.quiz_type == "scenario" ||
                _[0].quiz.quiz_type == "branching") &&
              ...
              (0, _.jsx)(_._, {
                ...
                onChange: (_) => {
                  ...
                  if (
                    ...
                    const _ = _.map((_) => _(_, _)).filter(Boolean),
                      _ = new Array();
                    _.forEach((_) => _.push(..._)),
        ...
        function _(_) {
          ...
          return (0, _.jsx)(_, {
            ...
            additionalButtons: _,
            onDeleteRequest: _ && (0, _._)() == "community" ? _ : void 0,
            saleDayControl:
              _ !== void 0 &&
              _.length > 0 &&
              (0, _.jsx)(_._, {
                  ...
                  (0, _._)(_.section_type) &&
                    ...
                    _.capsules.forEach((_) => {
                      _.visibility_index !== void 0 &&
                        (_ === void 0 || _ < _.visibility_index) &&
                        (_ = _.visibility_index);
                    });
                }),
              _.jsondata.sale_num_headers > 1 &&
                (_ === void 0 || _ < _.jsondata.sale_num_headers) &&
        ...
        function _(_) {
          const { eventModel: _ } = _,
            _ = (0, _._)(() => _.jsondata.sale_sections),
            _ = (0, _.useMemo)(
              () => _?.find((_) => _.section_type == "badge_progress"),
              [_],
            );
