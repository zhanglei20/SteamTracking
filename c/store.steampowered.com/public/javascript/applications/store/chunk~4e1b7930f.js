  ...
  [38713],
  {
    ...
    chunkid: (module, module_exports, __webpack_require__) => {
      ...
      class _ {
        ...
        async Save(_) {
          ...
          for (const [_, _] of this.m_existingRegistrations) {
            if (this.m_selections.has(_.group_id)) continue;
            const _ = _._.Init(_._);
            _.Body().set_clan_event_gid(this.m_gidClanEvent),
              _.Body().set_steamid(
                _._.InitFromAccountID(
    ...
    chunkid: (module, module_exports, __webpack_require__) => {
      ...
      function _(_) {
        ...
        let _ =
          (0, _._)(_.args, "style")?.toLocaleLowerCase() ?? _._.k_TrailerAsFull;
      ...
      function _(_) {
        ...
        return (0, _.jsx)("div", {
          ...
          children: (0, _.jsx)(_._, {
            _: _,
            type: _,
            bShowDemoButton: _?.GetAppType() == _._._,
    ...
    chunkid: (module, module_exports, __webpack_require__) => {
      ...
      function _(_) {
        const { section: _, rewardDef: _, language: _ } = _,
          _ = _(_.appid, _.community_item_type),
