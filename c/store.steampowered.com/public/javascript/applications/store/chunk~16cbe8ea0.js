  ...
  [53337],
  {
      ...
      function _(_) {
        ...
        return (0, _._)({
          ...
          queryFn: async () => {
            ...
            return (await _._.GetNominationRecommendations(_, _))
              .Body()
              .toObject();
          },
          staleTime: 1 / 0,
              ...
              Boolean(!_ && _) &&
                (0, _.jsx)("div", {
                  ...
                  children: (0, _.jsx)(_._, {
                    ...
                    className: (0, _._)(_().ActionButton, _().WishlistBtnShort),
                  }),
                }),
              (0, _.jsx)("div", {
    ...
    chunkid: (module, module_exports, __webpack_require__) => {
      ...
      function _(_) {
        ...
        const _ =
          _?.success == _._
            ? Boolean(_.visible && _.best_purchase_option)
            : !_?.unvailable_for_country_restriction;
        return (!_ && !_) || (_ && _)
          ? (0, _.jsx)(_.Fragment, {
              children: _.children,
      ...
      function _(_, _, _) {
        return `${_._.COMMUNITY_BASE_URL}partnerevents/${_.ConvertTo64BitString()}/userpoll/${_}/${_ ? "ajaxcastvote" : "ajaxloaddata"}/?origin=store`;
      }
      const _ = 86400;
      function _(_, _) {
        let _ = 0;
    ...
    chunkid: (module, module_exports, __webpack_require__) => {
      ...
      const _ = {
        GetMyEventVote: async function (_) {
          ...
          if (!_._) throw new Error(`${_} answered ${_.status}`);
          return (await __webpack_require__.json()).vote ?? null;
        },
