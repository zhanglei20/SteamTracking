      ...
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        var _ = (_, _, _) =>
          ...
          _ = (_) => {
            ...
            return (_) => {
              const _ =
                !_.test(_[0]) && _.find((_) => _.test(_))?.replace(_, "");
              let _ = 0;
              return _[0]
                .replace(_, () => `${_[_++](_)}${_ || ""}`)
                .replace(_, _);
        ...
        var _,
          ...
          _ = (_) =>
            _.forEach(({ target: _, contentRect: _ }) =>
              _.get(_)?.forEach((_) => _(_)),
            );
        function _(_, _) {
          _ || (typeof ResizeObserver < "u" && (_ = new ResizeObserver(_)));
          let _ = _.get(_);
          return (
        ...
        var _ = new Set(),
          ...
          _ = (_, { container: _ = document.documentElement } = {}) => {
            ...
            const _ = new _(_, _);
            if ((_.add(_), !_.has(_))) {
              const _ = () => (_?.forEach((_) => _.advance()), !0);
              _.set(_, _);
              const _ = _(_);
              window.addEventListener("resize", _, {
                passive: !0,
        ...
        function _(_, _) {
          ...
          return (
            useIsomorphicLayoutEffect7(() => {
              const _ = _.current,
                { root: _, once: _, amount: _ = "any", ..._ } = _ ?? {};
              if (!_ || (_ && _) || typeof IntersectionObserver > "u") return;
              const _ = new WeakMap(),
                _ = () => (
                  _ && _.start(_),
                  _(!0),
