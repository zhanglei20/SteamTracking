...
function _() {
  ...
  let _ = _.bSearchDescriptions ? null : _(_, _.Actions.SearchMarketListings),
    _ = _.bSearchDescriptions ? _(_, _.Actions.SearchItemDescriptions) : null,
    _ = _ !== null ? _ : _,
    _ = _(_, _, _, _),
    [_, _] = (0, _.useState)(_),
    [_, _] = (0, _.useState)(),
  ...
  let _ = _.data?.pages && _.data.pages[0] && _.data.pages[0].facets,
    ...
    [_, _] = (0, _.useState)(!1),
    _ =
      !_.bSearchDescriptions && _ && _.isSuccess
        ? (0, _.jsxs)(_, {
            gap: "2",
            align: "center",
            children: [
