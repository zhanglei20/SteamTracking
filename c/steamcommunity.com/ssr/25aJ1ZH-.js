var _ = (function (_) {
    return (
      ...
      (_[(_.kPFIFlag_CollectionIsASet = 16384)] = `kPFIFlag_CollectionIsASet`),
      ...
      (_[(_.kPFIFlag_ForceAppropriate = 262144)] = `kPFIFlag_ForceAppropriate`),
      ...
      (_[(_.kPFIFlag_DisableComments = 8388608)] = `kPFIFlag_DisableComments`),
  ...
  _ = (function (_) {
    return (
      ...
      (_[(_.k_EPFSplitType_WorkshopItem = 1)] = `k_EPFSplitType_WorkshopItem`),
      (_[(_.k_EPFSplitType_GreenlightItem = 2)] =
        `k_EPFSplitType_GreenlightItem`),
      (_[(_.k_EPFSplitType_SharedFile = 3)] = `k_EPFSplitType_SharedFile`),
      _
    );
  })({}),
  _ = (function (_) {
    return (
      ...
      (_[(_.k_EPFAuditAction_UnBanned = 2)] = `k_EPFAuditAction_UnBanned`),
