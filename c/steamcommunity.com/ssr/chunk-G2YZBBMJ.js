var _ = {};
_(_, {
  k_EQueryFilesSpecialFilter_AcceptedForUse: () => _,
  k_EQueryFilesSpecialFilter_CreateByFriends: () => _,
  k_EQueryFilesSpecialFilter_CreatedByFollowed: () => _,
  k_EQueryFilesSpecialFilter_FavoritedByFriends: () => _,
  k_EQueryFilesSpecialFilter_None: () => _,
  k_EQueryFilesSpecialFilter_ParentCollections: () => _,
  k_EQueryFilesSpecialFilter_ParentItems: () => _,
  k_EQueryFilesSpecialFilter_Reported: () => _,
});
var _ = 0,
  _ = 1,
  _ = 2,
...
var _ = {};
_(_, {
  k_EQueryFilesSearchTextTarget_AllText: () => _,
  k_EQueryFilesSearchTextTarget_Description: () => _,
  k_EQueryFilesSearchTextTarget_Title: () => _,
});
var _ = 0,
  _ = 1,
  _ = 2;
var _ = {};
_(_, {
  k_EQueryFilesRequiredAppsPreset_ExcludeUnownedDLC: () => _,
  k_EQueryFilesRequiredAppsPreset_IncludeOwnedDLC: () => _,
  k_EQueryFilesRequiredAppsPreset_None: () => _,
});
var _ = 0,
  _ = 1,
  _ = 2;
