...
var _ = class {
  ...
  ChangeNavigationSource(_, _, _, _) {
    ...
    if (_ == _.MOUSE && _.eActivationSourceType == _.KEYBOARD_SIMULATOR)
      return !1;
...
var _ = _.lazy(() =>
  _(() => import(`./BfXsm1uT2.js`), __vite__mapDeps([0]), import.meta.url),
);
function _(_) {
  return _().metrics
    ? (0, _.jsx)(_.Suspense, {
...
var _ = `nlTg10o51PM-`,
  ...
  _ = `PjCIRmdNpcU-`,
  _ = {};
(_.arabic = () => _(() => import(`./BxMUZ0Cj.js`), [], import.meta.url)),
...
var _ = [
    ...
    {
      strKey: `F1`,
      button: _.STEAM_GUIDE,
    },
    {
      strKey: `F2`,
      button: _.STEAM_QUICK_MENU,
    },
    {
      strKey: `F3`,
      button: _.SECONDARY,
    ...
    {
      strKey: `F6`,
      button: _.BUMPER_LEFT,
    },
    {
      strKey: `F7`,
      button: _.BUMPER_RIGHT,
    },
    {
      strKey: `F6`,
      bShift: !0,
      button: _.TRIGGER_LEFT,
    },
    {
      strKey: `F7`,
      bShift: !0,
      button: _.TRIGGER_RIGHT,
    },
    {
      strKey: `F6`,
      bCtrl: !0,
      button: _.LSTICK_CLICK,
    },
    {
      strKey: `F7`,
      bCtrl: !0,
      button: _.RSTICK_CLICK,
    },
    {
      strKey: `F8`,
      button: _.SELECT,
...
`);
  ...
  TranslateKey(_) {
    let _ = this.GetKeycodeFromEvent(_);
    return _.altKey || this.BShouldSwallowEventForTextInputWorkaround(_)
      ? _.INVALID
      : (_.find(
          (_) =>
            _.strKey === _ &&
...
(_.arabic = () => _(() => import(`./TrJW4YjE.js`), [], import.meta.url)),
  ...
  (_.malay = () => _(() => import(`./CCPjqcEe2.js`), [], import.meta.url)),
