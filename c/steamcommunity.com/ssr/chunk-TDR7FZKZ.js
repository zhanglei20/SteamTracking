...
var _ = {};
_(_, {
  k_ELoyaltyRewardReactionType_Award: () => _,
  k_ELoyaltyRewardReactionType_Beautiful: () => _,
  k_ELoyaltyRewardReactionType_Clever: () => _,
  k_ELoyaltyRewardReactionType_Coffee: () => _,
  k_ELoyaltyRewardReactionType_DeepThoughts: () => _,
  k_ELoyaltyRewardReactionType_ExtraHelpful: () => _,
  k_ELoyaltyRewardReactionType_FancyPants: () => _,
  k_ELoyaltyRewardReactionType_Funny: () => _,
  k_ELoyaltyRewardReactionType_GoldenUnicorn: () => _,
  k_ELoyaltyRewardReactionType_GottaHaveIt: () => _,
  k_ELoyaltyRewardReactionType_Heartwarming: () => _,
  k_ELoyaltyRewardReactionType_Helpful: () => _,
  k_ELoyaltyRewardReactionType_Hilarious: () => _,
  k_ELoyaltyRewardReactionType_HotTake: () => _,
  k_ELoyaltyRewardReactionType_Invalid: () => _,
  k_ELoyaltyRewardReactionType_Jester: () => _,
  k_ELoyaltyRewardReactionType_LifeSaver: () => _,
  k_ELoyaltyRewardReactionType_MadScientist: () => _,
  k_ELoyaltyRewardReactionType_Michelangelo: () => _,
  k_ELoyaltyRewardReactionType_MindBlown: () => _,
  k_ELoyaltyRewardReactionType_OnFire: () => _,
  k_ELoyaltyRewardReactionType_OneHundred: () => _,
  k_ELoyaltyRewardReactionType_Perfect: () => _,
  k_ELoyaltyRewardReactionType_PlusOne: () => _,
  k_ELoyaltyRewardReactionType_Poetry: () => _,
  k_ELoyaltyRewardReactionType_PureGold: () => _,
  k_ELoyaltyRewardReactionType_Saucy: () => _,
  k_ELoyaltyRewardReactionType_SlowClap: () => _,
  k_ELoyaltyRewardReactionType_Smart: () => _,
  k_ELoyaltyRewardReactionType_SuperStar: () => _,
  k_ELoyaltyRewardReactionType_TakeMyPoints: () => _,
  k_ELoyaltyRewardReactionType_Treasure: () => _,
  k_ELoyaltyRewardReactionType_WarmBlanket: () => _,
  k_ELoyaltyRewardReactionType_Whoa: () => _,
  k_ELoyaltyRewardReactionType_Wholesome: () => _,
  k_ELoyaltyRewardReactionType_Wild: () => _,
});
var _ = 0,
  _ = 1,
  _ = 2,
...
var _ = {};
_(_, {
  k_ELoyaltyRewardReactionTargetType_Comment: () => _,
  k_ELoyaltyRewardReactionTargetType_ForumTopic: () => _,
  k_ELoyaltyRewardReactionTargetType_Invalid: () => _,
  k_ELoyaltyRewardReactionTargetType_Profile: () => _,
  k_ELoyaltyRewardReactionTargetType_UGC: () => _,
  k_ELoyaltyRewardReactionTargetType_UserReview: () => _,
});
var _ = 0,
  _ = 1,
  _ = 2,
  ...
  return (
    _.forEach(function (_) {
      if (
        ...
        switch (_) {
          case _.k_ELoyaltyRewardReactionTargetType_UserReview:
            _.push(_.reactionid);
            break;
          case _.k_ELoyaltyRewardReactionTargetType_UGC:
            _ !== void 0 &&
              _.valid_ugc_types?.includes(_) &&
              _.push(_.reactionid);
            break;
          case _.k_ELoyaltyRewardReactionTargetType_Profile:
            _.push(_.reactionid);
            break;
          case _.k_ELoyaltyRewardReactionTargetType_ForumTopic:
            _.push(_.reactionid);
            break;
          case _.k_ELoyaltyRewardReactionTargetType_Comment:
            _.push(_.reactionid);
            break;
        }
    }),
...
var _ = class extends _.Component {
  static defaultProps = {
    targetType: _.k_ELoyaltyRewardReactionTargetType_UserReview,
  };
  constructor(_) {
    super(_),
      ...
      (this.state = {
        bShowModal: !1,
        targetid: "",
        targetType: _.k_ELoyaltyRewardReactionTargetType_Invalid,
      });
  }
  render() {
    let {
    ...
    return _
      ? (0, _.jsx)(
          _,
          {
            targetid: _,
            active: _,
            targetType: _ ?? _.k_ELoyaltyRewardReactionTargetType_Invalid,
            ugcType: _,
            onDismiss: () =>
              this.setState({
                bShowModal: !1,
...
function _(_) {
  let {
    ...
    [_, _] = _.useState(_ || _.k_ELoyaltyRewardReactionType_Invalid),
    [_, _] = _.useState(0),
    [_, _] = _.useState(!1),
    [_, _] = _.useState(2),
    _ = _(),
  ...
  switch (_) {
    case 0:
      {
        let _ = _ === _.k_ELoyaltyRewardReactionType_Invalid || _.data?.has(_),
                    ...
                    _,
                    {
                      ...
                      onClick: () => {
                        _.data?.has(_) ||
                          _(
                            _ === _
                              ? _.k_ELoyaltyRewardReactionType_Invalid
                              : _,
                          );
                      },
                    },
...
function _(_) {
  let { details: _, className: _ } = _,
    ...
    _ = _.publishedfileid;
  return _(_, _, _.file_type, _).data
    ? (0, _.jsx)(_, {
...
function _(_) {
  let { details: _, onSubscribe: _, onClose: _ } = _,
    { rgChildIDs: _ } = _(_),
    _ = _.consumer_appid || _,
    _ = _(_, _, _.file_type, _.publishedfileid),
    { errorDialog: _, HandleMutationError: _ } = _(),
    _ = async () => {
      ...
      (0, _.jsx)(_, {
        ...
        children: (0, _.jsx)("div", {
          ...
          children: (0, _.jsxs)(_, {
            ...
            disabled: _,
            onClick: async () => {
              if (!_ && _.file_type == _ && _.num_children != 0) {
                _(!0);
                return;
              }
              _();
      ...
      _ &&
        ...
        (0, _.jsx)(_, {
          ...
          children: (0, _.jsxs)(_, {
            ...
            gap: "2",
            children: [
              _ == _.k_EContentReportReason_Invalid &&
                (0, _.jsxs)(_.Fragment, {
                  children: [
                    (0, _.jsx)(_, {
                      children: _.Localize(
                    ...
                    (0, _.jsx)(_, {
                      reasons: _,
                      onSelect: (_) => _(_ ?? _.k_EContentReportReason_Invalid),
                    }),
                  ],
                }),
              _ != _.k_EContentReportReason_Invalid &&
...
function _(_) {
  ...
  return (0, _.jsxs)(_, {
    ...
    children: [
      ...
      (0, _.jsx)(_, {
        targetType: _.k_ELoyaltyRewardReactionTargetType_UGC,
        bShowModal: _,
        targetid: _.publishedfileid,
        ugcType: _.file_type ?? _,
        onDismiss: _,
        onSuccess: () => {},
      }),
      _.map((_, _) =>
...
function _(_) {
  let { details: _, bEnlarged: _ } = _,
    ...
    _ = _(_.consumer_appid, _, _.file_type, _.publishedfileid),
...
function _(_) {
  let { details: _, className: _, enlargedImageWidth: _ } = _,
    ...
    _ = (0, _.useMemo)(() => {
      ...
      return (
        ...
        (_ =
          _.filter((_) => _.preview_type == _ || _.preview_type == _).sort(
            (_, _) => {
              if (_.preview_type != _.preview_type) {
                if (_.preview_type == _) return -1;
                if (_.preview_type == _) return 1;
              }
    ...
    _ = _.findIndex((_) => _.preview_type == _),
  ...
  (0, _.useEffect)(() => {
    ...
    let _ = setInterval(() => {
      ...
      for (_ = _[_]; _.preview_type != _ && _ != _; )
...
function _(_) {
  let { details: _ } = _,
    _ = _(_.publishedfileid),
    _ = (0, _.useMemo)(
      () => _.data?.filter((_) => _.relationship == _) ?? [],
      [_.data],
    );
  return _.length == 0
    ? null
...
function _(_) {
  ...
  let _ = [
      _.k_EQueryFilesSearchTextTarget_AllText,
      _.k_EQueryFilesSearchTextTarget_Title,
      _.k_EQueryFilesSearchTextTarget_Description,
    ],
    _ = (_) => {
      _(_),
        _({
      ...
      let _ = (_) => {
        ...
        switch (
          (_.childpublishedfileid
            ? ((_.page = 1),
              (_.special_filter = _.k_EQueryFilesSpecialFilter_None),
            ...
            : _.section
              ...
              : (_.search_text && _.search_text != _.search_text) ||
                  ...
                  _.browse_sort
                ? (_.page = 1)
                : _.special_filter == _.k_EQueryFilesSpecialFilter_Reported &&
                  (_.browse_sort = "reported"),
          ...
          case "textsearch":
            break;
          case "accepted":
            _.special_filter != _.k_EQueryFilesSpecialFilter_AcceptedForUse &&
              (_.browse_sort = "mostrecent");
            break;
          case "num_parent_items":
            _.special_filter != _.k_EQueryFilesSpecialFilter_ParentItems &&
              (_.browse_sort = "mostrecent");
            break;
          case "num_parent_collections":
            _.special_filter !=
              _.k_EQueryFilesSpecialFilter_ParentCollections &&
              (_.browse_sort = "mostrecent");
            break;
          case "reported":
            _.special_filter != _.k_EQueryFilesSpecialFilter_Reported &&
  ...
  return (
    (0, _.useLayoutEffect)(() => {
      _.current == null ||
        ...
        _.current.BFocusWithin() ||
        _.current.Node().BFocusFirstChild(2);
    }, [_]),
    (0, _.jsxs)(_, {
...
function _(_) {
  ...
  switch (_) {
    case _.k_EQueryFilesSearchTextTarget_Title:
      _ = "#Workshop_SearchResults_SearchText_TitleOnly";
      break;
    case _.k_EQueryFilesSearchTextTarget_Description:
  ...
  let { preset: _ } = _,
    ...
    _ = (0, _.useMemo)(() => {
      let _ = _.filter(({ appid: _ }) => _ && _.has(_)).map(
        ...
        _ = "";
      switch (_) {
        case _.k_EQueryFilesRequiredAppsPreset_IncludeOwnedDLC:
          (_ = _.slice(0, _)),
            (_ = _.length),
            (_ = _.Localize("#Workshop_OwnedDLC_None_Filter"));
          break;
        case _.k_EQueryFilesRequiredAppsPreset_ExcludeUnownedDLC:
          (_ = _.slice(0, _)),
            (_ = _.length),
    ...
    _ = _ == _.k_EQueryFilesRequiredAppsPreset_IncludeOwnedDLC,
    _ = _.Localize(
      _
...
function _(_) {
  let { rgRequiredAppIDs: _, rgExcludedRequiredAppIDs: _ } = _,
    ...
    _ = _.filter((_) => _.includes(_.appid) || _.includes(_.appid));
  return (0, _.jsx)(_.Fragment, {
    children: _.map((_) =>
      (0, _.jsx)(
        _,
...
function _(_) {
  ...
  return (0, _.jsx)(
    _,
    {
      onClick: () => {
        _({
          special_filter: _.k_EQueryFilesSpecialFilter_None,
          required_flags: [],
          omitted_flags: [],
          required_tags: [],
          excluded_tags: [],
...
function _(_) {
  let { browseQuery: _ } = _,
    ...
    _ = (_) => {
      let _;
      switch (_) {
        case _.k_EQueryFilesSpecialFilter_AcceptedForUse:
          _ = "accepted";
          break;
        case _.k_EQueryFilesSpecialFilter_ParentItems:
          _ = "num_parent_items";
          break;
        case _.k_EQueryFilesSpecialFilter_ParentCollections:
          _ = "num_parent_collections";
          break;
        case _.k_EQueryFilesSpecialFilter_Reported:
          _ = "reported";
          break;
      }
      _({
...
function _(_) {
  let { browseQuery: _ } = _,
    ...
    _ = () => {
      _({
        required_apps_preset: _.k_EQueryFilesRequiredAppsPreset_IncludeOwnedDLC,
    ...
    _ = () => {
      _({
        required_apps_preset:
          _.k_EQueryFilesRequiredAppsPreset_ExcludeUnownedDLC,
        appids_required_for_use: void 0,
        excluded_appids_required_for_use: void 0,
      });
    };
