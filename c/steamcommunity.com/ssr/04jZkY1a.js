...
(_.arabic = () => _(() => import(`./BkOSMHNK.js`), [], import.meta.url)),
  (_.brazilian = () => _(() => import(`./DErt1R-6.js`), [], import.meta.url)),
  (_.bulgarian = () => _(() => import(`./B0RiKcPc.js`), [], import.meta.url)),
  (_.czech = () => _(() => import(`./QsY1Ldgj.js`), [], import.meta.url)),
  (_.danish = () => _(() => import(`./SX2x6UGg.js`), [], import.meta.url)),
  (_.dutch = () => _(() => import(`./BiJkwt1-.js`), [], import.meta.url)),
  (_.english = () => _(() => import(`./BLrHyOvF.js`), [], import.meta.url)),
  (_.finnish = () => _(() => import(`./Bj1xWXmX.js`), [], import.meta.url)),
  (_.french = () => _(() => import(`./DlQWfhjp.js`), [], import.meta.url)),
  (_.german = () => _(() => import(`./CROzQkpx.js`), [], import.meta.url)),
  (_.greek = () => _(() => import(`./BsnzvPi2.js`), [], import.meta.url)),
  (_.hungarian = () => _(() => import(`./BZJZYmV7.js`), [], import.meta.url)),
  (_.indonesian = () => _(() => import(`./oJX_uHm6.js`), [], import.meta.url)),
  (_.italian = () => _(() => import(`./ByRUSH7Q.js`), [], import.meta.url)),
  (_.japanese = () => _(() => import(`./DarjycNt.js`), [], import.meta.url)),
  (_.koreana = () => _(() => import(`./DYqa-nkE2.js`), [], import.meta.url)),
  (_.latam = () => _(() => import(`./BegbsaPT2.js`), [], import.meta.url)),
  (_.malay = () => _(() => import(`./sQ7mKLDF2.js`), [], import.meta.url)),
  (_.norwegian = () => _(() => import(`./VNO7EM9h2.js`), [], import.meta.url)),
  (_.polish = () => _(() => import(`./CnVCP10w2.js`), [], import.meta.url)),
  (_.portuguese = () => _(() => import(`./gxmn_4rt2.js`), [], import.meta.url)),
  (_.romanian = () => _(() => import(`./H09RtEhE2.js`), [], import.meta.url)),
  (_.russian = () => _(() => import(`./DtiY3QUX2.js`), [], import.meta.url)),
  (_.sc_schinese = () =>
    _(() => import(`./m_dVskLd2.js`), [], import.meta.url)),
  (_.schinese = () => _(() => import(`./UKg3F--M2.js`), [], import.meta.url)),
  (_.spanish = () => _(() => import(`./CGfLAhfT2.js`), [], import.meta.url)),
  (_.swedish = () => _(() => import(`./K39nAcel2.js`), [], import.meta.url)),
  (_.tchinese = () => _(() => import(`./BcWx45WH2.js`), [], import.meta.url)),
  (_.thai = () => _(() => import(`./GEZ4oM6k2.js`), [], import.meta.url)),
  (_.turkish = () => _(() => import(`./CeHFacBk2.js`), [], import.meta.url)),
  (_.ukrainian = () => _(() => import(`./9ixgYcWf2.js`), [], import.meta.url)),
  (_.vietnamese = () => _(() => import(`./BdIkIs5-2.js`), [], import.meta.url));
async function _(_) {
  if (_[_]) return await _[_]();
}
var _ = _(_),
  _ = {};
(_.arabic = () => _(() => import(`./BTb_uZyA2.js`), [], import.meta.url)),
  (_.brazilian = () => _(() => import(`./QREVJR_A2.js`), [], import.meta.url)),
  (_.bulgarian = () => _(() => import(`./BxSlJj5P2.js`), [], import.meta.url)),
  (_.czech = () => _(() => import(`./D1dEV2Ii2.js`), [], import.meta.url)),
  (_.danish = () => _(() => import(`./CcgJT0kz2.js`), [], import.meta.url)),
  (_.dutch = () => _(() => import(`./vfrptCGf2.js`), [], import.meta.url)),
  (_.english = () => _(() => import(`./CJ1mZgFb2.js`), [], import.meta.url)),
  (_.finnish = () => _(() => import(`./Dcu70pDy2.js`), [], import.meta.url)),
  (_.french = () => _(() => import(`./i6RCyW-A2.js`), [], import.meta.url)),
  (_.german = () => _(() => import(`./BurJS0bm.js`), [], import.meta.url)),
  (_.greek = () => _(() => import(`./BSmqvquA.js`), [], import.meta.url)),
  (_.hungarian = () => _(() => import(`./BPEcRRjs.js`), [], import.meta.url)),
  (_.indonesian = () => _(() => import(`./Dj_S4Oi3.js`), [], import.meta.url)),
  (_.italian = () => _(() => import(`./DzA3yab0.js`), [], import.meta.url)),
  (_.japanese = () => _(() => import(`./CriA2zms.js`), [], import.meta.url)),
  (_.koreana = () => _(() => import(`./CHZBSah8.js`), [], import.meta.url)),
  (_.latam = () => _(() => import(`./BfCbHJsu.js`), [], import.meta.url)),
  (_.malay = () => _(() => import(`./yi09X7Te.js`), [], import.meta.url)),
  (_.norwegian = () => _(() => import(`./Csx9IlN8.js`), [], import.meta.url)),
  (_.polish = () => _(() => import(`./ChFtTBeD.js`), [], import.meta.url)),
  (_.portuguese = () => _(() => import(`./3hRzeFAi.js`), [], import.meta.url)),
  (_.romanian = () => _(() => import(`./B08lLw6L.js`), [], import.meta.url)),
  (_.russian = () => _(() => import(`./TYtu8cix.js`), [], import.meta.url)),
  (_.sc_schinese = () => _(() => import(`./7W1Ba1D7.js`), [], import.meta.url)),
  (_.schinese = () => _(() => import(`./CxGyXWEK.js`), [], import.meta.url)),
  (_.spanish = () => _(() => import(`./C8T0UdP9.js`), [], import.meta.url)),
  (_.swedish = () => _(() => import(`./C35K2uwr.js`), [], import.meta.url)),
  (_.tchinese = () => _(() => import(`./BRYoFDL0.js`), [], import.meta.url)),
  (_.thai = () => _(() => import(`./DZD6_dJf.js`), [], import.meta.url)),
  (_.turkish = () => _(() => import(`./Cjqxns7G.js`), [], import.meta.url)),
  (_.ukrainian = () => _(() => import(`./MNlfDPOP.js`), [], import.meta.url)),
  (_.vietnamese = () => _(() => import(`./BW7tfLPK.js`), [], import.meta.url));
async function _(_) {
  if (_[_]) return await _[_]();
}
var _ = _(_),
...
function _(_) {
  ...
  switch (_._) {
    ...
    case 13:
      return _.Localize(`#moderation_sanction_markedincompatible`);
    case 4:
      return _
