...
function _(_) {
  return _.file_type != _ || (_.num_children ?? 0) == 0
    ? !1
    : ((_?.flags ?? 0) & 16) == 16;
}
function _(_) {
...
function _(_, _) {
  let _ = [_.k_EQueryFilesSpecialFilter_None];
  switch (
    (_.logged_in &&
      (_ = [
        ..._,
        _.k_EQueryFilesSpecialFilter_CreateByFriends,
        _.k_EQueryFilesSpecialFilter_CreatedByFollowed,
        _.k_EQueryFilesSpecialFilter_FavoritedByFriends,
      ]),
    _)
  ) {
    case "mtxitems":
      _ = [
        ..._,
        _.k_EQueryFilesSpecialFilter_AcceptedForUse,
        _.k_EQueryFilesSpecialFilter_ParentCollections,
      ];
      break;
    case "merchandise":
    case "collections":
      _ = [..._, _.k_EQueryFilesSpecialFilter_AcceptedForUse];
      break;
    case "readytouseitems":
      _ = [
        ..._,
        _.k_EQueryFilesSpecialFilter_ParentItems,
        _.k_EQueryFilesSpecialFilter_ParentCollections,
      ];
      break;
  }
  return _ && (_ = [..._, _.k_EQueryFilesSpecialFilter_Reported]), _;
}
function _(_) {
...
function _(_, _, _, _, _) {
  return {
    queryKey: _(_, _, _, _),
    queryFn: async () =>
      !_.logged_in || _ == _ ? !1 : (await _.load(_))?.inlist || !1,
    staleTime: 3600 * 1e3,
  };
}
function _(_, _, _, _, _) {
...
function _(_) {
  let { tab: _, appid: _, bActive: _ } = _,
    ...
    _ = _.Localize(_[_]);
  return (0, _.jsx)("div", {
    className: (0, _.default)(_.Tab, _ && _.Active),
    children: (0, _.jsx)(_, {
      size: "4",
      href: _,
      children: _,
...
var _ = "./workshop_ui_malay-XXXXXXXX.json";
...
function _(_, _ = {}) {
  ...
  switch (_) {
    ...
    case "editcollection":
      ...
      break;
    case "createmerch":
      _ = `${_.COMMUNITY_BASE_URL}workshop/edititem/${_.appid}/${_}/`;
      break;
    case "votingqueue":
      _ = `${_.COMMUNITY_BASE_URL}sharedfiles/votingqueue/?appid=${_.appid}&matchingFileType=${_}`;
      break;
    case "approvalqueue":
