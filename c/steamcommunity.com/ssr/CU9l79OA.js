...
function _(_) {
  let { details: _, size: _, bVotingQueue: _ } = _,
    _ = _(_.publishedfileid),
    _ = _(_.publishedfileid),
    _ = _(_.publishedfileid),
    _ = !!_.data?.vote_for,
    ...
    _ = _ || _ || _,
    { errorDialog: _, HandleMutationError: _ } = _(),
    { refreshVotingQueueDialog: _, fnVotingQueueNext: _ } = _(
      _.consumer_appid,
      _.file_type,
    ),
    _ = async () => {
  ...
  return (0, _.jsxs)(_.Fragment, {
    children: [
      (0, _.jsx)(`div`, {
        className: (0, _.default)(_, _ && `Znsa0JpgewY-`, _ && `fD3zAAqavK0-`),
        children: (0, _.jsxs)(_, {
          ...
          icon: !0,
          color: _,
          variant: !_ || _ ? `basic` : `inverted`,
          children: [
            (0, _.jsx)(_, {}),
            _ && _.LocalizeReact(`#SharedFiles_Queue_VoteUp`),
          ],
        }),
      }),
      (0, _.jsx)(`div`, {
      ...
      _ &&
        ...
        !_ &&
        (0, _.jsx)(`div`, {
          className: (0, _.default)(`jgM07f7W9ss-`, _ && `Znsa0JpgewY-`),
          children: (0, _.jsx)(_, {
            disabled: !_.logged_in,
            onClick: _,
            size: _,
      ...
      _ &&
        (0, _.jsx)(`div`, {
          className: (0, _.default)(`qWWrgQnkqWo-`, _ && `Znsa0JpgewY-`),
          children: (0, _.jsxs)(_, {
            disabled: !_.logged_in,
            onClick: _,
            size: _,
            ...
            color: _,
            children: [
              _.LocalizeReact(`#SharedFiles_Queue_Next`, (0, _.jsx)(`br`, {})),
              (0, _.jsx)(_, {}),
            ],
          }),
        }),
