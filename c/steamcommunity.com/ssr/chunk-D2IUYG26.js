...
var _ = {
  ...
  "ItemFocusAnim-darkGreySettings": "Z7cETAwROrs-",
...
var _ = {
  ...
  "ItemFocusAnim-darkGreySettings": "XlvNyFynnIA-",
...
var _ = {
  ...
  "ItemFocusAnim-darkGreySettings": "F4oP2n5q9sc-",
...
function _(_, _) {
  let { page: _, bManuallyFocusPageContent: _, showTitle: _ = !1 } = _,
    _ = _.useRef(null),
    _ = _(),
    _ = _.useRef(!0);
  _.useEffect(() => {
    !_.state?.bDirectNav && (!_.current || !_) && _.current?.TakeFocus(),
      (_.current = !1);
  }, [_, _, _.state]);
  let _ = (_, _, _) =>
    (0, _.jsx)(_, {
...
var _ = {
  ...
  "ItemFocusAnim-darkGreySettings": "A1I0HQt-rVA-",
...
var _ = {
  ...
  CompoundSliderContainer: "MkNoWNrzzTY-",
  ...
  "ItemFocusAnim-darkGreySettings": "HF7gdCIQfwc-",
...
function _(_) {
  let {
    ...
    [_, _] = _.useState(!1),
    _ = () => {
      _.onChangeStart && _.onChangeStart(_), _(!0);
    },
    _ = (_) => {
      _(_) &&
        (_.onChange && _.onChange(_, _),
        _.onChangeComplete && _.onChangeComplete(_, _)),
        _(!1);
    };
  _.useEffect(() => {
...
function _(_) {
  ...
  let _ = _ || (_ && !_ && _.length > 0 && _ != "-"),
    _ = _(_.DescriptionValue, _ && _.RedBorder),
    [_, _] = _.useState(0),
    [_, _] = _.useState(0),
    _ = _.useRef(void 0),
    _ = _.useCallback(() => {
  ...
  let [_, _] = _.useState(!1),
    ...
    _ = _.useCallback(() => {
      window.clearTimeout(_.current),
        (_.current = window.setTimeout(() => {
          _.current?.classList.remove(_.ErrorShake),
            _.current?.getBoundingClientRect(),
            _.current?.classList.add(_.ErrorShake);
        }, 0)),
        _(!0),
        window.clearTimeout(_.current),
