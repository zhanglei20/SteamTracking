...
function _(_) {
  ...
  let _ = _(_.reported_content_id, _.Actions.GetFriendChatReportMetadata),
...
function _(_) {
  let { subject: _, bbCodeParser: _ } = _,
    _ = _(_.reported_content_id, _.Actions.GetChatGroupReportMetadata),
    _ = _(_.coordinates?.chat_group_id ?? ``),
    _ = _(_, _),
    _ = _.reports?.length ? _.reports[0] : void 0,
...
var _ = `boFn38nWkPs-`,
  ...
  _ = `nQe-Q0MAJqE-`,
  _ = `-gDeIhGX0GM-`,
  _ = (_) => [`get_published_file_details`, _],
...
function _(_) {
  let { group: _, coordinates: _, subjects: _ } = _,
    ...
    _ = _.forum ?? ``,
    _ = _(_, _, _.topic);
  if (!_.isSuccess || !_ || !_) return null;
  ...
  return (0, _.jsx)(_, {
    ...
    broken: _,
    summary: _,
    href: `${_.COMMUNITY_BASE_URL}actions/redirecttoforumtopic/?accountIDOwner=${_}&gidForum=${_}&gidTopic=${_.topic}`,
  });
}
function _(_) {
