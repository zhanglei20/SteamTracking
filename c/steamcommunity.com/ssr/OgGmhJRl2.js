...
var _ = {};
(_.arabic = () => _(() => import(`./rN5CFTd92.js`), [], import.meta.url)),
  (_.brazilian = () => _(() => import(`./BnIw7EYQ2.js`), [], import.meta.url)),
  (_.bulgarian = () => _(() => import(`./BLnjZWm22.js`), [], import.meta.url)),
  (_.czech = () => _(() => import(`./CnUgLyxJ2.js`), [], import.meta.url)),
  (_.danish = () => _(() => import(`./BjYYy76J2.js`), [], import.meta.url)),
  (_.dutch = () => _(() => import(`./BFCibLhZ2.js`), [], import.meta.url)),
  (_.english = () => _(() => import(`./llq_5aOJ2.js`), [], import.meta.url)),
  (_.finnish = () => _(() => import(`./rRkzNERb2.js`), [], import.meta.url)),
  (_.french = () => _(() => import(`./B6mp-Sbp2.js`), [], import.meta.url)),
  ...
  (_.malay = () => _(() => import(`./DApHeSfP.js`), [], import.meta.url)),
  ...
  (_.turkish = () => _(() => import(`./q89L-1eW.js`), [], import.meta.url)),
  (_.ukrainian = () => _(() => import(`./CmpCYDaI.js`), [], import.meta.url)),
  (_.vietnamese = () => _(() => import(`./VZreZ3i7.js`), [], import.meta.url));
async function _(_) {
...
function _(_) {
  let { bAllowAnimatedIcon: _ = !0, size: _ = `row` } = _,
    _ = _(),
    _ = _ == `fit`,
    _ =
      `${_.COMMUNITY_CDN_URL}economy/image/${_.icon_url_large || _.icon_url}/${_[_]}` +
      (_ ? `?allow_animated=1` : ``);
  return (0, _.jsxs)(_, {
    height: _ ? `100%` : `196px`,
    width: _ ? `100%` : void 0,
