...
var _ = {
  attributeDefinitions: [
    ...
    },
    {
      ...
      type: "select",
      label: "Collection",
      options: ["Boring Collection", "Cool Collection", "Cooler Collection"],
    },
  ],
  hierarchy: {
    _: "type",
    ...
    options: [
      ...
      },
      {
        ...
        options: [
          {
            _: "gloves_bloodhound",
            label: "Bloodhound Gloves",
            inheritAttributes: !0,
          },
          {
            _: "gloves_brokenfang",
            label: "Broken Fang Gloves",
            inheritAttributes: !0,
          },
          {
            _: "gloves_driver",
...
function _(_) {
  ...
  try {
    ...
    return {
      bSuccess: !1,
      strError: "Invalid JSON syntax",
    };
  }
  if (((_ = _(_, ["attributeDefinitions", "hierarchy"])), typeof _ == "string"))
    return {
      bSuccess: !1,
      strError: "Invalid schema root. " + _,
    };
  if (!Array.isArray(_.attributeDefinitions))
    return {
      bSuccess: !1,
      strError: 'Invalid "attributeDefinitions" property',
    };
  for (let _ of _.attributeDefinitions) {
    let _ = _(_, ["id", "type", "label"]);
    if (typeof _ == "string") {
      let _ = _ && typeof _ == "object" && typeof _._ == "string" ? _._ : null;
      return {
        bSuccess: !1,
        strError: _
          ? `Invalid attribute definition "${_}": ${_}`
          : `Invalid attribute definition: ${_}`,
      };
    }
    if (typeof _._ != "string")
      return {
        bSuccess: !1,
        strError: "Invalid attribute definition: Non-string ID found.",
      };
    _.attributeDefinitions[_._] = _;
  }
  let _ = _(_.hierarchy, "root");
...
function _(_, _) {
  let _ = _(_, ["id", "label"]);
  if (typeof _ == "string") return `In hierarchy "${_}": ${_}`;
  if (((_ = _ + " | " + _._), "options" in _)) {
    if (!Array.isArray(_.options))
      return `Expected "options" in node "${_._}" to be an array`;
...
function _(_, _) {
  if (!_ || typeof _ != "object") return "Not a valid object";
  for (let _ of Object.keys(_)) if (!(_ in _)) return `Missing property "${_}"`;
  return _;
}
var _ = _(_(), 1),
  _ = _(JSON.stringify(_));
if (!_.bSuccess)
  throw new Error(`Hardcoded CS Schema is invalid: ${_.strError}`);
var _ = _.schema;
function _(_) {
...
function _(_) {
  let { onChange: _ } = _,
    [_, _] = (0, _.useState)(JSON.stringify(_, null, "	")),
    [_, _] = (0, _.useState)("");
  return (0, _.jsxs)("div", {
    children: [
      (0, _.jsx)("textarea", {
        ...
        children: [
          (0, _.jsx)("button", {
            onClick: () => {
              if (!_) return;
              let _ = _(_);
              _.bSuccess ? (_(_.schema), _("")) : _(_.strError);
            },
            children: "Update",
          }),
          (0, _.jsx)("button", {
...
function _(_) {
  let { schema: _ } = _,
    ...
    { rgHierarchy: _, rgAttributes: _ } = _(_, _, _),
    _ = _.map(({ item: _, selected: _ }, _) =>
      (0, _.jsx)(
        _,
        {
          onSelect: (_) =>
            _({
              ..._,
              hierarchy: _.hierarchy.slice(0, _).concat(_),
            }),
          level: _,
          selectedValue: _,
        },
  ...
  return (0, _.jsxs)("div", {
    children: [
      _,
      _.map((_) => {
        let _ = _.attributeDefinitions[_];
        return _
          ? (0, _.jsx)(
              _,
              {
                definition: _,
                value: _.attributes[_],
                onChange: (_) =>
                  _({
                    ..._,
                    attributes: {
...
function _(_, _, _) {
  let _ = [],
    _ = [],
    _ = _.hierarchy;
  for (let _ = 0; _ < _.hierarchy.length + 1; _++) {
    let _ = _.hierarchy[_];
    !_ ||
      !_.options ||
      (_.push({
      ...
      (_ = _.options.find(({ _: _ }) => _ === _)));
  }
  for (let _ = _.length - 1; _ >= 0; _--) {
    let _ = _[_].item;
    if ((_.attributes && _.unshift(..._.attributes), !_.inheritAttributes))
      break;
  }
  return {
    rgHierarchy: _,
...
function _(_) {
  let { selectedValue: _, level: _, onSelect: _ } = _;
  return _.options
    ? (0, _.jsx)("div", {
        style: {
          display: "flex",
        ...
        children: _.options.map((_) =>
          (0, _.jsx)(
            ...
            {
              style: {
                backgroundColor: _._ === _ ? "red" : void 0,
              },
              onClick: () => _(_._),
              children: _.label,
            },
    ...
    : (console.error(
        "Cannot render hierarchy selector for a leaf node in the hierarchy",
      ),
      null);
}
function _(_) {
  switch (_.definition.type) {
    ...
    default: {
      let _ = _.definition;
      return console.error(`Unhandled attribute type! ${_}`), null;
    }
  }
}
function _(_) {
  let {
    definition: { min: _, max: _, buckets: _, label: _, _: _ },
    value: _,
    onChange: _,
  } = _;
  return (0, _.jsxs)("div", {
    children: [
      ...
      (0, _.jsx)("input", {
        ...
        step: 0.01,
        value: _,
        onChange: (_) => _(_.target.valueAsNumber),
      }),
    ],
  });
}
function _(_) {
  ...
  return _ === "radio"
    ...
    : (_ !== "dropdown" &&
        console.error(`Unknown display type "${_}" for "select" attribute`),
      (0, _.jsx)(_, {
        ..._,
      }));
}
function _(_) {
  let {
    definition: { options: _ },
    value: _,
    onChange: _,
  } = _;
  return (0, _.jsx)("fieldset", {
    children: _.map((_) =>
      (0, _.jsxs)(
        "div",
        {
...
function _(_) {
  ...
  return (0, _.jsx)("div", {
    children: (0, _.jsx)("select", {
      onChange: (_) => _(_[_.target.selectedIndex]),
      value: _,
      children: _.map((_) =>
        (0, _.jsx)(
          "option",
...
function _(_) {
  let {
    definition: { display: _ = "check" },
  } = _;
  return (
    _ !== "check" && console.error(`Unknown display type "${_}"`),
    (0, _.jsx)(_, {
      ..._,
    })
  );
...
var _ = {};
_(_, {
  k_EMarketSearchSortColumn_Default: () => _,
  k_EMarketSearchSortColumn_Name: () => _,
  k_EMarketSearchSortColumn_Popular: () => _,
  k_EMarketSearchSortColumn_Price: () => _,
  k_EMarketSearchSortColumn_Quantity: () => _,
});
var _ = 0,
  _ = 1,
  _ = 2,
...
var _ = {};
_(_, {
  k_EMarketSearchSortDirection_Ascending: () => _,
  k_EMarketSearchSortDirection_Descending: () => _,
  k_EMarketSearchSortDirection_Invalid: () => _,
});
var _ = 0,
  _ = 1,
  _ = 2;
...
var _ = {};
_(_, {
  k_EMarketListingSortField_AssetProperty: () => _,
  k_EMarketListingSortField_Price: () => _,
});
var _ = 0,
  _ = 1;
var _ = {};
_(_, {
  k_EMarketListingSortDirection_Ascending: () => _,
  k_EMarketListingSortDirection_Descending: () => _,
});
var _ = 0,
  _ = 1;
...
((_) => {
  function _(_, _) {
    return _.SendMsg("EconMarket.IsMarketplaceAllowed#1", _(_, _), _, {
      ePrivilege: 1,
    });
  }
...
var _ = "./market_ui_arabic-XXXXXXXX.json";
var _ = "./market_ui_brazilian-XXXXXXXX.json";
var _ = "./market_ui_bulgarian-XXXXXXXX.json";
var _ = "./market_ui_czech-XXXXXXXX.json";
var _ = "./market_ui_danish-XXXXXXXX.json";
var _ = "./market_ui_dutch-XXXXXXXX.json";
var _ = "./market_ui_english-XXXXXXXX.json";
var _ = "./market_ui_finnish-XXXXXXXX.json";
var _ = "./market_ui_french-XXXXXXXX.json";
var _ = "./market_ui_german-XXXXXXXX.json";
var _ = "./market_ui_greek-XXXXXXXX.json";
var _ = "./market_ui_hungarian-XXXXXXXX.json";
var _ = "./market_ui_indonesian-XXXXXXXX.json";
var _ = "./market_ui_italian-XXXXXXXX.json";
var _ = "./market_ui_japanese-XXXXXXXX.json";
var _ = "./market_ui_koreana-XXXXXXXX.json";
var _ = "./market_ui_latam-XXXXXXXX.json";
var _ = "./market_ui_malay-XXXXXXXX.json";
var _ = "./market_ui_norwegian-XXXXXXXX.json";
var _ = "./market_ui_polish-XXXXXXXX.json";
var _ = "./market_ui_portuguese-XXXXXXXX.json";
var _ = "./market_ui_romanian-XXXXXXXX.json";
var _ = "./market_ui_russian-XXXXXXXX.json";
var _ = "./market_ui_sc_schinese-XXXXXXXX.json";
var _ = "./market_ui_schinese-XXXXXXXX.json";
var _ = "./market_ui_spanish-XXXXXXXX.json";
var _ = "./market_ui_swedish-XXXXXXXX.json";
var _ = "./market_ui_tchinese-XXXXXXXX.json";
var _ = "./market_ui_thai-XXXXXXXX.json";
var _ = "./market_ui_turkish-XXXXXXXX.json";
var _ = "./market_ui_ukrainian-XXXXXXXX.json";
var _ = "./market_ui_vietnamese-XXXXXXXX.json";
var _ = {};
_.arabic = _;
_.brazilian = _;
_.bulgarian = _;
...
function _(_, _, _, _, _) {
  ...
  return (_ && _ === 0) ||
    (_ && _.total === _ && Object.keys(_.counts[_.name]).length === 1)
    ? null
    : {
...
function _(_) {
  let { price: _, onPriceChange: _, onPriceSettled: _ } = _,
    ...
    _ = (_) => (_) => {
      let _ = [..._];
      (_[_] = _.Clamp(_, _[0], _[1])), _(_), _ && _(_), _(!0);
    },
    _ = (_) => {
      _(!0);
      let [_, _] = _,
...
var _ = _(_(), 1);
function _(_) {
  return _.EUNIVERSE === _ ? _ === 710 : _ === 730;
}
var _ = [
    "weapon_knife_push",
...
function _(_) {
  let { facets: _, minWidth: _, mini: _, ..._ } = _,
...
async function _(_) {
  let _ = await fetch(`${_.COMMUNITY_BASE_URL}market/appfilters/${_}`);
  if (!_ || !_._) throw new Error(`Failed to load market filters for app ${_}`);
  let _ = await _.json();
...
function _(_ = !0) {
  ...
  return _({
    ...
    queryFn: async () => {
      ...
      if (!_ || !_._) throw new Error("Failed to load suggseted market apps");
      return await _.json();
    },
    retry: !1,
    enabled: _,
...
var _ = "./economy_arabic-XXXXXXXX.json";
var _ = "./economy_brazilian-XXXXXXXX.json";
var _ = "./economy_bulgarian-XXXXXXXX.json";
var _ = "./economy_czech-XXXXXXXX.json";
var _ = "./economy_danish-XXXXXXXX.json";
var _ = "./economy_dutch-XXXXXXXX.json";
var _ = "./economy_english-XXXXXXXX.json";
var _ = "./economy_finnish-XXXXXXXX.json";
var _ = "./economy_french-XXXXXXXX.json";
var _ = "./economy_german-XXXXXXXX.json";
var _ = "./economy_greek-XXXXXXXX.json";
var _ = "./economy_hungarian-XXXXXXXX.json";
var _ = "./economy_indonesian-XXXXXXXX.json";
var _ = "./economy_italian-XXXXXXXX.json";
var _ = "./economy_japanese-XXXXXXXX.json";
var _ = "./economy_koreana-XXXXXXXX.json";
var _ = "./economy_latam-XXXXXXXX.json";
var _ = "./economy_malay-XXXXXXXX.json";
var _ = "./economy_norwegian-XXXXXXXX.json";
var _ = "./economy_polish-XXXXXXXX.json";
var _ = "./economy_portuguese-XXXXXXXX.json";
var _ = "./economy_romanian-XXXXXXXX.json";
var _ = "./economy_russian-XXXXXXXX.json";
var _ = "./economy_sc_schinese-XXXXXXXX.json";
var _ = "./economy_schinese-XXXXXXXX.json";
var _ = "./economy_spanish-XXXXXXXX.json";
var _ = "./economy_swedish-XXXXXXXX.json";
var _ = "./economy_tchinese-XXXXXXXX.json";
var _ = "./economy_thai-XXXXXXXX.json";
var _ = "./economy_turkish-XXXXXXXX.json";
var _ = "./economy_ukrainian-XXXXXXXX.json";
var _ = "./economy_vietnamese-XXXXXXXX.json";
var _ = {};
_.arabic = _;
_.brazilian = _;
_.bulgarian = _;
...
function _(_) {
  ...
  if (_.float_value !== void 0) {
    ...
    return _.int_value !== void 0
      ? Number(_.int_value).toLocaleString(_())
      : _.string_value !== void 0
        ? _.string_value
        : null;
}
var _ = _(_(), 1);
function _(_) {
  let { description: _, type: _ = "descriptions", ..._ } = _,
    _ = _[_];
  return (0, _.jsx)(_, {
    direction: "column",
    children: _?.map((_, _) =>
...
function _(_, _) {
  ...
  return (_ && _ > 1 ? `${_(_)} ` : "") + _.name;
}
function _(_) {
  let { description: _, asset: _, style: _ = {}, ..._ } = _;
  return (0, _.jsx)(_, {
    contrast: "note",
    ..._,
    style: {
  ...
  return !_ && !_?.lowest_price && !_?.volume
    ...
    : (0, _.jsxs)(_, {
        ...
        children: [
          ...
          (0, _.jsx)(_, {
            _: "div",
            children: _?.volume ? _("#SellOnMarket_Volume", _.volume) : " ",
          }),
        ],
      });
}
...
function _(_) {
  ...
  return {
    gameURL:
      _ ??
      (_?.visible && _?.type !== _.k_EStoreAppType_Advertising ? _ : void 0),
    iconURL: _,
    strName: _?.name,
  };
}
        ...
        children: (0, _.jsx)(_, {
          ...
          children:
            _.marketable && _.market_hash_name
              ? (0, _.jsx)(_, {
                  description: _,
                  href: _.Item(_, _.market_hash_name),
                })
              : (0, _.jsx)(_, {
                  description: _,
                }),
...
function _(_) {
  let {
    ...
    _ = _ || _,
    _ = !_("sm");
  _ === _.k_EMarketBucketLevel_BucketGroup && _ && (_ = _);
  let _ = _(_);
  return (0, _.jsxs)(_, {
    ..._,
    children: [
...
function _(_) {
  return _.length < 2 ? 1 / 0 : Math.abs(_[0].price - _[_.length - 1].price);
}
function _(_) {
  let { currency: _ } = _;
  return (0, _.jsx)(_, {
    children: (_) => {
      ...
      let _ = new Intl.NumberFormat(),
        _ = _.payload[0].payload,
        { price: _, buyOrders: _, sellOrders: _ } = _,
...
function _(_) {
  let { priceHistory: _ } = _,
    ...
    _ = _(_, _),
    _ = (0, _.useMemo)(
      () => _.reduce((_, _) => _ + (_.purchases > 0 ? 1 : 0), 0),
      [_],
    );
  return (0, _.jsxs)(_, {
    currency: _.ecurrency,
...
var _ = _.default.memo(function (_) {
  ...
  _ = _.default.memo(function (_) {
    let { dateFormatter: _, mountTime: _, scale: _, customDomain: _ } = _,
      ...
      _ = _ || _,
      _ = (0, _.useCallback)((_) => _.format(_ * 1e3), [_]);
    return (0, _.jsx)(_, {
      dataKey: "time",
      tickMargin: 3,
      minTickGap: 24,
...
function _(_) {
  ...
  let { unAvgSum: _, cTotal: _ } = _.reduce(
      (_, _) => (
        _.price === void 0 ||
          _.purchases === void 0 ||
          ((_.unAvgSum += _.price * _.purchases), (_.cTotal += _.purchases)),
        _
      ),
      {
        unAvgSum: 0,
...
function _(_) {
  ...
  return (0, _.jsxs)(_, {
    ...
    children: [
      ...
      (0, _.jsx)(_, {
        selectedValue: _,
        options: _.map((_) => _.tag),
        onSelectionChange: _,
        placeholder: _.localized_name,
        getOptionLabel: (_) =>
          (_.tags && _.tags[_] && _.tags[_].localized_name) ?? "",
        clearable: !0,
        variant: "highlight",
      }),
      (0, _.jsxs)(_, {
...
var _ = _(_(), 1),
  _ = {
    [_.k_EAssetPropertyType_Float]: _,
    [_.k_EAssetPropertyType_Int]: _,
    [_.k_EAssetPropertyType_String]: _,
  };
function _(_) {
  let _ = _[_.property.type || _.k_EAssetPropertyType_Unknown];
  return _
    ? (0, _.jsx)(_, {
        ..._,
      })
...
function _(_, _) {
  ...
  return delete _[`${_}_Exterior`], delete _[`${_}_Quality`], _;
}
function _(_, _) {
  return _(_) ? _.filter((_) => _._ !== _) : _;
}
var _ = _(_(), 1);
function _(_) {
...
function _(_) {
  let {
    ...
    _ = _ && _.length > 0,
    _ = _ && !_,
    { market_name: _ = "", type: _, descriptions: _ = [] } = _,
    _ = _(_.listing),
    _ = _?.accessory_properties || [],
  ...
  return _
    ? (0, _.jsx)(_, {
        ...
        children: (0, _.jsx)(_, {
          buckets: _,
          value: _.float_value,
          focusedBucket: _ ? void 0 : _.focusedWear,
          min: 0,
          max: 1,
        }),
      })
