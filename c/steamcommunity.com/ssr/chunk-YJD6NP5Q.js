...
var _ = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        value: _.k_EContentReportReason_OtherDataProtectionAndPrivacyViolation,
      },
    ],
  },
  {
...
function _(_) {
  switch (_) {
    ...
    case _.k_EContentReportSubjectAction_SustainedOnDispute:
  ...
  let _ = async () => {
      _ &&
        (_.unresolved_dispute_count > 0 || _.dispute_resolved_time
          ? await _.mutateAsync({
              eSubjectType: _.k_EContentReportSubjectType_ForumPost,
              subjectGroupId: _,
              subjectId: "0",
              eResolution: _.k_EContentReportResolution_Acquitted,
              eReason: _.k_EContentReportReason_None,
  ...
  let [_, _] = (0, _.useState)(!1),
    _ = () => {
      (_.subject.resolved !== _.k_EContentReportResolution_Unresolved ||
        _.subject.dispute_resolved !==
          _.k_EContentReportResolution_Unresolved) &&
        _(!0),
        _.fnAcquit();
    },
    _ =
