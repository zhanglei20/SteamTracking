(self.webpackChunkcommunity = self.webpackChunkcommunity || []).push([
  [8010],
  {
    ...
    chunkid: (module, module_exports, __webpack_require__) => {
      ...
      function _(_) {
        var _, _, _, _, _;
        const _ = (0, _._)(_.reportedContentID),
          _ =
            null !==
              (_ =
                null ===
          ...
          _ =
            null !==
              (_ =
                null === (_ = _.data) || void 0 === _ ? void 0 : _.entries) &&
            void 0 !== _
              ? _
              : [];
        return (
        ...
        const [_, _] = (0, _.useState)(null),
          ...
          _ =
            ...
            (0, _._)({
              ...
              queryFn: async () => {
                if ("0" === _ || !_) throw new Error("Invalid steamid");
                const _ = await fetch(
      ...
      function _(_) {
        const { subject: _ } = _,
          _ = (0, _.useMemo)(() => {
            ...
            return __webpack_require__.sort((_, _) => _[1] - _[1]), _;
          }, [_.reports]);
        return 0 === _.length
          ? null
          : (0, _.jsxs)(_.Fragment, {
      ...
      function _(_) {
        ...
        const {
          ...
          _ = null == _ ? void 0 : _.reported_content_id,
          [_, _] = (0, _.useState)("main"),
          _ = [
            {
              name: "Reports",
      ...
      function _(_) {
        ...
        return (0, _.jsx)("button", {
          onClick: async () => {
            await _.mutateAsync(void 0), __webpack_require__();
          },
          disabled: !_,
          children: (0, _.jsxs)(_._, {
            direction: "row",
    ...
    chunkid: (module, module_exports, __webpack_require__) => {
      ...
      const _ = "get_reported_content",
        ...
        _ = (_) => ["get_reported_content_by_id", _],
        _ = (_) => ["get_reported_content_audit_log", _];
          ...
          (function (_, _) {
            return {
              ...
              queryFn: async () => {
                ...
                const _ = _._.Init(_._);
                return (
                  __webpack_require__.Body().set_reported_content_id(_),
      ...
      function _() {
        ...
        return (0, _._)({
          mutationFn: async (_) => {
            ...
            __webpack_require__
              .Body()
              .set_reported_content_id(_.reportedContentID);
      ...
      function _(_, _) {
        ...
        return (0, _._)({
          mutationFn: async () => {
            const _ = _._.Init(_._);
            __webpack_require__.Body().set_reported_content_id(_),
              __webpack_require__.Body().set_owner_dispute_details(_);
