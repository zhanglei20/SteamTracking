    ...
    [4922],
    {
      chunkid: function (module) {
        (function (_, _) {
          ...
          function _(_) {
            if (
              (typeof Symbol != "undefined" && _[Symbol.iterator] != null) ||
              _["@@iterator"] != null
            )
              return Array.from(_);
          }
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
              ...
              .forEach(function (_) {
                if (!_) {
                  ...
                  _ &&
                    ...
                    ((_ = _[_][_]),
                    delete _[_][_],
                    Object.keys(_[_]).length === 0 && delete _[_],
                    Object.keys(_).length === 0 && delete _.listeners);
                }
          ...
          function _(_, _, _) {
            ...
            return (
              _(Event) && _(CustomEvent)
                ...
                : ((_ = document.createEvent("CustomEvent")),
                  _.initCustomEvent(_, !0, !0, _)),
              _.dispatchEvent(_)
            );
          }
          function _(_) {
          ...
          function _(_) {
            var _ = _.rotate,
              ...
              _ = _.translateY,
              _ = [];
            _(_) && _ !== 0 && _.push("translateX(".concat(_, "px)")),
              _(_) && _ !== 0 && _.push("translateY(".concat(_, "px)")),
              _(_) && _ !== 0 && _.push("rotate(".concat(_, "deg)")),
              _(_) && _ !== 1 && _.push("scaleX(".concat(_, ")")),
              _(_) && _ !== 1 && _.push("scaleY(".concat(_, ")"));
          ...
          function _(_) {
            var _ = new DataView(_),
              _;
            try {
              var _, _, _;
              if (_.getUint8(0) === 255 && _.getUint8(1) === 216)
                for (var _ = _.byteLength, _ = 2; _ + 1 < _; ) {
                  if (_.getUint8(_) === 255 && _.getUint8(_ + 1) === 225) {
                    _ = _;
                    break;
                  }
                  _ += 1;
              ...
              if (_) {
                ...
                if (_(_, _, 4) === "Exif") {
                  ...
                  if (
                    ((_ = _ === 18761),
                    (_ || _ === 19789) && _.getUint16(_ + 2, _) === 42)
                  ) {
              ...
              if (_) {
                var _ = _.getUint16(_, _),
                  _,
                  _;
                for (_ = 0; _ < _; _ += 1)
                  if (((_ = _ + _ * 12 + 2), _.getUint16(_, _) === 274)) {
          ...
          var _ = {
              ...
              initCanvas: function () {
                ...
                (this.canvasData = _),
                  (this.limited = _ === 1 || _ === 2),
                  this.limitCanvas(!0, !0),
                  (_.width = Math.min(
                    Math.max(_.width, _.minWidth),
                    _.maxWidth,
                  )),
                  (_.height = Math.min(
                ...
                _ &&
                  (_
                    ? ((_.minLeft = Math.max(0, _.left)),
                      ...
                      (_.maxLeft =
                        Math.min(_.width, _.left + _.width) - _.width),
                      (_.maxTop =
            ...
            _ = {
              ...
              zoomTo: function (_, _, _) {
                ...
                if (
                  ((_ = Number(_)),
                  _ >= 0 && this.ready && !this.disabled && _.zoomable)
                ) {
                  var _ = _ * _,
                    _ = _ * _;
                  if (
              ...
              getCroppedCanvas: function () {
                ...
                var _ = _ / _,
                  ...
                  _ = _({
                    aspectRatio: _,
                    width: _.width || (_ !== 1 ? _.width : _),
                    height: _.height || (_ !== 1 ? _.height : _),
                  }),
                  _ = _.width,
                  _ = _.height;
                (_ = Math.min(_.width, Math.max(_.width, _))),
                  ...
                  [
                    ...
                    },
                    {
                      ...
                      value: function () {
                        ...
                        if (_.naturalWidth && !_) {
                          _(_.naturalWidth, _.naturalHeight);
                          return;
                        }
                        var _ = document.createElement("img"),
                        ...
                        if (!(!this.sized || this.ready)) {
                          ...
                          (this.container = _),
                            ...
                            (_.viewMode =
                              Math.max(
                                0,
                                Math.min(3, Math.round(_.viewMode)),
                              ) || 0),
                            _(_, _),
                            _.guides ||
                              _(
