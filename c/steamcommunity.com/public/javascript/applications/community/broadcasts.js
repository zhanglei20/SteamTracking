    ...
    [2079],
    {
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        const _ = class _ {
          ...
          async LoadBroadcastDebugInfo(_) {
            ...
            try {
              ...
              if (_ && _.status == 200 && _.data && _.data.success == _._)
                return (this.m_curDebugInfo = _.data), this.m_curDebugInfo;
            } catch (_) {
              let _ = (0, _._)(_);
              console.error(
                "LoadBroadcastDebugInfo: Failed " + _.strErrorMsg,
                _,
              );
            }
            return null;
          ...
          async UpdateBroadcastSettings(_, _, _) {
            let _ =
                _._.COMMUNITY_BASE_URL + "broadcast/updatebroadcastsettings",
              _ = {
                steamid: this.m_steamid.ConvertTo64BitString(),
                matchid: _,
                title: _,
          ...
          async SetBroadcasterRestrictions(_, _, _) {
            const _ = this.m_steamid.ConvertTo64BitString(),
              _ = _._.GetBroadcast(_);
            let _ =
                _._.COMMUNITY_BASE_URL + "broadcast/setbroadcastrestriction",
              _ = {
                steamid: _,
                broadcastid: _ ? _.m_ulBroadcastID : null,
                type: _,
          ...
          Init() {
            ...
            this.ValidateStoreDefault(_) &&
              ...
              (this.m_bShowOnlyChat = !!_.show_only_chat),
              (this.m_bShowOnlyVideo = !!_.show_only_video));
          }
          ValidateStoreDefault(_) {
            const _ = _;
            return _ && typeof _ == "object"
              ? typeof _.steamid == "string"
              : !1;
          }
        };
        _([_._], _.prototype, "m_curDebugInfo", 2);
        let _ = _;
        var _ = __webpack_require__("chunkid"),
          _ = __webpack_require__("chunkid"),
          _ = __webpack_require__("chunkid"),
        ...
        const _ = (_) => {
          ...
          _ = (_) => {
            ...
            return (0, _.jsxs)("div", {
              ...
              children: [
                !!(_.last_error_result && _.last_error_result != _._) &&
                  (0, _.jsxs)("div", {
                ...
                (0, _.jsxs)("div", {
                  ...
                  children: [
                    ...
                    (_ = _ == null ? void 0 : _.origin_video_streams) == null
                      ? void 0
                      : _.map((_) =>
                          (0, _.jsxs)(
                            "div",
                    ...
                    " segments received, \xA0",
                    _.origin_audio_stream.num_segments_cached * 2,
                    " seconds cached ( ",
                ...
                children: [
                  !!_.bShowName &&
                    (0, _.jsx)("a", {
                      href: _.GetCommunityProfileURL(),
                      "data-miniprofile":
                        "s" + _.steamid.ConvertTo64BitString(),
        ...
        function _(_) {
          ...
          let _ = _ == null ? void 0 : _.GetAssets().GetMainCapsuleURL(),
            _ = _ && _.length > 0;
          return (0, _.jsx)(_._, {
            children: (0, _.jsxs)("div", {
              ...
              children: [
                _ &&
                  (0, _.jsx)("a", {
                    ...
                    href: (0, _._)(
                      (_ == null ? void 0 : _.GetStorePageURL()) ||
            ...
            return (0, _.jsxs)("div", {
              ...
              children: [
                ...
                (0, _.jsx)("a", {
                  ...
                  children: _ || (_ == null ? void 0 : _.GetName()),
                }),
            ...
            const _ = [
              ...
              _ = async () => {
                ...
                try {
                  ...
                  const _ = _().CancelToken.source();
                  _.current = _.cancel;
                  let _ = await _.Get().SetBroadcasterRestrictions(_, _, _);
                  _.token.reason || (_ = !0);
                } finally {
                  _(!1), _(!0), _(_);
                }
            ...
            const _ = () => _.closeModal && _.closeModal(),
              _ = async () => {
                ...
                try {
                  _.current && _.current();
                  const _ = _().CancelToken.source();
                  (_.current = _.cancel), (_ = await _.Get().SetUnBannable(_));
                } finally {
                  _(!1), _(!0), _(_);
                }
              };
        ...
        const _ = (0, _._)((_) => {
          const _ = _.Get().GetBroadcasterSteamID(),
            _ = _ == null ? void 0 : _.ConvertTo64BitString(),
            _ = _(),
            [_, _] = (0, _._)("muted", !0),
            _ = _._.GetBroadcast(_),
          ...
          _ = (0, _._)((_) => {
            ...
            const _ = async () => {
              ...
              _ = (_) => {
                (0, _._)(
                  (0, _.jsx)(_._, {
                    strTitle: (0, _._)("#Broadcast_Control_StopBroadcast"),
                    strDescription: (0, _._)("#EventEditor_GenericAreYouSure"),
                    onOK: async () => {
                      _.current && _.current();
                      const _ = _().CancelToken.source();
                      _.current = _.cancel;
      ...
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        let _ = class extends _.Component {
          ...
          render() {
            ...
            const _ = this.state.bAnimate && _ != null ? _ : void 0;
            return (0, _.jsx)("div", {
              onMouseEnter: () =>
                this.setState({
                  bAnimate: this.props.loopDuration != "None",
