      ...
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        class _ {
          ...
          async Init() {
            ...
            if (this.ValidateStoreDefault(_)) {
              ...
              this.m_mapConferences.set(_.vanity, {
                ..._,
                strLocalizedLogos: typeof _ == "string" ? [_] : _,
                strLocalizedMobileLogos: typeof _ == "string" ? [_] : _,
              });
            }
          }
          ValidateStoreDefault(_) {
            ...
            return _ && typeof _ == "object"
              ? typeof _.event_group_steamid == "string" &&
                  typeof _.start_rtime == "number" &&
                  typeof _.end_rtime == "number"
              : !1;
          }
        }
        var _ = __webpack_require__("chunkid"),
        ...
        class _ {
          ...
          async InternalLoadInitialCalendarData(_, _) {
            ...
            _ && (await _.RegisterCalendarEventsAndModels(_)),
              _.SetFilteredView((_) => !0);
          }
          static Get() {
        ...
        function _(_) {
          ...
          (0, _._)(_);
          const _ = (0, _._)(_);
          (0, _._)((_ = _.clanInfo) == null ? void 0 : _.clanid);
          const _ = (0, _.sfN)(_._.LANGUAGE),
            _ = "capsule",
            ...
            _ = (0, _._)(),
            _ = !!(_ && _ && _),
            _ = (_ = (0, _._)(_ ? void 0 : _, _, _, _, _)) != null ? _ : _,
            _ = _(_, _),
            _ = (0, _._)(_),
            _ = _()[`EventType${_}`],
            _ = _.map((_) => _()[`Tag-${_}`]),
        ...
        function _(_) {
          const { eventModel: _ } = _,
            ...
            [_, _, _, _] = (0, _._)(() => [
              ...
              _.GetForumTopicURL(_ == null ? void 0 : _.vanity_url),
              _.nCommentCount,
            ]),
            _ = _(_, _),
            _ = !(0, _._)() && _,
                  ...
                  (0, _.jsx)("div", {
                    ...
                    children: _.map((_, _) =>
                      (0, _.jsx)(
                        _,
                        {
                          bDisplayAsUpNext: _ == 0 && _.length >= 1,
                          calendarItem: _,
        ...
        function _(_) {
          const {
            ...
            _ = (0, _._)(new Date(_ * 1e3), new Date(_ * 1e3));
          return (0, _.jsxs)("div", {
        ...
        function _(_) {
          const { conferenceInfo: _ } = _,
            ...
            _ = _.GetActiveEventsAt(_) || [],
            [_] = _.useState(new _._()),
            _ = _.GetCalendarItemsInTimeRange(_.rtStartTime - 1, _)
              .rgCalendarItems.filter(
                (_) => _.length == 0 || _[0].GID != _.unique_id,
              )
              .sort((_, _) => _.start_time - _.start_time);
          return _.length == 0
            ? (0, _.jsx)("div", {
                  ...
                  _
                    ? (0, _.jsx)("div", {
                        ...
                        children: (0, _.jsx)("div", {
                          ...
                          children: (0, _._)("#Conference_ChatHidden", _),
                        }),
                      })
                    : (0, _.jsx)(_, {
                        conferenceInfo: _,
