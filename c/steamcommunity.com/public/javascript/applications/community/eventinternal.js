      ...
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        const _ = (0, _._)((_) => {
            ...
            const _ = _.filter((_) => !_.gid_clan_event),
              ...
              _ = _.filter((_) => !!(_.gid_clan_event && _.hidden)),
              _ = _.filter((_) => !!(_.gid_clan_event && !_.hidden));
            return (0, _.jsxs)("div", {
              children: [
                (0, _.jsx)("h1", {
              ...
              children: [
                (0, _.jsxs)("div", {
                  ...
                  children: [
                    ...
                    !!(!_.gid_clan_event || (_.hidden && !_.published)) &&
                      (0, _.jsx)(_._, {
                        onClick: (_) =>
                          (0, _._)(
                            (0, _.jsx)(_, {
            ...
            return _
              ? (0, _.jsxs)("div", {
                  children: [
                    ...
                    !_.BIsPartnerEventEditorEnabled() &&
                      (0, _.jsxs)("div", {
                        children: [
        ...
        _([_._], _.prototype, "m_mapSaleIDToInfo", 2),
          _([_._], _.prototype, "m_listSaleState", 2);
        let _ = _;
        function _() {
        ...
        _([_._.shallow], _.prototype, "m_rgApps", 2),
          _([_._.shallow], _.prototype, "m_rgClanAccountIDs", 2);
        let _ = _;
        var _ = __webpack_require__("chunkid"),
          _ = __webpack_require__("chunkid"),
          _ = __webpack_require__._(_),
        ...
        const _ = (0, _._)((_) => {
            ...
            (0, _.useEffect)(() => {
              Promise.all([_._.InitGlobal(), _._.Init()]).then(() => _(!1));
            }, []);
            const [_, _] = (0, _._)("start", 0),
              ...
              _ = _ == 0 ? _ : _.filter((_) => !_.has(Number(_._))).slice(0, _),
              _ = (_, _) => {
                _.has(_) ||
          ...
          _ = (0, _._)((_) => {
            ...
            (0, _.useEffect)(() => {
              _._.LoadOGGClanInfoForAppID(_).then((_) => {
                ...
                return console.log(
                  "Loaded app",
                  _,
                  _ == null ? void 0 : _.group_name,
                  (_ = _ == null ? void 0 : _.clanSteamID) == null
                    ? void 0
                    : _.ConvertTo64BitString(),
                );
              });
            ...
            const _ = _._.GetOGGClanInfo(_),
              ...
              _ = _.filter(
                (_) =>
                  ...
                  (!_ ||
                    _.clanAccountID ==
                      _.announcementClanSteamID.GetAccountID()),
              ),
              _ = _.length,
              _ = !_ && _ > 0 && (_ == null ? void 0 : _.clanSteamID),
              _ = async () => {
                const _ = _;
                _(_ + _), _(!0);
                const _ = await _._.LoadPartnerEventsPageable(void 0, _, _, _);
                _(_.concat(_)), _(!1);
              };
            (0, _.useEffect)(() => {
              _.bAutoLoad && _ && !_ && _();
            ...
            const _ = (_, _) => {
              ...
              _ = async () => {
                _(!0),
                  await _(_, _.nMigrateBatchSize, _, _.clanSteamID, _),
                  _(!1);
              };
            return (
              (0, _.useEffect)(() => {
        ...
        async function _(_, _, _, _, _) {
          for (const _ of _.slice(0, _)) {
            ...
            try {
              ...
              const _ = (0, _._)(_);
              console.error("MigrateEvents: " + _.strErrorMsg.slice(0, 512), _),
