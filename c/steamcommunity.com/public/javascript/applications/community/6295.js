    ...
    [6295],
    {
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        var _ = Object.defineProperty,
          ...
          _ = (_, _, _) => (_(_, _, "default"), _ && _(_, _, "default")),
          _ = {};
        _(_, _);
        var _ = 120 * 1e3,
          _ = class {
            ...
            _checkIfIdle() {
              ...
              Date.now() - this._lastUsedTime > _ && this._stopWorker();
            }
            _getClient() {
              return (
        ...
        var _;
        (function (_) {
          (_.MIN_VALUE = -2147483648), (_.MAX_VALUE = 2147483647);
          function _(_) {
            return typeof _ == "number" && _.MIN_VALUE <= _ && _ <= _.MAX_VALUE;
          }
          _._ = _;
        })(_ || (_ = {}));
        var _;
        (function (_) {
          (_.MIN_VALUE = 0), (_.MAX_VALUE = 2147483647);
          function _(_) {
            return typeof _ == "number" && _.MIN_VALUE <= _ && _ <= _.MAX_VALUE;
          }
          _._ = _;
        ...
        (function (_) {
          ...
          function _(_) {
            ...
            return (
              ...
              (_._(_.originSelectionRange) ||
                _.undefined(_.originSelectionRange))
            );
          }
          _._ = _;
        })(_ || (_ = {}));
        ...
        var _;
        (function (_) {
          (_.Error = 1), (_.Warning = 2), (_.Information = 3), (_.Hint = 4);
        })(_ || (_ = {}));
        var _;
        (function (_) {
          (_.Unnecessary = 1), (_.Deprecated = 2);
        })(_ || (_ = {}));
        var _;
        (function (_) {
          function _(_) {
          ...
          function _(_) {
            ...
            return (
              ...
              (_.undefined(_.codeDescription) ||
                _.string(
                  (_ = _.codeDescription) === null || _ === void 0
                    ? void 0
                    : _.href,
                )) &&
        ...
        (function (_) {
          function _(_, _, _) {
            ...
            return (
              _ !== void 0 && (_.needsConfirmation = _),
              _ !== void 0 && (_.description = _),
              _
            );
          }
          _.create = _;
          function _(_) {
            ...
            return (
              ...
              (_.boolean(_.needsConfirmation) ||
                _.needsConfirmation === void 0) &&
              (_.string(_.description) || _.description === void 0)
            );
          }
          _._ = _;
        })(_ || (_ = {}));
        ...
        (function (_) {
          ...
          function _(_) {
            let _ = _;
            return (
              _.defined(_) && _._(_.textDocument) && Array.isArray(_.edits)
            );
          }
          _._ = _;
        })(_ || (_ = {}));
        ...
        (function (_) {
          function _(_, _, _) {
            ...
            return (
              _ !== void 0 &&
                (_.overwrite !== void 0 || _.ignoreIfExists !== void 0) &&
                (_.options = _),
              _ !== void 0 && (_.annotationId = _),
              _
            );
          }
          _.create = _;
          function _(_) {
            ...
            return (
              ...
              _.string(_.uri) &&
              (_.options === void 0 ||
                ((_.options.overwrite === void 0 ||
                  _.boolean(_.options.overwrite)) &&
                  (_.options.ignoreIfExists === void 0 ||
                    _.boolean(_.options.ignoreIfExists)))) &&
              (_.annotationId === void 0 || _._(_.annotationId))
            );
          }
          _._ = _;
        })(_ || (_ = {}));
        ...
        (function (_) {
          function _(_, _, _) {
            ...
            return (
              _ !== void 0 &&
                (_.recursive !== void 0 || _.ignoreIfNotExists !== void 0) &&
                (_.options = _),
              _ !== void 0 && (_.annotationId = _),
              _
            );
          ...
          function _(_) {
            ...
            return (
              ...
              _.string(_.uri) &&
              (_.options === void 0 ||
                ((_.options.recursive === void 0 ||
                  _.boolean(_.options.recursive)) &&
                  (_.options.ignoreIfNotExists === void 0 ||
        ...
        (function (_) {
          function _(_) {
            ...
            return (
              _ &&
              (_.changes !== void 0 || _.documentChanges !== void 0) &&
              (_.documentChanges === void 0 ||
        ...
        (function (_) {
          ...
          function _(_) {
            ...
            return (
              _.defined(_) &&
              _.string(_.uri) &&
              (_.version === null || _.integer(_.version))
            );
          }
          _._ = _;
        })(_ || (_ = {}));
        ...
        var _;
        (function (_) {
          (_.PlainText = "plaintext"), (_.Markdown = "markdown");
          function _(_) {
            const _ = _;
        ...
        var _;
        (function (_) {
          (_.asIs = 1), (_.adjustIndentation = 2);
        })(_ || (_ = {}));
        var _;
        (function (_) {
          function _(_) {
            ...
            return (
              _ &&
              (_.string(_.detail) || _.detail === void 0) &&
              (_.string(_.description) || _.description === void 0)
            );
          }
          _._ = _;
        ...
        (function (_) {
          function _(_, _, _, _, _, _) {
            ...
            return _ !== void 0 && (_.children = _), _;
          }
          _.create = _;
          function _(_) {
            let _ = _;
            return (
              ...
              (_.detail === void 0 || _.string(_.detail)) &&
              (_.deprecated === void 0 || _.boolean(_.deprecated)) &&
              (_.children === void 0 || Array.isArray(_.children)) &&
              (_.tags === void 0 || Array.isArray(_.tags))
            );
          }
          _._ = _;
        })(_ || (_ = {}));
        ...
        (function (_) {
          function _(_, _, _) {
            ...
            return (
              _ != null && (_.only = _), _ != null && (_.triggerKind = _), _
            );
          }
          _.create = _;
          function _(_) {
            ...
            return (
              ...
              (_.only === void 0 || _.typedArray(_.only, _.string)) &&
              (_.triggerKind === void 0 ||
        ...
        (function (_) {
          ...
          function _(_) {
            ...
            return (
              _ &&
              _.string(_.title) &&
              (_.diagnostics === void 0 || _.typedArray(_.diagnostics, _._)) &&
              (_.kind === void 0 || _.string(_.kind)) &&
              (_.edit !== void 0 || _.command !== void 0) &&
              (_.command === void 0 || _._(_.command)) &&
              (_.isPreferred === void 0 || _.boolean(_.isPreferred)) &&
              (_.edit === void 0 || _._(_.edit))
            );
          }
          _._ = _;
        })(_ || (_ = {}));
        ...
        (function (_) {
          function _(_) {
            ...
            return (
              _.objectLiteral(_) &&
              (_.resultId === void 0 || typeof _.resultId == "string") &&
              Array.isArray(_.data) &&
              (_.data.length === 0 || typeof _.data[0] == "number")
            );
          }
          _._ = _;
        })(_ || (_ = {}));
        ...
        (function (_) {
          ...
          function _(_) {
            const _ = _;
            return _ != null && _._(_.range) && _.string(_.text);
          }
          _._ = _;
        })(_ || (_ = {}));
        var _;
        (function (_) {
          ...
          function _(_) {
            ...
            return (
              ...
              (_.string(_.variableName) || _.variableName === void 0)
            );
          }
          _._ = _;
        })(_ || (_ = {}));
        ...
        (function (_) {
          ...
          function _(_) {
            ...
            return (
              _ != null &&
              _._(_.range) &&
              (_.string(_.expression) || _.expression === void 0)
            );
          }
          _._ = _;
        })(_ || (_ = {}));
        ...
        (function (_) {
          ...
          function _(_) {
            ...
            return (
              _.objectLiteral(_) &&
              (_.tooltip === void 0 || _.string(_.tooltip) || _._(_.tooltip)) &&
              (_.location === void 0 || _._(_.location)) &&
              (_.command === void 0 || _._(_.command))
            );
          }
          _._ = _;
          ...
          function _(_) {
            ...
            return (
              (_.objectLiteral(_) &&
                ...
                (_.kind === void 0 || _._(_.kind)) &&
                _.textEdits === void 0) ||
              (_.typedArray(_.textEdits, _._) &&
                (_.tooltip === void 0 ||
                  _.string(_.tooltip) ||
                  _._(_.tooltip)) &&
                (_.paddingLeft === void 0 || _.boolean(_.paddingLeft)) &&
                (_.paddingRight === void 0 || _.boolean(_.paddingRight)))
            );
          }
          _._ = _;
        })(_ || (_ = {}));
...
` &&
            ...
            offsetAt(_) {
              ...
              let _ = _[_.line],
                _ =
                  _.line + 1 < _.length ? _[_.line + 1] : this._content.length;
        ...
        (function (_) {
          ...
          _.boolean = _;
          function _(_) {
            return _.call(_) === "[object String]";
          }
          _.string = _;
          function _(_) {
            return _.call(_) === "[object Number]";
          }
          _.number = _;
          function _(_, _, _) {
            return _.call(_) === "[object Number]" && _ <= _ && _ <= _;
          }
          _.numberRange = _;
          function _(_) {
            return (
              _.call(_) === "[object Number]" &&
              -2147483648 <= _ &&
              _ <= 2147483647
            );
          }
          _.integer = _;
          function _(_) {
            return _.call(_) === "[object Number]" && 0 <= _ && _ <= 2147483647;
          }
          _.uinteger = _;
          function _(_) {
        ...
        var _ = class {
          constructor(_, _, _) {
            ...
            const _ = (_) => {
                let _ = _.getLanguageId();
                if (_ !== this._languageId) return;
                let _;
              ...
              _ = (_) => {
                ...
                let _ = _.uri.toString(),
                  _ = this._listener[_];
                _ && (_.dispose(), delete this._listener[_]);
              };
          ...
          _doValidate(_, _) {
            this._worker(_)
              ...
              .then((_) => {
                const _ = _.map((_) => _(_, _));
                let _ = _.editor.getModel(_);
                _ &&
                  _.getLanguageId() === _ &&
                  _.editor.setModelMarkers(_, _, _);
              })
              .then(void 0, (_) => {
                console.error(_);
              });
        ...
        function _(_, _) {
          let _ = typeof _.code == "number" ? String(_.code) : _.code;
          return {
        ...
        function _(_) {
          return (
            typeof _.insert != "undefined" && typeof _.replace != "undefined"
          );
        }
        function _(_) {
        ...
        function _(_) {
          return _ && _.command === "editor.action.triggerSuggest"
            ? {
                _: _.command,
                title: _.title,
        ...
        function _(_) {
          return _ && typeof _ == "object" && typeof _.kind == "string";
        }
        function _(_) {
          return typeof _ == "string"
            ? {
...
` +
        ...
        var _ = class {
          ...
          provideDocumentSymbols(_, _) {
            const _ = _.uri;
            return this._worker(_)
              .then((_) => _.findDocumentSymbols(_.toString()))
              .then((_) => {
                if (_)
                  return _.map((_) =>
                    _(_)
        ...
        function _(_) {
          return "children" in _;
        }
        function _(_) {
          var _, _, _;
          return {
            name: _.name,
            detail: (_ = _.detail) != null ? _ : "",
            kind: _(_.kind),
            range: _(_.range),
            selectionRange: _(_.selectionRange),
            tags: (_ = _.tags) != null ? _ : [],
            children: ((_ = _.children) != null ? _ : []).map((_) => _(_)),
          };
        }
        function _(_) {
        ...
        var _ = class {
            ...
            provideLinks(_, _) {
              const _ = _.uri;
              return this._worker(_)
                .then((_) => _.findDocumentLinks(_.toString()))
                .then((_) => {
                  if (_)
                    return {
                      links: _.map((_) => ({
            ...
            provideDocumentFormattingEdits(_, _, _) {
              ...
              return this._worker(_).then((_) =>
                _.format(_.toString(), null, _(_)).then((_) => {
                  if (!(!_ || _.length === 0)) return _.map(_);
                }),
              );
            }
          },
        ...
        var _ = class {
            ...
            provideDocumentColors(_, _) {
              const _ = _.uri;
              return this._worker(_)
                .then((_) => _.findDocumentColors(_.toString()))
                .then((_) => {
                  if (_)
                    return _.map((_) => ({
                      color: _.color,
                ...
                .then((_) => {
                  if (_)
                    return _.map((_) => {
                      ...
                      return (
                        typeof _.kind != "undefined" && (_.kind = _(_.kind)), _
                      );
                    });
                });
            }
        ...
        function _(_) {
          ...
          function _() {
            ...
            _(_),
              ...
              _.hovers &&
                _.push(_.languages.registerHoverProvider(_, new _(_))),
              _.documentHighlights &&
                _.push(
                  _.languages.registerDocumentHighlightProvider(_, new _(_)),
                ),
              _.definitions &&
                _.push(_.languages.registerDefinitionProvider(_, new _(_))),
              _.references &&
                _.push(_.languages.registerReferenceProvider(_, new _(_))),
              _.documentSymbols &&
                _.push(_.languages.registerDocumentSymbolProvider(_, new _(_))),
              _.rename &&
                _.push(_.languages.registerRenameProvider(_, new _(_))),
              _.colors &&
                _.push(_.languages.registerColorProvider(_, new _(_))),
              _.foldingRanges &&
                _.push(_.languages.registerFoldingRangeProvider(_, new _(_))),
              _.diagnostics && _.push(new _(_, _, _.onDidChange)),
              _.selectionRanges &&
                _.push(_.languages.registerSelectionRangeProvider(_, new _(_))),
