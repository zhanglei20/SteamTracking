    ...
    [3347],
    {
      chunkid: (module, module_exports, __webpack_require__) => {
            ...
            queryFn: async () => {
              ...
              if (_.GetEResult() == _._)
                return _._.fromString(
                  (_ =
                    (_ = _.Body().toObject().summary) == null
                      ? void 0
                      : _.points) != null
                    ? _
                    : "0",
        ...
        function _(_, _) {
          return (0, _._)({
            ...
            queryFn: async () => {
              ...
              if (_.GetEResult() == _._) {
                const _ = new Map();
                let _ = (_ = _.Body().toObject().reactions) != null ? _ : [];
        ...
        function _(_, _, _, _) {
          return (0, _._)({
            ...
            queryFn: async () => {
              ...
              if (_.GetEResult() == _._) return new Set(_.Body().reactionids());
              throw _.GetEResult();
            },
            enabled: _,
          });
        ...
        var module = __webpack_require__("chunkid"),
          ...
          module = (_, _, _) => _(_, typeof _ != "symbol" ? _ + "" : _, _),
          module = ((_) => (
        ...
        _([_.module], _.prototype, "handleMouseOver", 1),
          _([_.module], _.prototype, "handleMouseOut", 1);
        function _(_, _, _) {
          let _ = [];
          return (
        ...
        function _(_) {
          ...
          if (
            ...
            return null;
          const _ = (_ = _.data) != null ? _ : new Map(),
            _ = (_ = _.data) != null ? _ : new _._(0),
            _ = _(_, _, _),
          ...
          switch (_) {
            case 0:
              {
                const _ =
                    _ === _._._ || ((_ = _.data) == null ? void 0 : _.has(_)),
                          ...
                          return (0, _.jsx)(
                            _,
                            {
                              autoFocus:
                                (_ === void 0 && _ == 0) ||
                                (_ === _ &&
                                  !((_ = _.data) != null && _.has(_))),
                              reaction: _,
                              selected:
                                _ === _ && !((_ = _.data) != null && _.has(_)),
                              cost: _.get(_).points_cost,
                              alreadyAwarded:
                                (_ = _.data) == null ? void 0 : _.has(_),
                              awardConfig: _.get(_),
                              onClick: () => {
                                var _;
                                ((_ = _.data) != null && _.has(_)) ||
              ...
              children: [
                ...
                (0, _.jsxs)("div", {
                  ...
                  children: [
                    (0, _.jsx)("div", {
                      className: _.Label,
                      children: _ == null ? void 0 : _.localized_title,
                    }),
                    (0, _.jsx)(_, {
                      className: _.Points,
                      children: (0, _._)(_ != null ? _ : 0),
                    }),
                  ],
                }),
                _ &&
      ...
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        function _(_) {
          ...
          return (0, _.useMemo)(() => {
            var _;
            return (_ = _ == null ? void 0 : _.data) == null
              ? void 0
              : _.find((_) => _.reactionid === _);
          }, [_, _]);
        }
      },
      chunkid: (module) => {
