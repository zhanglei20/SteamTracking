      ...
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        function _(_) {
          const {
            ...
            [_, _] = _.useState(
              _ ? `https://www.youtube.com/watch?v=${_}` : "",
            ),
            [_, _] = _.useState(void 0),
            _ = _.useCallback(() => {
              const { strVideoID: _ } = (0, _._)(_);
              return (
                _ ? _(_, _) : _((0, _._)("#EventEditor_InsertYouTube_NoURL")),
                !1
              );
            }, [_, _, _]),
            _ = _.useCallback((_) => {
            ...
            children: [
              ...
              (0, _.jsx)(_._, {
                ...
                onChange: (_) => {
                  ...
                  (_.ask_registration_question = _), _(_);
                },
                label:
        ...
        function _(_) {
          ...
          const { group: _, fnSetGroup: _ } = _,
            [_, _] = (0, _.useState)(
              ((_ = _.group_visibility_tokens) == null ? void 0 : _.length) > 0,
            );
          return _
            ? (0, _.jsxs)(_.Fragment, {
                children: [
            ...
            children: [
              (0, _.jsxs)("div", {
                children: [
                  ...
                  ": ",
                  (0, _._)(_.unix() + _ * 60, !1, _.format("z")),
                  " ",
                ],
              }),
              (0, _.jsxs)("div", {
        ...
        function _(_) {
          const _ = (0, _._)({
            ...
            queryFn: async () => {
              ...
              return _ == null ? void 0 : _.data.timezones;
            },
          });
        ...
        function _(_, _) {
          if (_) {
            ...
            let _ = 0;
            do _ = Math.floor(1e4 + Math.random() * 9e4);
          ...
          if (_) {
            const _ = _._.GetTimeNowWithOverride(),
              ...
              _ =
                _ == null
                  ? void 0
                  : _.reduce((_, _) => _.concat(_.sessions), []);
            let _ = 0;
            do _ = Math.floor(1e4 + Math.random() * 9e4);
            while (_ && _.findIndex((_) => _._ == _) >= 0);
            const _ = Math.ceil(_ / 3600) * 3600;
            return {
              _: _,
        ...
        function _(_) {
          ...
          const { focusView: _, removeNode: _, group_id: _ } = _,
            ...
            _ = (0, _._)(() => {
              var _;
              return (_ = _.GetEventModel().jsondata.meet_steam_groups) == null
                ? void 0
                ...
                children: [
                  ...
                  (0, _.jsxs)("div", {
                    ...
                    children: [
                      ...
                      ((_ = _.group_visibility_tokens) == null
                        ? void 0
                        : _.length) > 0 &&
                        (0, _.jsx)(_._, {
                          onClick: () => {},
                    ...
                    (0, _.jsx)(_, {
                      ...
                      fnUpdateGroupSession: (_) => {
                        const { groupIndex: _ } = _(_.group_id),
                          _ = _._.GetEditModel();
                        (_.GetEventModel().jsondata.meet_steam_groups[_] = _),
        ...
        function _(_, _, _, _, _) {
          const _ = () => _.createChecked(null, _.createChecked()),
          ...
          const { schema: _ } = _,
            ...
            _ = _.useCallback(
              (_, _, _) =>
                _._(_)
                  ? !1
                  : (_ && _(_._.insert(_.selection._, _(_, _, _, _, _))), !0),
              [_, _, _, _, _],
            );
          return _
            ? (0, _.jsx)(_._, {
        ...
        function _(_) {
          const { schema: _ } = _,
            ...
            [_, _] = React.useState(() =>
              IsInNodeWithAttribute(_.state, _, TableAttr.NoBorder),
            ),
            [_, _] = React.useState(() =>
              IsInNodeWithAttribute(_.state, _, TableAttr.EqualCells),
            ),
            _ = React.useMemo(
              () => ToggleNodeBoolAttributeCommand(_, TableAttr.NoBorder),
              [_],
            ),
            _ = React.useMemo(
              () => ToggleNodeBoolAttributeCommand(_, TableAttr.EqualCells),
              [_],
            );
          return (
            useCallbackList(
              ...
              React.useCallback(
                (_) => {
                  _(IsInNodeWithAttribute(_.state, _, TableAttr.NoBorder)),
                    _(IsInNodeWithAttribute(_.state, _, TableAttr.EqualCells));
                },
                [_],
              ),
            ),
        ...
        function _(_) {
          const { hideModal: _, fnUpdateSession: _, inputScheduleModel: _ } = _,
            ...
            _ = (0, _.useMemo)(() => {
              ...
              return _.length == 0
                ? _
                : Math.min(..._.map((_) => _.rtime_start));
            }, [_, _]);
          return (0, _.jsx)(_._, {
            active: !0,
            children: (0, _.jsx)(_._, {
            ...
            children: [
              ...
              (0, _.jsx)(_._, {
                onClick: () => {
                  ...
                  let _ = Math.floor(1 + Math.random() * 1e5);
                  for (; _.findIndex((_) => _.break_id == _) >= 0; )
                    _ = Math.floor(1 + Math.random() * 1e5);
                  _(
                    {
                      break_id: _,
                    ...
                    ((_ = _.session_breaks) == null ? void 0 : _.length) || 0,
                  );
                },
                children: "+ Add Break",
              }),
        ...
        function _(_) {
          const { focusView: _, removeNode: _, schedule_id: _ } = _,
            ...
            _ = (0, _._)(() => {
              var _;
              return (_ = _.GetEventModel().jsondata.meet_steam_schedules) ==
                null
                ? void 0
            ...
            children: [
              ...
              (0, _.jsxs)("div", {
                ...
                children: [
                  ...
                  _ == _._.k_EPollVoter_MinPlayTime &&
                    (0, _.jsx)("div", {
                      ...
                      children: (0, _.jsx)(_._, {
                        ...
                        onChange: (_) => {
                          ...
                          const _ =
                            ((_ = Number.parseInt(
                              (_ = _ == null ? void 0 : _.currentTarget) == null
                                ? void 0
                                : _.value,
                            )) != null
                              ? _
          ...
          if (_) {
            const _ = _._.GetEditModel().GetEventModel().jsondata.user_polls,
              _ =
                _ == null
                  ? void 0
                  : _.reduce((_, _) => _.concat(_.options), []);
            let _ = 0;
            do _ = Math.floor(1e4 + Math.random() * 9e4);
        ...
        function _(_) {
          ...
          for (
            let _ = 0;
            _ < _.GetEventModel().jsondata.user_polls.length;
            ++_
          ) {
        ...
        function _(_) {
          const { focusView: _, removeNode: _, poll_id: _ } = _,
            ...
            _ = (0, _._)(() => {
              var _;
              return (_ = _.GetEventModel().jsondata.user_polls) == null
                ? void 0
                    ...
                    (0, _.jsx)(_, {
                      ...
                      fnUpdateUserPollDef: (_) => {
                        const { pollIndex: _ } = _(_.poll_id),
                          _ = _._.GetEditModel();
                        (_.GetEventModel().jsondata.user_polls[_] = _),
                          _.SetDirty(_._.description);
                      },
                    }),
                  !!_ &&
              ...
              children: [
                ...
                (0, _.jsx)(_._, {
                  ...
                  render: (_) => {
                    ...
                    return (0, _.jsx)("div", {
                      children:
                        ((_ = _.localized_option) == null ? void 0 : _[_]) ||
                        ((_ = _.localized_option) == null
                          ? void 0
                          : _[_.Bhc]) ||
                        "",
                    });
                  ...
                  children: (0, _.jsx)(_._, {
                    ...
                    onOK: () => {
                      const _ = _._.GetEditModel(),
                        { optionIndex: _, pollIndex: _ } = _(_),
                        _ = [
                          ..._.GetEventModel().jsondata.user_polls[_].options,
                        ];
                      _.splice(_, 1),
                        (_.GetEventModel().jsondata.user_polls[_].options = _),
                        _.SetDirty(_._.description);
            ...
            _ = _.useCallback(
              (_) => {
                _.GetEventModel().jsondata.user_polls ||
                  ...
                  _(_, _.nodes.userpolls, _.poll_id),
                  _();
              },
              [_, _, _, _],
            );
        ...
        function _(_) {
          const { schema: _ } = _,
            ...
            _ = _.useCallback(
              (_, _) => {
                _(_, _.nodes.previewyoutube, _, _), _();
              },
              [_, _, _],
            );
          return (0, _.jsxs)(_.Fragment, {
            ...
            _ = _.useCallback(
              (_, _) => {
                _.GetEventModel().jsondata.meet_steam_groups ||
                  ...
                  _(_, _.nodes.meetsteamsessiongroup, _.group_id),
                  _();
              },
              [_, _, _, _],
            );
          if ((_ == null ? void 0 : _.GetClanAccountID()) == (0, _._)())
            return (0, _.jsxs)(_.Fragment, {
              children: [
                _ &&
                  (0, _.jsx)(_, {
            ...
            _ = _.useCallback(
              (_) => {
                _.GetEventModel().jsondata.meet_steam_schedules ||
                  ...
                  _(_, _.nodes.meetsteamscheduleview, _.schedule_id),
                  _();
              },
              [_, _, _, _],
            );
        ...
        function _(_, _, _) {
          return new _._(_, (_, _, _, _) => {
            const _ = _[1];
            if (!_.BHasEmoticon(_)) return null;
