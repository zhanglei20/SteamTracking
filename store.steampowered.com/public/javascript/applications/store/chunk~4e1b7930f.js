  ...
  [8713],
  {
            ...
            for (let c = 0; c < e.length; c++) {
              ...
              switch (i.type) {
                case 0:
                  "[" == m
                    ? ((i.type = 2), (n = !0))
                    : ((i.type = 1), "\\" == m && t ? (s = !s) : (i.text += m));
                  break;
                case 2:
                case 3:
                  if ("/" == m && n) (i.type = 3), (i.text = ""), (n = !1);
                  else if ("[" != m || s)
                    if ("]" != m || s)
                      "\\" == m && t
                        ? ((i.text += m), (s = !s), (n = !1))
    ...
    65689: (e, t, r) => {
      ...
      class S extends s.Message {
        ...
        constructor(e = null) {
          super(),
            S.prototype.total_stats || a.Sg(S.M()),
      ...
      class R extends s.Message {
        ...
        constructor(e = null) {
          super(),
            R.prototype.median_achievements || a.Sg(R.M()),
            s.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class I extends s.Message {
        ...
        constructor(e = null) {
          super(),
            I.prototype.new_releases || a.Sg(I.M()),
            s.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class U extends s.Message {
        ...
        constructor(e = null) {
          super(),
            U.prototype.games_played || a.Sg(U.M()),
            s.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
    ...
    75048: (e, t, r) => {
      ...
      function w(e) {
        const { steamid: t } = e,
          ...
          s = (0, g.M8)(),
          a = (0, f.T)(),
          o = s.data?.get(new d.b(t).GetAccountID()),
        ...
        return (0, i.jsxs)(i.Fragment, {
          children: [
            ...
            (0, i.jsxs)("div", {
              ...
              children: [
                (0, i.jsx)(B, { className: n.ProfileRoleIcon, role: t }),
                (0, i.jsx)("div", {
      ...
      function v(e) {
        ...
        return (0, i.jsxs)("div", {
          ...
          children: [
            (0, i.jsx)(S, { role: r, persona: t, isSelf: a }),
            s &&
              (0, i.jsx)("div", {
    ...
    30193: (e, t, r) => {
      ...
      class l {
        ...
        SearchEmoticons(e, t = 25, r = !0) {
          ...
          function d(e, t, r) {
            for (let i of e) if (!m(i, t, r(i))) break;
          }
          return (
    ...
    83059: (e, t, r) => {
      ...
      class u {
        ...
        constructor() {}
        Init() {
          this.m_SteamInterface = new n.D(d.TS.WEBAPI_BASE_URL);
        }
      }
      function p(e) {
      ...
      function _(e, t) {
        ...
        return (
          ...
          (0, m.hL)(u.Get().GetItemsByCategoryAndClassCallback(e, t), s),
          r
        );
      }
    },
    ...
    73022: (e, t, r) => {
      ...
      function u(e) {
        const [t, r] = (0, a.useState)(d.Get().GetRegistration(e));
        return (
          (0, a.useEffect)(() => {
        ...
        o.useEffect(() => {
          ...
          const t = () => {
            ...
            (M.current = window.setTimeout(() => {
              ...
              (h.current = r),
              S.current ? (v(S), w(!1)) : B && e();
          };
          return (
            _.subscribe(t),
            () => {
              _.unsubscribe(t), v(S), v(M);
            }
          );
        }, [_, B]);
    ...
    44736: (e, t, r) => {
      ...
      function M() {
        return (0, l.q3)(() => S.Get().BIsLoading());
      }
      (0, h.Cg)([w.sH], S.prototype, "m_isLoading", void 0),
        (0, h.Cg)([w.sH], S.prototype, "m_existingRegistrations", void 0),
        (0, h.Cg)([w.sH], S.prototype, "m_selections", void 0),
        (0, h.Cg)([w.XI.bound], S.prototype, "SetSelection", null);
      var v = r(60746),
        C = r(53835),
        x = r(51706),
        j = r(738),
      ...
      function P(e) {
        const {
          ...
          [S, M] = d.useState(void 0),
          [v, j] = d.useState(void 0),
          I = d.useMemo(() => {
            const e = [];
            return (
              null == v &&
          ...
          n =
            ...
            (0, l.q3)(() =>
              a
                .filter((e) =>
                  e.sessions.some(
                    (t) => S.Get().GetRegistrationStatus(e.group_id, t.id) == o,
                  ),
                )
      ...
      function Q(e) {
        ...
        return (0, l.q3)(() => S.Get().BHasSomeRegistration())
          ? (0, i.jsx)(X, { eventModel: t, accountID: o.iA.accountid })
          : null;
      }
      function X(e) {
      ...
      function ee(e) {
        const { groupData: t, eventModel: r } = e,
          ...
          a = Z(),
          c = M(),
          m = (0, g.my)(s, r.clanSteamID.GetAccountID(), r.GID),
          u = (0, d.useMemo)(
          ...
          _ = (0, l.q3)(() =>
            u?.reduce(
              (e, r) =>
                e.set(r.id, S.Get().GetRegistrationStatus(t.group_id, r.id)),
              new Map(),
            ),
          ),
                      ...
                      (0, i.jsx)("div", {
                        ...
                        children: (0, i.jsx)(ie, {
                          ...
                          onClick: () =>
                            p(() =>
                              ((e) => {
                                const r = S.Get().GetSelection(t.group_id) == e;
                                S.Get().SetSelection(
                                  t.group_id,
                                  r ? void 0 : e,
                                );
      ...
      function te(e) {
        const { groupData: t, children: r } = e,
          ...
          o = z.NT.GetWithFallback(t?.localized_session_description, n),
          l = z.NT.GetWithFallback(t?.localized_intended_audience, n),
          c = z.NT.GetWithFallback(t?.localized_sesssion_faq, n),
          m = (0, k.MU)(),
          [u, _] = (0, d.useState)(!1);
        return t
          ? (0, i.jsxs)("div", {
      ...
      function re(e, t, r, i) {
        ...
        return (
          1 == e
            ? ((n = (0, z.we)("#MeetSteam_Registered")), (a = D().Registered))
            : 2 == e
      ...
      function ie(e) {
        const {
          ...
          c = Math.max(0, o - (s || 0)),
          { strStatusClass: m, strStatusToken: d, bEnabled: u } = re(n, c, a),
          { sDisplayTimeZone: p, rtime_start: _, rtime_end: h } = (0, g._t)(t),
          f = (0, g.rF)(_, p),
          y = (0, g.Mr)(_, h, p);
        return (0, i.jsx)(i.Fragment, {
          children: (0, i.jsxs)("div", {
            className: (0, U.A)(D().SessionInstance, m),
            children: [
              (0, i.jsx)("div", {
              ...
              (0, i.jsxs)("button", {
                className: (0, U.A)(D().Button, D().Background),
                disabled: !u,
                onClick: r,
                children: [
      ...
      function ae(e) {
        ...
        !(function (e, t, r, i) {
          d.useEffect(() => {
            (async () => {
              S.Get().Init(e, t, r, i), await S.Get().Load();
            })();
          }, [e, t, r, i]);
        ...
        const h = (0, g.my)(c, t.clanSteamID.GetAccountID(), t.GID),
          ...
          w = M(),
          v = m || w,
          j = (0, l.q3)(() => S.Get().BHaveSelectionsChanged()),
          I = (0, l.q3)(() => S.Get().BIsAddingOrChangingSelections()),
          T = (0, l.q3)(() => S.Get().BHasAlreadyRegistered()),
          F = (0, l.q3)(() =>
            S.Get()
              .GetSelectedGroups()
              .reduce((e, r) => {
                const i = oe(t, r),
                  s = S.Get().GetSelection(i.group_id),
      ...
      function me(e) {
        ...
        return (0, i.jsx)(de, {
          ...e,
          fnOnClick: (e, t) => {
            const r = S.Get().GetSelection(e) == t;
            S.Get().SetSelection(e, r ? void 0 : t);
          },
      ...
      function he(e) {
        const {
          ...
          [_, g, h] = (0, a.uD)(!1),
          [f, y, b] = (0, l.q3)(() => [
            S.Get().GetRegistrationStatus(t.group.group_id, t.session.id),
            S.Get().BIsRegisteredForDifferentSessionInGroup(
              t.group.group_id,
              t.session.id,
            ),
            S.Get().BGetRegistrationSessionID(t.group.group_id),
          ]),
          B = o?.find(
            (e) =>
              e.group_id === t.group.group_id && e.session_id === t.session.id,
          )?.guest_count,
          w = Math.max(0, t.session.max_capacity - (B || 0)),
          {
            strStatusClass: M,
            strStatusToken: v,
            bEnabled: j,
        ...
        return (0, i.jsx)(I.Gq, {
          toolTipContent: R
            ? (0, z.we)("#MeetSteam_AlreadyReg", (0, T.TW)(R), (0, T.KC)(R))
            : void 0,
          children: (0, i.jsxs)("div", {
            className: (0, U.A)(D().SessionInstance, M),
            children: [
    ...
    32337: (e, t, r) => {
          ...
          try {
            if (this.state.bLoading) {
              if (void 0 !== t) {
                ...
                n = (await X.ac.LoadOGGClanInfoForGroupVanity(s)).clanSteamID;
              }
      ...
      function de(e) {
        ...
        const n = s.appid,
          ...
          o = `${M.TS.MEDIA_CDN_COMMUNITY_URL}images/items/${n}/${a}`;
        return (
          "dev" == M.TS.WEB_UNIVERSE &&
          ...
          null == Ce &&
            (Ce = (0, M.Y2)()
              ? [
                  ...
                  { urlRegExp: new RegExp(Me), fnBBComponent: Ge },
                ]
              : [
                  {
                  ...
                  { urlRegExp: new RegExp(fe), fnBBComponent: Ae },
                  { urlRegExp: new RegExp(ge), fnBBComponent: Ne },
                  { urlRegExp: new RegExp(ye), fnBBComponent: Ie },
                  { urlRegExp: new RegExp(be), fnBBComponent: Ue },
                  { urlRegExp: new RegExp(Be), fnBBComponent: Oe },
                  { urlRegExp: new RegExp(we), fnBBComponent: Pe },
                  { urlRegExp: new RegExp(Se), fnBBComponent: We },
                  { urlRegExp: new RegExp(Me), fnBBComponent: Ge },
          ...
          if (r && r.length > 2) {
            ...
            "gid" == r[1]
              ...
              : "groups" == r[1]
                ...
                : isNaN(+r[2])
                  ? (a = r[2])
                  : ((s = Number(r[2])), (s = Ee(t.event, s) ? s : 0));
            const l = r[3];
            if (
              ((void 0 !== s && s > 0) ||
                void 0 !== a ||
      ...
      function Oe(e, t) {
        return (0, M.Y2)() ? null : qe(e, (0, i.jsx)($.KKS, {}), "@", t);
      }
      function Pe(e, t) {
        return (0, M.Y2)() ? null : qe(e, (0, i.jsx)($.KKS, {}), "#", t);
      }
      function We(e, t) {
        return (0, M.Y2)() ? null : qe(e, (0, i.jsx)($.qcc, {}), void 0, t);
      }
      function Ge(e, t) {
        return qe(e, (0, i.jsx)($.Qte, {}), void 0, t);
      }
      function qe(e, t, r, s) {
        let n;
            ...
            "gid" == s[1]
              ...
              : "group" == s[1]
                ...
                : "groups" == s[1]
                  ...
                  : isNaN(+s[2])
                    ? (a = s[2])
                    : ((e = Number(s[2])), (e = Ee(r.event, e) ? e : 0));
            const l = s[3];
            if (
              ((void 0 !== e && e > 0) ||
                void 0 !== a ||
        ...
        if (
          ((0, o.useEffect)(() => {
            if (0 == e.appid || 0 == e.trailerBaseID)
              return void n((0, S.we)("#TrailerPlayer_ID_NotProvided"));
            (async () => {
              if (
          ...
          return e.bIsPreviewMode
            ? (0, i.jsx)("div", { className: Ze().ErrorDiv, children: s })
            : null;
        if (t)
          return (0, i.jsx)(Z.t, {
      ...
      function yt(e) {
        ...
        return (0, i.jsxs)("div", {
          ...
          children: [
            ...
            Boolean(-1 != r.type.indexOf("video")) && (0, i.jsx)($.CeX, {}),
            (0, i.jsxs)("div", {
      ...
      function xt(e) {
        ...
        return (0, i.jsx)(Ct.F, {
          ...
          screenIsWide: r,
          bAutoAdvance: s,
          className: E().ScreenshotCarousel,
          children: e.children,
        });
      }
      var jt = r(82477),
        ...
        if (!a)
          return r
            ? (0, i.jsx)("div", {
                ...
                children: (0, S.we)("#UserPolls_Editor_FailToFindModel", n),
              })
            : null;
        ...
        const { eventModel: t, userPollDef: r, lang: s } = e,
          ...
          c = (function (e, t) {
            ...
            return (0, Nt.n)({
              ...
              onSuccess: (i, s) => {
                if (1 == i.success) r.setQueryData(Ot(e, t), () => Dt(i));
                else {
      ...
      function er(e) {
        ...
        let m;
        const d = s.clanSteamID.GetAccountID();
        Boolean(c) &&
          (m = {
            backgroundImage: `url('${(0, Vt.F)(d, c)}')`,
            backgroundRepeat: "no-repeat",
            backgroundSize: "cover",
            backgroundPosition: "center",
          });
        const u = (0, o.useMemo)(() => D.b.InitFromClanID(d), [d]),
        ...
        return (0, i.jsx)("div", {
          ...
          children: (0, i.jsxs)("div", {
            ...
            children: [
              ...
              (0, i.jsx)("div", { className: Yt().PollOptions, children: n }),
              (0, i.jsxs)("div", {
      ...
      function tr(e) {
        const {
          ...
          [l] = (0, gt.q3)(() => [S.NT.GetWithFallback(t.localized_option, s)]),
        ...
        return (
          null == rr &&
            (rr = new Map([
              ...
              ["dynamiclink", { Constructor: Ke, autocloses: !1 }],
              [
                "h1",
                {
      ...
      function dr(e) {
        ...
        return (0, i.jsx)(Rt.m, { bPreviewMode: t, rewardType: s });
      }
      function ur(e) {
        ...
        return M.iA.logged_in || "test" == t || "nologinrequired" == t
          ? (0, i.jsxs)(z.$n, {
              ...
              children: [
                ...
                Boolean(a.bSuccessState) && (0, S.we)(s),
                Boolean(a.bFailedState) && (0, S.we)(n),
              ],
            })
          : (0, i.jsx)(z.$n, {
              className: "CSSActionDialogButton",
        ...
        return (0, i.jsxs)(St.eV, {
          ...
          children: [
            (0, i.jsxs)(z.Y9, {
              id: u,
              children: [
                Boolean(c.bInitialState) && (0, S.we)(n),
      ...
      function hr(e) {
        ...
        return s == h.GU ||
          s == h.bv ||
          (2 == M.TS.EUNIVERSE && s == h.mW) ||
          (1 == M.TS.EUNIVERSE && s == h.Kd)
          ? (0, i.jsxs)("div", {
              children: [
      ...
      function yr(e) {
        ...
        return o
          .useMemo(
            () => new s.B(fr.sm_BBCodeDictionary, d, i || a.TS.LANGUAGE),
            [d, i],
          )
          .ParseBBCode(t, {
            showErrorInfo: c,
    ...
    48079: (e, t, r) => {
      ...
      function y(e) {
        const {
          ...
          m = c && !a ? ("string" == typeof c ? c : c[1]) : null,
          d = Boolean(i),
          p = Boolean(n);
        return (0, s.jsx)("div", {
      ...
      (0, i.Cg)([d.oI], f.prototype, "ClosePopup", null),
        (0, i.Cg)([d.oI], f.prototype, "OnScroll", null),
        (0, i.Cg)([d.oI], f.prototype, "OnHover", null),
        (0, i.Cg)([d.oI], f.prototype, "OnLeave", null);
    },
    2921: (e, t, r) => {
      "use strict";
      r.d(t, { PE: () => A, qP: () => E, Yg: () => F });
      var i = r(7850),
        s = r(76217),
        n = r(86927),
        a = r(42834),
      ...
      class U {
        ...
        static g_Self = null;
        static Get() {
          return U.g_Self || (U.g_Self = new U()), U.g_Self;
        }
      }
      function z(e) {
        const { categoryID: t } = e,
          r = U.Get().m_rgCategories.find((e) => e.categoryid == t);
        return r
          ? (0, i.jsx)("div", {
      ...
      function F(e) {
        ...
        if (!a)
          return (0, i.jsx)("div", {
            className: (0, g.A)(S().HilightGrid, S().MediaContainer),
      ...
      function E(e) {
        ...
        return void 0 !== !m && a && c
          ? (0, i.jsx)("div", {
              className: (0, g.A)(S().HilightGrid, S().MediaContainerMM),
              children: (0, i.jsx)(k, {
                id: t,
                ...
                featureElementclassName: S().MainImage,
      ...
      function k(e) {
        ...
        if (
          ...
          return null;
        const I = x.slice(0, 3),
          U = Array.from({ length: Math.max(0, 3 - I.length) });
        return (0, i.jsxs)(i.Fragment, {
          children: [
            b,
            (0, i.jsx)("div", {
              className: l || S().MainMediaCtn,
      ...
      function N(e) {
        ...
        if (
          ...
          return null;
        let m = (0, g.A)(S().VideoLargeContainer, a && S().videoPlaying);
        return (0, i.jsxs)("div", {
          className: m,
          onClick: l,
          children: [
      ...
      function O(e) {
        ...
        return (0, i.jsxs)(s.Z, {
          focusable: !0,
          noFocusRing: !0,
          className: S().MainCapsuleWithHover,
          ...m,
          onActivate: r,
          children: [
            (0, i.jsx)("img", { className: S().MainCapsule, src: h }),
            (0, i.jsxs)("div", {
              className: S().AppDetails,
              children: [
                (0, i.jsx)("div", {
                  className: (0, g.A)(S().GameName),
                  children: u.name || "",
                }),
                (0, i.jsxs)("div", {
    ...
    90874: (e, t, r) => {
      ...
      function B(e) {
        ...
        return (0, i.jsx)(c.$n, {
          ...
          onClick: (e) => {
            t.bCanClaimNewItem
              ? (0, d.pg)((0, i.jsx)(S, { rewardType: o }), (0, g.uX)(e))
        ...
        n.useEffect(() => {
          o.bLoading ||
            ...
            a()
              .then((e) => {
                if (
                  (d(e), console.log("claim response", (0, s.HO)(e)), e.appid)
                ) {
    ...
    59096: (e, t, r) => {
      ...
      function f(e) {
        ...
        if (n?.length > 0 && a?.length > 0) {
          const s = `${d.TS.MEDIA_CDN_COMMUNITY_URL}images/items/${t}/${r}`,
            o = `${d.TS.MEDIA_CDN_COMMUNITY_URL}images/items/${t}/${a}`,
            l = `${d.TS.MEDIA_CDN_COMMUNITY_URL}images/items/${t}/${n}`;
          return (0, i.jsx)(i.Fragment, {
        ...
        {
          const n = `${d.TS.MEDIA_CDN_COMMUNITY_URL}images/items/${t}/${r || s}`;
