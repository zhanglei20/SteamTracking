  ...
  [9236],
  {
        ...
        return (0, a.jsxs)(o.s, {
          ...
          children: [
            (0, a.jsx)("div", {
              ...
              children: n && (0, a.jsx)(x, { className: i.Icon }),
            }),
            l,
          ],
        });
    ...
    40704: (e, n, t) => {
      ...
      function i(e) {
        const { viewBoxSize: n = 20, ...t } = e,
          r = t.size ? void 0 : s.IconSizeDefault;
        return (0, a.jsx)("svg", {
          viewBox: `0 0 ${n} ${n}`,
    ...
    63556: (e, n, t) => {
      ...
      var a = t(34629),
        ...
        d = t(91986);
      class g {
        m_eCurLang = (0, s.sfN)(c.TS.LANGUAGE);
        m_rgHasData = (0, i.$Y)([], s.bP9, !1);
      ...
      const u = (e) => {
        ...
        m = (e) => {
          ...
          let r = n.file_name ? n.file_name : "",
            s = p(t, r, String(n.imageid), d.Hilight);
          return (0, a.jsxs)("div", {
          ...
          for (const n of s) {
            ...
            s &&
              ...
              (i += (0, u.we)(
                ...
                (0, u.$z)(s) + " @ " + (0, m.KC)(s, { bForce24HourClock: !1 }),
              ))),
              e.push(
                (0, o.jsx)(
                  "option",
    ...
    52948: (e, n, t) => {
      ...
      function I(e, n, t) {
        ...
        let s,
          i,
          l = 0;
        const { selectedTabBackgroundDef: c, nTabSaleSectionIndex: d } =
          (function (e, n) {
            const t = e.findIndex((e) => "tabs" === e.section_type);
            if (t >= 0 && void 0 !== n) {
              const a = e[t],
        ...
        if (e?.enabled) {
          ...
          if (
            (e.groups?.forEach((t, s) => {
              if (l >= n.length || "tabs" == n[l].section_type) return;
              const i = new Array();
              for (
                let e = 0;
                e < (t?.num_sections || 0) && l < n.length;
                ++e, ++l
              ) {
                if ("tabs" == n[l].section_type) break;
                const a = n[l].unique_id;
                i.push(a),
                  o.set(a, t.background_id),
                  0 === e && r.set(a, t.background_id);
              }
              a.set(t.background_id, {
                nBackgroundGroupID: t.background_id,
                sectionUniqueIDs: i,
                nSaleSectionLastIndex: l - 1,
                nUniqueIDNextSaleSection:
                  l < n.length && (!d || l < d) ? n[l].unique_id : void 0,
              });
              if (s + 1 == g && e.last_group_until_cover_section_until_end)
                for (
                  let e = l;
                  e < n.length && (!c || !c.enabled || e < d);
                  ++e
                ) {
                  if ("tabs" == n[e].section_type && c?.enabled) break;
                  const a = n[e].unique_id;
                  o.set(a, t.background_id);
                }
            }),
            l < n.length && (!d || l < d) && (s = n[l].unique_id),
            c?.enabled && void 0 !== d)
          ) {
            let e = d;
            const s = c.groups.length;
            for (
              c.groups.forEach((i, l) => {
                if (e >= n.length) return;
                const d = new Array();
                for (let a = 0; a < i.num_sections && e < n.length; ++a, ++e) {
                  const s = n[e],
                    l = s.unique_id;
                  (0, v.bF)(t, s)
                    ? (d.push(l),
                      o.set(l, i.background_id),
                      0 === a && r.set(l, i.background_id))
                    : --a;
                }
                let g = e;
                for (; g < n.length && !(0, v.bF)(t, n[g]); ) g += 1;
                ...
                if (l + 1 == s && c.last_group_until_cover_section_until_end)
                  for (let t = e; t < n.length; ++t) {
                    if ("tabs" == n[t].section_type && c?.enabled) break;
                    const e = n[t].unique_id;
                    o.set(e, i.background_id);
                  }
              });
              e < n.length && !(0, v.bF)(t, n[e]);
            )
              e++;
            e < n.length && (i = n[e].unique_id);
          }
        } else n?.length > 0 && (s = n[0].unique_id);
        return {
          mapGroupToSections: a,
          nFirstSaleSectionIDWithoutGroup: s,
          mapSectionToGroup: o,
          mapFirstSectionToGroup: r,
          selectedTabBackgroundDef: c,
          nTabSaleSectionIndex: d,
      ...
      function k(e, n, t, o) {
        let r = e.jsondata.sale_background_img_groups.groups.find(
          (e) => e.background_id === n.groupID,
        );
        if (!r && o >= 0) {
          const t = e.GetSaleSectionFirstMatchByType("tabs"),
            a = t?.tabs?.find((e) => e.unique_id == o);
          r = a?.tab_background_img_groups?.groups?.find(
            (e) => e.background_id == n.groupID,
          );
        }
        return (0, a.jsx)(
          D,
          {
            eventModel: e,
            displayDef: r,
            derivedGroupInfo: n.derivedGroupInfo,
            children:
              r &&
              r.randomize_section_order &&
              t !== C.S.EPreviewMode_EditBackground
                ? (0, a.jsx)(E, {
                    clanEventGID: e.GID,
      ...
      function E(e) {
        const { clanEventGID: n, elSaleSections: t } = e,
          [o, r] = (0, S.M)(`sale_section_seed_${n}`, (0, f.m)());
        if (!t || 0 === t.length) return null;
        if (t.length > 1 && void 0 !== o) {
          const e = (0, f.A)(o);
          return (0, a.jsx)(a.Fragment, { children: w.fW(t, 0, e) });
        }
      ...
      function D(e) {
        const {
          ...
          c = s.useCallback(
            (e, n) => {
              b.set(i.nBackgroundGroupID, n);
            },
            [i],
          ),
          d = (0, h.w6)(c);
        if (!t || (Array.isArray(t) && 0 == t.length)) return null;
        if (!n) return (0, a.jsx)(a.Fragment, { children: t });
        let g;
        if (n.localized_background_art) {
          const e = (0, o.LgB)(l),
            t =
              e in n.localized_background_art
                ? e
                : _.A0.GetLanguageFallback(x.TS.LANGUAGE),
            a = n.localized_background_art[t];
          a && (g = j.zU.GenerateURLFromHashAndExt(r.clanSteamID, a));
        }
        let u = "linear-gradient(";
        switch (n.gradient_setting) {
          case "top-to-bottom":
            u += "to bottom,";
            break;
          case "left-to-right":
        ...
        n.background_color1 &&
        n.background_color2 &&
        n.background_color1 != n.background_color2
          ? ((u += " " + n.background_color1),
            (u += ", " + n.background_color2),
            (u += ")"))
          : (u = null);
        const m =
            n.background_color1 &&
            (!n.background_color2 ||
              "single-color" == n.gradient_setting ||
              n.background_color1 == n.background_color2),
          v = "cover" !== n.scaling_setting && "unset" !== n.position_setting,
          I = {
            backgroundImage: u ? `url(${g}), ${u}` : `url(${g})`,
            backgroundSize: n.scaling_setting,
            backgroundRepeat: n.repeat_setting,
            backgroundPosition: v ? n.position_setting : void 0,
            backgroundColor: m ? n.background_color1 : void 0,
            overflowY: "hidden",
          };
        return (0, a.jsx)("div", {
          ref: d,
          style: I,
          id: "background_group_" + n.background_id,
          children: t,
        });
      }
      var A = t(60860),
      ...
      async function M(e, n, t) {
        const a = (0, L.Fd)("partnereventpermissions", "application_config");
        if (
          (function (e) {
            const n = e;
            if (
              ...
              return (
                "number" == typeof n[0].clanid && "number" == typeof n[0].appid
              );
            return !1;
          })(a)
        ) {
          const n = a.find((n) => (n.clanid = e));
          if (n) {
            let { success: e, warn_msg: t, err_msg: a, ...o } = n;
            return o;
          }
        }
        if (y.iA.logged_in) {
          const n = B.b.InitFromClanID(e);
          let t = `${y.TS.COMMUNITY_BASE_URL}gid/${n.ConvertTo64BitString()}/ajaxgetpartnereventpermissions/`;
          "partnerweb" == (0, N.yK)()
            ? (t = `${y.TS.PARTNER_BASE_URL}partnerevents/ajaxgetpartnereventpermissions?clanaccountid=${e}`)
            : "store" == (0, N.yK)() &&
              (t = `${y.TS.STORE_BASE_URL}events/ajaxgetpartnereventpermissions?clanaccountid=${e}`);
          const a = await fetch(t, { method: "GET", credentials: "include" });
          if (200 == a.status) {
            const e = await a.json();
            if (e) {
              let { success: n, warn_msg: t, err_msg: a, ...o } = e;
              return o;
            }
          }
        }
      ...
      function P(e) {
        return ["useEventUserPermissions", y.iA.accountid, e];
      }
      var F = t(55672),
        O = t(50909),
        z = t.n(O);
      function H(e) {
        const { eventModel: n } = e,
          { data: t } = R(n.clanSteamID.GetAccountID());
        if (
          !t ||
          ...
          return;
        const o = n.GetAllTags(),
          r = [];
        return (
          o.includes("hide_store") &&
            r.push(F.Z.Localize("#Sale_SaleEventIsHidden_Reason_ProductHide")),
          o.includes("mod_hide_store") &&
            t.support_user &&
            r.push(F.Z.Localize("#Sale_SaleEventIsHidden_Reason_Mod")),
          !n.BIsVisibleEvent() &&
            o.includes("contenthub") &&
            r.push(F.Z.Localize("#Sale_SaleEventIsHidden_ContentHub_Preview")),
          n.BIsVisibleEvent() && 0 == r.length
            ? void 0
            : (0, a.jsx)("div", {
                className: z().SalePageHiddenWarning,
                children: (0, a.jsxs)("div", {
                  children: [
                    !n.BIsVisibleEvent() &&
                      (0, a.jsx)("div", {
                        className: z().WarningText,
                        children: F.Z.Localize("#Sale_SaleEventIsHidden"),
                      }),
                    r.length > 0 &&
                      (0, a.jsxs)("div", {
                        className: z().WarningText,
      ...
      function J(e) {
        ...
        return n
          ? (0, a.jsx)("div", {
              className: K.MenuBackgroundReflection,
              children: (0, a.jsx)("img", { alt: "", src: n }),
            })
          : null;
      }
      var X = t(62641),
      ...
      function ie(e) {
        ...
        return (0, a.jsx)(l.Z, {
          className: (0, ne.A)({
            [se().SubMenuOuterCtn]: !0,
            [se().isOpen]: i,
          }),
          onMouseEnter: () => {
            d.current && window.clearTimeout(d.current), c(!0);
          },
          onMouseLeave: () => {
            d.current && window.clearTimeout(d.current),
              (d.current = window.setTimeout(() => c(!1), 180));
          },
          children: (0, a.jsx)("div", {
            className: se().SubMenuCtn,
            style: { ...(0, oe.Vb)(t, n, r) },
            children: t.menu_items.map((e) =>
              (0, a.jsx)(
                "div",
                {
                  className: se().SubMenuItemCtn,
                  children: (0, a.jsx)(le, {
                    language: o,
                    mainItem: e,
                    subMenu: t,
      ...
      function le(e) {
        const { language: n, mainItem: t, subMenu: i, clanAccountID: l } = e,
          [c, d] = (0, s.useState)(!1),
          [g, u, m, p] = (0, r.q3)(() => [
            t.sub_menu_url,
            ce(t.sub_menu_url, l),
            t.localized_sub_menu_name?.[n] ||
              t.localized_sub_menu_name?.[o.Bhc] ||
              "unknown",
            t.sub_menu_icon?.localized_media?.[n]?.image ||
              t.sub_menu_icon?.localized_media?.[o.Bhc]?.image ||
              void 0,
          ]);
        let _ = i.label_color || "#DBDFE2";
        return (
          u
            ? (_ = i.selected_label_color || _)
            : c && (_ = i.hover_label_color || _),
          (0, a.jsxs)(te.Ii, {
            className: se().SubMenuItemText,
            style: { color: _ },
            href: g,
            onMouseEnter: () => d(!0),
            onMouseLeave: () => d(!1),
            children: [
              (0, a.jsx)("div", { className: se().TextLabel, children: m }),
              Boolean(p) &&
                (0, a.jsx)("span", {
      ...
      function ce(e, n) {
        try {
          const t = window.location.pathname.toLowerCase(),
            a = new URL(e || ""),
            o = `/curator/${n}/sale/${(a.pathname.split("/").filter(Boolean).pop() || "").toLocaleLowerCase()}`;
          return a.pathname.toLocaleLowerCase() === t || o === t;
        } catch {
          return !1;
        }
      }
        ...
        return Boolean(r || o)
          ? (0, a.jsx)(u.tH, {
              children: (0, a.jsxs)("video", {
                ...
                style: {
                  backgroundColor: t
                    ? n.jsondata.sale_background_color
                    : void 0,
                },
                children: [
                  o && (0, a.jsx)("source", { src: o, type: "video/webm" }),
                  r &&
                    !N.TS.IN_CLIENT &&
                    (0, a.jsx)("source", { src: r, type: "video/mp4" }),
                ],
              }),
            })
          : null;
      ...
      function ue(e) {
        const { event: n, language: t, children: o, bIsPreview: i } = e,
          l = s.useRef(null),
          c = (0, de.m0)(n, "sale_header", t),
          [d] = (0, r.q3)(() => [n.jsondata.sale_sub_menu]);
        s.useEffect(() => {
          if (!c) return;
          const e = new Image();
          (e.onload = () => {
            const n = (100 * e.width) / 950 + "%";
            l.current && l.current.style.setProperty("--background-scale", n);
          }),
            (e.src = c);
        }, [c]);
        const g = n.jsondata.sale_sections?.some(
            (e) => "contenthubmaincarousel" === e.section_type,
          ),
          u =
            n.jsondata.item_source_type === X.w.k_EContentHub &&
            ((n.jsondata.sale_vanity_id &&
              n.jsondata.sale_vanity_id.includes("contenthubsalepage_")) ||
              g),
          m = c ? `url(${c})` : "none";
          ...
          children: [
            ...
            (0, a.jsx)("div", {
              ...
              children: (0, a.jsxs)("div", {
                ...
                ref: l,
                children: [
                  c && "coverBlur" == n.jsondata.sale_background_repeat
                    ? (0, a.jsx)("img", {
                        className: (0, ne.A)(
                          ee().SalePageBackground,
                          ee().BackgroundImage,
                          ee().Blur,
                        ),
                        src: c,
                  ...
                  (0, a.jsx)(ge, { event: n, bIsPreview: i }),
      ...
      function he(e) {
        const { eventModel: n, language: t } = e,
          [o, s] = (0, r.q3)(() => [
            ...
            _.NT.GetWithFallback(n.jsondata.localized_sale_logo, t),
          ]);
        return s && s?.length > 0
          ? o
            ? (0, a.jsx)("a", {
                className: _e().SalePageLogoCtn,
                href: N.TS.STORE_BASE_URL + o,
                children: (0, a.jsx)(xe, { ...e }),
              })
            : (0, a.jsx)("div", {
                className: (0, ne.A)(_e().SalePageLogoCtn, "SalePageLogoCtn"),
                children: (0, a.jsx)(xe, { ...e }),
              })
          : null;
      }
      function xe(e) {
        const { eventModel: n, language: t } = e,
          o = (0, de.m0)(n, "sale_logo", t);
        return (0, a.jsx)("img", { src: o, alt: "logo" });
      }
      var ve = t(99487),
        be = t(22797);
      class Ie {
        ...
        SortKey(e, n) {
          return (
            ...
            (this.m_mapVisible.get(this.Keyify(n)) || 0)
          );
        }
        BMarkAppVisibile(e, n) {
          const t = this.EnsureOwnerSetExists(e),
            a = this.Keyify(n);
          return (
            t.add(a),
        ...
        BMarkAppNotVisible(e, n) {
          if (!this.IsAlreadyVisible(n)) return !1;
          const t = this.EnsureOwnerSetExists(e),
            a = this.Keyify(n);
          return !!t.has(a) && (this.DecrementAppVisibility(a), !0);
        }
        ...
        EnsureOwnerSetExists(e) {
          let n = this.m_mapOwners.get(e);
          return (
            n ||
              (this.m_mapOwners.set(e, new Set()),
              (n = this.m_mapOwners.get(e))),
            n
          );
        }
        DecrementAppVisibility(e) {
          const n = (this.m_mapVisible.get(e) ?? 0) - 1;
          n > 0 ? this.m_mapVisible.set(e, n) : this.m_mapVisible.delete(e);
        }
      }
      var je = t(81393),
        Se = t(61336),
      ...
      function Le(e) {
        const { color: n, onChange: t, strTitle: o, disableAlpha: r } = e,
          [i, l] = (0, s.useState)(() => n || "rgba(255, 255, 255, 1)"),
        ...
        return (0, a.jsxs)("div", {
          children: [
            Boolean(o) && (0, a.jsx)(fe.JU, { children: o }),
            (0, a.jsx)(Ae.xk, {
              onChange: (e) => {
                const n = (function (e) {
      ...
      function Xe(e) {
        const {
          ...
          [i, l] = (function (e) {
            ...
            return [
              {
                onDragEnter: s.useCallback((e) => {
                  ((e.dataTransfer.files && e.dataTransfer.files[0]) ||
                    (e.dataTransfer.types &&
                      "Files" == e.dataTransfer.types[0])) &&
                    t(!0);
                }, []),
                onDragLeave: s.useCallback((e) => {
                  Be.NO(e) && t(!1);
                }, []),
                onDragEnd: s.useCallback(() => t(!1), []),
                onDragOver: n ? Qe : void 0,
                onDrop: s.useCallback(
                  (n) => {
          ...
          [c, d] = (function (e, n) {
            const t = s.useRef(void 0),
              ...
              r = s.useCallback(() => t.current.click(), []);
            return [
              Ze.createPortal(
                (0, a.jsx)("form", {
                  onSubmit: Qe,
        ...
        return (0, a.jsxs)("div", {
          ...i,
          className: (0, ne.A)(
            l ? Je().DragAndDropContainerDragging : Je().DragAndDropContainer,
            "DragAndDropContainer",
          ),
          children: [
            Boolean(t) && t(),
            (0, a.jsx)("div", {
              children: r || (0, _.we)("#ImagePicker_DragAndDrop"),
            }),
            (0, a.jsxs)("div", {
              className: Je().ImageUploadBar,
              children: [
                c,
                (0, a.jsxs)("label", {
                  onClick: d,
                  children: [
                    (0, a.jsxs)("span", {
                      children: [(0, _.we)("#ImagePicker_OrBrowse"), " "],
                    }),
                    (0, a.jsx)("span", {
                      className: Je().SelectImageButton,
                      children: (0, _.we)("#selectimage_select_file"),
                    }),
                  ],
                }),
              ],
          ...
          u = s.useCallback(
            async (e) => {
              ...
              for (let e = 0; e < t.length; e++) {
                const r = t[e],
                  { language: s } = (0, ze.jj)(r?.name, g);
                try {
                  const t = (0, ze.PD)(s, g, c);
                  (o = await n.AddImageForLanguage(r, t)),
                    o ||
                      (console.error(
          ...
          children: [
            ...
            (0, a.jsx)(on, {
              ...
              fnOnUploadImageRequested: async () => {
                const e = await n.UploadAllImages(i);
                t?.(e);
              },
            }),
          ],
      ...
      function on(e) {
        const { imageUploader: n, fnOnUploadImageRequested: t } = e,
          [o] = (0, r.q3)(() => [n.GetUploadImages()]),
          s = o.some((e) => "pending" == e.status),
          i = o.some(
            (e) =>
              "waiting" == e.status ||
              "uploading" == e.status ||
        ...
        return (0, a.jsxs)("div", {
          style: { display: "flex" },
          className: nn().UploadPreviewButtonsCtn,
          children: [
            Boolean(o.length) &&
              (0, a.jsx)(fe.$n, {
                style: { margin: "8px" },
                onClick: t,
                disabled: !s,
                children: (0, _.we)("#ImageUpload_Upload"),
              }),
            Boolean(o.length) &&
              (0, a.jsx)(fe.$n, {
                style: { margin: "8px" },
                ...
                disabled: i,
                children: (0, _.we)("#ImageUpload_Clear"),
              }),
          ],
        });
      }
      const rn = (0, qe.PA)(function (e) {
        const { asset: n, fnOnRemove: t, languageRealms: r } = e,
          ...
          l = n.BSupportsLanguages()
            ? (function (e) {
                ...
                for (const n of e) {
                  if (n == o.X51) continue;
                  const e = (0, _.we)("#Language_" + (0, o.LgB)(n));
                  t.push({ label: e, data: n });
                }
                return (
                  t.sort((e, n) => e.label.localeCompare(n.label)),
                  t.forEach((e) => n.push({ label: e.label, data: e.data })),
                  t
                );
              })(
                _.A0.GetLanguageListForRealms(r ?? [Ve.TU.k_ESteamRealmGlobal]),
              )
            : null,
        ...
        "pending" == n.status &&
          (c.needsCrop
            ? (g = (0, _.we)("#ImageUpload_NeedsCrop"))
            : c.error && (g = (0, _.we)("#ImageUpload_Invalid")));
        let u;
        const m = n.GetCurrentImageOption();
        m && (u = s?.find((e) => e.data.sKey == m.sKey)?.data);
        u || (u = s?.[0]?.data);
        return (0, a.jsxs)("div", {
          className: nn().UploadPreview,
          children: [
            (0, a.jsx)("div", {
              className: nn().UploadPreviewDelete,
              onClick: () => t(n),
              children: (0, a.jsx)(q.sED, {}),
            }),
            (0, a.jsx)(sn, { asset: n }),
            l &&
              (0, a.jsx)(fe.m, {
            ...
            d &&
              c.warnings?.map((e, n) =>
                (0, a.jsx)(
                  "div",
                  { className: nn().UploadPreviewWarning, children: e },
                  `warning${n}`,
                ),
              ),
            d &&
              c.messages?.map((e, n) =>
                (0, a.jsx)(
                  "div",
                  { className: nn().UploadPreviewMessage, children: e },
                  `message${n}`,
                ),
              ),
            (0, a.jsxs)("div", {
              className: (0, ne.A)({
                ...
                [nn().UploadPreviewError]: "failed" == n.status,
              }),
              children: [
                g,
                (0, tn.o)(n.status) &&
                  (0, a.jsx)("div", {
                    ...
                    children: (0, a.jsx)(be.t, { size: "small" }),
                  }),
              ],
            }),
            (0, a.jsx)("div", {
              className: nn().UploadPreviewError,
              children: n.message,
            }),
            d &&
              c.error &&
            ...
            d &&
              ...
              (0, a.jsx)(fe.jn, {
                    ...
                    if (n instanceof Ye.M7) {
                      ...
                      const t = window,
                        o = (0, a.jsx)($e.q, {
                          ...
                          fileType: e.forceFileType || We.bg.dU,
                        });
                      (0, Ce.HT)(o, t, "CropModal", {
                ...
                children: (0, _.we)("#ImageUpload_OpenEditor"),
              }),
          ],
        });
      });
      function sn(e) {
        ...
        return n.BIsVideo()
          ? (0, a.jsxs)("div", {
              className: nn().PreviewImgCtn,
              onClick: (e) =>
                (0, Ce.pg)((0, a.jsx)(ln, { asset: n }), (0, Be.uX)(e)),
              children: [
                (0, a.jsxs)("span", {
                  className: nn().PreviewImgInfo,
                ...
                (0, a.jsx)("video", {
                  ...
                  loop: !0,
                  muted: !0,
                  children: (0, a.jsx)("source", { src: n.dataUrl }),
                }),
              ],
            })
          : (0, a.jsx)("div", {
      ...
      const vn = s.memo(function (e) {
        const {
          fileNameSearch: n,
          clanAccountID: t,
          imageInsertCallBack: o,
          fnOnExpandImage: r,
          showImageActions: s = !0,
      ...
      function bn(e) {
        const { clanAccountID: n, fileNameSearch: t, children: o } = e,
          r = (0, Fe.n9)(n),
          s = t.trim().toLowerCase() || "",
          i = Fe.pU.GetFilteredClanImagesList(r, s);
        if (0 == i.length) {
          const e = B.b.InitFromClanID(n);
          let t = Fe.pU.GetLoadState(e);
          return t && t.loaded
            ? (0, a.jsx)(
                "div",
                {
                  className: _n().ResultNotification,
                  children:
                    s.length > 0
            ...
            : t && t.errMsg
              ? (0, a.jsx)(
                  "div",
                  {
                    className: _n().ErrorCode,
                    children: (0, _.we)("#ImagePicker_Error", t.errMsg),
                  },
                  "ImagePicker_Result",
                )
              : (0, a.jsx)(
      ...
      function In(e) {
        const {
          ...
          m = () => {
            d(!0);
            let e = B.b.InitFromClanID(n.clanAccountID);
            Fe.pU
              .DeleteClanImage(e, n)
              .then((e) => {
                e.success != dn.R && u((0, He.H)(e).strErrorMsg), d(!1);
              })
              .catch((e) => {
                u((0, He.H)(e).strErrorMsg), d(!1);
              }),
              p();
          },
          p = () => {},
          h = n.file_name ? n.file_name : "",
          x = (0, un.r)(t, h, String(n.imageid), _n().Hilight),
          v = j.zU.BIsClanImageVideo(n),
          b = i && !c && !v,
          I = i && !c && !v,
          S = i && !c && v,
          f = i && !c && !v;
        return (0, a.jsx)(mn.K, {
          ...
          className: _n().ImageWrapperContainer,
          rootMargin: "0px 0px 100% 0px",
          children: (0, a.jsxs)("div", {
            className: _n().ImageButton,
            children: [
              (0, a.jsx)("div", {
                className: _n().ImageWrapper,
                style: { backgroundImage: v ? "" : `url( '${n.thumb_url}' )` },
                draggable: !0,
                onDragStart: (e) => {
                  n.url &&
                    (e.dataTransfer.setData("text", n.url),
                    Fe.pU.GetClanImageDragListener().forEach((e) => {
                      e(B.b.InitFromClanID(n.clanAccountID), !0);
                    }));
                },
                onDragEnd: (e) => {
                  n.url &&
                    Fe.pU.GetClanImageDragListener().forEach((e) => {
                      e(B.b.InitFromClanID(n.clanAccountID), !1);
                    });
                },
                onDoubleClick: g,
                onClick: () => {
              ...
              b &&
                (0, a.jsx)("span", {
                  className: _n().Full,
                  onClick: g,
                  children: (0, _.we)("#ImagePicker_FullSize"),
                }),
              c &&
                (0, a.jsx)(be.t, {
                  size: "medium",
                  className: _n().FloatingThrobber,
                }),
              I &&
                (0, a.jsx)("span", {
                  className: _n().Thumb,
                  onClick: () => o(n, cn.k_eInsertThumbnail),
                  children: (0, _.we)("#ImagePicker_Thumbnail"),
                }),
              f &&
                l &&
                (0, a.jsx)(jn, {
              ...
              S &&
                (0, a.jsx)("span", {
                  className: _n().Full,
                  onClick: () => o(n, cn.k_eInsertVideo),
                  children: (0, _.we)("#ImagePicker_Video"),
                }),
              !c &&
                (0, a.jsx)("span", {
                  className: _n().Delete,
                      ...
                      (0, a.jsx)(we.o0, {
                        ...
                        children: (0, a.jsxs)(s.Fragment, {
                          children: [
                            ...
                            (0, a.jsx)("br", {}),
                            (0, a.jsx)("div", {
                              children: (0, _.we)("#ImagePicker_DeleteWarning"),
                            }),
                          ],
                        }),
                      }),
              ...
              (0, a.jsx)("div", {
                className: _n().ImageWrapperFilename,
                title: h,
                children: x,
              }),
            ],
      ...
      function jn(e) {
        const {
          ...
          r = (0, gn.Ec)(n.clanAccountID);
        return o || !r.valve_admin
          ? null
          : (0, a.jsx)("span", {
              className: (0, ne.A)(_n().Localized, ee().ValveOnlyBackground),
              onClick: () => t?.(n),
              children: "(VO) " + (0, _.we)("#ImagePicker_Localized"),
            });
      }
      function Sn(e) {
        const { clanImage: n, className: t } = e;
        return j.zU.BIsClanImageVideo(n)
          ? (0, a.jsx)("video", {
              autoPlay: !0,
              loop: !0,
              muted: !0,
              ...
              children: (0, a.jsx)("source", {
                src: n.url,
                type: "video/" + (n.file_type == We.bg.nn ? "mp4" : "webm"),
              }),
            })
          : null;
      }
        ...
        return (0, a.jsxs)("div", {
          ...
          children: [
            (0, a.jsxs)("label", {
              ...
              children: [
                (0, a.jsxs)("span", {
                  children: [(0, _.we)("#ImagePicker_PreviousImages"), " "],
                }),
                (0, a.jsx)("span", {
                  className: Je().SelectImageButton,
                  children: (0, _.we)("#ImagePicker_PreviousImages2"),
                }),
              ],
            }),
            (0, a.jsx)("input", {
              ...
              onClick: (e) => {
                (0, Ce.pg)(
                  (0, a.jsx)(fn, { clanSteamID: n, OnClanImageSelected: t }),
                  (0, Be.uX)(e) ?? window,
                );
              },
            }),
      ...
      function Cn(e) {
        const {
          ...
          [d] = (0, r.q3)(() => [p.O.Get().GetCurEditLanguage()]),
          g = (0, Pe.zO)(n, t, o),
          u = e.uploaderOverride || g,
          [m, h] = s.useState(!1),
          x = s.useCallback(
            async (e, n) => {
              if (!m) {
                h(!0);
                try {
                  const { language: n } = (0, ze.jj)(e.file_name ?? "", d),
                    t = (0, ze.PD)(n, d, c);
                  await u.AddExistingClanImage(e, t);
                } catch (e) {
                  let n = (0, He.H)(e);
              ...
              i
                ? [
                    [
                      (0, a.jsx)(
                        wn,
                        { clanSteamID: n, OnClanImageSelected: x },
                        "clanartworkpicker",
                      ),
                    ],
                  ]
        ...
        return (0, a.jsx)(an, {
          ...
          fnUploadComplete: (e) => {
            for (const t of e) {
              ...
              if (e?.origimagehash) {
                const n = (0, ze.PD)(e.language, d, c);
                Oe.R.AddLocalizeImageUploaded(e.origimagehash, n);
              } else {
                const a = Fe.pU.GetClanImageByImageHash(n, e?.image_hash ?? ""),
                  o = t.image.GetCurrentImageOption();
                if (a && o) {
                  const e = (0, ze.PD)(t.image.language, d, c);
                  l(o.artworkType, a, e);
                }
              }
            }
      ...
      function Ln(e) {
        const {
          ...
          [d, g] = (0, s.useState)(o),
          u = B.b.InitFromClanID(n.clanAccountID),
          m = (0, r.q3)(() =>
            j.zU.GenerateURLFromHashAndExt(u, j.zU.GetHashAndExt(n) ?? ""),
          );
        return (0, a.jsx)(we.o0, {
          ...
          closeModal: t,
          children: (0, a.jsxs)("div", {
            className: (0, ne.A)(ee().FlexColumnContainer, Gn().ReassignCtn),
            children: [
              (0, a.jsx)("div", {
                className: Gn().ImagePreviewContainer,
                children: (0, a.jsx)("img", {
                  className: Gn().ArtworkPreview,
                  src: m,
                }),
              }),
              (0, a.jsx)(Tn.Ng, {
      ...
      function Vn(e) {
        ...
        (0, Fe.mr)(n.GetAccountID());
        const l = s.useMemo(() => {
            let e = new Array();
            const n = _.A0.GetLanguageListForRealms([
              Ve.TU.k_ESteamRealmGlobal,
              Ve.TU.k_ESteamRealmChina,
            ]);
            for (const a of n) {
              const n = t(a);
              if (n) {
                const t = (0, o.LgB)(a),
                  r = (0, _.we)("#Language_" + t);
                e.push({ lang: a, strLang: t, locLang: r, imgHash: n });
              }
            }
            return (
              (e = e.sort((e, n) =>
                e.locLang > n.locLang ? 1 : e.locLang < n.locLang ? -1 : 0,
              )),
              e
            );
          }, [t]),
          [c, d, g] = (0, zn.uD)();
        return (0, a.jsxs)("div", {
          className: Gn().SelectImageLanguagesCtn,
          children: [
            (0, a.jsx)("div", {
              className: Gn().SelectImageTitle,
              children: (0, _.we)("#selectimage_uploaded_languages"),
            }),
            (0, a.jsx)("div", {
              className: Gn().LanguageListContainer,
              children: l.map((t) =>
                (0, a.jsx)(
                  Wn,
                  { langData: t, ...e },
                  "lang_select_" + n.GetAccountID() + " " + t.strLang,
                ),
              ),
            }),
            !!i &&
              (0, a.jsxs)(fe.$n, {
                ...
                children: [
                  ...
                  (0, a.jsx)(qn.o, {
                    tooltip: (0, _.we)("#Sale_RemoveAll_Tooltip"),
                  }),
                ],
              }),
            (0, a.jsx)(we.EN, {
      ...
      function Wn(e) {
        const {
          ...
          [d, g] = (0, r.q3)(() => {
            const e = Fe.pU.GetClanImageByImageHash(n, t.imgHash);
            let a = "";
            e &&
              (a = j.zU.GenerateURLFromHashAndExtAndLang(
                n,
                j.zU.GetHashAndExt(e),
                Mn.wI.full,
                t.lang,
              ));
            let o = Gn().LanguageSelectorSelected;
            return (
              s != t.lang &&
                (o = t.imgHash
                  ? Gn().LanguageSelector
                  : Gn().LanguageSelectorNoData),
              [a, o]
            );
          });
        return (0, a.jsxs)("div", {
          id: t.strLang,
          className: Gn().LanguageContainer,
          onClick: (e) => {
            let n = (0, o.sfN)(e.currentTarget.id);
            i(n);
          },
          children: [
            (0, a.jsx)("div", { className: g, children: t.locLang }),
            (0, a.jsxs)("span", {
              className: Gn().LanguageOptions,
              children: [
                Boolean(d) &&
                  (0, a.jsx)("a", {
                    href: d,
                    target: "_blank",
                    children: (0, a.jsx)(Q.he, {
                      toolTipContent: (0, _.we)("#selectimage_viewimage_ttip"),
                      children: q.YNO(),
                    }),
                  }),
                !!l && (0, a.jsx)(Yn, { ...e }),
                !!c && (0, a.jsx)(Zn, { fnOnRemoveImage: c, langData: t }),
              ],
            }),
          ],
        });
      ...
      function Yn(e) {
        const {
          ...
          m = (0, r.q3)(() => {
            ...
            return Fe.pU.GetClanImageByImageHash(n, e);
          });
        if (m)
          return (0, a.jsxs)(a.Fragment, {
            children: [
      ...
      function Zn(e) {
        const { fnOnRemoveImage: n, langData: t } = e,
          [r, s, i] = (0, zn.uD)();
        return (0, a.jsxs)(a.Fragment, {
          children: [
            (0, a.jsx)(Q.he, {
              ...
              children: (0, a.jsx)(we.EN, {
                ...
                children: (0, a.jsx)(we.o0, {
                  ...
                  strDescription: (0, _.we)(
                    ...
                    (0, _.we)("#Language_" + (0, o.LgB)(t.lang)),
                  ),
                  onOK: () => {
                    n(t.lang);
                  },
      ...
      function et(e) {
        const {
            ...
            fnFilterImageURLsForKnownFailures: d,
            langOverride: g,
          } = e,
          u = (0, Kn.c5)(),
          m = s.useCallback(
            (e) => {
              e.preventDefault(), i && i(n);
            },
            [n, i],
          ),
          p = g || (0, o.sfN)(N.TS.LANGUAGE),
          [_, h, x] = (0, r.q3)(() => [
            n.GetSummaryWithFallback(p),
            n.GetNameWithFallback(p),
            n.BShowLibrarySpotlightText(),
          ]);
        let v = "spotlight",
          b = Mn.wI.spotlight_main;
        (2434320 != n.appid && N.TS.EUNIVERSE != o.Rv) ||
          ((v = u
            ? "localized_store_app_spotlight_mobile"
            : "localized_store_app_spotlight"),
          (b = Mn.wI.full));
        let I =
          (0, $n.WC)(void 0 !== t ? void 0 : n, v, p, b) ??
          (void 0 !== t ? [t] : []);
        d && I && (I = d(I));
        const j = _.replace(/https:\/\/[^ ]*/gi, "").trimLeft();
        return (0, a.jsx)(s.Fragment, {
          children: (0, a.jsx)("div", {
            className: Xn().MajorEvent_Ctn,
            ref: e.containerRef,
            children: (0, a.jsxs)(l.Z, {
              className: (0, ne.A)(
                Xn().AppDetailsSpotlightContainer,
                Xn().MajorEventContainer,
              ),
              onActivate: m,
              focusable: !0,
              children: [
                (0, a.jsx)("div", {
                  className: Xn().MajorEventBackground,
                  children: (0, a.jsx)(Qn.c, {
                    className: Xn().MajorEventImageBackgroundBlur,
                    rgSources: I,
                    onIncrementalError: (e, n, t) => c && c(n),
                  }),
                }),
                (0, a.jsxs)("div", {
                  className: Xn().MajorEventImageContainer,
                  children: [
                    (0, a.jsx)(Qn.c, {
                      className: Xn().MajorEventImage,
                      rgSources: I,
                      onIncrementalError: (e, n, t) => c && c(n),
                    }),
                    (0, a.jsx)("div", {
                      className: Xn().MajorEventImageTemplate,
                    }),
                    (0, a.jsx)("div", {
                      className: Xn().MajoreEventImageContentContainer,
                      children:
                        x &&
                        (0, a.jsxs)("div", {
                          className: Xn().MajorEventContent,
                          children: [
                            (0, a.jsx)(Qn.c, {
                              className: Xn().MajorEventSpotlightBackground,
                              rgSources: I,
                              onIncrementalError: (e, n, t) => c && c(n),
                            }),
                            (0, a.jsxs)("div", {
                              className: Xn().MajorEventTextCtn,
                              children: [
                                (0, a.jsx)("div", {
                                  className: Xn().MajorEventTitle,
                                  children: h,
                                }),
                                (0, a.jsx)("div", {
                                  className: Xn().MajorEventSummary,
                                  children: j,
                                }),
                              ],
                            }),
                ...
                (0, a.jsx)("div", { className: Xn().BottomShadow }),
              ],
            }),
          }),
        });
      ...
      function at(e) {
        const {
          ...
          p = m(t, n),
          h = p
            ? j.zU.GenerateURLFromHashAndExtAndLang(s, p, Mn.wI.full, n)
            : "",
          [x] = (0, r.q3)(() => [ut(t, m)]);
        return 0 == x
          ? (0, a.jsxs)("div", {
              ...
              children: [
                ...
                (0, a.jsx)("div", {
                  children: (0, _.we)("#EventEditor_ArtworkMissing"),
                }),
              ],
            })
          : (0, a.jsxs)("div", {
              ...
              children: [
                "capsule" === t &&
                  (0, a.jsx)(rt, { imgURL: h, eventModel: i, langOverride: n }),
                "background" === t &&
                  (0, a.jsx)(st, {
                    imgURL: h,
                    lang: n,
                ...
                "spotlight" === t &&
                  (0, a.jsx)(it, { imgURL: h, event: i, lang: n }),
                ...
                "sale_header" === t && (0, a.jsx)(ct, { imgURL: h }),
                "sale_overlay" === t && (0, a.jsx)(dt, { imgURL: h }),
                Mn.pb.includes(t) &&
                  (0, a.jsx)("img", {
                    className: On.PreviewImg,
                    src:
                      Oe.R.GetLocalizedImageGroupForEditAsURL(s, n) ?? void 0,
                  }),
                "product_banner" === t && (0, a.jsx)(gt, { imgURL: h }),
                "product_mobile_banner" === t && (0, a.jsx)(gt, { imgURL: h }),
                "sale_logo" === t && (0, a.jsx)(gt, { imgURL: h }),
                "bestofyear_banner" === t && (0, a.jsx)(gt, { imgURL: h }),
                ...
                (0, a.jsx)(Vn, {
                  ...
                  realms: g,
                  fnLangHasData: u,
                  fnGetImageHash: (e) => Nn(m(t, e) ?? ""),
                }),
              ],
            });
      }
      function ot(e) {
        const { artworkType: n, langOverride: t, eventModel: o } = e,
          r = Dn.Fj[n],
          i = s.useMemo(
            () =>
              (function (e, n) {
                ...
                for (let e = 0; e < a; e += s)
                  for (let n = 0; n < t; n += s)
                    (r.fillStyle =
                      (n / s + e / s) % 2 == 0 ? "#a405e3ff" : "#000000"),
                      r.fillRect(n, e, s, s);
                const i = r.createLinearGradient(0, 0, t, 0);
                i.addColorStop(0, "rgba(32,32,32,0.8)"),
                  i.addColorStop(1, "rgba(60,60,60,0.8)"),
                  (r.fillStyle = i),
                  r.fillRect(0, 0, t, a);
                const l = r.createRadialGradient(
                  t / 2,
                  a / 2,
                  0,
                  t / 2,
                ...
                l.addColorStop(0, "rgba(0,0,0,0)"),
                  ...
                  r.fillText(e, t / 2, a / 2 - 20),
                  n &&
                    ((r.font = "18px Arial"), r.fillText(n, t / 2, a / 2 + 25));
                return o.toDataURL("image/png");
              })(
                (0, _.we)("#EventEditor_ArtworkType_" + n),
                `${r.width} X ${r.height}`,
              ),
            [r.height, r.width, n],
          );
        return (0, a.jsx)(it, { lang: t, imgURL: i, event: o });
      }
      function rt(e) {
        const { imgURL: n, eventModel: t, langOverride: o } = e,
          r = (0, p.E)();
        return (0, a.jsx)("div", {
          style: { display: "flex", width: "304px" },
          children: (0, a.jsx)(Fn.uY, {
            event: t,
            imageURLOverride: n,
            langOverride: o ?? r,
          }),
      ...
      function st(e) {
        const { lang: n, eventModel: t, partnerEventStore: i } = e,
          [l, c, d, g, u] = (0, r.q3)(() => [
            t.GetNameWithFallback(n),
            t.GetDescriptionWithFallback(n),
            t.GetSubTitleWithLanguageFallback(n),
            t.type,
            t.AnnouncementGID,
          ]);
        let m = c
        ...
        return (0, a.jsxs)("div", {
          className: tt().MultipleExampleContainer,
          children: [
            (0, a.jsx)("div", {
              className: tt().ExampleSectionTitle,
              children: (0, _.we)("#selectimage_preview_title_1"),
            }),
            (0, a.jsx)("div", {
              className: (0, ne.A)(tt().DetailPageExample, "DetailPageExample"),
              children: (0, a.jsxs)("div", {
                className: tt().DetailExample,
                children: [
                  (0, a.jsx)("div", {
                    className: tt().MainImageCtn,
                    children: (0, a.jsx)("img", { src: e.imgURL }),
                  }),
                  (0, a.jsx)("div", {
                    className: tt().ExampleBodyPosition,
                    children: (0, a.jsxs)("div", {
                      className: tt().ExampleContentCtn,
                      children: [
                        (0, a.jsx)("div", {
                          className: tt().TextTitle,
                          children:
                            l || (0, _.we)("#selectimage_display_event_title"),
                        }),
                        (0, a.jsx)("div", {
                          className: tt().TextSubTitle,
                          children:
                            d ||
                            (0, _.we)("#selectimage_display_event_subtitle"),
                        }),
                        (0, a.jsx)("div", {
                          className: tt().TextBody,
                          children: m,
                        }),
                      ],
                    }),
            ...
            g != o.Fwr &&
              (0, a.jsxs)(s.Fragment, {
                children: [
                  (0, a.jsx)("div", { className: tt().ExampleSpacer }),
                  (0, a.jsx)("div", {
                    className: tt().ExampleSectionTitle,
                    children: (0, _.we)("#selectimage_preview_title_2"),
                  }),
                  (0, a.jsx)("div", {
                    className: (0, ne.A)(
                      tt().DetailPageExample,
                      "DetailPageExample",
                    ),
                    children: (0, a.jsx)("div", {
                      className: tt().DetailExample2,
                      children: (0, a.jsx)(
                        Rn.He,
                        {
                          event: t,
      ...
      const it = (e) => {
          const [n] = (0, An.t7)(e.event.appid, { include_assets: !0 });
          if (!n) return null;
          const t = n.GetName(),
            o = n.GetAssets()?.GetCommunityIconURL();
          return (0, a.jsx)("div", {
            className: tt().SpotlightExample,
            children: (0, a.jsx)(et, {
              event: e.event,
              strDisplayName: t ?? "",
              gameIconUrl: o,
        ...
        lt = (e) => {
          const n = [
            (0, a.jsx)("img", { src: e.imgURL }, "img"),
            (0, a.jsx)("div", { className: Gn().BroadcastPreview }, "video"),
          ];
          return (
            "right" === e.side && n.reverse(),
            (0, a.jsx)("div", {
              className: tt().BroadcastPreviewContainer,
              children: n,
            })
          );
        },
        ct = (e) =>
          (0, a.jsx)("div", {
            className: tt().SaleHeaderPreviewContainer,
            children: (0, a.jsx)("img", {
              style: { width: "100%" },
              src: e.imgURL,
            }),
      ...
      function ut(e, n) {
        let t = 0;
        for (let a = o.Bhc; a < o.bP9; ++a)
          (n(e, a)?.length ?? 0) > 0 && (t += 1);
        return t;
      }
      var mt;
      function pt(e) {
        ...
        t === mt.k_Required
          ? (b = (0, a.jsx)("span", {
              style: { color: "#C6512B" },
              children: (0, _.we)("#EventEditor_Required"),
            }))
          : t === mt.k_Suggested
            ? (b = (0, a.jsx)("span", {
                style: { color: "#D7BC86" },
                children: (0, _.we)("#EventEditor_Suggested"),
              }))
            : t === mt.k_Requested &&
              (b = (0, a.jsx)("span", {
                style: { color: "#D7BC86" },
                children: (0, _.we)("#EventEditor_Requested"),
              }));
        let I = null;
        "capsule" === n
          ? (I = v
              ? (0, a.jsxs)(a.Fragment, {
                  children: [
                    (0, a.jsxs)("p", {
                      children: [
                        (0, a.jsx)("strong", {
                          children: (0, _.we)("#selectimage_tip_design_title"),
                        }),
                        ": ",
                        (0, _.we)("#selectimage_tip_capsule_creatorhome_1"),
                      ],
                    }),
                    (0, a.jsxs)("p", {
                      children: [
                        (0, a.jsx)("strong", {
                          children: (0, _.we)("#selectimage_tip_usage_title"),
                        }),
                        ": ",
                        (0, _.we)("#selectimage_tip_capsule_creatorhome_2"),
                      ],
                    }),
                  ],
                })
              : (0, a.jsxs)(a.Fragment, {
                  children: [
                    Boolean(x) &&
                      (0, a.jsxs)("div", {
                        className: Gn().HighlightBox,
                        children: [
                          (0, a.jsx)("p", {
                            children: (0, _.we)("#PartnerEvent_MM_ArtworkTip"),
                          }),
                          (0, a.jsx)("p", {
                            children: (0, a.jsx)("a", {
                              href: `${N.TS.PARTNER_BASE_URL}doc/store/assets/promos#popup_update`,
                              children: (0, _.we)("#PartnerEvent_MM_LearnMore"),
                            }),
                          }),
                        ],
                      }),
            ...
            : "spotlight" === n || "localized_store_app_spotlight" === n
              ...
              : "localized_store_app_spotlight_mobile" === n
                ...
                : "broadcast_left" === n || "broadcast_right" === n
                  ? (I = (0, a.jsx)(a.Fragment, {
                      children: (0, a.jsx)("p", {
                        children: (0, _.we)("#selectimage_tip_broadcast_1"),
                      }),
                    }))
                  : "sale_header" === n
                    ...
                    : "hero" === n
                      ? p &&
                        (I = (0, a.jsxs)(a.Fragment, {
                          children: [
                            (0, a.jsx)("p", {
                              children: (0, _.we)("#selectimage_tip_hero_1"),
                            }),
                            !Boolean(p.GetAssets()?.GetLibraryHeroURL()) &&
                              (0, a.jsx)("p", {
                                className: Bn.ErrorStylesBackground,
                                children: (0, _.we)(
                      ...
                      : (I =
                          ...
                          "localized_background_art" === n
                            ? (0, a.jsxs)(a.Fragment, {
                                children: [
                                  (0, a.jsx)("p", {
                                    children: (0, _.we)("#ImagePickerLoc_Desc"),
                                  }),
                                  (0, a.jsx)("p", {
                                    children: (0, _.PP)(
        ...
        const j = Dn.Fj[e.artworkType].width,
          S = Dn.Fj[e.artworkType].height;
        return (0, a.jsxs)("div", {
          id: e.id,
          className: Gn().ArtworkSelectorContainer,
          children: [
            Boolean(e.title) &&
              (0, a.jsxs)("div", {
                className: Gn().Title,
            ...
            !e.bIsMinimized &&
              (0, a.jsxs)("div", {
                className: (0, ne.A)(Gn().SelectImageBlock, Gn().Tips),
                children: [
                  I,
                  Boolean(j && S) &&
                    (0, a.jsxs)("p", {
                  ...
                  Boolean(e.strWarning) &&
                    (0, a.jsx)("div", {
                      children: (0, a.jsx)("p", {
                        className: Bn.WarningStylesWithIcon,
                  ...
                  Boolean(e.fnRemoveAllArtwork) &&
                    (0, a.jsx)(fe.$n, {
                      ...
                      children: (0, _.we)("#Sale_RemoveAll"),
                    }),
                ],
              }),
            !e.bIsMinimized &&
      ...
      function ht(e) {
        const {
          ...
          u = "localized_image_group" === n,
          [m, h] = s.useState((0, p.E)()),
          [x, v] = s.useState(new Array()),
          b = s.useCallback(
            (e, n, t) => {
              let a = [];
              x.find((n) => n.clanImage.imageid == e.imageid)
                ? (a = x.map((t) =>
                    t.clanImage.imageid == e.imageid
                      ? { clanImage: e, lang: n }
                      : t,
                  ))
                : t && (a = x.concat({ clanImage: e, lang: n })),
                v(a);
            },
            [x],
          ),
          I = s.useCallback(
            (e, t, a) => {
              (0, En.h5)(() => {
                Nn(i(n, t) ?? "") == e.image_hash && l(n, null, t),
                  l(n, e, a),
                  b(e, a, !1);
              });
            },
        ...
        return "hero" === n
          ? (0, a.jsx)("div", {
              ...
              children: (0, a.jsx)(fe.$n, {
                ...
                children: (0, _.we)("#ImageUpload_EditHeroImage"),
              }),
            })
          : (0, a.jsxs)("div", {
              children: [
                ...
                (0, a.jsx)("div", {
                  children: (0, a.jsx)("div", {
                    ...
                    children: (0, a.jsx)(at, {
                      ...
                      artworkType: n,
                      fnOnRemoveImage: u ? null : (e) => l(n, null, e),
                      realms: t,
                      fnLangHasData: r,
                      fnGetImageHashAndExt: i,
                      partnerEventStore: g,
      ...
      let xt = class extends s.Component {
        ShowLangChangeDialog(e, n) {
          const {
            fnOnArtworkLanguageChange: t,
            realms: o,
            fnLangHasData: r,
          } = this.props;
          (0, Ce.pg)(
        ...
        GenerateImageMappings() {
          ...
          return (
            n.forEach((n) => {
              ...
              let s = (0, _.we)("#Language_" + (0, o.LgB)(r));
              e.push(
                (0, a.jsxs)(
                  "div",
                  {
        ...
        render() {
          ...
          if (!e || 0 == e.length) return (0, a.jsx)("div", {});
          let n = this.GenerateImageMappings();
          return (0, a.jsx)("div", {
            className: Gn().UploadSuccess,
            children: n,
          });
        }
      };
      (0, kn.Cg)([h.oI], xt.prototype, "ShowLangChangeDialog", null),
        (xt = (0, kn.Cg)([qe.PA], xt));
      var vt = t(82705);
      function bt(e) {
        const {
        ...
        (0, s.useEffect)(() => {
          x(!1),
            Oe.R.ClearImageGroup(),
            c?.forEach((e, n) => {
              const t = B.b.InitFromClanID(b);
              if (0 == Oe.R.GetAllLocalizedGroupImages().length) {
                const n = e && j.zU.GetHashFromHashAndExt(e),
                  a = n && Fe.pU.GetClanImageByImageHash(t, n);
                a && Oe.R.SetPrimaryImageForImageGroup(a, d);
              }
              Oe.R.SetLocalizedImageGroupAtLang(n, t, e ?? null);
            }),
            x(!0);
        }, [c, b, d]);
        const S = (0, s.useCallback)(
            (e, n, t = o.Bhc) => {
              const a = B.b.InitFromClanID(b),
                r = j.zU.GetHashAndExt(n ?? null);
              if (0 == Oe.R.GetAllLocalizedGroupImages().length) {
                const n = r && j.zU.GetHashFromHashAndExt(r),
                  t = n && Fe.pU.GetClanImageByImageHash(a, n);
                t && Oe.R.SetPrimaryImageForImageGroup(t, e);
              }
              Oe.R.SetLocalizedImageGroupAtLang(t, a, r);
            },
            [b],
          ),
          f = (0, s.useCallback)((e, n) => {
            const t = Oe.R.GetLocalizedImageGroupForEdit(),
        ...
        return (0, a.jsxs)(we.o0, {
          ...
          bAllowFullSize: !0,
          className: (0, ne.A)(Bn.NotTooWideModal, Bn.ImageManageDialog),
          strTitle: e.strLocalizedTitle || (0, _.we)("#ImagePickerLoc_Title"),
          strDescription: e.strLocalizedDescription,
          bOKDisabled: I > 0,
          onOK: () => {
            const n = Oe.R.GetLocalizedImageGroupForEdit();
            for (let e = o.Bhc; e < o.bP9; ++e) {
              const t = n?.localized_images[e];
              if (t) {
                const n = t.split("/").pop() || "";
                m(
                  d,
            ...
            Oe.R.ClearImageGroup(), e.onOK ? e.onOK() : u?.();
          },
          strOKButtonText:
              ...
              : (0, a.jsxs)(a.Fragment, {
                  children: [
                    ...
                    (0, a.jsx)(pt, {
                      ...
                      appid: t,
                      realms: l,
                      fnRemoveAllArtwork: () => Oe.R.ClearImageGroup(),
                      fnSetImageURL: S,
      ...
      function It(e) {
        ...
        return (0, a.jsxs)(a.Fragment, {
          children: [
            (0, a.jsx)(fe.JU, {
              children: o || (0, _.we)("#EventEditor_Tile_Title"),
            }),
            (0, a.jsx)(fe.m, {
      ...
      function ft(e) {
        const {
            closeModal: n,
            imgGroup: t,
            fnUpdateImageGroup: i,
            eventModel: l,
          } = e,
          [c, d] = (0, s.useState)(() => t),
          [g, u, m, p, h, x, v, b] = (0, r.q3)(() => [
            c.repeat_setting,
            c.scaling_setting,
            c.background_color1,
            c.background_color2,
          ...
          [I] = (0, s.useState)(() =>
            (function (e) {
              const n = w.$Y([], o.bP9, null);
              for (const t in e) {
                const a = (0, o.sfN)(t);
                a != o.xPp && (n[a] = e[t]);
              }
              return n;
            })(c.localized_background_art ?? {}),
          );
        return (0, a.jsxs)(bt, {
          ...
          fnGetImageHash: (e, n) => I[n],
          fnSetImageURL: async (e, n, t) => {
            d((e) => {
              const a = { ...e.localized_background_art },
                r = j.zU.GetHashAndExt(n);
              return (
                r ? (a[(0, o.LgB)(t)] = r) : delete a[(0, o.LgB)(t)],
                { ...e, localized_background_art: a }
              );
            });
          },
          onOK: () => {
            d((e) => (i(e), n && setTimeout(n, 1), { ...e }));
          },
          children: [
            (0, a.jsxs)("div", {
              className: Me().ConfDialogOptions,
              children: [
                (0, a.jsxs)("div", {
                  className: Me().ImageOptions,
                  children: [
                    (0, a.jsx)(It, {
                      setting: g,
                      fnUpdateSetting: (e) => {
                    ...
                    (0, a.jsx)(Ct, {
                      ...
                      disable: "no-repeat" !== g,
                      fnUpdateSetting: (e) => d({ ...c, scaling_setting: e }),
                    }),
                    Boolean("cover" != u) &&
                      (0, a.jsx)(Et, {
                        position_settings: x,
                        fnUpdateSetting: (e) =>
                          d({ ...c, position_setting: e }),
                      }),
                  ],
                }),
                (0, a.jsxs)("div", {
                  className: Me().ColorOptions,
                  children: [
                    (0, a.jsx)(fe.JU, {
                      children: (0, _.we)("#BackgroundGroups_Color"),
                    }),
                    (0, a.jsxs)("div", {
                      ...
                      children: [
                        ...
                        " ",
                        (0, a.jsx)(fe.$n, {
                          onClick: () => d({ ...c, background_color1: void 0 }),
                          children: (0, _.we)("#BackgroundGroups_Color_Clear"),
                        }),
                      ],
                    }),
                    (0, a.jsx)("div", {
                      className: Me().SwapColorsCtn,
                      children: (0, a.jsx)(fe.$n, {
                        onClick: () =>
                          d({
                            ...c,
                        ...
                        children: (0, _.we)("#BackgroundGroups_Color_Swap"),
                      }),
                    }),
                    ...
                    (0, a.jsx)(kt, {
                      ...
                      fnUpdateSetting: (e) => d({ ...c, gradient_setting: e }),
                    }),
                  ],
                }),
              ],
            ...
            (0, a.jsx)(jt.E, {
              clanSteamID: l.clanSteamID,
              children: (0, a.jsx)(St.S, {
                checked: !!b,
                onChange: (e) => {
                  c.randomize_section_order = e;
                },
                children: (0, _.we)("#BackgroundGroups_RandomizeSectionOrder"),
              }),
            }),
          ],
        });
      ...
      function wt(e) {
        ...
        return (0, a.jsx)(we.o0, {
          ...
          closeModal: n,
          onOK: () => o(r),
          children: (0, a.jsx)(Le, { onChange: (e) => i(e), color: r }),
        });
      }
      function Ct(e) {
        const {
        ...
        return (0, a.jsxs)(a.Fragment, {
          children: [
            (0, a.jsx)(fe.JU, {
              children: o || (0, _.we)("#BackgroundGroups_Scaling"),
            }),
            (0, a.jsx)(fe.m, {
              strDropDownClassName: $.DropDownScroll,
              disabled: r,
              rgOptions: i,
              selectedOption: n || "cover",
              onChange: (e) => t(e.data),
              bDisableMouseOverlay: !0,
              contextMenuPositionOptions: { bDisableMouseOverlay: !0 },
            }),
      ...
      function kt(e) {
        ...
        return (0, a.jsxs)(a.Fragment, {
          children: [
            (0, a.jsx)(fe.JU, {
              children: o || (0, _.we)("#EventEditor_ColorSetting_Title"),
            }),
            (0, a.jsx)(fe.m, {
              strDropDownClassName: $.DropDownScroll,
              rgOptions: r,
      ...
      function Et(e) {
        const { position_settings: n, fnUpdateSetting: t, label: o } = e,
          r = s.useMemo(() => {
            ...
            return (
              ...
              e.push({
                label: (0, _.we)("#BackgroundGroups_Position_CenteredTop"),
                data: "top center",
              }),
              e.push({
        ...
        return (0, a.jsxs)(a.Fragment, {
          children: [
            (0, a.jsx)(fe.JU, {
              children: o || (0, _.we)("#BackgroundGroups_Position"),
            }),
            (0, a.jsx)(fe.m, {
              strDropDownClassName: $.DropDownScroll,
              rgOptions: r,
      ...
      function Dt(e) {
        const {
          ...
          [l, c] = (0, s.useState)(n.BIsBackgroundImageEnabled()),
          [d, g, m] = (0, h.uD)(),
          p = (0, r.q3)(() => n.GetSalePageLastCoverSectionUntilEnd());
        return (0, a.jsx)("div", {
          className: (0, ne.A)(Me().Ctn, i && $.ValveOnlyBackground),
          children: (0, a.jsxs)(u.tH, {
            children: [
              (0, a.jsx)(fe.Yh, {
                label: (0, _.we)("#BackgroundGroups_Setting"),
                checked: l,
                onChange: (e) => {
                  c(e), n.SetBackgroundImageEnabled(e);
                },
              }),
              l
                ? (0, a.jsxs)(a.Fragment, {
                    children: [
                      ...
                      (0, a.jsx)(we.EN, {
                        active: d,
                        children: (0, a.jsx)(we.o0, {
                          strTitle: (0, _.we)("#EventEditor_GenericAreYouSure"),
                          strDescription: (0, _.we)(
                            "#BackgroundGroups_ClearAllSettings_Desc",
                          ),
                          bDestructiveWarning: !0,
                          onOK: () => {
                            n.ClearAllBackgroundImageGroupSettings(), c(!1);
                          },
                          closeModal: m,
                        }),
                      }),
                ...
                : (0, a.jsx)("p", {
                    children: (0, _.we)("#BackgroundGroups_Desc"),
                  }),
              (0, a.jsx)("br", {}),
              (0, a.jsx)("a", {
                href: `${x.TS.PARTNER_BASE_URL}doc/marketing/event_tools/sales/groups`,
                target: "_blank",
                children: (0, _.we)("#EventGeneric_SeeDocs"),
              }),
            ],
          }),
        });
      }
      const At = s.forwardRef(function (e, n) {
        const {
          ...
          d = (0, p.E)(),
          [g, u, m, x] = (0, r.q3)(() => [
            i && t.mapGroupToSections.get(i.background_id),
            (i &&
              t.mapGroupToSections.get(i.background_id)?.sectionUniqueIDs) ??
              [],
            null != c
              ? o?.GetTabLastCoverSectionUntilEnd(c)
              : o?.GetSalePageLastCoverSectionUntilEnd(),
            null != c ? o?.GetTabGroupCount(c) : o?.GetSalePageGroupCount(),
          ]),
          v = m && s + 1 === x,
          [b, I, j] = (0, h.uD)(),
          [S, f, w] = (0, h.uD)();
        ...
        return (0, a.jsx)(ke.qx, {
          ...
          children: (0, a.jsxs)("div", {
            ...
            children: [
              (0, a.jsx)(fe.$n, {
                onClick: I,
                children: (0, _.we)("#BackgroundGroups_Configure"),
              }),
              (0, a.jsx)(we.EN, {
                active: b,
                children: (0, a.jsx)(ft, {
                  ...
                  fnUpdateImageGroup: (e) =>
                    null != c
                      ? o.SetTabBackgroundGroup(c, s, e)
                      : o.SetSalePageBackgroundGroup(s, e),
                }),
              }),
              (0, a.jsx)("br", {}),
              (0, a.jsx)("div", {
                className: Me().EditorTitle,
                children: (0, _.we)("#BackgroundGroups_ContentTitle"),
              }),
              (0, a.jsxs)("ul", {
                children: [
                  u.map((e) =>
                  ...
                  Boolean(v) &&
                    (0, a.jsx)("li", {
                      children: (0, _.we)("#BackgroundGroups_EndOfList"),
                    }),
                ],
              }),
              !!k &&
                (0, a.jsx)(fe.$n, {
                  onClick: () =>
                    null != c
                      ? o.SetTabBackgroundGroup(c, s, {
                          ...i,
                          num_sections: i.num_sections - 1,
                        })
                      : o.SetSalePageBackgroundGroup(s, {
                          ...i,
                          num_sections: i.num_sections - 1,
                        }),
                  children: (0, _.we)("#BackgroundGroups_Reduce", k),
                }),
              !!C &&
                (0, a.jsx)(fe.$n, {
                  onClick: () =>
                  ...
                  children: (0, _.we)("#BackgroundGroups_Extend", C),
                }),
              Boolean(s > 0) &&
                (0, a.jsxs)(a.Fragment, {
                  children: [
                    ...
                    (0, a.jsx)(fe.$n, {
                      onClick: f,
                      children: (0, _.we)("#BackgroundGroups_RemoveThisGroup"),
                    }),
                    (0, a.jsx)(we.EN, {
                      active: S,
                      children: (0, a.jsx)(we.o0, {
                        ...
                        onOK: () =>
                          null != c
                            ? o.RemoveTabBackgroundGroup(c, s)
                            : o.RemoveSalePageBackgroundGroup(s),
                        closeModal: w,
                      }),
                    }),
                  ],
      ...
      function Gt(e) {
        const {
          ...
          s = o.mapFirstSectionToGroup.get(t);
        return t == o.nFirstSaleSectionIDWithoutGroup ||
          t == o.nFirstTabSectionIDWithoutGroup
          ? (0, a.jsx)(yt, { backgroundImageEditModel: r, nTabID: n })
          : s
            ? (0, a.jsx)(Tt, { ...e, groupID: s })
            : null;
      }
      function Tt(e) {
        const {
          ...
          c = l.findIndex((e) => e.background_id === n),
          d = l[c],
          [g, u] = (0, s.useState)(!1);
        (0, s.useEffect)(() => {
          if (!g) return;
        ...
        return (0, a.jsxs)("div", {
          ...
          children: [
            Boolean(m && p && p > m) &&
              (0, a.jsx)(fe.$n, {
                onClick: (e) => u(!0),
                children: (0, _.we)("#BackgroundGroups_EditBackgroundGroup"),
              }),
            (0, a.jsx)(At, {
              backgroundImageEditModel: i,
              groupIndex: c,
      ...
      function Nt(e) {
        ...
        const i = (0, r.q3)(() => {
            ...
            return b.get(t?.nBackgroundGroupID);
          }),
          ...
          g = (0, h.w6)(d);
        return (0, a.jsxs)("div", {
          className: (0, ne.A)(Me().CtnEditor, Bt().TabCtn),
          ref: g,
          children: [
            Boolean(i && l && l > i) &&
              (0, a.jsx)(fe.$n, {
      ...
      function Mt(e) {
        const {
          ...
          [c, d, g, m] = (0, r.q3)(() => [
            n?.GetTabLastCoverSectionUntilEnd(o),
            n?.BIsTabEnabled(o),
            t.selectedTabBackgroundDef,
            n?.GetEventModel(),
          ]);
        return (0, a.jsxs)(u.tH, {
          children: [
            (0, a.jsx)(fe.Yh, {
              label: (0, _.we)("#BackgroundGroups_TaSetting"),
              checked: d,
              onChange: (e) => {
                l(n.SetTabEnabled(o, e));
              },
            }),
            Boolean(d) &&
              (0, a.jsxs)(a.Fragment, {
                children: [
                  ...
                  (0, a.jsx)(At, {
                    backgroundImageEditModel: n,
                    groupIndex: 0,
                    imgGroup: (g || i)?.groups[0],
                    imgGroupDerivedMapping: t,
                    eventModel: m,
                    nTabIndex: o,
                    classNameHeader: Bt().TabHeader,
                  }),
                ],
              }),
          ],
        ...
        return 1 == n.length
          ? (0, a.jsx)("div", {
              ...
              children: F.Z.LocalizeReact(
                "#SalePresented_By",
                (0, a.jsx)(qt, { presentor: n[0], lang: t }),
              ),
            })
          : (0, a.jsx)("div", {
              className: (0, ne.A)(
              ...
              children: F.Z.LocalizeReact(
                ...
                (0, a.jsx)(qt, { presentor: n[n.length - 1], lang: t }),
              ),
            });
      }
      function qt(e) {
        const { presentor: n, lang: t } = e,
          o = (0, Pt.aL)(n.url);
        return (0, a.jsx)(zt.uU, {
          href: o,
          bUseLinkFilter: !0,
          className: Ot().PresenterLabel,
          children: _.NT.GetWithFallback(n.localized_presenter_name, t),
        });
      }
      var Vt = t(77021),
        Wt = t(63512),
        ...
        Zt = t(21529);
      function Qt(e) {
        const { event: n, broadcastEmbedContext: t } = e,
          o = Boolean(n?.jsondata?.broadcast_display_wide_player),
          r = Boolean(n?.jsondata?.broadcast_dispaly_wide_player_allow_chat);
      ...
      var Kt = t(60092);
      function Jt(e) {
        const { event: n, fnOnChangeDayIndex: t, addtionalAdminButtons: o } = e;
        return (0, a.jsx)(Kt.g, {
          eventModel: n,
          fnOnUpdateSaleDayIndex: t,
      ...
      function Xt(e) {
        const {
          ...
          [x, v] = s.useState(t?.GetDayIndexFromEventStart()),
          [b, I] = s.useState(null),
          j = (0, r.q3)(() => t.jsondata.sale_header_disable_top_margin),
          S = (function (e, n) {
            const [t] = (0, m.QD)(c.jD, void 0);
            return s.useMemo(() => {
              const a = e.GetSaleSectionFirstMatchByType("tabs"),
                o = a?.tabs?.filter((e) => !e.hide);
              if (o && o.length > 0) {
                let e = t > 0 ? o.find((e) => e.unique_id == t) : void 0;
                e || (e = o[0]);
                const a = e === o[0];
                return new ve.y(e, n, a);
              }
            }, [e, n, t]);
          })(t, x),
          [f, w] = (0, s.useState)(!1);
        s.useEffect(() => {
          if (
            ...
            (n.innerText = (0, Se.L$)(t.jsondata.sale_custom_css)),
              I(n),
              e.appendChild(n);
          }
        ...
        const k = t?.jsondata,
          E = s.useMemo(
            () => ({
              ...
              bIsPreview: i,
              language: l,
              accountIDs: i ? k?.broadcast_whitelist : void 0,
              chat_announcement_giveaway:
                k?.broadcast_chat_announcement_giveaway,
            }),
            [i, t, k, l, n],
          ),
          D = (0, r.q3)(() => g?.BIsBackgroundImageEnabled() ?? !1);
        if (t && void 0 !== x) {
          const e =
              t.jsondata.localized_sale_logo &&
              t.jsondata.localized_sale_logo?.filter(Boolean).length > 0,
            r = t
              .GetSaleSections()
              .some((e) => "contenthubtitle" === e.section_type),
            s = t.BUsesContentHubForItemSource() && r;
          let c;
          c = e
            ? 0
          ...
          let m = !1;
          530 === t.jsondata.sale_header_offset && (m = !0);
          const _ = d.nY
              .Get()
            ...
            b = Boolean(!_),
            I = i
              ? !f && g?.BIsBackgroundImageEnabled()
                ? C.S.EPreviewMode_EditBackground
                : C.S.EPreviewMode_Enabled
              : C.S.EPreviewMode_Disabled,
            k = D || t.GetEventType() != o.ajI,
            y = (0, jt.m)(t.clanSteamID);
          return (0, a.jsx)(u.tH, {
            children: (0, a.jsx)(Ut.EU, {
              eventModel: t,
              language: l,
              children: (0, a.jsx)(A.Cs, {
                location: i ? A.HY : A.bs,
                children: (0, a.jsxs)(ue, {
                  ...
                  children: [
                    ...
                    (0, a.jsxs)("div", {
                      className: (0, ne.A)({
                        [W().SaleOuterContainer]: !0,
                        [W().SaleOuterTopMargin]: j,
                        [W().SaleNewSizing]: m,
                        [W()[`CustomStyle_${t.jsondata.sale_vanity_id}`]]: !0,
                      ...
                      children: [
                        (0, a.jsx)(he, { eventModel: t, language: l }),
                        (0, a.jsx)(Ht, {
                          rgPresenters: t.jsondata.sale_presenters,
                        }),
                        (0, a.jsx)(Qt, { event: t, broadcastEmbedContext: E }),
                        (0, a.jsx)($t, {
                          ePreviewMode: I,
                          event: t,
                          backgroundImageEditModel: g,
                        ...
                        !h &&
                          (0, a.jsx)(Jt, {
                            ...
                            fnOnChangeDayIndex: (e) => {
                              e != x && ((t.m_overrideCurrentDay = e), v(e));
                            },
                          }),
                      ],
                    }),
        ...
        return (0, a.jsx)("div", {
          className: Z().FlexCenter,
          style: { height: "500px" },
          children: (0, a.jsx)(be.t, {
            size: "medium",
            string: (0, _.we)("#Loading"),
          }),
        });
      }
      const $t = (0, i.y)(function (e) {
        const {
            event: n,
            language: t,
            nSaleDayIndex: o,
          ...
          [_, h] = s.useState((0, c.rp)()),
          x = s.useMemo(() => new Ie(), []),
          v = s.useCallback(() => h((0, c.rp)()), []);
        s.useEffect(
          () => (
        ...
        const b = (0, i.W6)(),
          ...
          [w, E] = (0, r.q3)(() => {
            ...
            return [
              I(
                n.jsondata.sale_background_img_groups,
                e,
                u && u.GetActiveTabUniqueID(),
              ),
              e,
            ];
          });
        let D = !1;
        const A = [{ elements: [], activeTab: new ve.y(void 0, o) }];
        let y = null;
        const G = (0, N.Qn)(),
          T = (0, Vt.ty)();
        E.forEach((o, r) => {
          const s = A[A.length - 1].activeTab;
          if (s && !s.ShouldShowSection(o)) return;
          const i = d.nY
              .Get()
              .BIsPartnerTakeoverActive(
                n.GetContentHubType(),
            ...
            l = _ && !i && !Boolean(n.jsondata.content_hub_restricted_width);
          let c = (0, C.I)(o, g, n, t, G);
          if (void 0 === c) return;
          if (c);
          else if ((0, me.su)(o) && !N.iA.logged_in)
            D ||
              ((c = (0, a.jsx)(me.CC, { section: o, event: n, language: t })),
              (D = !0));
          else {
            const n = o.diable_tab_id_filtering
              ? new ve.y(void 0, s && s.GetSaleDay())
              : s;
            "tabs" == o.section_type &&
              o.tabs?.some((e) => e.unique_id == u?.GetActiveTabUniqueID()) &&
              A.push({ activeTab: u, elements: [] }),
              (c = (0, a.jsx)(Rt.H, {
                ...e,
                section: o,
                activeTab: n,
          ...
          T && (c = (0, a.jsx)(oa, { nSectionID: o.unique_id, children: c }));
          const m = A && A.length && A[A.length - 1];
          let h = (0, a.jsx)(
            aa,
            {
              section: o,
              nActiveTabID:
                m && m.activeTab && m.activeTab.GetActiveTabUniqueID(),
              saleSectionIndex: r,
              ePreviewMode: g,
          ...
          const v = w.mapSectionToGroup.get(o.unique_id);
          y &&
            y.groupID != v &&
            (A[A.length - 1].elements.push(
              k(n, y, u && u?.GetActiveTabUniqueID()),
            ),
            (y = null)),
            v
              ? (y ||
                  (y = {
                    groupID: v,
                    elSaleSections: [],
                    derivedGroupInfo: w.mapGroupToSections.get(v),
                  }),
                y.elSaleSections.push(h))
              : A[A.length - 1].elements.push(h);
        }),
          y &&
            (A[A.length - 1].elements.push(
              k(n, y, u && u?.GetActiveTabUniqueID()),
        ...
        (0, s.useEffect)(() => {
          B.current &&
            (M.current =
              (0, Yt._f)(B.current, "y") ?? document.documentElement);
        }, []);
        const U = (0, Wt.ak)(M, "smooth");
        return (0, a.jsx)(l.Z, {
          ref: B,
          className: W().SaleSectionListContainer,
      ...
      function ea(e) {
        const {
          visibility_by_door_index_state: n,
          door_index_visibility: t,
          children: o,
        } = e;
        return n && null != t
          ? (0, a.jsx)(na, {
      ...
      function na(e) {
        const {
          ...
          r = (0, g.OM)(t);
        return ("hide_when_open_door_index" == n && r) ||
          ("show_when_open_door_index" == n && !r)
          ? null
          : (0, a.jsx)(a.Fragment, { children: o });
      }
      function ta({ children: e, onChange: n }) {
        s.useRef(null);
        return (
          (0, s.useEffect)(() => {
            n(!!s.Children.toArray(e).filter(Boolean).length);
          }, [e, n]),
          e
        );
      }
      function aa(e) {
        const {
          ...
          p = c.mj + (n.unique_id || t),
          _ = "tabs" != n.section_type,
          [h, x] = (0, s.useState)(!0);
        return h
          ? (0, a.jsx)(u.tH, {
              children: (0, a.jsx)(ea, {
                ...
                door_index_visibility: n.door_index_visibility,
                children: _
                  ? (0, a.jsx)(l.Z, {
                      navKey: p,
                      id: p,
                      className: (0, ne.A)({
                        ...
                        [W().SaleSectionBackgroundImageGroupEdit]:
                          r == C.S.EPreviewMode_EditBackground,
                        [W().NoTopPadding]: n.collapse_header_space,
                      }),
                      children: Boolean(r === C.S.EPreviewMode_EditBackground)
                        ? (0, a.jsxs)(a.Fragment, {
                            children: [
                              m,
                              (0, a.jsx)(Gt, {
                                nSectionUniqueID: n.unique_id || t,
                                nTabID: o,
                                salePageBackgroundDerivedConfig: i,
                                backgroundImageEditModel: d,
                              }),
                        ...
                        : (0, a.jsx)(ta, { onChange: x, children: m }),
                    })
                  : (0, a.jsx)(a.Fragment, {
                      children: Boolean(r === C.S.EPreviewMode_EditBackground)
                        ? (0, a.jsxs)("div", {
      ...
      function oa(e) {
        const { nSectionID: n, children: t } = e,
          [o, i] = s.useState(!1),
          [l, c] = s.useState(!1);
        s.useEffect(() => {
          Vt.TU.Get().SetMouseOverSection(n, o);
        }, [n, o]);
        const d = (0, r.q3)(() => Vt.TU.Get().GetMouseOverSectionID()),
          g = n && n == d,
          u = s.useRef(null);
        return (
          (0, Vt.lM)((e) => n == e && (u.current?.scrollIntoView(), c(!0), !0)),
          (0, a.jsxs)("div", {
            ref: u,
            className: (0, ne.A)({
              ...
              o &&
                (0, a.jsx)(Q.Gq, {
                  ...
                  children: (0, a.jsx)("button", {
                    ...
                    onClick: () => Vt.TU.Get().JumpToSection(n),
                    children: (0, a.jsx)(q.ffu, {}),
                  }),
                }),
              t,
            ],
    ...
    48479: (e, n, t) => {
            ...
            (0, a.jsxs)("div", {
              ...
              children: [
                (0, a.jsxs)("div", {
                  ...
                  children: [n, Boolean(t) && (0, a.jsx)(m.o, { tooltip: t })],
                }),
                (0, a.jsxs)("div", {
                  className: g.SectionTitleButtons,
                  children: [
                    p,
                    (0, a.jsx)(h, { bIsMinimized: _, fnToggleMinimize: r }),
                  ],
                }),
              ],
            }),
            !_ && (0, a.jsx)(d.tH, { children: i }),
          ],
        });
      }
      function _(e) {
        const [n, t] = i.useState(Boolean(e.bStartMinimized));
        return (0, a.jsx)(p, {
          ...e,
          getMinimized: () => n,
          toggleMinimized: () => t(!n),
      ...
      function h(e) {
        const { bIsMinimized: n, fnToggleMinimize: t } = e,
          i = n ? "#Section_Maximize_Tooltip" : "#Section_Minimize_Tooltip";
        return (0, a.jsx)(o.$n, {
          "data-tooltip-text": (0, r.we)(i),
          onClick: t,
          children: e.bIsMinimized
            ? (0, a.jsx)(s.hz4, {})
            : (0, a.jsx)(s.Xjb, {}),
    ...
    9678: (e, n, t) => {
      ...
      function p(e) {
        const { section: n, autoFocus: t } = e,
          o = (0, g.Qn)(),
          r = (0, a.jsxs)("div", {
            className: u.CategorySection,
            children: [
              (0, a.jsx)("span", {
                className: u.CategorySectionName,
                children: n.name,
              }),
              (0, a.jsx)(i.MS, {
                className: u.CategoriesCtn,
                scrollDirection: "x",
                navEntryPreferPosition: l.iU.MAINTAIN_X,
                navKey: "cat_section" + n.name,
                children: n.categories.map((e, n) =>
                  (0, a.jsx)(
                    _,
                    { category: e, autoFocus: t && 0 === n },
                    "category" + e.name,
                  ),
                ),
              }),
        ...
        return o
          ? r
          : (0, a.jsx)(c.K, { placeholderHeight: "150px", children: r });
      }
      function _(e) {
        const { category: n, autoFocus: t } = e;
        return (0, a.jsx)(s.Z, {
          focusableIfEmpty: !0,
          autoFocus: t,
          navKey: "cat_panel" + n.name,
          children: (0, a.jsxs)(r.Ii, {
            href: g.TS.STORE_BASE_URL + n.url,
            className: (0, d.A)({
              [u.Category]: !0,
              [u.TopLevelCategory]: n.is_toplevel_genre,
            }),
            children: [
              (0, a.jsx)(h, { ...e }),
              (0, a.jsx)("div", { className: u.CategoryGradient }),
              (0, a.jsx)("span", {
                className: u.CategoryName,
                children: (0, a.jsx)("span", { children: n.name }),
              }),
            ],
          }),
        });
      ...
      function h(e) {
        let { category: n } = e;
        return (0, a.jsx)("div", {
          className: u.GridOuter,
          children: (0, a.jsx)("div", {
            className: u.Grid,
            children: (0, a.jsx)("img", {
              src: g.TS.STORE_BASE_URL + n.image_url,
            }),
          }),
        });
      }
      const x = function () {
        const { sections: e } = (function () {
            const e = m.Get(),
              [n, t] = (0, o.useState)(e.GetSections());
            return { sections: n };
          })(),
          n = o.useRef(null);
        return (
          ...
          (0, a.jsx)(s.Z, {
            className: u.CategorySectionsCtn,
            navRef: n,
            children: e.map((e, n) =>
              (0, a.jsx)(
                p,
                { section: e, autoFocus: 0 == n },
                "section" + e.name,
              ),
            ),
          })
    ...
    19516: (e, n, t) => {
      ...
      function S(e) {
        ...
        return (0, a.jsx)(x.d, {
          bSalePage: !0,
          children: (0, a.jsx)(f, { ...e, overrideEventModel: n }),
        });
      }
      function f(e) {
        const { promotionName: n, language: t, overrideEventModel: r } = e,
          [s, u] = o.useState(
            r ?? d.O3.GetClanEventFromAnnouncementGID(h.P9.ANNOUNCEMENT_GID),
          );
        if (
          (o.useEffect(() => {
            if (!r && s?.AnnouncementGID != h.P9.ANNOUNCEMENT_GID) {
              const e = new c.b(h.UF.CLANSTEAMID);
              d.O3.LoadPartnerEventFromAnnoucementGIDAndClanSteamID(
                e,
          ...
          (function (e, n) {
            const t = (0, v.q3)(() => b.TU.Get().GetEventModelJson()),
              [a, r] = o.useState();
            o.useEffect(() => {
              if (!t || t == a) return;
              r(t);
              const e = l.lh.FromJSON(t);
        ...
        const x =
          s.visibility_state !== l.zv.k_EEventStateVisible &&
          s.visibility_state !== l.zv.k_EEventStateUnlisted;
        return (0, a.jsx)(w, {
          eventModel: s,
          children: (0, a.jsx)(j.oJ, {
      ...
      function w(e) {
        const { eventModel: n, children: t } = e,
          o = "adultonly" == n.GetContentHubType();
        return (0, a.jsx)(I.QA, {
          eAdultOnlyMediaBehavior: o ? "allowed" : "masked",
          children: t,
        });
      }
    },
