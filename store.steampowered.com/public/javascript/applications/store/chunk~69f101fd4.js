  ...
  [62077],
  {
    ...
    55815: (e, t, r) => {
      ...
      class je extends s.Message {
        ...
        constructor(e = null) {
          super(),
            je.prototype.broadcaster_steamid || o.Sg(je.M()),
            s.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
    ...
    44165: (e, t, r) => {
      ...
      (0, s.V)("g_EventCalendarDevFeatures", n);
      const o = new Date(),
        c = Math.floor(o.getTime() / 1e3);
      function l() {
        return n.nOverrideDateNow ?? c;
      }
      function d() {
        return i.useMemo(() => l(), []);
      }
      function m() {
        return i.useMemo(() => n.GetTimeNowWithOverrideAsDate(), []);
      }
    },
    62658: (e, t, r) => {
      "use strict";
