    ...
    75048: (e, n, a) => {
      ...
      function j(e) {
        return (0, s.jsx)("div", {
          ...
          children: 2 == e.role ? (0, s.jsx)(I, {}) : (0, s.jsx)(y, {}),
        });
      }
      function _(e) {
        const { steamid: n } = e,
            ...
            queryFn: async () => {
              ...
              if (m.iA.logged_in) {
                const a = f.w.Init(h.dN),
                  s = (await h.xt.GetNicknameList(n, a)).Body().toObject();
                s?.nicknames &&
    ...
    83137: (e, n, a) => {
      ...
      function o() {
        ...
        return (0, r.I)({
          ...
          queryFn: async () => {
            const n = s.w.Init(t.tz),
              a = await t.xt.GetCommunityPreferences(e, n);
            if (1 != a.GetEResult())
              throw new Error(
