  ...
  [321],
  {
    ...
    283: (e, t, s) => {
      ...
      let S = class extends o.Component {
        OnEmoticonClick(e) {
          ...
          if (
            ((c = r
              ...
              : s && t.flair_list && t.GetFlairListByGroupID(s)?.length > 0
                ? (0, i.jsx)(m.CE, {
                    emoticonStore: this.props.emoticonStore,
                    strFlairGroupID: this.props.strFlairGroupID,
            ...
            (!e || e < N) && (e = N), n("rtLastAckedNewEmoticons", e);
          }
        }
        GetNewestIndicatorTime() {
          let e = this.props.emoticonStore,
            t = Number.MIN_SAFE_INTEGER,
            s = e.GetTimeReceivedNewestEmoticon();
          s && (t = s);
        ...
        render() {
          const { disabled: e, className: t, ttip: s, useImg: n } = this.props;
          let o = [t],
            r = !1;
          return (
            e ? o.push("disabled") : this.BHaveUnseenEmoticons() && (r = !0),
            s && o.push("ttip"),
            n
              ? (0, i.jsx)(a.Z, {
              ...
              : (o.push(x().chatSubmitButton, x().EmoticonPickerButton),
                (0, i.jsx)(l.fu, {
                  ...
                  disabled: e,
                  children: (0, i.jsxs)(C.he, {
                    toolTipContent: s,
                    children: [
                      this.props.buttonIcon || (0, i.jsx)(j.nl, {}),
                      r && (0, i.jsx)(m.iD, {}),
                    ],
                  }),
                }))
      ...
      (0, n.Cg)([c.oI], S.prototype, "OnEmoticonClick", null),
        (S = (0, n.Cg)([r.PA], S));
      const E = S;
    },
    10820: (e, t, s) => {
      ...
      class S extends c.Component {
        ...
        render() {
          const { config: e } = this.props,
            ...
            s = e[t] && e[t].renderContent ? e[t].renderContent() : null,
            n = e.length > 1,
            o = n
              ? ({ detail: { button: t } }) => {
                  t === C.pR.BUMPER_LEFT
          ...
          return (0, i.jsxs)(j.Z, {
            className: N.Picker,
            onButtonDown: o,
            children: [n && (0, i.jsx)(E, { children: this.RenderTabs() }), s],
          });
        }
        RenderTabs() {
          ...
          children: [
            (0, i.jsxs)(M, {
              children: [
                o &&
                  (0, i.jsx)("div", {
                    className: N.SectionedPageTitle,
                    children: o,
                  }),
                n.map(({ title: e, ...t }) =>
                  (0, i.jsx)(
      ...
      function k(e) {
        return (0, i.jsxs)("div", {
          className: N.Section,
          children: [
            (0, i.jsx)("div", { className: N.SectionTitle, children: e.title }),
            (0, i.jsx)("div", {
      ...
      function A(e) {
        const { value: t, onChange: s, onSubmit: n } = e;
        return (0, i.jsx)("div", {
      ...
      const b = (0, r.PA)((e) => {
        ...
        !(function (e) {
          const [t, s] = (0, c.useState)(e.is_initialized);
          (0, c.useEffect)(() => {
            if (!e.is_initialized) {
      ...
      class W extends c.Component {
        ...
        m_ref = c.createRef();
        render() {
          const { sticker: e, className: t, ...s } = this.props,
          ...
          return (0, i.jsxs)("div", {
            ...
            ...s,
            children: [
              (0, i.jsx)("img", { style: { width: "100%" }, src: n }),
              this.state.showHover &&
                (0, i.jsx)(J, { target: this.m_ref.current, sticker: e }),
            ],
          });
        }
      }
      const J = (0, r.PA)((e) => {
        ...
        return (0, i.jsx)(P.c, {
          ...
          subtitle: o?.GetName(),
          children: (0, i.jsx)("img", {
            src: u(p.TS.COMMUNITY_CDN_URL, s),
      ...
      class q extends c.Component {
        ...
        render() {
          ...
          return (0, i.jsxs)("div", {
            ...
            onMouseLeave: () => this.setState({ showHover: !1 }),
            onBlur: () => this.setState({ showHover: !1 }),
            className: (0, m.A)(s, g().EffectButton),
            ...n,
            children: [
              o.renderEffectIcon(),
              this.state.showHover &&
      ...
      function K() {
        return (0, i.jsx)("div", {
          ...
          children: (0, i.jsx)("div", { className: g().NewEmoticonCircle }),
        });
      }
      function $(e) {
        return (0, i.jsxs)("svg", {
