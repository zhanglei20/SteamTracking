  ...
  [2920],
  {
    ...
    70343: (e, t, n) => {
      ...
      var i = n(7850),
        ...
        l = n(22797);
      function d(e) {
        const { text: t, children: n, className: s } = e;
        return (0, i.jsx)(a.Z, {
          "flow-children": "row",
          className: r()(c().LineItemDetailsRow, t && c().Text, s),
          children: n,
        });
      }
      function u(e) {
        ...
        return (0, i.jsx)(a.Z, {
          className: r()(c().LineItemWrapper, t && c().LineItemPlaceholder, n),
          children: s,
        });
      }
      function m() {
        return (0, i.jsx)(u, { placeholder: !0, children: (0, i.jsx)(_, {}) });
      }
      function _() {
        return (0, i.jsx)("div", {
          className: c().LoadingThrobber,
      ...
      function p(e) {
        ...
        return (0, i.jsx)(d, {
          text: !0,
          children: (0, i.jsx)("div", { className: c().Warning, children: t }),
        });
      }
      function h(e) {
    ...
    14336: (e, t, n) => {
      ...
      function p(e, t) {
        return new (_())(
          async (t) => {
            const n = [...t],
              i = await u.xtC.GetPlayerLinkDetails(e, { steamids: n }),
              s = new Map();
            return (
              i
                .Body()
      ...
      function h(e) {
        const t = (0, o.KV)(),
          n = i.useContext(g);
        return (0, s.I)(j(n, t, e));
      }
      function f(e) {
        const t = (0, o.KV)(),
          n = i.useContext(g);
        return (0, r.E)({ queries: e.map((e) => j(n, t, e)) });
      }
    ...
    31335: (e, t, n) => {
      ...
      function x(e) {
        const { dailyDeal: t } = e,
          ...
          o = (0, h.J$)((0, f.Jz)({ item_type: a, id: t.item?.id }));
        return (0, i.jsx)(l.A, {
          appID: "app" == t.item?.type ? t.item.id : void 0,
          feature: "daily-deal",
          children: (0, i.jsxs)(s.Z, {
      ...
      function C(e) {
        ...
        let P =
          (function () {
            ...
            : x;
        const k = r(),
          [B, E] = s.useState(k > 0 ? g()(1e3 * k) : null),
          [R, F] = s.useState(),
          [O, M] = s.useState(),
        ...
        return (0, i.jsxs)("div", {
          className: (0, u.A)(h().EventTimeSection, S),
          children: [
            (0, i.jsxs)("div", {
              ...
              children: [
                ...
                U &&
                  (0, i.jsxs)("span", {
                    ...
                    children: [(0, i.jsx)("img", { src: o.A }), U],
                  }),
              ],
            }),
            (0, i.jsxs)("div", {
        ...
        return (0, i.jsx)("div", {
          children: a
            ...
            : (0, i.jsx)(c.YN, {
                ...
                redirectUrl: t,
                theme: "modal",
                children: n && (0, i.jsx)(c.Mk, { redirectURL: t }),
              }),
        });
      }
    },
        ...
        const { component: t = "a" } = e,
          n = (function (e) {
            const {
              ...
              _ = s.useRef(0),
              p = t.GetStoreItemType() == a.c6.qI ? t.GetAppID() : null,
              h = (0, c.n9)(),
              f = s.useMemo(
                () => r.Ay.GetLinkParam({ ...h, feature: n || h.feature }, i),
                [h, n, i],
              ),
              g = s.useMemo(() => l.A.GetCuratorClanIDParam(h), [h]),
              x = s.useMemo(
                () => l.A.AddNavParamToURL(t.GetStorePageURL(), f, g),
                [t, f, g],
              ),
              j = (0, o.b)(),
              C = s.useCallback(() => {
                p && _.current != p && (j.AddImpression(p, f), (_.current = p));
              }, [j, p, f, _]),
              v = (0, d.OO)({ onEnter: C });
    ...
    43830: (e, t, n) => {
      ...
      function p(e, t) {
        const n = (0, o.KV)(),
          p = (0, m.j4)(),
          { storeBrowseContext: h, cacheStoreItemData: f } = (0, c.yn)();
        return (0, d.I)({
          queryKey: (0, _.m4)(p, e),
          queryFn: async () =>
            (async function (e, t, n, o, c, d) {
              const u = s.w.Init(r.vL);
              (0, i.kx)(t) || (0, i.uU)(t)
                ? (u.Body().set_gidshoppingcart(t.gid),
                  o && u.Body().set_gift_info(a.$z.fromObject(o)))
                : (0, i.sb)(t) && u.Body().set_gidreplayoftransid(t.gid);
              (0, l.rV)(n, u), c && (0, l.Bn)(u, c);
              const m = await r._o.ValidateCart(e, u);
              m.BSuccess() ||
                console.warn(
                  `Failed to validate shopping cart: ${m.GetEResult()}`,
                );
              if (c && d)
                for (const e of m.Body().cart_items()) d(e.store_item(), c);
              return m.Body().toObject();
            })(n, p, h, e, t, f),
          staleTime: 1 / 0,
          enabled: u.iA.logged_in || !(0, i.c2)(p),
        });
      }
      var h = n(37085),
        f = n(22837),
        ...
        return (0, v.n)({
          mutationFn: (e) =>
            (async function (e, t, n, i, r) {
              const o = s.w.Init(g.Bk);
              o.Body().set_line_item_id(t),
                o.Body().set_user_country(u.iA.country_code),
                i && o.Body().set_gift_info(a.$z.fromObject(i)),
                n && o.Body().set_flags(g.Eo.fromObject(n)),
                r && o.Body().set_apply_gidcoupon(r);
              const c = await g.t8.ModifyLineItem(e, o);
              return (
                c.BSuccess() ||
                  console.warn(`Failed to update gift info: ${c.GetEResult()}`),
                [c.GetEResult(), c.Body().toObject()]
              );
            })(n, e.lineItemID, e.lineItemFlags, e.giftInfo, e.gidCoupon),
          onMutate: async (e) => {
            await i.cancelQueries({ queryKey: r });
            const t = i.getQueryData(r);
            return (
              i.setQueryData(r, (t) => ({
                ...t,
          ...
          onSuccess: ([n, s], a, { previousCart: o }) => {
            n == h.R
              ? ((0, _.LN)(i, t, s.cart), e && e())
              : i.setQueryData(r, o);
          },
        ...
        return (0, d.I)({
          ...
          queryFn: async () => {
            const t = await (async function (e) {
              const t = s.w.Init(g.wi);
              t.Body().set_language((0, f.sfN)(u.TS.LANGUAGE));
      ...
      function O() {
        const e = (0, m.j4)(),
          t = (0, w.vo)(),
          n = L(),
          s = t.isSuccess && t.data.role() == x.PQ.sf,
          r = n.data?.cart_items.some((e) => !e.can_purchase_as_gift);
        let a = F.k_ECanRequest;
        return (
          s
            ? !(function (e) {
                return (0, i.c2)(e) || (0, i.kx)(e);
              })(e)
              ? (a = F.k_EInvalidCartType)
              : r && (a = F.k_ENonGiftableItemPresent)
            : (a = F.k_EIsNotChild),
          [a === F.k_ECanRequest, a]
        );
      }
      function M() {
        const e = (0, m.j4)(),
          t = (0, w.vo)();
        return t.isSuccess && t.data.role() == x.PQ.s && (0, i.uU)(e);
      }
      !(function (e) {
    ...
    48980: (e, t, n) => {
      ...
      function P(e) {
        const {
          lineItems: t = [],
          cartValidation: n,
          LineItemContainer: s = W,
        } = e;
        if (!t.length) return (0, i.jsx)(R, {});
      ...
      const k = {
        [d.KW.$B]: function (e) {
          const { item: t, validatedItem: n } = e,
            [s, r] = (0, C.Gg)(t.packageid, {}),
            [a, o] = (0, C.mZ)(t.packageid, u.c6.RD, h.lP),
            l = (a && !a.BIsVisible()) || o === C.eR || r === C.eR,
            d = s?.GetSelfPurchaseOption();
          return l || (s && !d)
            ? (0, i.jsx)(F, {
        ...
        [d.KW.XY]: function (e) {
          const { item: t, validatedItem: n } = e,
            [s, r] = (0, C.G6)(t.bundleid, u.c6.xO, h.xz);
          if ((s && !s.BIsVisible()) || r === C.eR)
            return (0, i.jsx)(F, {
              lineItemID: t.line_item_id,
              validatedItem: n,
              storeItem: s,
            });
          if (!s) return (0, i.jsx)(c.vF, {});
      ...
      function B(e) {
        ...
        return r
          ? (0, i.jsx)(I.tH, {
              fallback: (t) => (0, i.jsx)(E, { ...e, error: t }),
          ...
          children: [
            (0, i.jsxs)("div", {
              ...
              children: [
                (0, i.jsx)("div", {
                  className: o().Error,
                  children: (0, A.we)("#Cart_LineItem_ErrorBoundary"),
                }),
                (0, i.jsx)("div", {
                  className: o().Muted,
                  children: n.message,
        ...
        return (0, i.jsxs)(c.Rz, {
          ...
          children: [
            ...
            (0, i.jsxs)("div", {
              ...
              children: [
                (0, i.jsx)("div", {
                  className: (0, D.A)(o().LineItemColumn, o().LineItemCapsule),
                  children: (0, i.jsx)(b.p, {
                    item: s,
                    noImpressionTracking: !0,
                    children: (0, i.jsx)("img", {
                      className: o().HeaderImg,
                      src: a,
                    }),
                  }),
                }),
                  ...
                  children: [
                    (0, i.jsx)(c.UW, {
                      ...
                      children: (0, i.jsx)("div", {
                        ...
                        children:
                          s?.GetName() ||
                          (0, A.we)("#SteamCharts_UnknownGameTitle"),
                      }),
                    }),
                    (0, i.jsx)(K, { validatedItem: n }),
                    (0, i.jsx)(c.UW, {
      ...
      function O(e) {
        const {
          ...
          { data: f, isLoading: j } = (0, x.Pt)(),
          C = h.filter((e) => f?.has(e)),
          v = g.useId();
        if (j || !l) return (0, i.jsx)(c.vF, {});
        const I = s.flags?.is_gift,
          w = C.length === h.length,
          S = !I && C.length > 0 && !w;
        let y = I ? "gift" : "myself";
        return (
          "myself" === y && w && (y = "private"),
          (0, i.jsxs)(d, {
            lineItem: s,
            storeItem: t,
            validatedItem: l,
                ...
                children: [
                  ...
                  (0, i.jsxs)("div", {
                    ...
                    children: [
                      ...
                      t.BIsComingSoon() && (0, i.jsx)(Z, { storeItem: t }),
                      (0, i.jsxs)(K, {
                        validatedItem: l,
                        children: [
                          (0, i.jsx)(Y, { item: t }),
      ...
      function M(e) {
        ...
        return (0, i.jsx)("div", {
          ...
          children: (0, i.jsx)(b.p, {
            ...
            noImpressionTracking: !0,
            children: (0, i.jsx)("img", {
              className: a ? o().HeaderImgBlurred : o().HeaderImg,
              src: r,
              alt: t.GetName(),
            }),
          }),
      ...
      function W(e) {
        return (0, i.jsx)(l.Z, {
          children: (0, i.jsx)(c.Rz, { children: e.children }),
        });
      }
      function U(e) {
        ...
        let s = t?.formatted_original_price,
          ...
          a = t?.discount_pct,
          l = t?.final_price_in_cents;
        return (
          n &&
            n.original_price &&
            n.subtotal.amount_in_cents != l &&
      ...
      function z(e) {
        const {
          ...
          [p] = (0, G.fg)(),
          f =
            p?.accountid_giftee || (_ ? t.gift_info?.accountid_giftee : void 0),
          x = (0, h.ZB)() && !a?.restrict_add_additional_to_cart,
          j = a.errors?.adult_content_restricted,
          C = (0, s.A)(t.packageid, t.bundleid, ee(r), "cart-add-additional"),
          v = g.useId(),
          I = g.useId();
        return (0, i.jsxs)(c.UW, {
          className: o().LineItemSpaceBetween,
          children: [
            (0, i.jsx)("div", {
              className: o().LineItemCol,
              children: f
                ? (0, i.jsx)(H, { recipient: f })
                : (0, i.jsx)(Q, {
                    lineItem: t,
                    storeItem: n,
                    initialValue: d,
            ...
            (0, i.jsxs)("div", {
              className: (0, D.A)(o().LineItemRightCol, o().AddRemoveLinks),
              children: [
                x &&
                  (0, i.jsxs)(i.Fragment, {
                    children: [
                      (0, i.jsx)(l.Z, {
                        onActivate: () => !C.isPending && C.mutate(),
                        className: o().AddLineItem,
                        title: (0, A.we)("#Cart_LineItem_Add_Tooltip"),
                        id: v,
                        "aria-labelledby": `${v} ${m}`,
                        children: (0, A.we)("#Cart_Add"),
                      }),
                      "|",
                    ],
                  }),
      ...
      function V(e) {
        const t = `${T.TS.STORE_BASE_URL}public/images/checkout/Cart_generic_header_logo.png`;
        if (!e) return t;
        const n = e.GetAssets();
        if (!n) return t;
      ...
      function Z(e) {
        ...
        return (
          ...
          (0, i.jsx)(c.dp, { children: n })
        );
      }
      function K(e) {
        const { validatedItem: t, children: n } = e;
        return (0, i.jsxs)("div", {
          className: (0, D.A)(o().LineItemSpaceBetween),
      ...
      function Y(e) {
        ...
        return t.GetSelfPurchaseOption()?.requires_shipping
          ? (0, i.jsx)(c.dp, { children: (0, i.jsx)(y.r, { item: t }) })
          : null;
      }
      function q(e) {
        const { item: t } = e;
        if (!t || t.GetStoreItemType() != u.c6.RD) return null;
      ...
      function Q(e) {
        const {
          ...
          d = (0, h.EJ)(),
          u = !ee(r) || d,
          m = !(!(_ = r).is_commercial_license && !_.requires_shipping);
        var _;
        const p = [
      ...
      function J(e) {
        return (0, i.jsx)(v.m, {
          ...
          strDropDownButtonClassName: o().DropDownThin,
          ...e,
        });
      }
      const X = g.memo(function (e) {
        const { validatedItem: t } = e,
          n = t.included_packageids,
          s = (0, m.eG)(),
          r = (0, p.E)({
            queries: n.map((e) => (0, _.mt)(s, { packageid: e })),
          }),
          a = [
            ...new Set(
              r
        ...
        return !a.length || (1 == a.length && !t.item_id.bundleid)
          ...
          : (0, i.jsxs)(c.UW, {
              ...
              children: [
                (0, i.jsxs)("span", {
                  children: [
                    (0, A.Yp)("#Cart_IncludesItems", a.length),
                    ":",
                    " ",
                  ],
                }),
                a.map((e, t) =>
                  (0, i.jsxs)(
                    g.Fragment,
                    { children: [t > 0 && ", ", (0, i.jsx)(ne, { appid: e })] },
                    t,
                  ),
                ),
              ],
      ...
      function $(e) {
        ...
        return (0, i.jsxs)(c.UW, {
          children: [
            (0, i.jsxs)("span", {
              children: [(0, A.we)("#Cart_Notice_SomeAppsPrivate"), " "],
            }),
            n,
          ],
        });
      ...
      function ne(e) {
        const { name_override: t, ...n } = e,
          { data: s } = (0, _.J$)(t ? void 0 : n),
          r = t ?? s?.name;
        return (0, i.jsx)(ie, { ...n, name: r, children: r });
      }
      function ie(e) {
    ...
    98362: (e, t, n) => {
      ...
      function f(e) {
        ...
        return (0, i.jsx)(h.Provider, { value: s, children: n });
      }
      function g() {
        const { rgCartLevelNotices: e } = l.useContext(h);
        return e && e.length
          ? (0, i.jsx)("div", {
              className: p().HeaderNotices,
              children: e.map((e, t) => (0, i.jsx)(x, { children: e }, t)),
            })
          : null;
      }
      function x(e) {
        const { children: t } = e;
        return (0, i.jsx)("div", { className: p().HeaderNotice, children: t });
      }
      function j() {
        const { mapValidateNoticesToFootnote: e } = l.useContext(h);
        return e && e.size
          ? (0, i.jsx)("div", {
              className: p().FooterNoticesCtn,
              children: Array.from(e).map(([e, t]) =>
                (0, i.jsx)(C, { notice: t }, t.index),
              ),
            })
          : null;
      }
      function C(e) {
        const { notice: t } = e;
        return (0, i.jsxs)("div", {
          className: p().FooterNotice,
          children: [
            (0, i.jsx)("div", {
              className: p().NoticeIndex,
      ...
      function v(e) {
        ...
        return (
          ...
          n.push((0, i.jsx)(N, { lineItem: t }, "owned_apps")),
          t.errors?.unavailable_in_country &&
            n.push(
              (0, i.jsx)(
                I,
                {
                  purchase_state: r.WN.Hp,
                  notice_text: (0, m.we)(
          ...
          n.push((0, i.jsx)(y, { lineItem: t }, "coupon_notices")),
          t.errors?.too_many_in_cart &&
            n.push(
              (0, i.jsx)(
                I,
                {
                  purchase_state: r.WN.YF,
          ...
          n.push((0, i.jsx)(b, { lineItem: t }, "available_cheaper")),
          n
        );
      }
      function I(e) {
      ...
      function w(e) {
        ...
        return t && 0 != t.length
          ? t.map((e, n) =>
              (0, i.jsx)(S, { appid: e, last: n >= t.length - 1 }, `${e}_${n}`),
            )
          : null;
      }
      function S(e) {
        const { appid: t, last: n } = e,
          [s] = (0, d.t7)(t, { include_basic_info: !0 });
        return s
          ? (0, i.jsxs)(c.Zx, {
              appid: t,
              children: [
      ...
      function b(e) {
        const { lineItem: t } = e,
          { data: n } = (0, a.mr)(t.item_id),
          { data: r } = (0, a.EO)(t.item_id);
        if (!!t.gift_info?.accountid_giftee || !n || !r || (0, o.vk)(n, r))
          return null;
        const { purchase_option_name: l, packageid: d, bundleid: u } = r,
          _ = d ? { packageid: d } : { bundleid: u };
        return (0, i.jsx)(s.dp, {
          children: (0, m.PP)(
            "#Cart_Warning_AvailableAtALowerPrice",
            (0, i.jsx)(c.O3, { name_override: l, ..._ }),
          ),
        });
      }
    },
    17798: (e, t, n) => {
      ...
      function N(e) {
        return (0, i.jsx)("div", {
          className: (0, w.A)(S.CartCard, e.className),
          children: e.children,
        });
      }
      var y = n(2160),
      ...
      function D(e) {
        const { cart: t } = e,
          n = (function (e) {
            ...
            for (const t of e.cart_items)
              i += parseInt(t.subtotal.amount_in_cents);
            const {
                sale_name: s,
        ...
        const {
          ...
          u = (0, i.jsx)("div", {
            ...
            children: (0, v.we)("#Cart_SaleCardDrops_Explanation", l),
          });
        return (0, i.jsxs)(N, {
          ...
          children: [
            d &&
              (0, i.jsx)("div", {
                ...
                children: (0, v.Yp)("#Cart_SaleCardDrops_EarnedMessage", s, l),
              }),
            !d && u,
            (0, i.jsxs)("div", {
              ...
              children: [
                (0, i.jsx)("div", {
                  children: (0, v.we)("#Cart_SaleCardDrops_ProgressLabel"),
                }),
                (0, i.jsx)(A, { value: r }),
                (0, i.jsxs)("div", {
                  className: b.Right,
                  children: [
                    "(",
                    (0, v.we)("#Cart_SaleCardDrops_CardCost", c),
                    ")",
                  ],
                }),
              ],
        ...
        const { bMinimalDisplay: t } = e,
          n = (function () {
            ...
            return (
              ...
              window.innerWidth < parseInt(S.strMaxCartPartResponsiveWidth)
            );
          })();
        return (n && t) || (!n && !t) ? null : (0, i.jsx)(U, { ...e });
      }
      function U(e) {
      ...
      function H(e) {
        ...
        const l = a.reduce((e, t) => ((e[t] = !0), e), {}),
          d = z(l, c.data?.purchase_recommendations),
          u = z(l, c.data?.specials);
        z(l, c.data?.daily_deals), z(l, c.data?.spotlights);
        return (0, i.jsxs)("div", {
          className: k.CartUpsellArea,
          children: [
            (0, i.jsx)("div", {
              className: k.CartUpsellTitle,
              children: (0, v.we)("#Recommendations_Header"),
            }),
            d?.length > 3
              ? (0, i.jsx)(V, {
                  type: "recommended",
            ...
            (0, i.jsx)(W, { cart: t, bMinimalDisplay: !1 }),
          ],
        });
      }
      function V(e) {
        ...
        return !t && n
          ...
          : (0, i.jsx)(x.Ay, {
              feature: `upsell-${s}`,
              children: (0, i.jsx)(K, {
                className: (0, w.A)(k.Specials),
                children: t
                  ?.slice(0, 3)
                  .map(({ item_id: e, item: t }) =>
                    (0, i.jsx)(Z, { item_id: e, item: t }, (0, G.wD)(e)),
                  ),
              }),
            });
      }
      ...
      function K(e) {
        ...
        return (0, i.jsx)(u.Z, {
          "flow-children": "row",
          navEntryPreferPosition: T.iU.MAINTAIN_X,
          className: (0, w.A)(k.UpsellRow, t),
          children: n,
        });
      }
      var Y = n(99637),
      ...
      const $ = o.memo(function (e) {
        ...
        return (0, i.jsxs)(ze, {
          children: [
            (0, i.jsx)(Ze, { children: (0, v.we)("#Cart_GiftDelivery_Label") }),
            (0, i.jsx)(Ve, {
              children: (0, i.jsx)(h.Od, {
                controlled: !0,
                checked: !a,
                onChange: (e) => e && void n(0),
                label: (0, v.we)("#Cart_GiftDelivery_Now"),
              }),
            }),
            (0, i.jsxs)(Ve, {
              children: [
                (0, i.jsx)(h.Od, {
                  ...
                  label: (0, v.we)("#Cart_GiftDelivery_ScheduleDelivery"),
                }),
                (0, i.jsx)("div", { style: { clear: "both" } }),
                s &&
                  (0, i.jsx)("div", {
                    className: X().ScheduleError,
                    children: s,
                  }),
                a &&
                  (0, i.jsx)(f.tH, {
      ...
      function te(e) {
        ...
        return e > t
          ? (0, v.we)("#Cart_GiftScheduleError_TooFar")
          : !(e < n) || (0, v.we)("#Cart_GiftScheduleError_InvalidDate");
      }
      function ne(e) {
        const {
            scheduledTime: t,
          ...
          r = o.useMemo(() => {
            const e = new Intl.DateTimeFormat(v.pf.GetPreferredLocales(), {
              hour: "numeric",
            });
            return (
          ...
          a = new Date(1e3 * t),
          [c, l] = (0, o.useState)(a.getMonth()),
          [d, u] = (0, o.useState)(a.getDate()),
          [m, _] = (0, o.useState)(a.getFullYear()),
          [p, g] = (0, o.useState)(() =>
            (function (e, t) {
              let n = e.getHours(),
                i = e.getMinutes();
          ...
          [x, j] = (0, o.useState)(a.getHours() >= 12 ? "PM" : "AM");
        o.useEffect(() => {
          ...
          r &&
            ("PM" == x && t < 12 ? (t += 12) : "AM" == x && 12 == t && (t = 0));
          const a = new Date(m, c, d, t, i, 0, 0).getTime() / 1e3,
            o = te(a);
          !0 === o ? (s(null), n(a)) : s(o);
        }, [m, c, d, p, x, r, n, s]);
        const C = "US" == Q.TS.COUNTRY && "english" == Q.TS.LANGUAGE;
        return (0, i.jsxs)(i.Fragment, {
          children: [
            (0, i.jsxs)(h.Xp, {
              className: X().GamepadTimePickerRow,
              children: [
                C && (0, i.jsx)(se, { month: c, setMonth: l }),
                (0, i.jsx)(re, { year: m, month: c, day: d, setDay: u }),
                !C && (0, i.jsx)(se, { month: c, setMonth: l }),
                (0, i.jsx)(ie, { year: m, setYear: _ }),
              ],
            }),
            (0, i.jsxs)(h.Xp, {
              className: X().GamepadTimePickerRow,
              children: [
                ...
                r && (0, i.jsx)(ae, { strAMPM: x, setAMPM: j }),
                (0, i.jsx)(h.VP, {
                  className: X().TimezoneDisplay,
                  children: (0, i.jsx)(f.tH, { children: (0, i.jsx)(oe, {}) }),
                }),
                !r && (0, i.jsx)(h.VP, { children: " " }),
              ],
            }),
          ],
        });
      ...
      function ie(e) {
        const { year: t, setYear: n } = e,
          s = o.useMemo(() => {
            const e = new Date(),
              t = new Intl.DateTimeFormat(v.pf.GetPreferredLocales(), {
                year: "numeric",
              });
        ...
        const { year: t, month: n, day: s, setDay: r } = e,
          a = o.useMemo(() => {
            const e = new Date(t, n + 1, 0).getDate(),
              i = new Intl.DateTimeFormat(v.pf.GetPreferredLocales(), {
                day: "numeric",
              });
            let s = [];
            for (let t = 1; t <= e; t++)
      ...
      function ge(e) {
        const t = (function (e) {
            ...
            return (0, pe.I)({
              ...
              queryFn: async () => {
                const e = me.w.Init(_e.HM);
                e.Body().set_item_ids([r.O4.fromObject(n)]);
                const i = await _e._o.GetFriendOwnershipForGifting(t, e);
                if (!i.BSuccess()) throw i.GetEResult();
                return i.Body().toObject();
              },
            });
          })(e),
          n = (0, fe.d0)({ loadFavorites: !0, loadNicknames: !0 }),
        ...
        return (
          a.sort((e, t) => {
            ...
            const n = e.ownership.partial_wishes_for?.length ?? 0,
              i = t.ownership.partial_wishes_for?.length ?? 0;
            if (n != i) return i - n;
            if (e.ownership.already_owns) {
              if (!t.ownership.already_owns) return 1;
            } else if (t.ownership.already_owns) return -1;
            const s = e.ownership.partial_owns_appids?.length ?? 0,
              r = t.ownership.partial_owns_appids?.length ?? 0;
            if (s != r) return s - r;
            if (n > 0) {
      ...
      function Ie(e) {
        ...
        return (0, i.jsx)(ve.mt, {
          className: X().GiftRecipientPickerModal,
          active: s,
          onDismiss: r,
          children: (0, i.jsx)(we, { onDismiss: r, lineItem: n, storeItem: t }),
        });
      }
      const we = o.memo(function (e) {
        const {
      ...
      function Se(e) {
        const {
          ...
          _ = t.gift_info?.accountid_giftee,
          p = (e) => {
            if (e) {
              const n = new Ce.b(e);
              n.BIsValid() &&
        ...
        return c
          ? (0, i.jsx)(Ne, {
              children: (0, i.jsx)("div", {
                className: X().LoadingError,
                children: (0, v.we)("#Cart_GiftRecipientModal_IssueLoading"),
              }),
            })
          : (0, i.jsxs)(Ne, {
              loading: r,
              children: [
                (0, i.jsx)(ye, { value: d, onChange: u }),
                (0, i.jsx)(be, {
                  children: m.map((e) =>
                    (0, i.jsx)(
                      De,
                      {
                        selected: e.accountid === _,
                        onSelect: p,
        ...
        return (0, i.jsxs)(u.Z, {
          ...
          children: [
            (0, i.jsx)("div", {
              ...
              children: (0, v.we)("#Cart_GiftRecipientModal_Title"),
            }),
            t && (0, i.jsx)(j.t, { position: "center", size: "large" }),
            !t && n,
          ],
        });
      }
      function ye(e) {
        ...
        return (0, i.jsx)(h.pd, {
          ...
          placeholder: (0, v.we)("#Cart_GiftRecipientModal_Placeholder"),
          value: t,
          onChange: (e) => n(e.currentTarget.value),
        });
      }
      function be(e) {
        return (0, i.jsx)(xe.MS, { className: X().GiftFriendsListCtn, ...e });
      }
      function De(e) {
        const {
            selected: t,
          ...
          c = a.already_owns,
          l = o.useCallback(() => {
            c || n(r.m_steamid.ConvertTo64BitString());
          }, [c, n, r]);
        return (0, i.jsxs)(u.Z, {
          className: (0, w.A)(
          ...
          children: [
            ...
            (0, i.jsxs)("div", {
              className: X().FriendsGiftLabel,
              children: [
                (0, i.jsx)(Ae, { ownership: a }),
                (0, i.jsx)(Te, { ownership: a }),
              ],
            }),
          ],
        });
      ...
      function Ae(e) {
        ...
        return n
          ? (0, i.jsx)("div", {
              className: (0, w.A)(X().OwnsGame),
              children: (0, v.we)("#Cart_GiftRecipientModal_OwnsGameLabel"),
            })
          : s && s.length > 0
            ? (0, i.jsx)("div", {
                className: (0, w.A)(X().OwnsGame),
      ...
      function Te(e) {
        ...
        return n
          ...
          : s
            ? (0, i.jsx)("div", {
                className: (0, w.A)(X().OnWishlist),
                children: (0, v.we)("#Cart_GiftRecipientModal_OnWishlist"),
              })
            : r && r.length > 0
              ? (0, i.jsx)("div", {
                  className: (0, w.A)(X().OnWishlist),
          ...
          ? (0, i.jsxs)(Ue, {
              children: [
                (0, i.jsxs)(He, {
                  children: [
                    (0, i.jsx)(Ze, {
                      children: (0, v.we)("#Cart_PurchaseFor_Label"),
                    }),
                    (0, i.jsx)("a", {
                      href: s.data.GetCommunityProfileURL(),
                      target: "_blank",
                      children: (0, i.jsx)(ce.i8, {
                        className: X().FriendAvatar,
                        statusPosition: "right",
                        persona: s.data,
                      }),
                ...
                (0, i.jsx)(Oe, { giftInfo: t, onChange: n }),
              ],
            })
          : null;
      }
      ...
      function Ee(e) {
        ...
        return (0, i.jsxs)(ze, {
          children: [
            (0, i.jsx)(h.jn, {
              onClick: () => r(!0),
              children: (0, v.we)("#Cart_SelectGiftRecipient"),
            }),
            s &&
              (0, i.jsx)(Ie, {
                bShowGiftRecipientModal: s,
      ...
      function Re(e) {
        const { lineItem: t, storeItem: n } = e,
          [s, r] = o.useState(!1),
          a = (0, le.js)(t.gift_info.accountid_giftee);
        return a.data
          ? (0, i.jsxs)(ze, {
              children: [
                (0, i.jsx)("div", { className: X().GiftFormDivider }),
                (0, i.jsxs)(He, {
                  children: [
                    (0, i.jsx)(Ze, {
                      children: (0, v.we)("#Cart_GiftRecipient_Label"),
                    }),
                    (0, i.jsx)("a", {
                      href: a.data.GetCommunityProfileURL(),
                      target: "_blank",
                      children: (0, i.jsx)(ce.i8, {
                        className: X().FriendAvatar,
                        statusPosition: "right",
      ...
      function Fe(e) {
        const { lineItem: t } = e,
          [n, s] = o.useState(t.gift_info?.time_scheduled_send),
          r = o.useRef(n),
          [c, l] = o.useState(t.gift_info?.gift_message?.message || ""),
          d = o.useRef(c),
          [u, m] = o.useState(t.gift_info?.gift_message?.signature || ""),
          _ = o.useRef(u),
          p = (0, O._g)(3e3),
          { mutate: h } = (0, a.CM)(),
          f = o.useCallback(
            ...
            [h, t.line_item_id, t.flags, p],
          );
        return (
          (0, o.useEffect)(() => {
            (r.current == n && d.current == c && _.current == u) ||
              (f({
                accountid_giftee: t.gift_info?.accountid_giftee,
                gift_message: { message: c, signature: u },
                time_scheduled_send: n,
              }),
              (r.current = n),
              (d.current = c),
              (_.current = u));
          }, [c, u, n, f, t.gift_info?.accountid_giftee]),
          (0, i.jsx)(We, {
            id: t.line_item_id,
            message: c,
            onMessageChange: l,
          ...
          children: [
            ...
            (0, i.jsx)(ze, {
              children: (0, i.jsxs)("div", {
                ...
                children: [
                  (0, i.jsx)(Ze, {
                    children: (0, v.we)("#Cart_GiftDelivery_From"),
                  }),
                  (0, i.jsx)(ce.i8, {
                    className: X().FriendAvatar,
                    statusPosition: "right",
                  ...
                  !m &&
                    (0, i.jsxs)(Ke, {
                      ...
                      children: [
                        "(",
                        (0, v.we)("#Cart_GiftDelivery_AddSignature"),
                        ")",
                      ],
                    }),
                ],
            ...
            m &&
              (0, i.jsxs)(ze, {
                children: [
                  (0, i.jsx)(Ze, {
                    children: (0, v.we)("#Cart_GiftDelivery_Signature"),
                  }),
                  (0, i.jsx)(h.pd, {
                    value: r,
            ...
            (0, i.jsx)($, { scheduledTime: c, onScheduledTimeChange: l }),
          ],
        });
      }
      function Ue(e) {
        return (0, i.jsx)("div", {
          className: X().GiftFormCtn,
          children: e.children,
        });
      }
      function ze(e) {
      ...
      function Ye(e) {
        const { gifteeAccountID: t } = e,
          { isLoading: n, data: s } = (0, l.vo)(!0);
        if (n || s.is_not_member_of_any_group() || s.role() === Pe.PQ.sf)
          return null;
        const r = Le.b2
        ...
        return s
          .family_group()
          .members()
          .some((e) => e.steamid() === r && e.role() === Pe.PQ.sf)
          ? (0, i.jsxs)("div", {
              className: X().FamilyGiftNotice,
              children: [" ", (0, v.we)("#Cart_FamilyGift_Notice")],
            })
          : null;
      }
      var qe = n(79443),
      ...
      function it(e) {
        const {
          ...
          [{ bDialogActive: c, strDialogTitle: l }, d] = o.useState({
            bDialogActive: !1,
          }),
          u = (0, a.CM)();
        return (0, i.jsxs)(i.Fragment, {
          children: [
            ...
            (0, i.jsx)(at, {
              active: c,
              title: l || (0, v.we)("#Cart_CouponModify_Add"),
        ...
        return (0, i.jsx)("div", {
          ...
          children: (0, i.jsxs)("div", {
            ...
            children: [
              t ? (0, i.jsx)(rt, { ...t }) : null,
              (0, i.jsx)(lt, {
                children: (0, v.Yp)("#Cart_CouponAvailability", n),
              }),
              (0, i.jsx)("div", {
                className: tt.ModifyLink,
                children: (0, i.jsx)(Ke, { onClick: s, children: r }),
              }),
            ],
          }),
        });
      ...
      function at(e) {
        const {
          ...
          [d, u] = o.useState(a?.gidcoupon || "");
        return (0, i.jsxs)(ve.mt, {
          active: t,
          onDismiss: n,
          children: [
            (0, i.jsx)(h.Y9, { children: r }),
            (0, i.jsx)(h.a3, {
              children: (0, v.PP)(
                "#Cart_SelectCouponToApply",
                (0, i.jsx)("span", { className: tt.PackageName, children: s }),
              ),
            }),
            (0, i.jsx)(ot, {
              availableCoupons: c,
      ...
      function ot(e) {
        const {
          ...
          { data: o } = (0, a.g7)(),
          c = (o?.cart_items || []).map((e) => e.coupon_applied?.gidcoupon);
        return (0, i.jsx)("div", {
      ...
      function ct(e) {
        const {
          ...
          d = l ? void 0 : () => c(!s);
        return (0, i.jsxs)("div", {
          className: (0, w.A)(tt.CouponListItem, l && tt.Disabled),
          onClick: d,
          children: [
            (0, i.jsx)(dt, { checked: s, hidden: l }),
            (0, i.jsx)("img", { src: r, title: a, className: tt.Image }),
            (0, i.jsxs)("div", {
              className: tt.Info,
              children: [
                t &&
                  (0, i.jsx)(lt, {
                    children: (0, v.we)("#Cart_Coupons_Applied"),
                  }),
                l &&
                  (0, i.jsx)(lt, {
                    children: (0, v.we)("#Cart_Coupons_InUse"),
                  }),
              ],
            }),
            (0, i.jsxs)("div", {
              className: tt.Discount,
              children: ["-", o, "%"],
            }),
          ],
        });
      ...
      function dt(e) {
        ...
        return (0, i.jsx)("div", {
          className: (0, w.A)(tt.Checkbox, n && tt.Hidden),
          children: t && (0, i.jsx)(nt.Jl, {}),
        });
      }
      var ut = n(98362),
        mt = n(71460),
      ...
      function ft() {
        ...
        return (
          ...
          e
            ? (0, i.jsxs)("div", {
                className: (0, w.A)(
                  ht().EstimatedTotalFlex,
                  _t().UserCountrySelector,
                ),
                children: [
                  (0, i.jsx)("div", {
                    className: ht().CartLabelText,
                    children: (0, v.we)("#Cart_UserCountrySelector"),
                  }),
                  (0, i.jsx)("div", {
                    className: ht().CartValueText,
                    children: (0, i.jsx)(gt, { rgCountryOptions: e }),
                  }),
                ],
              })
            : null
      ...
      function vt(e) {
        const { children: t } = e,
          ...
          c = (0, Q.Qn)(),
          [l, d] = (0, jt.fg)(),
          { sortedLineItems: m, bCartIncludesGifts: _ } = o.useMemo(() => {
          ...
          { data: h } = (0, a.g7)();
        return (0, i.jsxs)(ut.wW, {
          validateCart: h,
          children: [
            (0, i.jsx)(ut.ZZ, {}),
            (0, i.jsxs)(u.Z, {
              className: ht().ShoppingCartCtn,
              children: [
                (0, i.jsxs)(u.Z, {
                  className: ht().ShoppingCartLeftCol,
                  children: [
                    r && (0, i.jsx)(Je.UD, {}),
                    !!l &&
                      (0, i.jsx)(f.tH, {
                    ...
                    (0, i.jsxs)(f.tH, {
                      children: [
                        m?.length > 1
                          ? (0, v.PP)("#Cart_ItemCount", m?.length)
                          : null,
                        (0, i.jsx)(xt.pf, {
                          lineItems: m,
                          cartValidation: h,
                    ...
                    !c &&
                      (0, i.jsxs)("div", {
                        className: ht().ResponsiveShoppingCartSummary,
                        children: [
                          (0, i.jsx)(wt, {
                            bCartIncludesGifts: _,
                            strEstimatedTotal:
                              h?.estimated_totals?.subtotal.formatted_amount,
                          }),
                          (0, i.jsx)(bt, {}),
                        ],
                      }),
                ...
                (0, i.jsx)(u.Z, {
                  className: (0, w.A)(
                    ht().ShoppingCartRightCol,
                    m?.length <= 2 && ht().SmallCart,
                  ),
                  children: (0, i.jsxs)("div", {
                    className: ht().CartRightColStickyCtn,
                    children: [
                      (0, i.jsx)(wt, {
                        bCartIncludesGifts: _,
                        strEstimatedTotal:
                      ...
                      (0, i.jsx)(bt, {}),
                      (0, i.jsx)(W, { cart: n.data, bMinimalDisplay: !0 }),
                    ],
                  }),
                }),
              ],
      ...
      function It(e) {
        const {
          ...
          [o] = (0, jt.Ez)(),
          c = "gifts" === o && !!t.flags.is_gift,
          l = !!r.length;
        return (0, i.jsxs)(u.Z, {
          children: [
            (0, i.jsxs)(Je.Rz, {
              children: [a, c && (0, i.jsx)(Be, { storeItem: n, lineItem: t })],
            }),
            l &&
              (0, i.jsx)(it, {
                storeItem: n,
      ...
      const wt = (0, f.Nr)(function (e) {
        const { strEstimatedTotal: t, bCartIncludesGifts: n } = e,
          { bButtonDisabled: s, nextStep: r, bGuestAvailable: a } = St(n);
        return (0, i.jsxs)("div", {
          className: ht().CartSummaryCtn,
          children: [
            (0, i.jsx)(f.tH, { children: (0, i.jsx)(ft, {}) }),
            (0, i.jsxs)("div", {
              className: (0, w.A)(
                ht().EstimatedTotalFlex,
                ht().SummaryMarginBottom,
              ),
              children: [
                (0, i.jsx)("div", {
                  className: ht().CartLabelText,
                  children: (0, v.we)("#Cart_EstimatedTotal"),
                }),
                (0, i.jsx)("div", {
                  className: ht().CartValueText,
                  children: t,
            ...
            (0, i.jsx)("div", {
              className: (0, w.A)(ht().CartNoteText, ht().SummaryMarginBottom),
              children: (0, v.we)("#Cart_Note_SalesTax"),
            }),
            (0, i.jsxs)(f.wC, {
              children: [
                (0, i.jsx)(yt, { bDisabled: s, nextStep: r, bGuestOption: a }),
                (0, i.jsx)(At, { disabled: s || n }),
                (0, i.jsx)(Dt, { bDisabled: s }),
              ],
            }),
          ],
        });
        ...
        return (
          (u = I.iA.logged_in
            ? e && "initial" == s && !o
              ...
              : "checkout"
            : "login"),
          { bButtonDisabled: d, nextStep: u, bGuestAvailable: c }
        );
      }
      function Nt(e) {
        const {
          ...
          nextStep: n,
          bGuestAvailable: s,
        } = St(e.bCartIncludesGifts);
        return (0, i.jsx)(yt, { bDisabled: t, nextStep: n, bGuestOption: s });
      }
      function yt(e) {
        ...
        const _ = (function (e) {
            return "login" == e
              ? (0, v.we)("#Cart_ContinueButton_Payment")
              : "gifts" == e
                ? (0, v.we)("#Cart_ContinueButton_Gifts")
                : "checkout" == e
                  ? (0, v.we)("#Cart_ContinueButton_Payment")
          ...
          onClick: () => {
            switch (n) {
              case "login":
                ...
                break;
              case "gifts":
                d("gifts"), o.push(et.B.ShoppingCartGifts());
                break;
              case "checkout":
                location.href = r;
                break;
      ...
      function bt() {
        const e = `${I.TS.STORE_BASE_URL}subscriber_agreement/`;
        return (0, i.jsxs)(u.Z, {
          className: ht().LicenseContextCtn,
          children: [
            (0, i.jsx)("img", {
              src: `${I.TS.IMG_URL}/checkout/computer.png`,
              alt: "",
            }),
            (0, i.jsxs)("div", {
              children: [
                (0, i.jsx)("div", {
                  className: ht().LicenseTitle,
                  children: (0, v.we)("#Cart_LicenseContextTitle"),
                }),
                (0, i.jsx)("div", {
                  className: ht().LicenseLink,
                  children: (0, v.PP)(
                    "#Cart_LicenseContextLink",
                    (0, i.jsx)("a", {
                      href: e,
                      children: (0, v.we)("#Cart_LicenseContextSSA"),
                    }),
                  ),
                }),
              ],
      ...
      function Dt(e) {
        const { bDisabled: t } = e,
          ...
          s = (0, a.sI)(),
          r = (0, a.F$)(),
          o = (0, l.Ke)(n.data?.family_groupid(), s, Pe.IG.DP);
        return r
          ? (0, i.jsx)(h.$n, {
              disabled: t,
              className: (0, w.A)(
              ...
              onClick: () => {
                o.mutate(void 0, {
                  onSuccess: () => {
                    location.href = `${I.TS.STORE_BASE_URL}account/familymanagement?tab=requests`;
                  },
                });
              },
              children: (0, v.we)("#Cart_DeclinePurchaseRequest"),
            })
          : null;
      }
      function At(e) {
        const { disabled: t } = e,
          ...
          r = (0, l.Yc)(s, I.iA.country_code),
          [c, d] = (0, a.S0)(),
          [u, m] = o.useState(!1);
        return c || d == a.Mn.k_ENonGiftableItemPresent
          ? (0, i.jsxs)("div", {
              className: (0, w.A)(
                ht().RequestPurchaseCtn,
                ht().SummaryMarginBottom,
              ),
              children: [
                (0, i.jsx)(h.jn, {
                  disabled: t || u || !c,
                  className: (0, w.A)(ht().CartSummaryBtn),
                  onClick: () => {
                    t ||
                      u ||
                      (m(!0),
                      r.mutate(void 0, {
                        onSuccess: () => {
                          window.location.assign((0, l.Vo)(s));
                        },
                      }));
                  },
                  children: (0, v.we)("#Cart_RequestPurchase"),
                }),
                c &&
                  (0, i.jsx)("div", {
                    children: (0, v.we)("#Cart_RequestPurchaseExplanation"),
                  }),
                d === a.Mn.k_ENonGiftableItemPresent &&
                  (0, i.jsx)("div", {
                    children: (0, v.we)(
      ...
      function Gt(e) {
        const t = Et(),
          n = (function () {
            ...
            return (0, o.useMemo)(() => {
              ...
              if (I.iA.logged_in) return { type: "account", global: !0 };
              const n = "shoppingCartGID";
              return { type: "anonymous", gid: (0, C.VY)(n), global: !0 };
            }, [e.search]);
          })();
        (0, p.YM)();
        let s = null;
        return (
          (s = t
            ? "replay" == n.type
              ? (0, i.jsx)(kt, { cartID: n })
              : (0, i.jsx)(Pt, { cartID: n, ...e })
            : (0, i.jsx)(j.t, { position: "center", msDelayAppear: 250 })),
          (0, i.jsxs)(i.Fragment, { children: [(0, i.jsx)(Lt, {}), s] })
        );
      }
      function Lt() {
        return (0, d.Pt)(), (0, l.vo)(), null;
      }
      function Pt(e) {
          ...
          children: ({ cart: e, validatedCart: t, bCartIncludesGifts: n }) =>
            (0, i.jsxs)(i.Fragment, {
              children: [
                ...
                (0, i.jsx)(f.tH, {
                  children: (0, i.jsx)(H, { cart: e, validatedCart: t }),
                }),
              ],
            }),
        });
      ...
      function kt(e) {
        ...
        return I.iA.logged_in
          ? (0, i.jsx)(Bt, {
              ...
              children: () =>
                (0, i.jsx)(N, {
                  children: (0, v.we)("#Cart_Replay_Instructions", 72),
                }),
            })
          : (0, i.jsx)(g.Cg, {});
      }
      function Bt(e) {
            ...
            if ("gifts" === e)
              return (0, i.jsxs)(i.Fragment, {
                children: [
                  "> ",
                  (0, i.jsx)("a", {
                    href: I.TS.STORE_BASE_URL + "cart",
                    children: (0, v.we)("#Cart_YourShoppingCart"),
                  }),
                ],
              });
            return null;
        ...
        return (
          o.useEffect(() => {
            d.current && d.current.NavTree()?.Activate(!0);
          }, []),
          (0, i.jsx)(x.Ay, {
            controller: "cart",
            method: "display",
            submethod: r,
            children: (0, i.jsxs)(jt.iZ, {
              cartID: n,
              step: r,
              setStep: a,
              ...c,
              children: [
                (0, i.jsx)(Rt, {}),
                (0, i.jsxs)(u.Z, {
                  className: ht().ShoppingCartPage,
                  navRef: d,
                  children: [
                    (0, i.jsxs)("div", {
                      className: ht().ShoppingCartBreadcrumbs,
                      children: [
                        (0, i.jsx)("a", {
                          href: I.TS.STORE_BASE_URL,
                          children: (0, v.we)("#Cart_Bradcrumb_Home"),
                        }),
                        " ",
                        l,
                        " ",
                        (0, i.jsxs)("span", {
                          className: ht().CurrentBreadcrumb,
                          children: ["> ", s],
                        }),
                      ],
                    }),
                    (0, i.jsx)("div", {
                      className: ht().ShoppingCartHeader,
                      children: s,
                    }),
                    (0, i.jsx)(Ct, { children: t }),
                  ],
                }),
              ],
            }),
          ...
          if (i && void 0 !== n) {
            const e = t.data?.line_items || [],
              n = e.length
                ...
                : null;
            (s = n?.bundleid || n?.packageid || m.sc),
              (c = s === n?.bundleid ? r.c6.xO : r.c6.RD);
          }
          const [l] = (0, p.G6)(s, c, a.xz);
          if (l && i) {
            const t = _.A.Get(),
      ...
      function Ft(e) {
        ...
        return (0, i.jsxs)(i.Fragment, {
          children: [
            ...
            (0, i.jsxs)(u.Z, {
              "flow-children": "row",
              className: ht().CartFooter,
              children: [
                (0, i.jsxs)("div", {
                  className: ht().NavButtons,
                  children: [
                    (0, i.jsx)(h.$n, {
                      onClick: () =>
                        (window.location.href = I.TS.STORE_BASE_URL),
                      className: ht().Button,
                      children: (0, v.we)("#Cart_ContinueShopping"),
                    }),
                    (0, i.jsx)(Nt, { bCartIncludesGifts: s }),
                  ],
                }),
                !t && (0, i.jsx)(Ot, {}),
              ],
      ...
      function Ot() {
        ...
        return (0, i.jsx)(Ke, {
          onClick: () => e.mutate(),
          children: (0, v.we)("#Cart_RemoveAll"),
        });
      }
    },
    10247: (e, t, n) => {
