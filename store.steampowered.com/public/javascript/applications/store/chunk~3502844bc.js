  ...
  [8291],
  {
              ...
              children: [
                ...
                r &&
                  (0, p.jsx)(m.s, {
                    ...
                    justify: "center",
                    align: "center",
                    children: (0, p.jsx)(d, { size: e, color: i, variant: t }),
                  }),
              ],
            })
    ...
    90534: (s, e, r) => {
      ...
      function c(s) {
        const { as: e = "div", ref: r, ...o } = s,
          a = (0, t.mz)({ ...o, className: i()(n.Box, s.className) }, l),
          c = e;
      ...
      function a(s, e) {
        return (function (s, e, r) {
          ...
          for (const n of e) {
            ...
            let e = a[n.prop];
            if (void 0 !== e) {
              if ((n.responsive && (e = i(e, r.formFactor)), n.className)) {
                if (
                  !n.cssProperty &&
                  !n.dataProperty &&
    ...
    20187: (s, e, r) => {
      ...
      function c(s) {
        ...
        return (0, p.jsx)(c, {
          ref: r,
          ...(0, o.mz)({ ...t, className: a()(n.Text, i) }, l),
        });
      }
      const l = [
        ...[
