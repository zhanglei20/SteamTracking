    ...
    39479: (s, r, e) => {
      ...
      function m(s) {
        const { children: r, "flow-children": e, ...m } = s,
          { gamepadEvents: _ } = (0, a.C7)(s);
        e && (m.layout = (0, i.O)(e)),
          _.onOKButton ||
            ("onClick" in r.props && r.props.onClick && (_.onOKButton = a._K));
        const { ref: l, node: c } = (0, a.qp)(m);
        (0, n.Ui)(_, l);
        const d = (0, o.Ue)(l, r.props?.ref);
        return (0, p.jsx)(a.TJ.Provider, {
          value: c,
          children: t.cloneElement(r, { ...r.props, ref: d }),
        });
      }
    },
  },
