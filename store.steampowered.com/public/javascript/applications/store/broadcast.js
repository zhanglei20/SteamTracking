  ...
  [8396],
  {
    ...
    42780: (e, t, r) => {
      ...
      class n {
        ...
        constructor(e) {
          (0, s.wT)(e, "decorated accumulator cannot be null"),
    ...
    99376: (e, t, r) => {
      ...
      class n {
        ...
        Parse(e, t, r = !0) {
          const s = (function (e, t) {
            ...
            for (let c = 0; c < e.length; c++) {
              ...
              switch (s.type) {
                case 0:
                  "[" == d
                    ? ((s.type = 2), (a = !0))
                    : ((s.type = 1), "\\" == d && t ? (i = !i) : (s.text += d));
                  break;
                case 2:
                case 3:
                  if ("/" == d && a) (s.type = 3), (s.text = ""), (a = !1);
                  else if ("[" != d || i)
                    if ("]" != d || i)
                      "\\" == d && t
                        ? ((s.text += d), (i = !i), (a = !1))
            ...
            0 != s.type &&
              (2 == s.type || 3 == s.type
                ? r.push(l(s))
                : r.push({ type: s.type, text: s.text ?? "" }));
            return r;
          })(e || "", r);
        ...
        Parse_BuildElements(e, t) {
          ...
          const s = [],
            i = () => (s.length < 1 ? void 0 : s[s.length - 1]),
            a = this.m_dictComponents,
            n = (e) => !(!e.tag || !a.get(e.tag)?.autocloses);
          let o = !1,
            l = !0;
          const c = (e, s) => {
            let i = s.text.toLowerCase();
            if (e && e.node.tag === i && a.get(e.node.tag)) {
              const s = a.get(e.node.tag),
                ...
                n = t(s.Constructor, i, ...r.GetElements());
              (r = e.accumulator),
                Array.isArray(n)
            ...
            e.forEach((e, t) => {
              if (1 == e.type) {
                ...
                if (t) {
                  ...
                  s.push({ accumulator: r, node: e, bWrapTextForCopying: l }),
      ...
      function o(e, t, r = 0) {
        ...
        if (2 == s) {
          ...
          t > 0
            ...
            : ((n = {}), (a = i.toLocaleLowerCase())),
            e.push({ type: s, text: i, tag: a, args: n, rawargs: o });
        } else 0 != s && e.push({ type: s, text: i });
        return { type: r, text: "" };
      }
      function l(e) {
        let t = "";
    ...
    32803: (e, t, r) => {
      ...
      function v(e) {
        return R(e, s.k_eStoreSalePage, "absolute");
      }
      function M(e) {
        return R(e, s.k_eStoreView, "absolute");
      }
      function I(e, t, r) {
        if (r)
          return (
        ...
        return B.TS.COMMUNITY_BASE_URL + s + "/";
      }
      function T() {
        return "news";
      }
      function R(e, t, r) {
        const { data: s } = (0, b.J$)(e?.appid ? { appid: e.appid } : void 0);
        if (e) return x(e, s, t, r);
      }
      function x(e, t, r, i) {
        const o = "relative" === i,
          l = "community" === (0, g.yK)(),
          c = o ? "/" : B.TS.STORE_BASE_URL,
          d = I(e.appid, e.clanSteamID, o);
        r === s.k_eView
          ? (r = l ? s.k_eCommunityView : s.k_eStoreView)
          : r === s.k_eViewWebSiteHub &&
            (r = l ? s.k_eCommunityAnnouncementHub : s.k_eStoreNewsHub);
        const m = e.GID ? e.GID : "",
        ...
        switch (r) {
          ...
          case s.k_eCommunityMigrate:
            return d + "partnerevents/migrate_announcement/" + h;
          case s.k_eCommunityPreview:
            return b
            ...
            return e.jsondata.bSaleEnabled
              ? e.clanSteamID.GetAccountID() == a.wv
                ...
                : e.clanSteamID.GetAccountID() == a.yT
                  ...
                  : _
                    ? `${(0, S._)(t)}/${e.GetSaleUpdateLandingPageVanity()}`
                    : b
              ...
              : c;
          case s.k_eCommunityView:
            return d + "announcements/detail/" + h;
          case s.k_eStoreView:
            if (e.clanSteamID.GetAccountID() == (0, u.H)())
              return `${B.TS.STORE_BASE_URL}meetsteam/${m}`;
            if (_)
              return `${(0, S._)(t)}/${e.GetSaleUpdateLandingPageVanity()}`;
            if (b) return `${c}curator/${e.clanSteamID.GetAccountID()}`;
            return `${c}news/${e.appid ? `app/${e.appid}` : `group/${e.clanSteamID.GetAccountID()}`}/${e.bOldAnnouncement ? `old_view/${h}` : `view/${m}`}`;
          case s.k_eStoreUsersNewsHub:
            return `${c}news/`;
          default:
      ...
      function D(e) {
        const { eventModel: t, route: r, bPopup: s = !0 } = e,
          a = f(r, t),
          n = R(t, r, a ? "relative" : "absolute");
        return (
          c.useEffect(() => {
            n && (s ? window.open(n) : window.location.assign(n));
          }, [s, n]),
          a && n ? (0, i.jsx)(d.rd, { push: !0, to: n }) : null
        );
      }
      function k(e, t, r) {
        const s = I(e, t, !1);
        return "admin" === r ? s + "partnerevents" : "";
      }
      function O(e) {
        const { eventModel: t, preferredFocus: r } = e,
          { bCanUseLink: a } = c.useContext(h.I),
          n = (0, l.n9)(),
          u = (0, d.W6)(),
          p = a && f(e.route, t),
          g = R(t, e.route, p ? "relative" : "absolute"),
          S = !p && g ? (0, _.NT)(g) : g,
          b = p || !S ? S : (0, m.wJ)(S, n),
          B = R(t, s.k_eViewWebSiteHub, "absolute"),
          w = Boolean(e.route != s.k_eViewWebSiteHub)
        ...
        return t
          ? p
            ? (0, i.jsx)(o.Ii, {
                ...
                href: u.createHref({ pathname: b }),
                onClick: (t) => {
                  b && (e.onClick?.(t), u.push(b), t.preventDefault());
                },
                onOptionsActionDescription: w,
                onOptionsButton: w ? C : void 0,
                preferredFocus: r,
                children: e.children,
              })
            : (0, i.jsx)(o.Ii, {
    ...
    45285: (e, t, r) => {
      ...
      class B extends i.Message {
        ...
        constructor(e = null) {
          super(),
            B.prototype.impressions || n.Sg(B.M()),
    ...
    20433: (e, t, r) => {
      ...
      function p(e) {
        ...
        return (0, s.jsx)(h, {
          ...e,
          children: (0, s.jsx)(a.Ii, {
            className: e.className,
            href: i ? void 0 : S,
            target: m.TS.IN_CLIENT || i ? void 0 : "_blank",
    ...
    59952: (e, t, r) => {
      ...
      const C = new Map([
        ...
        [
          ...
          {
            Constructor: function (e) {
              return I("h4", e, (0, b.A)(a().Header4, "BB_Header4"));
            },
            autocloses: !1,
        ...
        [
          ...
          {
            Constructor: function (e) {
              return I("h5", e, (0, b.A)(a().Header5, "BB_Header5"));
            },
            autocloses: !1,
            skipFollowingNewline: !0,
          },
        ...
        [
          ...
          {
            Constructor: function (e) {
              return I("div", e, (0, b.A)(a().SmallText, "BB_SmallText"));
            },
            autocloses: !1,
            skipFollowingNewline: !0,
          },
        ...
        [
          ...
          {
            Constructor: function (e) {
              return (0, s.jsx)("hr", { className: a().HR });
            },
            autocloses: !1,
          },
        ],
                ...
                children: [
                  i &&
                    (0, s.jsx)("colgroup", {
                      children: i
                        .split(",")
                        .map((e, t) => (0, s.jsx)(E, { width: e }, t)),
                    }),
                  (0, s.jsx)("tbody", { children: e.children }),
                ],
              });
            },
            autocloses: !1,
                  ...
                  switch (e) {
                    ...
                    case "title":
                      return {
                        ...
                        expanded: t || s || "#Bbcode_Expand_ShowMore_Expanded",
              ...
              return (0, s.jsxs)("div", {
                ...
                children: [
                  (0, s.jsxs)("div", {
                    ...
                    onClick: () => i(!r),
                    children: [
                      (0, B.we)(r ? c.expanded : c.collapsed),
                      (0, s.jsx)("div", {
                        className: a().EmbedArrow,
                        children: (0, s.jsx)(g.DK4, { angle: r ? 180 : 0 }),
                      }),
                    ],
                  }),
                  r &&
          ...
          "remindme",
          {
            Constructor: function (e) {
              const { event: t, showErrorInfo: r } = e.context,
                i = v(e.args);
              if (i) return (0, s.jsx)(_.y, { eventGID: i, bPreviewMode: r });
              if (t) {
                const e = (0, n.sfN)(w.TS.LANGUAGE);
                return (0, s.jsx)(_.j, { eventModel: t, lang: e });
              }
              return null;
            },
            autocloses: !1,
          ...
          "calendarevent",
          {
            Constructor: function (e) {
              const t = v(e.args, "title"),
                ...
                i = v(e.args, "end") ?? v(e.args, "datetime"),
                ...
                S = new Date(i),
                B = S.getUTCFullYear(),
                y = ("0" + (S.getUTCMonth() + 1)).slice(-2),
                w = ("0" + S.getUTCDate()).slice(-2),
                f = ("0" + S.getUTCHours()).slice(-2),
                C = ("0" + S.getUTCMinutes()).slice(-2),
                M = `${B}${y}${w}T${f}${C}00Z`;
              let I;
              try {
                ...
                (e += "VERSION:2.0\r\n"),
                  ...
                  (e += "END:VEVENT\r\n"),
                  (e += "END:VCALENDAR\r\n"),
                  (I = `data:text/calendar;charset=utf-8;base64,${c.iI(new TextEncoder().encode(e))}`);
              } catch (e) {
                console.error(e);
              }
              let T =
              ...
              const R = (e) => {
                if ("ReactNativeWebView" in window) {
                  ...
                  r.postMessage(JSON.stringify(s)), e.preventDefault();
                }
              };
              return (0, s.jsxs)("div", {
                className: (0, b.A)(
      ...
      function T(e) {
        return I("h1", e, (0, b.A)(a().Header1, "BB_Header1"));
      }
      function R(e) {
        return I("h2", e, (0, b.A)(a().Header2, "BB_Header2"));
      }
      function x(e) {
        return I("h3", e, (0, b.A)(a().Header3, "BB_Header3"));
      }
      const j = (e) => {
        const { href: t, ...r } = e;
        let i,
      ...
      function N(e, t) {
        const r = v(t.args, "width"),
          ...
          o = {};
        return (
          i && parseInt(i) > 1 && (o.colSpan = parseInt(i)),
    ...
    84958: (e, t, r) => {
      ...
      function c(e) {
        ...
        const r = new Array();
        {
          ...
          const s = (0, l.j$)(e, "webm");
          s && r.push({ sURL: (0, n.L$)(s), sFormat: "video/webm" });
        }
        const s = (0, i.sfN)(o.TS.LANGUAGE),
          a = s != i.Bhc,
          c = new Array();
        for (let t = i.Bhc; t < i.bP9; t++) {
          const r = (0, l.j$)(e, "sub_" + (0, i.wwZ)(t));
          r &&
            c.push({
              sURL: (0, n.L$)(r),
              eLanguage: t,
          ...
          const o = (0, l.j$)(e, "cap_" + (0, i.wwZ)(t));
          o &&
            c.push({
              sURL: (0, n.L$)(o),
              eLanguage: t,
    ...
    49850: (e, t, r) => {
      ...
      r.r(t),
        r.d(t, {
          BroadcastEmbeddablePopoutHeader: () => qr,
          default: () => Gr,
        });
      var s,
        i = r(34629),
      ...
      class C extends y.Message {
        ...
        constructor(e = null) {
          super(),
            C.prototype.unique_name || f.Sg(C.M()),
      ...
      class v extends y.Message {
        ...
        constructor(e = null) {
          super(),
            v.prototype.broadcast_channel_id || f.Sg(v.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class M extends y.Message {
        ...
        constructor(e = null) {
          super(),
            M.prototype.unique_name || f.Sg(M.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class I extends y.Message {
        ...
        constructor(e = null) {
          super(),
            I.prototype.broadcast_channel_id || f.Sg(I.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class T extends y.Message {
        ...
        constructor(e = null) {
          super(),
            T.prototype.broadcast_channel_id || f.Sg(T.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class j extends y.Message {
        ...
        constructor(e = null) {
          super(),
            j.prototype.unique_name || f.Sg(j.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class D extends y.Message {
        ...
        constructor(e = null) {
          super(),
            D.prototype.broadcast_channel_id || f.Sg(D.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class k extends y.Message {
        ...
        constructor(e = null) {
          super(),
            k.prototype.replace_image_hash || f.Sg(k.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class O extends y.Message {
        ...
        constructor(e = null) {
          super(),
            O.prototype.broadcast_channel_id || f.Sg(O.M()),
      ...
      class E extends y.Message {
        ...
        constructor(e = null) {
          super(),
            E.prototype.image_type || f.Sg(E.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class N extends y.Message {
        ...
        constructor(e = null) {
          super(),
            N.prototype.broadcast_channel_id || f.Sg(N.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class A extends y.Message {
        ...
        constructor(e = null) {
          super(),
            A.prototype.link_index || f.Sg(A.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class F extends y.Message {
        ...
        constructor(e = null) {
          super(),
            F.prototype.broadcast_channel_id || f.Sg(F.M()),
            y.Message.initialize(this, e, 0, -1, [2], null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class G extends y.Message {
        ...
        constructor(e = null) {
          super(),
            G.prototype.link_index || f.Sg(G.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class L extends y.Message {
        ...
        constructor(e = null) {
          super(),
            L.prototype.broadcast_channel_id || f.Sg(L.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class W extends y.Message {
        ...
        constructor(e = null) {
          super(),
            W.prototype.broadcast_channel_id || f.Sg(W.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class J extends y.Message {
        ...
        constructor(e = null) {
          super(),
            J.prototype.broadcast_channel_id || f.Sg(J.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Z extends y.Message {
        ...
        constructor(e = null) {
          super(),
            Z.prototype.is_subscribed || f.Sg(Z.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Q extends y.Message {
        ...
        constructor(e = null) {
          super(),
            Q.prototype.broadcast_channel_id || f.Sg(Q.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class te extends y.Message {
        ...
        constructor(e = null) {
          super(),
            te.prototype.broadcast_channel_id || f.Sg(te.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class re extends y.Message {
        ...
        constructor(e = null) {
          super(),
            re.prototype.is_followed || f.Sg(re.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class ae extends y.Message {
        ...
        constructor(e = null) {
          super(),
            ae.prototype.results || f.Sg(ae.M()),
            y.Message.initialize(this, e, 0, -1, [1], null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class ne extends y.Message {
        ...
        constructor(e = null) {
          super(),
            ne.prototype.algorithm || f.Sg(ne.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class oe extends y.Message {
        ...
        constructor(e = null) {
          super(),
            oe.prototype.results || f.Sg(oe.M()),
            y.Message.initialize(this, e, 0, -1, [1], null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class le extends y.Message {
        ...
        constructor(e = null) {
          super(),
            le.prototype.broadcast_channel_id || f.Sg(le.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class ce extends y.Message {
        ...
        constructor(e = null) {
          super(),
            ce.prototype.broadcasters || f.Sg(ce.M()),
            y.Message.initialize(this, e, 0, -1, [1], null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class de extends y.Message {
        ...
        constructor(e = null) {
          super(),
            de.prototype.steamid || f.Sg(de.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class me extends y.Message {
        ...
        constructor(e = null) {
          super(),
            me.prototype.issuer_steamid || f.Sg(me.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class ue extends y.Message {
        ...
        constructor(e = null) {
          super(),
            ue.prototype.broadcast_channel_id || f.Sg(ue.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class pe extends y.Message {
        ...
        constructor(e = null) {
          super(),
            pe.prototype.broadcast_channel_id || f.Sg(pe.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class _e extends y.Message {
        ...
        constructor(e = null) {
          super(),
            _e.prototype.results || f.Sg(_e.M()),
            y.Message.initialize(this, e, 0, -1, [1], null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class ge extends y.Message {
        ...
        constructor(e = null) {
          super(),
            ge.prototype.broadcast_channel_id || f.Sg(ge.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class be extends y.Message {
        ...
        constructor(e = null) {
          super(),
            be.prototype.broadcast_channel_id || f.Sg(be.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Be extends y.Message {
        ...
        constructor(e = null) {
          super(),
            Be.prototype.steamid || f.Sg(Be.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class ye extends y.Message {
        ...
        constructor(e = null) {
          super(),
            ye.prototype.results || f.Sg(ye.M()),
            y.Message.initialize(this, e, 0, -1, [1], null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class we extends y.Message {
        ...
        constructor(e = null) {
          super(),
            we.prototype.broadcast_channel_id || f.Sg(we.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Ce extends y.Message {
        ...
        constructor(e = null) {
          super(),
            Ce.prototype.broadcast_channel_id || f.Sg(Ce.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class ve extends y.Message {
        ...
        constructor(e = null) {
          super(),
            ve.prototype.results || f.Sg(ve.M()),
            y.Message.initialize(this, e, 0, -1, [1], null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Me extends y.Message {
        ...
        constructor(e = null) {
          super(),
            Me.prototype.broadcast_channel_id || f.Sg(Me.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Ie extends y.Message {
        ...
        constructor(e = null) {
          super(),
            Ie.prototype.chat_id || f.Sg(Ie.M()),
      ...
      class Re extends y.Message {
        ...
        constructor(e = null) {
          super(),
            Re.prototype.results || f.Sg(Re.M()),
            y.Message.initialize(this, e, 0, -1, [1], null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class je extends y.Message {
        ...
        constructor(e = null) {
          super(),
            je.prototype.stream_live_email || f.Sg(je.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class De extends y.Message {
        ...
        constructor(e = null) {
          super(),
            De.prototype.stream_live_email || f.Sg(De.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Pe extends y.Message {
        ...
        constructor(e = null) {
          super(),
            Pe.prototype.results || f.Sg(Pe.M()),
            y.Message.initialize(this, e, 0, -1, [1], null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Ee extends y.Message {
        ...
        constructor(e = null) {
          super(),
            Ee.prototype.broadcasts || f.Sg(Ee.M()),
            y.Message.initialize(this, e, 0, -1, [1], null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Ne extends y.Message {
        ...
        constructor(e = null) {
          super(),
            Ne.prototype.broadcasts || f.Sg(Ne.M()),
            y.Message.initialize(this, e, 0, -1, [1], null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Ae extends y.Message {
        ...
        constructor(e = null) {
          super(),
            Ae.prototype.entries || f.Sg(Ae.M()),
            y.Message.initialize(this, e, 0, -1, [1], null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Fe extends y.Message {
        ...
        constructor(e = null) {
          super(),
            Fe.prototype.broadcasts || f.Sg(Fe.M()),
            y.Message.initialize(this, e, 0, -1, [1], null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Ge extends y.Message {
        ...
        constructor(e = null) {
          super(),
            Ge.prototype.broadcasts || f.Sg(Ge.M()),
            y.Message.initialize(this, e, 0, -1, [1], null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Ve extends y.Message {
        ...
        constructor(e = null) {
          super(),
            Ve.prototype.broadcast || f.Sg(Ve.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Le extends y.Message {
        ...
        constructor(e = null) {
          super(),
            Le.prototype.broadcast || f.Sg(Le.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class We extends y.Message {
        ...
        constructor(e = null) {
          super(),
            We.prototype.template_type || f.Sg(We.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
            ...
            We.sm_m ||
              (We.sm_m = {
                ...
                fields: {
                  ...
                  game_list: { n: 4, c: Ae },
                  quick_explore: { n: 5, c: Fe },
                  conveyor_belt: { n: 6, c: Ge },
                  watch_party: { n: 7, c: Ve },
                  developer: { n: 8, c: Le },
                  event: { n: 9, c: Ue },
                },
              }),
      ...
      class Ke extends y.Message {
        ...
        constructor(e = null) {
          super(),
            Ke.prototype.broadcast_channel_id || f.Sg(Ke.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Ye extends y.Message {
        ...
        constructor(e = null) {
          super(),
            Ye.prototype.broadcast_clip_id || f.Sg(Ye.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Ze extends y.Message {
        ...
        constructor(e = null) {
          super(),
            Ze.prototype.aggregation_delay_ms || f.Sg(Ze.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      !(function (e) {
        (e.CreateBroadcastChannel = function (e, t) {
          ...
          (e.GetGames = function (e, t) {
            return e.SendMsg("SteamTV.GetGames#1", (0, g.I8)(ie, t), ae, {
              bConstMethod: !0,
              ePrivilege: 2,
          ...
          (e.AddWordBan = function (e, t) {
            return e.SendMsg("SteamTV.AddWordBan#1", (0, g.I8)(we, t), fe, {
              ePrivilege: 1,
              eWebAPIKeyRequirement: 2,
            });
          }),
          (e.GetWordBans = function (e, t) {
            return e.SendMsg("SteamTV.GetWordBans#1", (0, g.I8)(Ce, t), ve, {
              bConstMethod: !0,
              ePrivilege: 1,
              eWebAPIKeyRequirement: 2,
            });
          ...
          (e.JoinChat = function (e, t) {
            return e.SendMsg("SteamTV.JoinChat#1", (0, g.I8)(Me, t), Ie, {
              ePrivilege: 2,
              eWebAPIKeyRequirement: 1,
            });
          }),
          (e.Search = function (e, t) {
            return e.SendMsg("SteamTV.Search#1", (0, g.I8)(Te, t), Re, {
              bConstMethod: !0,
              ePrivilege: 0,
            });
          }),
          ...
          (e.AppCheer = function (e, t) {
            return e.SendMsg("SteamTV.AppCheer#1", (0, g.I8)(Je, t), Ze, {
              ePrivilege: 0,
              eWebAPIKeyRequirement: 1,
            });
          });
      ...
      class it {
        ...
        GetOrCreateChat(e, t) {
          ...
          return r || ((r = new at()), this.m_mapChats.set(e || t, r)), r;
        }
        static s_Singleton;
        static Get() {
          return (
            it.s_Singleton ||
              ...
              "dev" == rt.TS.WEB_UNIVERSE &&
                (window.g_BroadcastChatStore = it.s_Singleton)),
            it.s_Singleton
          );
        }
        constructor() {
      ...
      (0, i.Cg)([m.sH], it.prototype, "m_mapChats", void 0);
      class at {
        ...
        constructor() {
          (0, m.Gn)(this),
            (this.m_webAPIInterface = new b.D(
              rt.TS.WEBAPI_BASE_URL,
              rt.iA.webapi_token,
            ));
        }
        InitTextFilter() {
          this.m_textFilterStore = new st.s({ BIsFriend: (0, st.Q)() });
          let e = 0;
          if ("" !== rt.iA.steamid) {
            e = new B.b(rt.iA.steamid).GetAccountID();
          }
        ...
        StartForChannel(e) {
          (this.m_webAPIInterface = new b.D(
            ...
            (this.m_strUserSteamID = rt.iA.steamid),
            this.InitTextFilter(),
            ...
            try {
              ...
              if (this.m_webApiToken) {
                ...
                e.append("chat_id", this.m_ulChatID),
                  ...
                  (r = await o().post(
                    `${rt.TS.WEBAPI_BASE_URL}IBroadcastService/PostChatMessage/v0001?access_token=${this.m_webApiToken}`,
                    e,
                  )),
        ...
        async RequestChatInfo(e) {
          ...
          try {
            const t = {
                ...
                sessionid: rt.TS.SESSIONID,
              },
              r = await o().get(`${rt.TS.CHAT_BASE_URL}broadcast/getchatinfo`, {
                params: t,
                withCredentials: !0,
                cancelToken: e?.token,
              });
            (e && e.token.reason) ||
              (0, m.h5)(() => {
                ...
                (this.m_strChatURL = e.view_url_template),
                  ...
                  (this.m_chatScheduledFunc = new et.LU()),
        ...
        async UpdateBroadcastChatModerator(e, t, r) {
          {
            ...
            s.append("broadcaststeamid", this.m_ulBroadcastSteamID),
              ...
              s.append("bAdd", t ? "1" : "0"),
              s.append("sessionid", rt.TS.SESSIONID);
            try {
              await o().post(
                `${rt.TS.CHAT_BASE_URL}broadcast/ajaxupdatechannelmod`,
                s,
              ),
              ...
              this.m_rgChatMessages.push({ type: p.X8.Notification, msg: i });
            } catch {
              const e = (0, tt.we)(
                t
            ...
            try {
              if (this.m_webApiToken) {
                ...
                t.append("chat_id", this.m_ulChatID),
                  ...
                  t.append("muted", "1"),
                  await o().post(
                    `${rt.TS.WEBAPI_BASE_URL}IBroadcastService/MuteBroadcastChatUser/v0001/?access_token=${this.m_webApiToken}`,
                    t,
                  );
              } else {
            ...
            try {
              if (this.m_webApiToken) {
                ...
                t.append("chat_id", this.m_ulChatID),
                  t.append("user_steamid", e),
                  await o().post(
                    `${rt.TS.WEBAPI_BASE_URL}IBroadcastService/RemoveUserChatText/v0001/?access_token=${this.m_webApiToken}`,
                    t,
                  );
              } else {
        ...
        async UpdateChatMessageFlair(e) {
          if (this.m_webApiToken) {
            ...
            t.append("chat_id", this.m_ulChatID),
              ...
              await o().post(
                `${rt.TS.WEBAPI_BASE_URL}IBroadcastService/UpdateChatMessageFlair/v0001/?access_token=${this.m_webApiToken}`,
                t,
              );
          } else {
      ...
      (0, i.Cg)([m.sH], at.prototype, "m_mapChannelModeratorUsers", void 0),
        (0, i.Cg)([m.sH], at.prototype, "m_mapBroadcastModeratorUsers", void 0),
        (0, i.Cg)([m.sH], at.prototype, "m_nRateLimitSeconds", void 0),
        (0, i.Cg)([m.sH], at.prototype, "m_bRateLimited", void 0),
        (0, i.Cg)([m.sH], at.prototype, "m_rgChatMessages", void 0),
        (0, i.Cg)([m.sH], at.prototype, "m_latestAnnouncement", void 0),
        (0, i.Cg)([Qe.o], at.prototype, "FetchChatModerators", null),
        (0, i.Cg)([Qe.o], at.prototype, "RequestLoop", null),
        (0, i.Cg)([Qe.o], at.prototype, "MuteUserForSession", null);
      var nt = r(60727),
        ot = r(90024),
        lt = r.n(ot),
        ct = r(60155),
      ...
      function Ot(e) {
        const {
          ...
          [o, l] = d.useState(n),
          c = (0, xt.L$)(
            `${Mt.zU.GetBaseURL()}4/080b1f163b02a9810fa78f0b32b9396fab012aef.gif`,
          ),
          m = (0, xt.L$)(
            `${Mt.zU.GetBaseURL()}4/56521811317a8298a7aff4a914be964b67dd0325.png`,
          ),
          u = (0, It.w)(t.giveaway_gid);
        let h =
        ...
        return (0, a.jsx)(Rt.uU, {
          ...
          children: (0, a.jsxs)("div", {
            className: (0, yt.A)({
              [Dt().GiveawayWinnerBox]: !0,
              [Dt().GiveawayWinnerAnnounced]: o === n,
            }),
            children: [
              (0, a.jsx)("div", {
                className: Dt().GiveawayWinnerBoxLeft,
                children: (0, a.jsx)("img", {
                  className: Dt().GiveawayWinnerArt,
                  src: c,
                }),
              }),
              (0, a.jsxs)("div", {
                className: Dt().GiveawayWinnerBoxRight,
                children: [
                  Boolean(o !== n) &&
                    (0, a.jsx)("div", {
                      className: (0, yt.A)(Dt().GiveawayWinnerText),
                      children: (0, tt.PP)(
                  ...
                  Boolean(o === n) &&
                    (0, a.jsx)("div", {
                      className: (0, yt.A)(
                        Dt().GiveawayWinnerText,
                        Dt().GiveawayWinnerAnnounced,
                      ),
                      children: (0, tt.PP)(
                        p
                  ...
                  Boolean(h > 0) &&
                    (0, a.jsx)("div", {
                      className: Dt().GiveawayWinnerCountdown,
                      children: (0, tt.PP)("#GA2022_Congrats_NextDraw", h),
                    }),
                ],
              }),
              (0, a.jsx)("img", {
                className: Dt().GiveawayWinnerQuestion,
                src: m,
              }),
              Boolean(s) &&
                (0, a.jsx)("div", {
                  className: i,
                  children: p ? (0, tt.we)("#GA2022_YouWonNextSteps") : s,
                }),
            ],
          }),
        });
      ...
      function Pt(e) {
        const { gidGiveaway: t, stream: r } = e,
          s = (function (e, t) {
            const [r, s] = (0, c.q3)(() => [
                t?.steamid,
                vt.es.GetBroadcast(t?.steamid)?.m_ulBroadcastID,
              ]),
              [i, a] = d.useState(null);
            d.useEffect(() => {
              let e = null;
              return (
                (r || s) &&
                  ((e = it.Get().GetOrCreateChat(s, r)),
                  e.StartForSteamID(r, s),
                  a(e)),
                () => {
                  e && (e.Stop(), a(null));
                }
            ...
            const n = (0, c.q3)(() => i?.m_latestAnnouncement || null);
          ...
          i = (0, Tt.h)("GameAwardDrop2022");
        let n = null,
          o = Dt().GiveawayRegisterButton;
        return (
          rt.iA.logged_in
            ? i?.registered
              ? ((n = (0, tt.we)("#GA2022_AlreadyRegistered")),
                (o = Dt().GiveawayAlreadyRegistered))
              : (n = (0, tt.we)("#GA2022_RegisterToWin"))
            : (n = (0, tt.we)("#GA2022_RegisterLoginToWin")),
          s
            ? (0, a.jsx)(Ot, {
                latestWinner: s,
                className: Dt().InViewerBar,
                strActionButton: n,
      ...
      const At = (e) => {
          const { userType: t, msg: r, presenterInfo: s } = e;
          if ("presenter" === t)
            return (0, a.jsx)("span", {
              children: (0, a.jsx)(pt.fI, {
                ...
                bioString: s.bio,
                children: (0, a.jsx)("a", {
                  className: (0, yt.A)(Ct().MessageName, Ct().MessagePresenter),
            ...
            });
          {
            ...
            return (
              "broadcaster" === t
                ? (e = Ct().MessageBroadcaster)
                : "moderator" === t && (e = Ct().MessageModerator),
              (0, a.jsx)("span", {
                children: (0, a.jsx)("a", {
                  className: (0, yt.A)(Ct().MessageName, e),
                  href: rt.TS.COMMUNITY_BASE_URL + "profiles/" + r.steamid,
        ...
        Ft = (e) => {
          switch (e.userType) {
            case "presenter":
              return (0, a.jsx)(Et.Gq, {
                toolTipContent: (0, tt.we)(
                  "#BroadcastChat_Role_Presenter_ttip",
                ),
                children: (0, a.jsx)("span", {
                  className: Ct().RoleFlairContainer,
                  children: (0, a.jsx)(Bt.NCC, {}),
                }),
              });
            case "moderator":
              return (0, a.jsx)(Et.Gq, {
      ...
      let Gt = class extends d.Component {
        ...
        AddLinksEmoticons(e, t) {
          ...
          for (let e = 0; e < s.length; e += 1)
            e % 2 == 1
              ? i.push((0, a.jsx)(mt.n, { emoticon: s[e], large: !0 }, e))
              : i.push(s[e]);
          return i;
        }
        HandleScroll(e) {
              ...
              ? r.push(
                  (0, a.jsx)(
                    ct.kt,
                    {
                      ...
                      children: (0, tt.we)("#BroadcastChat_RemoveMessages"),
                    },
                    "remove",
                  ),
                  (0, a.jsx)(
                    ct.kt,
                    {
                      ...
                      children: (0, tt.we)("#BroadcastChat_half_Mute"),
                    },
                    "updatebanh",
                  ),
                  (0, a.jsx)(
                    ct.kt,
                    {
                      ...
                      children: (0, tt.we)("#BroadcastChat_day_Mute"),
                    },
                    "updateband",
                  ),
                  (0, a.jsx)(
                    ct.kt,
                    {
                      ...
                      children: (0, tt.we)("#BroadcastChat_week_Mute"),
                    },
                    "updatebanw",
                  ),
                  (0, a.jsx)(
                    ct.kt,
                    {
                      ...
                      children: (0, tt.we)("#BroadcastChat_perm_Mute"),
                    },
                    "updatebanp",
                  ),
                  (0, a.jsx)(
                    ct.kt,
                    {
                      ...
                      children: (0, tt.we)("#BroadcastChat_Unmute"),
                    },
                    "removeban",
                  ),
                )
                ...
                ? r.push(
                    (0, a.jsx)(
                      ct.kt,
                      {
                        ...
                        children: (0, tt.we)("#BroadcastChat_UnmuteLocal"),
                      },
                      "unmuteuser",
                    ),
                  )
                : r.push(
                    (0, a.jsx)(
                      ct.kt,
                      {
                        ...
                        children: (0, tt.we)("#BroadcastChat_MuteLocal"),
                      },
                      "muteuser",
                    ),
                  ),
            ((rt.iA && rt.iA.is_support) ||
              ...
              ? r.push(
                  (0, a.jsx)(
                    ct.kt,
                    {
                      ...
                      children: (0, tt.we)("#BroadcastChat_Remove_Moderator"),
                    },
                    "removemod",
                  ),
                )
              : r.push(
                  (0, a.jsx)(
                    ct.kt,
                    {
                      ...
                      children: (0, tt.we)("#BroadcastChat_Add_Moderator"),
                    },
                    "addmod",
                  ),
                );
          ...
          return r.length
            ? (0, u.lX)(
                (0, a.jsxs)(ct.tz, {
                  children: [
                    (0, a.jsxs)("div", {
                      className: Ct().SelectedUserNameCtn,
                      children: [
                        (0, tt.we)("#BroadcastChat_User"),
                        (0, a.jsx)("br", {}),
                        (0, a.jsx)("span", {
                          className: Ct().SelectedUserName,
        ...
        RenderUserChatLine(e, t, r) {
          let s = r ? r.get(e.steamid) : void 0;
          const i =
            e.type === p.X8.Chat
              ? (function (e, t, r) {
                  return r
          ...
          return (0, a.jsxs)(
            "div",
            {
              ...
              children: [
                e.type === p.X8.Chat && (0, a.jsx)(Ft, { userType: i }),
                e.flair &&
                  (0, a.jsx)("span", {
                    className: Ct().FlairContainer,
                    children: this.AddLinksEmoticons(e.flair, !1),
                  }),
                e.type === p.X8.Chat &&
                  (0, a.jsx)(At, { userType: i, msg: e, presenterInfo: s }),
                e.type === p.X8.Chat &&
                  this.m_chat.GetBroadcastSteamID() === e.steamid &&
                  (0, a.jsx)("span", {
                    className: `${Ct().MessageNotification} ${Ct().MessageContents}`,
                ...
                e.type === p.X8.Chat &&
                  ...
                  (0, a.jsx)("span", {
                    className: `${Ct().MessageNotification} ${Ct().MessageContents}`,
                    children: ` (${(0, tt.we)("#BroadcastChat_Moderator")})`,
                  }),
                (0, a.jsxs)("span", {
                  className: `${Ct().MessageContents} ${this.AddLinksEmoticons(e.msg, !1).filter((e) => e && "string" == typeof e).length ? "" : Ct().EmoticonsOnly}`,
                  children: [
                    e.type === p.X8.Chat ? " : " : "",
        ...
        render() {
          const {
            ...
            i = r ? s.reverse() : s,
            n = this.m_chat
              ? nt.l.GetPresenterMapForBroadcasterSteamID(
                  this.m_chat.GetBroadcastSteamID(),
                )
              : void 0,
            o = this.m_chat ? this.m_chat.m_latestAnnouncement : null;
          return (0, a.jsxs)("div", {
            className: (0, yt.A)(Ct().ChatPanel, "ChatPanel"),
            style: e ? { display: "none" } : void 0,
            children: [
              (0, a.jsx)(kt, { latestAnnouncement: o }),
              r &&
                !!this.m_chat &&
                (0, a.jsx)(Vt, {
                  oChat: this.m_chat,
              ...
              (0, a.jsx)("div", {
                className: (0, yt.A)(
                  `${Ct().ChatMessages} ${lt().minHeightZero}`,
                  "ChatMessages",
                ),
                onScroll: this.HandleScroll,
                ref: this.messagesContainer,
                children: i.map((e, t) => this.RenderUserChatLine(e, t, n)),
              }),
              (0, a.jsx)(bt, {}),
              !r &&
                !!this.m_chat &&
      ...
      function Vt(e) {
        const { oChat: t, emoticonStore: r, bPartnerMemberOnlyChat: s } = e;
        return !s || (rt.iA?.logged_in && rt.iA?.is_partner_member)
          ? rt.iA?.logged_in
        ...
        const { oChat: t, emoticonStore: r } = e,
          ...
          l = d.useCallback(
            (e) => {
              !!e.shiftKey ||
                13 !== e.charCode ||
                (t.m_bRateLimited || (t.SendMessage(s), i("")),
                e.preventDefault());
            },
            [t, s],
          ),
          m = d.useCallback(
            (e, t = !1) => {
              i(s + `ː${e}ː`), n?.current && n.current.focus();
            },
            [s, n],
          );
        let u = o || 0 == s.trim().length,
          h = (0, yt.A)(lt().chatSubmitButton, 0 == s.length && lt().disabled);
        return (0, a.jsx)("div", {
          className: (0, yt.A)(Ct().ChatEntryCtn, "ChatEntryCtn"),
          children: (0, a.jsxs)("div", {
            className: (0, yt.A)(Ct().ChatEntry, "ChatEntry"),
            children: [
              (0, a.jsxs)("form", {
                className: `${lt().chatEntryControls}`,
                children: [
                  (0, a.jsx)("textarea", {
                    className: lt().chatTextarea,
                    placeholder: (0, tt.we)("#BroadcastChat_EnterResponse"),
                    onKeyPress: l,
                  ...
                  (0, a.jsx)("button", {
                    ...
                    children: (0, a.jsx)(Bt.XTb, {}),
                  }),
                ],
              }),
              (0, a.jsx)("div", {
                style: { height: "50px" },
                className: `${lt().chatEntryActionsContainer}`,
                children: (0, a.jsxs)("div", {
                  className: lt().chatEntryActionsGroup,
                  children: [
                    (0, a.jsx)(ut.A, {
                      disabled: !1,
      ...
      function Ut(e) {
        const { oChat: t, emoticonStore: r, textInputRef: s } = e;
        return t.m_strFlairGroupID &&
          ...
          ? (0, a.jsx)(ut.A, {
              ...
              OnEmoticonSelected: (e) => {
                t.UpdateChatMessageFlair(e), s?.current && s.current.focus();
              },
              rtLastAckedNewEmoticons: Number.MAX_VALUE,
              emoticonStore: r,
              strFlairGroupID: t.m_strFlairGroupID,
              title: (0, tt.we)("#ChatEntryButton_Flair"),
              buttonIcon: (0, a.jsx)(Bt.P7r, {}),
            })
          : null;
      }
      (0, i.Cg)([m.sH], Gt.prototype, "m_chat", void 0),
        (0, i.Cg)([wt.oI], Gt.prototype, "StartChat", null),
        (0, i.Cg)([wt.oI], Gt.prototype, "HandleScroll", null),
        (0, i.Cg)([wt.oI], Gt.prototype, "OnContextMenu", null),
        (0, i.Cg)([wt.oI], Gt.prototype, "RenderUserChatLine", null),
        (Gt = (0, i.Cg)([l.PA], Gt));
      class Wt extends d.Component {
        render() {
          return (0, a.jsx)("div", {
            className: Ct().TimedProgressBarContainer,
            children: (0, a.jsxs)("div", {
              className: Ct().wrapper,
              children: [
                (0, a.jsx)("div", {
                  className: `${Ct().spinner} ${Ct().pie}`,
                  style: { animationDuration: `${this.props.nSeconds || 0}s` },
                }),
                (0, a.jsx)("div", {
                  className: `${Ct().filler} ${Ct().pie}`,
                  style: { animationDuration: `${this.props.nSeconds || 0}s` },
                }),
                (0, a.jsx)("div", {
                  className: Ct().mask,
      ...
      function Ht(e) {
        return (0, a.jsxs)("div", {
          ...
          children: [
            (0, a.jsx)("div", {
              className: Ct().LogInPrompt,
              children: (0, tt.we)("#Broadcast_PartnerChat_Login"),
            }),
            !rt.iA.logged_in &&
              (0, a.jsx)(dt.$n, {
                onClick: ht.vg,
                className: (0, yt.A)(Ct().SignInButton),
      ...
      const lr = (0, l.PA)((e) => {
        ...
        let u = (0, yt.A)(
          ...
          h = rr().StoreSaleWidgetImage_mini,
          p = rr().StoreSaleImage_mini;
        if (null == n)
          return (0, a.jsx)("div", {
            className: u,
            children: (0, a.jsx)(er.t, { size: "medium" }),
          });
        if (null == n || !n.name)
          return (0, a.jsx)("div", {
      ...
      const fr = (0, l.PA)((e) => {
        const { event: t } = e,
          ...
          i = (0, d.useRef)(null),
          [n, l] = (0, d.useState)(
            t ? Br.pF.GetCreatorHome(t.clanSteamID) : null,
          );
        if (
          ((0, d.useEffect)(() => {
            ...
            return (
              (async () => {
                const t = B.b.InitFromClanID(r),
                  s = await Br.pF.LoadCreatorHome(t, !1, e);
                e.token.reason || l(s);
              })(),
              () => {
            ...
            children: [
              ...
              Boolean(t.jsondata.broadcast_item_drops_details_clan_accountid) &&
                (0, a.jsx)("a", {
                  ...
                  children: (0, tt.we)("#SalePage_WatchForDrop_LearnMore"),
                }),
            ],
          }),
        });
      ...
      function Or(e) {
        ...
        return (0, a.jsxs)("div", {
          className: (0, yt.A)(vr().FlexRowContainer, Dr().share_controls_ctn),
          children: [
            (0, a.jsx)(Et.he, {
              toolTipContent: (0, tt.we)("#EventDisplay_Share_OnFaceBook"),
              children: (0, a.jsx)(Rt.uU, {
                href: r.strFacebookUrl,
                className: Dr().ShareBtn,
                children: (0, a.jsx)("img", {
                  className: (0, yt.A)(vr().Button),
                  src: Ir.A,
                }),
              }),
            }),
      ...
      function Pr(e) {
        const { steamid: t } = e,
            ...
            (e) => {
              r.current &&
                r.current.ownerDocument.defaultView.navigator.clipboard
                  ...
                  .then((e) => {
                    i((0, tt.we)("#EventDisplay_Share_CopiedToClipboard"));
                  })
                  .catch((e) => {
                    i(
                      (0, tt.we)("#EventDisplay_Share_FailedToCopyToClipboard"),
                    ),
          ...
          l = rt.TS.COMMUNITY_BASE_URL + "broadcast/watch/" + t;
        return (0, a.jsxs)("div", {
          children: [
            (0, a.jsxs)("div", {
              className: (0, yt.A)(vr().FlexRowContainer, Dr().linkField),
              onClick: o,
              children: [
                (0, a.jsx)("span", {
                  className: Dr().LinkInputLabel,
                  children: (0, tt.we)("#EventDisplay_Share_Link"),
                }),
                (0, a.jsx)("textarea", {
                  className: Dr().LinkInput,
                  ref: r,
                  value: l,
                  readOnly: !0,
                }),
      ...
      let Vr = class extends d.Component {
        ...
        async componentDidMount() {
          await hr.j.Get().LoadBIsEmbeddedBroadcastHidden(this.m_cancelSignal),
            ...
            !this.props.event.BUsesContentHubForItemSource()
              ? hr.j.Get().HintLoadEmbeddablePreviewStreams(this.props)
              : hr.j.Get().HintLoadEmbeddableStreams(this.props)),
        ...
        ToggleBroadcastExpandShrink() {
          let e = hr.j.Get().GetPlayReadyStream(this.props);
          const t = this.state.bExpanded,
            r = vt.es.GetOrCreateBroadcastInfo(e.steamid).m_nAppID;
          (0, hr.U7)(r, t ? mr.Mc.U6 : mr.Mc.B_, e.snr),
            ...
            t ||
              this.setState({ bExpanded: !this.state.bExpanded }, () =>
                hr.j.Get().SetEmbeddedStreamCollapsed(!this.state.bExpanded),
              );
        }
        OnShrinkTransitionEnd() {
          "0vh" === this.state.innerStyle.maxHeight &&
            this.setState({ bExpanded: !1 }, () =>
              hr.j.Get().SetEmbeddedStreamCollapsed(!0),
            );
        }
        async onStreamSelect(e) {
          this.setState({ bStartMuted: !1 }),
            hr.j.Get().GetPlayReadyStream(this.props).accountid !=
              e.accountid &&
              (await hr.j.Get().AttemptToPlayStream(this.props, e));
        }
        async PlayNextNonVOD() {
          ...
          await hr.j.Get().PlayFromAvailableStreams(this.props, e, !0);
        }
        ConstructSidePanels(e, t) {
          ...
          const s = hr.j.Get().GetConcurrentStreams(this.props) > 1;
          let i = vt.es.GetOrCreateBroadcastInfo(e.steamid).m_nAppID,
            n = (0, a.jsx)(Hr, { ImgUrl: e.right_panel }, "right" + i),
            o = (0, a.jsx)(Hr, { ImgUrl: e.left_panel }, "left" + i);
          if (i < 11) {
            const t = nt.l.GetAppIDListForBroadcasterSteamID(e.steamid);
            t && 1 === t.length && (i = t[0]);
          }
          return (
            !(
              ...
              ((n = (0, a.jsx)(lr, { appid: i }, "mini" + e.accountid)),
        ...
        MarkBroadcastSeen() {
          this.m_bMarkedUsabilitySeen ||
            ...
            (0, dr.D)() && (0, dr.D)().AddEvent(ur.Xm.ex));
        }
        render() {
          ...
          if (e) {
            ...
            let t = "show" === hr.j.Get().GetChatVisibility();
            const {
              event: r,
              language: s,
            ...
            let n = this.ConstructSidePanels(e, t),
              ...
              l = hr.j.Get().GetConcurrentStreams(this.props) > 1;
            const c = () => {
            ...
            return (0, a.jsx)(d.Fragment, {
              children: (0, a.jsxs)("div", {
                ...
                children: [
                    ...
                    children: [
                      (0, a.jsxs)("div", {
                        ...
                        children: [
                          (0, a.jsx)(_r.K, {}),
                          (0, a.jsx)("div", {
                            className: wr().streamTitle,
                            children: o,
                          }),
                          (0, a.jsxs)("div", {
                            className: wr().bordered_corner_container,
                            children: [
                              Boolean(!this.state.bExpanded) &&
                                (0, a.jsx)(Et.he, {
                                  ...
                                  children: (0, a.jsx)("div", {
                                    className: wr().broadcast_settings_icon,
                                    onClick: () =>
                                      window.open(
                                        `${rt.TS.STORE_BASE_URL}account/preferences/#store_broadcast_settings`,
                                      ),
                                  }),
                                }),
                              (0, a.jsx)(Et.he, {
                                ...
                                children: (0, a.jsx)("div", {
                                  className: this.state.bExpanded
                                    ? wr().bordered_corner_expanded
                                    : wr().bordered_corner_shrinked,
                          ...
                          Boolean(e.gamedata_subtitle) &&
                            (0, a.jsx)("div", {
                              className: wr().bordered_subtitle,
                  ...
                  (0, a.jsx)("div", { className: wr().clear_div }),
                ],
              }),
            });
          }
      ...
      (0, i.Cg)([wt.oI], Vr.prototype, "ToggleBroadcastExpandShrink", null),
        (0, i.Cg)([wt.oI], Vr.prototype, "OnShrinkTransitionEnd", null),
        (0, i.Cg)([wt.oI], Vr.prototype, "onStreamSelect", null),
        (0, i.Cg)([wt.oI], Vr.prototype, "PlayNextNonVOD", null),
        (Vr = (0, i.Cg)([l.PA], Vr));
      class Lr extends d.Component {
        ...
        CloseBroadcastPopup() {
          const e = vt.es.GetOrCreateBroadcastInfo(
            this.props.stream.steamid,
          ).m_nAppID;
          (0, hr.U7)(e, mr.Mc.n6, this.props.stream.snr),
        ...
        render() {
          return (0, a.jsx)("div", {
            ...
            children: (0, a.jsx)(zr.j, {
              ...
              className: (0, yt.A)({
                [wr().video_placeholder]: !0,
                video_placeholder_trgt: !0,
                [wr().WidePlayer]: this.props.bWidePlayer,
              }),
              ref: this.m_iVideoContainerRef,
              children: (0, a.jsxs)("div", {
                className: this.state.bPopout
                  ? wr().broadcast_floating
                  : wr().video_container,
                children: [
                  this.state.bPopout &&
                    (0, a.jsx)(qr, {
                  ...
                  (0, a.jsx)("div", {
                    className: wr().BroadcastPlayerContainer,
                    children: (0, a.jsx)(qt.default, {
                      steamIDBroadcast: this.props.stream.steamid,
      ...
      function Ur(e) {
        const { stream: t } = e,
          [r] = (0, c.q3)(() => [t.steamid]),
          s = vt.es.GetOrCreateBroadcastInfo(r).m_nAppID,
          i = Fr.list.find(
            (e) =>
              e.appid == s &&
        ...
        }
        {
          ...
          return (0, a.jsx)(Et.he, {
            toolTipContent: (0, tt.we)("#BroadcastWatch_View_Broadcast_Page"),
            children: (0, a.jsx)("a", {
              href: e,
              className: wr().external_link,
              children: (0, a.jsx)(Bt.GrD, {}),
            }),
          });
        }
      }
      (0, i.Cg)([wt.oI], Lr.prototype, "CloseBroadcastPopup", null),
        (0, i.Cg)([wt.oI], Lr.prototype, "OnEnter", null),
        (0, i.Cg)([wt.oI], Lr.prototype, "OnLeave", null);
      let Wr = class extends d.Component {
        OnToggleChat(e) {
          e.preventDefault();
          const t = vt.es.GetOrCreateBroadcastInfo(
            this.props.stream.steamid,
          ).m_nAppID;
          (0, hr.U7)(
            t,
            "show" === hr.j.Get().GetChatVisibility() ? mr.Mc.kz : mr.Mc.bW,
            this.props.stream.snr,
          ),
            hr.j.Get().ToggleChatVisibility();
        }
        onWatchBroadcastPage() {
          const e = vt.es.GetOrCreateBroadcastInfo(
            this.props.stream.steamid,
          ).m_nAppID;
          (0, hr.U7)(e, mr.Mc.Is, this.props.stream.snr);
        }
        render() {
          const e = "remove" != hr.j.Get().GetChatVisibility(),
            t = "hide" === hr.j.Get().GetChatVisibility(),
            r = !this.props.stream.nAppIDVOD,
            s = r;
          let i = Number.parseInt(
            "" +
              vt.es.GetOrCreateBroadcastInfo(this.props.stream.steamid)
                .m_nViewerCount,
          );
          return (0, a.jsxs)("div", {
            className: (0, yt.A)(wr().viewer_bar, "viewer_bar"),
            children: [
              (0, a.jsxs)("div", {
                className: (0, yt.A)(wr().viewer_count, "viewer_count"),
                children: [(0, a.jsx)(Bt.y_e, {}), (0, br.Dq)(i)],
              }),
              (0, a.jsxs)("div", {
                className: (0, yt.A)(wr().viewer_links, "viewer_links"),
                children: [
                  Boolean(e && !t && this.props.bMultistream) &&
                    (0, a.jsx)("div", {
                      className: wr().chat_link,
                      children: (0, a.jsx)("a", {
                        href: "#",
                        className: wr().ChatToggle,
                  ...
                  (0, a.jsx)(Et.he, {
                    ...
                    children: (0, a.jsx)("a", {
                      ...
                      target: rt.TS.IN_CLIENT ? void 0 : "_blank",
                      className: wr().settings_link,
                      children: (0, a.jsx)(Bt.wB_, {}),
                    }),
                  }),
                  r && (0, a.jsx)(Ur, { ...this.props }),
                ],
              }),
      ...
      (0, i.Cg)([wt.oI], Wr.prototype, "OnToggleChat", null),
        (0, i.Cg)([wt.oI], Wr.prototype, "onWatchBroadcastPage", null),
        (Wr = (0, i.Cg)([l.PA], Wr));
      class Hr extends d.Component {
        render() {
          let e = this.props.ImgUrl;
          return (0, a.jsxs)("div", {
            className: wr().SidePanelBackground,
            children: [
              e &&
                (0, a.jsx)("img", {
                  className: wr().side_panels,
                  src: this.props.ImgUrl,
                }),
              !e && (0, a.jsx)("div", { className: wr().side_panels }),
            ],
          });
        }
      }
      const qr = (0, l.PA)((e) => {
        ...
        let r = vt.es.GetOrCreateBroadcastInfo(t).m_nAppID;
        r = r != vt.fO ? r : 0;
        const s = (0, sr.$5)(r),
          { data: i } = (0, ir.J$)(s);
        return (0, a.jsxs)("div", {
          className: [wr().PopOutVideoTitleBar, wr().NoSeslect].join(" "),
          children: [
            Boolean(i)
              ? (0, a.jsx)(Zt.u, {
                  id: s,
                  className: wr().PopOutVideoTitleText,
            ...
            (0, a.jsx)(Et.he, {
              ...
              children: (0, a.jsx)("button", {
                className: wr().PopOutVideoCloseButton,
                onClick: e.OnPreventPopup,
                children: (0, a.jsx)(Bt.X, {}),
              }),
            }),
          ],
        });
      ...
      function Kr(e, t) {
        const r = vt.es.GetOrCreateBroadcastInfo(t.steamid).m_nAppID,
          s = pr.A.Get().GetApp(r);
        return e && s?.GetAssets()?.GetHeaderURL()
          ? parseInt(wr().strStreamIconCapsuleArtHeight)
          : parseInt(wr().strStreamIconScreenshotArtHeight);
      }
      function Yr(e) {
        const {
            curStream: t,
        ...
        return (
          (0, d.useEffect)(() => {
            if (o && o.current) {
              const e = l
                .map((e) => vt.es.GetOrCreateBroadcastInfo(e.steamid).m_nAppID)
                .filter(Boolean);
              pr.A.Get()
          ...
          (0, a.jsx)("div", {
            ...
            className: (0, yt.A)({
              ...
              side_panels: !0,
              [wr().multistream]: !0,
              [wr().scrollingstreams]: l.length > 3,
            }),
            children: (0, a.jsx)("div", {
      ...
      function Xr(e) {
        ...
        let n = (0, c.q3)(
          () => vt.es.GetOrCreateBroadcastInfo(s.steamid).m_nAppID,
        );
        n = n != vt.fO ? n : 0;
        const o = (0, sr.$5)(n),
          { data: l } = (0, ir.J$)(o),
          { data: d } = (0, ir.lv)(o);
        if (!(0, hr.fn)(s)) return null;
        const m = i && d && (0, nr.b0)(d, "header"),
          u = Number.parseInt("" + s.viewer_count),
          h = !Number.isNaN(u),
          p = !!s.nAppIDVOD && l?.name;
        return (0, a.jsxs)("div", {
          className: (0, yt.A)({
            [wr().stream_icon_and_viewer_container]: !0,
            [wr().stream_featured]:
              s.current_selection_priority == Ar.mY.k_eFeatured,
            [wr().display_capsule_art]: Boolean(m),
          }),
          children: [
            (0, a.jsx)(Zt.j, {
              id: o,
              hoverClassName: wr().StreamCapsule,
              children: (0, a.jsx)(Sr.K, {
                className: (0, yt.A)(
                  wr().stream_icon_container,
                  r && wr().stream_selected,
                ),
                onClick: () => t && t(s),
            ...
            (0, a.jsx)("div", {
              className: (0, yt.A)(wr().viewer_count, !h && wr().vod_title),
              children: h
                ? (0, a.jsxs)(a.Fragment, {
                    children: [
                      (0, a.jsx)(Bt.y_e, {}),
                      (0, a.jsx)("div", {
                        className: wr().ViewerNum,
                        children: (0, br.Dq)(u),
                      }),
                    ],
                  })
      ...
      function $r(e) {
        ...
        if (t) {
          ...
          return (0, a.jsxs)(a.Fragment, {
            children: [
              (0, a.jsx)("img", {
                className: (0, yt.A)(i, wr().stream_icon_hide_on_hover),
                src: t,
              }),
              (0, a.jsx)(gr.o, {
                className: (0, yt.A)(i, wr().stream_icon_show_on_hover),
                srcs: e,
              }),
            ],
          });
        }
        return (0, a.jsx)("img", { className: i, src: r });
      }
      function Jr(e) {
        const { stream: t, orientation: r } = e,
          s = "below" == r,
          [i, n] = (0, c.q3)(() => [
            vt.es.GetBroadcast(t.steamid),
            vt.es.GetBroadcast(t.steamid)?.m_ulBroadcastID,
          ]),
          o = (0, c.q3)(() => t.steamid);
        return i
          ? (0, a.jsx)("div", {
              className: (0, yt.A)({
                [wr().chat_below_container]: s,
                [wr().chat_rightside_container]: !s,
                [wr().store_chat_ctn]: !0,
              }),
              children: (0, a.jsx)("div", {
                className: wr().ChatContainer,
                children: (0, a.jsx)(Gt, {
                  emoticonStore: hr.MX,
                  watchLocation: h.nn.fe,
                  steamID: o,
    ...
    3067: (e, t, r) => {
      ...
      (0, s.Cg)([i.sH], n.prototype, "bValid", void 0),
        (0, s.Cg)([i.sH], n.prototype, "stream", void 0),
        (0, s.Cg)([i.sH], n.prototype, "name", void 0),
        (0, s.Cg)([i.sH], n.prototype, "appName", void 0),
        (0, s.Cg)([i.sH], n.prototype, "appID", void 0),
        (0, s.Cg)([i.sH], n.prototype, "link", void 0),
        (0, s.Cg)([i.sH], n.prototype, "linkName", void 0),
        (0, s.Cg)([i.sH], n.prototype, "tabIcon", void 0),
        (0, s.Cg)([i.sH], n.prototype, "offlineImage", void 0),
        (0, s.Cg)([i.sH], n.prototype, "gidEvent", void 0);
      let o = new n({
        bValid: !1,
        stream: { 0: "#Broadcast_EnglishMain" },
        name: "",
    ...
    72224: (e, t, r) => {
      ...
      class _ extends o.Component {
        ...
        updateCanvas() {
          ...
          let a = () => {
            this.m_Context.drawImage(t, 0, 0, s * e[0], i * e[1]),
      ...
      (0, s.Cg)([h.oI], _.prototype, "BindCanvasRef", null),
        (0, s.Cg)([h.oI], _.prototype, "updateCanvas", null);
      var g = r(60155),
        S = r(16569),
        b = r(90740),
        B = r(52038);
      ...
      function f(e) {
        ...
        return (0, i.jsx)(w, {
          ...
          childRef: a,
          ...r,
          children: (0, i.jsx)("div", { ref: a, className: "crossfade-img" }),
        });
      }
      var C = r(41399),
        v = r(69409),
      ...
      const F = (0, n.PA)((e) => {
        ...
        let r = m.fK.Loading,
          s = "";
        if (t) {
          (r = t.GetBroadcastState()), (s = t.GetBroadcastStateDescription());
          let e = t.IsBuffering();
          r == m.fK.Unlocking && ((r = m.fK.Loading), (s = "")),
            r == m.fK.Ready && e && ((r = m.fK.Loading), (s = ""));
        }
      ...
      (0, s.Cg)([h.oI], G.prototype, "OnClick", null);
      ...
      (0, s.Cg)([h.oI], V.prototype, "HideStats", null),
        (V = (0, s.Cg)([n.PA], V));
      let L = class extends o.Component {
        ...
        createBufferedRange(e) {
          ...
          if (a > 0)
            ...
            r.push((0, i.jsx)("div", { children: t }, s + "none"));
          }
          return r;
        }
        render() {
      ...
      class W extends o.Component {
        ...
        render() {
          let e = !1,
            t = !1;
          const { video: r, actions: s } = this.props;
          let a,
            n,
            o = 0,
            l = (0, i.jsx)(
      ...
      (0, s.Cg)([h.oI], W.prototype, "OnVideoControlClick", null),
        (0, s.Cg)([h.oI], W.prototype, "OnSubtitlesClick", null),
        (0, s.Cg)([h.oI], W.prototype, "OnMouseUp", null),
        (0, s.Cg)([h.oI], W.prototype, "bindSettingsButton", null),
        (0, s.Cg)([h.oI], W.prototype, "BindSettingsPanel", null),
        (0, s.Cg)([h.oI], W.prototype, "OnShowStats", null);
      const H = !0;
              ...
              children: (0, i.jsxs)("div", {
                ...
                children: [
                  (0, i.jsx)("div", {
                    ...
                    children: (0, i.jsx)(I.fSs, {}),
                  }),
                  (0, i.jsx)(K, { video: e, onDrag: this.OnChildDrag }),
                ],
              }),
            })
          );
      ...
      (0, s.Cg)([a.sH], q.prototype, "m_bShowSlider", void 0),
        (0, s.Cg)([h.oI], q.prototype, "ToggleMute", null),
        (0, s.Cg)([h.oI], q.prototype, "OnMouseEnter", null),
        (0, s.Cg)([h.oI], q.prototype, "OnMouseLeave", null),
        (0, s.Cg)([h.oI], q.prototype, "OnChildDrag", null),
        (q = (0, s.Cg)([n.PA], q));
      let K = class extends o.Component {
        ...
        SetVolumeWithCoord(e, t) {
          let r = e.getBoundingClientRect(),
            s = D.Fu(t, r.left, r.right, 0, 1),
            i = D.OQ(s, 0, 1),
            a = this.props.video;
          a.SetMute(s < 0.01), a.SetVolume(i);
        }
        render() {
          let e = this.props.video,
            t = 100 * e.GetVolume();
      ...
      let $ = class extends o.Component {
        ...
        OnContextMenu(e) {
          this.state.bFullscreen ||
            ((0, l.lX)(
              (0, i.jsx)(g.tz, { children: this.GetContextMenuItems() }),
              e,
            ),
            e.preventDefault());
        }
        ...
        ShowStorePage(e) {
          ...
          if (!r) return;
          let s = (0, d.k2)(`${k.TS.STORE_BASE_URL}app/${r.m_strAppId}`);
        ...
        render() {
          ...
          return (0, i.jsxs)("div", {
            ...
            children: [
              ...
              u && (0, i.jsx)(Q, { onClick: this.props.onRequestClose }),
              r &&
                (0, i.jsx)(V, {
        ...
        render() {
          ...
          return (0, i.jsxs)("div", {
            ...
            children: [
              ...
              t && (0, i.jsx)(ie, { video: e }),
            ],
          });
        }
      }
      (0, s.Cg)([h.oI], ee.prototype, "OnJumpBackward", null),
        (0, s.Cg)([h.oI], ee.prototype, "OnJumpForward", null);
      const te = (0, n.PA)((e) => {
      ...
      let re = class extends o.Component {
        ...
        render() {
          ...
          return (0, i.jsx)("div", {
            ...
            children: e ? (0, i.jsx)(I.jGG, {}) : (0, i.jsx)(I.vRz, {}),
          });
        }
      };
      (0, s.Cg)([h.oI], re.prototype, "OnTogglePlayPause", null),
        (re = (0, s.Cg)([n.PA], re));
      ...
      (0, s.Cg)([a.sH], se.prototype, "video", void 0),
        (0, s.Cg)([a.EW], se.prototype, "has_previous_marker", null),
        (0, s.Cg)([h.oI], se.prototype, "OnJumpToPreviousMarkerClicked", null),
        (se = (0, s.Cg)([n.PA], se));
      ...
      (0, s.Cg)([a.sH], ie.prototype, "video", void 0),
        (0, s.Cg)([a.EW], ie.prototype, "has_next_marker", null),
        (0, s.Cg)([h.oI], ie.prototype, "OnJumpToNextMarkerClicked", null),
        (ie = (0, s.Cg)([n.PA], ie));
      const ae = (e) =>
        (0, i.jsx)("div", {
      ...
      let oe = class extends o.Component {
        ...
        AdjustSliderForClientX(e) {
          let t = this.props.video,
            ...
            i = t.GetTimeAtMousePosition(e, this.m_rectSlider, r, s);
          if (this.state.bStartMouseDown) {
            const e = D.OQ(i, r, t.m_editorEndTime - 5);
            t.m_editorStartTime = e;
          } else if (this.state.bEndMouseDown) {
            const e = D.OQ(i, t.m_editorStartTime + 5, s);
            t.m_editorEndTime = e;
          } else
        ...
        AdjustHoverForClientX(e) {
          ...
          this.m_rectSlider =
            this.m_elSlider.current &&
            this.m_elSlider.current.getBoundingClientRect();
          t.GetTimeAtMousePosition(e, this.m_rectSlider, r, s);
        }
        OnSegmentClick(e) {
        ...
        render() {
          let e = this.props.video,
            ...
            s = e.GetPercentOffsetFromTime(e.GetPlaybackTime(), m.a0.Timeline),
            a = e.GetPercentOffsetFromTime(
              e.GetVideoAvailableStartTime(),
              m.a0.Timeline,
            );
          a < 0.05 && (a = 0);
          let n = D.OQ(r, 0, 100).toFixed(1) + "%",
            o = D.OQ(s, 0, 100).toFixed(1) + "%",
            l = D.OQ(a, 0, 100).toFixed(1) + "%",
            c = {},
            d = {},
            u = {},
            h = {};
          ...
          let p = (0, P.ap)(e.GetPlaybackTime()),
          ...
          e.GetTimelineMarkers().forEach((t, r) => {
            let s = e.GetPercentOffsetFromTime(t.nTime, m.a0.Timeline);
            s < 0 ||
              s > 100 ||
              b.push(
                (0, i.jsx)(
          ...
          e.GetTimelineSegments().forEach((t, r) => {
            let s = e.GetPercentOffsetFromTime(t.nTimeStart, m.a0.Timeline);
            if (s > 100) return;
          ...
          return (0, i.jsx)("div", {
            ...
            children: (0, i.jsxs)("div", {
              className: g,
              children: [
                (0, i.jsx)("div", { className: "DialogLabel", children: p }),
                (0, i.jsx)("div", {
      ...
      (0, s.Cg)([h.oI], oe.prototype, "OnMouseDown", null),
        (0, s.Cg)([h.oI], oe.prototype, "OnMouseMove", null),
        (0, s.Cg)([h.oI], oe.prototype, "OnMouseUp", null),
        (0, s.Cg)([h.oI], oe.prototype, "OnKeyDown", null),
        (0, s.Cg)([h.oI], oe.prototype, "OnMouseHoverMove", null),
        (0, s.Cg)([h.oI], oe.prototype, "OnMouseHoverLeave", null),
        (0, s.Cg)([h.oI], oe.prototype, "AdjustHoverForClientX", null),
        (0, s.Cg)([h.oI], oe.prototype, "OnSegmentClick", null),
        (0, s.Cg)([h.oI], oe.prototype, "OnMarkerMouseEnter", null),
        (0, s.Cg)([h.oI], oe.prototype, "OnMarkerMouseLeave", null),
        (oe = (0, s.Cg)([n.PA], oe));
      let le = class extends o.Component {
        ...
        render() {
          ...
          if (!e) return null;
          let t = "";
          e.m_nViewerCount && (t = (0, j.Dq)(e.m_nViewerCount));
          let r =
          ...
          return (0, i.jsxs)("div", {
            ...
            children: [
              ...
              a && (0, i.jsx)(v.m, { gidEvent: O.td.gidEvent }),
              s &&
                (0, i.jsx)(C.p, {
                  id:
                    O.td.bValid &&
      ...
      class ce extends o.Component {
        showContextMenu(e) {
          const { options: t, value: r, onChange: s } = this.props,
          ...
          (0, l.lX)((0, i.jsx)(g.tz, { children: a }), e);
        }
        render() {
          ...
          return (0, i.jsxs)("div", {
            ...
            children: [
              (0, i.jsxs)("span", { children: [" - ", (0, x.we)(r)] }),
              (0, i.jsx)("div", {
                className: "ContextMenuButton",
                children: (0, i.jsx)(I.GB9, {}),
              }),
            ],
          });
        }
      }
      (0, s.Cg)([h.oI], ce.prototype, "showContextMenu", null);
      ...
      (0, s.Cg)([h.oI], de.prototype, "AddLinkRegion", null),
        (0, s.Cg)([h.oI], de.prototype, "LoadLinkRegion", null),
        (0, s.Cg)([h.oI], de.prototype, "OnSaveRegions", null),
        (0, s.Cg)([h.oI], de.prototype, "DeleteRegion", null),
        (0, s.Cg)([h.oI], de.prototype, "UpdatePanel", null),
        (de = (0, s.Cg)([n.PA], de));
    },
    47822: (e, t, r) => {
      "use strict";
      r.d(t, { NK: () => o, bK: () => s, dF: () => l, w2: () => c });
      var s,
        i = r(16021),
        a = r(4796),
        n = r(61859);
    ...
    13699: (e, t, r) => {
      ...
      (0, s.Cg)([n.sH], l.prototype, "m_mapYouTubeVideo", void 0),
        (0, s.Cg)([n.sH], l.prototype, "m_mapSharedFile", void 0);
      const c = new l();
    },
    54728: (e, t, r) => {
      "use strict";
      r.d(t, { es: () => L, fK: () => k, a0: () => O, fO: () => D });
      var s = r(34629),
        i = r(41735),
        a = r.n(i),
        n = r(14947),
      ...
      class m extends l.J8 {
        ...
        parseDict(e, t) {
          ...
          for (let s in e)
            try {
              ...
              throw (
                ((e.message += "\n...while parsing dictionary element " + s), e)
              );
            }
          return r;
        }
        ...
        UpdateMarkers(e, t) {
          ...
          for (const i of e)
            i.persistent
              ? (s.length > 0 &&
                  (s[s.length - 1].nTimeEnd = this.convertTime(i.Timestamp, t)),
                i.name.length > 0 &&
                  s.push({
          ...
          return { rgMarkers: r, rgSegments: s };
        }
        UpdateRegions(e) {
          let t = [];
          for (const r of e)
      ...
      class w {
        ...
        async PlayWebRTC(e, t, r, s, i) {
          ...
          let n = {
            iceServers: [
              { urls: ["stun:" + s] },
              { urls: ["turn:" + s], username: t, credential: r },
            ],
      ...
      (0, s.Cg)([g.o], w.prototype, "PlayWebRTC", null),
        (0, s.Cg)([n.XI.bound], w.prototype, "CaptureStatsForDisplay", null),
        (0, s.Cg)([g.o], w.prototype, "OnVideoPause", null),
        (0, s.Cg)([g.o], w.prototype, "OnVideoResize", null);
      var f = r(22837),
        C = r(55815),
        v = r(62490),
        M = r(81393),
      ...
      class P {
        ...
        UnlockH264(e, t) {
          this.BCanUnlockH264()
            ...
            : e.SetState(k.Error, (0, I.we)("#BroadcastWatch_MinBrowser"));
        }
        BCanUnlockH264() {
      ...
      (0, s.Cg)([n.sH], E.prototype, "m_ulBroadcastID", void 0),
        (0, s.Cg)([n.sH], E.prototype, "m_eWatchState", void 0),
        (0, s.Cg)([n.sH], E.prototype, "m_strStateDescription", void 0),
        (0, s.Cg)([n.XI], E.prototype, "SetState", null);
      class N {
        m_steamIDBroadcast = "";
        m_bInitialized = !1;
        m_strTitle = "";
      ...
      (0, s.Cg)([n.sH], N.prototype, "m_bInitialized", void 0),
        (0, s.Cg)([n.sH], N.prototype, "m_strTitle", void 0),
        (0, s.Cg)([n.sH], N.prototype, "m_strAppId", void 0),
        (0, s.Cg)([n.sH], N.prototype, "m_nAppID", void 0),
        (0, s.Cg)([n.sH], N.prototype, "m_strAppTitle", void 0),
        (0, s.Cg)([n.sH], N.prototype, "m_strThumbnailUrl", void 0),
        (0, s.Cg)([n.sH], N.prototype, "m_nViewerCount", void 0),
        (0, s.Cg)([n.sH], N.prototype, "m_bIsOnline", void 0);
      class z {
        constructor() {
          (0, n.Gn)(this);
        }
      ...
      (0, s.Cg)([n.sH], z.prototype, "m_eWatchState", void 0),
        (0, s.Cg)([n.sH], z.prototype, "m_strStateDescription", void 0),
        (0, s.Cg)([n.XI], z.prototype, "SetState", null);
      class A extends z {
        m_clipID;
        m_data;
      }
      ...
      class G {
        ...
        CreateBroadcastVideo(e, t, r, s) {
          ...
          if (
            ...
            return new P().UnlockH264(i, o), o;
          }
          return o;
        }
        CreateClipVideo(e, t, r) {
          let s = this.GetOrCreateClip(t),
            { nVolume: i, bMuted: a } = this.m_broadcastSettings,
            n = new V(e, i, a, r);
          if (
            ...
            return new P().UnlockH264(s, n), n;
          }
          return n;
        }
        CreateVODVideo(e, t, r) {
          let s = this.GetOrCreateVOD(t),
            { nVolume: i, bMuted: a } = this.m_broadcastSettings,
            n = new V(e, i, a, r);
          if (
        ...
        async GetClipManifest(e, t) {
          ...
          let r = {
            ...
            s = null;
          try {
            s = await a().get(_.TS.CHAT_BASE_URL + "broadcast/getclipdetails", {
              params: r,
              withCredentials: !0,
            });
          } catch (e) {
          ...
          let i = s.data;
          i.success == y.R
            ? (e.SetState(k.Ready), (e.m_data = i), this.LoadClip(e))
            : e.SetState(k.Error, (0, I.we)("#BroadcastWatch_RequestFailed"));
        }
        async GetVODManifest(e, t) {
          e.SetState(k.Loading, "");
          let r = await R.K.Get().LoadVODForAppID(e.m_nAppIDVOD);
          r
            ? (e.SetState(k.Ready),
        ...
        BroadcastDownloadFailed(e, t = !0, r = h.N_.Invalid) {
          e.Stop();
          let s = this.m_mapBroadcasts.get(e.GetBroadcastSteamID());
          s &&
            s.m_eWatchState != k.Loading &&
            (s.m_bWebRTC && t && (s.m_bWebRTC = !1),
            r == h.N_.StreamGone
              ? this.DelayedGetBroadcastManifest(s, e.GetWatchLocation())
              : this.GetBroadcastManifest(s, e.GetWatchLocation()));
        }
      ...
      (0, s.Cg)([n.sH], G.prototype, "m_mapBroadcasts", void 0),
        (function (e) {
      ...
      class V {
        ...
        OnGameDataUpdate(e) {
          ...
          if ("timelinemarkers" in t.gamedata) {
            ...
            const s = this.m_gameDataParser.UpdateRegions(t.gamedata.__regions);
        ...
        GetTimeAtMousePosition(e, t, r, s) {
          let i = p.Fu(e, t.left, t.right, r, s);
        ...
        GetPercentOffsetFromTime(e, t) {
          ...
          return (
            t == O.Timeline
              ? ((s = this.m_nVideoEndPos), (r = s - this.m_nTimelineDuration))
              : ((r = 0), (s = 0)),
            p.Fu(e, r, s, 0, 100)
          );
        }
      ...
      (0, s.Cg)([n.sH], V.prototype, "m_player", void 0),
        (0, s.Cg)([n.sH], V.prototype, "m_bPaused", void 0),
        (0, s.Cg)([n.sH], V.prototype, "m_nPlaybackTime", void 0),
        (0, s.Cg)([n.sH], V.prototype, "m_bBuffering", void 0),
        (0, s.Cg)([n.sH], V.prototype, "m_bOnLiveEdge", void 0),
        (0, s.Cg)([n.sH], V.prototype, "m_nVolume", void 0),
        (0, s.Cg)([n.sH], V.prototype, "m_bMuted", void 0),
        (0, s.Cg)([n.sH], V.prototype, "m_bUserInputNeeded", void 0),
        (0, s.Cg)([n.sH], V.prototype, "m_bIsReplay", void 0),
        (0, s.Cg)([n.sH], V.prototype, "m_nTimelineDuration", void 0),
        (0, s.Cg)([n.sH], V.prototype, "m_nVideoStartPos", void 0),
        (0, s.Cg)([n.sH], V.prototype, "m_nVideoEndPos", void 0),
        (0, s.Cg)([n.sH], V.prototype, "m_editorStartTime", void 0),
        (0, s.Cg)([n.sH], V.prototype, "m_editorEndTime", void 0),
        (0, s.Cg)([n.XI.bound], V.prototype, "StartBroadcast", null),
        (0, s.Cg)([n.XI.bound], V.prototype, "StartClip", null),
        (0, s.Cg)([n.XI.bound], V.prototype, "StartVOD", null),
        (0, s.Cg)([g.o], V.prototype, "OnVideoPlaying", null),
        (0, s.Cg)([g.o], V.prototype, "OnVideoPause", null),
        (0, s.Cg)([n.XI.bound], V.prototype, "OnVideoTimeUpdate", null),
        (0, s.Cg)([g.o], V.prototype, "OnVolumeUpdated", null),
        (0, s.Cg)([n.XI.bound], V.prototype, "OnGameDataUpdate", null),
        (0, s.Cg)([g.o], V.prototype, "OnDownloadFailed", null),
        (0, s.Cg)([g.o], V.prototype, "OnWebRTCRetry", null),
        (0, s.Cg)([g.o], V.prototype, "OnWebRTCFailed", null),
        (0, s.Cg)([g.o], V.prototype, "OnUserInputNeeded", null);
      const L = new G();
    ...
    30193: (e, t, r) => {
      ...
      class l {
        ...
        SearchEmoticons(e, t = 25, r = !0) {
          ...
          let i = this.recent_emoticons.filter((t) => !e || s(t).startsWith(e)),
            a = this.recent_emoticons.filter(
              (t) => !r && -1 !== s(t).indexOf(e),
            ),
            n = this.m_rgEmoticons.filter((t) => !e || s(t).startsWith(e)),
            o = this.m_rgEmoticons.filter((t) => !r && -1 !== s(t).indexOf(e)),
            l = new Set(),
            c = [];
          function d(e, r, i) {
            return (
              !(c.length >= t) &&
              (l.has(e) ||
                (l.add(e), c.push({ name: s(e), recent: r, new: i })),
              !0)
            );
          }
          function m(e, t, r) {
            for (let s of e) if (!d(s, t, r(s))) break;
          }
          return (
      ...
      (0, s.Cg)([a.sH], l.prototype, "m_bInitialized", void 0),
        (0, s.Cg)([a.sH], l.prototype, "m_rtMostRecentEmoticon", void 0),
        (0, s.Cg)([a.sH], l.prototype, "m_rtLastStickerOrEffect", void 0),
        (0, s.Cg)([a.XI], l.prototype, "TrackEmoticonUsage", null);
    },
    81477: (e, t, r) => {
      "use strict";
      r.d(t, { E: () => s, V: () => d });
      ...
      const d = new (class {
        ...
        RecordViewedEvent(e, t) {
          ...
          for (const e of o) {
            ...
            if ((e.unique_id == t && ((s = i), (a = e)), n))
              this.m_nFutureViewableEvents++;
            else if (void 0 !== s) break;
            i++;
          }
          if (void 0 !== s)
            if (s < this.m_nFutureViewableEvents) {
              const t = this.m_nFutureViewableEvents - s;
              if (this.m_nFutureViewedIndex < t) {
                ...
                const r = () => {
                  ...
                  s = 500;
                this.m_scheduledFutureStats.Schedule(s, r);
              }
            } else {
              const t = s - this.m_nFutureViewableEvents;
              if (this.m_nPastViewedIndex < t) {
                ...
                const s = () => {
                  ...
                  i = 500;
                this.m_scheduledPastStats.Schedule(i, s);
              }
            }
        }
        ...
        SendExperimentEventToSteam(e, t) {
          ...
          s.append("page_action", "" + e),
            s.append("snr", o.TS.SNR),
            s.append("uint_data", "" + t),
            s.append("str_data", this.m_sBrowserID),
            a().post(r, s);
        }
        InitBrowserID() {
    ...
    46910: (e, t, r) => {
      ...
      const S = [
        ...
        b = new Map([
          [g.k_ENews, [n.uYK]],
          [g.k_EEvents, [n.L0X, n.I5b, n.zA, n.y6, n.hGl, n.WNR, n.pIh, n.izQ]],
          [g.k_EStreaming, [n.KDJ]],
          [g.k_EUpdates, [n.Fwr, n.u0, n.zeJ]],
          [g.k_EReleases, [n.yhO, n.Aqr, n.DEQ, n.f4X, n.zcX]],
          [g.k_ESales, [n.HRy, n.C$4, n.LOv, n.HFK]],
        ]);
      function B(e) {
      ...
      class y {
        ...
        InitDefaultCheckboxes(e, t, r) {
          (this.m_bInitializedForUpdatesOnly = t),
            (this.m_mapEventTypeGroupsAllowed = B(t ? [g.k_EUpdates] : S));
          const i = (0, c.Y2)() ? p : h;
          (this.m_mapGameSources = B(e ? i : _)),
            r && this.m_mapGameSources.set(s.k_EFeatured, !0);
        }
        Init(e, t, r, s, i) {
        ...
        BShouldDisplayEvent(e) {
          ...
          return (
            ...
            (!!(t & o.bK.k_eRequired || t & o.bK.k_eReposted) ||
              Boolean(
                (this.BIsGameSourceAllowed(s.k_ERecent) && r) ||
        ...
        BAreAnyEventsFiltered(e) {
          ...
          return (
            ...
            S.some((e) => !this.BIsEventTypeGroupAllowed(e))
          );
        }
        BIsClanVisible(e) {
      ...
      (0, i.Cg)([a.sH], y.prototype, "m_mapEventTypeGroupsAllowed", void 0),
        (0, i.Cg)([a.sH], y.prototype, "m_mapGameSources", void 0),
        (0, i.Cg)(
          [a.sH],
          y.prototype,
        ...
        (0, i.Cg)([a.sH], y.prototype, "m_mapHiddenApps", void 0),
        (0, i.Cg)([a.sH], y.prototype, "m_mapHiddenClans", void 0),
        (0, i.Cg)(
        ...
        (0, i.Cg)([a.XI], y.prototype, "SetEventTypeGroupAllowed", null),
        (0, i.Cg)([a.XI], y.prototype, "SetGameSourceAllowed", null);
    },
    44165: (e, t, r) => {
      "use strict";
      r.d(t, { HD: () => d, f1: () => p, s4: () => _, sB: () => h });
      var s = r(34629),
        i = r(14947),
        a = r(19367),
        n = r.n(a),
      ...
      (0, s.Cg)([i.sH], c.prototype, "nOverrideDateNow", void 0);
      const d = new c();
    ...
    94057: (e, t, r) => {
      ...
      (0, s.Cg)([n.sH], h.prototype, "giveaway_id", void 0),
        (0, s.Cg)([n.sH], h.prototype, "seconds_until_drawing", void 0),
        (0, s.Cg)([n.sH], h.prototype, "rtime_start", void 0),
        (0, s.Cg)([n.sH], h.prototype, "rtime_end", void 0),
        (0, s.Cg)([n.sH], h.prototype, "closed", void 0),
        (0, s.Cg)([n.sH], h.prototype, "winner_count", void 0);
      class p {
        constructor() {
          (0, n.Gn)(this);
        }
      ...
      (0, s.Cg)([n.sH], p.prototype, "m_mapGiveawayIDToNextDrawInfo", void 0),
        (0, s.Cg)([n.XI], p.prototype, "CopyToGiveaway", null);
      class _ {
        m_intervalID;
      ...
      function S(e) {
            ...
            p
              ...
              .then((s) => {
                t.SetupRefreshDataInterval(s, () =>
                  ...
                  t.SetupCountDown(s.seconds_until_drawing, () => g(e, t)),
                  r();
              }),
            () => {
        ...
        return {
          bLoadingGiveawayInfo:
            !s || null == s.giveaway_id || !s.BStarted() || void 0 === i,
          winner_count: i,
          closed: a,
          seconds_until_drawing: n,
        };
      }
      (0, s.Cg)([c.o], _.prototype, "ClearRefreshInterval", null),
        (0, s.Cg)([c.o], _.prototype, "ClearCountDown", null),
        (0, s.Cg)([c.o], _.prototype, "SetupRefreshDataInterval", null),
        (0, s.Cg)([c.o], _.prototype, "SetupCountDown", null);
    },
    73022: (e, t, r) => {
      "use strict";
      r.d(t, { Q: () => p, h: () => h });
        ...
        async InternalLoadRegistration(e) {
          ...
          try {
            const r =
              ...
              s = { giveaway_name: e, sessionid: m.TS.SESSIONID },
              i = await a().get(r, { params: s, withCredentials: !0 });
            if (
              200 == i?.status &&
              i?.data?.success == o.R &&
              i?.data?.registration
      ...
      (0, s.Cg)([d.oI], u.prototype, "CreateRegistration", null);
    },
    55263: (e, t, r) => {
      "use strict";
      r.d(t, {
      ...
      function h(e, t, r, s) {
        ...
        if (
          ((0, a.useEffect)(() => {
            ...
            return (
              !e ||
                ...
                (void 0 !== _ && s && s == h.current) ||
                (s !== h.current && (g(void 0), (h.current = s)),
          ...
          }, [e, t, s, _, S, b, B, y, w, f, C, v, M, I, T, R, x, j, D, k, p]),
          !e)
        )
          return [null, m];
        if (!1 === _) return [void 0, m];
      ...
      function p(e, t, r) {
        return h(e, o.c6.qI, t, r);
      }
      function _(e, t, r) {
        return h(e, o.c6.xO, t, r);
      }
      function g(e, t, r) {
        return h(e, o.c6.RD, t, r);
      }
      function S(e, t, r) {
        const [s, i] = h(e, t, r);
        let a;
        s?.GetStoreItemType() != o.c6.RD ||
          s.GetAssets()?.GetHeaderURL() ||
          1 != s?.GetIncludedAppIDs().length ||
          (a = s.GetIncludedAppIDs()[0]);
        const [n, l] = p(a, r);
        return a && n?.BIsVisible() ? [n, l] : [s, i];
      }
      function b(e, t, r, s) {
        const n = (0, l.CH)(),
          {
        ...
        if (
          ((0, a.useEffect)(() => {
            ...
            const a = i().CancelToken.source(),
              l = s.map((e) => c.A.Get().QueueStoreItemRequest(e, t, r));
            return (
              Promise.all(l).then(() => {
                a.token.reason || n();
              }),
          ...
          }, [e, t, s, n, o, h, p, _, g, S, b, B, y, w, f, C, v, M, I, T]),
          !e)
        )
          return m;
        if (
    ...
    23649: (e, t, r) => {
      ...
      function c(e) {
        ...
        return (0, s.jsx)(s.Fragment, { children: o.ParseBBCode(t, {}) });
      }
    },
    74410: (e, t, r) => {
      "use strict";
      r.d(t, { Eo: () => h, V2: () => s, gH: () => u });
      var s,
        i = r(7850),
        a = r(90626),
        n = r(59952),
      ...
      function m(e) {
        return {
          sizeStr: e == s.full ? d.sizeFull : d.sizeThumb,
          alignStr: e == s.full ? "" : e == s.left ? d.floatLeft : d.floatRight,
        };
      }
      function u(e) {
        ...
        if (t) {
          ...
          if (2 == e.length) {
            ...
            const { sizeStr: s, alignStr: a } = m(r);
            return (0, i.jsx)(l.A, {
              videoID: t,
              classNameAlign: a,
              classNameSize: s,
      ...
      function h(e) {
        ...
        const t = (0, n.j$)(e.args, "youtubeid"),
          r = (0, n.j$)(e.args, "size"),
          s = (0, n.j$)(e.args, "seconds"),
          { sizeStr: a, alignStr: d } = m(r);
        return (0, i.jsx)(l.A, {
          videoID: t,
          nStartSeconds: s ? Number.parseInt(s) : void 0,
          classNameAlign: d,
          classNameSize: a,
          bShowVideoImmediately: !0,
        });
      ...
      function g(e) {
        ...
        (0, i.useEffect)(() => {
          B &&
            a.R.LoadYouTubeDynamicData([t], C)
              .then((e) => {
                !C.token.reason && e.length > 0 && (M(e[0]), f(!0));
              })
              .catch((e) =>
                console.error(
        ...
        return (0, s.jsx)(h.gZ, {
          ...
          children: (0, s.jsxs)("div", {
            className: (0, c.A)(_().PreviewYouTubeVideo, S, b),
            id: t,
            children: [
              (0, s.jsx)("img", {
    ...
    81962: (e, t, r) => {
      ...
      function o(e) {
        ...
        if (null == t) return (0, s.jsx)(i.Fragment, { children: a });
        let n;
        if (
          ((n =
            t instanceof Array
      ...
      function p(e) {
        ...
        return (0, s.jsxs)(s.Fragment, {
          children: [
            ...
            a && (0, s.jsx)(_, { target: u, emoticon: t }),
          ],
        });
      }
      function _(e) {
        ...
        return (0, s.jsx)(g, {
          ...
          children: (0, s.jsx)(p, { emoticon: r, large: !0 }),
        });
      }
          ...
          children: [
            ...
            (0, s.jsxs)("div", {
              ...
              children: [
                (0, s.jsx)("div", {
                  className: d().Name,
                  children: t || (0, s.jsx)("span", { children: " " }),
                }),
                (0, s.jsx)("div", {
                  className: d().AppName,
                  children: r || (0, s.jsx)("span", { children: " " }),
                }),
              ],
            }),
          ],
    ...
    43667: (e, t, r) => {
      ...
      class w {
        ...
        LazyInit() {
          if (!this.m_bLoadedFromConfig) {
            let e = (0, b.Fd)("notificationstore", "application_config");
        ...
        async InternalLoad() {
          const e = b.TS.STORE_BASE_URL + "notification/ajaxusersettings",
      ...
      (0, s.Cg)([S.sH], w.prototype, "m_bValidatedEmail", void 0),
        (0, s.Cg)([S.sH], w.prototype, "m_nMobileDeviceCount", void 0);
      let f = new w();
      var C = r(40650),
        v = r(56283),
        M = r(76684),
      ...
      let W = class extends o.Component {
        ...
        state = { bIsOpen: !1, bIsLoadingNotificationSettings: !f.BIsLoaded() };
        componentDidMount() {
          this.state.bIsLoadingNotificationSettings &&
            ...
            !this.props.eventModel.appid &&
              ...
              h.ac.LoadClanInfoForClanSteamID(
                this.props.eventModel.clanSteamID,
              );
        }
        componentWillUnmount() {
                ...
                children: [
                  t &&
                    (0, i.jsx)("div", {
                      ...
                      children: (0, i.jsx)(R.Jlk, {}),
                    }),
                  e &&
                    (0, i.jsx)("div", {
                      className: G.RemindBell,
                      children: (0, i.jsx)(R.IrQ, {}),
                    }),
                  (0, i.jsx)("div", {
                    className: G.ReminderDefault,
                    children: (0, O.we)("#EventDisplay_Reminder_SetReminder"),
                  }),
                  (0, i.jsx)("div", { className: G.ReminderOptions }),
                ],
              });
        }
      };
      function H(e) {
        const { bPreviewMode: t, eventGID: r, ...s } = e,
          a = (0, u.RR)(r);
        if (!a)
          return t
            ? (0, i.jsx)("div", {
            ...
            : null;
        const n = (0, c.sfN)(b.TS.LANGUAGE);
        return (0, i.jsx)(W, { lang: n, ...s, eventModel: a });
      }
      function q(e) {
        return n.unix(e).utc().format("YYYYMMDD[T]HHmmss[Z]");
      }
      (0, s.Cg)([P.oI], W.prototype, "ToggleMenu", null),
        (0, s.Cg)([P.oI], W.prototype, "ShowMenu", null),
        (0, s.Cg)([P.oI], W.prototype, "HideMenu", null),
        (W = (0, s.Cg)([a.PA], W));
      const K = (0, a.PA)((e) => {
        const {
            eventModel: t,
            ...
            if (a && a != c.kFb) {
              ...
              try {
                await g.KN.Get().SetFollowOrUnfollowEvent(
                  ...
                  e &&
                    (s === g.Nh.k_ENotifyFlagByEmail
                      ? B(p.E.k_eReminder_Email)
                      : s === g.Nh.k_ENotifyFlagByPush &&
                        B(p.E.k_eReminder_MobilePush));
              } catch (e) {
                (0, T.HT)(
                  (0, i.jsx)(I.KG, {
                    strTitle: (0, O.we)(
          ...
          y = t.jsondata.bSaleEnabled
            ? F.PH.k_eStoreSalePage
            : F.PH.k_eStoreView,
          w = (0, F.Bw)(t, y, "forceAbsolute"),
          C = (e) => {
            const r = t.appid
                ? "app/" + t.appid
                : "group/" + t.clanSteamID.GetAccountID(),
              s = "l=" + (0, c.LgB)(d);
            return `${b.TS.STORE_BASE_URL}${(0, F.LJ)()}/download/${r}/${e}/${t.GID}?${s}`;
          },
          P = f.BHasValidatedEmail(),
          z = f.BHasPushNotification(),
          A = r && t.GetStartTimeAndDateUnixSeconds();
        return (0, i.jsxs)("div", {
          children: [
            (0, i.jsxs)("div", {
              className: (0, k.A)(
              ...
              children: [
                ...
                (0, i.jsx)("div", { className: G.ReminderOpennedOptions }),
              ],
            }),
            (0, i.jsxs)("div", {
              className: (0, k.A)(
              ...
              children: [
                ...
                (0, i.jsxs)("div", {
                  className: (0, k.A)(G.ReminderOption, !P && G.Unverified),
                  children: [
                    (0, i.jsx)(j.he, {
                      ...
                      children: (0, i.jsx)(v.Yh, {
                        label: (0, O.we)("#EventDisplay_Reminder_ViaEmail"),
                        disabled: !P,
                        ...
                        onChange: (e) => {
                          S(e, !1, g.Nh.k_ENotifyFlagByEmail);
                        },
                      }),
                    }),
                    !P &&
                      (0, i.jsx)("div", {
                        ...
                        children: (0, i.jsx)("a", {
                          ...
                          onClick: () => B(p.E.k_eReminder_EmailUnverified),
                          children: (0, O.we)(
                ...
                (0, i.jsxs)("div", {
                  className: (0, k.A)(G.ReminderOption, !z && G.Unverified),
                  children: [
                    (0, i.jsx)(j.he, {
                      className: G.CheckboxWrapper,
                      bTopmost: !0,
                      ...
                      children: (0, i.jsx)(v.Yh, {
                        label: (0, O.we)("#EventDisplay_Reminder_ViaMobileApp"),
                        disabled: !z,
                        checked: g.KN.Get().BFollowsEventAndNotifiedBy(
                          t.clanSteamID,
                          t.GID,
                        ...
                        onChange: (e) => {
                          S(e, !1, g.Nh.k_ENotifyFlagByPush);
                        },
                      }),
                    }),
                    !z &&
                      (0, i.jsx)("div", {
                        className: V.FlexColumnContainer,
                        children: (0, i.jsx)("a", {
                          href: b.TS.STORE_BASE_URL + "mobile/?show=steamapp",
                          target: b.TS.IN_CLIENT ? void 0 : "_blank",
                          onClick: () => B(p.E.k_eReminder_MobilePushMissing),
                          children: (0, O.we)(
                    ...
                    (0, i.jsxs)("div", {
                      ...
                      children: [
                        (0, i.jsx)("a", {
                          ...
                          href: C("ics"),
                          onClick: () => B(p.E.k_eReminder_CalendarApple),
                          children: (0, O.we)(
                        ...
                        (0, i.jsx)("a", {
                          ...
                          href: (() => {
                            const e = encodeURIComponent(
                              ...
                              s = t.GetStartTimeAndDateUnixSeconds(),
                              i = q(s),
                              a = q(
                          ...
                          onClick: () => B(p.E.k_eReminder_CalendarGoogle),
                          children: (0, O.we)(
                        ...
                        (0, i.jsx)("a", {
                          className: G.ReminderOption,
                          href: C("outlook"),
                          onClick: () => B(p.E.k_eReminder_CalendarOutlook),
                          children: (0, O.we)(
    ...
    82477: (e, t, r) => {
      ...
      function p(e) {
        ...
        return (0, s.jsx)(u.EN, {
          active: !0,
          children: (0, s.jsx)(h, { redirectURL: t }),
        });
      }
      function _() {
        (0, a.pg)(
      ...
      function g(e, t) {
        (0, a.pg)(
          (0, s.jsx)(h, { ownerWin: window, redirectURL: e, guestOption: t }),
          window,
          { strTitle: (0, n.we)("#Login_SignInTitle") },
        );
      }
        ...
        return (0, s.jsx)("div", {
          children: n
            ...
            : (0, s.jsx)(l.YN, {
                ...
                redirectUrl: t,
                theme: "modal",
                children: r && (0, s.jsx)(l.Mk, { redirectURL: t }),
              }),
        });
      }
    },
    48079: (e, t, r) => {
      ...
      var s = r(34629),
        ...
        g = r.n(_);
      const S = (0, a.PA)((e) => {
        const t = (0, o.z5)(e.photo, (0, l.sfN)(h.TS.LANGUAGE)),
                    ...
                    (s || a) &&
                      (0, i.jsxs)("div", {
                        children: [
                          ...
                          s && a && (0, i.jsx)("span", { children: ", " }),
                          a && (0, i.jsx)("span", { children: e.company }),
                        ],
                      }),
                  ],
                }),
      ...
      class b extends n.Component {
        ...
        OnHover(e) {
          ...
          const r = {
            ...
            s = "presenter-hover-" + Math.floor(1e8 * Math.random());
          (this.m_fnHidePopup = () =>
            b.sm_embeddedElements.HideElement(t.ownerDocument, s)),
          ...
          b.sm_embeddedElements.ShowElementDelayed(
            ...
            (0, i.jsx)(d.g, {
              ...r,
              children: (0, i.jsx)(S, { ...this.props, fnClose: this.OnLeave }),
            }),
            s,
          );
        }
      ...
      function B(e) {
        const {
          ...
          c = (0, o.z5)(t, (0, l.sfN)(h.TS.LANGUAGE)),
                      ...
                      (m || u) &&
                        (0, i.jsxs)("div", {
                          children: [
                            ...
                            m && u && (0, i.jsx)("span", { children: ", " }),
                            u && (0, i.jsx)("span", { children: a }),
                          ],
                        }),
                    ],
                  }),
      ...
      (0, s.Cg)([u.oI], b.prototype, "ClosePopup", null),
        (0, s.Cg)([u.oI], b.prototype, "OnScroll", null),
        (0, s.Cg)([u.oI], b.prototype, "OnHover", null),
        (0, s.Cg)([u.oI], b.prototype, "OnLeave", null);
    },
    69409: (e, t, r) => {
      "use strict";
      r.d(t, { m: () => h });
            ...
            if (
              ...
              if (t?.length > 0 && s?.length > 0)
                return [
                  ...
                  u.zU.GenerateURLFromHashAndExt(r.clanSteamID, s),
                ];
            }
            return [null, null];
          }, [r]);
    ...
    93267: (e, t, r) => {
      ...
      (0, s.Cg)([m.oI], u.prototype, "BUserHasVolumePreference", null),
        (0, s.Cg)([m.oI], u.prototype, "SetVolumePreference", null);
      const h = (0, a.forwardRef)(function (e, t) {
        ...
        let C;
        (!f || (B && "public" == d.TS.WEB_UNIVERSE)) && (C = "anonymous");
        const v = l || (s && u.Get().BVolumePreferenceMuted()),
          M = r.sPoster ? p(r.sPoster) : "";
        return (0, i.jsxs)("video", {
          ...
          children: [
            (0, i.jsx)(_, { rgVideoSources: r.rgVideoSources }),
            (0, i.jsx)(g, { rgVideoTracks: r.rgVideoTracks }),
          ],
        });
      });
      function p(e) {
      ...
      function _(e) {
        ...
        return t
          ...
          .map((e) =>
            (0, i.jsx)("source", { src: p(e.sURL), type: e.sFormat }, e.sURL),
          );
      }
      function g(e) {
        const { rgVideoTracks: t } = e;
        return t
          ? t.map((e, r) => (0, i.jsx)(S, { track: e, rgVideoTracks: t }, r))
          : null;
      }
      function S(e) {
        ...
        return (0, i.jsx)("track", {
          ...
          default: t.bDefault,
          srcLang: (0, n.wwZ)(s),
          label: (0, l.we)("#language_selection_" + (0, n.LgB)(s)),
        });
      }
    },
    97232: (e, t, r) => {
      ...
      function c() {
        return (0, n.Qn)() ? (0, s.jsx)(a.nl, {}) : (0, s.jsx)(i.jZW, {});
      }
    },
    81416: (e, t, r) => {
      "use strict";
      ...
      (0, i.Cg)([o.oI], g.prototype, "LinkRegionBoxRef", null),
        (0, i.Cg)([o.oI], g.prototype, "OnMouseDown", null),
        (0, i.Cg)([o.oI], g.prototype, "OnMouseMove", null),
        (0, i.Cg)([o.oI], g.prototype, "OnMouseUp", null),
        (0, i.Cg)([o.oI], g.prototype, "HandleDelete", null),
        (0, i.Cg)([o.oI], g.prototype, "OnSetLinkURLChange", null),
        (0, i.Cg)([o.oI], g.prototype, "OnSetLinkDescriptionChange", null),
        (0, i.Cg)([o.oI], g.prototype, "OnSaveLink", null),
        (0, i.Cg)([o.oI], g.prototype, "OnEditLink", null),
        (g = (0, i.Cg)([l.PA], g));
    },
    76684: (e, t, r) => {
      "use strict";
      ...
      function _(e) {
        const t = p.tz.guess(),
          r = p.unix(e).tz(t),
          s = (0, o.l4)();
        return s && r.locale(s), r.format("LT");
      }
      function g(e, t) {
        const r = p.tz.guess(),
          s = p.unix(e).tz(r),
      ...
      const S = (0, l.PA)((e) => {
          ...
          return r
            ? (0, i.jsxs)("span", {
                className: s || a ? d.DateAndTimeInline : d.DateAndTime,
                children: [
                  n && c,
                  n && l ? (0, i.jsx)("span", { children: " " }) : void 0,
                  Boolean(t && l) && g(t, l),
                ],
              })
            : (0, i.jsxs)("div", {
      ...
      let B = class extends a.Component {
        render() {
          ...
          let a = h.HD.GetTimeNowWithOverride();
          if (s)
            return (0, i.jsxs)("div", {
              ...
              children: [
                ...
                (0, i.jsx)(S, { stylesmodule: r, dateAndTime: e }),
              ],
            });
          let n = e <= a && a <= t;
      ...
      let y = class extends a.Component {
        render() {
          ...
          const n = h.HD.GetTimeNowWithOverrideAsDate(),
            l = h.HD.GetTimeNowWithOverride(),
    ...
    48211: (e, t, r) => {
      ...
      class B extends n.Component {
        ...
        componentWillUnmount() {
          var e;
          this.DestroyPlayer(), (e = this.OnYoutubeScriptsReady), o.x9(_, e);
        }
      ...
      (0, i.Cg)([l.oI], B.prototype, "BindPlayerContainer", null),
        (0, i.Cg)([l.oI], B.prototype, "OnYoutubeScriptsReady", null),
        (0, i.Cg)([l.oI], B.prototype, "CreatePlayer", null),
        (0, i.Cg)([l.oI], B.prototype, "OnPlayerReady", null),
        (0, i.Cg)([l.oI], B.prototype, "OnPlayerStateChange", null),
        (0, i.Cg)([l.oI], B.prototype, "OnError", null),
