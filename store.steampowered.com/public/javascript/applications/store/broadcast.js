  ...
  [8396],
  {
            ...
            for (let c = 0; c < e.length; c++) {
              ...
              switch (i.type) {
                case 0:
                  "[" == m
                    ? ((i.type = 2), (s = !0))
                    : ((i.type = 1), "\\" == m && t ? (a = !a) : (i.text += m));
                  break;
                case 2:
                case 3:
                  if ("/" == m && s) (i.type = 3), (i.text = ""), (s = !1);
                  else if ("[" != m || a)
                    if ("]" != m || a)
                      "\\" == m && t
                        ? ((i.text += m), (a = !a), (s = !1))
    ...
    23338: (e, t, r) => {
      ...
      const o = i.forwardRef(function (e, t) {
        const { onLeave: r, onEnter: n, options: o, ...l } = e,
          ...
          m = (0, s.Ue)(c, t);
        return i.createElement("div", { ref: m, ...l });
      });
    },
    61949: (e, t, r) => {
      "use strict";
          ...
          return (
            l.sm_m ||
              (l.sm_m = {
                proto: l,
                fields: {
                  version: { n: 1, br: n.qM.readEnum, bw: n.gp.writeEnum },
                  preference_state: {
                    n: 2,
                    br: n.qM.readEnum,
                    bw: n.gp.writeEnum,
      ...
      class c extends a.Message {
        ...
        constructor(e = null) {
          super(),
            c.prototype.recentapps || n.Sg(c.M()),
            a.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
          ...
          return (
            c.sm_m ||
              (c.sm_m = {
                proto: c,
                fields: {
                  recentapps: { n: 1, br: n.qM.readBool, bw: n.gp.writeBool },
                },
              }),
            c.sm_m
          );
      ...
      class m extends a.Message {
        ...
        constructor(e = null) {
          super(),
            m.prototype.product_impressions_tracking || n.Sg(m.M()),
            a.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class d extends a.Message {
        ...
        constructor(e = null) {
          super(),
            d.prototype.google_analytics || n.Sg(d.M()),
            a.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
          ...
          return (
            u.sm_m ||
              (u.sm_m = {
                proto: u,
                fields: {
                  youtube: { n: 1, br: n.qM.readBool, bw: n.gp.writeBool },
                  vimeo: { n: 2, br: n.qM.readBool, bw: n.gp.writeBool },
                  sketchfab: { n: 3, br: n.qM.readBool, bw: n.gp.writeBool },
                  twitter: { n: 4, br: n.qM.readBool, bw: n.gp.writeBool },
                },
              }),
            u.sm_m
          );
      ...
      class p extends a.Message {
        ...
        constructor(e = null) {
          super(),
            p.prototype.preferences || n.Sg(p.M()),
            a.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      var y = r(91933);
      async function S(e) {
        if ((0, g.nA)(h.TS.EREALM)) return { version: 1, preference_state: 0 };
        if (h.iA.logged_in) {
        ...
        const t = h.TS.COUNTRY;
        return t in b.eucountries || t in b.eeacountries || "CH" === t
    ...
    59952: (e, t, r) => {
      ...
      const C = new Map([
        [
          "b",
          {
            Constructor: function (e) {
              return c.createElement("b", { className: a().Bold }, e.children);
            },
            autocloses: !1,
          },
        ],
        ...
        ["h3", { Constructor: O, autocloses: !1, skipFollowingNewline: !0 }],
        [
          "h4",
          {
            Constructor: function (e) {
        ...
        [
          ...
          {
            Constructor: function (e) {
              let t = (0, f.J)(T(e.args));
              if (!t) {
                const r = e.children;
                "string" == typeof r && (0, S.DZ)(r) && (t = (0, f.J)(r));
              }
              const r = "button" == T(e.args, "style") ? a().LinkButton : null,
              ...
              return c.createElement(
                W,
                { className: r, href: t, id: s, style: { backgroundColor: i } },
                e.children,
              );
            },
            autocloses: !1,
              ...
              return c.createElement(
                ...
                i &&
                  c.createElement(
                    ...
                    i
                      .split(",")
                      .map((e, t) => c.createElement(k, { key: t, width: e })),
                  ),
          ...
          "calendarevent",
          {
            Constructor: function (e) {
              const t = T(e.args, "title"),
                ...
                i = T(e.args, "end") ?? T(e.args, "datetime"),
                s = T(e.args, "body") ?? null,
                n = T(e.args, "location") ?? null,
                o = T(e.args, "id") ?? "",
                m = new Date(r),
                d = m.getUTCFullYear(),
                u = ("0" + (m.getUTCMonth() + 1)).slice(-2),
                _ = ("0" + m.getUTCDate()).slice(-2),
                p = ("0" + m.getUTCHours()).slice(-2),
                g = ("0" + m.getUTCMinutes()).slice(-2),
                h = `${d}${u}${_}T${p}${g}00Z`,
                B = new Date(i),
                y = B.getUTCFullYear(),
                S = ("0" + (B.getUTCMonth() + 1)).slice(-2),
                w = ("0" + B.getUTCDate()).slice(-2),
                M = ("0" + B.getUTCHours()).slice(-2),
                f = ("0" + B.getUTCMinutes()).slice(-2),
                C = `${y}${S}${w}T${M}${f}00Z`;
              let v;
              try {
      ...
      new Map([
        ...
        ["video", { Constructor: q, autocloses: !1 }],
      ...
      function R(e, t, r = 0) {
        if (e && 0 != e.length) {
          if (e?.startsWith(M.lw)) return u.z.ReplacementTokenToClanImageURL(e);
          if (e?.startsWith(M.eg)) {
            const i = new Array(),
              a = u.z.GetBaseURL(),
              n = e.substring(M.eg.length + 1),
              o = parseInt(n.substring(0, n.indexOf("/"))),
              l = n.substring(n.indexOf("/") + 1),
              c = u.z.GetHashFromHashAndExt(l),
              m = u.z.GetExtStringFromHashAndExt(l);
            if (null != t) {
              let e = (0, s.Lg)(t);
              i.push(a + o + "/" + c + "/" + e + m + "?t=" + r),
                4 == t &&
                  ((e = (0, s.x6)((0, s.Lg)(t))),
                  i.push(a + o + "/" + c + "/" + e + m + "?t=" + r));
            }
      ...
      const W = (e) => {
        ...
        return c.createElement(
          ...
          c.createElement(n.Ii, { ...r, href: a, rel: i }, e.children),
        );
      };
      function N(e) {
      ...
      function x(e, t) {
        const r = T(t.args, "width"),
          ...
          n = {};
        return (
          i && parseInt(i) > 1 && (n.colSpan = parseInt(i)),
          s && parseInt(s) > 1 && (n.rowSpan = parseInt(s)),
          c.createElement(
            e,
            {
      ...
      function A(e) {
        ...
        const i = (0, s.sf)(w.TS.LANGUAGE),
          a = 0 != i,
          n = new Array();
        for (let t = 0; t < 31; t++) {
          const r = T(e, "sub_" + (0, s.ww)(t));
          r &&
            n.push({
              sURL: (0, S.L$)(r),
              eLanguage: t,
    ...
    74968: (e, t, r) => {
      ...
      class O extends y.Message {
        ...
        constructor(e = null) {
          super(),
            O.prototype.thumbnail_url || w.Sg(O.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class x extends y.Message {
        ...
        constructor(e = null) {
          super(),
            x.prototype.permission || w.Sg(x.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class q extends y.Message {
        ...
        constructor(e = null) {
          super(),
            q.prototype.broadcast_id || w.Sg(q.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Y extends y.Message {
        ...
        constructor(e = null) {
          super(),
            Y.prototype.broadcast_upload_id || w.Sg(Y.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class X extends y.Message {
        ...
        constructor(e = null) {
          super(),
            X.prototype.broadcast_id || w.Sg(X.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Re extends y.Message {
        ...
        constructor(e = null) {
          super(),
            Re.prototype.viewer_stats || w.Sg(Re.M()),
      ...
      class ze extends y.Message {
        ...
        constructor(e = null) {
          super(),
            ze.prototype.country_code || w.Sg(ze.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Fe extends y.Message {
        ...
        constructor(e = null) {
          super(),
            Fe.prototype.webrtc_session_id || w.Sg(Fe.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class We extends y.Message {
        ...
        constructor(e = null) {
          super(),
            We.prototype.broadcaster_steamid || w.Sg(We.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class De extends y.Message {
        ...
        constructor(e = null) {
          super(),
            De.prototype.sdp_mid || w.Sg(De.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class ke extends y.Message {
        ...
        constructor(e = null) {
          super(),
            ke.prototype.broadcaster_steamid || w.Sg(ke.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Ae extends y.Message {
        ...
        constructor(e = null) {
          super(),
            Ae.prototype.broadcaster_steamid || w.Sg(Ae.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class qe extends y.Message {
        ...
        constructor(e = null) {
          super(),
            qe.prototype.broadcast_session_id || w.Sg(qe.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Ge extends y.Message {
        ...
        constructor(e = null) {
          super(),
            Ge.prototype.turn_server || w.Sg(Ge.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Ye extends y.Message {
        ...
        constructor(e = null) {
          super(),
            Ye.prototype.broadcast_session_id || w.Sg(Ye.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      !(function (e) {
        (e.BeginBroadcastSession = function (e, t) {
          ...
          (e.WatchBroadcast = function (e, t) {
            return e.SendMsg("Broadcast.WatchBroadcast#1", (0, g.I8)(W, t), N, {
              ePrivilege: 2,
            });
          }),
          ...
          (e.SetRTMPInfo = function (e, t) {
            return e.SendMsg("Broadcast.SetRTMPInfo#1", (0, g.I8)(be, t), ye, {
              ePrivilege: 1,
            });
          }),
          (e.GetRTMPInfo = function (e, t) {
            return e.SendMsg("Broadcast.GetRTMPInfo#1", (0, g.I8)(Se, t), we, {
              bConstMethod: !0,
              ePrivilege: 1,
            });
          }),
      ...
      class Xe extends y.Message {
        ...
        constructor(e = null) {
          super(),
            Xe.prototype.broadcast_channel_id || w.Sg(Xe.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class $e extends y.Message {
        ...
        constructor(e = null) {
          super(),
            $e.prototype.unique_name || w.Sg($e.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class St extends y.Message {
        ...
        constructor(e = null) {
          super(),
            St.prototype.results || w.Sg(St.M()),
            y.Message.initialize(this, e, 0, -1, [1], null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class zt extends y.Message {
        ...
        constructor(e = null) {
          super(),
            zt.prototype.is_followed || w.Sg(zt.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Ft extends y.Message {
        ...
        constructor(e = null) {
          super(),
            Ft.prototype.results || w.Sg(Ft.M()),
            y.Message.initialize(this, e, 0, -1, [1], null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Ot extends y.Message {
        ...
        constructor(e = null) {
          super(),
            Ot.prototype.algorithm || w.Sg(Ot.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Nt extends y.Message {
        ...
        constructor(e = null) {
          super(),
            Nt.prototype.broadcast_channel_id || w.Sg(Nt.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Dt extends y.Message {
        ...
        constructor(e = null) {
          super(),
            Dt.prototype.broadcasters || w.Sg(Dt.M()),
            y.Message.initialize(this, e, 0, -1, [1], null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class jt extends y.Message {
        ...
        constructor(e = null) {
          super(),
            jt.prototype.issuer_steamid || w.Sg(jt.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class At extends y.Message {
        ...
        constructor(e = null) {
          super(),
            At.prototype.broadcast_channel_id || w.Sg(At.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Xt extends y.Message {
        ...
        constructor(e = null) {
          super(),
            Xt.prototype.results || w.Sg(Xt.M()),
            y.Message.initialize(this, e, 0, -1, [1], null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Zt extends y.Message {
        ...
        constructor(e = null) {
          super(),
            Zt.prototype.chat_id || w.Sg(Zt.M()),
      ...
      class yr extends y.Message {
        ...
        constructor(e = null) {
          super(),
            yr.prototype.broadcast_channel_id || w.Sg(yr.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Sr extends y.Message {
        ...
        constructor(e = null) {
          super(),
            Sr.prototype.broadcast_clip_id || w.Sg(Sr.M()),
            y.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      !(function (e) {
        (e.CreateBroadcastChannel = function (e, t) {
          ...
          (e.GetGames = function (e, t) {
            return e.SendMsg("SteamTV.GetGames#1", (0, g.I8)(Et, t), Ft, {
              bConstMethod: !0,
              ePrivilege: 2,
          ...
          (e.AddChatBan = function (e, t) {
            return e.SendMsg("SteamTV.AddChatBan#1", (0, g.I8)(kt, t), xt, {
              ePrivilege: 1,
              eWebAPIKeyRequirement: 2,
            });
          }),
          (e.GetChatBans = function (e, t) {
            return e.SendMsg("SteamTV.GetChatBans#1", (0, g.I8)(At, t), Pt, {
              bConstMethod: !0,
              ePrivilege: 1,
              eWebAPIKeyRequirement: 2,
            });
          ...
          (e.AddWordBan = function (e, t) {
            return e.SendMsg("SteamTV.AddWordBan#1", (0, g.I8)(Kt, t), Yt, {
              ePrivilege: 1,
              eWebAPIKeyRequirement: 2,
            });
          }),
          (e.GetWordBans = function (e, t) {
            return e.SendMsg("SteamTV.GetWordBans#1", (0, g.I8)(Jt, t), Xt, {
              bConstMethod: !0,
              ePrivilege: 1,
              eWebAPIKeyRequirement: 2,
            });
          ...
          (e.JoinChat = function (e, t) {
            return e.SendMsg("SteamTV.JoinChat#1", (0, g.I8)($t, t), Zt, {
              ePrivilege: 2,
              eWebAPIKeyRequirement: 1,
            });
          }),
          (e.Search = function (e, t) {
            return e.SendMsg("SteamTV.Search#1", (0, g.I8)(Qt, t), er, {
              bConstMethod: !0,
              ePrivilege: 0,
            });
          }),
          ...
          return (
            Er.s_Singleton ||
              ...
              "dev" == zr.TS.WEB_UNIVERSE &&
                (window.g_BroadcastChatStore = Er.s_Singleton)),
            Er.s_Singleton
          );
        }
        constructor() {
      ...
      (0, n.Cg)([u.sH], Er.prototype, "m_mapChats", void 0);
      class Fr {
        ...
        InitTextFilter() {
          ...
          let e = 0;
          if ("" !== zr.iA.steamid) {
            e = new b.b(zr.iA.steamid).GetAccountID();
          }
        ...
        async RequestChatInfo(e) {
          ...
          try {
            const t = {
              ...
              r = await l().get(`${zr.TS.CHAT_BASE_URL}broadcast/getchatinfo`, {
                params: t,
                withCredentials: !0,
                cancelToken: e?.token,
              });
        ...
        async UpdateUserChatBan(e, t, r, i, a, n) {
          ...
          if (this.m_ulBroadcastChannelID) {
            ...
            s.append("broadcaststeamid", o),
              ...
              s.append("perm", i ? "1" : "0"),
              s.append("sessionid", zr.TS.SESSIONID);
            try {
              await l().post(
      ...
      (0, n.Cg)([u.sH], Fr.prototype, "m_mapChannelModeratorUsers", void 0),
        (0, n.Cg)([u.sH], Fr.prototype, "m_mapBroadcastModeratorUsers", void 0),
        (0, n.Cg)([u.sH], Fr.prototype, "m_nRateLimitSeconds", void 0),
        (0, n.Cg)([u.sH], Fr.prototype, "m_bRateLimited", void 0),
        (0, n.Cg)([u.sH], Fr.prototype, "m_rgChatMessages", void 0),
        (0, n.Cg)([u.sH], Fr.prototype, "m_latestAnnouncement", void 0),
        (0, n.Cg)([vr.o], Fr.prototype, "FetchChatModerators", null),
        (0, n.Cg)([vr.o], Fr.prototype, "RequestLoop", null),
        (0, n.Cg)([vr.o], Fr.prototype, "MuteUserForSession", null);
      var Or = r(60727),
        Wr = r(90024),
        Nr = r.n(Wr),
        Dr = r(60155),
      ...
      const Vr = () =>
          d.createElement(
            "div",
            { className: qr().FriendsListInsetShadowCtn },
            d.createElement("div", {
              className: qr().FriendListInsetShadowTop,
            }),
          ),
        Gr = () =>
          d.createElement(
            ...
            { className: qr().FriendsListInsetShadowCtn },
            d.createElement("div", {
              className: qr().FriendListInsetShadowBottom,
            }),
          );
      var Lr = r(12155),
        Hr = r(52038),
      ...
      function si(e) {
        const {
          ...
          [n, o] = d.useState(s),
          l = (0, ti.L$)(
            `${$r.z.GetBaseURL()}4/080b1f163b02a9810fa78f0b32b9396fab012aef.gif`,
          ),
          c = (0, ti.L$)(
            `${$r.z.GetBaseURL()}4/56521811317a8298a7aff4a914be964b67dd0325.png`,
          ),
          m = (0, Zr.w)(t.giveaway_gid);
        let u =
          m.bLoadingGiveawayInfo || m.closed ? null : m.seconds_until_drawing;
        const _ = s === zr.iA.accountid;
        d.useEffect(() => {
          ...
          d.createElement(
            ...
            Boolean(i) &&
              d.createElement(
                "div",
                { className: a },
                _ ? (0, Tr.we)("#GA2022_YouWonNextSteps") : i,
              ),
          ),
        );
      }
      function ni(e) {
        const { gidGiveaway: t, stream: r } = e,
          i = (function (e, t) {
            const [r, i] = (0, m.q3)(() => [
                t?.steamid,
                Xr.es.GetBroadcast(t?.steamid)?.m_ulBroadcastID,
              ]),
              [a, s] = d.useState(null);
            d.useEffect(() => {
              let e = null;
      ...
      let ui = class extends d.Component {
        ...
        StartChat() {
          if (
            (this.m_chat && this.m_chat.Stop(),
            (this.m_chat = Er.Get().GetOrCreateChat(
        ...
        AddLinksEmoticons(e, t) {
          ...
          for (let e = 0; e < i.length; e += 1)
            e % 2 == 1
              ? a.push(
                  d.createElement(jr.n, { key: e, emoticon: i[e], large: !0 }),
                )
              : a.push(i[e]);
          return a;
        }
        ...
        RenderUserChatLine(e, t, r) {
          ...
          return d.createElement(
            ...
            e.type === p.X8.Chat && d.createElement(di, { userType: a }),
            e.flair &&
              d.createElement(
                "span",
      ...
      function pi(e) {
        ...
        let c = n || 0 == i.trim().length,
          u = (0, Hr.A)(Nr().chatSubmitButton, 0 == i.length && Nr().disabled);
        return d.createElement(
          "div",
      ...
      (0, n.Cg)([u.sH], ui.prototype, "m_chat", void 0),
        (0, n.Cg)([Kr.oI], ui.prototype, "StartChat", null),
        (0, n.Cg)([Kr.oI], ui.prototype, "HandleScroll", null),
        (0, n.Cg)([Kr.oI], ui.prototype, "OnContextMenu", null),
        (0, n.Cg)([Kr.oI], ui.prototype, "RenderUserChatLine", null),
        (ui = (0, n.Cg)([c.PA], ui));
      class hi extends d.Component {
        render() {
          return d.createElement(
            "div",
      ...
      function Bi(e) {
        return d.createElement(
          ...
          !zr.iA.logged_in &&
            d.createElement(
              Ur.$n,
              { onClick: xr.vg, className: (0, Hr.A)(Jr().SignInButton) },
      ...
      const Wi = (0, c.PA)((e) => {
        const { appid: t } = e,
          ...
          { data: n } = (0, Ii.lv)(a),
          { data: o } = (0, Ii.by)(a),
          [l, c] = (0, Si.t7)(t, i.current);
        let m = (0, Hr.A)(
            Ti().StoreSaleWidgetContainer_mini,
            "StoreSaleWidgetContainer_mini",
          ),
          u = Ti().StoreSaleWidgetImage_mini,
          _ = Ti().StoreSaleImage_mini;
        if (null == s)
          return d.createElement(
            "div",
            { className: m },
        ...
        if (null == s || !s.name)
          return d.createElement("div", {
            className: wi.StoreSaleWidgetEmptyContainer,
          });
        const p = 8 != s.type,
          g = (0, yi.wJ)((0, Ei._)(s), r);
        return d.createElement(
          "div",
          { className: m },
          d.createElement(
            "a",
            { href: g, target: zr.TS.IN_CLIENT ? void 0 : "_blank" },
            d.createElement(
              fi.j,
              { id: a },
              d.createElement(
          ...
          d.createElement(
            "div",
            { className: wi.StoreSaleBroadcastWidgetRight },
            d.createElement(
              "a",
              { href: g, target: zr.TS.IN_CLIENT ? void 0 : "_blank" },
              d.createElement(
            ...
            o &&
              d.createElement(
                "div",
                { className: wi.StoreSaleWidgetRelease },
                (0, Oi.CC)(o),
              ),
            Boolean(p) && d.createElement(Mi.w, { id: a, bShowDemoButton: !0 }),
          ),
        );
      });
      var Ni = r(22837),
      ...
      const Li = (0, c.PA)((e) => {
        const { event: t } = e,
          ...
          a = (0, d.useRef)(null),
          [s, n] = (0, d.useState)(
            t ? qi.pF.GetCreatorHome(t.clanSteamID) : null,
          );
        if (
          ((0, d.useEffect)(() => {
            ...
            return (
              (async () => {
                const t = b.b.InitFromClanID(r),
                  i = await qi.pF.LoadCreatorHome(t, !1, e);
                e.token.reason || n(i);
              })(),
              () => {
        ...
        return d.createElement(
          ...
          d.createElement(
            ...
            Boolean(t.jsondata.broadcast_item_drops_details_clan_accountid) &&
              d.createElement(
                "a",
                { href: o, target: zr.TS.IN_CLIENT ? "" : "_blank" },
      ...
      function ra(e) {
        ...
        return d.createElement(
          ...
          d.createElement(
            ...
            d.createElement(
              ei.uU,
              { href: r.strFacebookUrl, className: ea().ShareBtn },
              d.createElement("img", {
          ...
          d.createElement(
            ...
            d.createElement(
              ei.uU,
              { href: r.strTwitterUrl, className: ea().ShareBtn },
              d.createElement("img", {
                className: (0, Hr.A)(Ki().Button),
                src: $i.A,
              }),
          ...
          d.createElement(
            ...
            d.createElement(
              ei.uU,
              { href: r.strRedditUrl, className: ea().ShareBtn },
              d.createElement("img", {
                className: (0, Hr.A)(Ki().Button),
                src: Xi.A,
              }),
      ...
      function ia(e) {
        const { steamid: t } = e,
          ...
          o = zr.TS.COMMUNITY_BASE_URL + "broadcast/watch/" + t;
        return d.createElement(
          "div",
          null,
          d.createElement(
            "div",
            {
              className: (0, Hr.A)(Ki().FlexRowContainer, ea().linkField),
              onClick: n,
            },
            d.createElement(
              "span",
      ...
      let ma = class extends d.Component {
        ...
        async componentDidMount() {
          await Ui.j.Get().LoadBIsEmbeddedBroadcastHidden(this.m_cancelSignal),
            ...
            !this.props.event.BUsesContentHubForItemSource()
              ? Ui.j.Get().HintLoadEmbeddablePreviewStreams(this.props)
              : Ui.j.Get().HintLoadEmbeddableStreams(this.props)),
        ...
        ToggleBroadcastExpandShrink() {
          let e = Ui.j.Get().GetPlayReadyStream(this.props);
          const t = this.state.bExpanded,
            r = Xr.es.GetOrCreateBroadcastInfo(e.steamid).m_nAppID;
          (0, Ui.U7)(r, t ? 2 : 3, e.snr),
            ...
            t ||
              this.setState({ bExpanded: !this.state.bExpanded }, () =>
                Ui.j.Get().SetEmbeddedStreamCollapsed(!this.state.bExpanded),
              );
        }
        OnShrinkTransitionEnd() {
          "0vh" === this.state.innerStyle.maxHeight &&
            this.setState({ bExpanded: !1 }, () =>
              Ui.j.Get().SetEmbeddedStreamCollapsed(!0),
            );
        }
        async onStreamSelect(e) {
          this.setState({ bStartMuted: !1 }),
            Ui.j.Get().GetPlayReadyStream(this.props).accountid !=
              e.accountid &&
              (await Ui.j.Get().AttemptToPlayStream(this.props, e));
        }
        async PlayNextNonVOD() {
          ...
          await Ui.j.Get().PlayFromAvailableStreams(this.props, e, !0);
        }
        ConstructSidePanels(e, t) {
          ...
          const i = Ui.j.Get().GetConcurrentStreams(this.props) > 1;
          let a = Xr.es.GetOrCreateBroadcastInfo(e.steamid).m_nAppID,
            s = d.createElement(pa, {
              key: "right" + a,
              ImgUrl: e.right_panel,
            }),
            n = d.createElement(pa, { key: "left" + a, ImgUrl: e.left_panel });
          if (a < 11) {
            ...
            i && !t
              ...
              : t
                ? ((r.leftPanel = d.createElement("div", null)),
                  (r.rightPanel = d.createElement(Sa, {
                    stream: e,
        ...
        render() {
          ...
          if (e) {
            ...
            let t = "show" === Ui.j.Get().GetChatVisibility();
            const {
              event: r,
              language: i,
            ...
            let s = this.ConstructSidePanels(e, t),
              ...
              o = Ui.j.Get().GetConcurrentStreams(this.props) > 1;
            const l = () => {
      ...
      (0, n.Cg)([Kr.oI], ma.prototype, "ToggleBroadcastExpandShrink", null),
        (0, n.Cg)([Kr.oI], ma.prototype, "OnShrinkTransitionEnd", null),
        (0, n.Cg)([Kr.oI], ma.prototype, "onStreamSelect", null),
        (0, n.Cg)([Kr.oI], ma.prototype, "PlayNextNonVOD", null),
        (ma = (0, n.Cg)([c.PA], ma));
      class da extends d.Component {
        ...
        CloseBroadcastPopup() {
          const e = Xr.es.GetOrCreateBroadcastInfo(
            this.props.stream.steamid,
          ).m_nAppID;
          (0, Ui.U7)(e, 7, this.props.stream.snr),
      ...
      function ua(e) {
        const { stream: t } = e,
          [r] = (0, m.q3)(() => [t.steamid]),
          i = Xr.es.GetOrCreateBroadcastInfo(r).m_nAppID,
          a = la.list.find(
            (e) =>
              e.appid == i &&
      ...
      (0, n.Cg)([Kr.oI], da.prototype, "CloseBroadcastPopup", null),
        (0, n.Cg)([Kr.oI], da.prototype, "OnEnter", null),
        (0, n.Cg)([Kr.oI], da.prototype, "OnLeave", null);
      let _a = class extends d.Component {
        OnToggleChat(e) {
          e.preventDefault();
          const t = Xr.es.GetOrCreateBroadcastInfo(
            this.props.stream.steamid,
          ).m_nAppID;
          (0, Ui.U7)(
            t,
            "show" === Ui.j.Get().GetChatVisibility() ? 5 : 4,
            this.props.stream.snr,
          ),
            Ui.j.Get().ToggleChatVisibility();
        }
        onWatchBroadcastPage() {
          const e = Xr.es.GetOrCreateBroadcastInfo(
            this.props.stream.steamid,
          ).m_nAppID;
          (0, Ui.U7)(e, 9, this.props.stream.snr);
        }
        render() {
          const e = "remove" != Ui.j.Get().GetChatVisibility(),
            t = "hide" === Ui.j.Get().GetChatVisibility(),
            r = !this.props.stream.nAppIDVOD,
            i = r;
          let a = Number.parseInt(
            "" +
              Xr.es.GetOrCreateBroadcastInfo(this.props.stream.steamid)
                .m_nViewerCount,
          );
          return d.createElement(
            "div",
      ...
      (0, n.Cg)([Kr.oI], _a.prototype, "OnToggleChat", null),
        (0, n.Cg)([Kr.oI], _a.prototype, "onWatchBroadcastPage", null),
        (_a = (0, n.Cg)([c.PA], _a));
      class pa extends d.Component {
        render() {
          ...
          return d.createElement(
            "div",
            { className: Gi().SidePanelBackground },
            e &&
              d.createElement("img", {
      ...
      const ga = (0, c.PA)((e) => {
        ...
        let r = Xr.es.GetOrCreateBroadcastInfo(t).m_nAppID;
        r = r != Xr.fO ? r : 0;
        const i = (0, zi.$5)(r),
          { data: a } = (0, Ii.J$)(i);
        return d.createElement(
          ...
          Boolean(a)
            ? d.createElement(
                ...
                { id: i, className: Gi().PopOutVideoTitleText },
      ...
      function ha(e, t) {
        const r = Xr.es.GetOrCreateBroadcastInfo(t.steamid).m_nAppID,
          i = ji.A.Get().GetApp(r);
      ...
      function Ba(e) {
        ...
        return (
          (0, d.useEffect)(() => {
            if (n && n.current) {
              const e = o
                .map((e) => Xr.es.GetOrCreateBroadcastInfo(e.steamid).m_nAppID)
                .filter(Boolean);
              ji.A.Get()
      ...
      function ba(e) {
        ...
        let s = (0, m.q3)(
          () => Xr.es.GetOrCreateBroadcastInfo(i.steamid).m_nAppID,
        );
        s = s != Xr.fO ? s : 0;
        const n = (0, zi.$5)(s),
          { data: o } = (0, Ii.J$)(n),
          { data: l } = (0, Ii.lv)(n);
        if (!(0, Ui.fn)(i)) return null;
        const c = a && l && (0, Fi.b0)(l, "header"),
          u = Number.parseInt("" + i.viewer_count),
          _ = !Number.isNaN(u),
          p = !!i.nAppIDVOD && o?.name;
        return d.createElement(
          "div",
          {
            className: (0, Hr.A)({
              ...
              [Gi().stream_featured]:
                i.current_selection_priority == oa.mY.k_eFeatured,
              [Gi().display_capsule_art]: Boolean(c),
            }),
          },
          d.createElement(
            fi.j,
            { id: n, hoverClassName: Gi().StreamCapsule },
            d.createElement(
              Ai.K,
              {
                className: (0, Hr.A)(
                  Gi().stream_icon_container,
                  r && Gi().stream_selected,
                ),
                onClick: () => t && t(i),
          ...
          d.createElement(
            "div",
            { className: (0, Hr.A)(Gi().viewer_count, !_ && Gi().vod_title) },
            _
              ? d.createElement(
                  d.Fragment,
                  null,
    ...
    72224: (e, t, r) => {
      ...
      (0, i.Cg)([d.oI], k.prototype, "OnClick", null);
      ...
      (0, i.Cg)([d.oI], x.prototype, "HideStats", null),
        (x = (0, i.Cg)([s.PA], x));
        ...
        render() {
          ...
          return n.createElement(
            ...
            n.createElement(
              ...
              n.createElement(C.wB_, null),
            ),
            n.createElement(G, { video: r }),
            i &&
              i.map((e) =>
                n.createElement(
                  "div",
      ...
      (0, i.Cg)([d.oI], q.prototype, "OnVideoControlClick", null),
        (0, i.Cg)([d.oI], q.prototype, "OnSubtitlesClick", null),
        (0, i.Cg)([d.oI], q.prototype, "OnMouseUp", null),
        (0, i.Cg)([d.oI], q.prototype, "bindSettingsButton", null),
        (0, i.Cg)([d.oI], q.prototype, "BindSettingsPanel", null),
        (0, i.Cg)([d.oI], q.prototype, "OnShowStats", null);
      const V = !0;
      ...
      (0, i.Cg)([a.sH], G.prototype, "m_bShowSlider", void 0),
        (0, i.Cg)([d.oI], G.prototype, "ToggleMute", null),
        (0, i.Cg)([d.oI], G.prototype, "OnMouseEnter", null),
        (0, i.Cg)([d.oI], G.prototype, "OnMouseLeave", null),
        (0, i.Cg)([d.oI], G.prototype, "OnChildDrag", null),
        (G = (0, i.Cg)([s.PA], G));
      ...
      (0, i.Cg)([d.oI], L.prototype, "OnMouseDown", null),
        (0, i.Cg)([d.oI], L.prototype, "OnMouseMove", null),
        (0, i.Cg)([d.oI], L.prototype, "OnMouseUp", null),
      ...
      let Y = class extends n.Component {
        ...
        OnContextMenu(e) {
          this.state.bFullscreen ||
            ((0, o.lX)(
              n.createElement(p.tz, null, this.GetContextMenuItems()),
              e,
            ),
            e.preventDefault());
        }
        ...
        ShowStorePage(e) {
          ...
          if (!r) return;
          let i = (0, l.k2)(`${E.TS.STORE_BASE_URL}app/${r.m_strAppId}`);
        ...
        render() {
          ...
          return n.createElement(
            ...
            p && n.createElement("div", { className: N().BroadcastContext }, p),
            ...
            u && n.createElement($, { onClick: this.props.onRequestClose }),
            r &&
              n.createElement(x, {
                stats: e.GetDASHPlayerStats(),
                closeStats: this.CloseStats,
              }),
            n.createElement(j, { video: e }),
            o && n.createElement(k, { video: e }),
          );
        }
      };
      (0, i.Cg)([d.oI], Y.prototype, "BindBroadcastPlayerRef", null),
        (0, i.Cg)([d.oI], Y.prototype, "BindVideoRef", null),
        (0, i.Cg)([d.oI], Y.prototype, "OnMouseDown", null),
        (0, i.Cg)([d.oI], Y.prototype, "OnMouseUp", null),
        (0, i.Cg)([d.oI], Y.prototype, "OnMouseMove", null),
        (0, i.Cg)([d.oI], Y.prototype, "OnMouseLeave", null),
        (0, i.Cg)([d.oI], Y.prototype, "HideControls", null),
        (0, i.Cg)([d.oI], Y.prototype, "UmountControls", null),
        (0, i.Cg)([d.oI], Y.prototype, "ShowStatsView", null),
        (0, i.Cg)([d.oI], Y.prototype, "OnContextMenu", null),
        (0, i.Cg)([d.oI], Y.prototype, "ToggleStatsView", null),
        (0, i.Cg)([d.oI], Y.prototype, "ShowStorePage", null),
        (0, i.Cg)([d.oI], Y.prototype, "CloseStats", null),
        (0, i.Cg)([d.oI], Y.prototype, "OnToggleFullscreen", null),
        (0, i.Cg)([d.oI], Y.prototype, "OnFullscreenChange", null),
        (Y = (0, i.Cg)([s.PA], Y));
      const J = Y;
      let X = class extends n.Component {
        render() {
      ...
      (0, i.Cg)([d.oI], Z.prototype, "OnJumpBackward", null),
        (0, i.Cg)([d.oI], Z.prototype, "OnJumpForward", null);
      const Q = (0, s.PA)((e) => {
      ...
      let ee = class extends n.Component {
        ...
        render() {
          ...
          return n.createElement(
            ...
            e ? n.createElement(C.jGG, null) : n.createElement(C.vRz, null),
          );
        }
      };
      (0, i.Cg)([d.oI], ee.prototype, "OnTogglePlayPause", null),
        (ee = (0, i.Cg)([s.PA], ee));
      let te = class extends n.Component {
        ...
        render() {
          ...
          return n.createElement(
            ...
            n.createElement(C.tID, { bHidePostArrow: !0, bFlipHorizontal: !0 }),
          );
        }
      };
      (0, i.Cg)([a.sH], te.prototype, "video", void 0),
        (0, i.Cg)([a.EW], te.prototype, "has_previous_marker", null),
        (0, i.Cg)([d.oI], te.prototype, "OnJumpToPreviousMarkerClicked", null),
        (te = (0, i.Cg)([s.PA], te));
      let re = class extends n.Component {
        ...
        render() {
          ...
          return n.createElement(
            ...
            n.createElement(C.tID, { bHidePostArrow: !0, bFlipHorizontal: !1 }),
          );
        }
      };
      (0, i.Cg)([a.sH], re.prototype, "video", void 0),
        (0, i.Cg)([a.EW], re.prototype, "has_next_marker", null),
        (0, i.Cg)([d.oI], re.prototype, "OnJumpToNextMarkerClicked", null),
        (re = (0, i.Cg)([s.PA], re));
      const ie = (e) =>
        n.createElement(
          "div",
      ...
      let se = class extends n.Component {
        ...
        render() {
          ...
          let s = I.OQ(r, 0, 100).toFixed(1) + "%",
            ...
            _ = {};
          t
            ? ((_.left = s), (m.width = s), (d.width = o), (u.width = l))
            : ((_.left = o), (d.width = o), (u.width = l));
          let p = (0, O.ap)(e.GetPlaybackTime()),
      ...
      (0, i.Cg)([d.oI], se.prototype, "OnMouseDown", null),
        (0, i.Cg)([d.oI], se.prototype, "OnMouseMove", null),
        (0, i.Cg)([d.oI], se.prototype, "OnMouseUp", null),
        (0, i.Cg)([d.oI], se.prototype, "OnKeyDown", null),
        (0, i.Cg)([d.oI], se.prototype, "OnMouseHoverMove", null),
        (0, i.Cg)([d.oI], se.prototype, "OnMouseHoverLeave", null),
        (0, i.Cg)([d.oI], se.prototype, "AdjustHoverForClientX", null),
        (0, i.Cg)([d.oI], se.prototype, "OnSegmentClick", null),
        (0, i.Cg)([d.oI], se.prototype, "OnMarkerMouseEnter", null),
        (0, i.Cg)([d.oI], se.prototype, "OnMarkerMouseLeave", null),
        (se = (0, i.Cg)([s.PA], se));
      let ne = class extends n.Component {
        ...
        render() {
          ...
          return n.createElement(
            ...
            a && n.createElement(M.m, { gidEvent: F.td.gidEvent }),
            i &&
              n.createElement(w.p, {
                id:
                  F.td.bValid &&
      ...
      class oe extends n.Component {
        showContextMenu(e) {
          ...
          (0, o.lX)(n.createElement(p.tz, null, a), e);
        }
        render() {
          ...
          return n.createElement(
            ...
            n.createElement(
              ...
              n.createElement(C.GB9, null),
            ),
          );
        }
      }
      (0, i.Cg)([d.oI], oe.prototype, "showContextMenu", null);
      ...
      (0, i.Cg)([d.oI], le.prototype, "AddLinkRegion", null),
        (0, i.Cg)([d.oI], le.prototype, "LoadLinkRegion", null),
        (0, i.Cg)([d.oI], le.prototype, "OnSaveRegions", null),
        (0, i.Cg)([d.oI], le.prototype, "DeleteRegion", null),
        (0, i.Cg)([d.oI], le.prototype, "UpdatePanel", null),
        (le = (0, i.Cg)([s.PA], le));
    },
    13699: (e, t, r) => {
      "use strict";
    ...
    54728: (e, t, r) => {
      ...
      class U {
        ...
        async GetClipManifest(e, t) {
          ...
          let a = i.data;
          1 == a.success
            ? (e.SetState(z.Ready), (e.m_data = a), this.LoadClip(e))
      ...
      class j {
        ...
        GetBroadcastState() {
          return k.GetBroadcastState(this);
        }
        GetBroadcastStateDescription() {
          return k.GetBroadcastStateDescription(this);
        }
        ...
        StartBroadcast(e) {
          ...
          t &&
            ...
            (this.m_BroadcastInfo = k.StartInfo(this.m_steamIDBroadcast));
        }
        StartClip(e) {
          this.InitPlayer();
          let t = new _.Zn(this.m_elVideo);
        ...
        Stop() {
          this.m_listeners.Unregister(),
            this.m_BroadcastInfo &&
              (k.StopInfo(this.m_BroadcastInfo), (this.m_BroadcastInfo = null)),
        ...
        Play() {
          ...
          e == z.None || this.IsBroadcastClip()
            ? k.StartVideo(this)
            : e == z.Ready &&
              (k.SetActiveVideo(this),
              this.m_player
                ? this.m_player.Play()
                : this.IsBroadcastVOD()
                  ? this.StartVOD(k.GetBroadcastVOD(this.m_nBroadcastAppIDVOD))
                  : this.StartBroadcast(
                      k.GetBroadcast(this.m_steamIDBroadcast),
                    ));
        }
        Pause() {
          console.log(
        ...
        SetVolume(e) {
          this.m_player && this.m_player.SetVolume(e),
            ...
            k.SaveVolumeChange(e, this.m_bMuted);
        }
        SetMute(e) {
          this.m_player && this.m_player.SetMuted(e),
            (this.m_bMuted = e),
            k.SaveVolumeChange(this.m_nVolume, e);
        }
        IsMuted() {
        ...
        OnDownloadFailed(e) {
          ...
          k.BroadcastDownloadFailed(this, !0, t);
        }
        OnWebRTCRetry() {
          k.BroadcastDownloadFailed(this, !1);
        }
        OnWebRTCFailed() {
          k.BroadcastDownloadFailed(this, !0);
        }
        OnUserInputNeeded() {
        ...
        GetTimeAtMousePosition(e, t, r, i) {
          let a = p.Fu(e, t.left, t.right, r, i);
      ...
      (0, i.Cg)([n.sH], j.prototype, "m_player", void 0),
        ...
        (0, i.Cg)([h.o], j.prototype, "OnVideoPlaying", null),
        (0, i.Cg)([h.o], j.prototype, "OnVideoPause", null),
        (0, i.Cg)([n.XI.bound], j.prototype, "OnVideoTimeUpdate", null),
        (0, i.Cg)([h.o], j.prototype, "OnVolumeUpdated", null),
        (0, i.Cg)([n.XI.bound], j.prototype, "OnGameDataUpdate", null),
        (0, i.Cg)([h.o], j.prototype, "OnDownloadFailed", null),
        (0, i.Cg)([h.o], j.prototype, "OnWebRTCRetry", null),
        (0, i.Cg)([h.o], j.prototype, "OnWebRTCFailed", null),
        (0, i.Cg)([h.o], j.prototype, "OnUserInputNeeded", null);
      const k = new U();
      window.uiBroadcastWatchStore = k;
    },
    30193: (e, t, r) => {
      "use strict";
      r.d(t, { pN: () => l });
    ...
    43882: (e, t, r) => {
      ...
      class g extends m.Message {
        ...
        constructor(e = null) {
          super(),
            g.prototype.encryption_key || u.Sg(g.M()),
            m.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      !(function (e) {
        (e.ClientGetVideoURL = function (e, t) {
          return e.SendMsg("Video.ClientGetVideoURL#1", (0, l.I8)(_, t), p, {
            ePrivilege: 1,
          });
        }),
          ...
          (e.GetVideoBookmarks = function (e, t) {
            return e.SendMsg("Video.GetVideoBookmarks#1", (0, l.I8)(S, t), w, {
              ePrivilege: 1,
            });
          });
      })(i || (i = {})),
      ...
      function m(e) {
        ...
        if (t) {
          ...
          if (2 == e.length) {
            ...
            const { sizeStr: i, alignStr: s } = c(r);
    ...
    88527: (e, t, r) => {
      ...
      function g(e) {
        ...
        (0, i.useEffect)(() => {
          b &&
            a.R.LoadYouTubeDynamicData([t], M)
              .then((e) => {
                !M.token.reason && e.length > 0 && (C(e[0]), w(!0));
              })
              .catch((e) =>
                console.error(
          ...
          return i.createElement(
            ...
            i.createElement(
              ...
              i.createElement(
                ...
                { className: p().Dynamiclink_Content },
                S && a,
                !S && i.createElement(s.t, { size: "medium" }),
              ),
            ),
          );
        }
        return i.createElement(
          ...
          i.createElement(
            "div",
            { className: (0, l.A)(p().PreviewYouTubeVideo, h, B), id: t },
            i.createElement("img", {
    ...
    81962: (e, t, r) => {
      ...
      function _(e) {
        const { emoticon: t, large: r } = e,
          ...
          [d, u] = i.useState(),
          _ = `:${t}:`,
          g = s.pN.GetEmoticonURL(t, r);
        return i.createElement(
          i.Fragment,
          null,
          i.createElement(
            n,
            { text: _, style: "merge-adjacent" },
            i.createElement("img", {
              ...l,
              src: g,
          ...
          a && i.createElement(p, { target: d, emoticon: t }),
        );
      }
      function p(e) {
        ...
        return i.createElement(
          ...
          i.createElement(_, { emoticon: r, large: !0 }),
        );
      }
            ...
            : n.createElement(
                ...
                t &&
                  n.createElement(
                    ...
                    n.createElement(R.Jlk, null),
                  ),
                e &&
                  n.createElement(
                    "div",
                    { className: k.RemindBell },
                    n.createElement(R.IrQ, null),
                  ),
                n.createElement(
                  "div",
                  { className: k.ReminderDefault },
                  (0, F.we)("#EventDisplay_Reminder_SetReminder"),
                ),
                n.createElement("div", { className: k.ReminderOptions }),
              );
        }
      };
      function V(e) {
        ...
        if (!a)
          return t
            ? n.createElement(
                ...
                (0, F.we)("#EventDidplay_Reminder_EventNotVisible", r),
              )
            : null;
        const s = (0, o.sf)(h.TS.LANGUAGE);
        return n.createElement(q, { lang: s, ...i, eventModel: a });
      }
      function G(e) {
        return s.unix(e).utc().format("YYYYMMDD[T]HHmmss[Z]");
      }
      (0, i.Cg)([O.oI], q.prototype, "ToggleMenu", null),
        (0, i.Cg)([O.oI], q.prototype, "ShowMenu", null),
        (0, i.Cg)([O.oI], q.prototype, "HideMenu", null),
        (q = (0, i.Cg)([a.PA], q));
      const L = (0, a.PA)((e) => {
        const {
            eventModel: t,
            ...
            if (a && a != o.kF) {
              ...
              try {
                await p.KN.Get().SetFollowOrUnfollowEvent(
                  ...
                  e &&
                    (i === p.Nh.k_ENotifyFlagByEmail
                      ? b(u.E.k_eReminder_Email)
                      : i === p.Nh.k_ENotifyFlagByPush &&
                        b(u.E.k_eReminder_MobilePush));
              } catch (e) {
                (0, v.HT)(
                  n.createElement(
                    C.KG,
          ...
          y = t.jsondata.bSaleEnabled
            ...
            : j.PH.k_eStoreView,
          w = (0, j.Bw)(t, y, "forceAbsolute"),
          O = (e) => {
            const r = t.appid
                ? "app/" + t.appid
                : "group/" + t.clanSteamID.GetAccountID(),
              i = "l=" + (0, o.Lg)(m);
            return `${h.TS.STORE_BASE_URL}${(0, j.LJ)()}/download/${r}/${e}/${t.GID}?${i}`;
          },
          D = S.BHasValidatedEmail(),
          U = S.BHasPushNotification(),
        ...
        return n.createElement(
          ...
          n.createElement(
            ...
            n.createElement("div", { className: k.ReminderOpennedOptions }),
          ),
          n.createElement(
            "div",
            {
            ...
            n.createElement(
              ...
              (0, F.we)("#EventDisplay_Reminder_GetNotification_Via"),
            ),
            n.createElement(
              "div",
              { className: (0, E.A)(k.ReminderOption, !D && k.Unverified) },
              n.createElement(
                z.he,
                {
                ...
                n.createElement(M.Yh, {
                  ...
                  onChange: (e) => {
                    B(e, !1, p.Nh.k_ENotifyFlagByEmail);
                  },
                }),
              ),
              !D &&
                n.createElement(
                  ...
                  n.createElement(
                    "a",
                    {
                      ...
                      onClick: () => b(u.E.k_eReminder_EmailUnverified),
                    },
                    (0, F.we)("#EventReminder_NotifyByEmail_Missing_Add"),
                  ),
                ),
            ),
            n.createElement(
              "div",
              { className: (0, E.A)(k.ReminderOption, !U && k.Unverified) },
              n.createElement(
                z.he,
                {
                  className: k.CheckboxWrapper,
                ...
                n.createElement(M.Yh, {
                  ...
                  onChange: (e) => {
                    B(e, !1, p.Nh.k_ENotifyFlagByPush);
                  },
                }),
              ),
              !U &&
                n.createElement(
                  ...
                  n.createElement(
                    "a",
                    {
                      ...
                      target: h.TS.IN_CLIENT ? void 0 : "_blank",
                      onClick: () => b(u.E.k_eReminder_MobilePushMissing),
                    },
                    (0, F.we)("#EventReminder_NotifyByMobile_Install"),
                  ),
                ),
            ),
            n.createElement(
              ...
              n.createElement(
                "div",
                { className: k.ReminderOptionsHeader },
                (0, F.we)("#EventDisplay_Reminder_AddToCalendar"),
              ),
              n.createElement(
                "div",
                ...
                n.createElement(
                  "a",
                  {
                    ...
                    href: O("ics"),
                    onClick: () => b(u.E.k_eReminder_CalendarApple),
                  },
                  (0, F.we)("#EventDisplay_Reminder_AppleCalendar_Short"),
                ),
                n.createElement(
                  "a",
                  {
                    ...
                    href: (() => {
                      const e = encodeURIComponent(
                        ...
                        a = G(i),
                        s = G(
                          t.GetEndTimeAndDateUnixSeconds() || i + W.Kp.PerHour,
                        ),
                        n =
                    ...
                    onClick: () => b(u.E.k_eReminder_CalendarGoogle),
                  },
                  (0, F.we)("#EventDisplay_Reminder_GoogleCalendar_Short"),
                ),
                n.createElement(
                  "a",
                  {
                    className: k.ReminderOption,
                    href: O("outlook"),
                    onClick: () => b(u.E.k_eReminder_CalendarOutlook),
                  },
                  (0, F.we)("#EventDisplay_Reminder_OutlookCalendar_Short"),
                ),
              ),
            ),
            !1,
    ...
    48079: (e, t, r) => {
      ...
      var i = r(34629),
        ...
        p = r.n(_);
      const g = (0, a.PA)((e) => {
        const t = (0, n.z5)(e.photo, (0, o.sf)(d.TS.LANGUAGE)),
        ...
        return s.createElement(
          ...
          s.createElement(
            ...
            e.photo && s.createElement("img", { src: r }),
            s.createElement(
              "div",
              ...
              (i || a) &&
                s.createElement(
                  ...
                  i && a && s.createElement("span", null, ", "),
                  a && s.createElement("span", null, e.company),
                ),
            ),
          ),
          e.bio &&
            s.createElement(
              ...
              e.bio,
              e.bioString && s.createElement(u.h, { text: e.bioString }),
            ),
        );
      });
        ...
        OnHover(e) {
          ...
          h.sm_embeddedElements.ShowElementDelayed(
            ...
            s.createElement(
              c.g,
              { ...r },
              s.createElement(g, { ...this.props, fnClose: this.OnLeave }),
            ),
            i,
          );
        }
      ...
      function B(e) {
        const {
          ...
          c = (0, n.z5)(t, (0, o.sf)(d.TS.LANGUAGE)),
                ...
                s.createElement(
                  ...
                  (u || _) &&
                    s.createElement(
                      ...
                      u && _ && s.createElement("span", null, ", "),
                      _ && s.createElement("span", null, a),
                    ),
                ),
              ),
            ),
    ...
    93267: (e, t, r) => {
      ...
      (0, i.Cg)([m.oI], d.prototype, "BUserHasVolumePreference", null),
        (0, i.Cg)([m.oI], d.prototype, "SetVolumePreference", null);
      const u = (0, a.forwardRef)(function (e, t) {
        ...
        let M;
        (!w || (b && "public" == c.TS.WEB_UNIVERSE)) && (M = "anonymous");
        const f = o || (i && d.Get().BVolumePreferenceMuted()),
        ...
        return a.createElement(
          ...
          a.createElement(g, { rgVideoTracks: r.rgVideoTracks }),
        );
      });
      function _(e) {
        if (e)
      ...
      function g(e) {
        ...
        return t
          ? t.map((e, r) =>
              a.createElement(h, { key: r, track: e, rgVideoTracks: t }),
            )
          : null;
      }
      function h(e) {
        ...
        let i = t.eLanguage;
        if ((0, c.Y2)())
          if (o.A0.IsELanguageValidInRealm(i, n.TU.k_ESteamRealmChina))
        ...
        else if (!o.A0.IsELanguageValidInRealm(i, n.TU.k_ESteamRealmGlobal))
          return null;
        return a.createElement("track", {
          ...
          default: t.bDefault,
          srcLang: (0, s.ww)(i),
          label: (0, o.we)("#language_selection_" + (0, s.Lg)(i)),
        });
      }
    },
    97232: (e, t, r) => {
    ...
    76684: (e, t, r) => {
      ...
      const h = (0, o.PA)((e) => {
          ...
          return r
            ? a.createElement(
                "span",
                { className: i || s ? m.DateAndTimeInline : m.DateAndTime },
                o && c,
                ...
                o &&
                  a.createElement(
                    ...
                    a.createElement(
                      "span",
                      { className: m.At },
                      (0, n.we)("#EventDisplay_DateAndTimeCombiner"),
                    ),
                  ),
                a.createElement(
                  "div",
          ...
          if (null == e || 0 == e)
            return a.createElement(
              ...
              a.createElement(
                ...
                (0, n.we)("#EventDisplay_TimeRange"),
              ),
              (0, n.we)("#EventDisplay_TimeDisplayNone"),
            );
      ...
      let y = class extends a.Component {
        render() {
            ...
            h =
              t < o
                ? a.createElement(
                    "div",
                    { className: i.RightSideTitles },
                    (0, n.we)("#EventDisplay_TimeEndsOn_Ran"),
                    e,
                  )
                : a.createElement(
                    "div",
          ...
          const y = a.createElement(B, { rtFullDate: t, stylesmodule: i }, h);
          return a.createElement("div", { className: i.ShortDateRange }, _, y);
        }
      };
      y = (0, i.Cg)([o.PA], y);
    },
    48211: (e, t, r) => {
      ...
      class b extends s.Component {
        ...
        componentWillUnmount() {
          var e;
          this.DestroyPlayer(), (e = this.OnYoutubeScriptsReady), n.x9(p, e);
        }
        ...
        render() {
          return s.createElement(
            ...
            s.createElement(
              ...
              s.createElement(c.t, { className: "YoutubePlayerThrobber" }),
            ),
          );
        }
      }
      ...
      (0, a.Cg)([o.oI], b.prototype, "BindPlayerContainer", null),
        (0, a.Cg)([o.oI], b.prototype, "OnYoutubeScriptsReady", null),
        (0, a.Cg)([o.oI], b.prototype, "CreatePlayer", null),
        (0, a.Cg)([o.oI], b.prototype, "OnPlayerReady", null),
        (0, a.Cg)([o.oI], b.prototype, "OnPlayerStateChange", null),
        (0, a.Cg)([o.oI], b.prototype, "OnError", null),
        (0, a.Cg)([o.oI], b.prototype, "OnPlayerLeftView", null),
        (0, a.Cg)([o.oI], b.prototype, "PlayVideo", null);
    },
  },
]);
