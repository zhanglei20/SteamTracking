...
(() => {
  (self.webpackChunkstore = self.webpackChunkstore || []).push([
    ...
    {
      8433: (_, I, R) => {
        R.r(I), R.d(I, { apply: () => Z, isSupported: () => X });
        var y = class extends Event {
            oldState;
            newState;
        ...
        function F(e, t, o) {
          x.set(
            ...
            setTimeout(() => {
              x.has(e) &&
                e.dispatchEvent(
                  new y("toggle", { cancelable: !1, oldState: t, newState: o }),
                );
            }, 0),
          );
        }
        ...
        function w(e, t = !1, o = !1) {
          ...
          if (
            ...
            o &&
              (e.dispatchEvent(
                new y("beforetoggle", { oldState: "open", newState: "closed" }),
              ),
              !f(e, !0)))
          )
            return;
        ...
        function k(e, t, o) {
          ...
          if (!a) return C(r, t, o);
          for (; i && m(i) === "showing" && p.get(r)?.size; ) w(i, t, o);
        }
        var P = new WeakMap();
        function W(e) {
...
`,
        ...
        function Z() {
          window.ToggleEvent = window.ToggleEvent || y;
          function e(n) {
            return (
