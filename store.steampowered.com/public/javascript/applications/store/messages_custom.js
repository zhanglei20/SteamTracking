  ...
  (self.webpackChunkstore = self.webpackChunkstore || []).push([
    [8287],
    {
      54407: (c, u, e) => {
          ...
          const g = (0, p.KV)(),
            { data: m, isLoading: _ } = (0, i.I)({
              ...
              queryFn: async () => {
                const C = new Map();
                if (o.iA.logged_in) {
                  const l = P.w.Init(y.w_T),
                    k = (await y.xtC.GetNicknameList(g, l)).Body().toObject();
                  k?.nicknames &&
                    k.nicknames.length > 0 &&
                    k.nicknames.forEach((S) => {
                      C.set(S.accountid, S.nickname);
                    });
                }
                return C;
              },
        ...
        async function L(a) {
          ...
          if (a.length == 1) {
            const m = { accountid: a[0], origin: self.origin },
              _ = await A().get(`${g}actions/ajaxgetavatarpersona`, {
                params: m,
              });
            if (
              !_ ||
            ...
            const m = { accountids: a.join(","), origin: self.origin },
              _ = await A().get(`${g}actions/ajaxgetmultiavatarpersona`, {
                params: m,
              });
            if (
              !_ ||
            ...
            const C = new Map();
            return (
              _.data.userinfos.forEach((l) =>
                C.set(new D.b(l.steamid).GetAccountID(), l),
              ),
              a.map((l) => C.get(l))
            );
          }
        }
        const O = new (f())((a) => L(a), { cache: !1 }),
          v = "avatarandpersonas";
        function T(a) {
          const { data: g, isLoading: m } = (0, i.I)({
            queryKey: [v, a],
            queryFn: () => O.load(a),
          });
          return [g, m];
        ...
        function s(a) {
          const g = (0, I.jE)(),
            { data: m, isLoading: _ } = (0, i.I)({
              queryKey: [v, a],
              queryFn: async () => {
                const l = await O.loadMany(a);
                return (
                  l.forEach((M) => {
                    const k = [v, new D.b(M.steamid).GetAccountID()];
                    g.setQueryData(k, M);
                  }),
                  l
                );
        ...
        function n(a) {
          return ReactQueryClient.getQueryData([v, a]);
        }
      },
      72795: (c, u, e) => {
        "use strict";
        e.r(u), e.d(u, { default: () => y });
        var t = e(7850),
          A = e(53617),
          h = e(15978),
          f = e(19298),
          ...
          P = e(86174);
        function y(s) {
          const n = (0, d.b)(s.year),
            a = T();
          return (0, t.jsxs)("div", {
            className: (0, o.A)(r.MMFrame, n.MMFrame, n.MMOverride),
            onClick: a,
            children: [
              (0, t.jsxs)("div", {
                className: r.HeaderCtn,
                children: [
                  (0, t.jsx)(L, {
                    baseClass: (0, o.A)(r.ReplayLogo, n.ReplayLogo),
                    accentClass: (0, o.A)(
                      r.ReplayLogoAccent,
                      n.ReplayLogoAccent,
                    ),
                  }),
                  (0, t.jsx)(O, { year: s.year, theme: n }),
                ],
              }),
              (0, t.jsx)(G, { className: (0, o.A)(r.SteamLogo, n.SteamLogo) }),
              (0, t.jsx)(v, { theme: n }),
              (0, t.jsxs)("div", {
                className: (0, o.A)(r.Content, n.Content),
                children: [
                  (0, t.jsx)(p, { theme: n }),
                  (0, t.jsx)("div", {
                    className: (0, o.A)(r.Description, n.Description),
        ...
        function p(s) {
          const { theme: n } = s,
            [a] = (0, B.KT)(I.iA.accountid);
          return a
            ? (0, t.jsxs)(t.Fragment, {
                children: [
                  (0, t.jsx)("div", {
                    className: (0, o.A)(r.Avatar, n.Avatar),
                    children:
                      a &&
                      a.avatar_url &&
                      (0, t.jsx)("img", {
                  ...
                  (0, t.jsx)("div", {
                    className: (0, o.A)(r.DataBlock, n.DataBlock),
                    children: (0, t.jsx)("div", {
                      className: (0, o.A)(r.PersonaName, n.PersonaName),
        ...
        function E(s) {
          const { theme: n } = s,
            a = T();
          return (0, t.jsx)(f.Z, {
            className: (0, o.A)(r.ViewPageButton, n.ViewPageButton),
            onActivate: a,
        ...
        function L(s) {
          const { baseClass: n, accentClass: a } = s;
          return (0, t.jsxs)("svg", {
            xmlns: "http://www.w3.org/2000/svg",
            viewBox: "0 0 80 50",
            fill: "none",
        ...
        function O(s) {
          const { year: n, theme: a } = s;
          return (0, t.jsx)("div", {
            className: (0, o.A)(r.Header, a.Header),
            children: (0, i.PP)(
              "#YIR_MM_Header",
              (0, t.jsx)("br", {}),
              (0, t.jsx)("div", {
                className: (0, o.A)(r.YearSubtitle, a.YearSubtitle),
                children: (0, i.we)("#date_year", n),
              }),
            ),
          });
        }
        function v(s) {
          return (0, t.jsx)("div", {
            className: (0, o.A)(r.Hashtag, s.theme.Hashtag),
            children: (0, i.we)("#YIR_MM_HashTag"),
          });
        }
        function T() {
          const n = (0, h.J)().GetTemplateVars();
          return (0, A.WN)(n.linkurl, P.cU.wY);
        }
      },
      1143: (c, u, e) => {
        "use strict";
        ...
        var t = e(90626),
          ...
          f = e(94595),
          B = e(62324);
        const i = { 2022: A, 2023: h, 2024: f, 2025: B },
          I = Object.values(i).reduce((d, o) => ({ ...d, ...o }), {}),
          r = 2022;
        function D(d) {
          const [o, P] = (0, t.useState)({});
          return (
            (0, t.useEffect)(() => {
              let p = i[d];
              p || (p = i[r]), P({ ...I, ...p });
