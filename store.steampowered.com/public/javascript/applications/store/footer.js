  ...
  (self.webpackChunkstore = self.webpackChunkstore || []).push([
    [21574],
    {
      84909: (R, D, t) => {
        ...
        function u(c) {
          const { children: x, ...a } = c,
            m = Q(a);
          return (0, n.jsx)(g.Provider, { value: m, children: x });
        }
        function A(c) {
          const { children: x } = c,
            a = o.Children.only(x),
          ...
          return a
            ? m
              ? (0, o.cloneElement)(a, {
                  ...m.getReferenceProps(a.props),
                  ref: (0, M.XB)(a.props.ref, m.floating.refs.setReference),
                })
              : (console.error(
        ...
        function B(c) {
          const { children: x, className: a, ref: m } = c,
            C = (0, o.useContext)(g),
            W = (0, p.SV)([
              m,
          ...
          let H = o.Children.only(x),
            F = o.Fragment;
          H.type == N.FocusManager &&
            ((H = o.Children.only(H.props.children)), (F = y));
          const I = (0, o.cloneElement)(H, {
            ref: W,
        ...
        function s(c) {
          ...
          const m = () => a.floating.context.onOpenChange(!1),
            C = o.useRef(void 0);
          return (
            (0, e.O7)(C, !!C.current, !1),
            (0, n.jsx)(S.D6, {
              navID: "Popover",
              onCancelButton: m,
              modal: !0,
              ...
              children: (0, n.jsx)("div", {
                ...
                children: (0, n.jsx)(j.q, { children: x }),
              }),
            })
          );
        }
        ...
        function Q(c) {
          ...
          const H = (0, p.we)({
              ...
              onOpenChange: a,
              middleware: K(c),
              whileElementsMounted: V.ll,
              placement: m && typeof m == "object" ? m.initial : m,
              strategy: "fixed",
              platform: {
                ...V.iD,
                getOffsetParent: (t1) =>
                  t1?.ownerDocument?.defaultView ?? window,
              },
            }),
            F = { enabled: !!C.click },
            I = typeof C.click == "function" ? C.click(F) : F,
            z = (0, p.kp)(H.context, I),
            T = { enabled: !!C.focus },
            Z = typeof C.focus == "function" ? C.focus(T) : T,
            w = (0, p.iQ)(H.context, Z),
            i = { handleClose: (0, p.iB)() },
            b = typeof C.hover == "function" ? C.hover(i) : i,
            h = (0, p.Mk)(H.context, { enabled: !!C.hover, ...b }),
            k = (0, p.s9)(H.context),
            { getFloatingProps: q, getReferenceProps: _ } = (0, p.bv)([
              z,
              w,
              h,
              k,
        ...
        function K(c) {
          const { gutter: x = 0, placement: a } = c,
            m = [],
            C = a && typeof a == "object";
          return (
            C && a.offset
              ? m.push((0, d.cY)(a.offset))
              : (!C || a.offset === void 0) && m.push((0, d.cY)(2)),
            C && a.flip
              ? m.push((0, d.UU)(a.flip))
              : (!C || a.flip === void 0) && m.push((0, d.UU)()),
            C && a.shift
              ? m.push((0, d.BN)(a.shift))
              : (!C || a.shift === void 0) && m.push((0, d.BN)()),
            m.push(
              (0, d.Ej)({
                apply: (W) => {
                  const { rects: H, elements: F, availableHeight: I } = W,
                    z = { boxSizing: "border-box", zIndex: "1" };
                  switch ((c.scroll && (z.overflowY = "auto"), c.width)) {
                    case "target": {
                      z.width = `${H.reference.width}px`;
                      break;
                    }
                    case "content": {
                      z.width = `${H.floating.width}px`;
                      break;
                    }
                    case "dropdown": {
                      let Z = H.reference.width;
                      H.floating.width > Z && Z < 200 && (Z = H.floating.width),
                        (z.width = `${Z}px`);
                    }
                  }
                  typeof c.width == "function" &&
                    (z.width = c.width({
                  ...
                  typeof c.maxHeight == "function"
                    ? (z.maxHeight = c.maxHeight({
                        unAvailableHeight: I,
                        gutter: T,
                      }))
                    : typeof c.maxHeight == "number"
                      ? (z.maxHeight = `min( calc( ${I}px - ${T} ), ${c.maxHeight}px )`)
                      : typeof x == "number"
                        ? (z.maxHeight = `${I - x}px`)
                        : (z.maxHeight = `calc( ${I}px - var(--spacing-${x}) )`),
                    Object.assign(F.floating.style, z),
        ...
        const N = { Root: u, Anchor: A, Positioner: B, FocusManager: y };
      },
      95994: (R, D, t) => {
        "use strict";
        t.d(D, { x: () => r });
        var n = t(7850),
          ...
          j = t(3166);
        function r(l) {
          const { as: L = "div", ref: E, focusable: g, navProps: u, ...A } = l,
            B = (0, j.Qn)(),
            y = (0, M.mz)({ ...A, className: V()(e.Grid, l.className) }, O),
            s = g ?? u?.focusable ?? !!A.onClick,
            U = (0, n.jsx)(L, { ref: E, ...y });
          return B
            ? (0, n.jsx)(o.J, {
                "flow-children": "grid",
        ...
        const O = [
          ...
          },
          {
            ...
            responsive: !0,
            className: e.Gap,
            cssProperty: (l) => ["--grid-gap", `var(--spacing-${l})`],
          },
          {
            prop: "gapX",
            responsive: !0,
            className: e.Gap,
            cssProperty: (l) => ["--grid-gap-x", `var(--spacing-${l})`],
          },
          {
            prop: "gapY",
            responsive: !0,
            className: e.Gap,
            cssProperty: (l) => ["--grid-gap-y", `var(--spacing-${l})`],
          },
        ];
      },
      57152: (R, D, t) => {
        ...
        var n = t(7850),
          ...
          M = t(90626);
        function e(u) {
          const { depth: A } = useContext(S);
          return jsx(S.Provider, {
            value: { depth: A + 1 },
            children: jsx(Box, { ...u }),
          });
        }
        const S = M.createContext({ depth: 0 });
        function j() {
          return (0, M.useContext)(S).depth;
        }
        var r = t(3877),
          O = t(64238),
          l = t.n(O);
        function L(u) {
          const { level: A = "auto", className: B, color: y } = u,
            s = j(),
            U = g(A, s);
          return (0, n.jsx)(U, {
            ...(0, d.mz)({ ...u, className: l()((0, r.T)(), o.Heading, B) }, E),
          });
        }
        const E = [
          ...V.U6,
          ...p.L,
          {
            prop: "size",
            responsive: !0,
            className: (u) => o[`HeadingSize-${u}`],
          },
        ];
        function g(u, A) {
          if (u === "auto" && A === 0) return "h1";
          const B = u === "auto" ? A.toString() : u;
          return /^[1-6]$/.test(B)
            ? "h" + B
            : u === "auto"
              ? (console.error(
                ...
                "h6")
              : (console.error(
                  `Attempt to render invalid heading level, "${B}".`,
                ),
                "h1");
        }
      },
      15252: (R, D, t) => {
        ...
        var n = t(7850),
          ...
          S = t.n(e);
        function j(l) {
          const { as: L = "span", ref: E, className: g, ...u } = l,
            A = L;
          return (0, n.jsx)(A, {
            ref: E,
            ...(0, p.mz)({ ...u, className: M()(e.Text, g) }, O),
          });
        }
        const r = [
            {
              ...
              cssProperty: (l) => ["--text-weight", `var(--font-weight-${l})`],
            },
            {
              prop: "align",
              responsive: !0,
            ...
            },
            {
              ...
              cssProperty: (l, L, E) => [
                "--text-color",
                (0, p.To)(l, (0, o.I)(L.contrast, E) ?? "body"),
              ],
            },
            {
              prop: "contrast",
              ...
              cssProperty: (l, L, E) => [
                "--text-color",
                (0, p.To)((0, o.I)(L.color, E) ?? "text-body", l),
              ],
            },
            { prop: "truncate", className: e.Truncate },
            {
              prop: "lineClamp",
              responsive: !0,
              className: e.LineClamp,
              cssProperty: "--line-clamp",
            },
            {
              prop: "whiteSpace",
              className: e.WhiteSpace,
      ...
      86336: (R, D, t) => {
        ...
        var n = t(7850),
          ...
          S = t(3166);
        function j(l) {
          const { underline: L = "auto", focusable: E, navProps: g, ...u } = l,
            A = (0, S.Qn)(),
            B = E ?? g?.focusable ?? !!u.href,
            y = (0, d.mz)({ ...u, underline: L, className: o.TextLink }, r);
          return A && (B || g)
            ? (0, n.jsx)(M.Ii, { ...y, ...(g || {}), focusable: B })
            : (0, n.jsx)("a", { ...y });
        }
        const r = [
          ...V.Ae,
          { prop: "underline", className: (l) => o[`Underline-${l}`] },
        ];
        function O(l) {
          const { underline: L = "auto", focusable: E, navProps: g, ...u } = l,
            A = (0, S.Qn)(),
            B = E ?? g?.focusable ?? !!u.onClick,
            y = (0, n.jsx)("span", {
              role: "button",
              ...(0, d.mz)(
                { ...u, underline: L, className: o.TextLinkButton },
                r,
              ),
            });
          return A && (B || g)
            ? (0, n.jsx)(e.J, { ...(g || {}), focusable: B, children: y })
            : y;
        }
      },
      10566: (R, D, t) => {
        "use strict";
        t.r(D), t.d(D, { GlobalFooter: () => a1 });
        var n = t(7850),
          o = t(68031),
          p = t(57152),
          V = t(86336),
        ...
        function u(f = !1) {
          const P = [];
          return (
            E() ? P.push("force_desktop") : P.push("responsive"),
            (g() || f) && P.push("touch"),
            P.join(" ")
          );
        }
        ...
        function y() {
          E() && (0, l.Y1)(L.k1), "location" in window && location.reload();
        }
        var s = t(72609),
          U = t(72865),
          Q = t(64238),
        ...
        function C(f) {
          const {
            ...
            [h1, e1] = (0, N.useState)(!1),
            u1 = (J) => {
              ((0, m.p)() && !J) || e1(J);
            },
            d1 = (J) => {
              let n1 = { ...J, delay: { open: Y, close: 0 } };
              return c1 && (n1 = { ...n1, handleClose: null }), n1;
            };
          return (0, n.jsxs)(a.A.Root, {
            open: h1,
            onOpenChange: e1,
            interactions: { hover: d1 },
            ...C1,
            children: [
              (0, n.jsx)(a.A.Anchor, { children: P }),
              (0, n.jsx)(a.A.Positioner, {
                children: (0, n.jsx)(x.az, { children: G }),
              }),
            ],
          });
        }
	...
	c1.3,0,2.6,0,4,0c0,0.7,0,1.4,0,2.1c-1.3,0-2.6,0-4,0c0,0.8,0,1.6,0,2.4c1.4,0,4.3,0,4.3,0v2.1h-6.7V5.8h6.7V7.8z`,
        ...
        function T(f) {
          ...
          const Y = (0, U.n9)();
          return (
            P?.startsWith(s.TS.STORE_BASE_URL) && (P = (0, U.bV)(Y, P)),
            (0, n.jsx)(V.Y, {
              href: P,
              color: "dull-11",
              target: "_blank",
        ...
        function Z(f) {
          const P = (0, d.xC)();
          return P === "initial" || P === "sm"
            ? null
            : (0, n.jsx)("footer", {
                className: K()(H().SteamChinaFooter, f.className),
                children: (0, n.jsxs)(x.az, {
                      ...
                      children: [
                        ...
                        (0, n.jsxs)(x.az, {
                          ...
                          children: [
                            ...
                            "\xA0 | \xA0",
                            (0, n.jsx)(T, {
                              href: s.TS.STORE_BASE_URL + "steam_refunds",
                              children: "\u9000\u6B3E\u653F\u7B56",
                            }),
                            "\xA0 | \xA0",
                            (0, n.jsx)(T, {
                              href:
                                s.TS.STORE_BASE_URL + "subscriber_agreement",
                              children:
                                "\u8F6F\u4EF6\u8BB8\u53EF\u670D\u52A1\u534F\u8BAE",
                            }),
                            "\xA0 | \xA0",
                            ...
                            "\xA0 | \xA0",
                            (0, n.jsx)(T, {
                              href: s.TS.STORE_BASE_URL + "data_outbound",
                              children:
                                "\u4E2A\u4EBA\u4FE1\u606F\u51FA\u5883\u544A\u77E5\u4E66",
                            }),
                            "\xA0 | \xA0",
        ...
        var w = t(31275);
        const i = {};
        (i.arabic = () => t.e(42560).then(t.t.bind(t, 42560, 19))),
          (i.brazilian = () => t.e(37442).then(t.t.bind(t, 37442, 19))),
          (i.bulgarian = () => t.e(39945).then(t.t.bind(t, 39945, 19))),
          (i.czech = () => t.e(55059).then(t.t.bind(t, 55059, 19))),
          (i.danish = () => t.e(19605).then(t.t.bind(t, 19605, 19))),
          (i.dutch = () => t.e(13366).then(t.t.bind(t, 13366, 19))),
          (i.english = () => t.e(74468).then(t.t.bind(t, 74468, 19))),
          (i.finnish = () => t.e(31655).then(t.t.bind(t, 31655, 19))),
          (i.french = () => t.e(21580).then(t.t.bind(t, 21580, 19))),
          (i.german = () => t.e(5666).then(t.t.bind(t, 5666, 19))),
          (i.greek = () => t.e(22936).then(t.t.bind(t, 22936, 19))),
          (i.hungarian = () => t.e(52173).then(t.t.bind(t, 52173, 19))),
          (i.indonesian = () => t.e(80412).then(t.t.bind(t, 80412, 19))),
          (i.italian = () => t.e(29468).then(t.t.bind(t, 29468, 19))),
          (i.japanese = () => t.e(52811).then(t.t.bind(t, 52811, 19))),
          (i.koreana = () => t.e(76139).then(t.t.bind(t, 76139, 19))),
          (i.latam = () => t.e(77267).then(t.t.bind(t, 77267, 19))),
          (i.malay = () => t.e(88844).then(t.t.bind(t, 88844, 19))),
          (i.norwegian = () => t.e(85964).then(t.t.bind(t, 85964, 19))),
          (i.polish = () => t.e(26509).then(t.t.bind(t, 26509, 19))),
          (i.portuguese = () => t.e(58233).then(t.t.bind(t, 58233, 19))),
          (i.romanian = () => t.e(48727).then(t.t.bind(t, 48727, 19))),
          (i.russian = () => t.e(98973).then(t.t.bind(t, 98973, 19))),
          (i.schinese = () => t.e(49720).then(t.t.bind(t, 49720, 19))),
          (i.spanish = () => t.e(31924).then(t.t.bind(t, 31924, 19))),
          (i.swedish = () => t.e(17925).then(t.t.bind(t, 17925, 19))),
          (i.tchinese = () => t.e(89259).then(t.t.bind(t, 89259, 19))),
          (i.thai = () => t.e(25474).then(t.t.bind(t, 25474, 19))),
          (i.turkish = () => t.e(12164).then(t.t.bind(t, 12164, 19))),
          (i.ukrainian = () => t.e(52626).then(t.t.bind(t, 52626, 19))),
          (i.vietnamese = () => t.e(66515).then(t.t.bind(t, 66515, 19)));
        async function b(f) {
          if (i[f]) return i[f]();
        }
        const h = (0, w.l)(b);
        ...
        function $(f) {
          return (0, n.jsx)(o.s, { direction: "column", gap: "4", ...f });
        }
        function X(f) {
          return (0, n.jsx)(p.D, {
            level: "3",
          ...
          return (
            ...
            (0, n.jsx)(S.N, {
              ...
              children: (0, n.jsxs)(j.x, {
                ...
                className: K()(c.GlobalFooter, f.className),
                ...
                children: [
                  ...
                  (0, n.jsxs)($, {
                    ...
                    children: [
                      ...
                      (0, n.jsx)(v, {
                        href: s.TS.STORE_BASE_URL + "subscriber_agreement/",
                        children: h.Localize("#footer_link_steam_ssa"),
                      }),
                      (0, n.jsx)(v, {
                        href: s.TS.PARTNER_BASE_URL,
                        children: h.Localize("#footer_link_steamworks"),
                      }),
                      (0, n.jsx)(v, {
                        href: s.TS.PARTNER_BASE_URL + "steamdirect",
                  ...
                  (0, n.jsxs)($, {
                    ...
                    children: [
                      ...
                      (0, n.jsx)(v, {
                        href: s.TS.STORE_BASE_URL + "hardware/",
                        children: h.Localize("#footer_link_hardware"),
                      }),
                      (0, n.jsx)(v, {
                        href: s.TS.STORE_BASE_URL + "hardware_recycling/",
                  ...
                  (0, n.jsxs)($, {
                    ...
                    children: [
                      ...
                      (0, n.jsx)(v, {
                        href: s.TS.STORE_BASE_URL + "legal/",
                        children: h.Localize(
                      ...
                      (0, n.jsx)(v, {
                        href:
                          s.TS.STORE_BASE_URL + "account/cookiepreferences/",
        ...
        function a1(f) {
          if ((0, k.Qn)()) return null;
          const P = (0, r.nA)(s.TS.EREALM)
            ? (0, n.jsx)(Z, { ...f })
            : (0, n.jsx)(r1, { ...f });
          return (0, n.jsx)(U.nn, {
            controller: "footer",
      ...
      79014: (R, D, t) => {
        ...
        function o(V, ...d) {
          ...
          let S = 0,
            j;
          for (; (j = e.exec(V)); ) {
            (S += j[0].length), M.push(j[1]);
            const r = parseInt(j[2]),
              O = j[3] || "",
              l = o(O, ...d),
              E = (r >= 1 && r <= d.length ? d[r - 1] : null)
                ? n.cloneElement(d[r - 1], {}, O ? l : null)
                : O;
            M.push(E);
          }
          return M.push(V.substr(S)), n.createElement(n.Fragment, null, ...M);
        }
        function p(V, d = ["b", "i", "br"]) {
          const M = d.join("|"),
            e = [],
            S = new RegExp(
          ...
          for (; (r = S.exec(V)); ) {
            ...
            if (!r.groups?.endtag) {
              const g = r.groups.before.length + r.groups.tagname.length + 2;
              (j += g), (S.lastIndex = r.index + g), e.push(r.groups.before);
              const u = r[2],
                A = n.createElement(u);
              e.push(A);
              continue;
            }
            (j += r[0].length), e.push(r.groups.before);
            const O = r.groups.tagname,
              l = r.groups.contents || "";
            let L = null;
            l && (L = p(l, d));
            const E = n.createElement(O, {}, L);
            e.push(E);
          }
          return e.push(V.slice(j)), n.createElement(n.Fragment, null, ...e);
        }
      },
      75180: (R) => {
        R.exports = {
