...
(self.webpackChunkstore = self.webpackChunkstore || []).push([
  [3384],
  {
    ...
    44165: (e, s, t) => {
      ...
      const o = new c();
      window.g_EventCalendarDevFeatures = o;
      const d = new Date(),
        j = Math.floor(d.getTime() / 1e3);
      function _() {
        return o.nOverrideDateNow ?? j;
      }
      function m() {
        return l.useMemo(() => _(), []);
      }
      function f() {
        return l.useMemo(() => o.GetTimeNowWithOverrideAsDate(), []);
      }
    },
    55263: (e, s, t) => {
      "use strict";
