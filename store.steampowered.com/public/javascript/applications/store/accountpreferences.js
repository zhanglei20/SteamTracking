...
(self.webpackChunkstore = self.webpackChunkstore || []).push([
  [2634],
  {
    ...
    44165: (e, t, s) => {
      ...
      (0, r.Cg)([a.sH], l.prototype, "nOverrideDateNow", void 0);
      const d = new l();
        ...
        loadPersonaState: async (e, t) => {
          ...
          return (function (e, t) {
            ...
            const r = t?.public_data,
              a = t?.private_data;
            (s.m_bInitialized = !!t),
              (s.m_ePersonaState = a?.persona_state ?? n.cU3),
              (s.m_strAvatarHash = r?.sha_digest_avatar
                ? (0, o.Kx)(r.sha_digest_avatar)
                : l.dV),
              (s.m_strPlayerName = r?.persona_name ?? e.ConvertTo64BitString()),
              (s.m_strAccountName = a?.account_name),
              a?.persona_state_flags &&
                (s.m_unPersonaStateFlags = a?.persona_state_flags);
            a?.game_id && (s.m_gameid = a?.game_id);
            a?.game_server_ip_address &&
              (s.m_unGameServerIP = a?.game_server_ip_address);
            a?.lobby_steam_id && (s.m_game_lobby_id = a?.lobby_steam_id);
            a?.game_extra_info && (s.m_strGameExtraInfo = a?.game_extra_info);
            r?.profile_url && (s.m_strProfileURL = r.profile_url);
            return s;
        ...
        return (0, c.I)({
          ...
          queryFn: async () => {
            if (n.iA.logged_in) {
              ...
              return n.Body()?.toObject().results ?? [];
            }
            return [];
          },
          staleTime: 6e5,
        ...
        return (
          (0, a.useEffect)(() => {
            if (
              ...
              m.naturalWidth / m.naturalHeight < _ && s(!0);
            }
          }, [m]),
          t
            ? (0, r.jsxs)("span", {
    ...
    2489: (e, t, s) => {
      ...
      class h {
        ...
        constructor(e) {
          (0, c.Gn)(this),
            ...
            (this.m_Preferences.preference_state != d.CY.__ &&
              this.m_Preferences.preference_state != d.CY.PK) ||
            ...
            this.m_Preferences.version == d.ie.CL &&
              (this.m_Preferences.version = d.ie.mO);
        }
        GetVersion() {
        ...
        BIsRejectAll() {
          return this.m_Preferences.preference_state == d.CY.rE;
        }
        ...
        ProcessToggle() {
          (this.m_Preferences.preference_state = d.CY.UI),
            this.PostCookieSettings();
        }
        ...
        async PostStorePreferences() {
          ...
          try {
            ...
            200 != s.status || s?.data?.success != o.R
              ? window.ShowAlertDialog(
                  (0, m.we)("#DataCollectionPref_Error"),
                  (0, m.we)("#DataCollectionPref_ErrorNotSaved"),
                )
              : o.R;
          } catch (e) {
            0,
      ...
      class k {
        ...
        static Get() {
          return (
            k.s_AccountSavedHardwareStore ||
              ((k.s_AccountSavedHardwareStore = new k()),
              k.s_AccountSavedHardwareStore.Init()),
            k.s_AccountSavedHardwareStore
          );
        }
        Init() {
        ...
        async PostRequest(e, t) {
          try {
            ...
            return (
              (200 == s.status && s?.data?.success == o.R) ||
              (window.ShowAlertDialog(
                (0, m.we)("#SavedHardware_Error_Title"),
                (0, m.we)("#SavedHardware_Error_Desc"),
              ),
              !1)
            );
          } catch (e) {
      ...
      function C(e) {
        ...
        return (0, r.jsx)(D.o0, {
          ...
          onCancel: s,
          onOK: i,
          strOKButtonText: (0, m.we)("#SavedHardware_Delete"),
          children: (0, m.we)(
      ...
      const E = (0, P.PA)((e) => {
          ...
          switch (t.system_info.gaming_device_type) {
            case y.LS$:
              s = (0, m.we)("#HardwareVariant_SteamDeck");
              break;
            case y.ppM:
              s = (0, m.we)("#HardwareVariant_LegionGoS");
              break;
            case y.bOm:
                    ...
                    children: [
                      ...
                      (0, r.jsxs)("div", {
                        children: [
                          ...
                          " - ",
                          (0, N.dm)(1024 * t.system_info.vram_size * 1024, 0),
                        ],
                      }),
                    ],
                  }),
                  ...
                  (0, r.jsxs)(j.Z, {
                    ...
                    children: [
                      ...
                      (0, r.jsx)(w.ml, {
                        ...
                        onClick: s,
                        children: (0, m.we)("#CookiePref_AcceptAll"),
                      }),
                    ],
                  }),
                  (0, r.jsx)(H, { settings: e }),
                  (0, r.jsx)(z, { settings: e }),
      ...
      function re(e) {
        ...
        return (
          s.isSuccess &&
            (a = s.data
              .filter((e) => e.status === X.b1.fm || e.status === X.b1.T5)
              .map((e) => {
                switch (e.status) {
                  case X.b1.T5:
        ...
        return (0, r.jsxs)("div", {
          ...
          children: [
            ...
            !l.TS.IN_MOBILE_WEBVIEW &&
              (0, r.jsx)("div", {
                className: V().StatusCtn,
                children: (0, r.jsx)(j.Z, {
                  className: V().Buttons,
                  children: (0, r.jsx)(p.jn, {
                    className: V().WideButton,
                    noFocusRing: !1,
                    onClick: c,
                    children: (0, m.we)("#PlaytestInvites_ViewLibrary"),
                  }),
                }),
              }),
          ],
      ...
      function ne(e) {
        ...
        let i = t?.GetDeveloperNames()?.length
          ...
          n = t?.GetStorePageURL(),
          c = (0, r.jsx)("img", {
            className: V().SmallCap,
            src: t?.GetAssets().GetSmallCapsuleURL() ?? se.A,
          });
        return (
          1422450 == a && (i = "Valve"),
          (0, r.jsxs)("div", {
            className: V().AppInfoCtn,
            children: [
              n ? (0, r.jsxs)(w.Ii, { href: n, children: [" ", c, " "] }) : c,
              (0, r.jsxs)("div", {
                className: V().AppDescription,
                children: [
                  (0, r.jsx)("div", { className: V().AppName, children: s }),
                  i &&
                    (0, r.jsx)("div", {
                      className: V().AppDetail,
      ...
      function oe(e) {
        const { steamIDInviter: t } = e,
          s = (0, q.js)(t.ConvertTo64BitString()),
          a = s?.data;
        return s.isSuccess
          ? (0, r.jsxs)("div", {
              className: (0, g.A)(V().AvatarAndPersona, V().InviteDescription),
              children: [
                (0, r.jsx)(K.i8, {
                  persona: a,
                  size: "Small",
      ...
      class he {
        ...
        static Get() {
          return (
            he.s_AuthorizedDevicesStore ||
              ((he.s_AuthorizedDevicesStore = new he()),
              he.s_AuthorizedDevicesStore.Init()),
            he.s_AuthorizedDevicesStore
          );
        }
        Init() {
      ...
      (0, n.Cg)([c.sH], he.prototype, "m_rgActiveDevices", void 0),
        (0, n.Cg)([c.sH], he.prototype, "m_rgRevokedDevices", void 0);
      var ve = s(4869),
        pe = s(26296);
      const fe =
          s.p +
      ...
      const Ae = (0, v.PA)(() => {
        ...
        switch (i.steamguard_scheme) {
          default:
          case we.k_ETwoFactorTokenSteamguardScheme_None:
            n = "#accountpreferences_revoked_devices_revoked_description";
            break;
          case we.k_ETwoFactorTokenSteamguardScheme_Email:
            n = "#accountpreferences_revoked_devices_revoked_description_email";
            break;
          case we.k_ETwoFactorTokenSteamguardScheme_TwoFactor:
        ...
        return (0, r.jsxs)(r.Fragment, {
          children: [
            ...
            (0, r.jsxs)("div", {
              ...
              children: [
                (0, r.jsx)("div", {
                  className: Ce.SectionDescription,
                  children: (0, m.PP)(
                ...
                (0, r.jsxs)("div", {
                  className: Ce.AuthorizedDeviceGroup,
                  children: [
                    (0, r.jsx)(Ee, {
                      elHeader: (0, r.jsxs)("div", {
                        className: Ce.ActiveNow,
                        children: [
                          (0, r.jsx)(Ne.jlt, { className: Ce.ActiveNowDot }),
                          (0, m.we)(
                    ...
                    (0, r.jsx)("div", {
                      className: Ce.DeviceGroup,
                      children: (0, r.jsx)("div", {
                        className: Ce.RemoveDevicesRow,
      ...
      function Re(e) {
        ...
        f =
          v.country && n && n != v.country
            ? (0, r.jsx)(Pe.he, {
                ...
                direction: "top",
                children: (0, r.jsxs)("div", {
                  className: Ce.LocationSuspicious,
                  children: [v.location, (0, r.jsx)(ve.$$j, {})],
                }),
              })
            : (0, r.jsx)("div", {
                className: Ce.LocationNotSuspicious,
                children: v.location,
              });
        ...
        return (0, r.jsxs)(
          j.Z,
          {
            className: (0, g.A)(Ce.DeviceContainer, s && Ce.ActiveDevice, c),
            navRef: u,
            onActivate: () => _(!d),
            children: [
              ...
              (0, r.jsxs)("div", {
                ...
                children: [
                  (0, r.jsxs)("div", {
                    className: Ce.DeviceHeaderRow,
                    children: [
                      (0, r.jsxs)("div", {
                        className: Ce.DeviceNameContainer,
                        children: [
                          (0, r.jsxs)("div", {
                            className: Ce.DeviceName,
                            children: [(0, r.jsx)(Ue, { device: t }), h],
                          }),
                          i &&
                            (0, r.jsx)("div", {
                              className: Ce.ThisDevice,
                              children: (0, m.we)(
                      ...
                      (0, r.jsxs)("div", {
                        className: Ce.DetailsToggleContainer,
                        children: [
                          f,
                          (0, r.jsx)("div", {
                            className: Ce.DetailsToggle,
                            children: (0, r.jsx)(p.wl, {
                              className: (0, g.A)({
                                [Ce.DetailsToggle]: !0,
                                [Ce.Selected]: d,
                              }),
                              children: (0, r.jsx)(ve.b8_, {
                                direction: "down",
                              }),
                            }),
                          }),
      ...
      function Le(e) {
        const { device: t } = e;
        return (0, r.jsx)("div", {
          className: Ce.AuthorizedDeviceDetails,
          children: (0, m.we)(
            Be(t),
      ...
      function Me(e) {
        ...
        if (t.platform_type == xe.SS.tS)
          ...
          i = a
            ...
            : (0, r.jsx)(ve.oEi, { className: Ce.DeviceLogo });
        return s
          ? (0, r.jsxs)("div", {
              className: Ce.DeviceLogoBoundingBox,
              children: [
                i,
                (0, r.jsx)("img", {
                  src: ge,
                  className: Ce.DeviceSteamGuardLogo,
                }),
              ],
            })
          : i;
      ...
      function qe(e) {
        return (0, r.jsxs)("div", {
          children: [(0, r.jsx)(Ye, {}), (0, r.jsx)(Ae, {})],
        });
      }
      function Ye(e) {
        ...
        return (0, r.jsxs)(r.Fragment, {
          children: [
            (0, r.jsx)("div", {
              ...
              children: (0, r.jsxs)("div", {
                children: [
                  (0, r.jsx)(ve.iSZ, { className: Ke.HeaderIcon }),
            ...
            (0, r.jsxs)("div", {
              ...
              children: [
                ...
                a
                  ...
                  : (0, r.jsx)(Xe, { strFaqUrl: t }),
                (0, r.jsxs)("div", {
                  className: Ke.AccountDetailsCtn,
                  children: [
                    (0, r.jsx)(Je, {}),
                    (0, r.jsx)("div", { className: Ke.Divider }),
                    (0, r.jsx)(et, {}),
                    (0, r.jsx)(Ze, {
                      msgTwoFactorStatus: s.GetTwoFactorStatus(),
                    }),
      ...
      function $e(e) {
        ...
        return (
          ...
          (0, r.jsxs)("div", {
            children: [
              (0, r.jsxs)("div", {
                className: Ke.SteamGuardStatusHeader,
                children: [
                  (0, r.jsx)("img", { className: Ke.SteamGuardLogo, src: ge }),
                  (0, r.jsx)("div", {
              ...
              (0, r.jsxs)("div", {
                className: Ke.SteamGuardStatusBody,
                children: [
                  !!o &&
                    (0, r.jsxs)(r.Fragment, {
                      children: [
                  ...
                  (0, r.jsxs)("div", {
                    className: Ke.SteamGuardActionsCtn,
                    children: [
                      (0, r.jsx)(rt, {
                        strLabel: (0, m.we)(
      ...
      function Xe(e) {
        ...
        return (0, r.jsxs)("div", {
          className: Ke.NoSteamGuardCtn,
          children: [
            (0, r.jsxs)("div", {
              className: Ke.SteamGuardStatusHeader,
              children: [
                (0, r.jsx)("img", { className: Ke.SteamGuardLogo, src: fe }),
                (0, r.jsx)("div", {
                  className: Ke.HeaderText,
                  children: (0, m.we)(
            ...
            (0, r.jsx)("div", { className: Ke.Divider }),
            (0, r.jsxs)("div", {
              className: Ke.NoSteamGuardBody,
              children: [
                (0, r.jsxs)("div", {
                  className: Ke.QROuterCtn,
                  children: [
                    (0, r.jsxs)("div", {
                      className: Ke.GetMobileAppCtn,
                      children: [
                        (0, r.jsx)("div", {
                          className: Ke.GetMobileAppText,
                          children: (0, m.oW)(
                    ...
                    (0, r.jsx)("img", { src: je, className: Ke.QRCode }),
                  ],
                }),
                (0, r.jsxs)("div", {
                  className: Ke.MobileAppLinksCtn,
                  children: [
                    (0, r.jsx)("div", {
                      children: (0, m.we)(
                      ...
                      children: [
                        ...
                        (0, r.jsx)(w.Ii, {
                          ...
                          children: (0, r.jsx)(pe.o, {
                            ...
                            className: Ke.GooglePlayStoreImg,
                          }),
                        }),
                      ],
                    }),
      ...
      function Je(e) {
        ...
        return (0, r.jsxs)("div", {
          className: Ke.AccountDetailsSubBlock,
          children: [
            (0, r.jsx)(st, {
              strLabel: (0, m.we)(
      ...
      function et(e) {
        const t = he.Get();
        let s = (0, m.we)("#accountpreferences_account_security_phone_none");
        return (
          t.GetPhoneHint() &&
            (s = (0, m.we)(
      ...
      function st(e) {
        ...
        return (0, r.jsxs)("div", {
          children: [
            (0, r.jsx)("span", {
              className: Ke.AccountDetailLabel,
              children: t,
            }),
      ...
      function rt(e) {
        ...
        return (0, r.jsx)("div", {
          children: (0, r.jsx)(w.Ii, {
            className: Ke.AccountActionButton,
            href: s,
            target: a,
            children: t,
          }),
