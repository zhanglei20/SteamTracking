  ...
  [1446],
  {
    ...
    78588: (e, t, a) => {
      ...
      function u(e) {
        ...
        if ("library" === a || "vertical" == a)
          return (0, r.jsx)(i.G, { id: t, bPreferAssetWithoutOverride: o });
        let C = "";
    ...
    8893: (e, t, a) => {
      ...
      function h(e) {
        const { id: t, bPreferLibrary: a, bPreferAssetWithoutOverride: l } = e,
          { storeItemDefaultInfo: p, storeItemAsset: h } = (0, i.q)(
            t,
            "vertical",
            l,
          ),
        ...
        const { strStoreVerticalURL: _, strLibraryVerticalURL: v } = (0, m.M)(
          h,
          p,
        );
        if (_ && (!a || !v))
    ...
    94191: (e, t, a) => {
      ...
      function j(e) {
        const { appids: t, hide_status_banners: a, show_early_access: n } = e,
          { data: c } = (0, C.$Y)(),
          { data: o } = (0, h.F0)(),
          x = t.length > 0 && t.every((e) => c && c.has(e)),
              ...
              (0, m.useEffect)(() => {
                ...
                (async () => {
                  const a = await Promise.all(
                    e
                      .filter((e) => !!e)
                      .map((e) => s.fetchQuery((0, u.us)(i, { appid: e }))),
                  );
                  r(
                    a.some(
                      (e) =>
          ...
          S = !a && n;
        return (0, r.jsxs)("div", {
          className: (0, g.A)(_().CapsuleDecorators, "CapsuleDecorators"),
          children: [
            b &&
              (0, r.jsxs)("span", {
                className: (0, g.A)(_().Banner, _().Blue),
                children: [
                  (0, r.jsx)("img", {
                    src: (0, s.YJ)(f),
            ...
            A &&
              (0, r.jsxs)("span", {
                className: _().Banner,
                children: [
                  (0, r.jsx)(v.qnF, { className: _().LinesImg }),
                  i.Z.Localize("#Sale_OnWishlist"),
                ],
              }),
            S && !b && !A && (0, r.jsx)(y, { appids: t }),
            L && (0, r.jsx)(w.K, {}),
          ],
        });
      }
      function y(e) {
        ...
        return a
          ? (0, r.jsx)("span", {
              className: (0, g.A)(_().Banner, _().EarlyAccessGradient),
    ...
    72860: (e, t, a) => {
      ...
      function d(e, t, a, d, u, m) {
        ...
        const p = (0, i.wJ)(`${(0, s._)(e, d)}${u ? `?${u}` : ""}`, t);
        return {
          onClick: (e) => {
    ...
    70300: (e, t, a) => {
      ...
      const l = (e) => {
        ...
        return t ? (0, r.jsx)(i.A, { appID: t, children: a }) : a;
      };
    },
    2240: (e, t, a) => {
      "use strict";
      ...
      function v(e) {
        const { id: t, ...a } = e,
          { data: s } = (0, o.qI)(t);
        return (0, r.jsx)(g, { ...a, platforms: s });
      }
      m.memo(function (e) {
        const { platforms: t } = e;
        if (!t) return null;
        const { windows: a, mac: s, steamos_linux: i, vr_support: n } = t;
        ...
        if (a == _.c9) {
          ...
          switch (e) {
            ...
            case h.xs:
              ...
              break;
            default:
              return (0, x.z_)(e, `Unhandled steam os category: ${e}`), null;
          }
        } else {
          let e;
          if (
          ...
          switch (e) {
            ...
            case f.YX:
              ...
              break;
            default:
              return (0, x.z_)(e, `Unhandled deck compat category: ${e}`), null;
          }
        }
        return (0, r.jsxs)("span", {
          className: u()(
          ...
          children: [
            Boolean(a == _.ZJ) && (0, r.jsx)(Z, {}),
            Boolean(a == _.JR) && (0, r.jsx)(k, {}),
            Boolean(a == _.bY) && (0, r.jsx)(D, {}),
            (0, r.jsx)(i, {}),
          ],
        });
      });
      ...
      function G(e) {
        ...
        return (0, n.Qn)() || t ? (0, r.jsx)(H, { ...e }) : null;
      }
      function H(e) {
        ...
        return (
          c == _.iA && (d = _.ZJ),
          a
            ? (c == _.bY && (o = l.CompatIconFrame),
              (0, r.jsx)("div", {
                className: (0, i.A)(l.CompatIcon, o, t),
                children: (0, r.jsx)(v, { id: a, eHWCompat: d }),
              }))
            : null
        );
      }
