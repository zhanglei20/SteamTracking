  ...
  [76226],
  {
    96873: (e, t, r) => {
      ...
      class y extends p.Message {
        ...
        constructor(e = null) {
          super(),
            y.prototype.protocol_version || b.Sg(y.M()),
            p.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class h extends p.Message {
        ...
        constructor(e = null) {
          super(),
            h.prototype.package_version || b.Sg(h.M()),
      ...
      class C extends p.Message {
        ...
        constructor(e = null) {
          super(),
            C.prototype.client_info || b.Sg(C.M()),
            p.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
        static M() {
          return (
            C.sm_m ||
              (C.sm_m = { proto: C, fields: { client_info: { n: 1, c: h } } }),
            C.sm_m
          );
        }
        static MBF() {
        ...
        return (0, s.I)({
          ...
          queryFn: async () => {
            ...
            for (const e of r.Body().sessions())
              e.device_type() !== u.eSB && n.push(e.toObject());
            return {
              sessions: n,
      ...
      function Q(e, t = !0) {
        const r = $(),
          ...
          s = (0, m.LH)(),
          o = (e) => {
            t && ((e.result != c.Dy && e.result != c._3) || r.refetch());
          },
          u = (0, a.E)({
            queries: (r.data?.sessions || []).map((e) => ({
              queryKey: K(s, e.client_instanceid, "none"),
              queryFn: async () => H(i, e, "none"),
              staletime: 36e5,
              refetchInterval: (e) =>
          ...
          B = (0, a.E)({
            queries: (r.data?.sessions || []).map((e, r) => ({
              queryKey: K(s, e.client_instanceid, "changing"),
              queryFn: async () =>
                (async function (e, t, r, i) {
                  if (!i) return;
                  const n = await H(e, t, r);
        ...
        return {
          ...
          refetch: () => {
            for (const e of r.data?.sessions || []) {
              const t = K(s, e.client_instanceid, "changing");
      ...
      function X(e, t, r) {
        ...
        return (0, o.n)({
          mutationFn: async () => {
            ...
            const l = await i.InstallClientApp(n, r);
            if (l.GetEResult() != c.R)
              throw (
                (console.error(
            ...
            const o = s?.data;
            o && o.get(t) && o.get(t).app.SetDownloading(),
              u.setQueryData(V(a, e), o),
              s.refetch();
          },
          onSuccess: r,
        });
