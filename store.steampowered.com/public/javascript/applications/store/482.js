  ...
  [482],
  {
    ...
    63556: (e, t, n) => {
      ...
      var s = n(34629),
        ...
        h = n(91986);
      class p {
        m_eCurLang = (0, a.sf)(c.TS.LANGUAGE);
      ...
      (0, s.Cg)([o.sH], p.prototype, "m_eCurLang", void 0),
        (0, s.Cg)([o.sH], p.prototype, "m_rgHasData", void 0),
        (0, s.Cg)([o.sH], p.prototype, "m_bHasLocalizationContext", void 0),
        (0, s.Cg)([l.o], p.prototype, "GetCurEditLanguage", null),
        (0, s.Cg)([l.o], p.prototype, "SetCurEditLanguage", null),
        (0, s.Cg)([o.XI.bound], p.prototype, "SetHasLanguage", null),
    ...
    29347: (e, t, n) => {
      ...
      const d = (e) => {
          const { clanSteamID: t, fnImageSelectCallBack: n } = e,
            [d, g] = (0, o.useState)(""),
            m = (0, r.mr)(e.clanSteamID.GetAccountID()),
            S = () => e.closeModal && e.closeModal(),
            C = r.pU.GetFilteredClanImages(t, d),
            x = (e) => {
              n(e), S();
            };
          return (0, s.jsx)(i.tH, {
            children: (0, s.jsx)(l.x_, {
              onEscKeypress: S,
              children: (0, s.jsxs)(a.UC, {
                children: [
                  (0, s.jsx)(a.Y9, {
                    children: (0, c.we)("#ClanImageChooser_Title"),
                  }),
                  (0, s.jsx)(a.nB, {
                    children: (0, s.jsxs)(a.a3, {
                      children: [
                        (0, s.jsx)("p", {
        ...
        u = (e) => {
          ...
          let r = t.file_name ? t.file_name : "",
            a = g(n, r, String(t.imageid), p.Hilight);
          return (0, s.jsxs)("div", {
          ...
          for (let i = 0; i < t.length; ) {
            ...
            i < l &&
              ...
              r.push(
                (0, s.jsx)(
                  "span",
                  { className: o, children: t.substr(l, e.length) },
                  n + "_" + String(i),
                ),
              ),
              (i = l + e.length);
          }
        } else r.push((0, s.jsx)("span", { children: t }, n + "_null"));
        return r;
      }
    },
    1909: (e, t, n) => {
        ...
        GenerateLanguageOptions() {
          ...
          for (const e of d.A0.GetLanguageListForRealms(c)) {
            ...
            const n = (0, i.Lg)(e),
              ...
              o = Boolean(r) && r(e);
            a.push({ eLang: e, sLocName: s, bSupported: o });
          }
          a.sort((e, t) =>
    ...
    20482: (e, t, n) => {
      ...
      const D = (e) => {
        ...
        return (0, o.jsxs)("div", {
          children: [
            (0, o.jsxs)("div", {
              className: (0, h.A)(l().FlexRowContainer, T().linkField),
              onClick: (e) => {
                t.current &&
              ...
              children: [
                ...
                document.queryCommandSupported("copy") &&
                  (0, o.jsx)("div", {
                    className: (0, h.A)(l().Button, l().Icon, T().LinkButton),
                    title: (0, p.we)("#ToolTip_CopyLinkToClipboard"),
                    children: (0, o.jsx)(x.he, {
      ...
      (0, s.Cg)([d.oI], _.prototype, "ShareOnSteamActivityFeed", null);
      const w = (e) => {
        const {
            eventLink: t,
            sharePageUrls: n,
          ...
          i = (0, u.Y2)(),
          [c, d] = (0, r.useState)((0, a.sf)(u.TS.LANGUAGE)),
          C = (0, r.useMemo)(() => {
            const e = new URL(t);
            return e.searchParams.set("l", (0, a.Lg)(c)), e.href;
          }, [c, t]);
        return (0, o.jsxs)("div", {
          className: (0, h.A)(l().FlexColumnContainer, T().share_controls_ctn),
          children: [
            !i &&
              (0, o.jsxs)(o.Fragment, {
                children: [
    ...
    73067: (e, t, n) => {
      ...
      class j extends i.Component {
        ...
        constructor(e) {
          super(e),
            (this.m_hMobxSearchDisposer = (0, T.fm)(async () => {
        ...
        render() {
          ...
          return (0, s.jsx)("div", {
            className: A().mentionDialogPosition,
            ref: this.containerRef,
            children: (0, s.jsxs)("div", {
              className: A().mentionDialog,
              tabIndex: 0,
      ...
      (0, u.Cg)([x.oI], j.prototype, "OnKeyDown", null),
        (0, u.Cg)([x.oI], j.prototype, "OnClickSuggestion", null),
        (0, u.Cg)([x.oI], j.prototype, "OnMouseOverSuggestion", null),
        (0, u.Cg)([x.oI], j.prototype, "BindSelectedElement", null);
      class D extends i.PureComponent {
        ...
        render() {
          return (0, s.jsx)("div", {
            className: (0, v.A)(
              A().suggestOption,
              A().mentionSearchOption,
              this.props.bIsSelected ? A().selected : "",
            ),
      ...
      (0, u.Cg)([x.oI], D.prototype, "OnMouseOver", null),
        (0, u.Cg)([x.oI], D.prototype, "OnClick", null);
      const _ = j;
      var w = n(79786),
        E = n.n(w);
      const N = class extends _ {
        ...
        renderMatch(e) {
          return (0, s.jsxs)("div", {
            className: (0, v.A)(
              E().EmoticonSuggestion,
              e.recent ? "Recent" : "",
            ),
            children: [
              (0, s.jsxs)("div", {
                className: E().Emoticon,
                children: [
      ...
      class O extends _ {
        ...
        renderMatch(e) {
          return (0, s.jsxs)(
            "div",
            {
              className: (0, v.A)(f().BBCodeSuggestion),
              children: [
                (0, s.jsx)("div", { className: f().BBCode, children: e.name }),
                "[",
                e.name,
                "]...[/",
                e.name,
        ...
        renderNoMatchMessage() {
          return (0, s.jsx)(
            "div",
            {
              className: (0, v.A)(A().mentionSearchOption, A().noMatches),
      ...
      class B extends i.Component {
        ...
        ReplaceSuggestedText(e, t) {
          let n = this.descTextAreaRef.current.selectionStart,
            ...
            o = this.FindMatchOpener(e, s, n);
          if (
            (void 0 === o && "@" == e && (o = this.FindMatchOpener("＠", s, n)),
            void 0 !== o)
          ) {
            let e = s.substr(0, o);
      ...
      (0, u.Cg)([x.oI], B.prototype, "BindMentionDialog", null),
        (0, u.Cg)([x.oI], B.prototype, "OnKeyDown", null),
        (0, u.Cg)([x.oI], B.prototype, "OnFocus", null),
        (0, u.Cg)([x.oI], B.prototype, "OnKeyPress", null),
        (0, u.Cg)([x.oI], B.prototype, "OnClick", null),
        (0, u.Cg)([x.oI], B.prototype, "OnEmoticonSuggestionSelected", null),
        (0, u.Cg)([x.oI], B.prototype, "OnBBCodeSuggestionSelected", null),
        (0, u.Cg)([x.oI], B.prototype, "FocusTextInput", null),
        (0, u.Cg)([x.oI], B.prototype, "GetTextAreaRef", null),
        (0, u.Cg)([x.oI], B.prototype, "GetTextAreaCurrent", null);
      var k = n(53835),
        R = n(283),
        U = n(95695),
        H = n.n(U),
      ...
      const re = (0, a.PA)((e) => {
        const {
          ...
          l = i.useMemo(() => ({ width: o, height: r }), [o, r]),
          [c, h] = i.useState(void 0),
          [d, u] = i.useState(Boolean(n)),
          [g, m] = i.useState(!1),
          C = (0, oe.zO)(t, "dummy"),
          x = i.useCallback(
            async (e) => {
                          ...
                          try {
                            ...
                            if (
                              ...
                              const e = n[0].uploadResult,
                                s = S.z.GenerateURLFromHashAndExt(
                                  t,
                                  S.z.GetHashAndExt(e),
                                ),
                                o = S.z.GenerateURLFromHashAndExt(
                                  t,
                                  S.z.GetThumbHashAndExt(e),
                                ),
                                r = {
                                  imageid: -11231412,
            ...
            (0, s.jsx)(k.$n, {
              onClick: (e) => {
                ...
                (0, F.pg)(
                  (0, s.jsx)(ne.z, {
                    clanSteamID: t,
                    fnImageSelectCallBack: (e) => x(e),
                  }),
                  (0, P.uX)(e),
                );
              },
              children: (0, b.we)("#BBCode_ChooseImage", o, r),
            }),
          ],
        });
      });
      ...
      let le = class extends i.Component {
        ...
        async AjaxGetFormattingHelp() {
          if ("" == this.state.formattingHelp.__html) {
            ...
            (e = await r().get(ae.GetHelpURL(this.props.formatType, !0), {
              params: t,
      ...
      (0, u.Cg)([x.oI], ue.prototype, "ClanImageDragListener", null),
        (0, u.Cg)([x.oI], ue.prototype, "onFocus", null),
        (0, u.Cg)([x.oI], ue.prototype, "OnTextAreaDropListener", null),
        (0, u.Cg)([x.oI], ue.prototype, "GetTextAreaRef", null),
        (ue = (0, u.Cg)([a.PA], ue));
      class ge {
        static BIsFireFox() {
          return Boolean(
      ...
      let me = class extends i.Component {
        ...
        OnAddLink(e) {
          (0, F.HT)(
            (0, s.jsx)(xe, { textareaRef: this.props.fnTextareaRef() }),
            (0, P.uX)(e),
          );
        }
        ShowHelpDialog(e) {
        ...
        OnOpenImageDialog(e) {
          (0, F.HT)(
            (0, s.jsx)(Ie, { textareaRef: this.props.fnTextareaRef() }),
            (0, P.uX)(e),
          );
        }
      ...
      (0, u.Cg)([x.oI], me.prototype, "onBold", null),
        (0, u.Cg)([x.oI], me.prototype, "onItalics", null),
        (0, u.Cg)([x.oI], me.prototype, "onUnderline", null),
        (0, u.Cg)([x.oI], me.prototype, "onStrikeThrough", null),
        (0, u.Cg)([x.oI], me.prototype, "onHeader", null),
        (0, u.Cg)([x.oI], me.prototype, "onHeader2", null),
        (0, u.Cg)([x.oI], me.prototype, "onHeader3", null),
        (0, u.Cg)([x.oI], me.prototype, "onUnorderedList", null),
        (0, u.Cg)([x.oI], me.prototype, "onOrderedList", null),
        (0, u.Cg)([x.oI], me.prototype, "OnAddLink", null),
        (0, u.Cg)([x.oI], me.prototype, "ShowHelpDialog", null),
        (0, u.Cg)([x.oI], me.prototype, "OnConvertHTMLToBBCodeDialog", null),
        (0, u.Cg)([x.oI], me.prototype, "OnOpenYoutubeDialog", null),
        (0, u.Cg)([x.oI], me.prototype, "OnOpenImageDialog", null),
        (0, u.Cg)([x.oI], me.prototype, "OnOpenSpeakerDialog", null),
        (0, u.Cg)([x.oI], me.prototype, "OnEmoticonSelected", null),
        (me = (0, u.Cg)([a.PA], me));
      ...
      (0, u.Cg)([x.oI], Ce.prototype, "OnYoutubeInsertLink", null),
        (0, u.Cg)([x.oI], Ce.prototype, "OnUrlChange", null),
        (0, u.Cg)([x.oI], Ce.prototype, "OnLeftSelected", null),
        (0, u.Cg)([x.oI], Ce.prototype, "OnRightSelected", null),
        (0, u.Cg)([x.oI], Ce.prototype, "OnFullSelected", null),
        (0, u.Cg)([x.oI], Ce.prototype, "OnSummarySelected", null),
        (0, u.Cg)([x.oI], Ce.prototype, "OnOuterDivClickPassDown", null),
        (Ce = (0, u.Cg)([a.PA], Ce));
      ...
      (0, u.Cg)([x.oI], xe.prototype, "onLinkTitleUpdate", null),
        (0, u.Cg)([x.oI], xe.prototype, "onLinkURLUpdate", null),
        (0, u.Cg)([x.oI], xe.prototype, "onInsertLink", null),
        (xe = ce = (0, u.Cg)([a.PA], xe));
      let Ie = class extends i.Component {
        ...
        OnImageInsert() {
          ...
          e && e.length > 0 && ((n += "[url=" + e + "]"), (s = "[/url]" + s)),
            (n += "[img]" + t),
            (s = "[/img]" + s),
            ge.wrapBBCode(n, s, this.props.textareaRef.current);
        }
        OnImageURLChange(e) {
      ...
      (0, u.Cg)([x.oI], Ie.prototype, "OnImageInsert", null),
        (0, u.Cg)([x.oI], Ie.prototype, "OnImageURLChange", null),
        (0, u.Cg)([x.oI], Ie.prototype, "OnAnchorURLChange", null),
        (Ie = (0, u.Cg)([a.PA], Ie));
      const Me = (e) => {
        const [t, n] = i.useState(""),
          ...
          { data: x } = (0, Q.Dv)(),
          { isLoading: I, data: M } = (0, Z.js)(m?.GetAccountID()),
        ...
        return (0, s.jsx)(z.o0, {
          ...
          onOK: () => {
            ...
            if (
              (o.trim().length > 0 && (n += ` title="${o}"`),
              a.trim().length > 0 && (n += ` company="${a}"`),
              d)
            ) {
              n += ` photo="${he.lw + "/" + d.clanAccountID + "/" + S.z.GetHashAndExt(d)}"`;
            }
            m && (n += ` steamid="${m.ConvertTo64BitString()}"`),
              (n += `]${c}[/speaker]`),
              ...
              (0, s.jsxs)("div", {
                children: [
                  ...
                  (0, s.jsxs)("div", {
                    ...
                    children: [
                      (0, s.jsx)(k.$n, {
                        onClick: () => C(new p.b(V.iA.steamid)),
                        children: (0, b.we)("#EventEditor_SteamAccount_addme"),
                      }),
                      (0, s.jsx)(k.$n, {
                        onClick: (e) =>
                          (0, g.lX)(
                            (0, s.jsx)(Te, { friends: x, setSteamID: C }),
                            e,
                          ),
                        children: (0, b.we)(
      ...
      function Te(e) {
        ...
        return (0, s.jsx)("div", {
          ...
          children: t.map((e) =>
            (0, s.jsx)(Le, { steamid: e, setSteamID: n }, e),
          ),
        });
      }
      function Le(e) {
      ...
      (0, u.Cg)([x.oI], Ae.prototype, "OnConvertAndOverriteHTML", null),
        (0, u.Cg)([x.oI], Ae.prototype, "OnConvertAndAppendHTML", null),
        (0, u.Cg)([x.oI], Ae.prototype, "OnCheckboxChange", null),
        (0, u.Cg)([x.oI], Ae.prototype, "OnTextAreaChange", null),
        (Ae = (0, u.Cg)([a.PA], Ae));
      var ve = n(32337),
        je = n(86244),
        De = n.n(je);
      const _e = (0, a.PA)((e) => {
        ...
        const T = a ? a.avatar_url : null,
          L = p.b.InitFromAccountID(V.iA.accountid),
          A = async () => {
            o.current &&
              o.current("ShareEventOnFriendsActivityFeed: cancel previous...");
            const e = r().CancelToken.source();
            (o.current = e.cancel), S(!0);
            let s = u;
            0 != s.trim().length && (s += "\n\n"), (s += n);
            const a =
              V.TS.COMMUNITY_BASE_URL +
            ...
            try {
              if (V.TS.IN_STEAMUI) {
                ...
                let o = await d.xt.PostStatusToFriends(
                ...
                const o = await r().post(a, n, { withCredentials: !0 });
                if (200 != o.status || 1 != o?.data?.success) {
                  const t =
                    (0, b.we)("#EventDisplay_Share_Failure") +
                    "\n\n" +
                    o?.data?.message;
                  return console.error(t), void (e.token.reason || x(t));
                }
              }
              e.token.reason ||
                (M(!0), x((0, b.we)("#EventDisplay_Share_Success")));
            } catch (t) {
              const n = (0, ie.H)(t),
                s =
                  (0, b.we)("#EventDisplay_Share_Failure") +
                  "\n\n" +
                  n.strErrorMsg;
              e.token.reason || x(s), console.error(s);
            }
          };
        return m
          ? (0, s.jsx)(z.o0, {
