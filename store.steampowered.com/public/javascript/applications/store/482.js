...
(self.webpackChunkstore = self.webpackChunkstore || []).push([
  [482],
  {
    ...
    63556: (e, t, n) => {
      ...
      (0, s.Cg)([r.sH], p.prototype, "m_eCurLang", void 0),
        (0, s.Cg)([r.sH], p.prototype, "m_rgHasData", void 0),
        (0, s.Cg)([r.sH], p.prototype, "m_bHasLocalizationContext", void 0),
        (0, s.Cg)([l.o], p.prototype, "GetCurEditLanguage", null),
        (0, s.Cg)([l.o], p.prototype, "SetCurEditLanguage", null),
        (0, s.Cg)([r.XI.bound], p.prototype, "SetHasLanguage", null),
        (0, s.Cg)([l.o], p.prototype, "BHasLanguageData", null);
    },
    29347: (e, t, n) => {
      "use strict";
      n.d(t, { r: () => g, z: () => d });
      ...
      const d = (e) => {
        ...
        u = (e) => {
          ...
          let o = t.file_name ? t.file_name : "",
            a = g(n, o, String(t.imageid), h.Hilight);
          return (0, s.jsxs)("div", {
      ...
      function g(e, t, n, r) {
        ...
        } else o.push((0, s.jsx)("span", { children: t }, n + "_null"));
        return o;
      }
    },
    1909: (e, t, n) => {
      ...
      let S = class extends a.Component {
        GenerateLanguageOptions() {
          ...
          for (const e of d.A0.GetLanguageListForRealms(c)) {
            if (t && !t(e)) continue;
            const n = (0, i.LgB)(e),
              s = (0, d.we)("#Language_" + n),
              r = !(!o || !o(e));
            a.push({ eLang: e, sLocName: s, bSupported: r });
          }
          a.sort((e, t) =>
          ...
          for (const t of a) {
            t.bSupported != g &&
              (e.push(
                (0, r.jsx)(
                  "option",
                  {
                    className: h().SupportedGroupLabel,
                    disabled: !0,
                    children: (0, d.we)(
                      t.bSupported
            ...
            a &&
              ...
              (i += (0, d.we)(
                ...
                (0, d.$z)(a) + " @ " + (0, u.KC)(a, { bForce24HourClock: !1 }),
              ))),
              e.push(
                (0, r.jsx)(
                  "option",
                  {
                    value: t.eLang,
                    className: (0, p.A)(
                      { [h().LanguageWithContent]: o },
                      t.bSupported
                        ? h().SupportedLanguage
                        : h().UnsupportedLanguage,
                    ),
                    children: i,
                  },
                  "langpicker" + t.eLang + (o ? "_hasdata" : ""),
                ),
              );
          }
          return e;
      ...
      (0, s.Cg)([g.oI], S.prototype, "OnLanguageChange", null),
        (S = (0, s.Cg)([o.PA], S));
    },
    20482: (e, t, n) => {
      "use strict";
      ...
      const w = (e) => {
          ...
          l = (e) => {
            t.current &&
              t.current.ownerDocument.defaultView.navigator.clipboard
                ...
                .then((e) => {
                  s((0, d.we)("#EventDisplay_Share_CopiedToClipboard"));
                })
                .catch((e) => {
                  s((0, d.we)("#EventDisplay_Share_FailedToCopyToClipboard")),
        ...
        return (0, r.jsxs)("div", {
          children: [
            (0, r.jsxs)("div", {
              className: (0, p.A)(c().FlexRowContainer, L().linkField),
              onClick: l,
              children: [
                (0, r.jsx)("span", {
                ...
                document.queryCommandSupported("copy") &&
                  (0, r.jsx)(i.Z, {
                    className: (0, p.A)(c().Button, c().Icon, L().LinkButton),
                    onActivate: l,
      ...
      (0, s.Cg)([u.oI], E.prototype, "ShareOnSteamActivityFeed", null);
      const N = (e) => {
        const {
            eventLink: t,
            sharePageUrls: n,
          ...
          l = (0, g.Y2)(),
          [h, u] = (0, o.useState)((0, a.sfN)(g.TS.LANGUAGE)),
          C = (0, o.useMemo)(() => {
            const e = new URL(t);
            return e.searchParams.set("l", (0, a.LgB)(h)), e.href;
          }, [h, t]);
        return (0, r.jsxs)("div", {
          className: (0, p.A)(c().FlexColumnContainer, L().share_controls_ctn),
          children: [
            !l &&
              (0, r.jsxs)(r.Fragment, {
                children: [
                  (0, r.jsxs)("div", {
                    className: L().ShareLanguagePicker,
                    children: [
                      (0, r.jsx)(_.JU, {
                        className: L().LanguageLabel,
                        children: (0, d.we)(
                          "#EventDisplay_Share_LanguageLabel",
                        ),
                      }),
                      (0, r.jsx)("div", {
                        children: (0, r.jsx)(v.Ng, {
                          selectedLang: h,
    ...
    73067: (e, t, n) => {
      ...
      class w extends i.Component {
        ...
        BindSelectedElement(e) {
          ...
          n &&
            s &&
            (s.scrollTop + s.clientHeight < n.offsetTop ||
              n.offsetTop < s.scrollTop) &&
            n.scrollIntoView();
        }
      ...
      (0, g.Cg)([I.oI], w.prototype, "OnKeyDown", null),
        (0, g.Cg)([I.oI], w.prototype, "OnClickSuggestion", null),
        (0, g.Cg)([I.oI], w.prototype, "OnMouseOverSuggestion", null),
        (0, g.Cg)([I.oI], w.prototype, "BindSelectedElement", null);
      ...
      (0, g.Cg)([I.oI], E.prototype, "OnMouseOver", null),
        (0, g.Cg)([I.oI], E.prototype, "OnClick", null);
      const N = w;
      var f = n(79786),
        y = n.n(f);
      ...
      class B extends N {
        ...
        renderMatch(e) {
          return (0, s.jsxs)(
            "div",
            {
              className: (0, D.A)(A().BBCodeSuggestion),
              children: [
                (0, s.jsx)("div", { className: A().BBCode, children: e.name }),
                "[",
                e.name,
                "]...[/",
                e.name,
        ...
        renderNoMatchMessage() {
          return (0, s.jsx)(
            "div",
            {
              className: (0, D.A)(_().mentionSearchOption, _().noMatches),
      ...
      class R extends i.Component {
        ...
        ReplaceSuggestedText(e, t) {
          let n = this.descTextAreaRef.current.selectionStart,
            ...
            r = this.FindMatchOpener(e, s, n);
          if (
            (void 0 === r && "@" == e && (r = this.FindMatchOpener("＠", s, n)),
            void 0 !== r)
          ) {
            let e = s.substr(0, r);
            (e += t), (n >= s.length || " " != s[n]) && (e += " ");
            let o = e.length;
            (e += s.substr(n)),
      ...
      (0, g.Cg)([I.oI], R.prototype, "BindMentionDialog", null),
        (0, g.Cg)([I.oI], R.prototype, "OnKeyDown", null),
        (0, g.Cg)([I.oI], R.prototype, "OnFocus", null),
        (0, g.Cg)([I.oI], R.prototype, "OnKeyPress", null),
        (0, g.Cg)([I.oI], R.prototype, "OnClick", null),
        (0, g.Cg)([I.oI], R.prototype, "OnEmoticonSuggestionSelected", null),
        (0, g.Cg)([I.oI], R.prototype, "OnBBCodeSuggestionSelected", null),
        (0, g.Cg)([I.oI], R.prototype, "FocusTextInput", null),
        (0, g.Cg)([I.oI], R.prototype, "GetTextAreaRef", null),
        (0, g.Cg)([I.oI], R.prototype, "GetTextAreaCurrent", null);
      var U = n(56283),
        H = n(283),
        z = n(95695),
        G = n.n(z),
      ...
      const ce = (0, a.PA)((e) => {
        const {
          ...
          l = i.useMemo(() => ({ width: r, height: o }), [r, o]),
          [c, h] = i.useState(void 0),
          ...
          C = i.useCallback(
            async (e) => {
              if (
                (S.ClearImages(),
                e && (u(!0), await S.AddExistingClanImage(e, ne.Bhc)))
              ) {
                h(e);
                const t = S.GetUploadImages()[0].IsValidAssetType(l);
                0 != t.error.length ||
                  t.needsCrop ||
        ...
        if (S && S.GetFilesToUpload().length > 0) {
          ...
          const e = I.IsValidAssetType(l);
          (M = e.error), (T = e.needsCrop);
        }
        return (0, s.jsxs)(s.Fragment, {
          children: [
            ...
            Boolean(M) && (0, s.jsx)("p", { children: M }),
            T &&
              (0, s.jsx)(U.$n, {
                onClick: (e) => {
                  const t = (0, Q.uX)(e);
                  ...
                  g
                    ...
                    : (0, s.jsx)(U.$n, {
                        onClick: async () => {
                          m(!0);
                          try {
                            const e = await S.UploadAllImages(l),
                              n = Object.values(e);
                            if (
                              n &&
                              n.length > 0 &&
                              ...
                              const e = n[0].uploadResult,
                                ...
                                r = x.zU.GenerateURLFromHashAndExt(
                                  t,
            ...
            (0, s.jsx)(U.$n, {
              ...
              children: (0, k.we)("#BBCode_ChooseImage", r, o),
            }),
          ],
        });
      });
      ...
      let de = class extends i.Component {
        ...
        constructor(e) {
          super(e),
            (this.state = {
              formattingHelp: {
                __html: he.s_formattingHelp.has(e.formatType)
                  ? he.s_formattingHelp.get(e.formatType)
                  : "",
              },
            });
        }
        ...
        async AjaxGetFormattingHelp() {
          if ("" == this.state.formattingHelp.__html) {
            ...
            (e = await o().get(he.GetHelpURL(this.props.formatType, !0), {
              params: t,
      ...
      let xe = class extends i.Component {
        ...
        componentDidMount() {
          C.pU.AddClanImageDragListener(this.ClanImageDragListener);
        }
        componentWillUnmount() {
          C.pU.RemoveClanImageDragListener(this.ClanImageDragListener);
        }
          ...
          if (
            ...
            if (t && t.length > 0)
              for (let e of [x.zU.GetBaseURL(), x.zU.GetBaseURLV2()])
                if (t.startsWith(e)) {
                  let n = "[img]" + ge.lw + "/" + t.substr(e.length) + "[/img]";
      ...
      (0, g.Cg)([I.oI], xe.prototype, "ClanImageDragListener", null),
        (0, g.Cg)([I.oI], xe.prototype, "onFocus", null),
        (0, g.Cg)([I.oI], xe.prototype, "OnTextAreaDropListener", null),
        (0, g.Cg)([I.oI], xe.prototype, "GetTextAreaRef", null),
        (xe = (0, g.Cg)([a.PA], xe));
      class Ce {
        static BIsFireFox() {
          return Boolean(
        ...
        static InsertTextAtSelect(e, t) {
          ...
          if (null !== n && null !== s) {
            t.setRangeText
              ? t.setRangeText(e, n, s, "preserve")
              : (t.value = t.value.slice(0, n) + e + t.value.slice(s));
      ...
      let Ie = class extends i.Component {
        ...
        OnAddLink(e) {
          (0, Y.HT)(
            (0, s.jsx)(Le, { textareaRef: this.props.fnTextareaRef() }),
            (0, Q.uX)(e),
          );
        }
        ShowHelpDialog(e) {
          this.props.showFormatHelp &&
            (0, Y.HT)(
              (0, s.jsx)(de, { formatType: this.props.showFormatHelp }),
              (0, Q.uX)(e),
            );
        }
        ...
        render() {
          ...
          return (
            e &&
              (o = t
                ? (0, s.jsx)("span", {
                    className: (0, D.A)("ttip", te().ActionGetHelp),
                    children: (0, s.jsx)($.he, {
                      ...
                      children: (0, s.jsxs)("a", {
                        ...
                        children: [
                          (0, s.jsx)("img", { src: r + "/action_help.png" }),
                          " ",
      ...
      (0, g.Cg)([I.oI], Ie.prototype, "onBold", null),
        (0, g.Cg)([I.oI], Ie.prototype, "onItalics", null),
        (0, g.Cg)([I.oI], Ie.prototype, "onUnderline", null),
        (0, g.Cg)([I.oI], Ie.prototype, "onStrikeThrough", null),
        (0, g.Cg)([I.oI], Ie.prototype, "onHeader", null),
        (0, g.Cg)([I.oI], Ie.prototype, "onHeader2", null),
        (0, g.Cg)([I.oI], Ie.prototype, "onHeader3", null),
        (0, g.Cg)([I.oI], Ie.prototype, "onUnorderedList", null),
        (0, g.Cg)([I.oI], Ie.prototype, "onOrderedList", null),
        (0, g.Cg)([I.oI], Ie.prototype, "OnAddLink", null),
        (0, g.Cg)([I.oI], Ie.prototype, "ShowHelpDialog", null),
        (0, g.Cg)([I.oI], Ie.prototype, "OnConvertHTMLToBBCodeDialog", null),
        (0, g.Cg)([I.oI], Ie.prototype, "OnOpenYoutubeDialog", null),
        (0, g.Cg)([I.oI], Ie.prototype, "OnOpenImageDialog", null),
        (0, g.Cg)([I.oI], Ie.prototype, "OnOpenSpeakerDialog", null),
        (0, g.Cg)([I.oI], Ie.prototype, "OnEmoticonSelected", null),
        (Ie = (0, g.Cg)([a.PA], Ie));
      let Te = class extends i.Component {
        state = { youtubeInput: "", alignment: me.V2.left };
        OnYoutubeInsertLink() {
          const e =
            this.state.youtubeInput && (0, S.XU)(this.state.youtubeInput);
          if (e) {
      ...
      (0, g.Cg)([I.oI], Te.prototype, "OnYoutubeInsertLink", null),
        (0, g.Cg)([I.oI], Te.prototype, "OnUrlChange", null),
        (0, g.Cg)([I.oI], Te.prototype, "OnLeftSelected", null),
        (0, g.Cg)([I.oI], Te.prototype, "OnRightSelected", null),
        (0, g.Cg)([I.oI], Te.prototype, "OnFullSelected", null),
        (0, g.Cg)([I.oI], Te.prototype, "OnSummarySelected", null),
        (0, g.Cg)([I.oI], Te.prototype, "OnOuterDivClickPassDown", null),
        (Te = (0, g.Cg)([a.PA], Te));
      ...
      (0, g.Cg)([I.oI], Le.prototype, "onLinkTitleUpdate", null),
        (0, g.Cg)([I.oI], Le.prototype, "onLinkURLUpdate", null),
        (0, g.Cg)([I.oI], Le.prototype, "onInsertLink", null),
        (Le = ue = (0, g.Cg)([a.PA], Le));
      let ve = class extends i.Component {
        ...
        OnImageInsert() {
          ...
          let n = "",
            s = "";
          e && e.length > 0 && ((n += "[url=" + e + "]"), (s = "[/url]" + s)),
            (n += "[img]" + t),
            (s = "[/img]" + s),
            Ce.wrapBBCode(n, s, this.props.textareaRef.current);
        }
        OnImageURLChange(e) {
      ...
      (0, g.Cg)([I.oI], ve.prototype, "OnImageInsert", null),
        (0, g.Cg)([I.oI], ve.prototype, "OnImageURLChange", null),
        (0, g.Cg)([I.oI], ve.prototype, "OnAnchorURLChange", null),
        (ve = (0, g.Cg)([a.PA], ve));
      const je = (e) => {
        const [t, n] = i.useState(""),
          ...
          [g, S] = i.useState(void 0),
          { data: C } = (0, K.Dv)(),
          { isLoading: I, data: M } = (0, W.js)(g?.GetAccountID()),
          T = 0 != t.trim().length && 0 != c.trim().length;
        return (0, s.jsx)(F.o0, {
          ...
          onOK: () => {
            ...
            if (
              (r.trim().length > 0 && (n += ` title="${r}"`),
              a.trim().length > 0 && (n += ` company="${a}"`),
              p)
            ) {
              n += ` photo="${ge.lw + "/" + p.clanAccountID + "/" + x.zU.GetHashAndExt(p)}"`;
            }
              ...
              (0, s.jsxs)("div", {
                children: [
                  ...
                  (0, s.jsxs)("div", {
                    ...
                    children: [
                      (0, s.jsx)(U.$n, {
                        onClick: () => S(new d.b(Z.iA.steamid)),
                        children: (0, k.we)("#EventEditor_SteamAccount_addme"),
                      }),
                      (0, s.jsx)(U.$n, {
                        onClick: (e) =>
                          (0, m.lX)(
                            (0, s.jsx)(_e, { friends: C, setSteamID: S }),
                            e,
                          ),
                        children: (0, k.we)(
      ...
      function _e(e) {
        ...
        return (0, s.jsx)("div", {
          ...
          children: t.map((e) =>
            (0, s.jsx)(De, { steamid: e, setSteamID: n }, e),
          ),
        });
      }
      function De(e) {
      ...
      (0, g.Cg)([I.oI], we.prototype, "OnConvertAndOverriteHTML", null),
        (0, g.Cg)([I.oI], we.prototype, "OnConvertAndAppendHTML", null),
        (0, g.Cg)([I.oI], we.prototype, "OnCheckboxChange", null),
        (0, g.Cg)([I.oI], we.prototype, "OnTextAreaChange", null),
        (we = (0, g.Cg)([a.PA], we));
      var Ee = n(52885),
        Ne = n(86244),
        fe = n.n(Ne);
      const ye = (0, a.PA)((e) => {
        ...
        const L = a ? a.avatar_url : null,
          v = d.b.InitFromAccountID(Z.iA.accountid),
          j = async () => {
            r.current &&
              r.current("ShareEventOnFriendsActivityFeed: cancel previous...");
            const e = o().CancelToken.source();
            (r.current = e.cancel), x(!0);
            let s = g;
            0 != s.trim().length && (s += "\n\n"), (s += n);
            const a =
              Z.TS.COMMUNITY_BASE_URL +
            ...
            try {
              if (Z.TS.IN_STEAMUI) {
                let n = h.w.Init(u.kVt);
                n.Body().set_appid(t), n.Body().set_status_text(s);
                let r = await u.xtC.PostStatusToFriends(
                ...
                const r = await o().post(a, n, { withCredentials: !0 });
              ...
              e.token.reason ||
                (T(!0), I((0, k.we)("#EventDisplay_Share_Success")));
            } catch (t) {
              const n = (0, pe.H)(t),
                s =
                  (0, k.we)("#EventDisplay_Share_Failure") +
                ...
                children: [
                  ...
                  (0, s.jsxs)("div", {
                    ...
                    children: [
                        ...
                        children: [
                          ...
                          (0, s.jsx)("div", {
                            ...
                            children: (0, s.jsx)(xe, {
                              ...
                              limitBBCode: l.iH,
                              classNameForTextArea: fe().ShareDescription,
                              bEmbeddedInDialog: !0,
                            }),
                          }),
                        ],
                      ...
                      (0, s.jsx)("div", {
                        className: fe().ShareLink,
                        children: (0, s.jsx)(Ee.fh, {
                          text: n,
                          event: null,
