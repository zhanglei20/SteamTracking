  ...
  [53318],
  {
    ...
    17083: (e, t, a) => {
      ...
      var h = p(function (e, t) {
        ...
        return (c.ref = (m !== p && t) || a), i.createElement("a", c);
      });
      var v = p(function (e, t) {
          ...
          return i.createElement(s.XZ.Consumer, null, function (e) {
            e || (0, d.A)(!1);
            var a = e.history,
              s = _(c(u, e.location), e.location),
              l = s ? a.createHref(s) : "",
              h = (0, o.A)({}, S, {
                href: l,
                navigate: function () {
                  var t = c(u, e.location),
                    s = (0, r.AO)(e.location) === (0, r.AO)(_(t));
                  (v || s ? a.replace : a.push)(t);
                },
              });
            return (
              m !== p ? (h.ref = t || g) : (h.innerRef = g),
              i.createElement(n, h)
            );
          });
        }),
        ...
        return i.createElement(s.XZ.Consumer, null, function (e) {
          ...
          var a = x || e.location,
            ...
            N = f
              ...
              : null,
            B = !!(j ? j(N, a) : N),
            C = "function" == typeof h ? h(B) : h,
            T = "function" == typeof b ? b(B) : b;
          B &&
            ((C = (function () {
              for (
            ...
            (T = (0, o.A)({}, T, p)));
          var I = (0, o.A)(
            { "aria-current": (B && n) || null, className: C, style: T, to: r },
            D,
          );
          return (
            u !== g ? (I.ref = t || A) : (I.innerRef = A), i.createElement(v, I)
          );
        });
      });
    },
    ...
    34696: (e, t, a) => {
      ...
      (0, p.Cg)([v.sH], S.prototype, "m_stats", void 0),
        (0, p.Cg)([v.sH], S.prototype, "m_lastUpdateTime", void 0);
      class j {
        ...
        LazyInit() {
          if (!this.m_bLoadedFromConfig) {
            let e = (0, h.Tc)("trackingdatasummary", "application_config");
            this.ValidateStoreDefault(e) &&
              this.m_mapSummaryStats.set(e.clan_account_id, new S(e));
            let t = (0, h.Tc)("trackingdataevents", "application_config");
        ...
        async LoadStatsForEvents(e, t, a) {
          ...
          let s = Date.now() / 1e3,
            n = t.filter((t) => {
              let a = this.GetKey(e, t),
                n = this.m_mapPerEventStats.get(a);
              return !n || null == n.m_stats || n.m_lastUpdateTime < s - 3600;
            });
          if (!n || 0 == n.length) return !0;
          let i = (0, h.xv)() + "actions/ajaxgetpartnereventsreport",
            r = {
              sessionid: (0, h.KC)(),
        ...
        BHasEventStats(e, t) {
          let a = g.b.InitFromClanID(e),
            s = this.GetKey(a, t),
            n = this.m_mapPerEventStats.get(s);
          return Boolean(n && n.m_stats);
        }
      }
      (0, p.Cg)([v.sH], j.prototype, "m_mapPerEventStats", void 0),
        (0, p.Cg)([v.sH], j.prototype, "m_mapSummaryStats", void 0),
        (0, p.Cg)([v.XI], j.prototype, "LazyInit", null);
      const x = new j();
      var w = a(84811),
        y = a(94333),
        b = a(47413),
        ...
        T = a(61859);
      function I(e) {
        const { appid: t, creatorHome: a } = e;
        return (0, s.jsx)("div", {
          className: N().AppSummaryCtn,
          children: (0, s.jsxs)("div", {
            className: N().EventBodyPosition,
            children: [t ? (0, s.jsx)(P, { appid: t }) : null, a],
          }),
        });
      }
      function P(e) {
        const { appid: t } = e,
          { data: a } = (0, o.J$)({ appid: t });
        if (!a) return null;
        const n = (0, A.U)(a.type ?? D.uE.HT);
        return (0, s.jsxs)("div", {
          className: N().AppSummaryWidgetTitleCtn,
          children: [
            (0, s.jsx)("span", {
              className: N().Title,
              children: (0, T.we)("#CreatorHome_ThisGame"),
            }),
            (0, s.jsx)("div", {
              className: (0, C.A)(
      ...
      function L(e) {
        const {
          ...
          } = e,
          {
            total_showm: l = 0,
            total_read: d = 0,
            library_overview_shown: c = 0,
            library_overview_read: _ = 0,
            app_details_spotlight_shown: m = 0,
            app_details_spotlight_read: p = 0,
            app_details_activity_shown: v = 0,
            app_details_activity_read: u = 0,
            store_app_page_shown: g = 0,
            store_app_page_read: S = 0,
            community_hub_shown: j = 0,
        ...
        return d + l == 0
          ? null
          : (0, s.jsxs)("div", {
              className: (0, C.A)(i ? G.EventDetailView : G.DashboardView),
              children: [
                (0, s.jsxs)("div", {
                  className: (0, C.A)(G.HeaderCtn),
                  children: [
                    o,
                    (0, s.jsxs)("div", {
                      className: G.TotalsCtn,
                      children: [
                        (0, s.jsxs)("div", {
                          className: G.HeaderStat,
                          children: [
                            (0, s.jsx)("span", {
                              className: G.StatDescription,
                              children: (0, T.we)(
                                "#EventDashBoard_SummaryStats_TotalImpressions",
                              ),
                            }),
                            (0, s.jsx)("span", {
                              className: G.StatFigure,
                              children: (0, k.Dq)(l),
                            }),
                          ],
                        }),
                ...
                Boolean(n && a) &&
                  (0, s.jsxs)("div", {
                    className: G.ModerationWarningCtn,
                    children: [
                      (0, s.jsx)("div", {
                        className: G.ModerationWarning,
                        children: (0, T.we)(
                          ...
                          children: [
                            ...
                            (0, s.jsxs)("div", {
                              ...
                              children: [
                                ...
                                (0, s.jsx)("span", { children: (0, k.Dq)(c) }),
                              ],
                            }),
                            (0, s.jsxs)("div", {
                              className: G.StatsTitle,
                              children: [
                                ...
                                (0, s.jsx)("span", { children: (0, k.Dq)(_) }),
                              ],
                            }),
                            (0, s.jsxs)("div", {
                              className: G.StatsTitle_ctn,
                            ...
                            (0, s.jsxs)("div", {
                              ...
                              children: [
                                ...
                                (0, s.jsx)("span", { children: (0, k.Dq)(v) }),
                              ],
                            }),
                            (0, s.jsxs)("div", {
                              className: G.StatsTitle,
                              children: [
                                ...
                                (0, s.jsx)("span", { children: (0, k.Dq)(u) }),
                              ],
                            }),
                          ],
                        }),
                      (0, s.jsxs)("div", {
                        className: G.StatsRightSection,
                        children: [
                          (0, s.jsx)("div", {
                            className: G.StatsTitle_ctn,
                          ...
                          (0, s.jsxs)("div", {
                            ...
                            children: [
                              ...
                              (0, s.jsx)("span", { children: (0, k.Dq)(g) }),
                            ],
                          }),
                          (0, s.jsxs)("div", {
                            className: G.StatsTitle,
                            children: [
                              ...
                              (0, s.jsx)("span", { children: (0, k.Dq)(S) }),
                            ],
                          }),
                          (0, s.jsx)("div", {
                            className: G.StatsTitle_ctn,
                          ...
                          (0, s.jsxs)("div", {
                            ...
                            children: [
                              ...
                              (0, s.jsx)("span", { children: (0, k.Dq)(j) }),
                            ],
                          }),
                          (0, s.jsxs)("div", {
                            className: G.StatsTitle,
                            children: [
                              ...
                              (0, s.jsx)("span", { children: (0, k.Dq)(x) }),
                            ],
                          }),
                          (0, s.jsx)("div", {
                            className: G.StatsTitle_ctn,
                          ...
                          (0, s.jsxs)("div", {
                            ...
                            children: [
                              ...
                              (0, s.jsx)("span", { children: (0, k.Dq)(w) }),
                            ],
                          }),
                          (0, s.jsxs)("div", {
                            className: G.StatsTitle,
                            children: [
                              ...
                              (0, s.jsx)("span", { children: (0, k.Dq)(y) }),
                            ],
                          }),
                        ],
                      }),
      ...
      const M = (0, c.PA)(function (e) {
        const { event: t, bIsOGG: a, summary: n } = e,
          i = (0, R.n)();
        return (0, s.jsxs)(w.tH, {
          children: [
            (0, s.jsxs)("div", {
              className: N().EditorStatsCtn,
              children: [
                (0, s.jsxs)("div", {
                  className: N().EditorStatsRow,
                  children: [
                    (0, s.jsx)("span", {
                      children: (0, T.we)("#EventEditor_Comments"),
                    }),
                    (0, s.jsx)("span", {
                      children: (0, k.Dq)(t.nCommentCount),
                    }),
                  ],
                }),
                (0, s.jsxs)("div", {
                  ...
                  children: [
                    (0, s.jsx)("span", {
                      children: (0, T.we)("#EventEditor_UpVotes"),
                    }),
                    (0, s.jsx)("span", {
                      children: t.nVotesUp ? (0, k.Dq)(t.nVotesUp) : 0,
                    }),
                  ],
                }),
                (0, s.jsxs)("div", {
                  ...
                  children: [
                    (0, s.jsx)("span", {
                      children: (0, T.we)("#EventEditor_DownVotes"),
                    }),
                    (0, s.jsx)("span", {
                      children: t.nVotesDown ? (0, k.Dq)(t.nVotesDown) : 0,
                    }),
                  ],
                }),
              ],
            ...
            n &&
              (0, s.jsxs)("div", {
                className: N().EditorStatsCtn,
                children: [
                  (0, T.we)("#EventDashBoard_SummaryStats_Admin_Title"),
                  (0, s.jsx)(L, {
                    summary: n,
                    bIsAllowedInLibrary: a,
                    bEventIsInModerationQueue: (0, H.Dn)(t, i),
                    bCompact: !0,
                    bExpanded: !0,
                  }),
                ],
      ...
      const X = (0, c.PA)((e) => {
        const {
          ...
          { data: u, isPending: g } = (0, o.J$)(p ? { appid: p } : void 0),
          { data: S, isPending: j } = (0, i.TB)(h.GetAccountID());
        return j || (p && g)
          ? null
          : (0, s.jsx)("div", {
              className: N().EventDetailTitleDesc,
              children: (0, s.jsxs)("div", {
                className: N().EventDetailsSticky,
                children: [
                  (S?.is_ogg ?? Boolean(p))
                    ? (0, s.jsx)(Q, { appid: S?.appid || p })
                    : (0, s.jsx)(Y, { clanSteamID: h }),
                  (0, s.jsx)(F.j, {
                    event: t,
                    className: N().EventDetailTimeInfo,
                    nOverrideEndTime: l,
                    nOverrideStartTime: r,
                  }),
                  d &&
                  ...
                  (0, s.jsxs)("div", {
                    ...
                    children: [
                      ...
                      (0, s.jsxs)("div", {
                        className: N().EventDetailsType,
                        children: [t.GetCategoryAsString(), " "],
                      }),
                    ],
                  }),
                  c,
                  Boolean(t.jsondata.meet_steam_groups) && _,
                ],
              }),
            });
      });
      function Q(e) {
        const { appid: t } = e;
        (0, W.wT)(t && 0 != t, "Expected Appid In Game Info Section");
        const { data: a, isPending: n } = (0, o.J$)(t ? { appid: t } : void 0);
        return (0, s.jsxs)("div", {
          className: N().EventDetailGameCallToAction,
          children: [
            (0, s.jsx)("div", {
              className: N().RightSideTitles,
              children: H.zK.some((e) => t === e)
                ? (0, T.we)("#EventDisplay_RightColumnTitle_Blog")
                : (0, T.we)("#EventDisplay_RightColumnTitle_Game"),
            }),
            (0, s.jsx)(O.W, {
              imageType: "header",
            ...
            (0, s.jsxs)("div", {
              ...
              children: [
                ...
                n && (0, s.jsx)(K.t, { size: "small", position: "center" }),
              ],
            }),
          ],
        });
          ...
          children: [
            ...
            (0, s.jsx)(z.m, {
              ...
              children: (0, s.jsx)("div", {
                className: N().EventDetailsAvatar,
      ...
      function ue(e) {
        const { event: t, lang: a } = e,
          i = (0, _.q3)(() => t.jsondata.meet_steam_groups),
          { data: o } = (0, r.hM)(t.clanSteamID.GetAccountID()),
          [l, d, c] = (0, m.useMemo)(() => {
            const e = new Map(),
              t = new Map();
            let a = !1;
            return (
              i.forEach((s) => {
                s.group_visibility_tokens?.length > 0
                  ? (s.group_visibility_tokens.forEach((t) => {
                      e.has(t)
                        ? e.get(t).push(s.group_id)
                        : e.set(t, [s.group_id]);
                    }),
                    t.set(s.group_id, s.localized_session_title[n.Bhc]))
                  : (a = !0);
              }),
              [e, t, a]
            );
        ...
        return 0 == l.size
          ...
          : o?.can_edit
            ? (0, s.jsxs)("div", {
                className: (0, C.A)(
                  ve().DefaultSectionCtn,
                  ve().ValveOnlyBackground,
                ),
                children: [
                  (0, s.jsx)(pe.JU, { children: "(VO) Meet Steam URLs" }),
                  Array.from(l.keys()).map((e) => {
                    ...
                    return (0, s.jsx)(
                      ...
                      {
                        children: (0, s.jsxs)("a", {
                          href: `${me.TS.STORE_BASE_URL}meetsteam/${t.GID}/${e}`,
                          target: "_blank",
                          children: [
                            "Shows Sessions: ",
                            a.map((t) =>
                  ...
                  Boolean(c) &&
                    (0, s.jsx)("div", {
                      children: (0, s.jsx)("a", {
                        href: `${me.TS.STORE_BASE_URL}meetsteam/${t.GID}`,
                        target: "_blank",
      ...
      var ge = a(85693),
        ...
        Ee = a(13843);
      const Ae = {};
      Ae.english = () => a.e(23130).then(a.t.bind(a, 23130, 19));
      const De = (0, Ee.l)(async function (e) {
        if (Ae[e]) return Ae[e]();
      });
      function fe(e) {
        const { appid: t } = e,
          { data: a } = (0, o.J$)(t ? { appid: t } : void 0);
        return t && U.iA.logged_in && a?.type == D.uE.Vi
          ? (0, s.jsx)(Ne, { appid: t })
          : null;
      }
      function Ne(e) {
        return !1 !== (0, be.S6)(e.appid)
          ? null
          : (0, s.jsxs)("div", {
              className: N().EventNotPublicBar,
              children: [
                (0, s.jsx)("span", {
                  className: N().EventNotPublicBarTitle,
                  children: De.Localize("#PartnerEvents_PlaytestOnly_Header"),
                }),
                (0, s.jsx)("span", {
                  className: N().EventNotPublicBarDetail,
                  children: De.Localize("#PartnerEvents_PlaytestOnly_Detail"),
                }),
              ],
            });
      }
      const Be = (0, c.PA)((e) => {
          const {
            ...
            m = (0, ye.m0)(t, "background", a),
            { data: p } = (0, o.j4)(t.appid ? { appid: t.appid } : void 0),
            { data: h } = (0, i.TB)(t.clanSteamID.GetAccountID()),
            v = t.BIsImageSafeForAllAges("background", a, {
              bAppHasAgeSafeScreenshots:
                (p?.all_ages_screenshots?.length ?? 0) > 0,
              clanInfo: h ?? void 0,
            }),
            u = "lang_" + (0, n.wwZ)(a),
            g = !!m && t.BImageNeedScreenshotFallback("background", a);
          return (0, s.jsxs)(xe.Z, {
            scrollIntoViewType: we.Yo.NoTransformSparseContent,
            className: (0, C.A)(
              N().EventDetailsPageContainer,
              u,
              ie().PartnerEventFont,
              v
                ? N().DetailArtworkAgeAppropriate
                : N().DetailArtworkAgeNotAppropriate,
              !m && N().NoTitleArtwork,
              g && N().ScreenshotInsteadOfCover,
            ),
            children: [
              r,
              l,
              (0, s.jsx)(fe, { appid: t.appid }),
              (0, s.jsx)(Ce, { strImageURL: m }),
              (0, s.jsx)(Te, { strImageURL: m, body: d, postbody: c }),
              Boolean(_) && (0, s.jsx)(w.tH, { children: _ }),
            ],
          });
        }),
        Ce = (e) => {
          ...
          return (0, s.jsxs)("div", {
            className: N().EventCoverImageCtn,
            children: [
              (0, s.jsx)("div", {
                className: N().EventCoverImageBlr,
                children:
                  t &&
                  (0, s.jsxs)(s.Fragment, {
                    children: [
                      (0, s.jsx)("div", {
                        className: N().EventCoverImageFuzz,
                        style: {
              ...
              t && (0, s.jsx)("div", { className: N().CoverImageGradient }),
            ],
          });
        },
        Te = (e) => {
          ...
          return (0, s.jsxs)("div", {
            className: N().EventBodyCtn,
            children: [
              (0, s.jsx)("div", { className: N().EventBackgroundBlurCtn }),
              (0, s.jsxs)("div", {
                className: N().EventBodyPosition,
                children: [
                  (0, s.jsxs)("div", {
                    className: N().EventBody,
                    children: [
                      Boolean(n) &&
                        (0, s.jsx)("div", {
                      ...
                      (0, s.jsx)(w.tH, { children: t }),
                    ],
                  }),
                  Boolean(a) && (0, s.jsx)(w.tH, { children: a }),
                ],
              }),
            ],
          });
        ...
        Pe = (0, c.PA)((e) => {
          const {
            ...
            g = (0, ae.MU)(),
            S = (0, R.n)(),
            { data: j, isPending: x } = (0, o.J$)(v ? { appid: v } : void 0),
            { data: A, isPending: D } = (0, i.TB)(u);
          if (
            (m.useEffect(() => {
              window.scrollTo(0, 0);
            }, [v, u]),
            !g && t.GetEventType() == n.ajI)
          )
            return (0, s.jsx)($.OG, {
              eventModel: t,
              route: $.PH.k_eStoreSalePage,
              bPopup: !1,
            });
          const f = (0, $.Bw)(t, $.PH.k_eStoreNewsHub, "allowRelative"),
            B = (0, $.Bw)(t, $.PH.k_eStoreUsersNewsHub, "allowRelative");
          if (!t.bLoaded || D || (v && x))
            return (0, s.jsx)("div", {
              className: le().FlexCenter,
              style: { height: "400px" },
          ...
          const P = j?.name || A?.group_name;
          let H = t.GetDescriptionWithFallback(a);
          return (0, s.jsx)(Be, {
            event: t,
            lang: a,
            titleBar: h,
            banner: (0, s.jsx)(Z.v, { appId: t.appid, clanId: u }),
            body: (0, s.jsxs)(w.tH, {
              children: [
                (0, s.jsxs)("div", {
                  ...
                  children: [
                    (0, s.jsx)(ge.r, {
                      crumbs: [
                        { name: (0, T.we)("#BreadCrumbs_AllEvents"), url: B },
                        ...(P
                          ? [
                              {
                                name: (0, T.we)("#BreadCrumbs_GameEvents", P),
                                url: f,
                              },
                            ]
                          : []),
                    ...
                    t.BHasSubTitle(a) &&
                      (0, s.jsx)("div", {
                        className: N().EventDetailsSubTitle,
                        children: t.GetSubTitle(a),
                      }),
                  ],
                }),
                Boolean(t.BEventCanShowBroadcastWidget(g, S)) &&
                  (0, s.jsx)("div", {
                ...
                (0, s.jsxs)("div", {
                  className: (0, C.A)(N().EventColumns, "EventDetail"),
                  children: [
                    (0, s.jsxs)("div", {
                      className: N().EventDetailsDescription,
                      children: [
                        (0, s.jsxs)(w.tH, {
                          children: [
                            t.BHasTag("steam_award_nomination_request") &&
                              (0, s.jsx)(te.EventDisplaySteamAwardNomination, {
                                event: t,
                                lang: a,
                                previewMode: g,
                              }),
                            t.BHasTag("steam_award_vote_request") &&
                              (0, s.jsx)(te.WinterSaleSteamAwardVoteWrapper, {
                                appID: t.appid,
                                bIsEventActionEnabled:
                                  t.BIsEventActionEnabled(S),
                                voteCategories:
                          ...
                          children: (0, s.jsxs)("div", {
                            ...
                            children: [
                              ...
                              Boolean(
                                ...
                                (0, s.jsxs)("div", {
                                  className: (0, C.A)(N().ReadMoreCnt),
                                  children: [
                                    (0, s.jsx)(re.m, { gidEvent: t.GID }),
                                    (0, s.jsx)(Se.Ii, {
                                      className: (0, C.A)(
                                        ie().Button,
                                        "LinkButton",
                                      ),
                                      href: (0, J.k2)((0, je.n4)(t)),
                                      children: (0, T.we)(
                        ...
                        (0, s.jsx)(w.tH, {
                          children: (0, s.jsx)(se._, { event: t }),
                        }),
                        Boolean(t.jsondata.read_more_link) &&
                          (0, s.jsx)("div", {
                            className: (0, C.A)(N().ReadMoreCnt),
                            children: (0, s.jsx)(de.uU, {
                              className: (0, C.A)(ie().Button),
                        ...
                        (0, s.jsx)("span", { className: ie().Clear }),
                        (0, s.jsxs)(w.tH, {
                          children: [
                            Boolean(t.appid) &&
                              (0, s.jsx)(_e.lS, { appid: t.appid }),
                    ...
                    (0, s.jsx)(w.tH, {
                      children: (0, s.jsx)(X, {
                        ...
                        nOverrideStartTime: d,
                        nOverrideEndTime: c,
                        reminder: (0, s.jsx)(ee.j, { eventModel: t, lang: a }),
                        editorInfo: (0, s.jsx)(He, {
                          event: t,
                          bIsOGG: A?.is_ogg ?? Boolean(v),
                        }),
                        meetSteamInfo: (0, s.jsx)(ue, { event: t, lang: a }),
                      }),
                    }),
                  ],
                }),
            ...
            postbody: (0, s.jsxs)(w.tH, { children: [_, p] }),
            footer: (0, s.jsx)(I, {
              appid: t.appid,
              creatorHome: (0, s.jsx)(y.LG, {
                appid: t.appid,
                bSmallFormat: !0,
              }),
            }),
      ...
      function He(e) {
        const { event: t, bIsOGG: a } = e,
          n = (0, R.n)(),
          { data: i } = (0, r.hM)(t.clanSteamID.GetAccountID()),
          o = Boolean(i?.can_edit),
          l = t.clanSteamID,
          c = t.GID,
          p = o && t.BIsPartnerEvent() && t.BIsVisibleEvent(n);
        m.useEffect(() => {
          if (!p) return;
          const e = d().CancelToken.source();
          return (
            x.LoadStatsForEvents(l, [c], e),
            () => e.cancel("EventDisplayEditorInfo cancelled")
          );
        }, [p, l, c]);
        const h = (0, _.q3)(() => p && x.GetStatsFor(l, c));
        return o
          ? (0, s.jsx)(M, {
              event: t,
              bIsOGG: a,
              summary: h ? h.m_stats : void 0,
            })
          : null;
      }
    },
    43068: (e, t, a) => {
      ...
      class m {
        ...
        constructor() {
          ...
          this.ValidateStoreDefault(e)
            ...
            : (l.iA.logged_in && l.TS.EREALM === _.TU.k_ESteamRealmChina) ||
      ...
      (0, r.Cg)([o.sH], m.prototype, "m_objApprovalPriviledge", void 0);
      var p = a(75844),
        h = a(90626),
        v = a(56284),
        u = a(65580),
      ...
      const A = (0, p.PA)((e) => {
          ...
          const { data: o } = (0, v.hM)(r);
          return (
            h.useEffect(() => {
              const e = i().CancelToken.source();
              return (
                (async () => {
                  const t = await m.Get().HintLoadAppApprovalPriviledge();
                  e.token.reason ||
                    a(l.iA.is_support || Boolean(o?.can_edit) || t.bHasAccess);
                })(),
                () => e.cancel("SteamChinaAdminPanel is unmounting")
              );
            }, [r, o]),
            l.iA.is_support || o?.can_edit
              ? (0, s.jsx)(u.g, {
                  eventModel: n,
                  partnerEventStore: e.partnerEventStore,
                  addtionalAdminButtons: t
                    ? [(0, s.jsx)(D, { eventModel: n }, "removesteamchina")]
                    : void 0,
                })
        ...
        D = (e) => {
          ...
          return (0, s.jsx)("div", {
            className: (0, y.A)(S.Button, g.AdminButton, S.ValveOnlyBackground),
            onClick: (a) => {
              let n = !1;
              (0, x.pg)(
                (0, s.jsx)(j.o0, {
                  strTitle: (0, E.we)("#EventAdmin_Moderation_HideEventInSC"),
                      ...
                      (async () => {
                        ...
                        try {
                          const e = `${l.TS.STORE_BASE_URL}/events_admin/ajaxhidefromsteamchina`,
                            s = await i().post(e, a, { withCredentials: !0 });
                          (n =
                            s?.data?.success == c.R ||
                            s?.data?.success == c.Ze),
                            s?.data?.success == c.Ze &&
                  ...
                  children:
                    n &&
                    (0, s.jsx)(w.t, { size: "medium", position: "center" }),
                }),
                (0, b.uX)(a),
              );
            },
            children: (0, E.we)("#EventAdmin_Moderation_HideEventInSC"),
          });
        };
    },
  },
