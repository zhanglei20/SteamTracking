...
(self.webpackChunkstore = self.webpackChunkstore || []).push([
  [8455],
  {
        ...
        return (0, o.n)({
          mutationFn: () =>
            (async function (e, t) {
              ...
              n.Body().set_item_id(l.O4.fromObject(t));
    ...
    26514: (e, t, n) => {
      ...
      function C(e, t, n, C) {
        const p = (0, u.j4)(),
          _ = (0, a.KV)(),
          g = (0, o.jE)(),
          { storeBrowseContext: f, dataLoader: w } = (0, r.yn)(),
          { country: h } = f,
          v = (0, i.Gd)(C);
        return (0, s.n)({
          mutationFn: async () => {
            ...
            let a;
            if ((0, c.c2)(p)) {
              const [r, l] = await (0, m.Jn)(_, h, e, t, n, v);
              if (1 != r) throw `AddToAccountCart failed with ${r}`;
              (a = l.line_item_ids), (0, d.LN)(g, p, l.cart);
            } else {
              if (!(0, c.kx)(p)) throw "Invalid cart type";
              {
                const [r, l] = await (0, m.SI)(_, e ? [e] : void 0, t, n);
                if (1 != r || !l)
          ...
          onMutate: () => {
            ...
            (async () => {
              const e = await g.fetchQuery((0, l.us)(w, n)),
                t =
                  1 == e?.included_appids?.length
                    ? { appid: e.included_appids[0] }
                    : n;
              g.prefetchQuery((0, l.AQ)(w, t)),
                g.prefetchQuery((0, l.rK)(w, t));
            })();
          },
        });
      }
    ...
    99116: (e, t, n) => {
      ...
      const l = (0, n(42475).l)(async function (e) {
        if (r[e]) return r[e]();
      });
      var i,
        o = n(83710);
      ...
      function c(e, t) {
        const {
          ...
          o = new Date(),
          c = new Date(1e3 * e);
        if (c.getFullYear() != o.getFullYear())
          return s(e, { month: n ? "long" : "short" });
        const m = new Date();
        if ((m.setHours(0, 0, 0, 0), r))
          if (c >= m) {
            if ((m.setDate(m.getDate() + 1), c < m))
              return l.Localize("#Time_Today");
            if ((m.setDate(m.getDate() + 1), c < m))
              return l.Localize("#Time_Tomorrow");
          } else if ((m.setDate(m.getDate() - 1), c >= m))
            return l.Localize("#Time_Yesterday");
        const u = { month: n ? "long" : "short", day: "numeric" };
        return i && (u.weekday = "long"), c.toLocaleDateString((0, a.J)(), u);
      }
      function m(e) {
        const t = Math.floor(e / o.Kp.PerYear),
          n = Math.floor(e / o.Kp.PerMonth),
          a = Math.floor((e % o.Kp.PerMonth) / o.Kp.PerDay),
          r = Math.floor((e % o.Kp.PerDay) / o.Kp.PerHour),
          i = Math.floor((e % o.Kp.PerHour) / o.Kp.PerMinute);
        return (
          (e %= o.Kp.PerMinute),
          t > 0
            ? l.Localize("#TimeRemaining_MoreThanOneYear")
            : n > 0
              ? l.Localize("#TimeRemaining_MonthsDays", n, a)
              : a > 0
                ? l.Localize(
    ...
    88680: (e, t, n) => {
      ...
      (i.arabic = () => n.e(3695).then(n.t.bind(n, 93695, 19))),
        ...
        (i.danish = () => n.e(5598).then(n.t.bind(n, 45598, 19))),
      ...
      const o = (0, l.l)(async function (e) {
        if (i[e]) return i[e]();
      });
      var s = n(8527),
        c = n(64753),
      ...
      function d() {
        const [e, t, n] = (0, c.uD)();
        return {
          elDialogElement: a.createElement(
            m.E,
            { active: e },
            a.createElement(u, { closeModal: n }),
          ),
          fnShowLogonDialog: t,
        };
      }
    ...
    40807: (e, t, n) => {
      ...
      function N(e) {
        ...
        return n?.length
          ? r.createElement(
              "button",
              { onClick: a, className: B().ClientSelectDropdown },
              r.createElement(M, null),
            )
          : null;
      }
      function R({ sessions: e, setRemoteDownloadClientId: t }) {
        return r.createElement(
          "ul",
          ...
          ? _
            ...
            : r.createElement(
                ...
                r.createElement(
                  ...
                  u && r.createElement(T.t, { size: "small" }),
      ...
      function Z(e) {
        ...
        if (A.TS.IN_CLIENT || !c) return null;
        const m = n.data?.sessions?.filter((e) => {
      ...
      function W(e) {
        ...
        return r.createElement(
          ...
          r.createElement(
            "a",
            {
              href: `${A.TS.COMMUNITY_BASE_URL}my/games?tab=all&clientid=${t.client_instanceid}`,
            },
      ...
      function O(e) {
        const { appid: t, session: n, setRemoteDownloadRequested: a } = e,
          l = (0, S.we)(t, n.client_instanceid);
        return r.createElement(
          r.Fragment,
          null,
          r.createElement(
      ...
      function G(e) {
        ...
        const C =
          ...
          _ = p || 1 === u.type,
          g = _
            ? (0, s.we)("#Sale_InstallDemo_ttip", u.name || "")
            : p
              ? (0, s.we)("#Sale_CannotInstallDemo_ttip", u.name || "")
              : (0, s.we)("#Loading");
        if ((0, c.$W)()) {
          if (_ && p) {
            ...
            return r.createElement(
              "div",
              { className: n },
              r.createElement(x, { appid: e }),
            );
          }
          return null;
        }
        return !_ && p && u.is_free
          ? r.createElement(m.h, { id: t, className: n })
          : r.createElement(
              i.he,
              {
                toolTipContent: g,
                onClick: (e) => {
                  e.preventDefault(),
                    e.stopPropagation(),
                    _ && (0, l.o)(1 === u.type ? u.appid : C[0], u.name);
                },
                className: (0, o.A)(
                  n,
                  d().DemoButton,
    ...
    3740: (e, t, n) => {
        ...
        if (e.bShowInLibrary)
          return p.createElement(
            ...
            p.createElement(
              ...
              (0, C.we)("#EventDisplay_CallToAction_InLibrary"),
            ),
          );
        if (w && w.is_coming_soon && (!h || !h.packageid)) {
          if (u) return null;
          const e =
          ...
          return p.createElement(
            "div",
            { className: S },
            p.createElement("div", { className: c().StoreSalePriceBox }, e),
          );
        }
        if (v.is_free) {
              ...
              ? _
                ...
                : p.createElement(
                    ...
                    p.createElement(
                      "div",
                      { className: c().StoreSalePriceBox },
                      (0, C.we)("#EventDisplay_CallToAction_FreeDemo"),
                    ),
                  )
              : p.createElement(
                  "div",
                  ...
                  p.createElement(
                    "div",
                    { className: c().StoreSalePriceBox },
                    (0, C.we)("#EventDisplay_CallToAction_FreeToPlay"),
                  ),
                );
          if (h && h.is_free_to_keep && !h.formatted_original_price)
            return p.createElement(
              ...
              p.createElement(
                "div",
                { className: c().StoreSalePriceBox },
                (0, C.we)("#EventDisplay_CallToAction_Free"),
              ),
            );
        }
        if (!h || !h.formatted_final_price) return null;
        let E = h.discount_pct || 0,
          y = s || 2 != v.item_type ? 0 : h.bundle_discount_pct || 0,
          L = h.formatted_final_price;
        const H = (0, r.Nq)(w, h);
        return p.createElement(g, {
          bSingleLineMode: Boolean(t),
          nBaseDiscountPercentage: y,
          nDiscountPercentage: E,
          bIsPrePurchase: H,
          strBestPurchaseOriginalPriceFormatted:
            h.formatted_price_before_bundle_discount ||
      ...
      function g(e) {
        const {
            ...
            strBestPurchaseOriginalPriceFormatted: l,
        ...
        return (
          n &&
            (f = g
              ? (0, C.we)("#Discount_ARIA_Label_SpecialPrice", l)
              : (0, C.we)("#Discount_ARIA_Label", n, l, i)),
          p.createElement(
            "div",
            {
              className: (0, d.A)({
            ...
            Boolean(a && !_) &&
              p.createElement(
                ...
                p.createElement(
                  "span",
                  null,
                  (0, C.we)("#EventDisplay_CallToAction_Prepurchase_Short"),
                ),
              ),
            Boolean(!a && s) &&
              p.createElement(
            ...
            Boolean(r && !g) &&
              p.createElement(
                ...
                p.createElement(
                  u.Gq,
                  { toolTipContent: (0, C.we)("#Sale_Bundle_Discount_ttip") },
                  p.createElement(
                    "span",
            ...
            Boolean((n || r) && l && !g)
              ...
              : p.createElement("div", { className: c().StoreSalePriceBox }, i),
          )
        );
      }
    },
    52471: (e, t, n) => {
      "use strict";
      n.d(t, { M4: () => s, hg: () => m, hl: () => o, kB: () => i });
      var a = n(8527),
        r = n(39777),
        l = n(38535);
      n(90626);
      function i(e) {
        const { data: t } = (0, r.Yo)(e),
          n = (0, l.dy)();
        if (!t) return;
        const a = [...(t.highlights || []), ...(t.other_trailers || [])];
        return n ? a.filter((e) => !!e.all_ages) : a;
      }
      function o(e) {
    ...
    80696: (e, t, n) => {
      ...
      var a = n(8527),
        ...
        m = n.n(c);
      function u(e) {
        const { id: t, active: n, bIsHoverMode: l, bGrowOnHover: c } = e,
          { data: d } = (0, r.J$)(t),
          C = o.useRef(0),
          p = o.useRef(null);
        o.useLayoutEffect(() => {
          n && p.current && (p.current.currentTime = C.current);
        }, [n]);
        const _ = (0, s.kB)(n ? t : void 0);
        if ((l && a.TS.IN_MOBILE) || !n) return null;
        if (!d || !d.visible || !_) return null;
        const g = _.filter((e) => e.microtrailer && e.microtrailer.length > 0);
        if (0 === g.length)
          return d &&
            ...
            ? o.createElement(u, {
                ...e,
                id: { appid: d.related_items.parent_appid },
              })
            : null;
        const f = g[0];
        return o.createElement(
          "video",
          {
            className: i()(m().CapsuleMicroTrailer, c && m().GrowOnHover),
            loop: !0,
            muted: !0,
            controls: !1,
            autoPlay: !0,
    ...
    5309: (e, t, n) => {
      ...
      function o(e) {
        ...
        if (e && e.is_coming_soon) {
          if (e.coming_soon_display) return (0, l.d)(e);
    ...
    30020: (e, t, n) => {
      ...
      function i(e, t) {
        if (!e) return !1;
        const n = r(e);
        return !!n && !e.is_coming_soon && n + l * a.Kp.PerDay > t;
      }
      function o(e, t) {
    ...
    82415: (e, t, n) => {
      ...
      const p = (e) => {
        ...
        return a.createElement(
          l.x_,
          { onEscKeypress: t, className: d().GotSteamDialog },
          a.createElement(
            r.UC,
            null,
            ...
            a.createElement(
              ...
              a.createElement(
                ...
                a.createElement(
                  "a",
                  {
                    ...
                    onClick: t,
                    className: (0, s.A)(d().Button, d().LeftButton),
                  },
                  a.createElement(
                    "div",
              ...
              a.createElement(
                "div",
                { className: d().Footer },
                a.createElement(o.Qte, { className: d().Logo }),
    ...
    20713: (e, t, n) => {
      ...
      (0, r.Cg)([o.oI], c.prototype, "OnFocusNavigationChanged", null),
        (0, r.Cg)([o.oI], c.prototype, "SetActionDescriptionsFromMap", null);
    },
    54906: (e, t, n) => {
      "use strict";
      n.d(t, {
      ...
      class g {
        ...
        async InternalLoadAppCompatability(e) {
          ...
          try {
            ...
            const r = await u().get(a, { params: n, withCredentials: !0 });
      ...
      function B(e) {
        ...
        const d = r.steam_deck_compat_category || 0;
        return o.createElement(
          "div",
          { className: (0, S.A)(H().LearnMoreCtn, "LearnMoreCtn") },
          o.createElement(s.$o, { category: d }),
          o.createElement(
            a.Ii,
            { onClick: m },
            o.createElement(
              ...
              (0, E.we)("#SteamDeckVerified_Store_CompatSectionHeader_Desktop"),
            ),
          ),
          o.createElement(
            w.EN,
            { active: c },
            o.createElement(N, { nAppID: n.appid, closeModal: u }),
          ),
        );
      }
      function k(e) {
        ...
        return o.createElement(
          a.Ii,
          {
            className: n,
            onClick: () => {
              l ? l() : t && (window.location.href = t);
            },
          },
          r &&
            o.createElement("div", { className: H().DeveloperComments_Icon }),
          o.createElement(
            "div",
            {
              className: r
      ...
      function N(e) {
        const { nAppID: t, closeModal: n } = e,
          a = (function (e) {
            const [t, n] = o.useState(g.Get().GetCompatabilityResultForApp(e));
            return (
              (0, p.hL)(g.Get().GetCallbackForAppList(e), n),
              o.useEffect(() => {
        ...
        return o.createElement(
          ...
          o.createElement(
            ...
            o.createElement(
              ...
              a
                ? o.createElement(v.A, { titleId: l, results: a })
                : o.createElement(b.t, {
                    size: "medium",
                    position: "center",
      ...
      function D(e) {
        ...
        if (0 == n)
          return o.createElement(
            "div",
            { id: t, className: H().CompatibilityDetailRatingSummary },
            a
              ? (0, E.PP)(
                  "#SteamDeckVerified_DescriptionHeader_Unknown_WithAppName",
                  o.createElement("b", null, (0, y.EK)(a)),
                )
              : (0, E.we)("#SteamDeckVerified_DescriptionHeader_Unknown"),
          );
        let l = "",
          i = null;
        switch (n) {
        ...
        const s = o.createElement("span", { className: i }, (0, E.we)(T(n))),
          c = o.createElement(
            "span",
          ...
          m = a
            ...
            : (0, E.PP)("#SteamDeckVerified_DescriptionHeader", s, c);
        return o.createElement(
          "div",
          { id: t, className: H().CompatibilityDetailRatingSummary },
          m,
      ...
      function V(e) {
        ...
        if (0 == n)
          return o.createElement(
            ...
            a
              ...
              : (0, E.we)("#SteamOSCompatibility_DescriptionHeader_Unknown"),
          );
        let l = "",
          i = null;
        switch (n) {
        ...
        const s = o.createElement("span", { className: i }, (0, E.we)(A(n))),
          c = o.createElement(
            "span",
            { className: H().CompatibilityDetailRatingSummary },
            (0, E.we)(r || l),
          ...
          m = a
            ...
            : (0, E.PP)("#SteamOSCompatibility_DescriptionHeader", s, c);
        return o.createElement(
          "div",
          { id: t, className: H().CompatibilityDetailRatingSummary },
          m,
    ...
    43976: (e, t, n) => {
          ...
          g = (0, c.useCallback)(() => {
            if (r) {
              ...
              r.related_items?.parent_appid &&
                ...
                (0, E.Id)(window, `steam://run/${e}`);
            }
          }, [r]);
        if (!r || !u || !d || 8 == r.type) return null;
        const f =
          r.is_free ||
          (null != d.final_price_in_cents && "0" == d.final_price_in_cents) ||
          (d.discount_pct && d.discount_pct >= 100);
        if (1 == r.item_type)
          if (10 == r.type) {
            if (!C)
            ...
            if (!C.inventory_available)
              return c.createElement(
                "div",
                { className: (0, y.A)(N().ActionOutOfStock, n) },
                c.createElement(
                  "span",
                  null,
                  " ",
                  (0, L.we)("#Sale_ReserveExhausted"),
                ),
              );
          } else if (f && r.included_appids && r.included_appids.length > 1)
            return null;
        if (0 == r.item_type) {
          if (u.is_coming_soon && !d.packageid) return null;
          if (p && 10 === r.type) return null;
          if (!p && d.is_free_to_keep) {
            if (H.TS.IN_CLIENT || "store" != (0, H.yK)()) {
              const e = `${H.TS.IN_CLIENT ? "steam://openurl/" : ""}${_}`;
              return c.createElement(
                "div",
                {
                  onClick: (t) => (0, E.Id)(t, e),
                  className: (0, y.A)(N().Action, n),
                },
                c.createElement(
                  "span",
                  null,
                  (0, L.we)("#EventDisplay_CallToAction_VisitStore"),
                ),
              );
            }
            {
              const e = (0, m.wJ)(
                `${H.TS.STORE_BASE_URL}freelicense/addfreelicense`,
                a,
              );
              return c.createElement(
                "form",
                ...
                c.createElement("input", {
                  type: "hidden",
                  name: "sessionid",
                  value: H.TS.SESSIONID,
                }),
                c.createElement(
                  "button",
                  { className: (0, y.A)(N().Action, n), type: "submit" },
                  (0, L.we)("#EventDisplay_CallToAction_AddToAccount"),
                ),
              );
            }
          }
          if ((p || f) && !r.is_coming_soon) {
            ...
            return (
              ...
              c.createElement(
                "div",
                { className: (0, y.A)(N().Action, n), onClick: g },
                c.createElement("span", null, e),
              )
            );
          }
          if ("" == d.formatted_final_price)
            return c.createElement(
              "a",
              { href: _, className: (0, y.A)(N().Action, n) },
              (0, L.we)("#EventDisplay_CallToAction_VisitStore"),
            );
        }
        return c.createElement(M, {
          className: n,
          storeItemBestPurchaseOption: d,
      ...
      function M(e) {
        const {
          ...
          l = (0, o.n9)(),
          { mutate: i } = (0, r.A)(n?.packageid, n?.bundleid, !1, l.feature);
        return c.createElement(
          "div",
          { className: (0, y.A)(N().Action, t), onClick: () => i() },
          c.createElement("span", null, (0, L.we)("#Store_AddToCart")),
        );
      }
    },
    52050: (e, t, n) => {
      ...
      function g(e) {
        const { id: t, bTruncateTotalReviews: n, bShowTooltip: p } = e,
          ...
          { data: h } = (0, l.J$)(w);
        if (!g || !f) return null;
        if (1 == f.type && !(0, r.J)(h)) return null;
        let v = g.summary_unfiltered || g.summary_filtered,
          b = "#ReviewScore_UserReviewScoreAria",
          S = !1;
        const E = (0, d.we)("#Language_" + C.TS.LANGUAGE);
        if (
          (s.Fm.Get().BShowFilteredUserReviewScores() &&
            (g.summary_language_specific
              ? ((S = !0),
                (b = "#ReviewScore_UserReviewScoreAria_LanguageSpecific"),
        ...
        y =
          v.review_score > 0 && v.review_score < 5
            ...
            : 5 == v.review_score
              ? _().ReviewScoreMixed
              : _().ReviewScoreHigh;
        const L = `${C.TS.STORE_BASE_URL}app/${f.appid}/#app_reviews_hash`,
          H = o.createElement(
            "div",
            ...
            o.createElement(
              "div",
              {
                ...
                "aria-label": (0, d.we)(b, v.review_score_label, E),
              },
              v.review_score_label,
            ),
            o.createElement(
              "div",
              {
                ...
                "aria-label": (0, d.we)(
                  ...
                  v.review_count.toLocaleString((0, a.J)()),
                ),
              },
              "(",
              n
            ...
            !n &&
              o.createElement(
                ...
                " ",
                (0, d.we)("#GameHover_UserReviewsHeader"),
              ),
          );
        let B = "#ReviewScore_PercentPositive";
        if (2 === f.item_type) B = "#ReviewScore_PercentPositive_bundle";
        ...
        return o.createElement(
          c.q,
          { url: L, className: (0, u.A)(_().ReviewScore, "ReviewScore") },
          p &&
    ...
    28045: (e, t, n) => {
      ...
      function w(e) {
        const { id: t, snr: n, classOverride: g, styleOverride: w } = e,
          { data: h } = (0, l.J$)(t),
          { elDialogElement: v, fnShowLogonDialog: b } = (0, r.l)(),
          [S, E] = (0, c.useState)(() =>
            h && (1 == h.type || 12 == h.type) && h.related_items?.parent_appid
          ...
          { bIsOwned: H } = (0, i.ZJ)(y),
          [B, k] = (0, c.useState)(!1),
          N = (0, d.m)("GameHoverWishlistButton"),
          { mutateAsync: R } = (0, s.s)(S, !L, n);
        (0, c.useEffect)(() => {
          t &&
            "appid" in t &&
            (1 == h?.type || 12 == h?.type) &&
            E(h.related_items?.parent_appid || t.appid);
        }, [h, t]);
        const M = (0, c.useCallback)(
          async (e) => {
            e.preventDefault(),
              e.stopPropagation(),
              _.iA.logged_in
                ? (k(!0), await R(), N.token.reason || k(!1))
                : b();
          },
          [N.token.reason, b, R],
        );
        return H && 10 != h?.type
          ...
          : c.createElement(
              ...
              L ? c.createElement(u.qnF, null) : c.createElement(u.T4m, null),
              c.createElement(
                "div",
                {
                  className: (0, C.A)(
                    f().WishlistButtonText,
                    B && f().WishlistLoadingText,
                    "WishlistButtonText",
                  ),
                },
                (0, p.we)(
    ...
    72237: (e, t, n) => {
      ...
      var a = n(39777),
        ...
        m = n(78327);
      function u(e) {
        const { id: t, strClassName: n, bMinimizePlatforms: l } = e,
          { data: u } = (0, a.qI)(t);
        if (!u) return null;
        if (l) {
          let e =
    ...
    99956: (e, t, n) => {
      ...
      function C(e) {
        const { tagid: t, className: n } = e,
          i = (0, l.MB)(t, u.TS.LANGUAGE);
        if (!i) return null;
        const m = (0, r.ww)((0, r.sf)(u.TS.LANGUAGE)),
          d = `${u.TS.STORE_BASE_URL}tags/${m}/${i}`;
        return a.createElement(
          s.q,
          { url: d, className: (0, c.A)(o().Tag, "WidgetTag", n) },
          i,
        );
      }
      function p(e) {
        const { tagid: t, className: n, bNoStoreLinks: i } = e,
          m = (0, r.ww)((0, r.sf)(u.TS.LANGUAGE)),
          d = (0, l.MB)(t, u.TS.LANGUAGE),
          C = `${u.TS.STORE_BASE_URL}tags/${m}/${d}`;
        return d
          ? i
            ? a.createElement(
                "div",
                { className: (0, c.A)(o().Tag, "WidgetTag", n) },
                d,
              )
            : a.createElement(
                s.q,
                { url: C, className: (0, c.A)(o().Tag, "WidgetTag", n) },
                d,
              )
          : null;
      }
    ...
    90595: (e, t, n) => {
      ...
      function u(e) {
        const {
          ...
          u = s ? n : n ? (0, c.Ps)(n, m.TS.STORE_BASE_URL) : void 0,
          d = (0, r.aL)(u);
        return d
          ? l.createElement(
              a.Ii,
          ...
          : l.createElement("span", { style: i, className: t }, o);
      }
      function d(e) {
        const { section: t } = e;
    ...
    47235: (e, t, n) => {
      ...
      const p = (0, i.PA)((e) => {
        ...
        return o.createElement(
          ...
          {
            onClick: (e) => {
              e.preventDefault(), m ? (0, c.o)(t, p?.name) : _();
            },
            className: g,
          },
          (0, C.we)(m ? "#Sale_PlayNow" : "#Sale_AddToLibrary"),
        );
      });
    },
    44986: (e, t, n) => {
      ...
      function C(e) {
        const t = (0, c.A)(
            null != e.size ? u(e.size) : u(r.Medium),
    ...
    27581: (e, t, n) => {
      ...
      class E extends h.Message {
        ...
        constructor(e = null) {
          super(),
            E.prototype.frame_rates || b.Sg(E.M()),
        ...
        static M() {
          return (
            E.sm_m ||
              (E.sm_m = {
                proto: E,
                fields: { frame_rates: { n: 1, c: y, r: !0, q: !0 } },
              }),
            E.sm_m
          );
        }
      ...
      class y extends h.Message {
        ...
        constructor(e = null) {
          super(),
            y.prototype.clusterid || b.Sg(y.M()),
            h.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      function L(e) {
        ...
        let h = s ?? {},
          ...
          b = null;
        t.steam_deck_blog_url &&
          ((h.onOptionsActionDescription = (0, p.we)(
        ...
        if (!t.resolved_items?.length) {
          ...
          return i.createElement(
            r.Z,
            {
              ...
              focusableIfEmpty: m,
              noFocusRing: !0,
              className: u().CompatibilityDetailsContainer,
              ...h,
            },
            i.createElement(
              "div",
              ...
              i.createElement(
                "div",
                { id: n, className: u().DialogHeader },
                i.createElement("div", { className: u().DialogTitle }, e),
                i.createElement(
                  "div",
                  { className: u().AppTitleCategory },
        ...
        if (S || _) {
          const n = (0, o.z5)(t.resolved_category),
            a = (0, o._R)(t.steamos_resolved_category),
            r = (e) =>
            ...
            l = [
              ...
              },
              {
                ...
                contents: i.createElement(
                  g.tH,
                  null,
                  i.createElement(B, { ...e, deckBlogContent: b }),
                ),
                onClick: r,
              },
            ];
          return i.createElement(f.V, {
            tabs: l,
            classNameCtn: u().CompatibilityTabs,
            startingTab: S ? "steamos" : "steamdeck",
          });
        }
        return i.createElement(k, { ...e, deckBlogContent: v });
      }
      function H(e) {
        const {
            titleId: t,
        ...
        return (
          ...
          i.createElement(
            ...
            {
              className: w
                ? u().CompatibilityDetailsContainer
                : u().CompatibilityDetailsContainerDesktop,
              ...h,
            },
            i.createElement(
              "div",
              ...
              i.createElement(
                "div",
                { id: t, className: u().DialogHeader },
                i.createElement("div", { className: u().DialogTitle }, n),
                i.createElement("div", { className: u().AppTitleCategory }, s),
              ),
              c,
            ),
            m,
            i.createElement(
              l.Qg,
              {
                ref: f,
                className: g()
                  ? u().CompatibilityDetailsInterior_Scroll
                  : u().CompatibilityDetailsInterior_NoScroll,
              },
              i.createElement(
                r.Z,
      ...
      function B(e) {
        const { titleId: t, descriptionId: n, results: a, appName: r } = e,
          ...
          m = a.steamos_resolved_items && a.steamos_resolved_items?.length > 0;
        return i.createElement(
          H,
          {
            titleId: t,
          ...
          i.createElement(
            ...
            m &&
              i.createElement("div", {
                className: u().CompatibilityDetailsSeparator,
              }),
            a.steamos_resolved_items &&
              a.steamos_resolved_items
                ...
                .map((e) =>
                  i.createElement(
                    "div",
                    {
                      ...
                      className: u().CompatibilityDetailsRow,
                    },
                    i.createElement(M, { displaytype: e.display_type }),
                    i.createElement("span", null, (0, p.we)(e.loc_token)),
                  ),
                ),
            l &&
              i.createElement(
                "div",
                { className: u().CompatibilityNotes },
                a.steamos_resolved_items
                  ?.filter((e) => 1 == e.display_type)
                  .map((e) =>
                    i.createElement(
      ...
      function k(e) {
        const { titleId: t, descriptionId: n, results: a, appName: r } = e,
          l = -1 !== a.resolved_items?.findIndex((e) => 1 == e.display_type),
          o = i.createElement(c.UN, {
            id: n,
            category: a.resolved_category,
            appName: r,
          }),
          s = i.createElement(c.Ez, { category: a.resolved_category }),
          m = a.resolved_items && a.resolved_items?.length > 0;
        return i.createElement(
          H,
          {
            titleId: t,
              ...
              a.resolved_items
                ...
                .map((e) =>
                  i.createElement(
                    ...
                    i.createElement(R, { displaytype: e.display_type }),
                    i.createElement("span", null, (0, p.we)(e.loc_token)),
                  ),
                ),
            l &&
                ...
                a.resolved_items
                  ...
                  .map((e) =>
                    i.createElement(
                      ...
                      {
                        key: e.loc_token + e.display_type,
                        className: u().CompatibilityDetailsNoteRow,
                      },
                      i.createElement("span", null, (0, p.we)(e.loc_token)),
                    ),
                  ),
      ...
      function N(e) {
        ...
        if (a) {
          ...
          return i.createElement(
            "div",
            { className: u().CompatibilityDetailRatingSummary },
            e,
            i.createElement(
              "div",
              { className: u().DeveloperBlogYButton },
              i.createElement(d.$m, { button: s.g4.Y, type: d.wt.Knockout }),
            ),
          );
        }
        const r =
        ...
        return i.createElement(
          ...
          i.createElement(
            "a",
            { href: t, className: u().DeveloperBlockLinkDesktop },
            (0, p.we)("#SteamDeckVerified_ViewDeveloperPost"),
          ),
        );
      }
      function R(e) {
        ...
        switch (t) {
          case 4:
            return i.createElement(C.o5Q, {
              className: u().CompatibilityDetailsResultIcon,
            });
          case 3:
            return i.createElement(C.aVR, {
              className: u().CompatibilityDetailsResultIcon,
            });
          case 2:
            return i.createElement(C.jIP, {
              className: u().CompatibilityDetailsResultIcon,
            });
          case 0:
            return i.createElement(C.WX$, {
              className: u().CompatibilityDetailsResultIcon,
            });
          case 1:
            return (
      ...
      function M(e) {
        ...
        switch (t) {
          case 3:
            return i.createElement(C.ZjT, {
              className: u().CompatibilityDetailsResultIcon,
            });
          case 1:
            return i.createElement(C.bcZ, {
              className: u().CompatibilityDetailsResultIcon,
            });
          default:
            return null;
        ...
        render() {
          ...
          return r.createElement(
            ...
            r.createElement(
              p.Z,
              null,
              t && r.createElement(p.Z, null, t.contents),
            ),
          );
        }
      }
      (0, a.Cg)([_.o], g.prototype, "OnTabClick", null);
