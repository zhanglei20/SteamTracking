  ...
  [62733],
  {
    ...
    28491: (e, t, n) => {
      ...
      var i = n(7850),
        ...
        l = n(78327);
      function d(e) {
        const { underline: t = "auto", focusable: n, navProps: r, ...c } = e,
          d = (0, l.Qn)(),
          m = n ?? r?.focusable ?? !!c.href,
          _ = (0, a.mz)({ ...c, underline: t, className: s.TextLink }, u);
        return d && (m || r)
          ? (0, i.jsx)(o.Ii, { ..._, ...(r || {}), focusable: m })
          : (0, i.jsx)("a", { ..._ });
      }
      const u = [
        ...r.Ae,
      ...
      function m(e) {
        const { underline: t = "auto", focusable: n, navProps: r, ...o } = e,
          d = (0, l.Qn)(),
          m = n ?? r?.focusable ?? !!o.onClick,
          _ = (0, i.jsx)("span", {
            role: "button",
            ...(0, a.mz)(
              { ...o, underline: t, className: s.TextLinkButton },
              u,
            ),
          });
        return d && (m || r)
          ? (0, i.jsx)(c.J, { ...(r || {}), focusable: m, children: _ })
          : _;
      }
    },
    90485: (e, t, n) => {
        ...
        return (0, c.n)({
          mutationFn: async () =>
            await (async function (e, t, n) {
              if ((0, l.c2)(t)) {
                const t = i.w.Init(s.tj);
                t.Body().set_line_item_id(n);
                const r = await s.t8.RemoveItemFromCart(e, t);
                return (0, _.WZ)(), r.Body().toObject();
              }
              {
                const s = i.w.Init(r.VJ);
                s.Body().set_gidlineitems([n]),
                  s.Body().set_gidshoppingcart(t.gid);
                const a = await r.Q2.RemoveLineItems(e, s);
                return (0, _.WZ)(), a.Body().toObject();
              }
            })(t, d, e),
          onSuccess: (e) => {
            "cart" in e ? (0, m.LN)(n, d, e.cart) : (0, m.Cd)(n, d);
          },
        });
      }
      function f() {
        ...
        return (0, c.n)({
          mutationFn: async () =>
            await (async function (e, t) {
              if ((0, l.c2)(t)) {
                const t = i.w.Init(s.HK);
                return (await s.t8.DeleteCart(e, t)).BSuccess();
              }
              {
                ...
                if (n && n.line_items && n.line_items.length) {
                  ...
                  return (
                    ...
                    s.Body().set_gidshoppingcart(t.gid),
                    (await r.Q2.RemoveLineItems(e, s)).BSuccess()
                  );
                }
                return !1;
              }
            })(e, n),
          onSuccess: () => (0, m.Cd)(t, n),
        });
      }
    },
    13904: (e, t, n) => {
        ...
        return (0, l.n)({
          mutationFn: (e) =>
            (async function (e, t, n, o, c, l) {
              if ((0, m.c2)(t)) {
                const t = i.w.Init(s.Bk);
                t.Body().set_line_item_id(n),
                  t.Body().set_user_country(a.iA.country_code),
                  c && t.Body().set_gift_info(r.$z.fromObject(c)),
                  o && t.Body().set_flags(s.Eo.fromObject(o)),
                  l && t.Body().set_apply_gidcoupon(l);
                const d = await s.t8.ModifyLineItem(e, t);
                return (
                  d.BSuccess() ||
                    console.warn(
              ...
              {
                const s = i.w.Init(_.ic);
                s.Body().set_gidlineitem(n),
                  s.Body().set_gidshoppingcart(t.gid),
                  c
                    ? s.Body().set_gift_info(r.$z.fromObject(c))
                    : o?.is_gift &&
                      s
                        .Body()
                        .set_gift_info(
                ...
                const a = await _.Q2.ModifyLineItem(e, s);
                return (
                  a.BSuccess() ||
                    console.warn(
          ...
          onMutate: async (e) => {
            await p.cancelQueries({ queryKey: f });
            const t = p.getQueryData(f);
            return (
              p.setQueryData(f, (t) => ({
                ...(t ?? {}),
                line_items:
          ...
          onSuccess: (e) => {
            "cart" in e ? (0, u.LN)(p, t, e.cart) : (0, u.Cd)(p, t);
          },
          onError: (e, t, n) => {
            n?.previousCart && p.setQueryData(f, n.previousCart);
          },
        });
      }
    },
    70343: (e, t, n) => {
      ...
      function _(e) {
        const { text: t, children: n, className: r, noWrap: a } = e;
        return (0, i.jsx)(s.Z, {
          "flow-children": "row",
          className: c()(
      ...
      function p(e) {
        const { placeholder: t, className: n, children: s } = e;
        return (0, i.jsx)(r.YZ, {
      ...
      function f() {
        return (0, i.jsx)(p, { placeholder: !0, children: (0, i.jsx)(h, {}) });
      }
      function h() {
        return (0, i.jsx)("div", {
    ...
    8364: (e, t, n) => {
      ...
      function p(e, t) {
        const n = (0, a.KV)(),
          p = (0, m.j4)(),
          { storeBrowseContext: f, cacheStoreItemData: h } = (0, o.yn)();
        return (0, l.I)({
          queryKey: (0, _.m4)(p, e),
          queryFn: async () =>
            (async function (e, t, n, a, o, l) {
              const d = i.w.Init(s.vL);
              (0, u.kx)(t) || (0, u.uU)(t)
                ? (d.Body().set_gidshoppingcart(t.gid),
                  a && d.Body().set_gift_info(r.$z.fromObject(a)))
                : (0, u.sb)(t) && d.Body().set_gidreplayoftransid(t.gid);
              (0, c.rV)(n, d), o && (0, c.Bn)(d, o);
              const m = await s._o.ValidateCart(e, d);
              m.BSuccess() ||
                console.warn(
                  `Failed to validate shopping cart: ${m.GetEResult()}`,
                );
              if (o && l)
                for (const e of m.Body().cart_items()) l(e.store_item(), o);
              return m.Body().toObject();
            })(n, p, f, e, t, h),
          staleTime: 1 / 0,
          enabled: d.iA.logged_in || !(0, u.c2)(p),
        });
      }
    },
    93332: (e, t, n) => {
              ...
              queryFn: async () => {
                ...
                return n
                  ...
                  ?.filter((e) => {
                    ...
                    return (
                      (e.efriendrelationship() == s._UC ||
                        e.efriendrelationship() == s.Ec7) &&
    ...
    11333: (e, t, n) => {
      ...
      function o(e, t) {
        return new (a())(
          async (t) => {
            const n = [...t],
              s = await i.xtC.GetPlayerLinkDetails(e, { steamids: n }),
              r = new Map();
            return (
              s
                .Body()
    ...
    49845: (e, t, n) => {
      ...
      var r = n(90626);
      n(7850);
      const a = (0, r.createContext)({ instances: {}, factories: {} });
      function o(e, t) {
        ...
        const c = (o?.factories[i] ?? t)();
        return ((o ?? n).instances[i] = c), c;
      }
    },
    44165: (e, t, n) => {
      "use strict";
      n.d(t, { HD: () => d, f1: () => p, s4: () => f, sB: () => _ });
      var i = n(34629),
        s = n(14947),
        r = n(19367),
        a = n.n(r),
      ...
      (0, i.Cg)([s.sH], l.prototype, "nOverrideDateNow", void 0);
      const d = new l();
      window.g_EventCalendarDevFeatures = d;
      const u = new Date(),
        m = Math.floor(u.getTime() / 1e3);
      function _() {
        return d.nOverrideDateNow ?? m;
      }
      function p() {
        return o.useMemo(() => _(), []);
      }
      function f() {
        return o.useMemo(() => d.GetTimeNowWithOverrideAsDate(), []);
      }
    },
    41471: (e, t, n) => {
      "use strict";
      n.d(t, { DW: () => _, js: () => m, mK: () => h, tb: () => f });
      var i = n(90626),
        s = n(80902),
        r = n(54806),
        a = n(22837),
      ...
      function m(e) {
        const t = (0, o.KV)(),
          n = i.useContext(p);
        return (0, s.I)(h(n, t, e));
      }
      function _(e) {
        const t = (0, o.KV)(),
          n = i.useContext(p);
        return (0, r.E)({ queries: e.map((e) => h(n, t, e)) });
      }
        ...
        loadPersonaState: async (e, t) => {
          ...
          return (function (e, t) {
            ...
            const i = t?.public_data,
              s = t?.private_data;
            (n.m_bInitialized = !!t),
              (n.m_ePersonaState = s?.persona_state ?? a.cU3),
              (n.m_strAvatarHash = i?.sha_digest_avatar
                ? (0, c.Kx)(i.sha_digest_avatar)
                : l.dV),
              (n.m_strPlayerName = i?.persona_name ?? e.ConvertTo64BitString()),
              (n.m_strAccountName = s?.account_name),
              s?.persona_state_flags &&
                (n.m_unPersonaStateFlags = s?.persona_state_flags);
            s?.game_id && (n.m_gameid = s?.game_id);
            s?.game_server_ip_address &&
              (n.m_unGameServerIP = s?.game_server_ip_address);
            s?.lobby_steam_id && (n.m_game_lobby_id = s?.lobby_steam_id);
            s?.game_extra_info && (n.m_strGameExtraInfo = s?.game_extra_info);
            i?.profile_url && (n.m_strProfileURL = i.profile_url);
            return n;
          })(d.b.InitFromAccountID(e), n);
        },
      });
      function f() {
      ...
      function h(e, t, n) {
        const i = "string" == typeof n ? new d.b(n).GetAccountID() : n;
        return {
    ...
    31335: (e, t, n) => {
          ...
          children: (0, i.jsxs)(s.Z, {
            ...
            children: [
              (0, i.jsxs)("div", {
                ...
                children: [
                  (0, i.jsx)("div", {
                    ...
                    children: t.has_live_broadcast && (0, i.jsx)(c.K, {}),
                  }),
              ...
              (0, i.jsxs)("div", {
                ...
                children: [
                  (0, i.jsx)("div", {
                    className: p.SpotlightTitle,
                    children: t.title,
                  }),
                  (0, i.jsx)("div", {
                    className: p.SpotlightBody,
                    children: t.body,
                  }),
                  (0, i.jsx)("div", {
      ...
      function x(e) {
        const { dailyDeal: t } = e,
          ...
          a = (0, r.SW)(t.item?.type ?? "application"),
          o = (0, f.J$)((0, h.Jz)({ item_type: a, id: t.item?.id }));
        return (0, i.jsx)(l.A, {
          appID: "app" == t.item?.type ? t.item.id : void 0,
          feature: "daily-deal",
          children: (0, i.jsxs)(s.Z, {
      ...
      const j = (e) => {
        ...
        if (!t) return null;
        const s = t.hide_discount_percent_for_compliance;
        return n
          ...
          : null == t.final_price || "" === t.final_price
            ? null
            : null != t.bundle_discount && t.bundle_discount > 0 && !s
              ? (0, i.jsx)("div", {
    ...
    32541: (e, t, n) => {
        ...
        return (0, i.jsx)(p.tH, {
          children: (0, i.jsx)(f.Ay, {
            ...
            children: (0, i.jsxs)(s.Z, {
              className: (0, l.A)(
                g.DevSummaryCtn,
                C ? g.SmallFormat : g.LargeFormat,
                w ? g.MinimalDisplay : "",
              ),
              "flow-children": "row",
              children: [
                !o && (0, i.jsx)("span", { className: g.Title, children: b }),
                (0, i.jsxs)("div", {
                  className: g.DevSummaryWidgetCtn,
                  children: [
                    (0, i.jsx)("div", {
                    ...
                    (0, i.jsxs)("div", {
                      className: (0, l.A)(g.DevSummaryContent),
                      children: [
                        (0, i.jsxs)("div", {
                          ...
                          children: [
                            (0, i.jsx)(c.m, {
                              ...
                              children: (0, i.jsx)("img", {
                                className: (0, l.A)(g.Avatar, "Avatar_Trgt"),
                                  ...
                                  children: [
                                    ...
                                    Boolean(n) &&
                                      (0, i.jsx)("div", {
                                        ...
                                        children: S.GetTagLine(),
                                      }),
                                  ],
                                }),
                                (0, i.jsx)("div", {
                                  className: (0, l.A)({
                                    [j.FlexColumnContainer]: C,
                                    [j.FlexRowContainer]: !C,
                                    [g.SocialFollowersCtn]: !0,
                                  }),
                                  children: (0, i.jsxs)("div", {
                                    className: (0, l.A)(g.FollowBtnCtn),
                                    children: [
                                      Boolean(!v) &&
                                        (0, i.jsx)(x.of, {
      ...
      function v(e) {
        const { appid: t, bSmallFormat: n } = e,
          [s] = (0, o.t7)(t, { include_basic_info: !0 });
        if (!t) return null;
        if (!s)
          return (0, i.jsx)("div", {
            className: g.DevSummaryWidgetCtn,
        ...
        let r;
        const a = s.GetAllDeveloperCreatorClans();
        if (a?.length > 0)
        ...
        return r
          ? (0, i.jsx)(p.tH, {
              children: (0, i.jsx)(C, { creatorID: r, bSmallFormat: n }),
            })
          : null;
      }
    },
    10962: (e, t, n) => {
      ...
      const l = (e) => {
        switch (e.display_style) {
          case i.k_eFinal:
            return (
              ...
              (0, s.jsx)("span", { children: e.formatted_final_price })
            );
          case i.k_eOriginal:
            const t = e.formatted_orig_price || e.formatted_final_price;
            return Boolean(t) && (0, s.jsx)("span", { children: t });
        }
        ...
        return (0, s.jsxs)("span", {
          className: (0, o.A)({
            [c.StoreSalePriceWidget]: !0,
            ["" + e.className]: Boolean(e.className),
            [c.StoreSaleReservationPrice]: t,
          }),
          children: [
            Boolean(e.discount_percent && !n) &&
              (0, s.jsx)("span", {
                className: (0, o.A)(
                  c.StoreSaleDiscountBox,
                  "StoreSaleDiscountBox",
                  e.bDiscountFromCoupon && c.FromCoupon,
                ),
            ...
            Boolean(e.discount_percent && n) &&
              (0, s.jsx)("div", {
                ...
                children: (0, s.jsx)(a.XH_, {}),
              }),
            Boolean(e.formatted_final_price) &&
              (Boolean(e.discount_percent && e.formatted_orig_price)
                ? (0, s.jsxs)("div", {
                    className: (0, o.A)({
                      [c.StoreSaleDiscountedPriceCtn]: !0,
                      bbcode_price_ctn: r,
                    }),
                    children: [
                      (0, s.jsx)("div", {
                        className: (0, o.A)({
                          [c.StoreOriginalPrice]: !0,
                          StoreOriginalPrice: !0,
                          bbcode_price_orig: r,
                        }),
                        children: e.formatted_orig_price,
                      }),
                      (0, s.jsx)("div", {
                        className: (0, o.A)({
                          [c.StoreSalePriceBox]: !0,
                          bbcode_price_box: r,
                          [c.StoreSaleReservationPriceBox]: t,
                          bbcode_price_final: r,
                        }),
                        children: e.formatted_final_price,
                      }),
                    ],
                  })
                : (0, s.jsx)("div", {
      ...
      function u(e) {
        ...
        return (0, s.jsx)(d, { packageID: t, display_style: n });
      }
      function m(e) {
        const [t] = (0, r.Gg)(e.packageID, {}),
          [n] = (0, r.Gg)(e.compareID, {});
        if (!t || !n) return null;
        ...
        return void 0 === i
          ? null
          : (0, s.jsx)("span", { className: c.StorePriceSavings, children: i });
      }
      function _(e) {
        const t = Number(e.args.packageid),
          n = Number(e.args.compareid);
        return t && n ? (0, s.jsx)(m, { packageID: t, compareID: n }) : null;
      }
    },
    99637: (e, t, n) => {
      "use strict";
        ...
        const L = r(),
          ...
          W = (function (e, t, n, i, r) {
            const a = i && i(),
              ...
              c = e && !w(e).isValid();
            let l = null;
            (c || o || "string" == typeof a || !1 === a) &&
              ((l = (0, m.we)(
                n || "#DateTimePicker_Fallback_Invalid_DateTime",
              )),
              c
                ? (l = (0, m.we)("#DateTimePicker_Time_CannotParse"))
                : o
                  ? (l = (0, m.we)("#DateTimePicker_Date_CannotParse"))
                  : "string" == typeof a && (l = a));
            return (
              s.useEffect(() => {
                r && r(l);
    ...
    70809: (e, t, n) => {
      ...
      function u(e) {
        const { item: t } = e,
                ...
                (function (e) {
                  _ ||
                    (_ = (function (e) {
                      return new (a())(
                        async (t) => {
                          const n = i.w.Init(s.eW);
                          (0, l.rV)(n), n.Body().set_packageid(t);
                          const r = await s.$4.GetHardwareItems(e, n);
                          return r.BSuccess()
          ...
          })(t.GetStoreItemType() == s.c6.RD ? t.GetID() : void 0);
        return n
          ? (0, d.we)("#Cart_ShippingEstimate_DeliveryDate", m(n))
          : null;
      }
      function m(e) {
        return (0, d.we)(
        ...
        const { component: t = "a" } = e,
          n = (function (e) {
            const {
              ...
              _ = s.useRef(0),
              p = t && t.GetStoreItemType() == a.c6.qI ? t.GetAppID() : null,
              f = (0, c.n9)(),
              h = s.useMemo(
                () => r.Ay.GetLinkParam({ ...f, feature: n || f.feature }, i),
                [f, n, i],
              ),
              g = s.useMemo(() => l.A.GetCuratorClanIDParam(f), [f]),
              x = s.useMemo(
                () => l.A.AddNavParamToURL(t ? t.GetStorePageURL() : "", h, g),
                [t, h, g],
              ),
              j = (0, o.b)(),
              C = s.useCallback(() => {
                p && _.current != p && (j.AddImpression(p, h), (_.current = p));
              }, [j, p, h, _]),
              v = (0, d.OO)({ onEnter: C });
            return { ...m, href: x, ref: p && !u ? v : void 0 };
          })(e);
        return (0, i.jsx)(t, { ...n });
      }
    },
    17289: (e, t, n) => {
      ...
      var i = n(7850),
        ...
        r = n(78327);
      function a(e) {
        const { href: t, children: n, bAllowFocuseableAnchor: a, ...o } = e;
        return (0, r.Y2)()
          ? (0, i.jsx)("div", { ...o, children: n })
          : a
            ? (0, i.jsx)(s.Ii, { href: t, ...o, children: n })
            : (0, i.jsx)("a", { href: t, ...o, children: n });
      }
    },
    59637: (e, t, n) => {
      "use strict";
      ...
      function h(e, t) {
        const n = (function (e) {
            ...
            return (0, o.I)({
              ...
              queryFn: async () => {
                const e = i.w.Init(s.HM);
                e.Body().set_item_ids([r.O4.fromObject(n)]);
                const a = await s._o.GetFriendOwnershipForGifting(t, e);
                if (!a.BSuccess()) throw a.GetEResult();
                return a.Body().toObject();
              },
            });
          })(e),
          a = (0, m.d0)({ loadFavorites: !0, loadNicknames: !0 }),
          d = n?.data?.ownership_info[0]?.friend_ownership,
          u = c.useMemo(
            () => new Map(d && d.map((e) => [e.accountid, e])),
            [d],
          ),
          _ = c.useMemo(() => new Set(t), [t]);
        if (n.isLoading || a.isLoading) return { isLoading: !0 };
        if (n.isError || a.isError) return { isError: !0 };
        const f = a.data.map((e, t) => {
          const n = u.get(e.accountid) || { already_owns: !1, wishes_for: !1 };
          return { ...e, ownership: n };
        });
        return (
          f.sort((e, t) => {
            const n = _.has(e.accountid);
            if (n != _.has(t.accountid)) return n ? -1 : 1;
            ...
            const i = e.ownership.partial_wishes_for?.length ?? 0,
              s = t.ownership.partial_wishes_for?.length ?? 0;
            if (i != s) return s - i;
            if (e.ownership.already_owns) {
              if (!t.ownership.already_owns) return 1;
            } else if (t.ownership.already_owns) return -1;
            const r = e.ownership.partial_owns_appids?.length ?? 0,
              a = t.ownership.partial_owns_appids?.length ?? 0;
            if (r != a) return r - a;
            if (i > 0) {
              const n = e.ownership.partial_wishes_for.reduce(
                  (e, t) => e ^ t,
                  0,
                ),
                i = t.ownership.partial_wishes_for.reduce((e, t) => e ^ t, 0);
              if (n != i) return n - i;
            }
            if (r > 0) {
              const n = e.ownership.partial_owns_appids.reduce(
                  (e, t) => e ^ t,
                  0,
                ),
                i = t.ownership.partial_owns_appids.reduce((e, t) => e ^ t, 0);
              if (n != i) return n - i;
            }
          ...
          { rgFriendsForGifting: f }
        );
      }
      function g(e) {
        const t = (0, a.LH)(),
          n = (0, _.js)(e.gift_info?.accountid_giftee),
          i = c.useMemo(
            () =>
              (0, f.Fd)("giftee_player_summaries", "application_config") ?? [],
            [],
          );
        if (!e.gift_info?.accountid_giftee || n.isLoading) return null;
        if (n.data?.m_bInitialized || t) return n.data;
        const s = i.find((t) => t.accountid === e.gift_info.accountid_giftee);
        if (!s) return null;
        let r = new d.Z(u.b.InitFromAccountID(s.accountid));
        return (
          (r.m_strAvatarHash = s.avatarHash),
          (r.m_strPlayerName = s.playerName),
          (r.m_bInitialized = !0),
          r
        );
      }
    ...
    41515: (e, t, n) => {
      ...
      var i = n(79443),
        ...
        x = n(12229);
      function j() {
        return (0, g.Fd)("cart_config", "application_config");
      }
      const C = {
        ...
        return (0, m.I)({
          ...
          queryFn: async () => {
            const t = await (async function (e) {
              const t = c.w.Init(l.wi);
              t.Body().set_language((0, a.sfN)(h.TS.LANGUAGE));
              const n = await l.t8.GetRelevantCoupons(e, t);
              return n.BIsValid()
                ? n.Body().toObject()
      ...
      function N() {
        return (0, m.I)({
          ...
          queryFn: async () => {
            const e = await fetch(
                `${h.TS.STORE_BASE_URL}cart/ajaxsaledropprogress`,
              ),
              t = await e.json();
            return (
              t.eresult !== o.R &&
      ...
      function b() {
        const e = (0, r.j4)(),
          [t] = (0, _.fg)(),
          n = `${h.TS.STORE_CHECKOUT_BASE_URL}checkout/`;
        if ((0, i.c2)(e)) return `${n}?accountcart=1`;
        if ((0, i.sb)(e)) return `${n}?gidreplay=${e.gid}`;
        {
      ...
      function T() {
        const e = (0, r.j4)(),
          t = (0, f.vo)(),
          n = I(),
          s = t.isSuccess && t.data.role() == d.PQ.sf,
          a = n.data?.cart_items.some((e) => !e.can_purchase_as_gift);
        let o = A.k_ECanRequest;
        return (
          s
            ? !(function (e) {
                return (0, i.c2)(e) || (0, i.kx)(e);
              })(e)
              ? (o = A.k_EInvalidCartType)
              : a && (o = A.k_ENonGiftableItemPresent)
            : (o = A.k_EIsNotChild),
          [o === A.k_ECanRequest, o]
        );
      }
      function G() {
        const e = (0, r.j4)(),
          t = (0, f.vo)();
        return t.isSuccess && t.data.role() == d.PQ.s && (0, i.uU)(e);
      }
      !(function (e) {
    ...
    48980: (e, t, n) => {
      ...
      function B(e) {
        const {
          lineItems: t = [],
          cartValidation: n,
          LineItemContainer: s = V,
          scrollable: r = !1,
        } = e;
        if (!t.length) return (0, i.jsx)(W, {});
      ...
      const R = {
        [_.KW.$B]: function (e) {
          const { item: t, validatedItem: n } = e,
            [s, r] = (0, b.Gg)(t.packageid, {}),
            [a, o] = (0, b.mZ)(t.packageid, p.c6.RD, v.lP),
            c = (a && !a.BIsVisible()) || o === b.eR || r === b.eR,
        ...
        [_.KW.XY]: function (e) {
          const { item: t, validatedItem: n } = e,
            [s, r] = (0, b.G6)(t.bundleid, p.c6.xO, v.xz);
          if ((s && !s.BIsVisible()) || r === b.eR)
            return (0, i.jsx)(z, {
              lineItemID: t.line_item_id,
              validatedItem: n,
              storeItem: s,
            });
          if (!s) return (0, i.jsx)(u.vF, {});
          const a = s.GetSelfPurchaseOption();
          return (0, i.jsx)(U, {
            ...e,
            storeItem: s,
            displayItem: s,
      ...
      function O(e) {
        const { item: t, loading: n, ...s } = e,
          r = n ? u.vF : R[t.type];
        return r
          ? (0, i.jsx)(A.tH, {
              fallback: (t) => (0, i.jsx)(M, { ...e, error: t }),
              children: (0, i.jsx)(r, { item: t, ...s }),
            })
          : (console.error(`Unknown line item type (${t.type})`), null);
      }
      function M(e) {
        const { item: t, error: n } = e,
          s = (0, r.t)(t.line_item_id);
        return (0, i.jsxs)(u.Rz, {
          className: d().ErrorLineItem,
          children: [
            (0, i.jsxs)("div", {
              className: d().Left,
              children: [
                (0, i.jsx)("div", {
                  className: d().Error,
                  children: (0, L.we)("#Cart_LineItem_ErrorBoundary"),
                }),
                (0, i.jsx)("div", {
                  className: d().Muted,
                  children: n.message,
      ...
      function W() {
        return (0, i.jsx)(u.Rz, {
          ...
          children: (0, i.jsx)("div", {
            className: d().Left,
            children: (0, i.jsx)("div", {
              className: d().LineItemTitle,
              children: (0, L.we)("#Cart_Empty"),
            }),
          }),
        });
      }
          ...
          children: [
            ...
            (0, i.jsxs)("div", {
              ...
              children: [
                ...
                (0, i.jsxs)("div", {
                  className: d().LineItemDetailsCtn,
                  children: [
                    (0, i.jsx)(u.UW, {
                      className: d().LineItemDetailsRowTop,
                      children: (0, i.jsx)("div", {
                        className: d().LineItemTitle,
                        children:
                          s?.GetName() ||
      ...
      function U(e) {
        const {
          ...
          m = (0, N.DJ)(t),
          _ = (0, r.t)(l),
          p = _.isPending || _.isSuccess,
          h = t.GetIncludedAppIDsOrSelf(),
          { data: g, isLoading: x } = (0, j.Pt)(),
          C = h.filter((e) => g?.has(e)),
          v = S.useId();
        if (x || !o) return (0, i.jsx)(u.vF, {});
        const I = s.flags?.is_gift,
          w = C.length === h.length,
          y = !I && C.length > 0 && !w;
        return (0, i.jsxs)(c, {
          lineItem: s,
              ...
              children: [
                ...
                (0, i.jsxs)("div", {
                  ...
                  children: [
                    ...
                    (0, i.jsx)(ie, { validatedItem: o }),
                    y && (0, i.jsx)(se, { appids: C }),
                    (0, i.jsxs)(u.UW, {
                      className: d().LineItemSpaceBetween,
                      children: [
                        (0, i.jsx)("div", {
                          ...
                          children: (0, i.jsx)(f.Q, {
                            id: m,
                            strClassName: d().LineItemPlatforms,
                          }),
                        }),
                        (0, i.jsx)(Z, { purchaseOption: a, validatedItem: o }),
                      ],
                    }),
                    (0, i.jsx)(K, {
                      lineItem: s,
      ...
      function H(e) {
        ...
        return (0, i.jsx)("div", {
          ...
          children: (0, i.jsx)(P.p, {
            ...
            noImpressionTracking: !0,
            children: (0, i.jsx)("img", {
              className: a ? d().HeaderImgBlurred : d().HeaderImg,
              src: r,
              alt: t.GetName(),
            }),
          }),
      ...
      function V(e) {
        return (0, i.jsx)(m.Z, {
          children: (0, i.jsx)(u.Rz, { children: e.children }),
        });
      }
      function Z(e) {
        const { purchaseOption: t, validatedItem: n } = e;
        let s = t?.formatted_original_price,
          r = t?.formatted_final_price,
          a = t?.discount_pct,
          o = t?.final_price_in_cents;
        return (
          n &&
            n.original_price &&
            n.subtotal.amount_in_cents != o &&
            ((s = n.original_price.formatted_amount),
            (r = n.subtotal.formatted_amount),
            (a = (0, u.dR)(n))),
          (0, i.jsx)("div", {
            className: d().LineItemRightCol,
            children: (0, i.jsx)(T.kb, {
              className: d().PriceWidget,
              formatted_orig_price: s,
      ...
      function K(e) {
        const {
          ...
          [h] = (0, F.fg)(),
          g =
            h?.accountid_giftee || (f ? t.gift_info?.accountid_giftee : void 0),
          x = (0, c.j4)(),
          j =
            (0, o.ZB)() && !a?.restrict_add_additional_to_cart && !(0, o.kx)(x),
          C = a.errors?.adult_content_restricted,
          v = (0, s.A)(
            t.packageid,
            t.bundleid,
            re(r),
        ...
        return (0, i.jsxs)(u.UW, {
          ...
          children: [
            ...
            (0, i.jsxs)("div", {
              className: (0, k.A)(d().LineItemRightCol, d().AddRemoveLinks),
              children: [
                j &&
                  (0, i.jsxs)(i.Fragment, {
                    children: [
                      (0, i.jsx)(m.Z, {
                        onActivate: () => !v.isPending && v.mutate(),
                        className: d().AddLineItem,
                        title: (0, L.we)("#Cart_LineItem_Add_Tooltip"),
                        id: I,
                        "aria-labelledby": `${I} ${p}`,
                        children: (0, L.we)("#Cart_Add"),
                      }),
                      "|",
                    ],
                  }),
                ...
                C &&
                  (0, i.jsxs)(i.Fragment, {
                    children: [
                      "| ",
                      (0, i.jsx)("a", {
                        href: `${E.TS.STORE_CHECKOUT_BASE_URL}checkout/?purchasetype=updatebillinginfo&r=cart`,
                        className: d().VerifyLineItem,
                        children: (0, L.we)("#Cart_Verify"),
                      }),
                      " ",
                    ],
                  }),
        ...
        return (0, i.jsx)("div", {
          ...
          children: (0, L.PP)(
            ...
            t.data
              ? (0, i.jsx)("span", {
                  className: d().Name,
                  children: t.data.m_strPlayerName,
                })
              : "",
          ),
        });
      ...
      function q(e) {
        ...
        const i = n.GetHeaderURL(),
          s = n.GetSmallCapsuleURL();
        return i || s || t;
      }
      function Q(e) {
        const { storeItem: t } = e;
        let n = (0, L.we)("#Cart_ComingSoon", t.GetFormattedSteamReleaseDate());
        return (
      ...
      function $(e) {
        const { item: t } = e;
        if (!t.GetSelfPurchaseOption()?.requires_shipping) return null;
        const n = E.iA.country_code;
        return ["GB"].includes(n)
          ? (0, i.jsx)(u.dp, {
              children: (0, i.jsx)(m.Z, {
                children: (0, i.jsx)("a", {
                  className: (0, k.A)(d().ComplianceLink),
                  target: "_blank",
      ...
      function ee(e) {
        const { item: t } = e;
        if (!t || t.GetStoreItemType() != p.c6.RD) return null;
        const n = t.GetSelfPurchaseOption(),
          s = n?.recurrence_info;
        if (!s) return null;
        let r = "#Package";
        2 === s.billing_agreement_type && (r = "#GameBillingPackage");
        const a = t.GetSelfPurchaseOption();
        a.formatted_final_price && a.discount_pct && (r += "WithDiscount");
        const o =
          r +
        ...
        return (0, i.jsx)(u.dp, {
          children: (0, L.we)(
            ...
            s.formatted_renewal_price,
            s.renewal_time_period,
            a.discount_pct,
          ),
        });
      }
      function te(e) {
        const {
          ...
          u = (0, w.$)(t),
          m = !re(r) || d,
          _ = !(!(p = r).is_commercial_license && !p.requires_shipping);
        var p;
        let f = [
          { data: "myself", label: (0, L.we)("#Cart_LineItemOptions_Myself") },
          !_ && {
            data: "private",
            label: (0, L.we)("#Cart_LineItemOptions_Privately"),
            tooltip: (0, L.we)("#Cart_LineItemOptions_PrivateTooltip"),
          },
        ].filter(Boolean);
        m ||
          (t.gift_info?.accountid_giftee && u?.m_strPlayerName
            ? f.push({
                data: "gift",
                label: (0, L.we)(
            ...
            : f.push({
                data: "gift",
                label: (0, L.we)("#Cart_LineItemOptions_Gift"),
              }));
        ...
        return (0, i.jsx)(ne, {
          onChange: (e) => {
            ...
            "private" === h ? i(!1) : "gift" === h && s(!1),
              "private" === e.data ? i(!0) : "gift" === e.data && s(!0);
          },
          selectedOption: h,
          rgOptions: f,
        });
      ...
      function ne(e) {
        return (0, i.jsx)(D.m, {
          strClassName: d().LineItemDropDown,
          strDropDownItemClassName: d().DropDownOptionItem,
          strDropDownClassName: d().DropDownOptionsCtnThin,
          strDropDownButtonClassName: d().DropDownThin,
          ...e,
        });
      }
      const ie = S.memo(function (e) {
        const { validatedItem: t } = e,
          n = t.included_packageids,
          s = (0, g.eG)(),
          r = (0, C.E)({
            queries: n.map((e) => (0, x.mt)(s, { packageid: e })),
          }),
          a = [
            ...new Set(
              r
        ...
        return !a.length || (1 == a.length && !t.item_id.bundleid)
          ...
          : (0, i.jsxs)(u.UW, {
              ...
              children: [
                (0, i.jsxs)("span", {
                  children: [
                    (0, L.Yp)("#Cart_IncludesItems", a.length),
                    ":",
                    " ",
                  ],
                }),
                a.map((e, t) =>
                  (0, i.jsxs)(
                    S.Fragment,
                    { children: [t > 0 && ", ", (0, i.jsx)(oe, { appid: e })] },
                    t,
                  ),
                ),
              ],
      ...
      function se(e) {
        ...
        return (0, i.jsxs)(u.UW, {
          children: [
            (0, i.jsxs)("span", {
              children: [(0, L.we)("#Cart_Notice_SomeAppsPrivate"), " "],
            }),
            n,
          ],
        });
      ...
      function oe(e) {
        const { name_override: t, ...n } = e,
          { data: s } = (0, x.J$)(t ? void 0 : n),
          r = t ?? s?.name;
        return (0, i.jsx)(ce, { ...n, name: r, children: r });
      }
      function ce(e) {
        const { name: t, children: n, ...s } = e;
        return (0, i.jsx)(h.Q, {
          id: s,
          hoverProps: ae,
          name: t,
          className: d().LineItemStoreHover,
    ...
    53534: (e, t, n) => {
      ...
      function u(e) {
        const { nGifteeAccountID: t } = e,
          ...
          { data: a } = (0, r.Dv)();
        return l.useMemo(() => !a || a.includes(n), [a, n]) || !o.iA.logged_in
          ? null
          : (0, i.jsx)(s.dp, {
              children: d.Q8.Localize("#Cart_Warning_GiftToNonFriend"),
            });
      }
      var m = n(39777),
        _ = n(52541),
      ...
      function I(e) {
        const { validateCart: t, children: n, eDisplayType: s } = e,
          r = (function (e, t) {
            return l.useMemo(() => {
              let n = new Map(),
                i = new Map(),
                s = 1;
              const r = (e, t) => {
                i.has(e) || i.set(e, { index: s++, footnote_text: t });
              };
              let o = !1;
              e?.cart_items?.forEach((e) => {
                ...
                e.errors && (o = !0),
                  e.errors?.duplicate_appids_in_cart?.length &&
                    r(a.WN.ZK, (0, g.we)("#Cart_Error_DuplicateApps_FootNote")),
                  ...
                  e.errors?.unavailable_in_country &&
                    r(
                      a.WN.Hp,
                      (0, g.we)("#Cart_Error_UnavailableCountry_FootNote"),
                    ),
                  e.errors?.adult_content_restricted &&
                    r(
                      a.WN.C4,
                      (0, g.we)("#Cart_Error_AdultContentRestricted_FootNote"),
                    ),
                  ...
                  e.errors?.missing_must_own_appids &&
                    r(
                      ...
                      t
                        ...
                        : (0, g.we)("#Cart_Error_MissingMustOwnApps_FootNote"),
                    ),
                  e.warnings?.appids_in_mastersub?.length &&
                    r(
                      a.WN.Q7,
                      (0, g.we)("#Cart_Error_MasterSubscription_FootNote"),
                    ),
                  e.warnings?.price_has_changed &&
                    n.set(
                      a.WN.vY,
                      (0, g.we)("#Cart_Warning_PriceChange_FootNote"),
                    );
              });
              let c = Array.from(n.values());
              return (
                o && c.unshift((0, g.we)("#Cart_CartLevelErrorNotice")),
                {
        ...
        return (0, i.jsx)(v.Provider, { value: r, children: n });
      }
      function w() {
        const { rgCartLevelNotices: e } = l.useContext(v);
        return e && e.length
          ? 1 == e.length
            ? (0, i.jsx)("div", {
                className: j().HeaderNotices,
                children: (0, g.we)("#Cart_CartLevelErrorFormat", e[0]),
              })
            : (0, i.jsxs)("div", {
                className: j().HeaderNotices,
                children: [
                  (0, i.jsx)("div", {
                    children: (0, g.we)("#Cart_CartLevelErrorMultiple"),
                  }),
                  (0, i.jsx)("ul", {
                    children: e.map((e, t) =>
                      (0, i.jsx)("li", { children: e }, t),
                    ),
                  }),
                ],
              })
      ...
      function S(e) {
        const { validateCart: t } = e,
          { mapValidateNoticesToFootnote: n } = l.useContext(v);
        if (!n || !n.size) return null;
        const s = (t?.cart_items || []).every((e) => !e.errors),
          r = s
            ? (0, g.we)("#Cart_FooterNoticeHeader_Warning")
            : (0, g.we)("#Cart_FooterNoticeHeader_MustFix"),
          a = (0, C.A)(j().FooterNoticesHeader, !s && j().MustFix);
        return (0, i.jsxs)("div", {
          className: j().FooterNoticesCtn,
          children: [
            (0, i.jsx)("div", { className: a, children: r }),
      ...
      function y(e) {
        ...
        return (0, i.jsxs)("div", {
          ...
          children: [
            (0, i.jsx)("div", {
              className: j().NoticeIndex,
              children: (0, i.jsx)("sup", { children: t.index }),
            }),
            (0, i.jsx)("div", {
              className: j().NoticeText,
              children: t.footnote_text,
            }),
          ],
        });
      }
            ...
            s.push(
              (0, i.jsx)(
                D,
                {
                  ...
                  notice_text: (0, g.we)("#Cart_Error_DuplicateApps_LineItem"),
                  appids: t.errors.duplicate_appids_in_cart,
                },
                "duplicate_appids",
              ),
            ),
          s.push((0, i.jsx)(G, { lineItem: t }, "owned_apps")),
            ...
            s.push(
              (0, i.jsx)(
                D,
                {
                  ...
                  notice_text: (0, g.we)("#Cart_Error_GiftRecipientInvalid"),
                },
                "gift_recipient_invalid",
              ),
            ),
          s.push((0, i.jsx)(P, { lineItem: t }, "coupon_notices")),
            ...
            s.push(
              (0, i.jsx)(
                D,
                {
                  ...
                  notice_text: (0, g.we)("#Cart_Error_TooManyInCart"),
                },
                "too_many_in_cart",
              ),
            ),
            ...
            s.push(
              (0, i.jsx)(
                D,
                {
                  ...
                  notice_text: r
                    ? (0, g.we)("#Cart_Error_MissingMustOwnApps_GiftLineItem")
                    : (0, g.we)("#Cart_Error_MissingMustOwnApps_LineItem"),
            ...
            s.push(
              (0, i.jsx)(
                D,
                {
                  ...
                  appids: t.warnings.appids_in_mastersub.map(
                    (e) => e.cart_appid,
                  ),
                },
                "appids_in_mastersub",
            ...
            s.push(
              (0, i.jsx)(
                D,
                {
                  ...
                  notice_text: (0, g.we)("#Cart_Warning_AlreadyOwned_LineItem"),
            ...
            s.push(
              (0, i.jsx)(
                D,
                {
                  ...
                  notice_text: (0, g.we)("#Cart_Warning_ExtraCopies_LineItem"),
            ...
            s.push(
              (0, i.jsx)(
                D,
                {
                  ...
                  notice_text: (0, g.we)("#Cart_Warning_PriceChange_LineItem"),
                },
                "price_has_changed",
              ),
            ),
          t.warnings?.non_refundable &&
            s.push(
              (0, i.jsx)(
                ...
                {
                  purchase_state: a.WN.YQ,
                  notice_text: (0, g.we)("#Cart_Warning_NoRefund_LineItem"),
                },
                "non_refundable",
              ),
            ),
            ...
            s.push(
              (0, i.jsx)(
                D,
                {
                  ...
                  notice_text: (0, g.we)("#Cart_Warning_RecipientHigherPrice"),
                },
                "non_refundable",
              ),
            ),
      ...
      function D(e) {
        ...
        return (0, i.jsxs)(s.dp, {
          children: [
            n,
            a && (0, i.jsx)("sup", { children: a }),
            " ",
            (0, i.jsx)(A, { rgAppIDs: r }),
          ],
        });
      }
      function A(e) {
        ...
        return t && 0 != t.length
          ? t.map((e, n) =>
              (0, i.jsx)(T, { appid: e, last: n >= t.length - 1 }, `${e}_${n}`),
            )
          : null;
      }
      function T(e) {
        const { appid: t, last: n } = e,
          [s] = (0, f.t7)(t, { include_basic_info: !0 });
        return s
          ? (0, i.jsxs)(p.Zx, {
              appid: t,
              children: [
      ...
      function G(e) {
        ...
        if (t.errors?.has_existing_billing_agreement)
          return (0, i.jsx)(D, {
            ...
            notice_text: (0, g.we)("#Cart_Error_ExistingBillingAgreement"),
          });
        {
          ...
          children: [
            t.errors?.coupon_exclusive_promo &&
              (0, i.jsx)(D, {
                ...
                notice_text: (0, g.we)("#Cart_Error_CouponIsExclusivePromo"),
              }),
            t.errors?.invalid_coupon &&
              (0, i.jsx)(D, {
                purchase_state: a.WN.p_,
                notice_text: (0, g.we)("#Cart_Error_CouponIsInvalid"),
              }),
            t.errors?.invalid_coupon_for_item &&
              (0, i.jsx)(D, {
                purchase_state: a.WN.VJ,
                notice_text: (0, g.we)("#Cart_Error_CouponIsInvalidForItem"),
              }),
          ],
        });
      }
      function k(e) {
        const { lineItem: t } = e,
          { data: n } = (0, m.mr)(t.item_id),
          { data: r } = (0, m.EO)(t.item_id);
        if (!!t.gift_info?.accountid_giftee || !n || !r || (0, _.vk)(n, r))
          return null;
        const { purchase_option_name: a, packageid: o, bundleid: c } = r,
          l = o ? { packageid: o } : { bundleid: c };
        return (0, i.jsx)(s.dp, {
          children: (0, g.PP)(
            "#Cart_Warning_AvailableAtALowerPrice",
            (0, i.jsx)(p.O3, { name_override: a, ...l }),
          ),
        });
      }
      !(function (e) {
    ...
    75910: (e, t, n) => {
      ...
      function T(e) {
        const { cart: t } = e,
          n = (function (e) {
            ...
            for (const t of e.cart_items)
              t.subtotal && (i += parseInt(t.subtotal.amount_in_cents));
            const {
                sale_name: s,
                spend_earned_for_next_drop: r,
                spend_needed_for_next_drop: a,
                formatted_spend_per_drop: o,
              } = t.data,
              c = i + r,
              l = Math.floor(c / a),
              u = Math.floor(((c % a) * 100) / a);
            return {
              cEarned: l,
              pctProgress: u,
        ...
        const {
          ...
          u = (0, i.jsx)("div", {
            ...
            children: (0, w.we)("#Cart_SaleCardDrops_Explanation", c),
          });
        return (0, i.jsxs)(b, {
          ...
          children: [
            l &&
              (0, i.jsx)("div", {
                ...
                children: (0, w.Yp)("#Cart_SaleCardDrops_EarnedMessage", s, c),
              }),
            !l && u,
            (0, i.jsxs)("div", {
              ...
              children: [
                (0, i.jsx)("div", {
                  children: (0, w.we)("#Cart_SaleCardDrops_ProgressLabel"),
                }),
                (0, i.jsx)(G, { value: r }),
                (0, i.jsxs)("div", {
                  className: A.Right,
                  children: [
                    "(",
                    (0, w.we)("#Cart_SaleCardDrops_CardCost", o),
                    ")",
                  ],
                }),
              ],
          ...
          s = (function (e) {
            ...
            (0, u.useEffect)(() => {
              ...
              e == a.uE.HT
                ? n(s.id)
                : (e != a.uE._i && e != a.uE.Ov) ||
                  n(s.related_items?.parent_appid);
            }, [s?.id, s?.related_items?.parent_appid, s?.type]);
            const r = (0, u.useMemo)(
        ...
        return 0 != o.length && r
          ? (0, i.jsxs)("div", {
              ...
              children: [
                (0, i.jsx)("div", {
                  className: R().Title,
                  children: (0, w.we)("#Cart_FollowCreator_title"),
                }),
                (0, i.jsx)("div", {
                  className: R().Description,
                  children: (0, w.we)("#Cart_FollowCreator_desc"),
                }),
                (0, i.jsx)("br", {}),
                o.map((e) =>
                  (0, i.jsx)(
      ...
      function Z(e) {
        const { cart: t, validatedCart: n } = e,
          [s, r] = u.useState(void 0),
          a = (n?.cart_items || []).reduce(
        ...
        const c = a.reduce((e, t) => ((e[t] = !0), e), {}),
          l = V(c, o.data?.purchase_recommendations),
          d = V(c, o.data?.specials);
        V(c, o.data?.daily_deals), V(c, o.data?.spotlights);
        return (0, i.jsxs)("div", {
          className: F.CartUpsellArea,
          children: [
            (0, i.jsx)("div", {
              className: F.CartUpsellTitle,
              children: (0, w.we)("#Recommendations_Header"),
            }),
            l?.length > 3
              ? (0, i.jsx)(K, {
                  type: "recommended",
            ...
            (0, i.jsx)(U, { cart: t, bMinimalDisplay: !1 }),
          ],
        });
      }
      function K(e) {
        const { data: t, isLoaded: n, type: s } = e;
        return !t && n
          ? null
          : (0, i.jsx)(C.Ay, {
              feature: `upsell-${s}`,
            ...
            (0, i.jsxs)(ct, {
              children: [
                (0, i.jsx)(g.Od, {
                  ...
                  label: (0, w.we)("#Cart_GiftDelivery_ScheduleDelivery"),
                }),
                (0, i.jsx)("div", { style: { clear: "both" } }),
                s &&
                  (0, i.jsx)("div", {
                    className: _e().ScheduleError,
                    children: s,
                  }),
                a &&
                  (0, i.jsx)(x.tH, {
      ...
      function he(e) {
        const t = Date.now() / 1e3 + de.Kp.PerYear,
          n = new Date(null, null, null, 0, 0, 0, 0).getTime() / 1e3;
        return e > t
          ? (0, w.we)("#Cart_GiftScheduleError_TooFar")
          : !(e < n) || (0, w.we)("#Cart_GiftScheduleError_InvalidDate");
      }
      function ge(e) {
        const {
            scheduledTime: t,
          ...
          r = u.useMemo(() => {
            const e = new Intl.DateTimeFormat(w.pf.GetPreferredLocales(), {
              hour: "numeric",
            });
            return (
          ...
          a = new Date(1e3 * t),
          [o, c] = (0, u.useState)(a.getMonth()),
          [l, d] = (0, u.useState)(a.getDate()),
          [m, _] = (0, u.useState)(a.getFullYear()),
          [p, f] = (0, u.useState)(() =>
            (function (e, t) {
              let n = e.getHours(),
                i = e.getMinutes();
          ...
          [h, j] = (0, u.useState)(a.getHours() >= 12 ? "PM" : "AM");
        u.useEffect(() => {
          ...
          const a = new Date(m, o, l, t, i, 0, 0).getTime() / 1e3,
            c = he(a);
          !0 === c ? (s(null), n(a)) : s(c);
        }, [m, o, l, p, h, r, n, s]);
        const C = "US" == ue.TS.COUNTRY && "english" == ue.TS.LANGUAGE;
        return (0, i.jsxs)(i.Fragment, {
          children: [
            (0, i.jsxs)(g.Xp, {
              className: _e().GamepadTimePickerRow,
              children: [
                C && (0, i.jsx)(je, { month: o, setMonth: c }),
                (0, i.jsx)(Ce, { year: m, month: o, day: l, setDay: d }),
                !C && (0, i.jsx)(je, { month: o, setMonth: c }),
                (0, i.jsx)(xe, { year: m, setYear: _ }),
              ],
            }),
            (0, i.jsxs)(g.Xp, {
              className: _e().GamepadTimePickerRow,
              children: [
                ...
                r && (0, i.jsx)(ve, { strAMPM: h, setAMPM: j }),
                (0, i.jsx)(g.VP, {
                  className: _e().TimezoneDisplay,
                  children: (0, i.jsx)(x.tH, { children: (0, i.jsx)(Ie, {}) }),
                }),
                !r && (0, i.jsx)(g.VP, { children: " " }),
              ],
            }),
          ],
        });
      ...
      function xe(e) {
        const { year: t, setYear: n } = e,
          s = u.useMemo(() => {
            const e = new Date(),
              t = new Intl.DateTimeFormat(w.pf.GetPreferredLocales(), {
                year: "numeric",
              });
      ...
      function Ce(e) {
        const { year: t, month: n, day: s, setDay: r } = e,
          a = u.useMemo(() => {
            const e = new Date(t, n + 1, 0).getDate(),
              i = new Intl.DateTimeFormat(w.pf.GetPreferredLocales(), {
                day: "numeric",
              });
            let s = [];
            for (let t = 1; t <= e; t++)
              s.push({ label: i.format(new Date(null, null, t)), data: t });
            return s;
          }, [n, t]);
        return (0, i.jsx)(g.m, {
          selectedOption: s,
      ...
      function Ie() {
        ...
        return (0, i.jsx)(i.Fragment, { children: e ? e.value : "" });
      }
      var we = n(1035),
        Se = n(41471),
        ye = n(71232);
      function Ne(e) {
        const { lineItem: t } = e,
          ...
          s = u.useMemo(() => {
            let e = [];
            for (const i of n?.line_items ?? [])
              i.line_item_id !== t.line_item_id &&
                i.flags?.is_gift &&
                i.gift_info &&
                e.push(i);
            return e;
          }, [n?.line_items, t.line_item_id]),
          { mutate: r } = (0, te.C)(),
          a = (0, ye.WM)({
            rgOptions: s,
            selectedValue: null,
          ...
          : (0, i.jsx)($.az, {
              ...
              children: (0, i.jsxs)(ye.l6.Root, {
                ...
                children: [
                  ...
                  (0, i.jsx)(ye.l6.Options, {
                    children: s.map((e, t) =>
                      (0, i.jsx)(
                        ye.l6.Option,
                        { value: e, children: (0, i.jsx)(be, { lineItem: e }) },
                        t,
                      ),
                    ),
                  }),
      ...
      function be(e) {
        const { lineItem: t } = e,
          n = t.bundleid ? a.c6.xO : a.c6.RD,
          [s] = (0, h.mZ)(t.bundleid ? t.bundleid : t.packageid, n, {
            include_basic_info: !0,
          }),
          r = (0, ce.$)(t),
          o = r?.m_strPlayerName ?? t.gift_info?.email_giftee;
        if (!s || !o) return null;
        const c = r
          ? (0, i.jsx)(we.i8, {
              size: "X-Small",
      ...
      function Le(e) {
        const {
          storeItem: t,
          lineItem: n,
          bShowGiftRecipientModal: s,
          fnOnDismiss: r,
          highlightedAccountIDs: a,
        } = e;
        return (0, i.jsx)(ke.mt, {
          className: _e().GiftRecipientPickerModal,
          active: s,
          onDismiss: r,
          children: (0, i.jsx)(Ee, {
            onDismiss: r,
      ...
      const Ee = u.memo(function (e) {
        const { storeItem: t, highlightedAccountIDs: n, ...s } = e,
          {
          ...
          l = u.useMemo(() => {
            const e = new Map(
              c
                .filter((e) => !!e.data)
                .map((e) => [e.data.GetAccountID(), e.data]),
            );
            for (const t of r ?? []) e.delete(t.accountid);
            let t = [];
      ...
      function Fe(e) {
            ...
            return e.length < 1
              ...
              : s.filter(
                  (t) =>
                    ...
                    !!(
                      t.nickname &&
                      t.nickname.toLocaleLowerCase().indexOf(e) > -1
                    ),
                );
          }, [c, s]),
          m = t.gift_info?.accountid_giftee,
          _ = (e) => {
            if (e) {
              const n = new Pe.b(e);
              n.BIsValid() &&
                o.mutate({
                  ...
                  giftInfo: {
                    ...(t.gift_info ?? {}),
                    accountid_giftee: n && n.GetAccountID(),
                  },
                });
            }
            n();
        ...
        return a
          ? (0, i.jsx)(Be, {
              children: (0, i.jsx)("div", {
                className: _e().LoadingError,
                children: (0, w.we)("#Cart_GiftRecipientModal_IssueLoading"),
              }),
            })
          : (0, i.jsxs)(Be, {
              loading: r,
              children: [
                (0, i.jsx)(Re, { value: c, onChange: l }),
                (0, i.jsx)(Oe, {
                  children: d.map((e) =>
                    (0, i.jsx)(
                      Me,
                      {
                        selected: e.accountid === m,
                        onSelect: _,
      ...
      function Be(e) {
        ...
        return (0, i.jsxs)(r.Z, {
          className: _e().GiftRecipientPickerFormCtn,
          children: [
            (0, i.jsx)("div", {
              className: _e().FormTitle,
              children: (0, w.we)("#Cart_GiftRecipientModal_Title"),
            }),
            t && (0, i.jsx)(v.t, { position: "center", size: "large" }),
            !t && n,
          ],
        });
      }
      function Re(e) {
        ...
        return (0, i.jsx)(g.pd, {
          autoFocus: !0,
          bShowClearAction: !0,
          className: _e().GiftFriendsInput,
          placeholder: (0, w.we)("#Cart_GiftRecipientModal_Placeholder"),
          value: t,
          onChange: (e) => n(e.currentTarget.value),
        });
      }
      function Oe(e) {
        return (0, i.jsx)(De.MS, { className: _e().GiftFriendsListCtn, ...e });
      }
      function Me(e) {
        const {
            selected: t,
        ...
        return (0, i.jsxs)(r.Z, {
          className: (0, y.A)(
            _e().GiftPickerFriendBlock,
            t && _e().Selected,
            c && _e().Disabled,
          ),
          focusClassName: _e().Focused,
          noFocusRing: !0,
          onActivate: l,
          children: [
            (0, i.jsx)(we.i8, {
              className: _e().FriendAvatar,
            ...
            (0, i.jsx)(Ge.A, {
              ...
              strNickname: s,
              persona: a,
              className: _e().PersonaName,
            }),
            (0, i.jsxs)("div", {
              className: _e().FriendsGiftLabel,
              children: [
                (0, i.jsx)(We, { ownership: o }),
                (0, i.jsx)(ze, { ownership: o }),
              ],
            }),
          ],
        });
      ...
      function ze(e) {
        const { ownership: t } = e,
          { already_owns: n, wishes_for: s, partial_wishes_for: r } = t;
        return n
          ? null
          : s
            ? (0, i.jsx)("div", {
                className: (0, y.A)(_e().OnWishlist),
              ...
              children: [
                (0, i.jsxs)(ot, {
                  children: [
                    ...
                    (0, i.jsx)("a", {
                      href: s.data.GetCommunityProfileURL(),
                      target: "_blank",
                      children: (0, i.jsx)(we.i8, {
                        className: _e().FriendAvatar,
                        statusPosition: "right",
                        persona: s.data,
                      }),
      ...
      function Ke(e) {
        const { lineItem: t, storeItem: n } = e,
          ...
          { data: a } = (0, ne.UI)(),
          o = u.useMemo(() => {
            if (!a?.line_items) return [];
            let e = new Set();
            for (const n of a.line_items)
              n.line_item_id !== t.line_item_id &&
                n.gift_info?.accountid_giftee &&
                e.add(n.gift_info.accountid_giftee);
            return [...e];
          }, [a?.line_items, t.line_item_id]);
        return (0, i.jsxs)(i.Fragment, {
          children: [
            S.iA.logged_in &&
              (0, i.jsx)(J.$, {
      ...
      function qe(e) {
        ...
        return (
          (0, u.useEffect)(() => {
            if (!a || a == t.gift_info?.email_giftee) return;
            let e = t.gift_info ? { ...t.gift_info } : {};
            (e.email_giftee = a),
              (e.time_scheduled_send = 0),
              s({
                lineItemID: t.line_item_id,
                lineItemFlags: t.flags,
                giftInfo: e,
          ...
          (0, i.jsxs)("div", {
            children: [
              (0, i.jsx)("div", {
                className: _e().GiftEmailInput,
                children: (0, i.jsx)(g.pd, {
                  label: " ",
                  mustBeEmail: !0,
                  value: r,
              ...
              (0, i.jsxs)("ul", {
                className: _e().GiftEmailWarnings,
                children: [
                  (0, i.jsx)("li", {
                    children: (0, w.we)("#Cart_GiftDeliveryEmail_Warning1"),
                  }),
                  (0, i.jsx)("li", {
                    children: (0, w.we)(
      ...
      function $e(e) {
        const { lineItem: t } = e,
          ...
          { data: s } = (0, ie.Dv)(),
          r = u.useMemo(
            () => !s || s.includes(n?.GetSteamIDAsString()),
            [s, n],
          );
        return n
          ? r
      ...
      function et(e) {
        const { lineItem: t } = e,
          ...
          r = u.useRef(n),
          [a, o] = u.useState(t.gift_info?.gift_message?.signature || ""),
          c = u.useRef(a),
          [l, d] = u.useState(t.gift_info?.time_scheduled_send),
          m = u.useRef(l),
          _ = u.useCallback((e) => {
            (p.current = !0), d(Math.floor(e));
          }, []),
          p = u.useRef(!1);
        u.useEffect(() => {
          p.current ||
            ((m.current = t.gift_info?.time_scheduled_send),
            (r.current = t.gift_info?.gift_message?.message || ""),
            (c.current = t.gift_info?.gift_message?.signature || ""),
            d(m.current),
            s(r.current),
            o(c.current));
        }, [t.gift_info]);
        const f = (0, W._g)(3e3),
          ...
          g = u.useCallback(
            ...
            [h, t.line_item_id, t.flags, f],
          );
        return (
          (0, u.useEffect)(() => {
            (m.current == l && r.current == n && c.current == a) ||
              (g({
                accountid_giftee: t.gift_info?.accountid_giftee,
                email_giftee: t.gift_info?.email_giftee,
                gift_message: { message: n, signature: a },
                time_scheduled_send: l,
              }),
              (m.current = l),
              (r.current = n),
              (c.current = a));
      ...
      function st(e) {
        ...
        return (0, i.jsxs)(i.Fragment, {
          children: [
                  ...
                  children: [
                    ...
                    !h &&
                      (0, i.jsxs)(dt, {
                        ...
                        children: [
                          "(",
                          (0, w.we)("#Cart_GiftDelivery_AddSignature"),
                          ")",
                        ],
                      }),
                  ],
            ...
            o && (0, i.jsx)(pe, { scheduledTime: c, onScheduledTimeChange: l }),
          ],
        });
      }
      function rt(e) {
      ...
      function ut(e) {
        ...
        return s
          .family_group()
          .members()
          .some((e) => e.steamid() === r && e.role() === se.PQ.sf)
          ? (0, i.jsxs)("div", {
              className: _e().FamilyGiftNotice,
              children: [" ", (0, w.we)("#Cart_FamilyGift_Notice")],
            })
          : null;
      }
      var mt = n(79443),
      ...
      function vt(e) {
        const {
          ...
          [{ bDialogActive: a, strDialogTitle: o }, c] = u.useState({
            bDialogActive: !1,
          }),
          l = (0, te.C)();
        return (0, i.jsxs)(i.Fragment, {
              ...
              onModifyClick: () =>
                c({
                  ...
                  strDialogTitle: (0, w.we)(
                    s ? "#Cart_CouponModify_Change" : "#Cart_CouponModify_Add",
                  ),
                }),
            }),
            (0, i.jsx)(St, {
      ...
      function St(e) {
        const {
          ...
          [l, d] = u.useState(a?.gidcoupon || "");
        return (0, i.jsxs)(ke.mt, {
          active: t,
          onDismiss: n,
          children: [
            (0, i.jsx)(g.Y9, { children: r }),
            (0, i.jsx)(g.a3, {
              children: (0, w.PP)(
          ...
          children: t.map((e) =>
            (0, i.jsx)(
              Nt,
              {
                ...
                selected: s === e.gidcoupon,
                inUse: o.includes(e.gidcoupon),
          ...
          l =
            ...
            t.data.line_items.some(
              (e) =>
                ...
                (!e.gift_info?.email_giftee ||
                  !g.pd.validateEmail(e.gift_info?.email_giftee)),
            );
        let u,
          m =
            S.iA.logged_in &&
              ...
              children: [
                ...
                (0, i.jsx)("div", {
                  ...
                  children: (0, w.PP)(
                    ...
                    (0, i.jsx)("a", {
                      href: e,
                      children: (0, w.we)("#Cart_LicenseContextSSA"),
                    }),
                  ),
                }),
              ],
      ...
      function Zt(e) {
        const { bDisabled: t } = e,
          ...
          s = (0, d.sI)(),
          r = (0, d.F$)(),
          a = (0, _.Ke)(n.data?.family_groupid(), s, se.IG.DP);
        return r
          ? (0, i.jsx)(g.$n, {
              disabled: t,
              className: (0, y.A)(
              ...
              children: (0, w.we)("#Cart_DeclinePurchaseRequest"),
            })
          : null;
      }
      function Kt(e) {
                ...
                (0, i.jsx)(g.jn, {
                  ...
                  onClick: () => {
                    t ||
                      ...
                      r.mutate(void 0, {
                        onSuccess: () => {
                          window.location.assign((0, _.Vo)(s));
                        },
                      }));
                  },
                  children: (0, w.we)("#Cart_RequestPurchase"),
                }),
                a &&
                  (0, i.jsx)("div", {
                    children: (0, w.we)("#Cart_RequestPurchaseExplanation"),
                  }),
                o === d.Mn.k_ENonGiftableItemPresent &&
                  (0, i.jsx)("div", {
                    children: (0, w.we)(
      ...
      function Jt(e) {
        const { cartID: t, initialStep: n = "initial" } = e,
          ...
          a = (0, d.UI)(),
          o = (function (e, t) {
            if ("gifts" === e) return (0, w.we)("#Cart_GiftOptions");
            return t > 0
        ...
        return (0, i.jsx)($t, {
          ...
          step: s,
          onStepChange: r,
          children: ({ cart: e, validatedCart: t, bCartIncludesGifts: n }) =>
            (0, i.jsxs)(i.Fragment, {
              children: [
                (0, i.jsx)(x.tH, {
                  children: (0, i.jsx)(sn, {
                ...
                (0, i.jsx)(x.tH, {
                  children: (0, i.jsx)(Z, { cart: e, validatedCart: t }),
                }),
              ],
            }),
        });
      ...
      function Xt(e) {
        ...
        return S.iA.logged_in
          ? (0, i.jsx)($t, {
              ...
              children: () =>
                (0, i.jsx)(b, {
                  children: (0, w.we)("#Cart_Replay_Instructions", 72),
                }),
            })
          : (0, i.jsx)(j.Cg, {});
      }
              ...
              return (0, i.jsxs)(i.Fragment, {
                children: [
                  ...
                  (0, i.jsx)("a", {
                    ...
                    children: (0, w.we)("#Cart_YourShoppingCart"),
                  }),
                ],
              });
            return null;
          ...
          : (0, i.jsxs)("div", {
              ...
              children: [
                (0, i.jsx)("a", {
                  ...
                  children: (0, w.we)("#Cart_Bradcrumb_Home"),
                }),
                " ",
                s,
                " ",
          ...
          if (i && void 0 !== n) {
            const e = t.data?.line_items || [],
              n = e.length
                ...
                : null;
            (s = n?.bundleid || n?.packageid || p.sc),
              (r = s === n?.bundleid ? a.c6.xO : a.c6.RD);
          }
          const [o] = (0, h.G6)(s, r, d.xz);
          if (o && i) {
            const t = f.A.Get(),
              n = o.GetIncludedAppIDs();
            for (const i of n) {
              const n = t.GetApp(i);
              if (!n) continue;
              const s = n.GetAssets().GetPageBackgroundURL();
              if (s) {
                e.current = s;
                break;
              }
    ...
    10247: (e, t, n) => {
      ...
      var i = n(7850),
        s = n(30709),
        r = n(90626);
      const a = r.createContext({ step: "initial", setStep: () => {} });
      function o() {
      ...
      function d(e) {
        ...
        return (0, i.jsx)(a.Provider, {
          value: u,
          children: (0, i.jsx)(s.h3, { cartID: o, children: d }),
        });
      }
    },
    44894: (e, t, n) => {
