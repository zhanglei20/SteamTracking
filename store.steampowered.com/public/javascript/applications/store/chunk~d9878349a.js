  ...
  [177],
  {
    56228: (e, t, r) => {
      ...
      class x extends h.Message {
        ...
        constructor(e = null) {
          super(),
            x.prototype.dictionary || p.Sg(x.M()),
            h.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class I extends h.Message {
        ...
        constructor(e = null) {
          super(),
            I.prototype.search_term || p.Sg(I.M()),
            h.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      !(function (e) {
        (e.UpdateTextFilterDictionaryHandler = {
          ...
          (e.RegisterForUpdateTextFilterDictionary = function (t, r) {
            return null == (r = r || (0, T.OI)().GetDefaultHandlerRegistry())
              ? (console.error(
          ...
          (e.UpdateTextFilterDictionary = function (e, t) {
            return null == (t = t || (0, T.OI)().GetDefaultTransport())
              ? (console.error(
          ...
          (e.GetGameIDForPID = function (e, t) {
            return null == (t = t || (0, T.OI)().GetDefaultTransport())
              ...
              : t.SendMsg("SteamEngine.GetGameIDForPID#1", (0, m.I8)(F, e), M, {
                  ePrivilege: 1,
