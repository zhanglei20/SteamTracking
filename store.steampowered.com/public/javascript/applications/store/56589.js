    ...
    [56589],
    {
      56589: (B, T, l) => {
        var u = l(48763),
          ...
          g = function (E, f) {
            f = f || {};
            var r = new u(f.typeNumber || -1, f.errorCorrectLevel || m.H);
            return r.addData(E), r.make(), r;
          };
        (g.ErrorCorrectLevel = m), (B.exports = g);
      },
      27932: (B, T, l) => {
        var u = l(91446);
        function m(g) {
        ...
        (m.prototype = {
          ...
          write: function (g) {
            for (var E = 0; E < this.data.length; E++)
              g.put(this.data.charCodeAt(E), 8);
          },
        }),
          (B.exports = m);
      },
      ...
      2163: (B) => {
        B.exports = { L: 1, M: 0, Q: 3, H: 2 };
      },
      24967: (B, T, l) => {
        var u = l(70555);
        function m(g, E) {
          if (g.length == null) throw new Error(g.length + "/" + E);
          for (var f = 0; f < g.length && g[f] == 0; ) f++;
          this.num = new Array(g.length - f + E);
        ...
        (m.prototype = {
          ...
          multiply: function (g) {
            for (
              var E = new Array(this.getLength() + g.getLength() - 1), f = 0;
              f < this.getLength();
              f++
            )
              for (var r = 0; r < g.getLength(); r++)
                E[f + r] ^= u.gexp(u.glog(this.get(f)) + u.glog(g.get(r)));
            return new m(E, 0);
          },
          mod: function (g) {
            if (this.getLength() - g.getLength() < 0) return this;
            for (
              var E = u.glog(this.get(0)) - u.glog(g.get(0)),
              ...
              f[r] = this.get(r);
            for (var r = 0; r < g.getLength(); r++)
              f[r] ^= u.gexp(u.glog(g.get(r)) + E);
            return new m(f, 0).mod(g);
          },
        }),
          (B.exports = m);
      },
        ...
        (a.addData = function (n) {
          ...
          (a.make = function () {
            if (this.typeNumber < 1) {
              ...
              for (n = 1; n < 40; n++) {
                for (
                  var e = m.getRSBlocks(n, this.errorCorrectLevel),
                    t = new g(),
                    o = 0,
                    i = 0;
                  i < e.length;
                ...
                for (var i = 0; i < this.dataList.length; i++) {
                  ...
                  t.put(s.mode, 4),
                    t.put(s.getLength(), E.getLengthInBits(s.mode, n)),
                    s.write(t);
                }
          ...
          (a.setupPositionAdjustPattern = function () {
            for (
              var n = E.getPatternPosition(this.typeNumber), e = 0;
              e < n.length;
              e++
            )
          ...
          (a.setupTypeNumber = function (n) {
            for (
              var e = E.getBCHTypeNumber(this.typeNumber), t = 0;
              t < 18;
              t++
            ) {
              var o = !n && ((e >> t) & 1) == 1;
              ...
              for (v == 6 && v--; ; ) {
                for (var h = 0; h < 2; h++)
                  if (this.modules[o][v - h] == null) {
                    var L = !1;
                    s < n.length && (L = ((n[s] >>> i) & 1) == 1);
                    var p = E.getMask(e, o, v - h);
                    p && (L = !L),
                      (this.modules[o][v - h] = L),
                      i--,
                      i == -1 && (s++, (i = 7));
                  }
          ...
          (r.createData = function (n, e, t) {
            for (
              var o = m.getRSBlocks(n, e), i = new g(), s = 0;
              s < t.length;
              s++
            ) {
              var v = t[s];
              i.put(v.mode, 4),
                i.put(v.getLength(), E.getLengthInBits(v.mode, n)),
                v.write(i);
            }
          ...
          (r.createBytes = function (n, e) {
            for (
              ...
              var L = e[h].dataCount,
                p = e[h].totalCount - L;
              (o = Math.max(o, L)), (i = Math.max(i, p)), (s[h] = new Array(L));
              for (var d = 0; d < s[h].length; d++)
                s[h][d] = 255 & n.buffer[d + t];
              t += L;
              var A = E.getErrorCorrectPolynomial(p),
      ...
      56941: (B, T, l) => {
        var u = l(2163);
        function m(g, E) {
          (this.totalCount = g), (this.dataCount = E);
        }
        (m.RS_BLOCK_TABLE = [
          [1, 26, 19],
          [1, 26, 16],
          ...
          (m.getRSBlocks = function (g, E) {
            var f = m.getRsBlockTable(g, E);
            if (f == null)
              throw new Error(
                "bad rs block @ typeNumber:" + g + "/errorCorrectLevel:" + E,
              );
          ...
          (m.getRsBlockTable = function (g, E) {
            switch (E) {
              case u.L:
                return m.RS_BLOCK_TABLE[(g - 1) * 4 + 0];
              case u.M:
                return m.RS_BLOCK_TABLE[(g - 1) * 4 + 1];
              case u.Q:
                return m.RS_BLOCK_TABLE[(g - 1) * 4 + 2];
              case u.H:
                return m.RS_BLOCK_TABLE[(g - 1) * 4 + 3];
              default:
                return;
            }
          }),
        ...
        var u = l(91446),
          ...
          f = {
            ...
            getErrorCorrectPolynomial: function (r) {
              for (var a = new m([1], 0), n = 0; n < r; n++)
                a = a.multiply(new m([1, g.gexp(n)], 0));
              return a;
            },
              ...
              for (var t = 0; t < a; t++)
                for (var e = 0; e < a - 6; e++)
                  r.isDark(e, t) &&
                    ...
                    r.isDark(e + 6, t) &&
                    (n += 40);
              for (var L = 0, t = 0; t < a; t++)
                for (var e = 0; e < a; e++) r.isDark(e, t) && L++;
              var p = Math.abs((100 * L) / a / a - 50) / 5;
              return (n += p * 10), n;
            },
          };
        B.exports = f;
