...
(self.webpackChunkstore = self.webpackChunkstore || []).push([
  [9297],
  {
            ...
            queryFn: async () => {
              ...
              if (h.iA.logged_in) {
                const a = p.w.Init(u.dN),
                  s = (await u.xt.GetNicknameList(t, a)).Body().toObject();
                s?.nicknames &&
    ...
    10820: (e, t, a) => {
      ...
      function G(e) {
        return B(e).length + b(e).length > 0;
      }
      const D = (0, i.PA)((e) => {
        const {
          emoticonStore: t,
                ...
                ...p,
                {
                  renderTab: (e) =>
                    (0, n.jsx)("span", {
                      ...
                      className: (0, m.A)(k().PickerTab, e && k().ActiveTab),
                      children: (0, n.jsx)(ee, {}),
                    }),
                  renderContent: () =>
                    (0, n.jsx)(F, {
          ...
          return (
            ...
            b(e).length &&
              r.push({
                ...
                items: l.pN.FilterStickers(b(e), s),
                onItemSelect: a,
      ...
      class V extends o.Component {
        ...
        render() {
          ...
          return (0, n.jsx)(f, {
            ...
            onItemSelect: a,
            renderItem: (e) =>
              (0, n.jsx)(X, { effect: e, roomEffectSettings: t }),
            keyExtractor: ({ name: e }) => e,
            onFilterChange: (e) => this.setState({ filter: e }),
            filter: s,
            onSubmit: () => a(r[0]),
      ...
      const Z = (e) => {
        ...
        return (0, n.jsxs)("div", {
          ...
          children: [
            (0, n.jsx)(P.n, { emoticon: t.name, large: a }),
            s && (0, n.jsx)(J, {}),
          ],
        });
      };
      class K extends o.Component {
        ...
        render() {
          ...
          return (0, n.jsxs)("div", {
            ref: this.m_ref,
            className: (0, m.A)(t, k().StickerButton),
      ...
      class X extends o.Component {
        ...
        render() {
          ...
          return (0, n.jsxs)("div", {
            ...
            onMouseLeave: () => this.setState({ showHover: !1 }),
            onBlur: () => this.setState({ showHover: !1 }),
            className: (0, m.A)(a, k().EffectButton),
            ...s,
            children: [
              r.renderEffectIcon(),
              this.state.showHover &&
      ...
      function J() {
        return (0, n.jsx)("div", {
          ...
          children: (0, n.jsx)("div", { className: k().NewEmoticonCircle }),
        });
      }
      function $(e) {
        return (0, n.jsxs)("svg", {
    ...
    1909: (e, t, a) => {
      ...
      (0, s.Cg)([u.oI], g.prototype, "OnLanguageChange", null),
        (g = (0, s.Cg)([r.PA], g));
    },
    73067: (e, t, a) => {
      "use strict";
      ...
      class b extends N {
        ...
        renderMatch(e) {
          return (0, s.jsxs)(
            "div",
            {
              className: (0, f.A)(P().BBCodeSuggestion),
              children: [
                (0, s.jsx)("div", { className: P().BBCode, children: e.name }),
                "[",
                e.name,
                "]...[/",
                e.name,
      ...
      (0, p.Cg)([v.oI], G.prototype, "BindMentionDialog", null),
        (0, p.Cg)([v.oI], G.prototype, "OnKeyDown", null),
        (0, p.Cg)([v.oI], G.prototype, "OnFocus", null),
        (0, p.Cg)([v.oI], G.prototype, "OnKeyPress", null),
        (0, p.Cg)([v.oI], G.prototype, "OnClick", null),
        (0, p.Cg)([v.oI], G.prototype, "OnEmoticonSuggestionSelected", null),
        (0, p.Cg)([v.oI], G.prototype, "OnBBCodeSuggestionSelected", null),
        ...
        return (0, s.jsxs)(s.Fragment, {
          children: [
            ...
            (0, s.jsx)(D.$n, {
              ...
              children: (0, B.we)("#BBCode_ChooseImage", n, r),
            }),
          ],
        });
      });
      ...
      let _e = class extends o.Component {
        ...
        OnAddLink(e) {
          (0, F.HT)(
            (0, s.jsx)(ve, { textareaRef: this.props.fnTextareaRef() }),
            (0, V.uX)(e),
          );
        }
        ShowHelpDialog(e) {
          this.props.showFormatHelp &&
            (0, F.HT)(
              (0, s.jsx)(le, { formatType: this.props.showFormatHelp }),
              (0, V.uX)(e),
            );
        }
        ...
        OnOpenImageDialog(e) {
          (0, F.HT)(
            (0, s.jsx)(Se, { textareaRef: this.props.fnTextareaRef() }),
            (0, V.uX)(e),
          );
        }
      ...
      let Se = class extends o.Component {
        ...
        OnImageInsert() {
          ...
          e && e.length > 0 && ((a += "[url=" + e + "]"), (s = "[/url]" + s)),
            (a += "[img]" + t),
            (s = "[/img]" + s),
            ue.wrapBBCode(a, s, this.props.textareaRef.current);
        }
        OnImageURLChange(e) {
                  ...
                  (0, s.jsxs)("div", {
                    ...
                    children: [
                      ...
                      (0, s.jsx)(D.$n, {
                        onClick: (e) =>
                          (0, u.lX)(
                            (0, s.jsx)(Ie, { friends: v, setSteamID: x }),
                            e,
                          ),
                        children: (0, B.we)(
      ...
      function Ie(e) {
        ...
        return (0, s.jsx)("div", {
          ...
          children: t.map((e) =>
            (0, s.jsx)(ye, { steamid: e, setSteamID: a }, e),
          ),
        });
      }
      function ye(e) {
          ...
          j = async () => {
            ...
            try {
              if (W.TS.IN_STEAMUI) {
                ...
                let n = await h.xt.PostStatusToFriends(
              ...
              const a = (0, oe.H)(t),
                s =
                  ...
                  "\n\n" +
                  a.strErrorMsg;
              e.token.reason || v(s), console.error(s);
            }
          };
        return _
          ? (0, s.jsx)(O.o0, {
    ...
    8905: (e, t, a) => {
      ...
      function c(e) {
        const {
          ...
          [m] = (0, i.KT)(t),
          h = (0, i.KM)(t),
          p = n.useMemo(() => r.b.InitFromAccountID(t), [t]),
    ...
    81416: (e, t, a) => {
        ...
        UpdateState(e) {
          ...
          this.props.bLockAspectRatio &&
            (void 0 !== e.curLeftPosPct || void 0 !== e.curRightPosPct
              ? (i = r / this.m_aspectRatio)
              : (r = i * this.m_aspectRatio)),
            void 0 !== e.curLeftPosPct
              ? (s = 100 - n - r)
              : (n = 100 - (s + r)),
            void 0 !== e.curTopPosPct ? (t = 100 - a - i) : (a = 100 - (t + i));
          const o = 100 - n - s,
            l = 100 - a - t;
          this.IsValidPct(s) &&
            this.IsValidPct(n) &&
      ...
      (0, n.Cg)([o.oI], g.prototype, "LinkRegionBoxRef", null),
        (0, n.Cg)([o.oI], g.prototype, "OnMouseDown", null),
        (0, n.Cg)([o.oI], g.prototype, "OnMouseMove", null),
        (0, n.Cg)([o.oI], g.prototype, "OnMouseUp", null),
        (0, n.Cg)([o.oI], g.prototype, "HandleDelete", null),
        (0, n.Cg)([o.oI], g.prototype, "OnSetLinkURLChange", null),
        (0, n.Cg)([o.oI], g.prototype, "OnSetLinkDescriptionChange", null),
        (0, n.Cg)([o.oI], g.prototype, "OnSaveLink", null),
        (0, n.Cg)([o.oI], g.prototype, "OnEditLink", null),
        (g = (0, n.Cg)([l.PA], g));
    },
    30700: (e, t, a) => {
      "use strict";
    ...
    13643: (e, t, a) => {
      ...
      var _ = a(51680),
        g = a(61859);
      function x() {
        return (0, l.useContext)(Zs).bIsUser;
      }
      function v() {
        return (0, l.useContext)(Zs).themeStyle;
      }
      function S(e) {
      ...
      (0, o.Cg)([R.sH], b.prototype, "m_privacyState", void 0);
      ...
      class H {
        ...
        async PreloadStoreItemCache(e) {
          ...
          if (1 != s.GetEResult()) throw "error loading game info";
      ...
      function X(e) {
        const t = (0, l.useContext)(Zs).Screenshots,
          { data: a } = (0, h.I)({
            queryKey: [
              "yirscreenshots",
      ...
      function ae(e, t, a) {
        const [s, n] = (0, l.useState)(te.Get().GetAchievement(e, t, a)),
          [r, i] = (0, l.useState)(a);
        return (
          (0, l.useEffect)(() => {
            (s && r == a) ||
          ...
          children: [
            ...
            (0, s.jsxs)("div", {
              ...
              children: [
                ...
                Boolean(!f) &&
                  (0, s.jsx)(Pe, { percentVal: u, subToken: "#YIR_NewLine" }),
              ],
            }),
            Boolean(o) &&
              (0, s.jsx)("div", {
      ...
      function ke(e) {
        ...
        if (!d || !d.BIsVisible())
          return !l || (1 != c && 12 != c)
            ? null
            : (0, s.jsx)(ke, { ...e, nParentAppID: l, eChildType: 0 });
        ...
        return (
          (0, l.useEffect)(() => {
            ...
            const s = () => {
              ...
              c <= t ? (p(c), (u.current = requestAnimationFrame(s))) : p(t);
            };
            return (
              r &&
                (o && o(),
      ...
      function Ct(e) {
        ...
        let r = t.GetPlayTimeStats().summary_stats?.total_achievements || 0,
          ...
          h = o > 0 && m > 0 && "cn" !== st.iA.country_code.toLowerCase();
        c >= 99 && (c = 100),
          d >= 99 && (d = 100),
          m >= 99 && (m = 100),
      ...
      function At(e) {
        ...
        let n = a.map(([e, t]) =>
          (0, s.jsx)(Nt, { label: (0, g.we)(e), value: t }, e),
        );
        return (0, s.jsxs)("div", {
      ...
      function qt(e) {
        ...
        const x = (0, l.useRef)(null),
          ...
          f = (0, s.jsx)(ht, { endValue: d, duration: 2e3, startAnimation: S }),
          w = (0, s.jsx)(ht, { endValue: m, duration: 2e3, startAnimation: S }),
          N =
            ((0, s.jsx)(ht, { endValue: u, duration: 2e3, startAnimation: S }),
            (0, l.useRef)(null));
        return (
          (0, Yt.q)(N),
          (0, s.jsxs)("div", {
      ...
      function Sa(e) {
        ...
        if (!r && c.iA.logged_in)
          return (0, s.jsx)(Bt.Ii, {
            ...
            href: `${c.TS.STORE_BASE_URL}replay/${c.iA.steamid}/${n}?src=9`,
      ...
      function ya(e) {
        const { closeModal: t, userYearInReview: a, steamId: n, nYear: r } = e,
          ...
          _ = ((x = n), _a.Get().GetAccountShortCode(x));
        var x;
        ...
        return i
          ? (0, s.jsx)(xa.J, { eventLink: C, closeModal: t })
          : (0, s.jsx)(ua.o0, {
              strDescription: "",
      ...
      function Ea(e) {
        const t = (0, l.useContext)(Zs).persona_name,
          {
            rgGamesLength: a,
            nNewGames: n,
            nDemoPlayed: r,
              ...
              ? (0, s.jsxs)("div", {
                  ...
                  children: [
                    ...
                    (0, s.jsx)("div", {
                      ...
                      children: (0, g.Yp)(t + "Less", n - a, (0, _e.Dq)(n - a)),
                    }),
                  ],
                })
              : (0, s.jsxs)("div", {
                  ...
                  children: [
                    ...
                    (0, s.jsx)("div", {
                      className: Se().CompareText,
                      children: (0, g.Yp)(t + "More", a - n, (0, _e.Dq)(a - n)),
                    }),
                  ],
                });
      }
              ...
              (0, s.jsxs)("div", {
                ...
                children: [
                  (0, s.jsx)("div", {
                    ...
                    children: os(o, t, "#YIR_MonthlyCharts_PlayedTotalTooltip"),
                  }),
                  !_ &&
                    (0, s.jsxs)(s.Fragment, {
                      children: [
      ...
      function _s(e) {
        const [t, a] = (0, l.useState)(us.Get().GetAchievements(e)),
          [s, n] = (0, l.useState)(e);
        return (
          (0, l.useEffect)(() => {
      ...
      function ys(e) {
        ...
        return (0, s.jsxs)("div", {
          ...
          children: [
            ...
            (0, s.jsx)("img", {
              className: (0, he.A)(Is().Icon, h && Is().IconGlow),
              src: t,
              loading: "lazy",
              alt: i,
              onLoad: () => m(!0),
      ...
      function Ts(e) {
        ...
        return n?.length > 0
          ...
          : (0, s.jsx)(me.t, { size: "small", string: (0, g.we)("#Loading") });
      }
      const Rs = 10;
      function ks(e) {
      ...
      function Bs(e) {
        ...
        return r && 0 != r.length
          ? (0, s.jsxs)("div", {
              className: (0, he.A)(ve.YearInReviewContent, Ps.ScreenshotsCtn),
              children: [
                o,
                (0, s.jsx)("div", {
                  className: Ps.ScreenshotHeader,
                  children: l("#YIR_ScreenshotsThisYear"),
                }),
                (0, s.jsx)("div", {
                  className: Ps.ScreenshotRow,
                  children: r.map((e, t) =>
                    (0, s.jsx)(
                      Gs,
                      {
      ...
      function Gs(e) {
        const {
          ...
          [i, o] = (0, l.useState)(n),
          d = { backgroundImage: `url(${t.image_url + bs})` },
          m = `${c.TS.IMG_URL}yearinreview/screenshot_placeholder.png`;
        return (0, s.jsxs)("div", {
          className: Ps.ScreenshotCtn,
          onClick: () => {
            i && o(!1), a();
          },
          style: d,
          children: [
            i &&
              (0, s.jsx)("div", {
                className: Ps.ContentRestrictionText,
                children: (0, g.we)(
      ...
      const Ys = l.memo((e) => {
        ...
        const R = A?.find((e) => e.percent > 0),
          k = R ? R.date.getMonth() : null,
          L = k ? (0, g.we)(`#YIR_MonthlyCharts_MonthNoun_${k + 1}`) : "",
          P = Math.trunc(o.total_sessions);
        let B = "";
        j && y
        ...
        return (
          o.demo
            ? (b = (0, g.we)("#YIR_GameName_PlusDemo", b))
            : o.playtest && (b = (0, g.we)("#YIR_GameName_PlusPlaytest", b)),
          (0, s.jsxs)(je, {
            className: (0, he.A)(
              ge.TopGameBlockContainer,
              ge[S],
      ...
      function Ws(e) {
        ...
        if (!a || !t)
          return (0, s.jsx)($s, { message: (0, g.we)("#YIR_Error_NoData") });
        const i = new k.b(a);
      ...
      function zs(e) {
        ...
        if (!n || !t.BIsIndividualAccount())
          return (0, s.jsx)($s, { message: (0, g.we)("#YIR_Error_NoUser") });
        if (!i)
          return (0, s.jsx)($s, {
      ...
      function Qs(e) {
        ...
        !(function (e, t, a) {
          const [s, n] = (0, l.useState)(te.Get().GetManyAchievement(e, t, a));
          (0, l.useEffect)(() => {
            a?.length > 0 &&
              te
                .Get()
          ...
          children: [
            ...
            (0, s.jsx)(oe.tH, {
              children: (0, s.jsxs)(qe, {
                userYearInReview: t,
                children: [
                  (0, s.jsx)(ka, { userYearInReview: t }),
                  Boolean(1 === _) && (0, s.jsx)(Ds, { userYearInReview: t }),
                ],
              }),
            }),
            (0, s.jsx)(oe.tH, {
            ...
            (0, s.jsx)(oe.tH, {
              children: (0, s.jsx)(bt, { userYearInReview: t }),
            }),
            (0, s.jsx)(oe.tH, {
      ...
      var an = a(32630);
      const sn = { Home: (e, t) => `${i.B.YearInReview(e, t)}` };
      function nn(e) {
        return (
          (0, ue.YM)(),
          (0, s.jsx)(n.u, {
            navID: "YearInReviewPageRoot",
            children: (0, s.jsx)(an.Ay, {
