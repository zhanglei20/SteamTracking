  ...
  [706],
  {
    ...
    35720: (e, t, n) => {
      ...
      function c(e) {
        ...
        return (0, s.n)({
          mutationFn: () =>
            (async function (e, t) {
              const n = r.w.Init(i.lO);
              n.Body().set_item_id(o.O4.fromObject(t));
              const a = await i._o.AddFreeLicense(e, n);
    ...
    26514: (e, t, n) => {
      ...
      function p(e, t, n, p) {
        const C = (0, d.j4)(),
          _ = (0, r.KV)(),
          g = (0, s.jE)(),
          { storeBrowseContext: h, dataLoader: f } = (0, i.yn)(),
          { country: w } = h,
          v = (0, a.Gd)(p);
        return (0, l.n)({
          mutationFn: async () => {
            ...
            let r;
            if ((0, c.c2)(C)) {
              const [i, o] = await (0, u.Jn)(_, w, e, t, n, v);
              if (1 != i) throw `AddToAccountCart failed with ${i}`;
              (r = o.line_item_ids), (0, m.LN)(g, C, o.cart);
            } else {
              if (!(0, c.kx)(C)) throw "Invalid cart type";
              {
                const [i, o] = await (0, u.SI)(_, e ? [e] : void 0, t, n);
                if (1 != i || !o)
          ...
          onMutate: () => {
            ...
            (async () => {
              const e = await g.fetchQuery((0, o.us)(f, n)),
                t =
    ...
    99116: (e, t, n) => {
      ...
      (i.arabic = () => n.e(6696).then(n.t.bind(n, 6696, 19))),
        ...
        (i.bulgarian = () => n.e(3473).then(n.t.bind(n, 53473, 19))),
        (i.czech = () => n.e(3899).then(n.t.bind(n, 83899, 19))),
        (i.danish = () => n.e(4925).then(n.t.bind(n, 84925, 19))),
        (i.dutch = () => n.e(9902).then(n.t.bind(n, 69902, 19))),
        (i.english = () => n.e(8335).then(n.t.bind(n, 80716, 19))),
        (i.finnish = () => n.e(1663).then(n.t.bind(n, 81663, 19))),
        (i.french = () => n.e(8484).then(n.t.bind(n, 48484, 19))),
        (i.german = () => n.e(6810).then(n.t.bind(n, 66810, 19))),
        (i.greek = () => n.e(3744).then(n.t.bind(n, 13744, 19))),
        (i.hungarian = () => n.e(2101).then(n.t.bind(n, 62101, 19))),
        (i.indonesian = () => n.e(8948).then(n.t.bind(n, 68948, 19))),
        ...
        (i.portuguese = () => n.e(6865).then(n.t.bind(n, 96865, 19))),
        (i.romanian = () => n.e(1391).then(n.t.bind(n, 71391, 19))),
        (i.russian = () => n.e(4933).then(n.t.bind(n, 64933, 19))),
        (i.sc_schinese = () => n.e(7503).then(n.t.bind(n, 27503, 19))),
        (i.schinese = () => n.e(4768).then(n.t.bind(n, 44768, 19))),
        (i.spanish = () => n.e(876).then(n.t.bind(n, 20876, 19))),
        (i.swedish = () => n.e(5181).then(n.t.bind(n, 75181, 19))),
        (i.tchinese = () => n.e(9779).then(n.t.bind(n, 89779, 19))),
        (i.thai = () => n.e(3732).then(n.t.bind(n, 98970, 19))),
      ...
      function c(e, t) {
        ...
        if (c.getFullYear() != s.getFullYear())
          return l(e, { month: n ? "long" : "short" });
        const u = new Date();
        if ((u.setHours(0, 0, 0, 0), i))
          if (c >= u) {
    ...
    706: (e, t, n) => {
        ...
        const { id: t, snr: n, classOverride: i } = e,
          ...
          { mutateAsync: B } = (function (e, t, n, r = 0) {
            const i = (0, x.h3)(),
              o = y.iA.accountid;
            return (0, b.n)({
              mutationKey: ["useUpdateAppIgnore", e, o, t],
              mutationFn: async () => {
                if (null == e) return;
                const i =
                    y.TS.STORE_BASE_URL + "recommended/ignorerecommendation",
                  o = new FormData();
                o.append("appid", "" + e),
                  o.append("sessionid", (0, L.KC)()),
                  o.append("remove", t ? "0" : "1"),
                  n && o.append("snr", n),
                  o.append("ignore_reason", "" + r);
                ...
                if (!a.ok)
                  throw new Error(
                    `Ignore App ${t ? "add" : "remove"} of appid ${e} failed (${a.status})`,
                  );
              },
              onMutate: () => {
          ...
          A = t && "appid" in t && d.Fm.Get().BIsGameIgnored(t.appid);
        return (0, r.jsxs)(v.Z, {
          className: (0, C.A)(f().IgnoreButton, i),
          onClick: async (e) => {
            e.preventDefault(),
              e.stopPropagation(),
              g.iA.logged_in
                ? t &&
                  "appid" in t &&
                  (a(!0), await B(), s.token.reason || a(!1))
                : c();
          },
          children: [
            (0, r.jsx)(m.NtH, {}),
            (0, r.jsx)("div", {
              className: (0, C.A)(
                f().IgnoreButtonText,
                o && f().IgnoreLoadingText,
              ),
              children: (0, _.we)(
                A ? "#Sale_RemoveFromIgnored" : "#Sale_Ignore",
              ),
            }),
            l,
          ],
      ...
      function U(e, t) {
        return {
          ...
          rctImage: (0, r.jsx)(H.m, { id: e, active: !0 }),
          nDurationMs: G,
        };
      }
      function K(e, t, n, i) {
        return n.slice(0, i).map((n, i) => {
          const o = (0, A.bu)(n, "1920x1080");
          return {
            stringifyID: `screen${i}_${(0, N.ER)(e)}`,
            rctImage: (0, r.jsx)(
              "img",
              {
                className: P().FullDivImage,
      ...
      function q(e) {
        ...
        const i = n.item_type,
          o = n.type;
        return 2 == i || 1 == i
          ? (0, r.jsx)($, { includeAppIDs: n.included_appids })
          : (1 == o || 12 == o) &&
              n.related_items &&
            ...
            : (0, r.jsx)(Q, { storeItemDefaultData: n });
      }
      function Q(e) {
          ...
          s = (0, u.useMemo)(
            () =>
              (function (e, t, n, r, i) {
                ...
                if (
                  (i && o.push(U(e)),
                  r && r.length > 0 && o.push(...K(e, t.name, r, W)),
        ...
        return (0, r.jsx)(ee, { rgTrailerAndImages: s });
      }
      function Y(e) {
        const { demoItemDefaultInfo: t, parentAppID: n } = e,
          i = (0, V.QO)(t);
        return (0, k.TH)(i)
          ? (0, r.jsx)(Q, { storeItemDefaultData: t })
          : (0, r.jsx)(X, {
              demoID: i,
      ...
      function X(e) {
        const { parentAppID: t, demoID: n, demoItemDefaultInfo: i } = e,
          o = (0, M.$5)(t),
          a = (0, A.DT)(n),
          s = (0, A.DT)(o),
          l = (0, k.TH)(o),
          c = (0, u.useMemo)(
            () =>
              (function (e, t, n, r, i, o) {
                const a = [];
                o && a.push(U(t)),
                  r && r.length > 0 && a.push(...K(e, n.name, r, W));
                const s = W - (r?.length || 0);
                return (
                  s > 0 && i && i.length > 0 && a.push(...K(e, n.name, i, s)),
                  ((e && 0 == a.length && "dev" == g.TS.WEB_UNIVERSE) ||
                    "beta" == g.TS.WEB_UNIVERSE) &&
                    console.error(
      ...
      function $(e) {
        const { includeAppIDs: t } = e,
          n = (0, I.eG)(),
          i = (0, T.E)({ queries: t.map((e) => (0, D.AQ)(n, { appid: e })) }),
          o = (0, T.E)({ queries: t.map((e) => (0, D.us)(n, { appid: e })) }),
          a = (0, u.useMemo)(
            () => i.map((e, t) => z(o[t].data, e.data)).filter((e) => !!e),
            [i, o],
          );
        return (0, r.jsx)(ee, { rgTrailerAndImages: a });
      }
      function ee(e) {
        const { rgTrailerAndImages: t } = e,
          n = (0, u.useRef)(0),
          i = (0, F.CH)(),
          [o] = u.useState(new E.LU()),
          a = (0, u.useCallback)(
            (e = !1) => {
      ...
      function me(e) {
        ...
        return (0, r.jsxs)("div", {
          ...
          role: "button",
          tabIndex: 0,
          className: (0, C.A)(le().ItemHoverSource, s),
          onMouseEnter: (e) => {
      ...
      function pe(e) {
        const {
          ...
          [l, c] = u.useState(a),
          { targetElement: d = o.ownerDocument.body } = (0, oe.gK)();
        if (
          (u.useEffect(() => {
            if (a) {
              if (n) {
        ...
        const m = o.clientWidth < 200 ? "8px" : "10px",
          p = {
            ...
            style: {
              ...
              height:
                "hiding" == _e() ? 1.15 * o.clientWidth * (125 / 184) : void 0,
              ...t?.style,
            },
            target: o,
          };
      ...
      function Ce(e) {
        const { hoverProps: t, children: n } = e,
          i = u.useCallback((e) => e?.focus(), []);
        return (0, r.jsx)(re.g, {
          ...t,
          children: (0, r.jsx)(ue.M, {
            timeout: 500,
            in: !0,
            appear: !0,
        ...
        return (0, r.jsxs)("div", {
          ...
          children: [
            ...
            (0, r.jsx)("div", {
              ...
              ref: (e) => L(`translateY( -${e?.clientHeight || 0}px )`),
              children: (0, r.jsxs)("div", {
                ...
                children: [
                  ...
                  p && (0, r.jsx)(a.j, { id: t, className: P().DemoButton }),
                  Boolean(h && H) && (0, r.jsx)(fe.Q8, { id: t }),
                  Boolean(m) && m,
                  f &&
                    H &&
                    t &&
                    "appid" in t &&
                    t.appid &&
                    (0, r.jsx)(s.E, { appid: t.appid, bIsMuted: !1 }),
                  w && (0, r.jsx)(l.Q, { nCreatorAccountID: w }),
                ],
              }),
            }),
          ],
      ...
      function Le(e) {
        ...
        if (!n) return null;
        const i = (0, he.CC)(n);
        return (0, r.jsx)("div", { className: P().ReleaseDate, children: i });
      }
      function je(e) {
        const { id: t } = e,
          { data: n } = (0, D.wl)(t);
              ...
              children: [
                (0, r.jsxs)("a", {
                  ...
                  children: [
                    ...
                    Boolean(l && !a) && (0, r.jsx)(j, { id: n, snr: e.strSNR }),
                    t && (0, r.jsx)(q, { id: t }),
                  ],
                }),
                (0, r.jsx)(ye, { ...e }),
      ...
      function Ae(e) {
        const {
          ...
          { data: v } = (0, D.J$)(t),
          x = (0, g.Qn)(),
          { strStoreURL: S, snr: b } = (0, te.x)(v, s);
        if ((!v && !n) || x) return (0, r.jsx)(r.Fragment, { children: d });
        let y = t;
        v &&
          1 == v.item_type &&
          1 == v.included_appids?.length &&
          (y = { appid: v.included_appids[0] });
        const L = i || !v ? void 0 : S,
          j = {
            id: t,
            displayID: y,
            name: n,
          ...
          B = (0, r.jsx)(Be, { ...j }),
          A = L ? (0, r.jsx)("a", { href: L, children: d }) : d;
        return (0, r.jsx)(me, {
          hoverContent: B,
          nWidthMultiplier: p,
          ...w,
    ...
    18638: (e, t, n) => {
          ...
          (function (e, t) {
            return {
              ...
              queryFn: async () => {
                ...
                if (n) {
                  n.appid && t.setQueryData(m(n.appid), n.clanAccountID),
                    n.vanity_url &&
      ...
      function b(e) {
        ...
        return a && s
          ? (0, r.jsxs)("div", {
              className: (0, S.A)(x().GameHoverCreatorFollowButtonCtn, n),
              style: i,
              children: [
                (0, r.jsx)("a", {
                  href: h(s, "developer"),
    ...
    24267: (e, t, n) => {
      ...
      var r = n(7850),
        ...
        _ = n(8527);
      function g(e) {
        const { id: t, bTruncateTotalReviews: n, bShowTooltip: m } = e,
          { data: g } = (0, a.ik)(t),
          { data: h } = (0, a.J$)(t),
          f = (0, s.h)(t),
          { data: w } = (0, a.J$)(f);
        if (!g || !h) return null;
        if (1 == h.type && !(0, o.J)(w)) return null;
        let v = g.summary_unfiltered || g.summary_filtered,
          x = "#ReviewScore_UserReviewScoreAria",
          S = !1;
        const b = C.Z.Localize("#Language_" + _.TS.LANGUAGE);
        if (
          (l.Fm.Get().BShowFilteredUserReviewScores() &&
            (g.summary_language_specific
              ? ((S = !0),
                (x = "#ReviewScore_UserReviewScoreAria_LanguageSpecific"),
                (v = g.summary_language_specific))
              : (v = g.summary_filtered)),
          !v || !v.review_score)
        )
          return null;
        let y = p().ReviewScoreNone;
        y =
          v.review_score > 0 && v.review_score < 5
            ? p().ReviewScoreLow
            : 5 == v.review_score
              ? p().ReviewScoreMixed
              : p().ReviewScoreHigh;
        const L = `${_.TS.STORE_BASE_URL}app/${h.appid}/#app_reviews_hash`,
          j = (0, r.jsxs)("div", {
            className: (0, d.A)(p().ReviewScoreValue, y),
            children: [
              (0, r.jsx)("div", {
                className: p().ReviewScoreLabel,
                "aria-label": C.Z.Localize(x, v.review_score_label, b),
                children: v.review_score_label,
              }),
              (0, r.jsxs)("div", {
                className: p().ReviewScoreCount,
                "aria-label": C.Z.Localize(
                  "#GameHover_UserReviewCount",
                  v.review_count.toLocaleString((0, i.J)()),
                ),
                children: [
                  "(",
                  n
              ...
              !n &&
                (0, r.jsxs)("div", {
                  ...
                  children: [" ", C.Z.Localize("#GameHover_UserReviewsHeader")],
                }),
            ],
          });
        let B = "#ReviewScore_PercentPositive";
        if (2 === h.item_type) B = "#ReviewScore_PercentPositive_bundle";
    ...
    94636: (e, t, n) => {
      ...
      function w(e) {
        const { id: t, snr: n, classOverride: g, styleOverride: w } = e,
          { data: v } = (0, a.J$)(t),
          { elDialogElement: x, fnShowLogonDialog: S } = (0, o.E)(),
          [b, y] = (0, u.useState)(() =>
          ...
          { bIsOwned: B } = (0, s.ZJ)(L),
          [A, k] = (0, u.useState)(!1),
          H = (0, p.m)("GameHoverWishlistButton"),
          { mutateAsync: N } = (0, c.s)(b, !j, n);
        (0, u.useEffect)(() => {
          t &&
            "appid" in t &&
            (1 == v?.type || 12 == v?.type) &&
            y(v.related_items?.parent_appid || t.appid);
        }, [v, t]);
        const D = (0, u.useCallback)(
          async (e) => {
            e.preventDefault(),
              e.stopPropagation(),
              _.iA.logged_in
                ? (k(!0), await N(), H.token.reason || k(!1))
                : S();
          },
          [H.token.reason, S, N],
        );
        return B && 10 != v?.type
          ? null
          : (0, r.jsxs)(i.Z, {
              className: (0, C.A)(h().WishlistButton, g),
              onActivate: D,
              style: w,
              children: [
                j ? (0, r.jsx)(m.qnF, {}) : (0, r.jsx)(m.T4m, {}),
                (0, r.jsx)("div", {
                  className: (0, C.A)(
                    h().WishlistButtonText,
                    A && h().WishlistLoadingText,
                    "WishlistButtonText",
                  ),
                  children: f.Z.Localize(
                    j ? "#Sale_RemoveFromWishlist" : "#Sale_AddToWishlist",
                  ),
                }),
                x,
              ],
    ...
    40807: (e, t, n) => {
        ...
        const { setRemoteClientID: t, rgSessions: n } = e,
          i = (0, w.useCallback)(
            (e) => {
              n?.length &&
                (0, y.lX)(
                  (0, r.jsx)(N, { sessions: n, setRemoteDownloadClientId: t }),
                  e,
                  k,
                );
            },
      ...
      function N({ sessions: e, setRemoteDownloadClientId: t }) {
        return (0, r.jsx)("ul", {
      ...
      function G(e) {
        const { rgAcceptableSession: t, session: n, setSessionIndex: i } = e;
        return (0, r.jsxs)(r.Fragment, {
          children: [
            ...
            (0, r.jsxs)("div", {
              className: F().ClientSelector,
              children: [
                (0, r.jsx)("span", {
                  className: F().ClientName,
      ...
      function O(e) {
        const { session: t } = e;
        return (0, r.jsxs)("div", {
          className: F().DownloadStartedCtn,
          children: [
      ...
      function W(e) {
        const { appid: t, session: n, setRemoteDownloadRequested: i } = e,
          o = (0, S.we)(t, n.client_instanceid);
        return (0, r.jsxs)(r.Fragment, {
          children: [
            (0, r.jsxs)(g, {
              onClick: () => {
      ...
      function U(e) {
        ...
        const m =
          ...
          C = p || 1 === u.type,
          _ = C
            ? z.Z.Localize("#Sale_InstallDemo_ttip", u.name || "")
            : p
              ? z.Z.Localize("#Sale_CannotInstallDemo_ttip", u.name || "")
        ...
        return !C && p && u.is_free
          ? (0, r.jsx)(c.h, { id: t, className: n })
          : (0, r.jsx)(a.he, {
              toolTipContent: _,
              onClick: (e) => {
                e.preventDefault(),
                  e.stopPropagation(),
                  C && (0, o.o)(1 === u.type ? u.appid : m[0], u.name);
              },
              className: (0, s.A)(n, d().DemoButton, !C && d().DisabledButton),
              children: C
    ...
    3740: (e, t, n) => {
      ...
      function _(e) {
        ...
        if (x && x.is_coming_soon && (!S || !S.packageid)) {
          if (d) return null;
          const e =
            x.coming_soon_display &&
            ["text_comingsoon", "text_tba"].includes(x.coming_soon_display)
              ? (0, s.d)(x)
              : p.Z.Localize(
        ...
        if (b.is_free) {
          if (!b.is_free_temporarily)
            return 0 == b.item_type && 1 == b.type
              ? _
                ? null
                : (0, r.jsxs)("div", {
                    className: L,
        ...
        let j = S.discount_pct || 0,
          B = l || 2 != b.item_type ? 0 : S.bundle_discount_pct || 0,
          A = S.formatted_final_price;
        const k = (0, o.Nq)(x, S);
        return (0, r.jsx)(g, {
          ...
          strBestPurchaseOriginalPriceFormatted:
            ...
            "",
          strBestPurchasePriceFormatted: A,
      ...
      function g(e) {
        ...
        return (
          n &&
            (w = f
              ? p.Z.Localize("#Discount_ARIA_Label_SpecialPrice", a)
              : p.Z.Localize("#Discount_ARIA_Label", n, a, s)),
          (0, r.jsxs)("div", {
            className: (0, m.A)({
              [c().StoreSalePriceWidgetContainer]: !0,
              [c().SingleLineMode]: t,
    ...
    90421: (e, t, n) => {
      ...
      function p(e) {
        const { tagid: t, className: n } = e,
          a = (0, o.MB)(t, d.TS.LANGUAGE);
        if (!a) return null;
        const u = (0, i.ww)((0, i.sf)(d.TS.LANGUAGE)),
          m = `${d.TS.STORE_BASE_URL}tags/${u}/${a}`;
        return (0, r.jsx)(l.q, {
          url: m,
    ...
    52471: (e, t, n) => {
      ...
      function a(e) {
        const { data: t } = (0, i.Yo)(e),
          n = (0, o.dy)();
        if (!t) return;
        const r = [...(t.highlights || []), ...(t.other_trailers || [])];
        return n ? r.filter((e) => !!e.all_ages) : r;
      }
      function s(e) {
        let t = a(e);
      ...
      function l(e) {
        return `${r.TS.STORE_ITEM_BASE_URL}${e.trailer_url_format.replace("${FILENAME}", e.screenshot_full ?? e.screenshot_medium ?? "")}`;
      }
      function c(e, t) {
        return `${r.TS.VIDEO_CDN_URL}store_trailers/${e.trailer_url_format.replace("${FILENAME}", t)}`;
      }
      function u(e, t) {
        return `${r.TS.VIDEO_CDN_URL}store_trailers/${t}`;
      }
      function d(e) {
        let t = [];
        e.adaptive_trailers &&
    ...
    80696: (e, t, n) => {
      ...
      var r,
        ...
        m = n.n(d);
      function p(e) {
        const { id: t, active: n, bIsHoverMode: s, eGrowOnHover: d } = e,
          { data: C } = (0, a.J$)(t),
          _ = c.useRef(0),
          g = c.useRef(null);
        c.useLayoutEffect(() => {
          n && g.current && (g.current.currentTime = _.current);
        }, [n]);
        const h = (0, u.kB)(n ? t : void 0);
        if ((s && o.TS.IN_MOBILE) || !n) return null;
        if (!C || !C.visible || !h) return null;
        ...
        if (0 === f.length)
          return C &&
            ...
            ? (0, i.jsx)(p, {
                ...e,
                id: { appid: C.related_items.parent_appid },
              })
            : null;
        let w;
        switch (d) {
          case r.k_ETrailerGrowAmount_Small:
            w = m().GrowOnHoverSmall;
            break;
        ...
        return (0, i.jsx)("video", {
          className: l()(m().CapsuleMicroTrailer, w),
          loop: !0,
          muted: !0,
          controls: !1,
          autoPlay: !0,
          ...
          children: v.microtrailer?.map((e) =>
            o.TS.IN_CLIENT && "video/mp4" == e.type
              ? null
              : (0, i.jsx)(
                  "source",
                  { src: (0, u.M4)(v, e.filename || ""), type: e.type },
                  e.filename,
                ),
          ),
        });
    ...
    5309: (e, t, n) => {
        ...
        return e?.is_coming_soon
          ? (function (e, t, n) {
              switch (e) {
                ...
                case "date_year":
                  return new Date(1e3 * t).toLocaleDateString((0, i.J)(), {
                    year: "numeric",
                  });
      ...
      function l(e) {
        return new Date(1e3 * e).toLocaleDateString((0, i.J)());
      }
      function c(e) {
                    ...
                    (
                      await (async function (e, t) {
                        const n = (0, l.Am)(
                          ...
                          i = await r.json(),
                          o = new Set();
                        i.rgCreatorsIgnored?.forEach((e) => o.add(e)),
                          i.rgCreatorsFollowed?.forEach((e) => o.add(e));
                        const a = new Set();
                        return (
                          i.rgCreatorsIgnored?.forEach((e) => a.add(e)),
                          [
                            ...(i.rgCuratorsIgnored ?? []),
                            ...(i.rgCurators
                              ? Object.values(i.rgCurators ?? {}).map(
                                  (e) => e.clanid,
                                )
                              : []),
                          ].map((e) => {
        ...
        return (n, r, i, o) => {
          e.setQueryData(_(t), (e) => {
            ...
            return (
              ...
              i?.forEach((e) => t.delete(e.clanAccountID)),
              o?.forEach((e) => {
      ...
      function l(e, t, n) {
        ...
        return (0, r.n)({
          ...
          mutationFn: async () => {
            ...
            if (!a.ok)
              throw new Error(
                `Wishlist ${t ? "add" : "remove"} of appid ${e} failed (${a.status})`,
              );
          },
          onMutate: () => {
            null != e && l(t ? [e] : void 0, t ? void 0 : [e]);
    ...
    6866: (e, t, n) => {
      ...
      function m(e, t, n) {
        ...
        return (
          ...
          (0, r.jsx)(p, { url: i, event: t, children: n || e })
        );
      }
      const p = (e) => {
        ...
        let m,
          p = (0, o.OZ)(t);
        (p = d(p, n)), (0, i.p)(p) && (m = "noopener nofollow");
        const C =
    ...
    35380: (e, t, n) => {
      ...
      function l(e) {
        return (0, r.useMemo)(() => {
          if (null != e && e != i.sc) return { packageid: e };
        }, [e]);
      }
    },
    82415: (e, t, n) => {
    ...
    20713: (e, t, n) => {
      ...
      (0, i.Cg)([s.oI], c.prototype, "OnFocusNavigationChanged", null),
        (0, i.Cg)([s.oI], c.prototype, "SetActionDescriptionsFromMap", null);
    },
    10050: (e, t, n) => {
      "use strict";
      n.d(t, { M: () => a });
      ...
      function a(e) {
        const { children: t, ...n } = e,
          a = i.useRef(null);
        return (0, r.jsx)(o.A, { nodeRef: a, ...n, children: e.children(a) });
      }
    },
    54906: (e, t, n) => {
      "use strict";
      ...
      class h {
        ...
        async InternalLoadAppCompatability(e) {
          let t = null;
          try {
            const n = { nAppID: e, l: g.TS.LANGUAGE, cc: g.TS.COUNTRY };
            let r =
              g.TS.STORE_BASE_URL +
              "saleaction/ajaxgetdeckappcompatibilityreport";
            const i = await m().get(r, { params: n, withCredentials: !0 });
      ...
      function A(e) {
        const { id: t } = e,
          ...
          { data: o } = (0, s.qI)(t),
          [l, u, d] = (0, a.uD)();
        if (!n || !o || 0 !== n.item_type) return null;
        const m = o.steam_deck_compat_category || 0;
        return (0, r.jsxs)("div", {
          className: (0, b.A)(B().LearnMoreCtn, "LearnMoreCtn"),
          children: [
            (0, r.jsx)(c.$o, { category: m }),
            (0, r.jsx)(i.Ii, {
              onClick: u,
              children: (0, r.jsx)("span", {
            ...
            (0, r.jsx)(w.EN, {
              active: l,
              children: (0, r.jsx)(H, { nAppID: n.appid, closeModal: d }),
            }),
          ],
        });
      }
      function k(e) {
        ...
        return (0, r.jsxs)(i.Ii, {
          className: n,
          onClick: () => {
            a ? a() : t && (window.location.href = t);
          },
          children: [
            o && (0, r.jsx)("div", { className: B().DeveloperComments_Icon }),
            (0, r.jsx)("div", {
              className: o
      ...
      function H(e) {
        const { nAppID: t, closeModal: n } = e,
          i = (function (e) {
            const [t, n] = l.useState(h.Get().GetCompatabilityResultForApp(e));
            return (
              (0, _.hL)(h.Get().GetCallbackForAppList(e), n),
              l.useEffect(() => {
        ...
        return (0, r.jsx)(w.eV, {
          ...
          closeModal: n,
          onCancel: n,
          children: (0, r.jsx)(f.nB, {
            children: (0, r.jsx)(o.Z, {
              focusable: !1,
              "flow-children": "column",
              children: i
                ? (0, r.jsx)(x.A, { titleId: a, results: i })
                : (0, r.jsx)(S.t, {
                    size: "medium",
                    position: "center",
      ...
      function I(e) {
        ...
        const l = (0, r.jsx)("span", {
          ...
          u = i
            ...
            : (0, y.PP)("#SteamDeckVerified_DescriptionHeader", l, c);
        return (0, r.jsx)("div", {
          id: t,
          className: B().CompatibilityDetailRatingSummary,
          children: u,
      ...
      function T(e) {
        ...
        switch (n) {
          case 2:
            (a = "#SteamOSCompatibility_DescriptionHeader_Compatible"),
              (s = B().Compatible);
            break;
          case 1:
            (a = "#SteamOSCompatibility_DescriptionHeader_Unsupported"),
              (s = B().Unsupported);
        }
        const l = (0, r.jsx)("span", {
            className: s,
          ...
          u = i
            ...
            : (0, y.PP)("#SteamOSCompatibility_DescriptionHeader", l, c);
        return (0, r.jsx)("div", {
          id: t,
          className: B().CompatibilityDetailRatingSummary,
          children: u,
    ...
    43976: (e, t, n) => {
      ...
      function b(e) {
        const t = (0, w.rW)(),
          ...
          i = (0, f.I)({
            ...
            queryFn: () =>
              (async function (e, t) {
                if (!e || 1 !== e.item_type || 10 !== e.type) return S;
                const n = m.w.Init(g);
                n.Body().set_packageid(e.id || 0),
                  n.Body().set_country_code(x.iA.country_code);
                const i = await r.CheckInventoryAvailableByPackage(t, n);
                if (1 !== i.GetEResult())
                  throw (
                    (console.error(
      ...
      function N(e) {
        ...
        if (!o || !m || !p || 8 == o.type) return null;
        const f =
          o.is_free ||
          (null != p.final_price_in_cents && "0" == p.final_price_in_cents) ||
          (p.discount_pct && p.discount_pct >= 100);
        if (1 == o.item_type)
          if (10 == o.type) {
            if (!C)
              return (0, i.jsx)(B.t, { size: "small", position: "center" });
            if (!C.inventory_available)
              return (0, i.jsx)("div", {
                className: (0, L.A)(k().ActionOutOfStock, n),
                children: (0, i.jsxs)("span", {
                  children: [" ", H.Z.Localize("#Sale_ReserveExhausted")],
                }),
              });
          } else if (f && o.included_appids && o.included_appids.length > 1)
            return null;
        if (0 == o.item_type) {
          if (m.is_coming_soon && !p.packageid) return null;
          if (_ && 10 === o.type) return null;
          if (!_ && p.is_free_to_keep) {
            if (j.TS.IN_CLIENT || "store" != (0, j.yK)()) {
              const e = `${j.TS.IN_CLIENT ? "steam://openurl/" : ""}${g}`;
              return (0, i.jsx)("div", {
                onClick: (t) => (0, y.Id)(t, e),
                className: (0, L.A)(k().Action, n),
            ...
            {
              const e = (0, d.wJ)(
                `${j.TS.STORE_BASE_URL}freelicense/addfreelicense`,
                r,
              );
      ...
      function D(e) {
        const {
          ...
          a = (0, l.n9)(),
          { mutate: s } = (0, o.A)(n?.packageid, n?.bundleid, !1, a.feature);
        return (0, i.jsx)("div", {
          className: (0, L.A)(k().Action, t),
          onClick: () => s(),
          children: (0, i.jsx)("span", {
    ...
    28372: (e, t, n) => {
      ...
      const H = (e) => {
        const {
          ...
          { elDialogElement: d, fnShowLogonDialog: m } = (0, l.E)();
        if (!(0, C.xU)()) return null;
        let p = null;
        switch (u) {
          case "app":
            p = (0, y.we)("#text_store_follow_desc");
            break;
          case "creatorhome":
            p = (0, y.we)("#CreatorHome_Follow_tooltip");
            break;
          case "steamcurator":
            p = (0, y.we)("#steam_curator_follow_ttip");
            break;
          case "group":
            p = (0, y.we)("#steam_group_follow_ttip");
        }
        return p
          ? (0, i.jsxs)(i.Fragment, {
              children: [
                (0, i.jsx)(j.Gq, {
                  toolTipContent: n || a ? void 0 : p,
                  children: (0, i.jsxs)(o.ml, {
                    className: (0, b.A)(
                      k.Button,
                      B.FollowButton,
                      "FollowButton",
                    ...
                    children: [
                      r && (0, i.jsx)(x.k, { size: 15 }),
                      !r && (a || n) && (0, i.jsx)(S.Jlk, {}),
                      (0, i.jsx)("div", {
                        className: (0, b.A)(B.FollowBtnText, "FollowBtnText"),
                        children:
                          !r &&
                          (a
      ...
      function N(e) {
            ...
            return (0, g.n)({
              ...
              mutationFn: async () => {
                ...
                const n = t == r.k_ECuratorFollow || t == r.k_ECuratorUnfollow,
                  i = t == r.k_ECuratorFollow || t == r.k_ECuratorIgnore,
                  o = `${h.TS.STORE_BASE_URL}curators/${n ? "ajaxfollow/" : "ajaxignore/"}`,
                  a = new FormData();
                a.append("clanid", "" + e),
                  a.append("sessionid", (0, f.KC)()),
                  a.append(n ? "follow" : "ignore", i ? "1" : "0");
                ...
                if (!s.ok)
                  throw new Error(
                    `Curator Affinity: ${n ? "Follow" : "Ignore"} Currator ${i ? "add" : "remove"} failed (${s.status} / ${l.msg})`,
                  );
                return l.is_creator;
              },
              onMutate: () => {
        ...
        return (0, i.jsxs)(i.Fragment, {
          children: [
            ...
            (0, i.jsx)(L.EN, {
              active: b,
              children: (0, i.jsx)(A.g, { closeModal: j }),
            }),
          ],
        });
      }
    ...
    86090: (e, t, n) => {
      ...
      var r = n(7850),
        ...
        a = n(78327);
      const s = (e) => {
        let t = a.TS.HELP_BASE_URL + "wizard/HelpWithLimitedAccount";
        return (0, r.jsx)(i.o0, {
    ...
    90595: (e, t, n) => {
      ...
      function d(e) {
        const {
          ...
          d = l ? n : n ? (0, c.Ps)(n, u.TS.STORE_BASE_URL) : void 0,
          m = (0, o.aL)(d);
        return m
          ? (0, r.jsx)(i.Ii, {
              href: m,
          ...
          : (0, r.jsx)("span", { style: a, className: t, children: s });
      }
      function m(e) {
        const { section: t } = e;
    ...
    39700: (e, t, n) => {
      ...
      var r = n(7850),
        ...
        o = n(37999);
      function a(e) {
        const { size: t, color: n, trackColor: a } = e,
          s = { borderColor: a, borderLeftColor: n };
        if ("number" == typeof t) {
          const e = `${t}px`;
          (s.width = e),
            (s.height = e),
    ...
    27581: (e, t, n) => {
      ...
      class y extends v.Message {
        ...
        constructor(e = null) {
          super(),
            y.prototype.frame_rates || S.Sg(y.M()),
        ...
        static M() {
          return (
            y.sm_m ||
              (y.sm_m = {
                proto: y,
                fields: { frame_rates: { n: 1, c: L, r: !0, q: !0 } },
              }),
            y.sm_m
          );
        }
      ...
      class L extends v.Message {
        ...
        constructor(e = null) {
          super(),
            L.prototype.clusterid || S.Sg(L.M()),
            v.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      function j(e) {
        ...
        let w = s ?? {},
          ...
          x = null;
        t.steam_deck_blog_url &&
          ((w.onOptionsActionDescription = (0, _.we)(
        ...
        if (!t.resolved_items?.length) {
          const e = S
            ...
            s = S
              ...
              : (0, i.jsx)(u.UN, { category: t.resolved_category, appName: a }),
            l = S ? x : v;
          return (0, i.jsxs)(o.Z, {
            autoFocus: c,
            focusableIfEmpty: c,
            ...
            children: [
              (0, i.jsxs)("div", {
                ...
                children: [
                  (0, i.jsx)("div", {
                    className: m().DialogTitle,
                    children: e,
                  }),
                  (0, i.jsx)("div", {
                    className: m().AppTitleCategory,
                    children: (0, i.jsx)(u.Ez, {
        ...
        if (S || C) {
          const n = (0, l.z5)(t.resolved_category),
            r = (0, l._R)(t.steamos_resolved_category),
            o = (e) =>
            ...
            a = [
              {
                name: (0, i.jsxs)("div", {
                  ...
                  children: ["Steam Deck", (0, i.jsx)(n, {})],
                }),
                key: "steamdeck",
                contents: (0, i.jsx)(h.tH, {
                  children: (0, i.jsx)(k, { ...e, deckBlogContent: v }),
                }),
                onClick: o,
              },
              {
                name: (0, i.jsxs)("div", {
                  className: m().pillContent,
                  children: ["SteamOS", (0, i.jsx)(r, {})],
                }),
                key: "steamos",
                contents: (0, i.jsx)(h.tH, {
                  children: (0, i.jsx)(A, { ...e, deckBlogContent: x }),
                }),
                onClick: o,
              },
            ];
          return (0, i.jsx)(f.V, {
            ...
            classNameTabContent: m().CompatibilityTabContent,
            startingTab: S ? "steamos" : "steamdeck",
            preferredFocus: !0,
          });
        }
        return (0, i.jsx)(k, { ...e, deckBlogContent: v });
      }
      function B(e) {
        const {
            titleId: t,
      ...
      function A(e) {
        const { titleId: t, descriptionId: n, results: r, appName: o } = e,
          a =
          ...
          l = (0, i.jsx)(u.aw, { category: r.steamos_resolved_category ?? 0 }),
          c = r.steamos_resolved_items && r.steamos_resolved_items?.length > 0;
        return (0, i.jsx)(B, {
          titleId: t,
          title: (0, _.we)(
            "#SteamOSCompatibility_Store_CompatSectionHeader_GamepadUI",
            ...
            children: [
                  ...
                  .map((e) =>
                    (0, i.jsxs)(
                      "div",
                      {
                        ...
                        children: [
                          (0, i.jsx)(D, { displaytype: e.display_type }),
                          (0, i.jsx)("span", {
              ...
              a &&
                (0, i.jsx)("div", {
                  ...
                  children: r.steamos_resolved_items
                    ?.filter((e) => 1 == e.display_type)
                    .map((e) =>
                      (0, i.jsxs)(
                        "div",
      ...
      function k(e) {
        const { titleId: t, descriptionId: n, results: r, appName: o } = e,
          a = -1 !== r.resolved_items?.findIndex((e) => 1 == e.display_type),
          s = (0, i.jsx)(u.UN, {
            id: n,
            category: r.resolved_category,
            appName: o,
          }),
          l = (0, i.jsx)(u.Ez, { category: r.resolved_category }),
          c = r.resolved_items && r.resolved_items?.length > 0;
        return (0, i.jsx)(B, {
          titleId: t,
          title: (0, _.we)(
            "#SteamDeckVerified_Store_CompatSectionHeader_GamepadUI",
                  ...
                  .map((e) =>
                    (0, i.jsxs)(
                      "div",
                      {
                        className: m().CompatibilityDetailsRow,
                        children: [
                          (0, i.jsx)(N, { displaytype: e.display_type }),
                          (0, i.jsx)("span", {
                            children: (0, _.we)(e.loc_token),
                          }),
                        ],
      ...
      function H(e) {
        ...
        return (0, i.jsxs)("div", {
          ...
          children: [
            ...
            (0, i.jsx)("a", {
              href: t,
              className: m().DeveloperBlockLinkDesktop,
      ...
      function N(e) {
        ...
        switch (t) {
          case 4:
            return (0, i.jsx)(C.o5Q, {
              className: m().CompatibilityDetailsResultIcon,
            });
          case 3:
            return (0, i.jsx)(C.aVR, {
              className: m().CompatibilityDetailsResultIcon,
            });
          case 2:
            return (0, i.jsx)(C.jIP, {
              className: m().CompatibilityDetailsResultIcon,
            });
          case 0:
            return (0, i.jsx)(C.WX$, {
      ...
      function D(e) {
        ...
        switch (t) {
          case 3:
            return (0, i.jsx)(C.ZjT, {
              className: m().CompatibilityDetailsResultIcon,
            });
          case 1:
            return (0, i.jsx)(C.bcZ, {
              className: m().CompatibilityDetailsResultIcon,
            });
          default:
            return null;
    ...
    38135: (e, t, n) => {
      ...
      function _(e) {
        ...
        const y = b.find((e) => e.key === v) || b[0],
          L = _ ? (a ?? b[0].key) : void 0,
          j = (0, r.jsxs)(r.Fragment, {
            children: [
              ...
              y && (0, r.jsx)(m.Z, { className: d, children: y.contents }),
            ],
          });
        return h
          ? (0, r.jsx)(m.Z, {
