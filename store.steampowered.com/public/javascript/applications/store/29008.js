  ...
  [29008],
  {
    ...
    26514: (e, t, n) => {
      ...
      function _(e, t, n, r, a) {
        return h(
          [{ packageid: e, bundleid: t, bIsGift: n, nAccountIDGiftee: r }],
          a,
        );
      }
      function h(e, t) {
        const n = (0, p.j4)(),
          _ = (0, o.KV)(),
          h = (0, c.jE)(),
          { storeBrowseContext: g, dataLoader: f } = (0, i.yn)(),
          { country: S } = g,
          b = (0, l.Gd)(t);
        return (0, u.n)({
          mutationFn: async () => {
            ...
            let t;
            if ((0, d.c2)(n)) {
              const [a, o] = await (0, m.ce)(_, S, e, b);
              if (a != r.R) throw `AddItemsToAccountCart failed with ${a}`;
              (t = o.line_item_ids), (0, C.LN)(h, n, o.cart);
            } else {
              if (!(0, d.kx)(n)) throw "Invalid cart type";
              {
                const o = e.map((e) => e.packageid).filter(a.z),
                  i = e.map((e) => e.bundleid).filter(a.z);
                if (i.length > 1)
                  throw "The anonymous cart can only take one bundle per call";
                const [s, l] = await (0, m.SI)(
                  _,
                  o.length > 0 ? o : void 0,
                  i[0],
                  e.some((e) => e.bIsGift),
                  ...
                  throw `AddItemsToAnonymousCart failed with ${s}`;
                {
                  const e = new Set(o),
                    r = new Set(i),
                    a = l.lineitems?.filter(
                      (t) =>
                        (t.package_item &&
                          !t.package_item.gidbundle &&
                          e.has(t.package_item.packageid)) ||
                        (t.bundle_item && r.has(t.bundle_item.bundleid)),
                    );
                  (t = a?.map((e) => e.gidlineitem) || []),
                    (0, C.LN)(h, n, (0, m.qS)(l));
                }
              }
            }
          ...
          onMutate: () => {
            (async () => {
              ...
              (
                await Promise.all(t.map((e) => h.fetchQuery((0, s.us)(f, e))))
              ).forEach((e, n) => {
                const r =
                  1 == e?.included_appids?.length
                    ? { appid: e.included_appids[0] }
                    : t[n];
                h.prefetchQuery((0, s.AQ)(f, r)),
                  h.prefetchQuery((0, s.rK)(f, r));
              });
            })();
          },
        });
    ...
    33951: (e, t, n) => {
      ...
      function S(e, t) {
        ...
        const n = (function (e) {
          ...
          return {
            ...a,
            rss_language: e.rss_language ? e.rss_language : r.Bhc,
          };
        })(t);
        return (
          e.setQueryData(d(n.clanAccountID), n),
          n.appid && e.setQueryData(m(n.appid), n.clanAccountID),
          n.vanity_url &&
            e.setQueryData(p(n.vanity_url, "group"), n.clanAccountID),
          n
        );
      }
      function b(e, t) {
      ...
      function v(e, t, n = "group") {
        return (
          h(t),
          {
            ...
            queryFn: async () => {
              if ("store" == n) {
                const n = t.getQueryData(p(e, "group"));
                if (n) return n;
              }
              const r =
                "store" == n
              ...
              return S(t, r)?.clanAccountID ?? null;
            },
            enabled: !!e,
          }
        );
      ...
      async function k(e, t) {
        return e ? f(await t.fetchQuery(y(e, t))) : null;
      }
    ...
    39832: (e, t, n) => {
      ...
      function l(e, t, n) {
        ...
        if (
          ...
          return o.Localize(`#${a}XYears`, l(e / s.Kp.PerYear));
        if (e >= s.Kp.PerYear)
          return (e -= s.Kp.PerYear) >= 2 * s.Kp.PerMonth &&
            !r.bForceSingleUnits
            ? o.Localize(`#${a}1YearXMonths`, l(e / s.Kp.PerMonth))
            : o.Localize(`#${a}1Year`);
        if (e >= 2 * s.Kp.PerMonth)
          return o.Localize(`#${a}XMonths`, l(e / s.Kp.PerMonth));
        if (e >= 2 * s.Kp.PerWeek)
          return o.Localize(`#${a}XWeeks`, l(e / s.Kp.PerWeek));
        if (e >= s.Kp.PerWeek)
          return o.Localize(`#${a}1Week`, l(e / s.Kp.PerWeek));
        if (e >= 2 * s.Kp.PerDay)
          return o.Localize(`#${a}XDays`, l(e / s.Kp.PerDay));
        if (e >= s.Kp.PerDay)
          return (e -= s.Kp.PerDay) >= 2 * s.Kp.PerHour && !r.bForceSingleUnits
            ? o.Localize(`#${a}1DayXHours`, l(e / s.Kp.PerHour))
            : o.Localize(`#${a}1Day`);
        if (e >= 2 * s.Kp.PerHour)
          return o.Localize(`#${a}XHours`, l(e / s.Kp.PerHour));
        if (e >= s.Kp.PerHour)
          return (e -= s.Kp.PerHour) >= 2 * s.Kp.PerMinute &&
            !r.bForceSingleUnits
            ? o.Localize(`#${a}1HourXMinutes`, l(e / s.Kp.PerMinute))
            : o.Localize(`#${a}1Hour`);
        if (e >= 2 * s.Kp.PerMinute) {
          ...
          return r.bHighGranularity && 0 != n
            ? 1 == n
              ? o.Localize(`#${a}XMinutes1Second`, t)
              : o.Localize(`#${a}XMinutesXSeconds`, t, n)
            : o.Localize(`#${a}XMinutes`, l(e / s.Kp.PerMinute));
        }
        if (e >= s.Kp.PerMinute) {
          const t = e % s.Kp.PerMinute;
          return r.bHighGranularity && 0 != t
            ? 1 == t
              ? o.Localize(`#${a}1Minute1Second`)
              : o.Localize(`#${a}1MinuteXSeconds`, t)
            : o.Localize(`#${a}1Minute`);
        }
        return r.bHighGranularity
          ? 1 == e
            ? o.Localize(`#${a}1Second`)
            : o.Localize(`#${a}XSeconds`, e)
          : o.Localize(`#${a}LessThanAMinute`);
      }
      function c(e, t, n) {
        let a;
        a =
      ...
      function C(e) {
        return e.toLocaleDateString((0, r.J)(), { year: "numeric" });
      }
      function _(e) {
    ...
    84547: (e, t, n) => {
      ...
      function d(e) {
        ...
        return (0, r.jsx)(i.o0, {
          ...
          strDescription:
            n || l.F5.Localize("#LoginRedirect_Dialog_Description"),
          onCancel: t,
          strOKButtonText: o.Z.Localize("#Button_OK"),
          onOK: () => {
            (0, c.l)(), t();
          },
        });
      ...
      function p(e) {
        const { label: t, strDialogDesc: n } = e,
          { elDialogElement: a, fnShowLogonDialog: i } = m(n);
        return (0, r.jsxs)(r.Fragment, {
          children: [
            (0, r.jsx)(u.$, {
              onClick: i,
              children: t || o.Z.Localize("#Login_SignIn"),
            }),
            a,
          ],
        });
    ...
    29008: (e, t, n) => {
      ...
      function y(e) {
        const {
          ...
          h = !u && !C,
          [g, f] = s.useState(!1),
          [b, y] = s.useState(void 0),
          v = s.useCallback(() => f(!1), []);
        return (0, r.jsxs)("div", {
          "data-key": "hover div",
          role: "button",
          tabIndex: 0,
          className: (0, p.A)(S().ItemHoverSource, c),
          onMouseEnter: (e) => {
            f(!0), y(e.currentTarget);
          },
          onMouseLeave: () => f(!1),
          onTouchStart: () => f(!1),
          onKeyDown: (e) => {
            e.keyCode == l.zV &&
              (f(!1), e.preventDefault(), e.stopPropagation());
          },
          children: [
            h &&
              b &&
      ...
      function x(e) {
        ...
        if (
          (s.useEffect(() => {
            if (l) {
              if (n) {
                const e = window.setTimeout(() => m(!0), n);
        ...
        const p = o.clientWidth < 200 ? "8px" : "10px",
          C = {
            ...
            style: {
              ...
              fontSize: p,
              minHeight: "hiding" == L() ? void 0 : 300,
              height:
                "hiding" == L() ? 1.15 * o.clientWidth * (125 / 184) : void 0,
              ...t?.style,
            },
            target: o,
          };
        return (0, r.jsx)(v, {
          hoverProps: C,
          children: (0, r.jsx)(d.tH, { children: c }),
        });
      }
      function v(e) {
        const { hoverProps: t, children: n } = e,
          a = s.useCallback((e) => e?.focus(), []);
        return (0, r.jsx)(c.g, {
          ...t,
          children: (0, r.jsx)(u.M, {
            ...
            appear: !0,
            classNames: {
              appearActive: (0, p.A)(S().Opening, g().Opening),
              enterDone: (0, p.A)(S().Open, g().Open),
            },
            children: (e) =>
              (0, r.jsx)("div", {
                ref: (0, C.XB)(e, a),
                className: S().HoverContentTransition,
                tabIndex: -1,
                children: n,
              }),
          }),
          ...
          onClick: async (e) => {
            e.preventDefault(),
              ...
              _.iA.logged_in
                ? t &&
                  "appid" in t &&
                  (i(!0), await C(), l.token.reason || i(!1))
                : u();
          },
          children: [
            (0, r.jsx)(R.NtH, {}),
            (0, r.jsx)("div", {
              className: (0, p.A)(
                V().IgnoreButtonText,
                o && V().IgnoreLoadingText,
              ),
              children: (0, M.we)(
                h ? "#Sale_RemoveFromIgnored" : "#Sale_Ignore",
              ),
            }),
            c,
          ],
      ...
      function ie(e, t) {
        return {
          stringifyID: `vid_${(0, J.ER)(e)}`,
          rctImage: (0, r.jsx)(K.mj, { id: e, active: !0 }),
          nDurationMs: ne,
        };
      }
      function se(e, t, n, a) {
      ...
      function ce(e) {
        ...
        if (!n || n.unvailable_for_country_restriction || !n.visible)
          return (0, r.jsx)("div", {
            ...
            children: (0, r.jsx)(le, {}, "default"),
          });
        const a = n.item_type,
          i = n.type;
        return a == o.c6.xO || a == o.c6.RD
          ? (0, r.jsx)(pe, { includeAppIDs: n.included_appids })
          : (i == o.uE.ue || i == o.uE.Vi) &&
              n.related_items &&
            ...
            : (0, r.jsx)(ue, { storeItemDefaultData: n });
      }
      function ue(e) {
          ...
          l = (0, s.useMemo)(
            () =>
              (function (e, t, n, r, a) {
                ...
                if (
                  (a && o.push(ie(e)),
                  r && r.length > 0 && o.push(...se(e, t.name, r, ae)),
        ...
        return (0, r.jsx)(Ce, { rgTrailerAndImages: l });
      }
      function de(e) {
      ...
      function me(e) {
          ...
          u = (0, s.useMemo)(
            () =>
              (function (e, t, n, r, a, o) {
                const i = [];
                o && i.push(ie(t)),
                  r && r.length > 0 && i.push(...se(e, n.name, r, ae));
                const s = ae - (r?.length || 0);
                return (
                  s > 0 && a && a.length > 0 && i.push(...se(e, n.name, a, s)),
                  e && i.length,
                  i
                );
              })(n, o, a, i, l, c),
        ...
        return (0, r.jsx)(Ce, { rgTrailerAndImages: u });
      }
      function pe(e) {
        const { includeAppIDs: t } = e,
          n = (0, Y.eG)(),
          a = (0, X.E)({ queries: t.map((e) => (0, q.AQ)(n, { appid: e })) }),
          o = (0, X.E)({ queries: t.map((e) => (0, q.us)(n, { appid: e })) }),
          i = (0, s.useMemo)(
            () => a.map((e, t) => oe(o[t].data, e.data)).filter((e) => !!e),
            [a, o],
          );
        return (0, r.jsx)(Ce, { rgTrailerAndImages: i });
      }
      function Ce(e) {
        const { rgTrailerAndImages: t } = e,
          n = (0, s.useRef)(0),
          a = (0, C.CH)(),
          [o] = s.useState(new te.LU()),
          i = (0, s.useCallback)(
            (e = !1) => {
      ...
      function xe(e) {
        const {
            ...
            onShowDeckCompatibilityDialog: C,
          ...
          { data: N } = (0, q.lv)(n),
          R = !_ && !c && !l,
          T = I && I.item_type == o.c6.qI;
        return (0, r.jsxs)("div", {
          className: g().BottomShelf,
          style: { transform: u && x ? L : "" },
          onMouseEnter: () => v(!0),
          onFocus: () => v(!0),
          onMouseLeave: () => v(!1),
          onBlur: () => v(!1),
          children: [
            ...
            (0, r.jsx)("div", {
              ...
              ref: (e) => j(`translateY( -${e?.clientHeight || 0}px )`),
              children: (0, r.jsxs)("div", {
                ...
                children: [
                  ...
                  c && (0, r.jsx)(B.j, { id: t, className: g().DemoButton }),
                  Boolean(m && T) &&
                    (0, r.jsx)(ge.Q8, { id: t, onShowDialog: y }),
                  Boolean(l) && l,
                  _ &&
                    T &&
                    t &&
                  ...
                  h && (0, r.jsx)(H.Q, { nCreatorAccountID: h }),
                ],
              }),
            }),
          ],
        ...
        return (0, r.jsxs)("div", {
          ...
          children: [
            (0, r.jsxs)("a", {
              ...
              children: [
                Boolean(s && !i) && (0, r.jsx)(I.E, { id: n, snr: e.strSNR }),
                Boolean(l && !i) && (0, r.jsx)(z, { id: n, snr: e.strSNR }),
                t && (0, r.jsx)(ce, { id: t }),
              ],
            }),
            (0, r.jsx)(xe, { ...e }),
      ...
      function Ae(e) {
        const {
          ...
          v = (0, _.Qn)(),
          [j, A, D] = (0, a.uD)(),
          { strStoreURL: B, snr: k } = (0, _e.x)(x, c);
        if ((!x && !n) || v) return (0, r.jsx)(r.Fragment, { children: p });
        let H = t;
        x &&
          x.item_type == o.c6.RD &&
          1 == x.included_appids?.length &&
          (H = { appid: x.included_appids[0] });
        const I = i || !x ? void 0 : B,
          N = {
            id: t,
            displayID: H,
            name: n,
            ...
            bShowIgnoreButton: S,
            bShowDescription: b,
            onShowDeckCompatibilityDialog: g ? A : void 0,
          },
          R = g && x?.item_type == o.c6.qI ? x.appid : void 0,
          T = (0, r.jsx)(je, { ...N }),
          M = I ? (0, r.jsx)("a", { href: I, children: p }) : p;
        return (0, r.jsxs)(r.Fragment, {
          children: [
            (0, r.jsx)(y, {
              hoverContent: T,
    ...
    94636: (e, t, n) => {
      ...
      function b(e) {
        const {
          ...
          { data: y } = (0, s.J$)(t),
          { elDialogElement: x, fnShowLogonDialog: v } = (0, i.l)(),
          [L, j] = (0, m.useState)(() =>
            y &&
    ...
    67936: (e, t, n) => {
      ...
      (a.arabic = () => n.e(22940).then(n.t.bind(n, 22940, 19))),
        ...
        (a.sc_schinese = () => n.e(98347).then(n.t.bind(n, 98347, 19))),
    ...
    3740: (e, t, n) => {
      ...
      function b(e) {
        ...
        if (k && k.is_coming_soon && (!I || !I.packageid)) {
          if (S) return null;
          const e =
        ...
        let T = I.discount_pct || 0,
          M = n || H.item_type != a.c6.xO ? 0 : I.bundle_discount_pct || 0,
          F = I.formatted_final_price;
        if (j) {
          const e = (0, h.rt)(_.iA.country_code.toUpperCase()),
            t = { ...(0, g.J)(e), bWholeUnitsOnly: !0 };
          F = (0, f.d)(Number.parseInt(I.final_price_in_cents || "0"), t);
        }
        const V = (0, i.Nq)(k, I);
        return (0, r.jsx)(w, {
          ...
          ? (function (e, t, n) {
              switch (e) {
                case "date_full":
                  return (0, r.$z)(t);
                case "date_month":
                  return (0, r.sq)(new Date(1e3 * t));
                case "date_quarter":
                  return (0, r.u6)(new Date(1e3 * t));
                case "date_year":
                  return (0, r.vl)(new Date(1e3 * t));
                case "text_comingsoon":
                  return n || a.Z.Localize("#Store_ComingSoon_ComingSoon");
                case "text_tba":
                  return n || a.Z.Localize("#Store_ComingSoon_TBA");
                default:
                  return "";
              }
            })(
    ...
    14987: (e, t, n) => {
      ...
      function u(e) {
        return (0, o.useMemo)(() => (e ? { appid: e } : void 0), [e]);
      }
      function d(e) {
        return (0, o.useMemo)(() => (e ? { packageid: e } : void 0), [e]);
      }
    },
    68009: (e, t, n) => {
      "use strict";
    ...
    54906: (e, t, n) => {
      ...
      var y = n(56283),
        ...
        H = n.n(k);
      function I(e) {
        const { id: t, onShowDialog: n } = e,
          { data: o } = (0, u.J$)(t),
          { data: s } = (0, u.qI)(t),
          [d, p, C] = (0, c.uD)();
        if (!o || !s || o.item_type !== l.c6.qI) return null;
        const _ = s.steam_deck_compat_category || i.YX;
        return (0, r.jsxs)("div", {
          className: (0, A.A)(H().LearnMoreCtn, "LearnMoreCtn"),
          children: [
            (0, r.jsx)(m.$o, { category: _ }),
            (0, r.jsx)(a.Ii, {
              onClick: (e) => {
                e.preventDefault(), (n ?? p)();
              },
              children: (0, r.jsx)("span", {
      ...
      function N(e) {
        const { nAppID: t, active: n, appName: a, closeModal: o } = e;
        return (0, r.jsx)(x.EN, {
          active: n,
          children: (0, r.jsx)(T, { nAppID: t, appName: a, closeModal: o }),
        });
      }
      function R(e) {
        const {
      ...
      function T(e) {
        const { nAppID: t, appName: n, closeModal: a } = e,
          i = (function (e) {
        ...
        return (0, r.jsx)(x.eV, {
          ...
          children: (0, r.jsx)(y.nB, {
            children: (0, r.jsx)(o.Z, {
              ...
              children: i
                ? (0, r.jsx)(L.Ay, { titleId: s, appName: n, results: i })
                : (0, r.jsx)(j.t, {
                    size: "medium",
                    position: "center",
    ...
    12529: (e, t, n) => {
      ...
      class N extends B.Message {
        ...
        constructor(e = null) {
          super(),
            N.prototype.frame_rates || H.Sg(N.M()),
        ...
        const D = l ?? v,
          ...
          H = (0, r.jsxs)(r.Fragment, {
            children: [
              ...
              B && (0, r.jsx)(m.Z, { className: g, children: B.contents }),
            ],
          });
        return S
          ? (0, r.jsx)(m.Z, {
