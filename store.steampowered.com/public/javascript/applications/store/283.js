  ...
  [283],
  {
      ...
      let j = class extends i.Component {
        OnEmoticonClick(e) {
          ...
          if (
            ...
            (!e || e < f) && (e = f), s("rtLastAckedNewEmoticons", e);
          }
        }
        ...
        render() {
          ...
          return (
            ...
            s
              ...
              : (i.push(x().chatSubmitButton, x().EmoticonPickerButton),
                (0, o.jsx)(l.fu, {
                  className: (0, p.A)(...i),
                  onOKActionDescription: (0, h.we)("#ChatEntryButton_Emoticon"),
                  type: "button",
                  ...
                  disabled: e,
                  children: (0, o.jsxs)(C.he, {
                    toolTipContent: n,
                    children: [
                      this.props.buttonIcon || (0, o.jsx)(S.nl, {}),
                      r && (0, o.jsx)(m.iD, {}),
                    ],
                  }),
                }))
    ...
    10820: (e, t, n) => {
      ...
      class j extends c.Component {
        ...
        render() {
          ...
          return (0, o.jsxs)(S.Z, {
            className: f.Picker,
            onButtonDown: i,
            children: [s && (0, o.jsx)(E, { children: this.RenderTabs() }), n],
          });
        }
        RenderTabs() {
      ...
      function k(e) {
        ...
        return (0, o.jsx)(S.Z, {
          className: (0, m.A)(f.Tab, t && f.Active),
          focusClassName: f.Focus,
          onActivate: s,
          children: (0, o.jsx)("div", {
            className: (0, m.A)(f.TabContent, t && f.Active),
            children: n,
          }),
        });
      }
      ...
      function I(e) {
        const { title: t, onFilterChange: n, filter: s, onSubmit: i, ...r } = e;
        return (0, o.jsxs)(o.Fragment, {
          children: [
            ...
            (0, o.jsx)(v, { value: s, onChange: n, onSubmit: i }),
          ],
        });
      }
      function w(e) {
        const { onFilterChange: t, filter: n, sections: s, title: i } = e;
        return (0, o.jsxs)(o.Fragment, {
          children: [
            (0, o.jsxs)(_, {
              children: [
                ...
                s.map(({ title: e, ...t }) =>
                  (0, o.jsx)(
                    P,
                    { title: e, children: (0, o.jsx)(A, { ...t }) },
                    e,
                  ),
                ),
              ],
            }),
            (0, o.jsx)(v, { value: n, onChange: t }),
          ],
        });
      }
      function P(e) {
        return (0, o.jsxs)("div", {
          className: f.Section,
          children: [
            (0, o.jsx)("div", { className: f.SectionTitle, children: e.title }),
            (0, o.jsx)("div", {
      ...
      function N(e) {
        ...
        return (0, o.jsx)("div", {
          className: (0, m.A)(t, f.AddonPickerMessage),
          ...n,
        });
      }
      var g = n(42060),
            ...
            children: (0, o.jsx)(j, {
              config: [
                ...
                },
                {
                  ...
                  renderContent: () =>
                    (0, o.jsx)(z, { store: t, onItemSelect: (e) => a(e.name) }),
                },
                {
                  renderTab: (e) =>
                    (0, o.jsx)("span", {
          ...
          return (
            F(e) &&
              i.push({
                ...
                onItemSelect: t,
                renderItem: (e) => (0, o.jsx)(W, { emoticon: e }),
            ...
            R(e).length &&
              i.push({
                ...
                items: l.pN.FilterStickers(R(e), s),
                onItemSelect: n,
                renderItem: (e) => (0, o.jsx)(X, { sticker: e }),
      ...
      class U extends c.Component {
        ...
        render() {
          const { store: e, onItemSelect: t, flairGroupID: n } = this.props,
            { filter: s } = this.state,
            i = !s && n ? e.GetFlairListByGroupID(n) : e.emoticon_list,
            r = l.pN.FilterEmoticons(i, s).slice(0, 1e3);
          return (0, o.jsx)(I, {
            title: (0, h.we)("#AddonPicker_Emoticons"),
            items: r,
            onItemSelect: t,
      ...
      class Z extends c.Component {
        ...
        render() {
          const { store: e, effectSettings: t, onItemSelect: n } = this.props,
            { filter: s } = this.state,
            i = e.GetEffectList().filter(({ name: e }) => e.indexOf(s) > -1);
          return (0, o.jsx)(I, {
            title: (0, h.we)("#EmoticonPicker_EffectHeading"),
            items: i,
            onItemSelect: n,
            renderItem: (e) =>
              (0, o.jsx)(J, { effect: e, roomEffectSettings: t }),
            keyExtractor: ({ name: e }) => e,
            onFilterChange: (e) => this.setState({ filter: e }),
            filter: s,
            onSubmit: () => n(i[0]),
      ...
      const W = (e) => {
        ...
        return (0, o.jsxs)("div", {
          ...
          children: [
            (0, o.jsx)(b.n, { emoticon: t.name, large: n }),
            s && (0, o.jsx)(Y, {}),
          ],
        });
      };
      class X extends c.Component {
        ...
        render() {
          ...
          return (0, o.jsxs)("div", {
            ...
            ...n,
            children: [
              (0, o.jsx)("img", { style: { width: "100%" }, src: s }),
              this.state.showHover &&
                (0, o.jsx)(Q, { target: this.m_ref.current, sticker: e }),
            ],
          });
        }
      }
      ...
      function Y() {
        return (0, o.jsx)("div", {
          ...
          children: (0, o.jsx)("div", { className: L().NewEmoticonCircle }),
        });
      }
      function $(e) {
        return (0, o.jsxs)("svg", {
