...
(self.webpackChunkappmgmt_storeadmin =
  ...
  [9433],
  {
        ...
        loadStoreItemCountryRestriction: async (e, t) =>
          await (function (e) {
            w ||
              (w = new (o())(
                async (t) => {
                  const r = i.w.Init(s.zo);
                  r.Body().set_ids(t.map((e) => n.O4.fromObject(e)));
                  const a = await s.BT.GetCountryRestrictions(e, r);
                  if (!a.BSuccess())
    ...
    43653: (e, t, r) => {
          ...
          children: [
            ...
            (0, i.jsx)("p", {
              children: (0, m.oW)(
                ...
                (0, i.jsx)("a", {
                  href: `${R.TS.PARTNER_BASE_URL}admin/game/editbyappid/${t}?activetab=tab_specialsettings#associated_demos`,
                  target: "_blank",
                }),
              ),
            }),
      ...
      function W(e) {
          ...
          B = (function (e, t) {
            ...
            return (
              ...
              ((i.related_items.demo_appid &&
                i.related_items.demo_appid.includes(e)) ||
                (i.related_items.standalone_demo_appid &&
        ...
        o.useEffect(() => {
          ...
          return (
            (async () => {
              n(!1), u(void 0);
              const i = g.w.Init(d.J6);
              i.Body().set_demo_appid(t), i.Body().set_appid(r);
              const s = await d.nd.GetWishlistDemoEmailStatus(R, i);
              e.signal.aborted ||
                (s.BSuccess() &&
                  (n(s.Body().can_fire()), u(s.Body().time_staged())));
            })(),
            () => e.abort()
          );
        }, [R, t, r, f]),
          ...
          return (0, i.jsxs)("div", {
            ...
            children: [
              (0, i.jsxs)("div", {
                ...
                children: [
                  (0, i.jsx)("h2", {
                    children: (0, m.we)("#App_Landing_DemoWishlist_Title"),
                  }),
                  (0, i.jsx)("a", {
                    className: c.DocumentationLink,
                    href: e,
                    children: (0, m.we)("#App_Landing_DemoWishlist_Link"),
                  }),
                ],
              }),
              C &&
        ...
        const {
          ...
          { bLoading: v, rgWarnings: C } = (function (e, t) {
            const r = (0, w.c2)({ appid: e }),
              ...
              n = r.isLoading || i.isLoading,
              a = r.isSuccess && i.isSuccess,
              [l, c, u, d] = o.useMemo(() => {
                if (!a) return [];
                const e = (e) =>
                  z.lf(
            ...
            if (n) return { bLoading: !0, rgWarnings: [] };
            if (!a)
              return {
                bLoading: !1,
                rgWarnings: [
            ...
            const g = [],
              B = s && s.GetReleaseDateRTime(!0);
            B &&
              B > new Date().getTime() / 1e3 &&
              B < new Date().getTime() / 1e3 + 14 * M.Kp.PerDay &&
              g.push({
                sText: (0, m.we)(
          ...
          W = C.every((e) => !e.bCritical);
        return (0, i.jsxs)(i.Fragment, {
          children: [
            (0, i.jsx)("div", {
              className: c.SubTitle,
              children: (0, m.we)("#App_Landing_DemoWishlist_SubTitle"),
            }),
            (0, i.jsx)("div", {
              className: c.Description,
              children: (0, i.jsx)("p", {
                children: (0, m.we)("#App_Landing_DemoWishlist_Desc"),
              }),
            }),
            v
              ? (0, i.jsx)(B.t, {})
                    ...
                    C.map((e) =>
                      (0, i.jsx)(
                        "div",
                        {
                          ...
                          children: (0, i.jsx)("p", { children: e.sText }),
                        },
                        e.sText,
                      ),
                    ),
      ...
      function q(e) {
        const { parentAppId: t, timeStaged: r, noticeVisibleToDate: s } = e,
          ...
          g = `${l.TS.STATS_BASE_URL}app/wishlist/${t}/?dateStart=${a}&dateEnd=${o}`;
        return (0, i.jsxs)("div", {
          className: c.Description,
          children: [
            (0, i.jsx)("p", {
      ...
      function Y(e) {
        const { nPartnerID: t, nAppID: r } = e,
          [s, n] = (0, o.useState)(90),
          a = (function (e, t, r) {
            const { isLoading: i, data: s } = (0, x.I)({
              queryKey: ["usePartnerFinancialDailySummary", e, t, r],
              queryFn: async () => {
                const i = { partnerid: e, pastdays: t, appid: r },
                  s = `${N.TS.PARTNER_BASE_URL}financial/ajaxgetpartnersummary`,
                  n = await U().get(s, { params: i, withCredentials: !0 });
                return n?.data?.success != F.R
        ...
        return a && 0 != a.daily_sales?.length
          ? (0, i.jsxs)("div", {
              ...
              children: [
                ...
                (0, i.jsx)(Z, { nDaysInThePast: s, fnUpdateDaysInPast: n }),
                (0, i.jsx)(re, { stats: a }),
                (0, i.jsx)(ie, { stats: a }),
              ],
            })
        ...
        return (0, i.jsxs)("div", {
          ...
          children: [
            (0, i.jsxs)("div", {
              ...
              children: [
                (0, i.jsx)("div", {
                  ...
                  children: (0, m.we)("#PartnerStats_DayLabel"),
                }),
                (0, i.jsx)(u.m, {
                  layout: "inline",
                  label: null,
            ...
            (0, i.jsx)("div", {
              ...
              children: (0, i.jsx)("a", {
                href: "#",
                children: (0, m.we)("#PartnerStats_ViewDetail"),
              }),
            }),
          ],
        });
      }
      const ee = new Intl.NumberFormat("en-US", {
        style: "currency",
        currency: "USD",
          ...
          children: [
            (0, i.jsxs)("div", {
              ...
              children: [
                (0, i.jsx)("div", {
                  className: V.Header,
                  children: (0, m.we)("#PartnerStats_Header_Revenue"),
                }),
                (0, i.jsx)("div", {
                  className: V.Numerals,
                  children: te(t.summary_sales.total_gross_sales_usdx100),
                }),
              ],
            }),
            (0, i.jsxs)("div", {
              ...
              children: [
                (0, i.jsx)("div", {
                  className: V.Header,
                  children: (0, m.we)("#PartnerStats_Header_Units"),
                }),
                (0, i.jsx)("div", {
                  className: V.Numerals,
                  children: (0, X.D)(
      ...
      function ie(e) {
        const { stats: t } = e,
          ...
          [s, n, a] = (0, o.useMemo)(() => {
            ...
            return (
              e.forEach((e) => {
                e.partner_stats_value > i && (i = e.partner_stats_value),
                  (s += e.partner_stats_value);
              }),
              [i, s, e.sort((e, t) => e.rtime - t.rtime)]
            );
          }, [t, r]);
        return t && 0 != a.length
          ? (0, i.jsx)("div", {
              ...
              children: (0, i.jsx)("div", {
                className: V.Chart,
                children: (0, i.jsx)(H.tH, {
                  children: (0, i.jsx)(se, { Data: a, nPeak: s }),
                }),
              }),
            })
          : null;
            ...
            (e, r) =>
              t.length > 20
                ? t[r]?.partner_stats_value && r % 7 == 0
                  ? new Date(1e3 * t[r].rtime).toLocaleDateString(
      ...
      function ne(e) {
        const { x: t, y: r, payload: s } = e,
          n = e.tickFormatter(s.value, s.index);
        return (0, i.jsx)("g", {
      ...
      function ae({ active: e, payload: t }) {
        if (e && t && t.length) {
          const e = t[0].payload,
                    ...
                    children: [
                      ...
                      (0, i.jsxs)("div", {
                        ...
                        children: [
                          (0, i.jsx)("div", {
                            className: V.ToolTipTableCell,
                            children: (0, m.we)("#PartnerStats_Tooltip_Total"),
                          }),
                          (0, i.jsx)("div", {
                            className: V.ToolTipTableCell,
                            children: (0, $.Z2)(r),
      ...
      function oe(e) {
        const { appid: t, usdRevenue: r, nPercentage: s } = e,
          [n] = (0, f.t7)(t, {});
        return (0, i.jsxs)("div", {
          className: V.ToolTipTableRow,
          children: [
      ...
      function ce(e) {
        ...
        return "Demo" == s && (0, i.jsx)(W, { demoAppID: t, parentAppId: r });
      }
      var me = r(35863),
        ue = r(85325),
        de = r(45699),
      ...
      class Se extends ge.Message {
        ...
        constructor(e = null) {
          super(),
            Se.prototype.contained_items || _e.Sg(Se.M()),
            ...
            ve.sm_m ||
              (ve.sm_m = {
                ...
                fields: {
                  ...
                  nested_accessories: { n: 5, c: ve, r: !0, q: !0 },
                },
              }),
            ve.sm_m
          );
        ...
        static M() {
          return (
            qe.sm_m ||
              (qe.sm_m = {
                proto: qe,
                fields: { property_schemas: { n: 1, c: We, r: !0, q: !0 } },
              }),
            qe.sm_m
          );
        }
      ...
      class De extends ge.Message {
        ...
        constructor(e = null) {
          super(),
            De.prototype.return_url || _e.Sg(De.M()),
            ge.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Pe extends ge.Message {
        ...
        constructor(e = null) {
          super(),
            Pe.prototype.language || _e.Sg(Pe.M()),
      ...
      class Ee extends ge.Message {
        ...
        constructor(e = null) {
          super(),
            Ee.prototype.descriptions || _e.Sg(Ee.M()),
            ge.Message.initialize(this, e, 0, -1, [1], null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Ke extends ge.Message {
        ...
        constructor(e = null) {
          super(),
            Ke.prototype.can_receive || _e.Sg(Ke.M()),
            ge.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Je extends ge.Message {
        ...
        constructor(e = null) {
          super(),
            Je.prototype.steamid || _e.Sg(Je.M()),
            ge.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
          ...
          return (
            lt.sm_m ||
              (lt.sm_m = {
                proto: lt,
                fields: {
                  trade_offers_sent: { n: 1, c: ot, r: !0, q: !0 },
                  trade_offers_received: { n: 2, c: ot, r: !0, q: !0 },
          ...
          return (
            dt.sm_m ||
              (dt.sm_m = {
                ...
                fields: {
                  my_escrow: { n: 1, c: gt },
                  their_escrow: { n: 2, c: gt },
                  both_escrow: { n: 3, c: gt },
                },
              }),
            dt.sm_m
          );
      ...
      class pt extends ge.Message {
        ...
        constructor(e = null) {
          super(),
            pt.prototype.steamid || _e.Sg(pt.M()),
            ge.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class zt extends ge.Message {
        ...
        constructor(e = null) {
          super(),
            zt.prototype.tradeid || _e.Sg(zt.M()),
            ge.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class St extends ge.Message {
        ...
        constructor(e = null) {
          super(),
            St.prototype.tradeofferid || _e.Sg(St.M()),
            ge.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Tt extends ge.Message {
        ...
        constructor(e = null) {
          super(),
            Tt.prototype.steamid_partya || _e.Sg(Tt.M()),
            ge.Message.initialize(this, e, 0, -1, [3], null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Dt extends ge.Message {
        ...
        constructor(e = null) {
          super(),
            Dt.prototype.is_sender || _e.Sg(Dt.M()),
            ge.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class At extends ge.Message {
        ...
        constructor(e = null) {
          super(),
            At.prototype.token_id || _e.Sg(At.M()),
            ge.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Pt extends ge.Message {
        ...
        constructor(e = null) {
          super(),
            Pt.prototype.language || _e.Sg(Pt.M()),
            ge.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Et extends ge.Message {
        ...
        constructor(e = null) {
          super(),
            Et.prototype.tradeid || _e.Sg(Et.M()),
            ge.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class kt extends ge.Message {
        ...
        constructor(e = null) {
          super(),
            kt.prototype.trade_response || _e.Sg(kt.M()),
            ge.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Xt extends ge.Message {
        ...
        constructor(e = null) {
          super(),
            Xt.prototype.steamid || _e.Sg(Xt.M()),
            ge.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class pr extends ge.Message {
        ...
        constructor(e = null) {
          super(),
            pr.prototype.overlay_auth_cookie || _e.Sg(pr.M()),
            ge.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
        ...
        static M() {
          return (
            Or.sm_m ||
              (Or.sm_m = {
                proto: Or,
                fields: { properties: { n: 1, c: Fr, r: !0, q: !0 } },
              }),
            Or.sm_m
          );
        }
      ...
      class Dr extends ge.Message {
        ...
        constructor(e = null) {
          super(),
            Dr.prototype.ack_type || _e.Sg(Dr.M()),
            ge.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Er extends ge.Message {
        ...
        constructor(e = null) {
          super(),
            Er.prototype.needed_types || _e.Sg(Er.M()),
            ge.Message.initialize(this, e, 0, -1, [1], null);
        }
        static sm_m;
        static sm_mbf;
        ...
        static MBF() {
          return Er.sm_mbf || (Er.sm_mbf = _e.w0(Er.M())), Er.sm_mbf;
        }
        toObject(e = !1) {
          return Er.toObject(e, this);
        }
        static toObject(e, t) {
          return _e.BT(Er.M(), e, t);
        }
        static fromObject(e) {
          return _e.Uq(Er.M(), e);
        }
      ...
      class Gr extends ge.Message {
        ...
        constructor(e = null) {
          super(),
            Gr.prototype.steamid || _e.Sg(Gr.M()),
            ge.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      function Lr(e) {
        ...
        return (0, i.jsxs)("div", {
          children: [
            ...
            (0, i.jsx)("div", {
              className: ue.AddPropertyButton,
            ...
            (0, i.jsx)("div", {
              ...
              children: (0, i.jsx)(u.$n, {
                onClick: async () => {
                  ...
                  if (!t || !t.ok) return void n("Failed to save properties");
                  (await t.json()).success
                    ? n("Saved successfully")
                    : n("Failed to save properties");
                },
                children: "Save",
              }),
            }),
            (0, i.jsx)("div", { className: ue.StatusMessage, children: s }),
          ],
        });
      }
      function Hr(e) {
        const { schema: t, index: r, onUpdate: s, onRemove: n } = e;
        return (0, i.jsxs)("div", {
          className: ue.AssetPropertyRow,
          children: [
            (0, i.jsx)("div", { children: "ID" }),
            (0, i.jsx)(de.BA, {
              className: ue.PropertyID,
              type: "number",
              value: 0 !== t.id ? t.id : "",
              placeholder: "Property id",
              onChange: (e) => {
                s({ ...t, id: e.target.valueAsNumber });
              },
            }),
            (0, i.jsx)("div", { children: "Name" }),
            (0, i.jsx)(de.BA, {
              className: ue.PropertyName,
              type: "text",
              value: t.name,
              placeholder: "Property name",
              onChange: (e) => {
                s({ ...t, name: e.target.value });
              },
            }),
            ...
            (0, i.jsx)("div", { children: "Min" }),
            (0, i.jsx)(de.BA, {
              className: ue.PropertyRange,
              type: "number",
              value: t.min ?? "",
              placeholder: "Min value",
              onChange: (e) => {
                s({ ...t, min: e.target.valueAsNumber });
              },
            }),
            (0, i.jsx)("div", { children: "Max" }),
            (0, i.jsx)(de.BA, {
              className: ue.PropertyRange,
              type: "number",
              value: t.max ?? "",
              ...
              onChange: (e) => {
                s({ ...t, max: e.target.valueAsNumber });
              },
            }),
            (0, i.jsx)("div", { children: "Hide" }),
            (0, i.jsx)(de.BA, {
              className: ue.HideFromDescription,
              type: "checkbox",
              checked: t.hide_from_description,
              onChange: (e) => {
                s({ ...t, hide_from_description: e.target.checked });
              },
            }),
            (0, i.jsx)(u.$n, {
      ...
      function Kr(e) {
        ...
        return (0, i.jsx)("div", {
          className: ue.PropertyType,
          children: (0, i.jsx)(u.ZU, {
      ...
      !(function (e) {
        (e.GetTradePermissionsForApp = function (e, t, r) {
          ...
          (e.GetTradeOffer = function (e, t, r) {
            return e.SendMsg("Econ.GetTradeOffer#1", (0, g.I8)(Bt, t, r), bt, {
              bConstMethod: !0,
              ePrivilege: 1,
              eWebAPIKeyRequirement: 2,
            });
      ...
      class Zr extends ge.Message {
        ...
        constructor(e = null) {
          super(),
            Zr.prototype.servers || _e.Sg(Zr.M()),
            ge.Message.initialize(this, e, 0, -1, [1], null);
        }
        static sm_m;
        static sm_mbf;
        ...
        static M() {
          return (
            Bi.sm_m ||
              (Bi.sm_m = {
                proto: Bi,
                fields: { detected_app_content: { n: 1, c: gi, r: !0, q: !0 } },
              }),
            Bi.sm_m
          );
        }
      ...
      class Si extends ge.Message {
        ...
        constructor(e = null) {
          super(),
            Si.prototype.depot_id || _e.Sg(Si.M()),
            ge.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Di extends ge.Message {
        ...
        constructor(e = null) {
          super(),
            Di.prototype.requests || _e.Sg(Di.M()),
            ge.Message.initialize(this, e, 0, -1, [1], null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Ai extends ge.Message {
        ...
        constructor(e = null) {
          super(),
            Ai.prototype.cdn_name || _e.Sg(Ai.M()),
            ge.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Pi extends ge.Message {
        ...
        constructor(e = null) {
          super(),
            Pi.prototype.cdn_name || _e.Sg(Pi.M()),
            ge.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Ei extends ge.Message {
        ...
        constructor(e = null) {
          super(),
            Ei.prototype.responses || _e.Sg(Ei.M()),
            ge.Message.initialize(this, e, 0, -1, [1], null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Gi extends ge.Message {
        ...
        constructor(e = null) {
          super(),
            Gi.prototype.cdn_name || _e.Sg(Gi.M()),
            ge.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Xi extends ge.Message {
        ...
        constructor(e = null) {
          super(),
            Xi.prototype.cache_id || _e.Sg(Xi.M()),
            ge.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Yi extends ge.Message {
        ...
        constructor(e = null) {
          super(),
            Yi.prototype.sysid_cm || _e.Sg(Yi.M()),
            ge.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class ls extends ge.Message {
        ...
        static M() {
          return (
            ls.sm_m ||
              (ls.sm_m = { proto: ls, fields: { config: { n: 1, c: as } } }),
            ls.sm_m
          );
        }
        static MBF() {
        ...
        static M() {
          return (
            us.sm_m ||
              (us.sm_m = {
                proto: us,
                fields: { history: { n: 1, c: ds, r: !0, q: !0 } },
              }),
            us.sm_m
          );
        }
        ...
        static M() {
          return (
            ys.sm_m ||
              (ys.sm_m = {
                proto: ys,
                fields: { config_names: { n: 1, c: Ms, r: !0, q: !0 } },
              }),
            ys.sm_m
          );
        }
      ...
      class zs extends ge.Message {
        ...
        constructor(e = null) {
          super(),
            zs.prototype.cache_id || _e.Sg(zs.M()),
            ge.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
        ...
        static MBF() {
          return zs.sm_mbf || (zs.sm_mbf = _e.w0(zs.M())), zs.sm_mbf;
        }
        toObject(e = !1) {
          return zs.toObject(e, this);
        }
        static toObject(e, t) {
          return _e.BT(zs.M(), e, t);
        }
        static fromObject(e) {
          return _e.Uq(zs.M(), e);
        }
        ...
        static M() {
          return (
            hs.sm_m ||
              (hs.sm_m = {
                proto: hs,
                fields: { config_names: { n: 1, c: Rs, r: !0, q: !0 } },
              }),
            hs.sm_m
          );
        }
      ...
      class Ws extends ge.Message {
        ...
        constructor(e = null) {
          super(),
            Ws.prototype.history || _e.Sg(Ws.M()),
            ge.Message.initialize(this, e, 0, -1, [1], null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Ts extends ge.Message {
        ...
        constructor(e = null) {
          super(),
            Ts.prototype.timestamp || _e.Sg(Ts.M()),
            ge.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Ds extends ge.Message {
        ...
        constructor(e = null) {
          super(),
            Ds.prototype.cache_id || _e.Sg(Ds.M()),
            ge.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Ps extends ge.Message {
        ...
        constructor(e = null) {
          super(),
            Ps.prototype.config_names || _e.Sg(Ps.M()),
            ge.Message.initialize(this, e, 0, -1, [1], null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Es extends ge.Message {
        ...
        constructor(e = null) {
          super(),
            Es.prototype.cache_id || _e.Sg(Es.M()),
            ge.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Gs extends ge.Message {
        ...
        constructor(e = null) {
          super(),
            Gs.prototype.cache_id || _e.Sg(Gs.M()),
            ge.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class ks extends ge.Message {
        ...
        constructor(e = null) {
          super(),
            ks.prototype.config || _e.Sg(ks.M()),
            ge.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Ks extends ge.Message {
        ...
        constructor(e = null) {
          super(),
            Ks.prototype.timestamp || _e.Sg(Ks.M()),
            ge.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class $s extends ge.Message {
        ...
        constructor(e = null) {
          super(),
            $s.prototype.cache_id || _e.Sg($s.M()),
            ge.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Xs extends ge.Message {
        ...
        constructor(e = null) {
          super(),
            Xs.prototype.config || _e.Sg(Xs.M()),
            ge.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class Zs extends ge.Message {
        ...
        constructor(e = null) {
          super(),
            Zs.prototype.load_calc_percent || _e.Sg(Zs.M()),
            ge.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
        ...
        static M() {
          return (
            sn.sm_m ||
              (sn.sm_m = {
                proto: sn,
                fields: { depots: { n: 1, c: rn, r: !0, q: !0 } },
              }),
            sn.sm_m
          );
        }
      ...
      class pn extends ge.Message {
        ...
        constructor(e = null) {
          super(),
            pn.prototype.property_type || _e.Sg(pn.M()),
            ge.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
        ...
        static MBF() {
          return pn.sm_mbf || (pn.sm_mbf = _e.w0(pn.M())), pn.sm_mbf;
        }
        toObject(e = !1) {
          return pn.toObject(e, this);
        }
        static toObject(e, t) {
          return _e.BT(pn.M(), e, t);
        }
        static fromObject(e) {
          return _e.Uq(pn.M(), e);
        }
      ...
      class zn extends ge.Message {
        ...
        constructor(e = null) {
          super(),
            zn.prototype.detected_anticheat || _e.Sg(zn.M()),
            ge.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
        ...
        static MBF() {
          return zn.sm_mbf || (zn.sm_mbf = _e.w0(zn.M())), zn.sm_mbf;
        }
        toObject(e = !1) {
          return zn.toObject(e, this);
        }
        static toObject(e, t) {
          return _e.BT(zn.M(), e, t);
        }
        static fromObject(e) {
          return _e.Uq(zn.M(), e);
        }
      ...
      !(function (e) {
        ...
        (function (e) {
          (e.ReloadOriginStorageInfo = function (e, t) {
            ...
            (e.InvalidateDepotMetadata = function (e, t) {
              return e.SendNotification(
            ...
            (e.MDSFlushManifestVersion = function (e, t) {
              return e.SendNotification(
            ...
            (e.AppBuildUpdated = function (e, t) {
              return e.SendNotification(
        ...
        (function (e) {
          (e.GetCDNConfigurations = function (e, t, r) {
            ...
            (e.SteamCacheConfigUpdateNotification = function (e, t) {
              return e.SendNotification(
      ...
      function jn(e) {
        const {
            ...
            rgCommonRedistWindows: r,
            rgCheckedDepots: s,
            nDetectedGameEngine: n,
          } = e,
          a = (0, o.useMemo)(() => new Map(t), [t]),
          l = (0, o.useMemo)(() => new Map(r), [r]),
          [c, u] = (0, o.useState)(
            (function (e, t, r) {
              const i = new Map();
              return (
          ...
          [d, g] = (0, o.useMemo)(() => {
            ...
            return (
              l.forEach((r) => {
                "directx" == r.category
                  ? Object.entries(r.components).forEach(([t, r]) => {
                      e.push(r);
                    })
                  : "vc" == r.category &&
                    Object.entries(r.components).forEach(([e, r]) => {
                      t.push(r);
                    });
              }),
              [e, t]
      ...
      function Cn(e) {
        ...
        return (0, i.jsxs)("div", {
          ...
          children: [
            ...
            (0, i.jsx)("div", { className: "grayRule" }),
            ...a,
          ],
        });
      }
        ...
        return (0, i.jsxs)(i.Fragment, {
          children: [
            (0, i.jsx)("input", {
              ...
              checked: s,
              disabled: a,
              onChange: (e) => n(r, e.currentTarget.checked),
            }),
            (0, i.jsx)("label", { htmlFor: r.toString(), children: t }),
          ],
        });
      }
      var qn = r(67045),
      ...
      function In(e, t) {
        ...
        switch (e) {
          case "image_large":
            t.item_image_large && r.push(t.item_image_large);
            break;
          case "image_small":
            t.item_image_small && r.push(t.item_image_small);
            break;
          case "movie_large":
            t.item_movie_webm && r.push(t.item_movie_webm),
              t.item_movie_mp4 && r.push(t.item_movie_mp4);
        }
        return r;
      }
      function Un(e, t) {
      ...
      class Hn extends Pn.q {
        ...
        IsValidAssetType(e, t) {
          const r = t && t != this.fileType,
            i = this.IsFileTypeSupported(this.fileType),
            s = this.GetCurrentImageOption();
          let n = "";
          return (
            i
              ? r &&
        ...
        BIsVideo() {
          return Ln.Ho.includes(this.fileType);
        }
        GetResizeDimension() {}
        BSupportsLanguages() {
          return !1;
      ...
      class Kn extends An.Vr {
        ...
        ClearImages() {
          this.m_filesToUpload = Nn.sH.array();
        }
        DeleteUploadImage(e) {
        ...
        GetImageOptions() {
          ...
          for (const r of this.m_filesToUpload.filter(
            ...
            this.m_rgAssetRequirements.forEach((i) => {
              r.width === i.width &&
                r.height === i.height &&
                i.accepted_filetypes.includes(r.fileType) &&
                (e.push({
                  asset_type: i.asset_type,
                  sKey: r.filename,
                  fnGetLabelText: () => i.label,
                  width: r.width,
                  height: r.height,
                  bEnforceDimensions: !0,
                  bHiddenFromDropdown: !1,
                  bDuplicateAssetType: Boolean(t.has(i.asset_type)),
                }),
                t.add(i.asset_type));
            });
          return e;
        ...
        async UploadSingleImage(e, t, r, i) {
          ...
          try {
            s = await U().post(this.m_strUploadPath, n, {
              withCredentials: !0,
      ...
      function Xn(e) {
        ...
        return (0, i.jsx)("div", {
          children: (0, i.jsx)($n.O9, {
            ...
            imageUploader: n,
            rgRealmList: [Vn.TU.k_ESteamRealmGlobal],
            fnUploadComplete: (e) => {
              var i, s;
              e.some((e) => e.bSuccess) &&
                ((i = t),
                (s = r),
                On.L.invalidateQueries({ queryKey: Un(i, s) }));
            },
          }),
        });
      }
      ...
      class Yn {
        ...
        m_ItemKV = null;
        constructor(e, t) {
          (0, Nn.Gn)(this), this.LoadItemDefinition(e, t);
        }
      ...
      const ea = [
        ...
        ra = ({ communityItem: e, assetDefs: t, children: r }) =>
          (0, i.jsx)(ta.Provider, {
            value: { communityItem: e, assetDefs: t },
            children: r,
          });
      function ia(e) {
        const { appID: t, unItemType: r } = e,
          s = (function (e, t) {
            const r = (0, x.I)({
              queryKey: Un(e, t),
              queryFn: async () => {
              ...
              staleTime: 1 / 0,
              initialData: (0, Fn.Tc)("item_def", "application_config"),
            });
            return r.isLoading ? null : r.data;
          })(t, r);
        if (!s) return null;
        const n = new Yn(s),
          a = n.ItemClass === Zn.Tl ? ea : null;
        if (!a) return null;
        ...
        return (0, i.jsxs)("div", {
          ...
          children: [
            ...
            t.rgBulletPoints?.length > 0 &&
              (0, i.jsx)(aa, { rgBulletPoints: t.rgBulletPoints }),
          ],
        });
      }
      function aa(e) {
        const { rgBulletPoints: t } = e,
          r = t.map((e, t) =>
            (0, i.jsx)("li", { children: e }, `bulletpoint_${t}`),
          );
        return (0, i.jsx)("ul", { children: r });
      }
      function oa() {
        const { communityItem: e, assetDefs: t } = o.useContext(ta),
      ...
      function ma(e) {
        ...
        return t.length
          ? (0, i.jsx)("img", { className: Jn.AssetPreview, src: Qn(r, t[0]) })
          : (0, i.jsx)(ca, {});
      }
      function ua(e) {
        const { rgSources: t, unAppID: r } = e,
      ...
      function da(e) {
        const {
          ...
          a = (0, w.c2)(n),
          [l, c, u] = o.useMemo(() => {
            if (!a || a.isLoading || !a.data) return ["", "", !1];
            let e = [...a.data.restricted_countries];
            return (
              r || (e = e.filter((e) => "XC" !== e)),
              a.data.no_restrictions
                ? ["", "", !1]
                : [e?.join(", "), a.data.allowed_countries?.join(", "), !s]
            );
          }, [s, r, a]);
        return c.length || l.length
                ...
                u &&
                  (0, i.jsx)("div", {
                    children: (0, m.oW)(
                      ...
                      (0, i.jsx)("a", {
                        href: `${R.TS.PARTNER_BASE_URL}/contentdescriptors/editsurvey/${t}`,
                      }),
                    ),
                  }),
              ],
          ...
          : (0, i.jsx)("div", {
              children: (0, m.we)("#AppLanding_RegionRestrictions_None"),
            });
      }
      const ga = {
      ...
      function Ba(e) {
        return (0, i.jsxs)(n.dO, {
          children: [
            (0, i.jsx)(n.qh, {
              path: ga.CommunityItem(":appid", ":itemtype"),
              render: (e) =>
                (0, i.jsx)(a.X, {
                  config: {
                    "appadmin-profilecolors": (e) => (0, i.jsx)(s.Y, { ...e }),
    ...
    27429: (e, t, r) => {
      ...
      function i(e, t) {
        const r = new Date(1e3 * e),
          i = t ? new Date(1e3 * t) : new Date(r);
        t || i.setDate(r.getDate() + 6);
        const s = r.toLocaleString("en-US", { month: "short" }),
          n = r.getDate(),
          a = i.toLocaleString("en-US", { month: "short" }),
          o = i.getDate();
        return s === a ? `${s} ${n} - ${o}` : `${s} ${n} - ${a} ${o}`;
      }
      function s(e) {
        let t = n(e);
    ...
    63556: (e, t, r) => {
      ...
      function d() {
        return (0, n.q3)(() => u.Get().GetCurEditLanguage());
      }
      (0, i.Cg)([s.sH], u.prototype, "m_eCurLang", void 0),
        (0, i.Cg)([s.sH], u.prototype, "m_rgHasData", void 0),
        (0, i.Cg)([s.sH], u.prototype, "m_bHasLocalizationContext", void 0),
        (0, i.Cg)([l.o], u.prototype, "GetCurEditLanguage", null),
        (0, i.Cg)([l.o], u.prototype, "SetCurEditLanguage", null),
        (0, i.Cg)([s.XI.bound], u.prototype, "SetHasLanguage", null),
        (0, i.Cg)([l.o], u.prototype, "BHasLanguageData", null);
    },
    44165: (e, t, r) => {
      "use strict";
    ...
    55263: (e, t, r) => {
      ...
      const m = 1,
        ...
        d = 3;
      function g(e, t, r, i) {
        const o = (0, n.useRef)(void 0),
          g = (0, n.useRef)(void 0),
          B = (0, l.CH)();
        o.current = e;
        const [_, b] = (0, n.useState)(void 0),
          {
            include_assets: p,
            include_release: y,
            include_platforms: M,
          ...
          ((0, n.useEffect)(() => {
            ...
            return (
              !e ||
                ...
                (void 0 !== _ && i && i == g.current) ||
                (i !== g.current && (b(void 0), (g.current = i)),
                (n = s().CancelToken.source()),
                c.A.Get()
                  .QueueStoreItemRequest(e, t, r)
                  .then((t) => {
                    n?.token.reason || o.current !== e || b(t == a.R), B();
                  })),
