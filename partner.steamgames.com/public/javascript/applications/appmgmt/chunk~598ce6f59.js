  ...
  [7368],
  {
    ...
    29020: (e, t, r) => {
      ...
      class p extends a.Message {
        ...
        constructor(e = null) {
          super(),
            p.prototype.clan_account_ids || n.Sg(p.M()),
            a.Message.initialize(this, e, 0, -1, [1], null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class _ extends a.Message {
        ...
        constructor(e = null) {
          super(),
            _.prototype.clan_account_id || n.Sg(_.M()),
            a.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class y extends a.Message {
        ...
        constructor(e = null) {
          super(),
            y.prototype.partnerid || n.Sg(y.M()),
            a.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class w extends a.Message {
        ...
        constructor(e = null) {
          super(),
            w.prototype.clan_accountid || n.Sg(w.M()),
    ...
    73139: (e, t, r) => {
      ...
      class g extends a.Message {
        ...
        constructor(e = null) {
          super(),
            g.prototype.list_details || n.Sg(g.M()),
            a.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
        static M() {
          return (
            g.sm_m ||
              (g.sm_m = { proto: g, fields: { list_details: { n: 1, c: u } } }),
            g.sm_m
          );
        }
        static MBF() {
      ...
      !(function (e) {
        (e.GetLists = function (e, t, r) {
          return e.SendMsg("StoreCuration.GetLists#1", (0, o.I8)(p, t, r), B, {
            bConstMethod: !0,
            ePrivilege: 2,
    ...
    12493: (e, t, r) => {
      ...
      (0, i.Cg)([m.sH], p.prototype, "m_appidList", void 0),
        (0, i.Cg)([m.sH], p.prototype, "m_nFollowers", void 0),
        (0, i.Cg)([m.sH], p.prototype, "m_clanAccountFlags", void 0);
      var B = r(96059),
        _ = r(17720),
        g = r(63340);
      class b {
        ...
        GetServiceTransport() {
          if (!this.m_serviceTransport) {
            const e = (0, d.Tc)("loyalty_webapi_token", "application_config"),
              t = new B.D(d.TS.WEBAPI_BASE_URL, e || void 0);
              ...
              (0, m.h5)(() => {
                n.data.curators.forEach((e) => {
                  if (!this.m_mapClanToCreatorHome.has(e.creator_clan_id)) {
                    let t = _.b.InitFromClanID(e.creator_clan_id),
                      r = new p(t);
                    r.Initialize(e),
      ...
      (0, i.Cg)([m.sH], b.prototype, "m_mapClanToCreatorHome", void 0),
        (0, i.Cg)([m.sH], b.prototype, "m_mapAppToCreatorIDList", void 0),
        (0, i.Cg)([m.XI], b.prototype, "LazyInit", null);
      const y = new b();
      function M(e) {
        if (!e) return null;
        const t = y.BHasCreatorHomeLoaded(e.clanSteamID)
          ? y.GetCreatorHome(e.clanSteamID)
          : void 0;
        return e.GetSaleURL(t?.GetCreatorHomeURL("developer"));
      }
      function w(e) {
        if (!e) return;
        const t = (0, d.Tc)("creator_home_list_info", "application_config");
      ...
      function z(e) {
        return w(e)?.description;
      }
      function S(e) {
        const t = _.b.InitFromClanID(e);
        return {
          queryKey: ["CreatorHome", e],
          initialData: () => y.GetCreatorHome(t),
          queryFn: async () => {
            const t = _.b.InitFromClanID(e);
            return await y.LoadCreatorHome(t, !0);
          },
        };
      }
      function h(e) {
        const { data: t, isFetching: r, refetch: i } = (0, o.I)(S(e));
