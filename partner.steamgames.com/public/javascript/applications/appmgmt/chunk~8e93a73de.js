  ...
  [1853],
  {
    ...
    47143: (e, t, i) => {
      ...
      function B(e, t, i) {
        ...
        let r = {
          nTimeScale: n,
          nDuration: T(e, "duration") || 0,
          nStartNumber: T(e, "startNumber") || 0,
          strMedia: M(e, "media"),
        ...
        return r.nDuration &&
          r.nStartNumber &&
          r.strMedia &&
          (t.bContainsThumbnails || r.strInitialization)
          ? ((r.strMedia = V(r.strMedia, i)),
            (r.strInitialization = V(r.strInitialization, i)),
            r)
          : null;
      }
      function y(e, t, i) {
      ...
      class H {
        ...
        ParseRepresentation(e, t, i, n, r) {
          ...
          let a = {
            ...
            nBandwidth: T(e, "bandwidth") || 0,
            segmentTemplate: s,
          };
          if ((!a.strMimeType && r && (a.strMimeType = r), t.bContainsVideo)) {
            if (
              ((a.nWidth = T(e, "width") || 0),
              (a.nHeight = T(e, "height") || 0),
              (a.nFrameRate = T(e, "frameRate") || 0),
              (0, p.q_)(
            ...
            a.nAudioSamplingRate = T(e, "audioSamplingRate") || 0;
            let t = w(e, "AudioChannelConfiguration");
            if (
              (t && (a.nAudioChannels = T(t, "value") || 0),
              a.nAudioChannels || (a.nAudioChannels = 2),
              !(
                a.strID &&
                a.strMimeType &&
                a.strCodecs &&
            ...
            (a.nWidth = T(e, "width") || 0), (a.nHeight = T(e, "height") || 0);
            ...
            (a.nTileWidthCount = parseInt(n[0])),
              (a.nTileHeightCount = parseInt(n[1]));
          }
          var l;
          return a;
        }
        ...
        BParse(e, t) {
          ...
          if (
            ((this.m_nMinBufferTime = v(n, "minBufferTime") || 0),
            "dynamic" == r)
          ) {
            if (
              ...
              (this.m_nMinimumUpdatePeriod = v(n, "minimumUpdatePeriod") || 0),
          ...
          let s = w(n, "BaseURL");
          s && s.textContent
            ? (this.m_strBaseURL = s.textContent)
          ...
          if (0 == a.length) return (0, p.q_)("MPD - Missing Periods"), !1;
          let l = a[0],
            d = M(l, "id"),
            m = v(l, "start");
          if (!d || null === m)
          ...
          for (let e = 0; e < u.length; e++) {
            let t = u[e],
              ...
              n = M(t, "lang"),
              r = {
                bSegmentAlignment: D(t, "segmentAlignment") || !1,
            ...
            for (let e = 0; e < m.length; e++) {
              let t = m[e],
                i = this.ParseRepresentation(t, r, a, this.m_strBaseURL, d);
              if (!i) return !1;
            ...
            switch (M(i, "type")) {
              ...
              case "static":
                (0, p.q_)("Converting MPD from dynamic to static"),
                  (this.m_strType = "static"),
                  (this.m_nMediaPresentationDuration =
                    v(i, "mediaPresentationDuration") || 0),
                  (this.m_nMinBufferTime = v(i, "minBufferTime") || 0),
      ...
      class E {
        ...
        async DownloadSegment(e, t, i, n = performance.now()) {
          ...
          let s = i;
          r && (s = i + r),
            (0, p.q_)(`${this.GetDebugName()} Downloading: ` + s);
          let a,
            l = null,
            m = performance.now(),
          ...
          if (!this.m_xhrDownload || this.m_xhrDownload != h)
            return void (0, p.q_)(`Throwing away cancelled download: ${s}`);
          a &&
            (0, p.q_)(
              `${this.GetDebugName()} Failed to download segment: ${s}`,
              a,
            );
          ...
          if (((this.m_xhrDownload = null), this.m_bSeekInProgress))
            return (
              (0, p.q_)(
                `${this.GetDebugName()} Throwing away download due to seek: ${s}`,
              ),
          ...
          (0, p.q_)(`HTTP ${f} (${_}ms, ${Math.floor(g.length / 1e3)}k): ${s}`),
        ...
        UpdateBuffer() {
          ...
          if (!this.m_representation)
            return void (0, p.ZI)("Update buffer - no representation?");
          let e = this.m_callbacks.GetCurrentPlayTime(),
          ...
          if (!this.m_bSourceBufferQuotaExceeded && s && r) {
            let e = r.data,
        ...
        Seek(e) {
          ...
          if (!this.m_representation)
            return void (0, p.ZI)("Seek without representation?");
      ...
      (0, r.Cg)([_.o], E.prototype, "OnSourceBufferUpdateEnd", null),
        (0, r.Cg)([_.o], E.prototype, "OnMediaUnsupportedError", null),
        (0, r.Cg)([_.o], E.prototype, "OnSourceBufferError", null),
        (0, r.Cg)([_.o], E.prototype, "OnSourceBufferAbort", null),
        (0, r.Cg)([_.o], E.prototype, "ScheduleNextDownload", null),
        (0, r.Cg)([_.o], E.prototype, "DownloadInitSegment", null),
        (0, r.Cg)([_.o], E.prototype, "DownloadNextSegment", null),
        (0, r.Cg)([_.o], E.prototype, "DownloadFailed", null),
        (0, r.Cg)([_.o], E.prototype, "DownloadGone", null),
        (0, r.Cg)([_.o], E.prototype, "CurrentTimeChanged", null);
      var U = i(36586),
        O = i(73745);
      const N = 5;
      var j, Z, q, $;
      ...
      class z {
        ...
        async PlayMPD(e, t, i, n) {
          ...
          if (r) {
            if (
              ((this.m_strMPD = r.strMPD), (this.m_mpd = r.mpd), !r.bCanPlay)
            ) {
              if (
                !t ||
                !(function (e) {
            ...
            if (
              ...
              this.IsLiveContent() &&
                ...
                this.CalcVideoStartRelativeToSystemClock(r.strServerTime)),
        ...
        async DownloadMPD(e, t) {
          ...
          return (
            (0, p.q_)("Failed to download: " + this.m_strMPD), [$.Timeout, null]
          );
        }
        async UpdateMPD() {
          W(this.m_mpd),
        ...
        BCreateLoaders() {
          ...
          for (let e of t.rgAdaptationSets) {
            ...
            if (
              ...
              let e = new E(this, this.m_mpd, t, this.m_stats);
        ...
        GetCurrentPlayTime() {
          ...
          if (this.m_seekingToTime) {
            if (
              ...
              this.m_seekingToTime.eSeekType == q.FromAvailableStart
            )
              return 0;
            let e =
              this.m_seekingToTime.eSeekType == q.FromAvailableStart
        ...
        SendUpdateToBookmarkServiceIfNeeded() {
          if (this.m_bookMarkAdapter) {
            ...
            let t = this.GetCurrentVideoAdaptation(),
              ...
              r = n && n.strID ? n.strID : "";
            this.m_bookMarkAdapter.SetBookmark(e, i, r, ""),
              this.IsPaused()
                ? this.m_schBookmarkUpdater.Cancel()
        ...
        OnSegmentDownloadGone(e) {
          this.m_bIsBuffering && e.GetNumConsecutiveDownloadGones() <= 3
            ...
            : ((0, p.q_)(
              ...
              this.OnSegmentDownloadFailed(e, Z.StreamGone));
        }
        OnMediaUnsupportedError() {
          this.DispatchEvent("valve-downloadfailed", Z.UnsupportedMediaType);
        }
        OnMediaSourceError() {
        ...
        BeginPlaybackHLS() {
          ...
          (0, p.q_)("Starting HLS playback at 0"), this.Seek(0);
        }
        BeginPlayback() {
          W(this.m_mpd);
          let e = this.GetVideoLoader();
          if (!e || this.m_bUseHLSManifest)
            return void (0, p.q_)("No video loader for playback?");
          ...
          if (this.IsLiveContent()) {
            ...
            (i = this.GetPlaybackStartTime(s)),
              (0, p.q_)(
                `Begin playback of live content [this.buffer=${this.m_nTrackBufferMS}][nStartTime=${i}][nLiveEdge=${s}]`,
              );
          } else
        ...
        Seek(e, t = q.Absolute) {
          ...
          t == q.FromAvailableStart && (e += this.GetAvailableVideoStartTime());
          ...
          if ((s || this.m_elVideo.pause(), this.m_bUseHLSManifest))
            ...
            (this.m_bIsBuffering = !0),
              (this.m_seekingToTime = { nTime: e, eSeekType: q.Absolute });
        ...
        GetVideoRepresentations() {
          ...
          if (t)
            for (let i of t.rgRepresentations) {
              ...
              let o = `${i.nWidth}x${i.nHeight} @ ${n}fps`;
              e.push({
                id: i.strID,
                displayName: o,
                selected: t,
      ...
      (0, r.Cg)([a.sH], z.prototype, "m_nTimedText", void 0),
        ...
        (0, r.Cg)([_.o], z.prototype, "CheckActiveTextTrack", null),
        (0, r.Cg)([_.o], z.prototype, "OnLoadedMetadataForHLS", null),
        (0, r.Cg)([_.o], z.prototype, "OnVisibilityChangeForHLS", null),
        (0, r.Cg)([_.o], z.prototype, "OnEndedForHLS", null),
        (0, r.Cg)([_.o], z.prototype, "UpdateMPD", null),
        (0, r.Cg)([_.o], z.prototype, "OnPlayerResize", null),
        (0, r.Cg)([_.o], z.prototype, "OnMediaSourceOpen", null),
        (0, r.Cg)([_.o], z.prototype, "HandleMediaSourceError", null),
        (0, r.Cg)([_.o], z.prototype, "OnMediaSourceEnded", null),
        (0, r.Cg)([_.o], z.prototype, "OnMediaSourceClose", null),
        (0, r.Cg)([_.o], z.prototype, "OnVideoWaiting", null),
        (0, r.Cg)([_.o], z.prototype, "OnVideoPause", null),
        (0, r.Cg)([_.o], z.prototype, "OnVideoResize", null),
        (0, r.Cg)([_.o], z.prototype, "OnVideoError", null),
        (0, r.Cg)([_.o], z.prototype, "OnVideoCanPlay", null),
        (0, r.Cg)([_.o], z.prototype, "OnVideoCanPlayHLS", null),
        (0, r.Cg)([_.o], z.prototype, "OnLoadedMetadata", null),
        (0, r.Cg)([_.o], z.prototype, "GetCurrentPlayTime", null),
        (0, r.Cg)([_.o], z.prototype, "GetBufferedEndTime", null),
        (0, r.Cg)([_.o], z.prototype, "OnVideoTimeUpdate", null),
        (0, r.Cg)(
          [_.o],
          z.prototype,
          "SendUpdateToBookmarkServiceIfNeeded",
        ...
        (0, r.Cg)([_.o], z.prototype, "OnVideoPlay", null),
        (0, r.Cg)([_.o], z.prototype, "OnVideoSeeking", null),
        (0, r.Cg)([_.o], z.prototype, "OnVideoSeeked", null),
        (0, r.Cg)([_.o], z.prototype, "GetPlaybackRate", null),
        (0, r.Cg)([_.o], z.prototype, "GetTimeoutAfterFailedDownload", null),
        (0, r.Cg)([_.o], z.prototype, "GetCDNAuthURLParameter", null),
        (0, r.Cg)([_.o], z.prototype, "OnSegmentDownloaded", null),
        (0, r.Cg)([_.o], z.prototype, "OnSegmentBuffered", null),
        (0, r.Cg)([_.o], z.prototype, "PlayOnElement", null),
        (0, r.Cg)([_.o], z.prototype, "OnSegmentDownloadFailed", null),
        (0, r.Cg)([_.o], z.prototype, "OnSegmentDownloadGone", null),
        (0, r.Cg)([_.o], z.prototype, "OnMediaUnsupportedError", null),
        (0, r.Cg)([_.o], z.prototype, "OnMediaSourceError", null),
        (0, r.Cg)(
          [_.o],
          z.prototype,
          "VerifyFirstSegmentDownloadProgress",
        ...
        (0, r.Cg)([_.o], z.prototype, "ReportPlayerStats", null),
    ...
    81952: (e, t, i) => {
      ...
      class C {
        ...
        async SendReportToServer(e, t) {
          ...
          let r = i.searchParams.get("l");
          r && n.append("l", r),
            (r = i.searchParams.get("e")),
            r && n.append("e", r),
            (r = i.searchParams.get("h")),
            r && n.append("h", r),
