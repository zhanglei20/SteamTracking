    ...
    [4298],
    {
      ...
      21690: (Q, z, s) => {
        ...
        function p1(u) {
          ...
          return React.createElement(l1.Provider, { value: H }, L);
        }
        function i1() {
          const {
          ...
          return (o && C) || u || $.TS.FORCED_DISPLAY_MODE == "steamdeck"
            ? [!0, I.ZJ]
            : (o && c) || $.TS.FORCED_DISPLAY_MODE == "steammachine"
              ? [!0, I.JR]
              : (o && p) || $.TS.FORCED_DISPLAY_MODE == "steamframe"
                ? [!0, I.bY]
                : o
                  ? [!0, I.c9]
                  : [!1, I.iA];
        ...
        const j = (u) => {
            const { category: C = f.YX, className: o } = u,
              c = q(C);
            return (0, e.jsxs)("div", {
              className: (0, t1.A)(k.SteamDeckCompatInfo, o),
              children: [
                (0, e.jsx)(B.lRD, {}),
                (0, e.jsx)(c, { className: k.SteamDeckCompatIcon }),
              ],
            });
          },
          v = (u) => {
            const {
                category:
                  C = ESteamDeckCompatibilityCategory.k_ESteamDeckCompatibilityCategory_Unknown,
                className: o,
              } = u,
              c = q(C);
            return jsxs("div", {
              className: classnames(styles.SteamDeckCompatInfo, o),
              children: [
                jsx(SteamMachineCompatLogo, {}),
                jsx(c, { className: styles.SteamDeckCompatIcon }),
              ],
            });
          },
          P = (u) => {
            ...
            return jsxs("div", {
              className: classnames(styles.SteamDeckCompatInfo, o),
              children: [
                jsx(SteamFrameCompatLogo, {}),
                jsx(c, { className: styles.SteamDeckCompatIcon }),
              ],
            });
          },
          E = (u) => {
            const { category: C, elControllerSupport: o } = u,
              c = g(C);
            return jsxs("div", {
              className: classnames(styles.SteamDeckCompatInfo, u.className),
              children: [o, jsx(c, { className: styles.SteamDeckCompatIcon })],
            });
          };
        function G(u) {
          const { eDisplay: C, storeItemPlatform: o, className: c } = u;
          return C ==
            ESteamHWCompatibilityDisplay.k_ESteamHWCompatibility_SteamDeck
            ? jsx(j, {
                category:
            ...
            : C ==
              ...
              ? jsx(v, {
                  category:
                    o?.steam_machine_compat_category ??
                    ESteamDeckCompatibilityCategory.k_ESteamDeckCompatibilityCategory_Unknown,
                  className: c,
                })
              : C ==
        ...
        const K = {
          ...
          f1 = { [D.xs]: B.WX$, [D.u_]: B.jIP, [D.Hi]: B.ZjT };
        function q(u) {
          return K[u] || B.WX$;
        }
        function g(u) {
        ...
        const Y = {
          [f.I2]: "#DeckVerified_CategoryLabel_Verified",
          [f.sd]: "#DeckVerified_CategoryLabel_Playable",
          [f.V8]: "#DeckVerified_CategoryLabel_Unsupported",
          [f.YX]: "#DeckVerified_CategoryLabel_Unknown",
        };
        function x1(u) {
          return HWCompatLocalization.Localize(
            Y[u] || "#DeckVerified_CategoryLabel_Unknown",
          );
        }
        const a1 = {
        ...
        function r1(u) {
          return HWCompatLocalization.Localize(
            a1[u] || "#SteamOS_CategoryLabel_Unknown",
          );
        }
        const m = {
          [f.I2]: "#DeckVerified_FilterLabel_Verified",
          [f.sd]: "#DeckVerified_FilterLabel_Verified_Playable",
          [f.YX]: "#DeckVerified_FilterLabel_Verified_Playable_Unknown",
          [f.V8]: "#DeckVerified_FilterLabel_AllGames",
        };
        function W(u) {
          return HWCompatLocalization.Localize(
            m[u] || "#DeckVerified_FilterLabel_Unknown",
          );
        }
        const d = {
          [f.I2]: "#DeckVerified_FilterDescription_Verified",
          [f.sd]: "#DeckVerified_FilterDescription_Verified_Playable",
          [f.YX]: "#DeckVerified_FilterDescription_Verified_Playable_Unknown",
          [f.V8]: "#DeckVerified_FilterDescription_AllGames",
        };
        function y(u) {
          return HWCompatLocalization.Localize(
            d[u] || "#DeckVerified_FilterLabel_Unknown",
          );
        }
        const l = {
        ...
        function H1(u) {
          return HWCompatLocalization.Localize(
            g1[u] || "#SteamOS_CategoryLabel_Unknown",
          );
        }
        const x = {
          [f.I2]: "#MachineVerified_FilterDescription_Verified",
          [f.sd]: "#MachineVerified_FilterDescription_Verified_Playable",
          [f.YX]:
            "#MachineVerified_FilterDescription_Verified_Playable_Unknown",
          [f.V8]: "#MachineVerified_FilterDescription_AllGames",
        };
        function d1(u) {
          return HWCompatLocalization.Localize(
            x[u] || "#DeckVerified_FilterLabel_Unknown",
          );
        }
        const u1 = {
          [f.I2]: "#FrameVerified_FilterDescription_Verified",
          [f.sd]: "#FrameVerified_FilterDescription_Verified_Playable",
          [f.YX]: "#FrameVerified_FilterDescription_Verified_Playable_Unknown",
          [f.V8]: "#FrameVerified_FilterDescription_AllGames",
        };
        function V(u) {
          return HWCompatLocalization.Localize(
            u1[u] || "#DeckVerified_FilterLabel_Unknown",
          );
        }
        const g1 = {
        ...
        function w1(u) {
          return HWCompatLocalization.Localize(
            l[u] || "#SteamOS_CategoryLabel_Unknown",
          );
        }
        function S1(u, C) {
          return u ==
      ...
      19563: (Q, z, s) => {
        ...
        var e = s(7850),
          ...
          E = (C, o, c, p) => {
            for (
              var L = p > 1 ? void 0 : p ? P(o, c) : o, H = C.length - 1, S;
              H >= 0;
              H--
            )
              (S = C[H]) && (L = (p ? S(o, c, L) : S(L)) || L);
            return p && L && v(o, c, L), L;
          };
        const G = class b1 {
          ...
          GetCallbackForAppList(o) {
            return (
              this.m_mapAppCallbackList.has(o) ||
                this.m_mapAppCallbackList.set(o, new i1.lu()),
          ...
          async InternalLoadAppCompatability(o) {
            let c = null;
            try {
              const p = { nAppID: o, l: j.TS.LANGUAGE, cc: j.TS.COUNTRY };
              let L =
                j.TS.STORE_BASE_URL +
                "saleaction/ajaxgetdeckappcompatibilityreport";
              const H = await l1().get(L, { params: p, withCredentials: !0 });
              if (
                H?.status == 200 &&
                H.data?.success == m1.R &&
                H.data?.results
          ...
          static Get() {
            return (
              b1.s_Singleton || (b1.s_Singleton = new b1()), b1.s_Singleton
            );
          }
          constructor() {
            if (document.getElementById("application_config")) {
              let o = (0, j.Tc)("hardwarecompatibility", "application_config");
              b1.ValidateCompatabilityResult(o) &&
          ...
          static ValidateCompatabilityResult(o) {
            ...
            return (
              ...
              typeof c.resolved_category == "number" &&
              typeof c.resolved_items == "object"
            );
          }
        };
        E([O.oI], G.prototype, "LoadAppCompabitilityResult", 1);
        let K = G;
        function f1(C) {
          const [o, c] = t1.useState(K.Get().GetCompatabilityResultForApp(C));
          return (
            (0, O.hL)(K.Get().GetCallbackForAppList(C), c),
            t1.useEffect(() => {
              K.Get().BHasCompatabilityResultForApp(C) ||
                K.Get()
                  .LoadAppCompabitilityResult(C)
                  .then(() => c(K.Get().GetCompatabilityResultForApp(C)));
            }, [C]),
            o
          );
        }
        ...
        function l(C) {
          const { id: o } = C,
            ...
            { data: p } = (0, C1.qI)(o),
            [L, H, S] = (0, k.uD)();
          if (!c || !p || c.item_type !== B.c6.qI) return null;
          const U = p.steam_deck_compat_category || b.YX;
          return (0, e.jsxs)("div", {
            className: (0, r1.A)(y().LearnMoreCtn, "LearnMoreCtn"),
            children: [
              (0, e.jsx)($.$o, { category: U }),
              (0, e.jsx)(f.Ii, {
                onClick: H,
              ...
              (0, e.jsx)(g.EN, {
                active: L,
                children: (0, e.jsx)(x, { nAppID: c.appid, closeModal: S }),
              }),
            ],
          });
        }
        function H1(C) {
          const {
            ...
            H = () => {
              L ? L() : o && (window.location.href = o);
            };
          return jsxs(FocusableAnchor, {
            className: c,
            onClick: H,
            children: [
              p && jsx("div", { className: styles.DeveloperComments_Icon }),
              jsx("div", {
                className: p
        ...
        function x(C) {
          ...
          return (0, e.jsx)(g.eV, {
            ...
            closeModal: c,
            onCancel: c,
            children: (0, e.jsx)(q.nB, {
              children: (0, e.jsx)(D.Z, {
                focusable: !1,
                "flow-children": "column",
                children: p
                  ? (0, e.jsx)(x1.default, { titleId: L, results: p })
                  : (0, e.jsx)(a1.t, {
                      size: "medium",
                      position: "center",
        ...
        function V(C) {
          const { id: o, category: c, appName: p, descriptionToken: L } = C;
          if (c == b.YX)
            return (0, e.jsx)("div", {
              id: o,
          ...
          const U = (0, e.jsx)("span", {
              className: S,
              children: m.Z.Localize(v1(c)),
            }),
            X = (0, e.jsx)("span", {
              className: y().CompatibilityDetailRatingSummary,
              children: m.Z.Localize(L || H),
            }),
            s1 = p
              ? m.Z.LocalizeReact(
              ...
              : m.Z.LocalizeReact("#SteamDeckVerified_DescriptionHeader", U, X);
          return (0, e.jsx)("div", {
            id: o,
            className: y().CompatibilityDetailRatingSummary,
            children: s1,
      ...
      51409: (Q, z, s) => {
        ...
        s.r(z),
          s.d(z, {
            ...
            SteamFrameCompatibilityTabContent: () => F1,
            SteamMachineCompatibilityTabContent: () => E1,
        ...
        var i1 = s(90626),
          ...
          q = (i, t, r, a) => {
            for (
              var h = a > 1 ? void 0 : a ? f1(t, r) : t, Z = i.length - 1, F;
              Z >= 0;
              Z--
            )
              (F = i[Z]) && (h = (a ? F(t, r, h) : F(h)) || h);
            return a && h && K(t, r, h), h;
          },
          g = ((i) => (
            (i[(i.A = 0)] = "A"),
            (i[(i.B = 1)] = "B"),
        ...
        function x1(i) {
          switch (i) {
            ...
            case v.pR.DIR_DOWN:
              return 7;
            case v.pR.STEAM_GUIDE:
              return 8;
            case v.pR.STEAM_QUICK_MENU:
              return 9;
            case v.pR.SELECT:
              return 10;
            case v.pR.START:
            ...
            case v.pR.TRIGGER_RIGHT:
              return 15;
            case v.pR.REAR_LEFT_UPPER:
              return 24;
            case v.pR.REAR_LEFT_LOWER:
              return 25;
            case v.pR.REAR_RIGHT_UPPER:
              return 26;
            case v.pR.REAR_RIGHT_LOWER:
              return 27;
            default:
              return 0;
          }
        ...
        const a1 = class _1 {
          ...
          static Log = new E.wd("ActionDescription").Debug;
          ...
          BFromActiveNavTree(t, r) {
            let a = r?.Tree;
            return (
              a || (a = t?.Tree), a && a.Controller.IsActiveFocusNavTree(a)
            );
          }
          OnFocusNavigationChanged(t, r, a) {
            this.BFromActiveNavTree(r, a) && this.UpdateForFocusedNode(a);
          }
          ...
          UpdateForFocusedNode(t) {
            if (
              ...
              r();
              for (let a = t; a != null; a = a.Parent)
                this.m_actionDescriptionChangedCallbackRegistrations.push(
                  a.ActionDescriptionChangedCallbackList.Register(() => r()),
                );
            } else this.SetActionDescriptionsFromMap({ [v.pR.OK]: null });
          }
          GetActionDescription(t) {
            ...
            return (
              ...
              _1.Log("GetActionDescription", r),
              r
            );
          }
          GetActionDescriptions() {
            const t = Object.values(g).filter((a) => typeof a == "number"),
              r = {};
            for (const a of t) r[a] = this.GetActionDescription(a);
            return r;
          }
          Notify() {
          ...
          SetDefaultActionsFromMap(t) {
            ...
            for (const a in t) {
              const h = parseInt(a);
              this.SetDefaultAction(h, t[h]) && (r = !0);
            }
            r && this.Notify();
          }
          ClearActions() {
            _1.Log("ClearActionDescriptions"),
              this.m_boundActions.clear(),
              this.Notify();
          }
          SetActionsFromMap(t) {
            let r = !1;
            const a = Array.from(this.m_boundActions.keys());
            for (let h of a)
              t[h] === void 0 && this.SetAction(h, void 0) && (r = !0);
            for (let h in t) {
              const Z = parseInt(h);
              this.SetAction(Z, t[Z]) && (r = !0);
            }
            r && this.Notify();
          }
          ...
          SetAction(t, r) {
            if ((_1.Log("SetActionDescription", t, r), r === void 0)) {
              if (!this.m_boundActions.has(t)) return !1;
              this.m_boundActions.delete(t);
            } else {
              if ((0, j.SI)(this.m_boundActions.get(t), r)) return !1;
          ...
          SubscribeToActions(t) {
            return (
              ...
              () => {
                const a = this.m_globalActionsSubscriptions?.indexOf(t);
                this.m_globalActionsSubscriptions && a != null && a >= 0
                  ? this.m_globalActionsSubscriptions.splice(a, 1)
                  : console.error(
        ...
        q([G.oI], a1.prototype, "OnFocusNavigationChanged", 1),
          q([G.oI], a1.prototype, "OnActiveNavTreeChanged", 1),
          q([G.oI], a1.prototype, "SetActionDescriptionsFromMap", 1);
        let r1 = null;
        var m = s(19563),
          W = s(35111),
          d = s.n(W),
        ...
        function w1(i) {
          const t = (0, H1.A)(
              i.size != null ? V(i.size) : V(1),
              i.type != null ? g1(i.type) : g1(1),
          ...
          switch (i.button) {
            case g.A:
              return (0, e.jsx)(S1, {
                bIsKnockout: r,
                className: t,
                "aria-label": (0, x.we)("#ControllerButton_A"),
              });
            case g.B:
              return (0, e.jsx)(v1, {
                bIsKnockout: r,
                className: t,
                "aria-label": (0, x.we)("#ControllerButton_B"),
              });
            case g.X:
              return (0, e.jsx)(u, {
                bIsKnockout: r,
                className: t,
                "aria-label": (0, x.we)("#ControllerButton_X"),
              });
            case g.Y:
              return (0, e.jsx)(C, {
                bIsKnockout: r,
                className: t,
                "aria-label": (0, x.we)("#ControllerButton_Y"),
              });
            case g.Left:
              return (0, e.jsx)(p, {
                bIsKnockout: r,
                className: t,
                "aria-label": (0, x.we)("#ControllerButton_DpadLeft"),
              });
            case g.Right:
              return (0, e.jsx)(L, {
                bIsKnockout: r,
                className: t,
                "aria-label": (0, x.we)("#ControllerButton_DpadRight"),
              });
            case g.Up:
              return (0, e.jsx)(o, {
                bIsKnockout: r,
                className: t,
                "aria-label": (0, x.we)("#ControllerButton_DpadUp"),
              });
            case g.Down:
              return (0, e.jsx)(c, {
                bIsKnockout: r,
                className: t,
                "aria-label": (0, x.we)("#ControllerButton_DpadDown"),
              });
            case g.HomeMenu:
              return (0, e.jsx)(H, {
                bIsKnockout: r,
                className: t,
                "aria-label": (0, x.we)("#ControllerButton_Steam"),
              });
            case g.QuickMenu:
              return (0, e.jsx)(S, {
                bIsKnockout: r,
                className: t,
                "aria-label": (0, x.we)("#ControllerButton_QAM"),
              });
            case g.Select:
              return (0, e.jsx)(U, {
                bIsKnockout: r,
                className: t,
                "aria-label": (0, x.we)("#ControllerButton_View"),
              });
            case g.Start:
              return (0, e.jsx)(X, {
                bIsKnockout: r,
                className: t,
                "aria-label": (0, x.we)("#ControllerButton_Menu"),
              });
            case g.LeftBumper:
              return (0, e.jsx)(s1, {
                bIsKnockout: r,
                className: t,
                "aria-label": (0, x.we)("#ControllerButton_L1"),
              });
            case g.RightBumper:
              return (0, e.jsx)(P1, {
                bIsKnockout: r,
                className: t,
                "aria-label": (0, x.we)("#ControllerButton_R1"),
              });
            case g.LeftTrigger:
              return (0, e.jsx)(K1, {
                bIsKnockout: r,
                className: t,
                "aria-label": (0, x.we)("#ControllerButton_L2"),
              });
            case g.RightTrigger:
              return (0, e.jsx)(Y1, {
                bIsKnockout: r,
                className: t,
                "aria-label": (0, x.we)("#ControllerButton_R2"),
              });
            case g.LeftStick:
              return (0, e.jsx)($1, {
                bIsKnockout: r,
                className: t,
                "aria-label": (0, x.we)("#ControllerButton_LS"),
              });
            case g.RightStick:
              return (0, e.jsx)(Q1, {
                bIsKnockout: r,
                className: t,
                "aria-label": (0, x.we)("#ControllerButton_RS"),
              });
            case g.LeftStickClick:
              return (0, e.jsx)(X1, {
                bIsKnockout: r,
                className: t,
                "aria-label": (0, x.we)("#ControllerButton_L3"),
              });
            case g.RightStickClick:
              return (0, e.jsx)(J1, {
                bIsKnockout: r,
                className: t,
                "aria-label": (0, x.we)("#ControllerButton_R3"),
              });
            case g.LeftTrackpad:
              return (0, e.jsx)(i2, {
                bIsKnockout: r,
                className: t,
                "aria-label": (0, x.we)("#ControllerButton_LPad"),
              });
            case g.RightTrackpad:
              return (0, e.jsx)(l2, {
                bIsKnockout: r,
                className: t,
                "aria-label": (0, x.we)("#ControllerButton_RPad"),
              });
            case g.LeftTrackpadClick:
              return (0, e.jsx)(r2, {
                bIsKnockout: r,
                className: t,
                "aria-label": (0, x.we)("#ControllerButton_LPad_Click"),
              });
            case g.RightTrackpadClick:
              return (0, e.jsx)(a2, {
                bIsKnockout: r,
                className: t,
                "aria-label": (0, x.we)("#ControllerButton_RPad_Click"),
              });
            case g.RearLeftUpper:
              return (0, e.jsx)(G1, {
                bIsKnockout: r,
                className: t,
                "aria-label": (0, x.we)("#ControllerButton_L4"),
              });
            case g.RearRightUpper:
              return (0, e.jsx)(e2, {
                bIsKnockout: r,
                className: t,
                "aria-label": (0, x.we)("#ControllerButton_R4"),
              });
            case g.RearLeftLower:
              return (0, e.jsx)(q1, {
                bIsKnockout: r,
                className: t,
                "aria-label": (0, x.we)("#ControllerButton_L5"),
              });
            case g.RearRightLower:
              return (0, e.jsx)(t2, {
                bIsKnockout: r,
                className: t,
                "aria-label": (0, x.we)("#ControllerButton_R5"),
              });
            default:
              return (0, e.jsx)(s2, {
                bIsKnockout: r,
                className: t,
                "aria-label": (0, x.we)("#ControllerButton_Default"),
              });
          }
        }
        function S1({ bIsKnockout: i, ...t }) {
          return i
            ? (0, e.jsx)("svg", {
        ...
        var o1 = s(36118),
          ...
          n1 = s.n(h1),
          w = s(75245);
        class _ extends h1.Message {
          static ImplementsStaticInterface() {}
          constructor(t = null) {
            super(),
              _.prototype.appid || w.Sg(_.M()),
              h1.Message.initialize(this, t, 0, -1, void 0, null);
          }
          static sm_m;
          static sm_mbf;
          static M() {
          ...
          static MBF() {
            return _.sm_mbf || (_.sm_mbf = w.w0(_.M())), _.sm_mbf;
          }
          toObject(t = !1) {
          ...
          static deserializeBinary(t) {
            let r = new (n1().BinaryReader)(t),
              a = new _();
            return _.deserializeBinaryFromReader(a, r);
          }
          static deserializeBinaryFromReader(t, r) {
            return w.zj(_.MBF(), t, r);
          }
          serializeBinary() {
            var t = new (n1().BinaryWriter)();
        ...
        class N extends h1.Message {
          static ImplementsStaticInterface() {}
          constructor(t = null) {
            super(),
              N.prototype.frame_rates || w.Sg(N.M()),
              h1.Message.initialize(this, t, 0, -1, [1], null);
          }
          static sm_m;
          static sm_mbf;
          static M() {
          ...
          static deserializeBinary(t) {
            let r = new (n1().BinaryReader)(t),
              a = new N();
            return N.deserializeBinaryFromReader(a, r);
          }
          static deserializeBinaryFromReader(t, r) {
            return w.zj(N.MBF(), t, r);
          }
          serializeBinary() {
            var t = new (n1().BinaryWriter)();
        ...
        class R extends h1.Message {
          static ImplementsStaticInterface() {}
          constructor(t = null) {
            super(),
              R.prototype.clusterid || w.Sg(R.M()),
              h1.Message.initialize(this, t, 0, -1, void 0, null);
          }
          static sm_m;
          static sm_mbf;
          ...
          static deserializeBinary(t) {
            let r = new (n1().BinaryReader)(t),
              a = new R();
            return R.deserializeBinaryFromReader(a, r);
          }
          static deserializeBinaryFromReader(t, r) {
            return w.zj(R.MBF(), t, r);
          }
          serializeBinary() {
            var t = new (n1().BinaryWriter)();
        ...
        function u2(i) {
          ...
          return useQuery({
            ...
            queryFn: async () => {
              ...
              r.Body().set_appid(i);
              const a = await GamePerformanceStatsService.GetGameFrameRateStats(
                t,
                r,
              );
              return a.BSuccess() ? a.Body().toObject() : null;
            },
          });
        }
        var J = s(26356);
        function c2(i) {
          ...
          if (
            (t.steam_deck_blog_url &&
              ((j1.onOptionsActionDescription = M.Z.Localize(
                "#SteamDeckVerified_ViewDeveloperPost",
              )),
              (j1.onOptionsButton = n),
              (L1 = (0, e.jsx)(U1, {
                blogURL: t.steam_deck_blog_url,
                eHWCompatibiltyDisplay: J.ZJ,
              })),
              (c1 = (0, e.jsx)(U1, {
                blogURL: t.steam_deck_blog_url,
                eHWCompatibiltyDisplay: J.c9,
              }))),
            ...
            return (
              ...
              (0, e.jsxs)(f.Z, {
                ...
                focusableIfEmpty: F,
                noFocusRing: !0,
                className: d().CompatibilityDetailsContainer,
                ...j1,
                children: [
                  (0, e.jsxs)("div", {
                    id: r,
          ...
          const z1 = (0, O.z5)(t.resolved_category),
            R1 = (0, O._R)(t.steamos_resolved_category),
            C2 = (0, O.z5)(t.machine_resolved_category),
            d2 = (0, O.z5)(t.frame_resolved_category || b.YX),
            k1 = (y1) =>
            ...
            W1 = [
              {
                name: (0, e.jsxs)("div", {
                  className: d().pillContent,
                  children: [
                    (0, e.jsx)(o1.lRD, { className: d().SteamDeckDeviceIcon }),
                    (0, e.jsx)(z1, { className: d().RatingIcon }),
                  ],
                }),
                key: J.ZJ.toString(),
                contents: (0, e.jsx)(V1.tH, {
                  children: (0, e.jsx)(O1, { ...i, deckBlogContent: L1 }),
                }),
                onClick: k1,
              },
              {
                name: (0, e.jsxs)("div", {
                  ...
                  children: [
                    (0, e.jsx)(o1.fhy, {
                      className: d().SteamMachineDeviceIcon,
                    }),
                    (0, e.jsx)(C2, { className: d().RatingIcon }),
                  ],
                }),
                key: J.JR.toString(),
                contents: (0, e.jsx)(V1.tH, {
              ...
              },
              {
                name: (0, e.jsxs)("div", {
                  ...
                  children: [
                    "steamos",
                    (0, e.jsx)(R1, { className: d().RatingIcon }),
                  ],
                }),
                key: J.c9.toString(),
                contents: (0, e.jsx)(V1.tH, {
                  children: (0, e.jsx)(T1, { ...i, deckBlogContent: c1 }),
                }),
                onClick: k1,
              },
            ];
          return (
            A == J.bY &&
              W1.push({
                name: (0, e.jsxs)("div", {
                  className: d().pillContent,
                  children: [
                    (0, e.jsx)(o1.Ves, { className: d().SteamFrameDeviceIcon }),
                    (0, e.jsx)(d2, { className: d().RatingIcon }),
                  ],
                }),
                key: J.bY.toString(),
                contents: (0, e.jsx)(V1.tH, {
            ...
            (0, e.jsx)(o2.V, {
              tabs: W1,
              classNameCtn: d().CompatibilityTabs,
              classNameTabContent: d().CompatibilityTabContent,
              startingTab: A.toString(),
              preferredFocus: !0,
            })
          );
        }
        function M1(i) {
          const {
            ...
            [n, j1] = i1.useState(!1),
            L1 = i1.useCallback(() => n, [n]),
            c1 = i1.useRef(null),
            z1 = (0, I1.Qn)();
          let R1 = h ?? {};
          return (
            i1.useEffect(() => {
              c1?.current?.scrollHeight !== void 0 &&
                c1?.current?.clientHeight !== void 0 &&
                j1(c1?.current?.scrollHeight > c1?.current?.clientHeight);
            }, []),
            (0, e.jsxs)(f.Z, {
              className: d().CompatibilityDetailsContainer,
              ...R1,
              children: [
                ...
                (0, e.jsx)(D.Qg, {
                  ref: c1,
                  className: L1()
                    ? d().CompatibilityDetailsInterior_Scroll
                    : d().CompatibilityDetailsInterior_NoScroll,
                  children: (0, e.jsx)(f.Z, {
                    autoFocus: a,
                    focusableIfEmpty: a || L1(),
                    noFocusRing: !0,
                    children: A,
                  }),
                }),
        ...
        function T1(i) {
          const { titleId: t, descriptionId: r, results: a, appName: h } = i,
            Z =
              a.steamos_resolved_items &&
              a.steamos_resolved_items?.findIndex(
                (n) => n.display_type == B,
              ) !== -1,
            F = (0, e.jsx)(m.cP, {
              id: r,
              category: a.steamos_resolved_category ?? t1.xs,
              appName: h,
            }),
            e1 = (0, e.jsx)(m.aw, {
              category: a.steamos_resolved_category ?? t1.xs,
            ...
            A =
              a.steamos_resolved_items && a.steamos_resolved_items?.length > 0;
          return (0, e.jsx)(M1, {
            titleId: t,
            title: M.Z.Localize(
              "#SteamOSCompatibility_Store_CompatSectionHeader_GamepadUI",
            ...
            children: (0, e.jsxs)(e.Fragment, {
              children: [
                A &&
                  (0, e.jsx)("div", {
                    className: d().CompatibilityDetailsSeparator,
                  }),
                a.steamos_resolved_items &&
                  a.steamos_resolved_items
                    .filter((n) => n.display_type != B)
                    .map((n) =>
                      (0, e.jsxs)(
                        "div",
                        {
                          className: d().CompatibilityDetailsRow,
                          children: [
                            (0, e.jsx)(A1, { displaytype: n.display_type }),
                            (0, e.jsx)("span", {
                              children: M.Z.Localize(n.loc_token),
                            }),
                          ],
                        },
                ...
                Z &&
                  (0, e.jsx)("div", {
                    className: d().CompatibilityNotes,
        ...
        function O1(i) {
          const { titleId: t, descriptionId: r, results: a, appName: h } = i,
            Z = a.resolved_items?.findIndex((n) => n.display_type == I) !== -1,
            F = (0, e.jsx)(m.UN, {
              id: r,
              category: a.resolved_category,
              appName: h,
            }),
            e1 = (0, e.jsx)(m.Ez, { category: a.resolved_category }),
            A = a.resolved_items && a.resolved_items?.length > 0;
          return (0, e.jsx)(M1, {
            titleId: t,
            title: M.Z.Localize(
              "#SteamDeckVerified_Store_CompatSectionHeader_GamepadUI",
                    ...
                    .map((n) =>
                      (0, e.jsxs)(
                        "div",
                        {
                          className: d().CompatibilityDetailsRow,
                          children: [
                            (0, e.jsx)(N1, { displaytype: n.display_type }),
                            (0, e.jsx)("span", {
                              children:
                                n.loc_token.charAt(0) != "#"
                                  ? M.Z.Localize("#" + n.loc_token)
                                  : M.Z.Localize(n.loc_token),
                            }),
                          ],
                        },
                    ...
                    children: a.resolved_items
                      ...
                      .map((n) =>
                        (0, e.jsx)(
                          "div",
                          {
                            className: d().CompatibilityDetailsNoteRow,
                            children: (0, e.jsx)("span", {
                              children: M.Z.Localize(n.loc_token),
                            }),
                          },
        ...
        function E1(i) {
          const { titleId: t, descriptionId: r, results: a, appName: h } = i,
            Z =
              a.machine_resolved_items?.findIndex(
                (n) => n.display_type == I,
              ) !== -1,
            F = (0, e.jsx)(m.Nt, {
              id: r,
            ...
            e1 = (0, e.jsx)(m.Ez, { category: a.machine_resolved_category }),
            A =
              a.machine_resolved_items && a.machine_resolved_items?.length > 0;
          return (0, e.jsx)(M1, {
            titleId: t,
            title: M.Z.Localize(
              "#SteamMachineCompatibility_Store_CompatSectionHeader_GamepadUI",
        ...
        function F1(i) {
          const { titleId: t, descriptionId: r, results: a, appName: h } = i,
            Z =
              a.frame_resolved_items?.findIndex((n) => n.display_type == I) !==
              -1,
            F = (0, e.jsx)(m.Pu, {
              id: r,
              category: a.frame_resolved_category ?? b.YX,
              appName: h,
            }),
            e1 = (0, e.jsx)(m.Ez, {
              category: a.frame_resolved_category ?? b.YX,
            }),
            A = a.frame_resolved_items && a.frame_resolved_items?.length > 0;
          return (0, e.jsx)(M1, {
            titleId: t,
            title: M.Z.Localize(
              "#SteamFrameCompatibility_Store_CompatSectionHeader_GamepadUI",
        ...
        function U1(i) {
          ...
          if (a) {
            const Z =
              r == J.c9
                ? M.Z.Localize("#SteamOS_DescriptionHeader_DeveloperBlog")
                : M.Z.Localize(
            ...
            return (0, e.jsxs)("div", {
              ...
              children: [
                Z,
                (0, e.jsx)("div", {
                  className: d().DeveloperBlogYButton,
                  children: (0, e.jsx)(w1, { button: g.Y, type: d1.Knockout }),
                }),
              ],
            });
          }
          const h =
            r == J.c9
              ? M.Z.Localize("#SteamOS_DescriptionHeader_DeveloperBlog_Desktop")
              : M.Z.Localize(
          ...
          return (0, e.jsxs)("div", {
            ...
            children: [
              ...
              (0, e.jsx)("a", {
                href: t,
                className: d().DeveloperBlockLinkDesktop,
                children: M.Z.Localize("#SteamDeckVerified_ViewDeveloperPost"),
              }),
            ],
          });
        }
        function N1(i) {
          ...
          switch (t) {
            case p1:
              return (0, e.jsx)(o1.o5Q, {
                className: d().CompatibilityDetailsResultIcon,
              });
            case m1:
              return (0, e.jsx)(o1.aVR, {
                className: d().CompatibilityDetailsResultIcon,
              });
            case l1:
              return (0, e.jsx)(o1.jIP, {
                className: d().CompatibilityDetailsResultIcon,
              });
            case $:
              return (0, e.jsx)(o1.WX$, {
                className: d().CompatibilityDetailsResultIcon,
              });
            case I:
              return null;
        ...
        function A1(i) {
          ...
          switch (t) {
            case C1:
              return (0, e.jsx)(o1.ZjT, {
                className: d().CompatibilityDetailsResultIcon,
              });
            case B:
              return (0, e.jsx)(o1.bcZ, {
                className: d().CompatibilityDetailsResultIcon,
              });
            default:
              return null;
      ...
      21418: (Q, z, s) => {
        ...
        function m1(O) {
          ...
          (0, f.useEffect)(() => {
            if (!O.bDisableRouting && r1) {
              const V = (0, T.f3)(r1, "tab");
              V && d(V);
            }
          }, [r1, r1.key, O.bDisableRouting, d]);
          const y = f.useCallback(
              (V) => {
                d(V.key),
                  v || (0, T.Bm)(m, "tab", V.key),
                  G?.(V.key),
                  V.onClick && V.onClick(V);
              },
              [v, m, G],
            ),
            l = j.filter((V) => !V.hidden);
          if (!l.length) return null;
          const H1 = E ?? W,
            x = l.find((V) => V.key === H1) || l[0],
            d1 = g ? (P ?? l[0].key) : void 0,
            u1 = (0, e.jsxs)(e.Fragment, {
              children: [
                (0, e.jsx)($.Z, {
                  className: (0, D.A)(
                    k().GraphicalAssetsTabs,
                    Y && k().GraphicalAssetsTabsVertical,
                    a1 && k().ChecklistMode,
                    x1 && k().Sticky,
                    K,
                  ),
                  navEntryPreferPosition: g ? I.iU.PREFERRED_CHILD : I.iU.FIRST,
                  children: l.map((V, g1) =>
                    (0, e.jsx)(
                      i1,
                      {
                        ...
                        classNameTab: f1,
                        active: V.key === x.key,
                        preferredFocus: d1 === V.key,
                      },
                      V.key,
                    ),
                  ),
                }),
                x && (0, e.jsx)($.Z, { className: q, children: x.contents }),
              ],
            });
          return Y
            ? (0, e.jsx)($.Z, {
                className: (0, D.A)(k().GraphicalAssetsTabsLayoutVertical),
                children: u1,
              })
            : u1;
        }
            ...
            j === "success"
              ...
              : j === "danger"
                ...
                : j === "caution"
                  ...
                  : j === "info"
                    ? (E = k().StatusInfo)
                    : j === "incomplete" && (E = k().StatusIncomplete),
            (0, e.jsx)("div", {
              className: (0, D.A)(
                k().GraphicalAssetStatus,
                E,
                v ? k().checklistBox : "",
              ),
              children: P,
        ...
        function i1(O) {
          ...
          return (0, e.jsx)(t1.e7, {
            condition: !!(j.statusToolTip || j.tooltip),
            wrap: (K) =>
              (0, e.jsx)(C1.he, {
                toolTipContent: j.statusToolTip || j.tooltip,
                children: K,
              }),
            children: (0, e.jsxs)($.Z, {
              className: (0, D.A)(
                k().GraphicalAssetsTab,
                E && k().Active,
                E && "ActiveTab",
                P,
              ),
              ...
              children: [
                !!j.vo_warning &&
                  (0, e.jsx)(C1.he, {
                    toolTipContent: j.vo_warning,
                    children: (0, e.jsx)("div", {
                      className: k().VOWarning,
                      children: (0, b.we)("#EventEditor_VOWarning"),
                    }),
                  }),
                j.status,
                j.name,
