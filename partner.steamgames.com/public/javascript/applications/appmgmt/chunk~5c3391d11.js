  ...
  [1917],
  {
    ...
    91822: (e, t, r) => {
      ...
      const c = a.createContext({
        ...
        C = () => a.useContext(c);
      function m() {
        const { bForceShowCompatInfo: e, bSteamDeck: t, bSteamOS: r } = C();
        return r && !t ? [!0, 2] : r || e || i.TS.ON_DECK ? [!0, 1] : [!1, 0];
      }
      function u(e) {
      ...
      const p = (e) => {
          ...
          return a.createElement(
            "div",
            { className: (0, l.A)(o.SteamDeckCompatInfo, r) },
            a.createElement(n.lRD, null),
            a.createElement(i, { className: o.SteamDeckCompatIcon }),
          );
        },
    ...
    35067: (e, t, r) => {
      ...
      class p {
        ...
        static Log = new C.wd("ActionDescription").Debug;
        InitContext(e) {
        ...
        SetAction(e, t) {
          if ((p.Log("SetActionDescription", e, t), void 0 === t)) {
      ...
      (0, s.Cg)([m.oI], p.prototype, "OnFocusNavigationChanged", null),
        (0, s.Cg)([m.oI], p.prototype, "SetActionDescriptionsFromMap", null);
      var d,
        g,
        f = r(54906),
        w = r(35111),
      ...
      function V(e) {
        const t = (0, v.A)(
            null != e.size ? L(e.size) : L(g.Medium),
            null != e.type ? b(e.type) : b(d.Light),
        ...
        switch (e.button) {
          case a.A:
            return o.createElement(y, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, _.we)("#ControllerButton_A"),
            });
          case a.B:
            return o.createElement(k, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, _.we)("#ControllerButton_B"),
            });
          case a.X:
            return o.createElement(M, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, _.we)("#ControllerButton_X"),
            });
          case a.Y:
            return o.createElement(R, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, _.we)("#ControllerButton_Y"),
            });
          case a.Left:
            return o.createElement(S, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, _.we)("#ControllerButton_DpadLeft"),
            });
          case a.Right:
            return o.createElement(Z, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, _.we)("#ControllerButton_DpadRight"),
            });
          case a.Up:
            return o.createElement(N, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, _.we)("#ControllerButton_DpadUp"),
            });
          case a.Down:
            return o.createElement(B, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, _.we)("#ControllerButton_DpadDown"),
            });
          case a.HomeMenu:
            return o.createElement(D, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, _.we)("#ControllerButton_Steam"),
            });
          case a.QuickMenu:
            return o.createElement(x, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, _.we)("#ControllerButton_QAM"),
            });
          case a.Select:
            return o.createElement(I, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, _.we)("#ControllerButton_View"),
            });
          case a.Start:
            return o.createElement(A, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, _.we)("#ControllerButton_Menu"),
            });
          case a.LeftBumper:
            return o.createElement(T, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, _.we)("#ControllerButton_L1"),
            });
          case a.RightBumper:
            return o.createElement(F, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, _.we)("#ControllerButton_R1"),
            });
          case a.LeftTrigger:
            return o.createElement(K, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, _.we)("#ControllerButton_L2"),
            });
          case a.RightTrigger:
            return o.createElement(U, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, _.we)("#ControllerButton_R2"),
            });
          case a.LeftStick:
            return o.createElement(z, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, _.we)("#ControllerButton_LS"),
            });
          case a.RightStick:
            return o.createElement(O, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, _.we)("#ControllerButton_RS"),
            });
          case a.LeftStickClick:
            return o.createElement(P, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, _.we)("#ControllerButton_L3"),
            });
          case a.RightStickClick:
            return o.createElement(G, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, _.we)("#ControllerButton_R3"),
            });
          case a.LeftTrackpad:
            return o.createElement(J, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, _.we)("#ControllerButton_LPad"),
            });
          case a.RightTrackpad:
            return o.createElement(Y, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, _.we)("#ControllerButton_RPad"),
            });
          case a.LeftTrackpadClick:
            return o.createElement(Q, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, _.we)("#ControllerButton_LPad_Click"),
            });
          case a.RightTrackpadClick:
            return o.createElement($, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, _.we)("#ControllerButton_RPad_Click"),
            });
          case a.RearLeftUpper:
            return o.createElement(W, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, _.we)("#ControllerButton_L4"),
            });
          case a.RearRightUpper:
            return o.createElement(X, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, _.we)("#ControllerButton_R4"),
            });
          case a.RearLeftLower:
            return o.createElement(j, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, _.we)("#ControllerButton_L5"),
            });
          case a.RearRightLower:
            return o.createElement(q, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, _.we)("#ControllerButton_R5"),
            });
          default:
            return o.createElement(ee, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, _.we)("#ControllerButton_Default"),
            });
        }
      }
      ...
      class Ce extends ie.Message {
        ...
        static MBF() {
          return Ce.sm_mbf || (Ce.sm_mbf = ce.w0(Ce.M())), Ce.sm_mbf;
        }
        toObject(e = !1) {
          return Ce.toObject(e, this);
        }
        static toObject(e, t) {
          return ce.BT(Ce.M(), e, t);
        }
        static fromObject(e) {
          return ce.Uq(Ce.M(), e);
        }
      ...
      class me extends ie.Message {
        ...
        constructor(e = null) {
          super(),
            me.prototype.frame_rates || ce.Sg(me.M()),
        ...
        static M() {
          return (
            me.sm_m ||
              (me.sm_m = {
                proto: me,
                fields: { frame_rates: { n: 1, c: ue, r: !0, q: !0 } },
              }),
            me.sm_m
          );
        }
      ...
      class ue extends ie.Message {
        ...
        constructor(e = null) {
          super(),
            ue.prototype.clusterid || ce.Sg(ue.M()),
            ie.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      function pe(e) {
        ...
        if (!t.resolved_items?.length) {
          const e = h
            ...
            i = h
              ? o.createElement(f.cP, {
                  id: a,
                  category: t.steamos_resolved_category,
                  appName: n,
                })
              : o.createElement(f.UN, {
          ...
          return o.createElement(
            ...
            o.createElement(
              ...
              o.createElement(
                "div",
                { id: r, className: H().DialogHeader },
                o.createElement("div", { className: H().DialogTitle }, e),
                o.createElement(
                  "div",
                  { className: H().AppTitleCategory },
                  o.createElement(f.Ez, { category: t.resolved_category }),
                ),
              ),
              i,
              !1,
        ...
        if (h || u) {
          const r = (0, i.z5)(t.resolved_category),
            a = (0, i._R)(t.steamos_resolved_category),
            l = (e) =>
            ...
            n = [
              {
                name: o.createElement(
                  "div",
                  { className: H().pillContent },
                  "Steam Deck",
                ...
                contents: o.createElement(
                  le.tH,
                  null,
                  o.createElement(fe, { ...e, deckBlogContent: g }),
                ),
                onClick: l,
              },
              {
                ...
                contents: o.createElement(
                  le.tH,
                  null,
                  o.createElement(ge, { ...e, deckBlogContent: w }),
                ),
                onClick: l,
              },
            ];
          return o.createElement(ne.V, {
            tabs: n,
            classNameCtn: H().CompatibilityTabs,
            startingTab: h ? "steamos" : "steamdeck",
          });
        }
        return o.createElement(fe, { ...e, deckBlogContent: g });
      }
      function de(e) {
        const {
            titleId: t,
        ...
        return (
          ...
          o.createElement(
            ...
            o.createElement(
              ...
              o.createElement(
                "div",
                { id: t, className: H().DialogHeader },
                o.createElement("div", { className: H().DialogTitle }, r),
                o.createElement("div", { className: H().AppTitleCategory }, s),
              ),
              c,
            ),
            C,
            o.createElement(
              ...
              o.createElement(
                l.Z,
                { autoFocus: a, focusableIfEmpty: a || d(), noFocusRing: !0 },
                m,
              ),
            ),
          )
      ...
      function ge(e) {
        const { titleId: t, descriptionId: r, results: a, appName: l } = e,
          n =
            a.steamos_resolved_items &&
            -1 !==
              a.steamos_resolved_items?.findIndex((e) => 1 == e.display_type),
          i = o.createElement(f.cP, {
            id: r,
            category: a.steamos_resolved_category ?? 0,
            appName: l,
          }),
          s = o.createElement(f.aw, {
            category: a.steamos_resolved_category ?? 0,
          }),
          c = a.steamos_resolved_items && a.steamos_resolved_items?.length > 0;
        return o.createElement(
          de,
          {
            titleId: t,
              ...
              a.steamos_resolved_items
                ...
                .map((e) =>
                  o.createElement(
                    ...
                    o.createElement(he, { displaytype: e.display_type }),
                    o.createElement("span", null, (0, _.we)(e.loc_token)),
                  ),
                ),
            n &&
              o.createElement(
      ...
      function fe(e) {
        const { titleId: t, descriptionId: r, results: a, appName: l } = e,
          n = -1 !== a.resolved_items?.findIndex((e) => 1 == e.display_type),
          i = o.createElement(f.UN, {
            id: r,
            category: a.resolved_category,
            appName: l,
          }),
          s = o.createElement(f.Ez, { category: a.resolved_category }),
        ...
        if (l) {
          ...
          return o.createElement(
            ...
            o.createElement(
              ...
              o.createElement(V, { button: a.Y, type: d.Knockout }),
            ),
          );
        }
        const n =
      ...
      function He(e) {
        ...
        switch (t) {
          case 4:
            return o.createElement(re.o5Q, {
              className: H().CompatibilityDetailsResultIcon,
            });
          case 3:
            return o.createElement(re.aVR, {
              className: H().CompatibilityDetailsResultIcon,
            });
          case 2:
            return o.createElement(re.jIP, {
              className: H().CompatibilityDetailsResultIcon,
            });
          case 0:
            return o.createElement(re.WX$, {
              className: H().CompatibilityDetailsResultIcon,
            });
          case 1:
            return (
      ...
      function he(e) {
        ...
        switch (t) {
          case 3:
            return o.createElement(re.ZjT, {
              className: H().CompatibilityDetailsResultIcon,
            });
          case 1:
            return o.createElement(re.bcZ, {
              className: H().CompatibilityDetailsResultIcon,
            });
          default:
            return null;
        ...
        render() {
          ...
          return l.createElement(
            ...
            l.createElement(
              d.Z,
              null,
              t && l.createElement(d.Z, null, t.contents),
            ),
          );
        }
      }
      function w(e) {
        ...
        return (
          "success" === t
            ...
            : "danger" === t
              ? (a = m().StatusDanger)
              : "caution" === t && (a = m().StatusCaution),
          l.createElement(
            "div",
            { className: (0, i.A)(m().GraphicalAssetStatus, a) },
            r,
          )
        );
      }
