  ...
  [1917],
  {
    ...
    91822: (e, t, r) => {
      ...
      const C = l.createContext({
        ...
        u = () => l.useContext(C);
      function d() {
        const { bForceShowCompatInfo: e, bSteamDeck: t, bSteamOS: r } = u();
        return r && !t ? [!0, 2] : r || e || a.TS.ON_DECK ? [!0, 1] : [!1, 0];
      }
      function p(e) {
        ...
        return l
          ? (0, s.jsx)(m, {
              category: l?.steam_deck_compat_category,
              className: r,
            })
          : null;
      }
      const m = (e) => {
          ...
          const l = x(t);
          return (0, s.jsxs)("div", {
            className: (0, o.A)(n.SteamDeckCompatInfo, r),
            children: [
              (0, s.jsx)(i.lRD, {}),
              (0, s.jsx)(l, { className: n.SteamDeckCompatIcon }),
            ],
          });
        },
    ...
    54906: (e, t, r) => {
      ...
      class x {
        ...
        async InternalLoadAppCompatability(e) {
          ...
          try {
            ...
            const l = await d().get(s, { params: r, withCredentials: !0 });
          ...
          return (
            x.s_Singleton ||
              ...
              ("dev" != h.TS.WEB_UNIVERSE && "beta" != h.TS.WEB_UNIVERSE) ||
                (window.g_DeckVerifiedDetailStores = x.s_Singleton)),
            x.s_Singleton
          );
        }
        constructor() {
          if (document.getElementById("application_config")) {
            ...
            x.ValidateCompatabilityResult(e) &&
      ...
      (0, C.Cg)([g.oI], x.prototype, "LoadAppCompabitilityResult", null);
      var f = r(16676),
        w = r(9154),
        H = r(12155),
        _ = r(35067),
      ...
      function k(e) {
        const { id: t } = e,
          ...
          { data: o } = (0, n.qI)(t),
          [a, C, u] = (0, i.uD)();
        if (!r || !o || 0 !== r.item_type) return null;
        const d = o.steam_deck_compat_category || 0;
        return (0, s.jsxs)("div", {
          className: (0, b.A)(y().LearnMoreCtn, "LearnMoreCtn"),
          children: [
            (0, s.jsx)(c.$o, { category: d }),
            (0, s.jsx)(l.Ii, {
              onClick: C,
            ...
            (0, s.jsx)(w.EN, {
              active: a,
              children: (0, s.jsx)(M, { nAppID: r.appid, closeModal: u }),
            }),
          ],
        });
      }
      function M(e) {
        const { nAppID: t, closeModal: r } = e,
          l = (function (e) {
            const [t, r] = a.useState(x.Get().GetCompatabilityResultForApp(e));
            return (
              (0, g.hL)(x.Get().GetCallbackForAppList(e), r),
              a.useEffect(() => {
                x.Get().BHasCompatabilityResultForApp(e) ||
                  x
                    .Get()
                    .LoadAppCompabitilityResult(e)
                    .then(() => r(x.Get().GetCompatabilityResultForApp(e)));
              }, [e]),
              t
            );
          })(t),
        ...
        return (0, s.jsx)(w.eV, {
          ...
          children: (0, s.jsx)(f.nB, {
            children: (0, s.jsx)(o.Z, {
              ...
              children: l
                ? (0, s.jsx)(_.default, { titleId: i, results: l })
                : (0, s.jsx)(v.t, {
                    size: "medium",
                    position: "center",
      ...
      function R(e) {
        ...
        switch (t) {
          case 3:
            return (0, s.jsx)(H.o5Q, {
              className: y().CategoryIcon,
              role: "presentation",
            });
          case 2:
            return (0, s.jsx)(H.aVR, {
              className: y().CategoryIcon,
              role: "presentation",
            });
          case 1:
            return (0, s.jsx)(H.jIP, {
              className: y().CategoryIcon,
              role: "presentation",
            });
          case 0:
      ...
      function B(e) {
        const { id: t, category: r, appName: l, descriptionToken: o } = e;
        if (0 == r)
          return (0, s.jsx)("div", {
            id: t,
        ...
        const a = (0, s.jsx)("span", {
          ...
          C = l
            ...
            : (0, j.PP)("#SteamDeckVerified_DescriptionHeader", a, c);
        return (0, s.jsx)("div", {
          id: t,
          className: y().CompatibilityDetailRatingSummary,
          children: C,
      ...
      function S(e) {
        ...
        const a = (0, s.jsx)("span", {
          ...
          C = l
            ...
            : (0, j.PP)("#SteamOSCompatibility_DescriptionHeader", a, c);
        return (0, s.jsx)("div", {
          id: t,
          className: y().CompatibilityDetailRatingSummary,
          children: C,
    ...
    35067: (e, t, r) => {
      ...
      function p(e) {
        switch (e) {
          ...
          case C.pR.START:
            return s.Start;
          case C.pR.BUMPER_LEFT:
            return s.LeftBumper;
          case C.pR.BUMPER_RIGHT:
            return s.RightBumper;
          case C.pR.TRIGGER_LEFT:
            return s.LeftTrigger;
          case C.pR.TRIGGER_RIGHT:
            return s.RightTrigger;
          default:
            return s.A;
        }
      }
      ...
      class m {
        ...
        static Log = new u.wd("ActionDescription").Debug;
        InitContext(e) {
        ...
        OnFocusNavigationChanged(e, t, r) {
          if (this.BFromActiveNavTree(t, r))
            ...
            } else this.SetActionDescriptionsFromMap({ [C.pR.OK]: null });
        }
      ...
      (0, c.Cg)([d.oI], m.prototype, "OnFocusNavigationChanged", null),
        (0, c.Cg)([d.oI], m.prototype, "SetActionDescriptionsFromMap", null);
      var g,
        h,
        x = r(54906),
        f = r(35111),
      ...
      function V(e) {
        const t = (0, v.A)(
            null != e.size ? j(e.size) : j(h.Medium),
            null != e.type ? L(e.type) : L(g.Light),
        ...
        switch (e.button) {
          case s.A:
            return (0, l.jsx)(y, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, b.we)("#ControllerButton_A"),
            });
          case s.B:
            return (0, l.jsx)(k, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, b.we)("#ControllerButton_B"),
            });
          case s.X:
            return (0, l.jsx)(M, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, b.we)("#ControllerButton_X"),
            });
          case s.Y:
            return (0, l.jsx)(R, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, b.we)("#ControllerButton_Y"),
            });
          case s.Left:
            return (0, l.jsx)(S, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, b.we)("#ControllerButton_DpadLeft"),
            });
          case s.Right:
            return (0, l.jsx)(Z, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, b.we)("#ControllerButton_DpadRight"),
            });
          case s.Up:
            return (0, l.jsx)(N, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, b.we)("#ControllerButton_DpadUp"),
            });
          case s.Down:
            return (0, l.jsx)(B, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, b.we)("#ControllerButton_DpadDown"),
            });
          case s.HomeMenu:
            return (0, l.jsx)(D, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, b.we)("#ControllerButton_Steam"),
            });
          case s.QuickMenu:
            return (0, l.jsx)(I, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, b.we)("#ControllerButton_QAM"),
            });
          case s.Select:
            return (0, l.jsx)(A, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, b.we)("#ControllerButton_View"),
            });
          case s.Start:
            return (0, l.jsx)(F, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, b.we)("#ControllerButton_Menu"),
            });
          case s.LeftBumper:
            return (0, l.jsx)(T, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, b.we)("#ControllerButton_L1"),
            });
          case s.RightBumper:
            return (0, l.jsx)(K, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, b.we)("#ControllerButton_R1"),
            });
          case s.LeftTrigger:
            return (0, l.jsx)(U, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, b.we)("#ControllerButton_L2"),
            });
          case s.RightTrigger:
            return (0, l.jsx)(G, {
              bIsKnockout: r,
          ...
          case s.RightStick:
            return (0, l.jsx)(z, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, b.we)("#ControllerButton_RS"),
            });
          case s.LeftStickClick:
            return (0, l.jsx)(P, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, b.we)("#ControllerButton_L3"),
            });
          case s.RightStickClick:
            return (0, l.jsx)(E, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, b.we)("#ControllerButton_R3"),
            });
          case s.LeftTrackpad:
            return (0, l.jsx)(Y, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, b.we)("#ControllerButton_LPad"),
            });
          case s.RightTrackpad:
            return (0, l.jsx)($, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, b.we)("#ControllerButton_RPad"),
            });
          case s.LeftTrackpadClick:
            return (0, l.jsx)(J, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, b.we)("#ControllerButton_LPad_Click"),
            });
          case s.RightTrackpadClick:
            return (0, l.jsx)(ee, {
              bIsKnockout: r,
              className: t,
          ...
          case s.RearRightUpper:
            return (0, l.jsx)(q, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, b.we)("#ControllerButton_R4"),
            });
          case s.RearLeftLower:
            return (0, l.jsx)(X, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, b.we)("#ControllerButton_L5"),
            });
          case s.RearRightLower:
            return (0, l.jsx)(Q, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, b.we)("#ControllerButton_R5"),
            });
          default:
            return (0, l.jsx)(te, {
              bIsKnockout: r,
              className: t,
              "aria-label": (0, b.we)("#ControllerButton_Default"),
            });
        }
      }
      ...
      var re,
        ...
        ce = r.n(ae),
        Ce = r(89068);
      class ue extends ae.Message {
        static ImplementsStaticInterface() {}
        constructor(e = null) {
          super(),
            ue.prototype.appid || Ce.Sg(ue.M()),
            ae.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
        static M() {
          return (
            ue.sm_m ||
              (ue.sm_m = {
                proto: ue,
                fields: {
                  appid: { n: 1, br: Ce.qM.readUint32, bw: Ce.gp.writeUint32 },
                },
              }),
            ue.sm_m
          );
        ...
        static MBF() {
          return ue.sm_mbf || (ue.sm_mbf = Ce.w0(ue.M())), ue.sm_mbf;
        }
        toObject(e = !1) {
          return ue.toObject(e, this);
        }
        static toObject(e, t) {
          return Ce.BT(ue.M(), e, t);
        }
        static fromObject(e) {
          return Ce.Uq(ue.M(), e);
        }
      ...
      class de extends ae.Message {
        static ImplementsStaticInterface() {}
        constructor(e = null) {
          super(),
            de.prototype.frame_rates || Ce.Sg(de.M()),
            ae.Message.initialize(this, e, 0, -1, [1], null);
        }
        static sm_m;
        static sm_mbf;
        static M() {
          return (
            de.sm_m ||
              (de.sm_m = {
                proto: de,
                fields: { frame_rates: { n: 1, c: pe, r: !0, q: !0 } },
              }),
            de.sm_m
          );
        }
      ...
      class pe extends ae.Message {
        static ImplementsStaticInterface() {}
        constructor(e = null) {
          super(),
            pe.prototype.clusterid || Ce.Sg(pe.M()),
            ae.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
      ...
      function me(e) {
        ...
        let m = n ?? {},
          ...
          h = null;
        t.steam_deck_blog_url &&
          ((m.onOptionsActionDescription = (0, b.we)(
        ...
        if (!t.resolved_items?.length) {
          const e = f
            ...
            n = f
              ...
              : (0, l.jsx)(x.UN, { category: t.resolved_category, appName: i }),
            a = f ? h : g;
          return (0, l.jsxs)(o.Z, {
            autoFocus: c,
            focusableIfEmpty: c,
        ...
        if (f || d) {
          const r = (0, a.z5)(t.resolved_category),
            s = (0, a._R)(t.steamos_resolved_category),
            o = (e) =>
            ...
            i = [
              {
                name: (0, l.jsxs)("div", {
                  ...
                  children: ["Steam Deck", (0, l.jsx)(r, {})],
                }),
                key: "steamdeck",
                contents: (0, l.jsx)(oe.tH, {
                  children: (0, l.jsx)(xe, { ...e, deckBlogContent: g }),
                }),
                onClick: o,
              },
              {
                name: (0, l.jsxs)("div", {
                  className: w().pillContent,
                  children: ["SteamOS", (0, l.jsx)(s, {})],
                }),
                key: "steamos",
                contents: (0, l.jsx)(oe.tH, {
                  children: (0, l.jsx)(he, { ...e, deckBlogContent: h }),
                }),
                onClick: o,
              },
            ];
        ...
        return (0, l.jsx)(xe, { ...e, deckBlogContent: g });
      }
      function ge(e) {
        const {
            titleId: t,
      ...
      function he(e) {
        const { titleId: t, descriptionId: r, results: s, appName: o } = e,
          i =
          ...
          a = (0, l.jsx)(x.aw, { category: s.steamos_resolved_category ?? 0 }),
                  ...
                  .map((e) =>
                    (0, l.jsxs)(
                      "div",
                      {
                        ...
                        children: [
                          (0, l.jsx)(He, { displaytype: e.display_type }),
                          (0, l.jsx)("span", {
                            children: (0, b.we)(e.loc_token),
                          }),
                        ],
                      },
      ...
      function xe(e) {
        const { titleId: t, descriptionId: r, results: s, appName: o } = e,
          ...
          a = (0, l.jsx)(x.Ez, { category: s.resolved_category }),
                  ...
                  .map((e) =>
                    (0, l.jsxs)(
                      "div",
                      {
                        className: w().CompatibilityDetailsRow,
                        children: [
                          (0, l.jsx)(we, { displaytype: e.display_type }),
                          (0, l.jsx)("span", {
                            children: (0, b.we)(e.loc_token),
                          }),
                        ],
          ...
          return (0, l.jsxs)("div", {
            ...
            children: [
              ...
              (0, l.jsx)("div", {
                ...
                children: (0, l.jsx)(V, { button: s.Y, type: g.Knockout }),
              }),
            ],
          });
        }
        ...
        return (0, l.jsxs)("div", {
          ...
          children: [
            ...
            (0, l.jsx)("a", {
              ...
              children: (0, b.we)("#SteamDeckVerified_ViewDeveloperPost"),
            }),
          ],
        });
      }
      function we(e) {
        ...
        switch (t) {
          case 4:
            return (0, l.jsx)(se.o5Q, {
              className: w().CompatibilityDetailsResultIcon,
            });
          case 3:
            return (0, l.jsx)(se.aVR, {
              className: w().CompatibilityDetailsResultIcon,
            });
          case 2:
            return (0, l.jsx)(se.jIP, {
              className: w().CompatibilityDetailsResultIcon,
            });
          case 0:
            return (0, l.jsx)(se.WX$, {
              className: w().CompatibilityDetailsResultIcon,
            });
          case 1:
            return (
      ...
      function He(e) {
        ...
        switch (t) {
          case 3:
            return (0, l.jsx)(se.ZjT, {
              className: w().CompatibilityDetailsResultIcon,
            });
          case 1:
            return (0, l.jsx)(se.bcZ, {
              className: w().CompatibilityDetailsResultIcon,
            });
          default:
            return null;
