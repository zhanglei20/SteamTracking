  ...
  [4440],
  {
    ...
    49693: (e, t, n) => {
      ...
      function r(e, t, n = !1) {
        let a = "[" + e;
        t?.[""] && (a += `=${n ? "" + t[""] : s("" + t[""])}`);
        for (const e in t) "" !== e && (a += ` ${i(e)}=${s("" + t[e])}`);
        return (a += "]"), a;
      }
      function s(e) {
    ...
    8893: (e, t, n) => {
      ...
      function f(e) {
        const { id: t, bPreferLibrary: n, bPreferAssetWithoutOverride: o } = e,
          { storeItemDefaultInfo: m, storeItemAsset: f } = (0, s.q)(
            t,
            "vertical",
            o,
          ),
    ...
    76682: (e, t, n) => {
      ...
      function o(e, t) {
        return (0, a.useMemo)(() => l(e, t), [e, t]);
      }
      function c(e, t) {
        let n = "app";
        return (
          t == r.c6.xO ? (n = "bundle") : t == r.c6.RD && (n = "sub"),
          (0, a.useMemo)(() => l(e, n), [e, n])
        );
      }
      function l(e, t) {
        switch (t) {
        ...
        const t = (0, h.KV)(),
          { data: n, isLoading: a } = (0, c.I)({
            ...
            queryFn: async () => {
              const e = new Map();
              if (m.iA.logged_in) {
                const n = g.w.Init(f.w_T),
                  a = (await f.xtC.GetNicknameList(t, n)).Body().toObject();
                a?.nicknames &&
    ...
    26161: (e, t, n) => {
      ...
      var a = n(22837),
        r = n(30470);
      const s = () => (r.TS.EUNIVERSE === a.Rv ? 2581 : 45267781);
    },
    1909: (e, t, n) => {
      "use strict";
          ...
          for (const t of i) {
            ...
            i &&
              ...
              (o += (0, g.we)(
                ...
                (0, g.$z)(i) + " @ " + (0, f.KC)(i, { bForce24HourClock: !1 }),
              ))),
              e.push(
                (0, r.jsx)(
                  "option",
      ...
      (0, a.Cg)([h.oI], _.prototype, "OnLanguageChange", null),
        (_ = (0, a.Cg)([s.PA], _));
    },
    94011: (e, t, n) => {
      "use strict";
    ...
    92532: (e, t, n) => {
      ...
      function u(e) {
        ...
        const f = (0, c.BL)(g),
          h = t && (!p || (p.appID != t && p.snr != u)),
          C = (0, l.Ue)(r.props.ref, h ? f : void 0);
        return i.cloneElement(r, { ref: C });
      }
      function d(e) {
        return e == r.c6.xO
          ? "bundle"
    ...
    2240: (e, t, n) => {
      ...
      p.memo(function (e) {
        const { platforms: t } = e;
        if (!t) return null;
        const { windows: n, mac: r, steamos_linux: s, vr_support: i } = t;
      ...
      const v = p.memo(function (e) {
        ...
        return (0, a.jsxs)("span", {
          ...
          children: [
            ...
            Boolean(n == _.JR) && (0, a.jsx)(k, {}),
            Boolean(n == _.bY) && (0, a.jsx)(M, {}),
            (0, a.jsx)(s, {}),
          ],
        });
      });
      ...
      function B(e) {
        ...
        return (0, i.Qn)() || t ? (0, a.jsx)(R, { ...e }) : null;
      }
      function R(e) {
        ...
        return (
          c == _.iA && (u = _.ZJ),
          n
            ? (c == _.bY && (l = o.CompatIconFrame),
              (0, a.jsx)("div", {
                className: (0, s.A)(o.CompatIcon, l, t),
                children: (0, a.jsx)(x, { id: n, eHWCompat: u }),
              }))
            : null
        );
      }
            ...
            (0, a.jsxs)("div", {
              ...
              children: [
                ...
                (0, a.jsxs)("div", {
                  ...
                  children: [
                    g,
                    (0, a.jsx)(h, { bIsMinimized: f, fnToggleMinimize: s }),
                  ],
                }),
              ],
            }),
            !f && (0, a.jsx)(u.tH, { children: o }),
          ],
        });
      }
      function f(e) {
