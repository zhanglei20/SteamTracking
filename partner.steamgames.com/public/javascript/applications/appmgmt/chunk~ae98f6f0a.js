...
(self.webpackChunkappmgmt_storeadmin =
  ...
  [6672],
  {
    ...
    3578: (e, t, r) => {
      ...
      class n {
        static InstrumentLink(e, t, r = null) {
          const a = n.GetSNRLinkParam(t, r),
            s = n.GetCuratorClanIDParam(t);
          return n.AddNavParamToURL(e, a, s);
        }
        static ParseSNR(e) {
          const t = e.split("_") || [];
          return {
        ...
        static AddNavParamToURL(e, t, r) {
          ...
          try {
            const s = new URL((0, a.S)(e)),
              n = new URLSearchParams(s.search);
            return (
              n.set("snr", encodeURIComponent(t ?? "")),
              r &&
                !o.WN.includes(r) &&
                n.set("curator_clanid", encodeURIComponent(r ?? "")),
        ...
        static ComputeLinkPrefix(e, t, r, a) {
          let s = "";
          return (
            (s += n.EncodeEventComponent(e)),
            (s += "_"),
            (s += n.EncodeEventComponent(t)),
            (s += "_"),
            (s += n.EncodeEventComponent(r)),
            (s += "_"),
            (s += n.EncodeEventComponent(a)),
            s
          );
        }
    ...
    60014: (e, t, r) => {
      ...
      function d(e, t, r) {
        const a = m();
        return s.useMemo(() => e && p(a, e, t, r), [e, a, t, r]);
      }
      function u(e, t) {
        const r = m();
        return s.useMemo(
          () => o.A.GetSNRLinkParam({ ...r, feature: e || r.feature }, t),
          [r, e, t],
        );
      }
      function p(e, t, r, a) {
        const s = o.A.GetSNRLinkParam({ ...e, feature: r || e.feature }, a),
          n = o.A.GetCuratorClanIDParam(e);
        return o.A.AddNavParamToURL(t, s, n);
      }
    },
    6866: (e, t, r) => {
      "use strict";
      ...
      function u(e, t, r) {
        ...
        return (
          ...
          (0, a.jsx)(p, { url: s, event: t, children: r || e })
        );
      }
      const p = (e) => {
        ...
        let u,
          p = (0, o.OZ)(t);
        (p = d(p, r)), (0, s.p)(p) && (u = "noopener nofollow");
        const h =
    ...
    55963: (e, t, r) => {
      ...
      function d(e, t, r) {
        const s = (0, a.n9)();
        return l.useMemo(() => {
          const o = (0, n.wm)(e).toLowerCase(),
            l = (0, n.wm)(i.TS.COMMUNITY_BASE_URL).toLowerCase(),
            m = (0, n.wm)(i.TS.STORE_BASE_URL).toLowerCase();
          return o === l || o === m ? (0, a.bV)(s, e, t, r) : e;
        }, [s, e, t, r]);
      }
      function u(e, t, r = null) {
        const a = h(t, r),
          o = t ? s.A.GetCuratorClanIDParam(t) : null;
        return s.A.AddNavParamToURL(e, a, o);
      }
      function p(e, t, r, a = null) {
        const s = u(e, t, a);
        if (r && Object.keys(r).length > 0)
          try {
            const e = new URL((0, m.S)(s)),
      ...
      class g {
        ...
        static InstrumentLink(e, t, r = null) {
          const a = g.GetLinkParam(t, r),
            o = "string" != typeof t ? s.A.GetCuratorClanIDParam(t) : null;
          return s.A.AddNavParamToURL(e, a, o);
        }
        static GetLinkParam(e, t = null) {
          let r, a;
          if ("string" != typeof e) {
            if (e.domain) return s.A.GetSNRLinkParam(e, t);
            r = e.feature || "";
          }
          if (!g.sm_strComputedLinkPrefix && !g.ComputeStaticLinkPrefix())
            return null;
          a = g.sm_strComputedLinkPrefix;
          let o = s.A.EncodeEventComponent(r);
          return o && ((a += "_" + o), t && (a += "_" + t)), a;
        }
        static ComputeStaticLinkPrefix() {
          return g.sm_strDomain
            ? ((g.sm_strComputedLinkPrefix = s.A.ComputeLinkPrefix(
                g.sm_strDomain,
                g.sm_strController,
                g.sm_strMethod,
                g.sm_strSubmethod,
