  ...
  (self.webpackChunkappmgmt_storeadmin =
    ...
    [3239],
    {
      94621: (Un, Bt, ye) => {
        ...
        function ee(M, K) {
          if (M === K) return !0;
          if (typeof M != typeof K) return !1;
          if (typeof M == "function" && M.toString() === K.toString())
            return !0;
          let U, te, we;
          if (M && K && typeof M == "object") {
            if (Array.isArray(M)) {
              if (((U = M.length), U !== K.length)) return !1;
              for (te = U; te-- !== 0; ) if (!ee(M[te], K[te])) return !1;
              return !0;
            }
            if (
              ((we = Object.keys(M)),
              (U = we.length),
              U !== Object.keys(K).length)
            )
              return !1;
            for (te = U; te-- !== 0; )
              if (!{}.hasOwnProperty.call(K, we[te])) return !1;
            for (te = U; te-- !== 0; ) {
              const Re = we[te];
              if (!(Re === "_owner" && M.$$typeof) && !ee(M[Re], K[Re]))
                return !1;
            }
            return !0;
          }
        ...
        function ct(M) {
          ...
          const [yt, It] = le.useState(null),
            ...
            He = le.useCallback(() => {
              ...
              const fe = { placement: K, strategy: U, middleware: at };
              Xe.current && (fe.platform = Xe.current),
                (0, f.rD)(Le.current, Ne.current, fe).then((mt) => {
                  const Ke = { ...mt, isPositioned: Ct.current !== !1 };
                  _e.current &&
                    !ee(Ge.current, Ke) &&
                    ((Ge.current = Ke),
                    z.flushSync(() => {
          ...
          const Ze = le.useMemo(
            ...
            St = le.useMemo(() => {
              ...
              const mt = st(Ae.floating, Ce.x),
                Ke = st(Ae.floating, Ce.y);
              return Ve
                ? {
                    ...fe,
                    transform: "translate(" + mt + "px, " + Ke + "px)",
                    ...(it(Ae.floating) >= 1.5 && { willChange: "transform" }),
                  }
                : { position: U, left: mt, top: Ke };
        ...
        const bt = (M) => {
          ...
          ut = (M, K) => ({ ...(0, f.cY)(M), options: [M, K] }),
          Vt = (M, K) => ({ ...(0, f.BN)(M), options: [M, K] }),
          nn = (M, K) => ({ ...limitShift$1(M), options: [M, K] }),
          Be = (M, K) => ({ ...(0, f.UU)(M), options: [M, K] }),
          $t = (M, K) => ({ ...(0, f.Ej)(M), options: [M, K] }),
          rn = (M, K) => ({ ...autoPlacement$1(M), options: [M, K] }),
          me = (M, K) => ({ ...hide$1(M), options: [M, K] }),
          Rt = (M, K) => ({ ...inline$1(M), options: [M, K] }),
          Oe = (M, K) => ({ ...bt(M), options: [M, K] });
      },
      73788: (Un, Bt, ye) => {
        ye.d(Bt, {
          s3: () => br,
        ...
        function te(t) {
          return t ? t.getAttribute("role") === "combobox" && K(t) : !1;
        }
        var we = ye(58015),
          Re = ye(7850); /*!
         * tabbable 6.2.0
        ...
        var Ht = [
          ...
          mt = function (e, n) {
            ...
            return (
              n.getShadowRoot
                ...
                : (r = xt(e, n.includeContainer, _e.bind(null, n))),
              r
            );
          },
          Ke = function (e, n) {
          ...
          Wr = function (e, n) {
            if (((n = n || {}), !e)) throw new Error("No node provided");
            return Te.call(e, Yn) === !1 ? !1 : _e(n, e);
          },
          jr = ye(72739),
          qn = ye(94621);
        function zn(t) {
        ...
        function br(t) {
          const {
            ...
            q = ne((A) => {
              ...
              return W.current
                .map((_) =>
                  h && _ === "reference" ? h : R && _ === "floating" ? R : V,
                )
                .filter(Boolean)
                .flat();
            });
          f.useEffect(() => {
            ...
            function A(_) {
              if (_.key === "Tab") {
                ee(R, ve(me(R))) && O().length === 0 && !H && U(_);
                const $ = q(),
                  ie = Oe(_);
                W.current[0] === "reference" &&
                  ie === h &&
                  (U(_), _.shiftKey ? Ue($[$.length - 1]) : Ue($[1])),
          ...
          f.useEffect(() => {
            ...
            J(() => {
              ...
              const A = () => {
                const _ = R.getAttribute("tabindex"),
                  $ = O(),
                  ie = ve(me(y)),
                  ue = $.indexOf(ie);
                ue !== -1 && (T.current = ue),
                  W.current.includes("floating") || (ie !== h && $.length === 0)
                    ? _ !== "0" && R.setAttribute("tabindex", "0")
                    : _ !== "-1" && R.setAttribute("tabindex", "-1");
              };
              A();
              ...
              Z &&
                (0, Re.jsx)(_t, {
                  ...
                  onFocus: (A) => {
                    if (u) {
                      const _ = q();
                      Ue(o[0] === "reference" ? _[0] : _[_.length - 1]);
            ...
            X = ne((k) => {
              ...
              if ((0, z.sb)(I) && w) {
                const de = (0, z.eu)(I),
                  ...
                  _ = A && I.clientWidth > 0 && I.scrollWidth > I.clientWidth,
                  $ =
        ...
        function Qt(t, e) {
          return Kt(e, t === Tt || t === Je, t === De || t === Fe);
        }
        function en(t, e, n) {
          return (
            Kt(e, t === Je, n ? t === De : t === Fe) ||
            t === "Enter" ||
            t === " " ||
            t === ""
          );
                          ...
                          $n =
                            Me && !Kr
                              ...
                              : vt
                                ...
                                : null;
                        $n && (U(P), $n.dispatchEvent(jt), _(void 0));
                      }
                      if (
                        (ht || be) &&
                        je.context &&
          ...
          return (
            J(() => {
              ...
              if (
                ...
                E === "open" &&
                  g({
                    transitionProperty: Object.keys(G).map(_n).join(","),
                ...
                const W = F || H;
                g({
                  transitionProperty: Object.keys(W).map(_n).join(","),
          ...
          async fn(e) {
            ...
            const x = {
              ...
              L = await detectOverflow(
                Kn(x, g.scrollHeight + d + p.clientTop),
                a,
              ),
            ...
            return (
              r &&
                (r.current = await detectOverflow(
                  Kn({ ...x, y: Y }, g.offsetHeight + d + p.clientTop),
                  a,
                )),
              { y: Y }
            );
