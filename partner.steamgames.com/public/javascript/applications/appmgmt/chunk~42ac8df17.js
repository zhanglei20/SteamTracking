...
(self.webpackChunkappmgmt_storeadmin =
  ...
  [2012],
  {
    ...
    33951: (e, t, r) => {
      ...
      function I(e, t) {
        if (e) return v(t.getQueryData(m(e)), t);
      }
      function T(e, t, r) {
        if (!e) return;
        const i = r ? [r] : ["store", "group"];
        for (const r of i) {
          const i = v(t.getQueryData(g(e, r)), t);
          if (i) return i;
        }
      }
      ...
      async function W(e, t) {
        return e ? j(await t.fetchQuery(h(e, t)), t) : null;
      }
      async function O(e, t, r = "group") {
        return e ? j(await t.fetchQuery(z(e, t, r)), t) : null;
      }
    },
    38861: (e, t, r) => {
      "use strict";
    ...
    94076: (e, t, r) => {
      ...
      class p extends n.Message {
        ...
        constructor(e = null) {
          super(),
            p.prototype.cart_appid || s.Sg(p.M()),
            n.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
    ...
    71430: (e, t, r) => {
      ...
      class h extends n.Message {
        ...
        constructor(e = null) {
          super(),
            h.prototype.lineitems || s.Sg(h.M()),
            n.Message.initialize(this, e, 0, -1, [1, 2], null);
        }
        static sm_m;
        static sm_mbf;
      ...
      class O extends n.Message {
        ...
        static M() {
          return (
            O.sm_m ||
              (O.sm_m = { proto: O, fields: { contents: { n: 1, c: h } } }),
            O.sm_m
          );
        }
        static MBF() {
    ...
    84547: (e, t, r) => {
      ...
      function u(e) {
        ...
        return (0, i.jsx)(o.o0, {
          ...
          strDescription:
            r || l.F5.Localize("#LoginRedirect_Dialog_Description"),
          onCancel: t,
    ...
    65522: (e, t, r) => {
      ...
      function p(e, t) {
        if (e.vanity) {
          switch (t) {
            case "publisher":
              return `${m.TS.STORE_BASE_URL}publisher/${e.vanity}/`;
            case "franchise":
              return `${m.TS.STORE_BASE_URL}franchise/${e.vanity}/`;
          }
          return `${m.TS.STORE_BASE_URL}developer/${e.vanity}/`;
        }
        return `${m.TS.STORE_BASE_URL}curator/${e.creator_clan_id}/`;
      }
      var B = r(85044),
        f = r(92124),
        b = r(64769),
      ...
      function M(e) {
        ...
        return s && o
          ? (0, i.jsxs)("div", {
              className: (0, w.A)(y().GameHoverCreatorFollowButtonCtn, r),
              style: n,
              children: [
                (0, i.jsx)("a", {
                  href: p(o, "developer"),
                ...
                (0, i.jsx)(f.of, { clanAccountID: t, followType: a }),
              ],
            })
          : null;
      }
      ...
      function L(e) {
        const { id: t, snr: r, classOverride: n } = e,
          [a, s] = (0, h.useState)(!1),
          o = (0, R.m)("GameHoverIgnoreButton"),
          { elDialogElement: c, fnShowLogonDialog: l } = (0, W.lS)(),
          u = t && "appid" in t ? t.appid : void 0,
          d = (0, F.BD)(u),
          { mutateAsync: m } = (function (e, t, r, i = D.RI.$m) {
            const n = (0, F.h3)(),
              a = q.iA.accountid;
            return (0, x.n)({
              ...
              mutationFn: async () => {
                if (null == e) return;
                const n =
                    q.TS.STORE_BASE_URL + "recommended/ignorerecommendation",
                  a = new FormData();
                a.append("appid", "" + e),
          ...
          g = t && "appid" in t && z.Fm.Get().BIsGameIgnored(t.appid);
        return (0, i.jsxs)(O.Z, {
          className: (0, w.A)(j().IgnoreButton, n),
          onClick: async (e) => {
            e.preventDefault(),
              e.stopPropagation(),
              I.iA.logged_in
        ...
        if (e && t && t.main_capsule) {
          return {
            ...
            rctImage: (0, i.jsx)(
              "img",
              {
                className: y().FullDivImage,
                loading: "lazy",
                src: (0, P.b0)(t, "main_capsule"),
                alt: e.name,
              },
              "fallback",
            ),
      ...
      function re(e, t) {
        return {
          ...
          rctImage: (0, i.jsx)(E.mj, { id: e, active: !0 }),
          nDurationMs: Y,
        };
      }
      function ie(e, t, r, n) {
        return r.slice(0, n).map((r, n) => {
          const a = (0, P.bu)(r, "1920x1080");
          return {
      ...
      function ae(e) {
        ...
        if (!r || r.unvailable_for_country_restriction || !r.visible)
          return (0, i.jsx)("div", {
            className: y().TrailerCtn,
            children: (0, i.jsx)(ne, {}, "default"),
          });
        const a = r.item_type,
          s = r.type;
        return a == n.c6.xO || a == n.c6.RD
          ? (0, i.jsx)(le, { includeAppIDs: r.included_appids })
          : (s == n.uE.ue || s == n.uE.Vi) &&
              r.related_items &&
      ...
      function ce(e) {
            ...
            () =>
              (function (e, t, r, i, n, a) {
                ...
                return (
                  ...
                  ((e && 0 == s.length && "dev" == I.TS.WEB_UNIVERSE) ||
                    "beta" == I.TS.WEB_UNIVERSE) &&
                    console.error(
        ...
        return (0, i.jsx)(ue, { rgTrailerAndImages: l });
      }
      function le(e) {
        const { includeAppIDs: t } = e,
          r = (0, H.eG)(),
          n = (0, K.E)({ queries: t.map((e) => (0, G.AQ)(r, { appid: e })) }),
          a = (0, K.E)({ queries: t.map((e) => (0, G.us)(r, { appid: e })) }),
          s = (0, h.useMemo)(
      ...
      function we(e) {
        const {
          ...
          { data: T } = (0, G.lv)(r),
          j = !B && !m && !d,
          W = I && I.item_type == n.c6.qI;
        return (0, i.jsxs)("div", {
          className: y().BottomShelf,
          style: { transform: g && z ? R : "" },
          onMouseEnter: () => C(!0),
          onFocus: () => C(!0),
          onMouseLeave: () => C(!1),
          onBlur: () => C(!1),
          children: [
            (0, i.jsxs)("a", {
              ...
              children: [
                T &&
                  (0, i.jsx)("div", {
                    className: y().CapsuleImageAnchorPoint,
                    children: (0, i.jsx)("div", {
                      className: (0, w.A)(
                        y().CapsuleImageCtn,
                        y().WithCornerShine,
            ...
            (0, i.jsx)("div", {
              className: y().BottomShelfOffScreen,
              ...
              children: (0, i.jsxs)("div", {
                ...
                children: [
                  ...
                  S && (0, i.jsx)(Se, { id: t }),
                  (0, i.jsx)(ye, { id: t }),
                  Boolean(!p) && (0, i.jsx)(s.J, { id: t }),
                  Boolean(!p && j) &&
                    (0, i.jsxs)("div", {
                      className: y().ReviewsAndRelease,
                      children: [
                        (0, i.jsx)(fe.Q, {
                          id: t,
                          strClassName: y().PlatformDisplay,
                        }),
                        (0, i.jsx)(Me, { id: t }),
                      ],
                    }),
                  m && (0, i.jsx)(o.j, { id: t, className: y().DemoButton }),
                  Boolean(p && W) && (0, i.jsx)(_e.Q8, { id: t }),
                  Boolean(d) && d,
                  B &&
                    W &&
                    t &&
                    "appid" in t &&
                    t.appid &&
                    (0, i.jsx)(c.E, { appid: t.appid, bIsMuted: !1 }),
                  f && (0, i.jsx)(M, { nCreatorAccountID: f }),
                ],
              }),
            }),
          ],
      ...
      function Me(e) {
        ...
        if (!r) return null;
        const n = (0, ge.CC)(r);
        return (0, i.jsx)("div", { className: y().ReleaseDate, children: n });
      }
      function Se(e) {
        const { id: t } = e,
          { data: r } = (0, G.wl)(t);
      ...
      function he(e) {
        ...
        return (0, i.jsxs)("div", {
          className: (0, w.A)(
            y().GameHoverCapsuleCtn,
            d && y().Loading,
            Be().InGameHover,
            a && y().UseHidingBottomHalf,
          ),
          children: [
            (0, i.jsxs)("a", {
              href: n,
              className: y().TrailerAnchorStoreLink,
              children: [
                Boolean(o && !s) && (0, i.jsx)(S.E, { id: r, snr: e.strSNR }),
                Boolean(c && !s) && (0, i.jsx)(L, { id: r, snr: e.strSNR }),
                t && (0, i.jsx)(ae, { id: t }),
              ],
            }),
            (0, i.jsx)(we, { ...e }),
      ...
      function ze(e) {
        const {
          ...
          { data: w } = (0, G.J$)(t),
          M = (0, I.Qn)(),
          { strStoreURL: S, snr: h } = (0, de.x)(w, c);
        if ((!w && !r) || M) return (0, i.jsx)(i.Fragment, { children: m });
        let z = t;
        w &&
          w.item_type == n.c6.RD &&
          1 == w.included_appids?.length &&
          (z = { appid: w.included_appids[0] });
        const C = a || !w ? void 0 : S,
          R = {
            id: t,
            displayID: z,
            name: r,
          ...
          v = (0, i.jsx)(he, { ...R }),
          T = C ? (0, i.jsx)("a", { href: C, children: m }) : m;
        return (0, i.jsx)(me.J, {
          hoverContent: v,
          nWidthMultiplier: _,
          ...y,
    ...
    24267: (e, t, r) => {
      ...
      function f(e) {
        ...
        let M = f.summary_unfiltered || f.summary_filtered,
          ...
          h = !1;
        const z = p.Z.Localize("#Language_" + B.TS.LANGUAGE);
        if (
        ...
        const R = `${B.TS.STORE_BASE_URL}app/${b.appid}/#app_reviews_hash`,
          v = (0, i.jsxs)("div", {
            className: (0, m.A)(_().ReviewScoreValue, C),
            children: [
              (0, i.jsx)("div", {
                className: _().ReviewScoreLabel,
                "aria-label": p.Z.Localize(S, M.review_score_label, z),
    ...
    94636: (e, t, r) => {
      ...
      function w(e) {
        const {
          ...
          { data: S } = (0, o.J$)(t),
          { elDialogElement: h, fnShowLogonDialog: z } = (0, s.lS)(),
          [C, R] = (0, d.useState)(() =>
            S &&
    ...
    13727: (e, t, r) => {
      ...
      function y(e) {
        ...
        return (0, i.jsxs)("div", {
          ...
          onMouseEnter: (e) => {
            y(!0), S(e.currentTarget);
          },
          onMouseLeave: () => y(!1),
          onTouchStart: () => y(!1),
          onKeyDown: (e) => {
            e.keyCode == s.zV &&
              (y(!1), e.preventDefault(), e.stopPropagation());
          },
          children: [
            B &&
              M &&
      ...
      function M(e) {
        ...
        return (0, i.jsx)(o.g, {
          ...
          children: (0, i.jsx)(c.M, {
            ...
            appear: !0,
            classNames: {
              appearActive: (0, d.A)(f().Opening, p().Opening),
              enterDone: (0, d.A)(f().Open, p().Open),
            },
            children: (e) =>
              (0, i.jsx)("div", {
                ref: (0, m.XB)(e, n),
    ...
    52606: (e, t, r) => {
      ...
      class Et extends Tt.Message {
        ...
        constructor(e = null) {
          super(),
            Et.prototype.bytes_available || Wt.Sg(Et.M()),
      ...
      class Jt extends Tt.Message {
        ...
        static MBF() {
          return Jt.sm_mbf || (Jt.sm_mbf = Wt.w0(Jt.M())), Jt.sm_mbf;
        }
        toObject(e = !1) {
          return Jt.toObject(e, this);
        }
        static toObject(e, t) {
          return Wt.BT(Jt.M(), e, t);
        }
        static fromObject(e) {
          return Wt.Uq(Jt.M(), e);
        }
        ...
        return (0, Mt.I)({
          ...
          queryFn: async () => {
            const t = vt.w.Init(At),
              r = await yt.GetAllClientLogonInfo(e, t);
      ...
      async function or(e, t, r) {
        ...
        const a = await yt.GetClientAppList(e, n);
          ...
          a = (function (e, t, r) {
            ...
            return (0, zt.n)({
              mutationFn: async () => {
                ...
                const o = await yt.InstallClientApp(i, r);
        ...
        return !p && _ && d.is_free
          ...
          : (0, i.jsx)(o.he, {
              ...
              onClick: (e) => {
                e.preventDefault(),
                  e.stopPropagation(),
                  p && (0, s.o)(d.type === n.uE.ue ? d.appid : g[0], d.name);
              },
              className: (0, c.A)(r, m().DemoButton, !p && m().DisabledButton),
              children: p
    ...
    3740: (e, t, r) => {
      ...
      function y(e) {
        ...
        return (0, i.jsx)(w, { purchaseOption: c, ...e });
      }
      function w(e) {
        const {
            bSingleLineMode: t,
        ...
        if (R) {
          const e = (0, B.rt)(p.iA.country_code.toUpperCase()),
            t = { ...(0, f.J)(e), bWholeUnitsOnly: !0 };
          U = (0, b.d)(Number.parseInt(O.final_price_in_cents || "0"), t);
        }
        const D = (0, s.Nq)(j, O);
        return (0, i.jsx)(M, {
    ...
    12424: (e, t, r) => {
      ...
      function g(e) {
        const { appid: t, bIsMuted: r } = e,
          ...
          { mutate: p } = (0, n.S)(l),
          B = (e) => {
            e.preventDefault(), g ? (0, c.o)(t, _?.name) : p();
          },
          f = (0, d.A)(
            u().CapsuleBottomBar,
            r && u().Muted,
    ...
    39020: (e, t, r) => {
      ...
      function c(e) {
        const t = (0, s.TR)(),
          r = (0, s.rX)();
        return (0, o.I)(l(t.GetAnonymousServiceTransport(), r, e));
      }
      function l(e, t, r) {
        return {
          ...
          queryFn: async () => {
            ...
            const l = await a.nd.GetTagList(e, c);
            let u;
            if (l.GetEResult() == i.R)
              (u = l.Body().toObject()), t && t.StoreObject(s, u);
    ...
    72119: (e, t, r) => {
      ...
      class A {
        ...
        BIsFollowingCurator(e) {
          return this.ReadData().setCuratorsFollowed.has(x(e));
        }
        BIsIgnoringCurator(e) {
          return this.ReadData().setCuratorsIgnored.has(x(e));
        }
        ...
        async UpdateAppIgnore(e, t, r, i = p.RI.$m) {
          this.LazyInit();
          ...
          return (
            A.s_globalSingletonStore ||
              ...
              "dev" == u.TS.WEB_UNIVERSE &&
                (0, F.V)("DUS", A.s_globalSingletonStore)),
            A.s_globalSingletonStore
          );
        }
    ...
    22692: (e, t, r) => {
      ...
      async function K(e, t, r, i) {
        ...
        const s = await E.AddItemsToCart(e, a);
        return (
          s.BSuccess() ||
            console.warn(
      ...
      function ie(e, t, r, i, m) {
        ...
        return (0, u.n)({
          mutationFn: async () => {
            ...
            if (d(g)) {
              const s = {
                ...
                [o, c] = await (async function (e, t, r, i) {
                  return K(e, t, [r], i);
                })(_, b, s, y);
              if (o != n.R) throw `AddToAccountCart failed with ${o}`;
              (a = c.line_item_ids), re(p, g, c.cart);
            } else {
              if (
                !(function (e) {
                ...
                throw "Invalid cart type";
              {
                  ...
                  throw `AddItemsToAnonymousCart failed with ${s}`;
                {
                  ...
                  (a = r?.map((e) => e.gidlineitem) || []), re(p, g, V(o));
                }
              }
            }
            return a;
          ...
          onMutate: () => {
            ...
            (async () => {
              const e = await p.fetchQuery((0, o.us)(f, r)),
                t =
                  1 == e?.included_appids?.length
                    ? { appid: e.included_appids[0] }
                    : r;
              p.prefetchQuery((0, o.AQ)(f, t)),
                p.prefetchQuery((0, o.rK)(f, t));
            })();
          },
        });
      }
      ...
      class le extends _.Message {
        ...
        constructor(e = null) {
          super(),
            le.prototype.packageid || B.Sg(le.M()),
            _.Message.initialize(this, e, 0, -1, void 0, null);
        }
        static sm_m;
        static sm_mbf;
            ...
            queryFn: () =>
              (async function (e, t) {
                ...
                r.Body().set_packageid(e.id || 0),
                  r.Body().set_country_code(ge.iA.country_code);
      ...
      function he(e) {
        ...
        if (!a || !s || !l || a.type == ne.uE.gQ) return null;
        const _ =
          a.is_free ||
        ...
        if (a.item_type == ne.c6.RD)
          if (a.type == ne.uE.Hk) {
            ...
            if (!u.inventory_available)
              return (0, i.jsx)("div", {
                className: (0, fe.A)(Me().ActionOutOfStock, r),
    ...
    92124: (e, t, r) => {
      ...
      function w(e, t, r) {
        ...
        return (0, b.n)({
          ...
          mutationFn: async () => {
            if (null == e) return;
            const i = _.TS.STORE_BASE_URL + "explore/followgame",
              n = new FormData();
            n.append("appid", "" + e),
      ...
      const A = (e) => {
        ...
        if (!(0, h.xU)()) return null;
        let g = null;
        switch (u) {
          case "app":
            g = (0, I.we)("#text_store_follow_desc");
            break;
          case "creatorhome":
            g = (0, I.we)("#CreatorHome_Follow_tooltip");
            break;
          case "steamcurator":
            g = (0, I.we)("#steam_curator_follow_ttip");
            break;
          case "group":
            g = (0, I.we)("#steam_group_follow_ttip");
        }
        return g
          ? (0, i.jsxs)(i.Fragment, {
              children: [
                (0, i.jsx)(j.Gq, {
                  ...
                  children: (0, i.jsxs)(a.ml, {
                    ...
                    children: [
                      n && (0, i.jsx)(C.k, { size: 15 }),
                      !n && (s || r) && (0, i.jsx)(R.Jlk, {}),
                      (0, i.jsx)("div", {
                        className: (0, v.A)(W.FollowBtnText, "FollowBtnText"),
                        children:
                          !n &&
                          (s
                            ? (0, I.we)("#Button_Followed")
                            : r
                              ? (0, I.we)("#Button_Ignored")
                              : (0, I.we)("#Button_Follow")),
                      }),
                    ],
                  }),
                }),
      ...
      function x(e) {
        const {
            ...
            return (0, b.n)({
              ...
              mutationFn: async () => {
                ...
                const r = t == M.k_ECuratorFollow || t == M.k_ECuratorUnfollow,
                  ...
                  n = `${_.TS.STORE_BASE_URL}curators/${r ? "ajaxfollow/" : "ajaxignore/"}`,
                  a = new FormData();
                a.append("clanid", "" + e),
              ...
              onMutate: () => {
                if (null != e) {
                  const i =
                    t == M.k_ECuratorUnfollow || t == M.k_ECuratorUnignore;
                  r(
          ...
          })(a, m ? M.k_ECuratorUnfollow : M.k_ECuratorFollow),
          [f, w, S] = (0, s.uD)(),
          C = z.useCallback(async () => {
        ...
        return (0, i.jsxs)(i.Fragment, {
          children: [
            ...
            (0, i.jsx)(T.EN, {
              active: f,
              children: (0, i.jsx)(O.g, { closeModal: S }),
            }),
          ],
        });
      }
