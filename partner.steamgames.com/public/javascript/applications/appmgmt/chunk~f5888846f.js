  ...
  [4829],
  {
    ...
    63556: (e, t, i) => {
      ...
      var s = i(34629),
        ...
        h = i(91986);
      class g {
        m_eCurLang = (0, r.sf)(l.TS.LANGUAGE);
      ...
      (0, s.Cg)([n.sH], g.prototype, "m_eCurLang", void 0),
        (0, s.Cg)([n.sH], g.prototype, "m_rgHasData", void 0),
        (0, s.Cg)([n.sH], g.prototype, "m_bHasLocalizationContext", void 0),
        (0, s.Cg)([c.o], g.prototype, "GetCurEditLanguage", null),
        (0, s.Cg)([c.o], g.prototype, "SetCurEditLanguage", null),
        (0, s.Cg)([n.XI.bound], g.prototype, "SetHasLanguage", null),
        (0, s.Cg)([c.o], g.prototype, "BHasLanguageData", null);
    },
    55263: (e, t, i) => {
      "use strict";
      i.d(t, {
          ...
          ((0, o.useEffect)(() => {
            ...
            return (
              !e ||
                ...
                (void 0 !== g && s && s == l.current) ||
                (s !== l.current && (p(void 0), (l.current = s)),
                (o = n().CancelToken.source()),
                a.A.Get()
                  .QueueStoreItemRequest(e, t, i)
                  .then((t) => {
                    o?.token.reason || c.current !== e || p(1 == t), h();
                  })),
              () => o?.cancel("useStoreItemCache: unmounting")
            );
          }, [e, t, s, g, d, u, m, _, f, w, b, P, y, k, v, L, T, I, C, D, h]),
          !e)
        )
          return [null, 2];
        if (!1 === g) return [void 0, 2];
        if (a.A.Get().BIsStoreItemMissing(e, t)) return [void 0, 2];
        if (!a.A.Get().BHasStoreItem(e, t, i)) return [void 0, 1];
        const x = a.A.Get().GetStoreItemWithLegacyVisibilityCheck(e, t);
        return x ? [x, 3] : [null, 2];
      }
      function l(e, t, i) {
        return c(e, 0, t, i);
      ...
      function p(e, t, i, s) {
        ...
        if (
          ...
          }, [e, t, s, c, l, h, g, p, d, u, m, _, f, w, b, P, y, k, v, L]),
          !e)
        )
          return 2;
        if (
          ...
          e &&
            (await (async function (e, t, i, s, n, o, r, a, c) {
              return new Promise((l, h) => {
                ...
                (p.width = r), (p.height = a);
                const d = 0,
                  m = 0,
                  f = p.getContext("2d");
                f?.drawImage(t, i, s, n, o, d, m, r, a),
                  p.toBlob((t) => {
